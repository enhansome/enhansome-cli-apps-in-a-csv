...
* [eza](https://github.com/eza-community/eza) ⭐ 22,982 | 🐛 433 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,182 | 🐛 206 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,749 | 🐛 138 | 🌐 Rust | 📅 2026-08-19 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [nav](https://github.com/dkaslovsky/nav) ⭐ 132 | 🐛 0 | 🌐 Go | 📅 2026-03-15 - Terminal navigator for interactive ls workflows.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,153 | 🐛 189 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [hiSHtory](https://github.com/ddworken/hishtory) ⭐ 3,110 | 🐛 63 | 🌐 Go | 📅 2026-03-18 - A better shell history that stores context (directory, succeeded or failed, how long it took, etc). The history is stored locally and end-to-end encrypted for syncing to other computers.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,813 | 🐛 429 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,805 | 🐛 295 | 🌐 Rust | 📅 2026-08-20 - Syntax-aware structured diff tool.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,450 | 🐛 179 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,605 | 🐛 46 | 🌐 Rust | 📅 2026-08-18 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,818 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,311 | 🐛 77 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,287 | 🐛 17 | 🌐 Rust | 📅 2026-08-15 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,153 | 🐛 8 | 🌐 Rust | 📅 2026-08-19 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,152 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,913 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [diskus](https://github.com/sharkdp/diskus) ⭐ 1,235 | 🐛 13 | 🌐 Rust | 📅 2026-02-14 - Minimal, fast alternative to du -sh.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,930 | 🐛 144 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,117 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,142 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,067 | 🐛 38 | 🌐 Python | 📅 2026-08-19 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,042 | 🐛 41 | 🌐 Rust | 📅 2026-07-13 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,404 | 🐛 134 | 🌐 C | 📅 2026-08-20 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,536 | 🐛 66 | 🌐 Rust | 📅 2026-08-19 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,671 | 🐛 257 | 🌐 Go | 📅 2026-08-20 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,819 | 🐛 4 | 🌐 C | 📅 2026-08-17 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,465 | 🐛 80 | 🌐 Go | 📅 2026-08-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 480 | 🌐 C++ | 📅 2026-08-19 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,719 | 🐛 27 | 🌐 C | 📅 2026-08-20 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
* [hunter](https://github.com/rabite0/hunter) ⭐ 1,337 | 🐛 40 | 🌐 Rust | 📅 2022-09-26 - Ranger-like file browser written in rust.
* [felix](https://github.com/kyoheiu/felix) ⭐ 914 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager with vim-like key mapping
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,808 | 🐛 14 | 🌐 Rust | 📅 2026-08-17 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [progress](https://github.com/Xfennec/progress) ⭐ 8,860 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Monitor the progress of common Coreutils command-line tools (`cp`, `mv`, `dd`, `tar`, `rsync`, etc.); it uses a ncurses interface to display the percentage of data copied; it works by reading from system files and retrieving the necessary information for the estimation.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,717 | 🐛 100 | 🌐 Rust | 📅 2026-08-17 - Painless compression and decompression in the terminal.
* [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,544 | 🐛 64 | 🌐 C | 📅 2026-08-01 - Rotate, compress and mail logs.
...
* [lib-x](https://github.com/Benexl/lib-x) ⭐ 75 | 🐛 0 | 🌐 Shell | 📅 2026-08-20 - Browse your calibre library from the terminal.
...
* [reflex](https://github.com/cespare/reflex) ⭐ 3,550 | 🐛 28 | 🌐 Go | 📅 2026-02-26 - Reflex is a small tool to watch a directory and rerun a command when certain files change.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,618 | 🐛 61 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 174,962 | 🐛 875 | 🌐 Python | 📅 2026-08-19 - Python tool for converting files and office documents to Markdown.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,320 | 🐛 535 | 🌐 Rust | 📅 2026-08-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,712 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,100 | 🐛 371 | 🌐 Python | 📅 2026-06-23.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,786 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,586 | 🐛 25 | 🌐 Go | 📅 2026-07-28 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,868 | 🐛 284 | 🌐 Go | 📅 2026-08-20 - Portable command-line YAML processor.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,667 | 🐛 60 | 🌐 Python | 📅 2026-06-18 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,134 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
...
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,722 | 🐛 22 | 🌐 Rust | 📅 2026-08-19 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,233 | 🐛 703 | 🌐 Go | 📅 2026-08-20 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,356 | 🐛 43 | 🌐 Python | 📅 2026-08-18 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,966 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - A command line client for MySQL that can do autocompletion and syntax highlighting.
...
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,001 | 🐛 70 | 🌐 Go | 📅 2026-08-20 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,334 | 🐛 45 | 🌐 Python | 📅 2026-08-20 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,286 | 🐛 18 | 🌐 Rust | 📅 2026-08-21 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,230 | 🐛 50 | 🌐 Go | 📅 2026-08-20 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,936 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,762 | 🐛 36 | 🌐 Rust | 📅 2026-08-21 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,762 | 🐛 36 | 🌐 Rust | 📅 2026-08-21 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,082 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,191 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,602 | 🐛 328 | 🌐 Go | 📅 2026-08-20 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,930 | 🐛 9 | 🌐 Rust | 📅 2026-08-17 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,186 | 🐛 82 | 🌐 Rust | 📅 2026-08-16 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 26,974 | 🐛 221 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,079 | 🐛 688 | 🌐 Rust | 📅 2026-08-20 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,822 | 🐛 126 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,404 | 🐛 1,033 | 🌐 Go | 📅 2026-08-21 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,474 | 🐛 163 | 🌐 Rust | 📅 2026-08-19 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 694 | 🐛 1 | 🌐 Go | 📅 2026-08-20 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,509 | 🐛 1,025 | 🌐 Go | 📅 2026-08-20 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,865 | 🐛 460 | 🌐 Go | 📅 2026-08-19 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,408 | 🐛 339 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,095 | 🐛 97 | 🌐 Shell | 📅 2026-08-17 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,311 | 🐛 230 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,330 | 🐛 98 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
...
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,146 | 🐛 146 | 🌐 Rust | 📅 2026-08-17 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,025 | 🐛 62 | 🌐 Rust | 📅 2026-08-17 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,008 | 🐛 176 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,187 | 🐛 78 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,062 | 🐛 14 | 🌐 Shell | 📅 2026-08-21 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,037 | 🐛 253 | 🌐 Shell | 📅 2026-08-11 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,297 | 🐛 11 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,100 | 🐛 1,213 | 🌐 Rust | 📅 2026-08-21 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,137 | 🐛 18 | 🌐 Rust | 📅 2026-08-20 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,981 | 🐛 133 | 🌐 TypeScript | 📅 2026-08-18 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,539 | 🐛 656 | 🌐 Go | 📅 2026-08-20 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,993 | 🐛 405 | 🌐 JavaScript | 📅 2026-08-18 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,901 | 🐛 4 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,449 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,834 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,289 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Instant, easy, and predictable development environments.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,636 | 🐛 25 | 🌐 Go | 📅 2026-08-20 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,393 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - A TUI for analyzing Linux binaries.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,099 | 🐛 444 | 🌐 Rust | 📅 2026-08-20 - Developer environments you can take with you.
* [PuDB](https://github.com/inducer/pudb) ⭐ 3,249 | 🐛 164 | 🌐 Python | 📅 2026-08-16 - Allows you to debug code right where you write and test it in a terminal.
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,636 | 🐛 15 | 🌐 Python | 📅 2026-08-20 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [cgdb](https://github.com/cgdb/cgdb) ⭐ 1,840 | 🐛 45 | 🌐 C | 📅 2026-02-27 - Console front-end to the GNU debugger.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 13 | 🌐 Python | 📅 2026-08-20 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,060 | 🐛 313 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,398 | 🐛 113 | 🌐 Go | 📅 2026-08-20 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,289 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,840 | 🐛 41 | 🌐 Go | 📅 2026-08-19 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,522 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,636 | 🐛 24 | 🌐 Go | 📅 2026-08-18 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,510 | 🐛 143 | 🌐 Go | 📅 2026-08-02 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,182 | 🐛 81 | 🌐 C | 📅 2026-08-09 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,182 | 🐛 81 | 🌐 C | 📅 2026-08-09 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,387 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
...
* [E1S](https://github.com/keidarcy/e1s) ⭐ 919 | 🐛 2 | 🌐 Go | 📅 2026-08-03 - TUI for browsing and managing AWS ECS resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,436 | 🐛 332 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,439 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,289 | 🐛 83 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,848 | 🐛 77 | 🌐 Rust | 📅 2026-08-18 - Fast, async, resource-friendly link checker written in Rust.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,215 | 🐛 9 | 🌐 Rust | 📅 2026-07-04 - TUI-based HTTP/REST client.
...
* [domain-check](https://github.com/saidutt46/domain-check) ⭐ 303 | 🐛 4 | 🌐 Rust | 📅 2026-05-14 - Universal domain exploration engine: fast domain availability checks across the internet.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,087 | 🐛 4 | 🌐 Rust | 📅 2026-08-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,363 | 🐛 1,809 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,396 | 🐛 170 | 🌐 Rust | 📅 2026-08-20 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,309 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,660 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,732 | 🐛 84 | 🌐 Python | 📅 2026-08-20 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 59,981 | 🐛 244 | 🌐 Zig | 📅 2026-08-20 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,473 | 🐛 1,815 | 🌐 Rust | 📅 2026-08-20 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,617 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,445 | 🐛 23 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,019 | 🐛 1,859 | 🌐 Rust | 📅 2026-08-20 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,304 | 🐛 1,432 | 🌐 Rust | 📅 2026-08-20 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,360 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 52 | 🌐 C++ | 📅 2026-08-20 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,947 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,686 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,293 | 🐛 76 | 🌐 C | 📅 2026-08-21 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,293 | 🐛 76 | 🌐 C | 📅 2026-08-21 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,827 | 🐛 455 | 🌐 C | 📅 2026-08-20 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,646 | 🐛 36 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,817 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,119 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,067 | 🐛 29 | 🌐 Go | 📅 2026-08-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [chdig](https://github.com/azat/chdig) ⭐ 292 | 🐛 5 | 🌐 Rust | 📅 2026-08-20 - Dig into ClickHouse with TUI interface.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,419 | 🐛 206 | 🌐 Rust | 📅 2026-08-20 - Upgrade all the things.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,481 | 🐛 211 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,560 | 🐛 292 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,826 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,688 | 🐛 68 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,883 | 🐛 141 | 🌐 Go | 📅 2026-08-09 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,266 | 🐛 28 | 🌐 Go | 📅 2026-08-20 - A Docker manager for the terminal.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,811 | 🐛 24 | 🌐 Rust | 📅 2026-07-24 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,339 | 🐛 116 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,698 | 🐛 67 | 🌐 Rust | 📅 2026-07-20 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,696 | 🐛 17 | 🌐 Go | 📅 2026-08-17 - TUI for running apps and processes.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,886 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,070 | 🐛 7 | 🌐 Rust | 📅 2026-08-16 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,070 | 🐛 7 | 🌐 Rust | 📅 2026-08-16 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,897 | 🐛 28 | 🌐 Go | 📅 2026-08-20 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,263 | 🐛 206 | 🌐 TypeScript | 📅 2026-08-20 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 884 | 🐛 9 | 🌐 Rust | 📅 2026-08-14 - Terminal mail client.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,161 | 🐛 1,188 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,119 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-16 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,922 | 🐛 21 | 🌐 C++ | 📅 2026-08-16 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,714 | 🐛 73 | 🌐 Go | 📅 2026-08-20 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,363 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,321 | 🐛 127 | 🌐 Python | 📅 2026-07-04 - Mastodon CLI & TUI.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 993 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 954 | 🐛 2 | 🌐 Python | 📅 2026-08-21 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 751 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
* [twitch-tui](https://github.com/Xithrius/twitch-tui) ⭐ 631 | 🐛 10 | 🌐 Rust | 📅 2026-05-29 - Twitch chat in the terminal.
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,523 | 🐛 212 | 🌐 Python | 📅 2026-08-20 - Transparent proxy server that works as a poor man's VPN. Forwards over ssh. Doesn't require admin. Works with Linux and macOS. Supports DNS tunneling.
* [gping](https://github.com/orf/gping) ⭐ 12,630 | 🐛 52 | 🌐 Rust | 📅 2026-08-10 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,235 | 🐛 112 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,906 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,407 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,718 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,498 | 🐛 57 | 🌐 Rust | 📅 2026-08-19 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,895 | 🐛 148 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,667 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,648 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,510 | 🐛 78 | 🌐 Rust | 📅 2026-08-13 - A network diagnostic tool.
...
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,107 | 🐛 47 | 🌐 C | 📅 2026-08-20 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,066 | 🐛 33 | 🌐 C | 📅 2026-08-20 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,873 | 🐛 13 | 🌐 Rust | 📅 2026-08-20 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,698 | 🐛 20 | 🌐 Rust | 📅 2026-03-09 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,559 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - TUI for sniffing network traffic using eBPF on Linux.
...
* [Wishlist](https://github.com/charmbracelet/wishlist) ⭐ 1,648 | 🐛 19 | 🌐 Go | 📅 2026-08-12 - With Wishlist you can have a single entrypoint for multiple SSH endpoints.
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,573 | 🐛 25 | 🌐 Rust | 📅 2026-07-09 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,550 | 🐛 16 | 🌐 Rust | 📅 2026-08-21 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,381 | 🐛 38 | 🌐 C | 📅 2026-08-03 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
...
* [ggh](https://github.com/byawitz/ggh) ⭐ 949 | 🐛 26 | 🌐 Go | 📅 2026-02-10 - Recall your SSH sessions, also searching your SSH config file.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,963 | 🐛 21 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,788 | 🐛 6 | 🌐 Rust | 📅 2026-08-17 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,389 | 🐛 11 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 185,893 | 🐛 2,592 | 🌐 Python | 📅 2026-08-20 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,978 | 🐛 4,128 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,766 | 🐛 1,160 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 39,987 | 🐛 4 | 🌐 Go | 📅 2026-08-20 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,641 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,861 | 🐛 178 | 🌐 Python | 📅 2026-08-20 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,272 | 🐛 1,156 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,030 | 🐛 38 | 🌐 Rust | 📅 2026-08-16 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 7,953 | 🐛 211 | 🌐 Go | 📅 2026-08-20 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,628 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,764 | 🐛 29 | 🌐 Go | 📅 2024-08-20 - A quick and easy command-line file transfer utility from any computer to another.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,844 | 🐛 400 | 🌐 C++ | 📅 2026-08-19 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,220 | 🐛 2 | 🌐 Python | 📅 2026-08-21 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,459 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,532 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
...
* [Neon Modem Overdrive](https://github.com/mrusme/neonmodem) ⭐ 700 | 🐛 21 | 🌐 Go | 📅 2026-07-21 - The program allows you to manage and read content from various popular platforms without having to use a browser or separate apps.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-21 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [geek-life](https://github.com/ajaxray/geek-life) ⭐ 563 | 🐛 26 | 🌐 Go | 📅 2026-01-28 - A full-featured TUI task manager.
...
* [kanban-python](https://github.com/Zaloog/kanban-python) ⭐ 347 | 🐛 0 | 🌐 Python | 📅 2026-05-12 - Kanban Terminal App written in Python.
...
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,377 | 🐛 6 | 🌐 Shell | 📅 2026-08-18 - A feature-rich clock/ timer/ pattern-based time manager in terminal with curated text-art.
...
* [zeit](https://github.com/mrusme/zeit) ⭐ 584 | 🐛 0 | 🌐 Go | 📅 2026-07-21 - A command line tool for tracking time spent on activities.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,366 | 🐛 150 | 🌐 Shell | 📅 2026-08-20 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,295 | 🐛 149 | 🌐 Python | 📅 2026-08-20 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,770 | 🐛 25 | 🌐 Go | 📅 2026-08-03 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,041 | 🐛 264 | 🌐 Python | 📅 2026-08-18 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,861 | 🐛 222 | 🌐 Python | 📅 2026-08-20.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,338 | 🐛 8 | 🌐 Python | 📅 2026-06-17 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,861 | 🐛 222 | 🌐 Python | 📅 2026-08-20 - CalDAV synchronization program.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,213 | 🐛 36 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [mop](https://github.com/mop-tracker/mop) ⭐ 2,202 | 🐛 6 | 🌐 Go | 📅 2025-12-28 - Stock market tracker for hackers.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,596 | 🐛 799 | 🌐 TypeScript | 📅 2026-08-21 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,487 | 🐛 63 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,377 | 🐛 96 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,620 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,784 | 🐛 74 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,342 | 🐛 172 | 🌐 C++ | 📅 2026-08-19 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 160 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,654 | 🐛 125 | 🌐 Rust | 📅 2026-03-13 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 720 | 🐛 12 | 🌐 C | 📅 2026-08-18 - Base conversion and bit manipulator in ncurses.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,725 | 🐛 455 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
...
* [pet](https://github.com/knqyf263/pet) ⭐ 5,329 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,928 | 🐛 97 | 🌐 Go | 📅 2026-08-20 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,276 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
...
* [docfd](https://github.com/darrenldl/docfd) ⭐ 288 | 🐛 4 | 🌐 OCaml | 📅 2026-08-20 - TUI fuzzy document finder that looks for documentation files in Markdown and txt format in the directory tree.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 109 | 🐛 1 | 🌐 Rust | 📅 2026-08-20 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 9 | 🐛 0 | 🌐 Zig | 📅 2026-08-20 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,016 | 🐛 549 | 🌐 Go | 📅 2026-08-12 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,642 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-19 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,162 | 🐛 57 | 🌐 C | 📅 2026-08-17 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,305 | 🐛 28 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
...
* [Diagon](https://github.com/ArthurSonzogni/Diagon) ⭐ 2,220 | 🐛 21 | 🌐 C++ | 📅 2025-05-16 - Diagon is an interactive interpreter, that transforms Markdown-style expression into an ASCII-art representation.
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,013 | 🐛 38 | 🌐 C | 📅 2026-08-20 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,789 | 🐛 4 | 🌐 Python | 📅 2026-08-18 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 991 | 🐛 17 | 🌐 Python | 📅 2026-08-18 - AI-Powered Command-Line Photo Search Tool.
...
* [Artem](https://github.com/FineFindus/artem) ⭐ 342 | 🐛 1 | 🌐 HTML | 📅 2025-06-15 - Convert images from multiple formats (JPG, PNG, WEBP, etc.) to ASCII art, written in Rust.
...
* [greentext](https://github.com/jasonuc/greentext) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-08-17 - A CLI tool for creating green-text memes.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,703 | 🐛 76 | 🌐 Python | 📅 2026-08-20 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,641 | 🐛 11 | 🌐 Shell | 📅 2026-08-19 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 589 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,311 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,564 | 🐛 710 | 🌐 Python | 📅 2026-08-20 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,098 | 🐛 164 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,728 | 🐛 209 | 🌐 Rust | 📅 2026-08-19 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [PyRadio](https://github.com/coderholic/pyradio) ⭐ 1,090 | 🐛 11 | 🌐 Python | 📅 2026-05-07 - Curses based internet radio player.
...
* [opencubicplayer](https://github.com/mywave82/opencubicplayer) ⭐ 436 | 🐛 17 | 🌐 C | 📅 2026-08-18 - Open Cubic Player (UNIX fork) is a music visualizer for various tracked music formats (amiga modules, S3M, IT), chiptunes and other formats related to demoscene.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 157 | 🐛 1 | 🌐 Shell | 📅 2026-08-20 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,823 | 🐛 177 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 2,983 | 🐛 0 | 🌐 C | 📅 2026-08-20 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,983 | 🐛 0 | 🌐 C | 📅 2026-08-20 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,176 | 🐛 49 | 🌐 Rust | 📅 2026-08-17 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,169 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 612 | 🐛 43 | 🌐 Go | 📅 2026-08-19 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,232 | 🐛 423 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,262 | 🐛 34 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,360 | 🐛 17 | 🌐 C | 📅 2026-08-18 - Cross-platform Audio Visualizer.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,385 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Terminal image, video, directory, and Markdown viewer.
...
* [termv](https://github.com/Roshan-R/termv) ⭐ 298 | 🐛 7 | 🌐 Shell | 📅 2026-05-27 - A terminal IPTV player written in bash.
...
* [dashbrew](https://github.com/rasjonell/dashbrew) ⭐ 268 | 🐛 1 | 🌐 Go | 📅 2026-05-15 - TUI dashboard builder that lets you visualize data from scripts and APIs.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,678 | 🐛 168 | 🌐 Go | 📅 2026-08-12 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,703 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,873 | 🐛 439 | 🌐 Go | 📅 2026-08-17 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [jdvrif](https://github.com/CleasbyCode/jdvrif) ⭐ 69 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 - CLI tool to embed or extract files via a JPG image. Post and share your embedded JPG image on compatible sites.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,026 | 🐛 44 | 🌐 Rust | 📅 2026-04-15 - A fast, simple, recursive content discovery tool written in Rust.
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,070 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [vet](https://github.com/safedep/vet) ⭐ 1,100 | 🐛 96 | 🌐 Go | 📅 2026-08-16 - Tool for identifying risks in open source software supply chain.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,230 | 🐛 564 | 🌐 Python | 📅 2026-08-20 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,682 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [gentoo-install](https://github.com/oddlama/gentoo-install) ⭐ 784 | 🐛 24 | 🌐 Shell | 📅 2026-08-08 - This project aspires to be your favorite way to install gentoo. It aims to provide a smooth installation experience, both for beginners and experts. You may configure it by using a menuconfig-inspired interface or simply via a config file.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,158 | 🐛 11 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,033 | 🐛 11 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,586 | 🐛 35 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
...
* [typtea](https://github.com/ashish0kumar/typtea) ⭐ 240 | 🐛 2 | 🌐 Go | 📅 2026-02-20 - Minimal terminal-based typing speed tester with support for dozens of programming languages.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,156 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - Play chess from your terminal.
...
* [Solitaire TUI](https://github.com/brianstrauch/solitaire-tui) ⭐ 365 | 🐛 4 | 🌐 Go | 📅 2023-09-20 - Klondike solitaire for the terminal.
* [tty-solitaire](https://github.com/mpereira/tty-solitaire) ⭐ 358 | 🐛 24 | 🌐 C | 📅 2025-05-03 - Solitaire game for the terminal ncurses based.
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 301 | 🐛 13 | 🌐 Python | 📅 2026-08-20 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,142 | 🐛 257 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,472 | 🐛 183 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,203 | 🐛 0 | 🌐 Shell | 📅 2026-08-19 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,192 | 🐛 15 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,255 | 🐛 74 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
