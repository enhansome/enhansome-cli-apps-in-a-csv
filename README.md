...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,919 | 🐛 137 | 🌐 Rust | 📅 2026-08-24 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,453 | 🐛 185 | 🌐 C | 📅 2026-08-26 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,820 | 🐛 298 | 🌐 Rust | 📅 2026-08-25 - Syntax-aware structured diff tool.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,627 | 🐛 182 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,656 | 🐛 45 | 🌐 Rust | 📅 2026-08-27 - A CLI tool for code structural search, lint and rewriting.
...
* [gdu](https://github.com/dundee/gdu) ⭐ 5,934 | 🐛 56 | 🌐 Go | 📅 2026-08-26 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,257 | 🐛 532 | 🌐 C++ | 📅 2026-08-26 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,119 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,922 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,720 | 🐛 69 | 🌐 Rust | 📅 2026-08-26 - Blazing fast terminal file manager written in Rust, based on async I/O.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,747 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 176,558 | 🐛 900 | 🌐 Python | 📅 2026-08-19 - Python tool for converting files and office documents to Markdown.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,714 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,253 | 🐛 372 | 🌐 Python | 📅 2026-06-23.
...
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,727 | 🐛 23 | 🌐 Rust | 📅 2026-08-19 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,280 | 🐛 706 | 🌐 Go | 📅 2026-08-27 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,368 | 🐛 40 | 🌐 Python | 📅 2026-08-26 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,970 | 🐛 3 | 🌐 Python | 📅 2026-08-27 - A command line client for MySQL that can do autocompletion and syntax highlighting.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,295 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
...
* [sq](https://github.com/neilotoole/sq) ⭐ 2,556 | 🐛 69 | 🌐 Go | 📅 2026-08-26 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,670 | 🐛 326 | 🌐 Go | 📅 2026-08-26 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,076 | 🐛 222 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,100 | 🐛 676 | 🌐 Rust | 📅 2026-08-26 - Create book from Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,445 | 🐛 991 | 🌐 Go | 📅 2026-08-27 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 698 | 🐛 1 | 🌐 Go | 📅 2026-08-25 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,971 | 🐛 465 | 🌐 Go | 📅 2026-08-26 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,438 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
...
* [BFG Repo-Cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,175 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
...
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,016 | 🐛 176 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,203 | 🐛 78 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,217 | 🐛 1,214 | 🌐 Rust | 📅 2026-08-27 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,079 | 🐛 137 | 🌐 TypeScript | 📅 2026-08-26 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,722 | 🐛 675 | 🌐 Go | 📅 2026-08-27 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
...
* [air](https://github.com/air-verse/air) ⭐ 23,925 | 🐛 6 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,469 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
...
* [release-it](https://github.com/release-it/release-it) ⭐ 9,036 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,665 | 🐛 25 | 🌐 Go | 📅 2026-08-27 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,105 | 🐛 443 | 🌐 Rust | 📅 2026-08-27 - Developer environments you can take with you.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 891 | 🐛 166 | 🌐 Rust | 📅 2026-08-27 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,391 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,290 | 🐛 11 | 🌐 Python | 📅 2024-07-09 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,208 | 🐛 17 | 🌐 Go | 📅 2026-08-24 - TUI for Podman environment.
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,325 | 🐛 83 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,162 | 🐛 6 | 🌐 Rust | 📅 2026-08-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,526 | 🐛 1,825 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,322 | 🐛 236 | 🌐 Zig | 📅 2026-08-27 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,581 | 🐛 1,825 | 🌐 Rust | 📅 2026-08-27 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,144 | 🐛 1,871 | 🌐 Rust | 📅 2026-08-26 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,353 | 🐛 1,437 | 🌐 Rust | 📅 2026-08-26 - A modern shell written in Rust, where all data is structured.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,981 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,869 | 🐛 457 | 🌐 C | 📅 2026-08-20 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,837 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [bin](https://github.com/marcosnils/bin) ⭐ 1,270 | 🐛 92 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,907 | 🐛 147 | 🌐 Go | 📅 2026-08-21 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,351 | 🐛 117 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,266 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,924 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,444 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,540 | 🐛 78 | 🌐 Rust | 📅 2026-08-27 - A network diagnostic tool.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,568 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - TUI for sniffing network traffic using eBPF on Linux.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,973 | 🐛 16 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 187,259 | 🐛 2,596 | 🌐 Python | 📅 2026-08-26 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,040 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,839 | 🐛 1,174 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,115 | 🐛 4 | 🌐 Go | 📅 2026-08-26 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,655 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,647 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,920 | 🐛 163 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,042 | 🐛 261 | 🌐 Python | 📅 2026-08-24 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,864 | 🐛 222 | 🌐 Python | 📅 2026-08-20.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,709 | 🐛 863 | 🌐 TypeScript | 📅 2026-08-27 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,539 | 🐛 68 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,398 | 🐛 98 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,793 | 🐛 75 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,742 | 🐛 455 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,483 | 🐛 113 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
...
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,226 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,178 | 🐛 57 | 🌐 C | 📅 2026-08-21 - Terminal graphics for the 21 st century.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 579 | 🐛 25 | 🌐 Rust | 📅 2026-08-09 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [cue](https://github.com/ravachol/cue) ⭐ 2,991 | 🐛 2 | 🌐 C | 📅 2026-08-27 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,991 | 🐛 2 | 🌐 C | 📅 2026-08-27 - A command-line music player with gapless playback and simple playlist management.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,275 | 🐛 423 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,264 | 🐛 34 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,370 | 🐛 17 | 🌐 C | 📅 2026-08-18 - Cross-platform Audio Visualizer.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,747 | 🐛 170 | 🌐 Go | 📅 2026-08-24 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,740 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,036 | 🐛 44 | 🌐 Rust | 📅 2026-04-15 - A fast, simple, recursive content discovery tool written in Rust.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,458 | 🐛 96 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,255 | 🐛 574 | 🌐 Python | 📅 2026-08-24 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,160 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - Play chess from your terminal.
...
[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,251 | 🐛 0 | 🌐 Shell | 📅 2026-08-22 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,350 | 🐛 93 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
