...
* [eza](https://github.com/eza-community/eza) ⭐ 23,261 | 🐛 450 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,217 | 🐛 207 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,263 | 🐛 31 | 🌐 Rust | 📅 2026-09-14 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,453 | 🐛 146 | 🌐 Rust | 📅 2026-09-08 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,045 | 🐛 109 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
* [autojump](https://github.com/wting/autojump) ⭐ 16,960 | 🐛 231 | 🌐 Python | 📅 2025-02-27 - A cd command that maintains a database of most visited paths and allows the access to a directory with shortened versions of the path.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,400 | 🐛 205 | 🌐 Rust | 📅 2026-09-09 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [rip](https://github.com/nivekuil/rip) ⭐ 1,734 | 🐛 26 | 🌐 Rust | 📅 2024-04-08 - Move and restore items from the graveyard (by default, `/tmp/graveyard-$USER` if $XDG\_DATA\_HOME is not set and `$XDG_DATA_HOME/graveyard` otherwise)
...
* [gomi](https://github.com/babarot/gomi) ⭐ 572 | 🐛 2 | 🌐 Go | 📅 2026-06-07 - UNIX rm command with a safety net.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,458 | 🐛 186 | 🌐 C | 📅 2026-09-11 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,176 | 🐛 441 | 🌐 Rust | 📅 2026-09-13 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,892 | 🐛 292 | 🌐 Rust | 📅 2026-09-13 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,883 | 🐛 70 | 🌐 Go | 📅 2026-09-11 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,233 | 🐛 195 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,120 | 🐛 563 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,886 | 🐛 54 | 🌐 Rust | 📅 2026-09-13 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,842 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,290 | 🐛 11 | 🌐 C++ | 📅 2026-09-14 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,257 | 🐛 8 | 🌐 Rust | 📅 2026-09-09 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,257 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,974 | 🐛 56 | 🌐 Go | 📅 2026-09-10 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [erdtree](https://github.com/solidiquis/erdtree) ⭐ 2,598 | 🐛 36 | 🌐 Rust | 📅 2024-05-19 - A multithreaded file-tree visualizer and disk usage analyzer.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,567 | 🐛 538 | 🌐 C++ | 📅 2026-09-09 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,115 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,930 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,000 | 🐛 143 | 🌐 C | 📅 2026-09-07 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,147 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,168 | 🐛 36 | 🌐 Rust | 📅 2026-09-09 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,088 | 🐛 43 | 🌐 Python | 📅 2026-08-27 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,052 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
* [below](https://github.com/facebookincubator/below) ⭐ 2,517 | 🐛 32 | 🌐 Rust | 📅 2026-09-14 - A time traveling resource monitor for modern Linux systems
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,420 | 🐛 117 | 🌐 C | 📅 2026-09-12 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,171 | 🐛 65 | 🌐 Rust | 📅 2026-09-12 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,230 | 🐛 269 | 🌐 Go | 📅 2026-09-11 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,881 | 🐛 7 | 🌐 C | 📅 2026-09-09 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,510 | 🐛 86 | 🌐 Go | 📅 2026-09-14 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,729 | 🐛 102 | 🌐 Rust | 📅 2026-08-20 - ranger-like terminal file manager
...
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,723 | 🐛 27 | 🌐 C | 📅 2026-09-12 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 13 | 🌐 Rust | 📅 2026-09-14 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,753 | 🐛 89 | 🌐 Rust | 📅 2026-09-13 - Painless compression and decompression in the terminal.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,446 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 183,688 | 🐛 649 | 🌐 Python | 📅 2026-09-12 - Python tool for converting files and office documents to Markdown.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,468 | 🐛 538 | 🌐 Rust | 📅 2026-09-13 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [lolcat](https://github.com/busyloop/lolcat) ⭐ 6,576 | 🐛 33 | 🌐 Ruby | 📅 2024-03-05 - Ruby Gem to colorize the output of the cat command.
* [toolong](https://github.com/Textualize/toolong) ⭐ 3,946 | 🐛 37 | 🌐 Python | 📅 2024-08-05 - A terminal application to view, tail, merge, and search log files (plus JSONL).
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,721 | 🐛 47 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,362 | 🐛 374 | 🌐 Python | 📅 2026-06-23.
...
* [choose](https://github.com/theryangeary/choose) ⭐ 2,275 | 🐛 5 | 🌐 Rust | 📅 2026-06-11 - A human-friendly and fast alternative to cut and (sometimes) awk.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,798 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,744 | 🐛 50 | 🌐 Python | 📅 2026-09-14 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,030 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,624 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,675 | 🐛 41 | 🌐 Python | 📅 2026-09-10 - Serializes the output of command line tools to JSON.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 19 | 🌐 Go | 📅 2026-09-13 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,753 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,839 | 🐛 24 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,484 | 🐛 22 | 🌐 Python | 📅 2026-09-09 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,433 | 🐛 606 | 🌐 Go | 📅 2026-09-12 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,384 | 🐛 41 | 🌐 Python | 📅 2026-09-09 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,976 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,112 | 🐛 119 | 🌐 Go | 📅 2026-09-13 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,018 | 🐛 72 | 🌐 Go | 📅 2026-09-09 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,398 | 🐛 44 | 🌐 Python | 📅 2026-09-11 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,328 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,298 | 🐛 40 | 🌐 Go | 📅 2026-09-13 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,964 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,786 | 🐛 29 | 🌐 Rust | 📅 2026-09-14 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,786 | 🐛 29 | 🌐 Rust | 📅 2026-09-14 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,298 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,231 | 🐛 12 | 🌐 Go | 📅 2026-09-09 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,100 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,564 | 🐛 77 | 🌐 Go | 📅 2026-09-12 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,195 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,972 | 🐛 328 | 🌐 Go | 📅 2026-09-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,953 | 🐛 5 | 🌐 Rust | 📅 2026-09-08 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,264 | 🐛 78 | 🌐 Rust | 📅 2026-09-11 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,296 | 🐛 232 | 🌐 Go | 📅 2026-09-07 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,140 | 🐛 663 | 🌐 Rust | 📅 2026-09-08 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,825 | 🐛 125 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,576 | 🐛 931 | 🌐 Go | 📅 2026-09-14 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,572 | 🐛 178 | 🌐 Rust | 📅 2026-09-11 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [aretext](https://github.com/aretext/aretext) ⭐ 286 | 🐛 4 | 🌐 Go | 📅 2026-09-13 - Minimalist text editor with vim-compatible key bindings.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,314 | 🐛 1,032 | 🌐 Go | 📅 2026-09-13 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,293 | 🐛 474 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,482 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,102 | 🐛 97 | 🌐 Shell | 📅 2026-09-01 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,334 | 🐛 234 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,509 | 🐛 101 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,231 | 🐛 114 | 🌐 Rust | 📅 2026-09-13 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,050 | 🐛 66 | 🌐 Rust | 📅 2026-09-14 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,027 | 🐛 173 | 🌐 Go | 📅 2026-09-13 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,217 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 7,004 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - A simple and efficient way to access various statistics in a git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,077 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 - A utility tool powered by fzf for using git interactively.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,556 | 🐛 1,240 | 🌐 Rust | 📅 2026-09-13 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,142 | 🐛 17 | 🌐 Rust | 📅 2026-09-13 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,330 | 🐛 139 | 🌐 TypeScript | 📅 2026-09-13 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,064 | 🐛 730 | 🌐 Go | 📅 2026-09-14 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,035 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-14 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,976 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,528 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,909 | 🐛 243 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,354 | 🐛 489 | 🌐 Go | 📅 2026-09-13 - Instant, easy, and predictable development environments.
...
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,844 | 🐛 18 | 🌐 Python | 📅 2026-09-12 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,054 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,744 | 🐛 26 | 🌐 Go | 📅 2026-09-14 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [blinkenlights](https://github.com/jart/blink) ⭐ 7,581 | 🐛 55 | 🌐 C | 📅 2025-12-10 - TUI that may be used for debugging x86\_64-linux or i8086 programs across platforms.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,430 | 🐛 38 | 🌐 Rust | 📅 2026-09-13 - A TUI for analyzing Linux binaries.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,656 | 🐛 18 | 🌐 Python | 📅 2026-08-27 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [cgdb](https://github.com/cgdb/cgdb) ⭐ 1,843 | 🐛 46 | 🌐 C | 📅 2026-02-27 - Console front-end to the GNU debugger.
...
* [gup](https://github.com/nao1215/gup) ⭐ 601 | 🐛 2 | 🌐 Go | 📅 2026-09-14 - Update binaries installed by "go install" with goroutines.
* [DevTUI](https://github.com/skatkov/devtui) ⭐ 554 | 🐛 42 | 🌐 Go | 📅 2026-09-07 - All-in-one terminal toolkit that consolidates everyday developer utilities into a unified TUI and CLI.
...
* [Scrut](https://github.com/facebookincubator/scrut) ⭐ 82 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - A testing toolkit for CLI applications designed to rigorously test terminal programs, inspired by Cram and focuses on providing a straightforward way to validate CLI behaviour.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,089 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,576 | 🐛 77 | 🌐 Go | 📅 2026-09-13 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,354 | 🐛 489 | 🌐 Go | 📅 2026-09-13 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,857 | 🐛 42 | 🌐 Go | 📅 2026-08-19 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,534 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,639 | 🐛 26 | 🌐 Go | 📅 2026-08-31 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,515 | 🐛 143 | 🌐 Go | 📅 2026-09-09 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,192 | 🐛 86 | 🌐 C | 📅 2026-08-30 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,192 | 🐛 86 | 🌐 C | 📅 2026-08-30 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,404 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,226 | 🐛 9 | 🌐 Go | 📅 2026-09-11 - TUI for Podman environment.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 12 | 🌐 Rust | 📅 2026-09-12 - A TUI tool designed for monitoring Kubernetes resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,508 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,477 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,410 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,919 | 🐛 9 | 🌐 Go | 📅 2026-09-14 - Domain Availability Research Tool.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,316 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,944 | 🐛 1,867 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,787 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,321 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,697 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,756 | 🐛 77 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,289 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,054 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,067 | 🐛 252 | 🌐 Zig | 📅 2026-09-14 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,882 | 🐛 1,851 | 🌐 Rust | 📅 2026-09-12 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,407 | 🐛 1,917 | 🌐 Rust | 📅 2026-09-09 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,363 | 🐛 20 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,363 | 🐛 20 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,500 | 🐛 1,442 | 🌐 Rust | 📅 2026-09-13 - A modern shell written in Rust, where all data is structured.
...
* [Oils](https://github.com/oilshell/oil) ⭐ 3,392 | 🐛 609 | 🌐 Python | 📅 2026-09-12 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 282 | 🐛 65 | 🌐 C | 📅 2026-09-14 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-13 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,094 | 🐛 150 | 🌐 Shell | 📅 2026-09-06 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,819 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,418 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,675 | 🐛 29 | 🌐 Shell | 📅 2026-09-13 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,040 | 🐛 46 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,854 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,620 | 🐛 90 | 🌐 C | 📅 2026-09-13 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,620 | 🐛 90 | 🌐 C | 📅 2026-09-13 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,925 | 🐛 449 | 🌐 C | 📅 2026-09-13 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,082 | 🐛 107 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,704 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,101 | 🐛 12 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,879 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,518 | 🐛 211 | 🌐 Rust | 📅 2026-09-14 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,072 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,289 | 🐛 87 | 🌐 Go | 📅 2026-09-12 - Manages binary files downloaded from different sources.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,816 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,838 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,170 | 🐛 70 | 🌐 Shell | 📅 2026-08-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,972 | 🐛 151 | 🌐 Go | 📅 2026-09-10 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,388 | 🐛 115 | 🌐 C | 📅 2026-09-06 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,331 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,681 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,771 | 🐛 25 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,718 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [dotbins](https://github.com/basnijholt/dotbins) ⭐ 270 | 🐛 28 | 🌐 Python | 📅 2026-09-10 - Keep updated binaries in your dotfiles.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,894 | 🐛 3 | 🌐 Rust | 📅 2026-09-14 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,236 | 🐛 10 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,236 | 🐛 10 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,329 | 🐛 220 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 890 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - Terminal mail client.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,192 | 🐛 1,186 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,909 | 🐛 112 | 🌐 Java | 📅 2026-09-10 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,136 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,948 | 🐛 16 | 🌐 C++ | 📅 2026-09-12 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,720 | 🐛 78 | 🌐 Go | 📅 2026-09-13 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,375 | 🐛 102 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,011 | 🐛 15 | 🌐 Rust | 📅 2026-09-07 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 988 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 755 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 71 | 🐛 30 | 🌐 Rust | 📅 2026-09-12 - TUI client for Nostr.
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,559 | 🐛 211 | 🌐 Python | 📅 2026-09-13 - Transparent proxy server that works as a poor man's VPN. Forwards over ssh. Doesn't require admin. Works with Linux and macOS. Supports DNS tunneling.
* [gping](https://github.com/orf/gping) ⭐ 12,678 | 🐛 39 | 🌐 Rust | 📅 2026-09-10 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,363 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* [oha](https://github.com/hatoo/oha) ⭐ 10,544 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,919 | 🐛 85 | 🌐 Rust | 📅 2026-09-14 - A network diagnostic tool.
...
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,068 | 🐛 32 | 🌐 C | 📅 2026-09-08 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,020 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,724 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,845 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,560 | 🐛 4 | 🌐 Rust | 📅 2026-09-13 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 726 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 539 | 🐛 1 | 🌐 Go | 📅 2026-09-12 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,004 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,850 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
...
* [goto](https://github.com/grafviktor/goto) ⭐ 533 | 🐛 11 | 🌐 Go | 📅 2026-09-13 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 190,968 | 🐛 2,650 | 🌐 Python | 📅 2026-08-30 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,218 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,240 | 🐛 1,177 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,320 | 🐛 2 | 🌐 Go | 📅 2026-09-13 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,674 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,927 | 🐛 182 | 🌐 Python | 📅 2026-09-13 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,635 | 🐛 1,135 | 🌐 Python | 📅 2026-09-12 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,070 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,063 | 🐛 189 | 🌐 Go | 📅 2026-09-09 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,531 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,860 | 🐛 383 | 🌐 C++ | 📅 2026-09-13 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,230 | 🐛 10 | 🌐 Python | 📅 2026-09-08 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,494 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,552 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 814 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [t](https://github.com/sjl/t) ⭐ 809 | 🐛 11 | 🌐 Python | 📅 2023-10-27 - A command-line todo list manager for people that want to finish tasks, not organize them.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,656 | 🐛 125 | 🌐 C++ | 📅 2026-09-09 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,315 | 🐛 152 | 🌐 Python | 📅 2026-09-10 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,796 | 🐛 24 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,047 | 🐛 264 | 🌐 Python | 📅 2026-09-07 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,872 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,354 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,872 | 🐛 225 | 🌐 Python | 📅 2026-09-04 - CalDAV synchronization program.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,230 | 🐛 32 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,904 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 326 | 🐛 9 | 🌐 Rust | 📅 2026-09-10 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,969 | 🐛 830 | 🌐 TypeScript | 📅 2026-09-14 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,913 | 🐛 70 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,445 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,082 | 🐛 107 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,834 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,413 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [navi](https://github.com/denisidoro/navi) ⭐ 17,542 | 🐛 112 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
...
* [Nap](https://github.com/maaslalani/nap) ⭐ 2,217 | 🐛 17 | 🌐 Go | 📅 2024-05-18 - Code snippet manager that allows creating and access new snippets quickly with the command-line interface or browse, manage, and organize them with the text-user interface.
* [eg](https://github.com/srsudar/eg) ⭐ 2,040 | 🐛 15 | 🌐 Python | 📅 2025-02-06 - Useful examples at the command line.
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,953 | 🐛 91 | 🌐 Go | 📅 2026-09-14 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 135 | 🐛 1 | 🌐 Rust | 📅 2026-09-13 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,410 | 🐛 528 | 🌐 Go | 📅 2026-09-13 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,669 | 🐛 269 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,490 | 🐛 40 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,239 | 🐛 54 | 🌐 C | 📅 2026-09-06 - Terminal graphics for the 21 st century.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,816 | 🐛 5 | 🌐 Python | 📅 2026-09-12 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 1,000 | 🐛 16 | 🌐 Python | 📅 2026-09-14 - AI-Powered Command-Line Photo Search Tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,752 | 🐛 70 | 🌐 Python | 📅 2026-09-13 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,500 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,655 | 🐛 11 | 🌐 Shell | 📅 2026-08-30 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,349 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,654 | 🐛 710 | 🌐 Python | 📅 2026-09-13 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,207 | 🐛 154 | 🌐 Rust | 📅 2026-09-12 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,771 | 🐛 211 | 🌐 Rust | 📅 2026-09-12 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 590 | 🐛 28 | 🌐 Rust | 📅 2026-09-13 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-13 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [spytorec](https://github.com/Danidukiyu/SpytoRec) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Real-time Spotify recorder with automatic track splitting, metadata tagging, and high-quality FLAC/OGG output.
...
* [cue](https://github.com/ravachol/cue) ⭐ 3,064 | 🐛 1 | 🌐 C | 📅 2026-09-13 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,064 | 🐛 1 | 🌐 C | 📅 2026-09-13 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,204 | 🐛 52 | 🌐 Rust | 📅 2026-09-13 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,243 | 🐛 9 | 🌐 Python | 📅 2026-09-13 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,442 | 🐛 519 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,270 | 🐛 35 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,415 | 🐛 18 | 🌐 C | 📅 2026-08-18 - Cross-platform Audio Visualizer.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,754 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,017 | 🐛 29 | 🌐 Go | 📅 2026-09-12 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,560 | 🐛 15 | 🌐 Go | 📅 2026-08-30 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,409 | 🐛 11 | 🌐 Rust | 📅 2026-09-05 - Terminal image, video, directory, and Markdown viewer.
* [youtube-viewer](https://github.com/trizen/youtube-viewer) ⭐ 1,315 | 🐛 45 | 🌐 Perl | 📅 2026-06-15 - Lightweight application that searches and streams videos from YouTube.
...
* [viu](https://github.com/learn-anything/command-line-tools) ⭐ 496 | 🐛 18 | 📅 2026-08-16 - Command-line application to view images from the terminal written in Rust.
* [GopherTube](https://github.com/krishnassh/gophertube) ⭐ 431 | 🐛 2 | 🌐 Go | 📅 2026-09-05 - A terminal-based YouTube client that scrapes YouTube search results and uses mpv for video playback.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,975 | 🐛 14 | 🌐 Rust | 📅 2026-09-14 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,886 | 🐛 175 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,797 | 🐛 10 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,106 | 🐛 446 | 🌐 Go | 📅 2026-09-07 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,816 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,077 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,762 | 🐛 14 | 🌐 Rust | 📅 2026-09-07 - Manage your GnuPG keys with ease!
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,192 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,476 | 🐛 102 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
* [passage](https://github.com/FiloSottile/passage) ⭐ 1,187 | 🐛 34 | 🌐 Shell | 📅 2024-08-30 - A fork of [password-store](https://www.passwordstore.org) that uses [age](https://age-encryption.org) as a backend instead of GnuPG.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,315 | 🐛 614 | 🌐 Python | 📅 2026-09-13 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,306 | 🐛 14 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,046 | 🐛 11 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,175 | 🐛 35 | 🌐 Rust | 📅 2026-09-10 - Play chess from your terminal.
...
* [gambit](https://github.com/maaslalani/gambit) ⭐ 905 | 🐛 10 | 🌐 Go | 📅 2024-01-25 - Chess board in your terminal.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,378 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,613 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,386 | 🐛 1 | 🌐 Shell | 📅 2026-09-13 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,583 | 🐛 49 | 📅 2026-09-13 - An awesome list dedicated to TUI programs.
