...
* [eza](https://github.com/eza-community/eza) ⭐ 23,338 | 🐛 454 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,236 | 🐛 210 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,269 | 🐛 31 | 🌐 Rust | 📅 2026-09-21 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,646 | 🐛 146 | 🌐 Rust | 📅 2026-09-21 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,510 | 🐛 199 | 🌐 Rust | 📅 2026-09-20 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,272 | 🐛 14 | 🌐 C | 📅 2026-09-21 - A breadth-first version of the UNIX find command.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,294 | 🐛 446 | 🌐 Rust | 📅 2026-09-19 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,919 | 🐛 289 | 🌐 Rust | 📅 2026-09-18 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,883 | 🐛 71 | 🌐 Go | 📅 2026-09-21 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,495 | 🐛 200 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,992 | 🐛 69 | 🌐 Rust | 📅 2026-09-21 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,854 | 🐛 71 | 🌐 Rust | 📅 2026-09-17 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,359 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 536 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,285 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,289 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,997 | 🐛 52 | 🌐 Go | 📅 2026-09-21 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,019 | 🐛 134 | 🌐 C | 📅 2026-09-20 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,519 | 🐛 32 | 🌐 Rust | 📅 2026-09-21 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,709 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,344 | 🐛 61 | 🌐 Rust | 📅 2026-09-21 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,335 | 🐛 269 | 🌐 Go | 📅 2026-09-18 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,989 | 🐛 1 | 🌐 C | 📅 2026-09-21 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
...
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,730 | 🐛 102 | 🌐 Rust | 📅 2026-09-17 - Ranger-like terminal file manager written in Go with fuzzy search, tabs bulk rename, file preview, exit to current directory, themes and trash support.
* [walk](https://github.com/antonmedv/walk) ⭐ 3,640 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,217 | 🐛 481 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
...
* [felix](https://github.com/kyoheiu/felix) ⭐ 920 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager with vim-like key mapping
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,764 | 🐛 96 | 🌐 Rust | 📅 2026-09-21 - Painless compression and decompression in the terminal.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,758 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,451 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,673 | 🐛 61 | 🌐 C | 📅 2026-09-16 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 186,254 | 🐛 695 | 🌐 Python | 📅 2026-09-21 - Python tool for converting files and office documents to Markdown.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,521 | 🐛 541 | 🌐 Rust | 📅 2026-09-20 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,724 | 🐛 47 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,412 | 🐛 378 | 🌐 Python | 📅 2026-06-23.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,744 | 🐛 49 | 🌐 Python | 📅 2026-09-21 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,635 | 🐛 33 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,990 | 🐛 303 | 🌐 Go | 📅 2026-09-17 - Portable command-line YAML processor.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,682 | 🐛 28 | 🌐 Python | 📅 2026-09-19 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,183 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
...
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,769 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [jtbl](https://github.com/kellyjonbrazil/jtbl) ⭐ 345 | 🐛 2 | 🌐 Python | 📅 2024-04-02 - A simple CLI tool to print JSON and JSON Lines data as a table in the terminal.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,493 | 🐛 587 | 🌐 Go | 📅 2026-09-22 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
...
* [usql](https://github.com/xo/usql) ⭐ 10,118 | 🐛 121 | 🌐 Go | 📅 2026-09-21 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,408 | 🐛 32 | 🌐 Python | 📅 2026-09-21 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,344 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,319 | 🐛 42 | 🌐 Go | 📅 2026-09-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,977 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,792 | 🐛 33 | 🌐 Rust | 📅 2026-09-21 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,792 | 🐛 33 | 🌐 Rust | 📅 2026-09-21 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,234 | 🐛 12 | 🌐 Go | 📅 2026-09-09 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,171 | 🐛 119 | 🌐 Python | 📅 2026-09-02 - Python CLI utility and library for manipulating SQLite databases.
...
* [zsv](https://github.com/liquidaty/zsv) ⭐ 397 | 🐛 24 | 🌐 C | 📅 2026-09-21 - The world's fastest (simd) CSV parser, with an extensible, multi-purpose CLI.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,182 | 🐛 330 | 🌐 Go | 📅 2026-09-21 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,417 | 🐛 236 | 🌐 Go | 📅 2026-09-14 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,160 | 🐛 657 | 🌐 Rust | 📅 2026-09-18 - Create book from Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,615 | 🐛 912 | 🌐 Go | 📅 2026-09-22 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,599 | 🐛 166 | 🌐 Rust | 📅 2026-09-21 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 703 | 🐛 0 | 🌐 Go | 📅 2026-09-21 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,560 | 🐛 1,051 | 🌐 Go | 📅 2026-09-21 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,419 | 🐛 481 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,511 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,108 | 🐛 93 | 🌐 Shell | 📅 2026-09-21 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,344 | 🐛 231 | 🌐 C | 📅 2026-09-19 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,544 | 🐛 101 | 🌐 Go | 📅 2026-09-21 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,257 | 🐛 114 | 🌐 Rust | 📅 2026-09-18 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,049 | 🐛 62 | 🌐 Rust | 📅 2026-09-20 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,043 | 🐛 150 | 🌐 Go | 📅 2026-09-20 - Distributed, offline-first bug tracker embedded in git, with bridges.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,082 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - A utility tool powered by fzf for using git interactively.
...
* [ggc](https://github.com/bmf-san/ggc) ⭐ 284 | 🐛 0 | 🌐 Go | 📅 2026-09-22 - A modern Git CLI tool with both traditional command-line and interactive incremental-search UI.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,691 | 🐛 1,258 | 🌐 Rust | 📅 2026-09-22 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,143 | 🐛 15 | 🌐 Rust | 📅 2026-09-22 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,449 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-21 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,239 | 🐛 775 | 🌐 Go | 📅 2026-09-22 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,057 | 🐛 402 | 🌐 JavaScript | 📅 2026-09-21 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 24,005 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
...
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,934 | 🐛 245 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,768 | 🐛 26 | 🌐 Go | 📅 2026-09-21 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,434 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,139 | 🐛 439 | 🌐 Rust | 📅 2026-09-21 - Developer environments you can take with you.
...
* [scons](https://github.com/SCons/scons) ⭐ 2,421 | 🐛 654 | 🌐 Python | 📅 2026-09-16 - Software construction tool.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 902 | 🐛 163 | 🌐 Rust | 📅 2026-09-22 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 603 | 🐛 0 | 🌐 Go | 📅 2026-09-22 - Update binaries installed by "go install" with goroutines.
* [DevTUI](https://github.com/skatkov/devtui) ⭐ 555 | 🐛 41 | 🌐 Go | 📅 2026-09-21 - All-in-one terminal toolkit that consolidates everyday developer utilities into a unified TUI and CLI.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 140 | 🐛 13 | 🌐 Python | 📅 2026-09-21 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,100 | 🐛 316 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,640 | 🐛 82 | 🌐 Go | 📅 2026-09-21 - Kubernetes CLI To Manage Your Clusters In Style!
...
* [stern](https://github.com/stern/stern) ⭐ 4,870 | 🐛 39 | 🌐 Go | 📅 2026-09-14 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,539 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A simple and fast terminal dashboard for Kubernetes.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,559 | 🐛 336 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,433 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,924 | 🐛 72 | 🌐 Rust | 📅 2026-09-21 - Fast, async, resource-friendly link checker written in Rust.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,400 | 🐛 3 | 🌐 Rust | 📅 2026-09-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,107 | 🐛 1,883 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,944 | 🐛 171 | 🌐 Rust | 📅 2026-09-22 - Handy way to save and run project-specific commands.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,416 | 🐛 249 | 🌐 Zig | 📅 2026-09-22 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,976 | 🐛 1,873 | 🌐 Rust | 📅 2026-09-21 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,500 | 🐛 1,936 | 🌐 Rust | 📅 2026-09-18 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,547 | 🐛 1,435 | 🌐 Rust | 📅 2026-09-22 - A modern shell written in Rust, where all data is structured.
...
* [Oils](https://github.com/oilshell/oil) ⭐ 3,393 | 🐛 610 | 🌐 Python | 📅 2026-09-17 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 281 | 🐛 61 | 🌐 C | 📅 2026-09-21 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-21 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,136 | 🐛 152 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,890 | 🐛 100 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,721 | 🐛 90 | 🌐 C | 📅 2026-09-21 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,721 | 🐛 90 | 🌐 C | 📅 2026-09-21 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,714 | 🐛 38 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [kmon](https://github.com/orhun/kmon) ⭐ 2,950 | 🐛 23 | 🌐 Rust | 📅 2026-09-21 - Linux TUI Kernel manager and activity monitor.
* [CoreFreq](https://github.com/cyring/CoreFreq) ⭐ 2,243 | 🐛 1 | 🌐 C | 📅 2026-08-16 - CPU monitoring TUI software designed for the 64-bits Processors.
...
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,974 | 🐛 12 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,891 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,574 | 🐛 205 | 🌐 Rust | 📅 2026-09-21 - Upgrade all the things.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,591 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,894 | 🐛 301 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,840 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,228 | 🐛 74 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,994 | 🐛 154 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,852 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,406 | 🐛 115 | 🌐 C | 📅 2026-09-17 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,341 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,789 | 🐛 28 | 🌐 Go | 📅 2026-09-21 - TUI for running apps and processes.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,296 | 🐛 19 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,296 | 🐛 19 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,362 | 🐛 223 | 🌐 TypeScript | 📅 2026-09-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,205 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,781 | 🐛 53 | 🌐 Go | 📅 2026-09-22 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,928 | 🐛 108 | 🌐 Java | 📅 2026-09-20 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,149 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,967 | 🐛 19 | 🌐 C++ | 📅 2026-09-20 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,725 | 🐛 80 | 🌐 Go | 📅 2026-09-20 - A terminal based Matrix client written in Go.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 993 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,567 | 🐛 210 | 🌐 Python | 📅 2026-09-22 - Transparent proxy server that works as a poor man's VPN. Forwards over ssh. Doesn't require admin. Works with Linux and macOS. Supports DNS tunneling.
* [gping](https://github.com/orf/gping) ⭐ 12,687 | 🐛 41 | 🌐 Rust | 📅 2026-09-18 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,404 | 🐛 116 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,981 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,505 | 🐛 16 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
...
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,669 | 🐛 26 | 🌐 Rust | 📅 2026-09-21 - Fast, collaborative live terminal sharing over the web.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,117 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,096 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,116 | 🐛 47 | 🌐 C | 📅 2026-09-19 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,042 | 🐛 29 | 🌐 Rust | 📅 2026-09-21 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [gg](https://github.com/mzz2017/gg) ⭐ 1,935 | 🐛 48 | 🌐 Go | 📅 2026-07-06 - A command-line tool for one-click proxy in your research and development without installing v2ray or anything else.
...
* [neoss](https://github.com/PabloLec/neoss) ⭐ 231 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-21 - User-friendly and detailed socket statistics with a Terminal UI.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,010 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,857 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi networks and connections on Linux.
...
* [goto](https://github.com/grafviktor/goto) ⭐ 533 | 🐛 11 | 🌐 Go | 📅 2026-09-21 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,694 | 🐛 2,662 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,313 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,603 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,406 | 🐛 2 | 🌐 Go | 📅 2026-09-20 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,696 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,941 | 🐛 182 | 🌐 Python | 📅 2026-09-22 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,797 | 🐛 1,135 | 🌐 Python | 📅 2026-09-19 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,088 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,085 | 🐛 202 | 🌐 Go | 📅 2026-09-21 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,097 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,864 | 🐛 391 | 🌐 C++ | 📅 2026-09-21 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,980 | 🐛 174 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
...
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,844 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,956 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,662 | 🐛 127 | 🌐 C++ | 📅 2026-09-19 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - Simple timer for the terminal with timer-mode and alarm.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,809 | 🐛 24 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [Toney](https://github.com/SourcewareLab/Toney) ⭐ 208 | 🐛 5 | 🌐 Go | 📅 2026-05-27 - A fast, lightweight, terminal-based note-taking TUI app built with Bubbletea; Offers markdown rendering, file navigation and native Neovim editing.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,205 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,051 | 🐛 265 | 🌐 Python | 📅 2026-09-21 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,878 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,128 | 🐛 830 | 🌐 TypeScript | 📅 2026-09-22 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 44,040 | 🐛 71 | 🌐 Go | 📅 2026-09-21 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,864 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,429 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [DeckTape](https://github.com/astefanutti/decktape) ⭐ 2,427 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - DeckTape is a high-quality PDF exporter for HTML presentation frameworks.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 528 | 🐛 15 | 🌐 Python | 📅 2026-09-21 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,689 | 🐛 130 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,919 | 🐛 40 | 🌐 Rust | 📅 2026-09-18 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,864 | 🐛 460 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,963 | 🐛 93 | 🌐 Go | 📅 2026-09-21 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 140 | 🐛 1 | 🌐 Rust | 📅 2026-09-19 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-21 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,481 | 🐛 530 | 🌐 Go | 📅 2026-09-20 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,689 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,239 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,265 | 🐛 54 | 🌐 C | 📅 2026-09-19 - Terminal graphics for the 21 st century.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,822 | 🐛 8 | 🌐 Python | 📅 2026-09-21 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,780 | 🐛 71 | 🌐 Python | 📅 2026-09-18 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,687 | 🐛 709 | 🌐 Python | 📅 2026-09-22 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,231 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,780 | 🐛 213 | 🌐 Rust | 📅 2026-09-21 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,742 | 🐛 168 | 🌐 C | 📅 2026-09-05 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 594 | 🐛 19 | 🌐 Rust | 📅 2026-09-20 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,843 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,096 | 🐛 1 | 🌐 C | 📅 2026-09-22 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,096 | 🐛 1 | 🌐 C | 📅 2026-09-22 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,213 | 🐛 49 | 🌐 Rust | 📅 2026-09-22 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,260 | 🐛 9 | 🌐 Python | 📅 2026-09-22 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,533 | 🐛 517 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,759 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,418 | 🐛 11 | 🌐 Rust | 📅 2026-09-14 - Terminal image, video, directory, and Markdown viewer.
* [youtube-viewer](https://github.com/trizen/youtube-viewer) ⭐ 1,314 | 🐛 46 | 🌐 Perl | 📅 2026-06-15 - Lightweight application that searches and streams videos from YouTube.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,948 | 🐛 176 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,822 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,185 | 🐛 448 | 🌐 Go | 📅 2026-09-21 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,828 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [eddy](https://github.com/70sh1/eddy) ⭐ 54 | 🐛 0 | 🌐 Go | 📅 2026-07-11 - Simple, fast CLI file encryption tool.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,494 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,340 | 🐛 624 | 🌐 Python | 📅 2026-09-19 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,318 | 🐛 14 | 🌐 Shell | 📅 2026-09-21 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,181 | 🐛 34 | 🌐 Rust | 📅 2026-09-17 - Play chess from your terminal.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,250 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,253 | 🐛 19 | 🌐 Rust | 📅 2026-09-21 - Turn your keyboard into a typewriter adding sounds at each keystroke.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,473 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,659 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,439 | 🐛 0 | 🌐 Shell | 📅 2026-09-21 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,692 | 🐛 45 | 📅 2026-09-22 - An awesome list dedicated to TUI programs.
