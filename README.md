...
* [eza](https://github.com/eza-community/eza) ⭐ 22,924 | 🐛 424 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,165 | 🐛 203 | 🌐 Rust | 📅 2026-07-25 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
* [colorls](https://github.com/athityakumar/colorls) ⭐ 5,135 | 🐛 87 | 🌐 Ruby | 📅 2026-07-27 - A Ruby script that colorizes the `ls` output with color and icons.
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,253 | 🐛 31 | 🌐 Rust | 📅 2026-08-10 - A themeable LS\_COLORS generator with a rich filetype datebase.
* [nat](https://github.com/willdoescode/nat) ⭐ 1,262 | 🐛 0 | 🌐 Rust | 📅 2021-05-28 - Complete replacement for the `ls` command.
* [stree](https://github.com/orangekame3/stree) ⭐ 143 | 🐛 0 | 🌐 Go | 📅 2024-07-17 - A CLI tool designed to visualize the directory tree structure of an S3 bucket.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,642 | 🐛 135 | 🌐 Rust | 📅 2026-08-10 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,041 | 🐛 107 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
* [autojump](https://github.com/wting/autojump) ⭐ 16,958 | 🐛 231 | 🌐 Python | 📅 2025-02-27 - A cd command that maintains a database of most visited paths and allows the access to a directory with shortened versions of the path.
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,142 | 🐛 73 | 🌐 Lua | 📅 2026-08-10 - Directory changer that learns your habits.
* [enhancd](https://github.com/babarot/enhancd) ⭐ 2,708 | 🐛 17 | 🌐 Shell | 📅 2025-01-24 - A next-generation cd command with your interactive filter.
* [fz](https://github.com/changyuheng/fz.sh) ⭐ 574 | 🐛 9 | 🌐 Shell | 📅 2024-02-25 - Fuzzy tab completion for z.
* [Shunpo](https://github.com/egurapha/Shunpo) ⭐ 445 | 🐛 1 | 🌐 Shell | 📅 2026-08-03 - A minimalist bash tool that makes directory navigation just a little bit faster.
...
* [nav](https://github.com/dkaslovsky/nav) ⭐ 133 | 🐛 0 | 🌐 Go | 📅 2026-03-15 - Terminal navigator for interactive ls workflows.
...
* [fastdiract](https://github.com/dp12/fastdiract) ⭐ 12 | 🐛 1 | 🌐 Shell | 📅 2026-06-11 - Lightning-fast cd and command execution.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,076 | 🐛 185 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,254 | 🐛 13 | 🌐 C | 📅 2026-08-10 - A breadth-first version of the UNIX find command.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,784 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
* [rip](https://github.com/nivekuil/rip) ⭐ 1,728 | 🐛 26 | 🌐 Rust | 📅 2024-04-08 - Move and restore items from the graveyard (by default, `/tmp/graveyard-$USER` if $XDG\_DATA\_HOME is not set and `$XDG_DATA_HOME/graveyard` otherwise)
* [trash-cli](https://github.com/sindresorhus/trash-cli) ⭐ 1,406 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-02 - Move files and folders to the trash on Linux (XDG trash), macOS (`macOS-trash` library) and Windows (`recycle-bin` library).
* [gomi](https://github.com/babarot/gomi) ⭐ 561 | 🐛 2 | 🌐 Go | 📅 2026-06-07 - UNIX rm command with a safety net.
...
* [undelete-btrfs](https://github.com/danthem/undelete-btrfs) ⭐ 291 | 🐛 3 | 🌐 Shell | 📅 2025-12-27 - Automate the generation of path regex for BTRFS restore and attempt the restore for you in 3 levels. The longer a file has existed prior to being deleted, the more likely it is to be recovered.
...
* [trasher](https://github.com/clementnerma/trasher) ⭐ 25 | 🐛 0 | 🌐 Rust | 📅 2025-04-18 - Delete files to a trash directory instead of deleting them immediately. Uses its own trash instead of the XDG one.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,777 | 🐛 135 | 🌐 Rust | 📅 2026-04-14 - Intelligent context-aware search engine for your shell history with TUI.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,451 | 🐛 185 | 🌐 C | 📅 2026-05-29 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
* [hiSHtory](https://github.com/ddworken/hishtory) ⭐ 3,104 | 🐛 62 | 🌐 Go | 📅 2026-03-18 - A better shell history that stores context (directory, succeeded or failed, how long it took, etc). The history is stored locally and end-to-end encrypted for syncing to other computers.
...
* [atuin](https://github.com/ellie/atuin) ⭐ 21 | 🐛 0 | 📅 2026-02-10 - Atuin replaces your existing shell history with a SQLite database, and records additional context for your commands. Additionally, it provides optional and fully encrypted synchronization of your history between machines, via an Atuin server.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,746 | 🐛 424 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,766 | 🐛 290 | 🌐 Rust | 📅 2026-08-13 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,082 | 🐛 3 | 🌐 Perl | 📅 2026-08-11 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,870 | 🐛 69 | 🌐 Go | 📅 2026-08-13 - A diff tool for YAML files, and sometimes JSON.
* [ydiff](https://github.com/ymattw/ydiff) ⭐ 930 | 🐛 1 | 🌐 Python | 📅 2026-05-20 - View colored, incremental diff.
* [pdf-diff](https://github.com/serhack/pdf-diff) ⭐ 864 | 🐛 5 | 🌐 Go | 📅 2023-05-08 - A tool for visualizing differences between two PDF files. Mainly dedicated to editors that usually spends a lot of hours on several PDFs.
* [diff2html-cli](https://github.com/rtfpessoa/diff2html-cli) ⭐ 601 | 🐛 16 | 🌐 TypeScript | 📅 2026-02-06 - Parse git diffs as JSON and generate pretty HTML.
...
* [Dirdiff](https://github.com/OCamlPro/dirdiff) ⭐ 92 | 🐛 3 | 🌐 Rust | 📅 2022-11-29 - Efficiently compute the differences between two directories.
...
* [sesdiff](https://github.com/proycon/sesdiff) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2024-10-15 - Generates a shortest edit script (Myers' diff algorithm) to indicate how to get from the strings in column A to the strings in column B. Also provides the edit distance (levenshtein).
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,308 | 🐛 175 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,108 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,505 | 🐛 48 | 🌐 Rust | 📅 2026-08-13 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,798 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,237 | 🐛 7 | 🌐 C++ | 📅 2026-08-07 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [Csope](https://github.com/agvxov/csope) ⭐ 71 | 🐛 0 | 🌐 C | 📅 2026-08-04 - C source code browser - Fork of Cscope version 15,9, with various improvements.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,296 | 🐛 74 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,284 | 🐛 17 | 🌐 Rust | 📅 2026-08-09 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
* [amber](https://github.com/dalance/amber) ⭐ 950 | 🐛 19 | 🌐 Rust | 📅 2026-08-07 - Code search / replace tool.
* [srgn](https://github.com/alexpovel/srgn) ⭐ 907 | 🐛 4 | 🌐 Rust | 📅 2026-08-04 - A code surgeon for precise text and code transplantation. A marriage of `tr`/`sed`, `rg` and `tree-sitter`.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 525 | 🐛 12 | 🌐 Rust | 📅 2025-06-18 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,117 | 🐛 10 | 🌐 Rust | 📅 2026-08-13 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,126 | 🐛 30 | 🌐 Rust | 📅 2026-08-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,894 | 🐛 65 | 🌐 Go | 📅 2026-08-13 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,114 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
* [erdtree](https://github.com/solidiquis/erdtree) ⭐ 2,592 | 🐛 36 | 🌐 Rust | 📅 2024-05-19 - A multithreaded file-tree visualizer and disk usage analyzer.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 33,973 | 🐛 520 | 🌐 C++ | 📅 2026-08-08 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,119 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,918 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
...
* [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,918 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/macOS/FreeBSD resource monitor with a nice interface.
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,909 | 🐛 142 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
* [gtop](https://github.com/aksakalli/gtop) ⭐ 9,924 | 🐛 42 | 🌐 JavaScript | 📅 2025-11-06 - System monitoring dashboard for terminal written in Node.js.
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,103 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,131 | 🐛 39 | 🌐 Rust | 📅 2026-08-10 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,066 | 🐛 38 | 🌐 Python | 📅 2026-08-05 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
* [gputop](https://github.com/wookayin/gpustat) ⭐ 4,392 | 🐛 31 | 🌐 Python | 📅 2026-05-30 - A simple command-line utility for querying and monitoring GPU status.
* [vtop](https://github.com/MrRio/vtop) ⭐ 4,171 | 🐛 80 | 🌐 JavaScript | 📅 2020-10-08 - Alternative to top with several additional stats.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,044 | 🐛 41 | 🌐 Rust | 📅 2026-07-13 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
* [below](https://github.com/facebookincubator/below) ⭐ 2,490 | 🐛 35 | 🌐 Rust | 📅 2026-08-13 - A time traveling resource monitor for modern Linux systems
* [tiptop](https://github.com/nschloe/tiptop) ⭐ 2,121 | 🐛 25 | 🌐 Python | 📅 2025-09-04 - A command-line system monitoring tool in the spirit of top, written in Python. It displays various interesting system stats and graphs them. Works on all operating systems.
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,675 | 🐛 4 | 🌐 Rust | 📅 2026-08-13 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
* [radeontop](https://github.com/clbr/radeontop) ⭐ 915 | 🐛 50 | 🌐 C | 📅 2026-03-20 - View your AMD GPU utilization, both for the total activity percent and individual blocks.
* [ttop](https://github.com/inv2004/ttop) ⭐ 393 | 🐛 6 | 🌐 Nim | 📅 2026-04-14 - top-like system monitoring tool with TUI, historical data service and triggers.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,395 | 🐛 136 | 🌐 C | 📅 2026-07-31 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
* [classifier](https://github.com/bhrigu123/classifier) ⭐ 1,102 | 🐛 25 | 🌐 Python | 📅 2022-03-07 - Organize files in your current directory, by classifying them into folders of music, PDFs, images, etc.
...
* [organize-cli](https://github.com/ManrajGrover/organize-cli) ⭐ 370 | 🐛 7 | 🌐 JavaScript | 📅 2018-10-11 - Organize your files automatically.
...
* [Dext](https://github.com/AfzGit/dext) ⭐ 16 | 🐛 0 | 🌐 Shell | 📅 2023-04-23 - (Directories by Extensions) is a script that moves (or copies) files of the same extension into a folder.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,303 | 🐛 70 | 🌐 Rust | 📅 2026-08-14 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,499 | 🐛 250 | 🌐 Go | 📅 2026-08-11 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,781 | 🐛 4 | 🌐 C | 📅 2026-08-11 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,464 | 🐛 81 | 🌐 Go | 📅 2026-08-13 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,720 | 🐛 107 | 🌐 Rust | 📅 2026-07-19 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,632 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,206 | 🐛 480 | 🌐 C++ | 📅 2026-08-13 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,711 | 🐛 26 | 🌐 C | 📅 2026-08-14 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
* [hunter](https://github.com/rabite0/hunter) ⭐ 1,339 | 🐛 40 | 🌐 Rust | 📅 2022-09-26 - Ranger-like file browser written in rust.
* [felix](https://github.com/kyoheiu/felix) ⭐ 911 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager with vim-like key mapping
...
* [goful](https://github.com/anmitsu/goful) ⭐ 379 | 🐛 4 | 🌐 Go | 📅 2021-11-29 - Goful is a CUI file manager written in Go.
...
* [fzfm](https://github.com/ashish0kumar/fzfm) ⭐ 211 | 🐛 4 | 🌐 Shell | 📅 2025-08-04 - A command-line fuzzy finder file manager.
* [adbtuifm](https://github.com/darkhz/adbtuifm) ⭐ 188 | 🐛 3 | 🌐 Go | 📅 2022-03-16 - A TUI file manager for the Android Debug Bridge, to make transfers between the device and client easier.
* [Better tree](https://github.com/LeperGnome/bt) ⭐ 164 | 🐛 15 | 🌐 Go | 📅 2026-05-20 - Interactive tree-like terminal file manager.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,801 | 🐛 14 | 🌐 Rust | 📅 2026-08-10 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
* [tere](https://github.com/mgunyho/tere) ⭐ 1,802 | 🐛 16 | 🌐 Rust | 📅 2026-03-09 - Terminal file explorer that is a faster alternative to using cd and ls to browse folders in your terminal.
* [tre](https://github.com/dduan/tre) ⭐ 1,214 | 🐛 23 | 🌐 Rust | 📅 2024-09-03 - `tree` command improved with git awareness, editor aliasing, and colors.
* [browsr](https://github.com/juftin/browsr) ⭐ 642 | 🐛 13 | 🌐 Python | 📅 2026-04-22 - A pleasant file explorer that can browse the contents of local and remote filesystems with your keyboard or mouse; remotes include GitHub, over SSH, in AWS S3, Google Cloud Storage, or Azure Blob Storage.
...
* [kupo](https://github.com/darrenburns/kupo) ⭐ 211 | 🐛 4 | 🌐 Python | 📅 2024-07-05 - A terminal file browser, kupo!
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,735 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,707 | 🐛 98 | 🌐 Rust | 📅 2026-08-10 - Painless compression and decompression in the terminal.
* [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,543 | 🐛 63 | 🌐 C | 📅 2026-08-01 - Rotate, compress and mail logs.
* [xcp](https://github.com/tarka/xcp) ⭐ 925 | 🐛 18 | 🌐 Rust | 📅 2026-06-23 - Extended cp.
* [compsize](https://github.com/kilobyte/compsize) ⭐ 410 | 🐛 22 | 🌐 C | 📅 2023-12-25 - Find compression type/ratio on a file or set of files on a btrfs file system.
* [qcp](https://github.com/crazyscot/qcp) ⭐ 282 | 🐛 11 | 🌐 Rust | 📅 2026-08-01 - Quick File Copy using QUIC.
* [vidir](https://github.com/trapd00r/vidir) ⭐ 228 | 🐛 7 | 🌐 Perl | 📅 2024-06-08 - vidir allows editing of the contents of a directory in a text editor.
...
* [ForkFS](https://github.com/SUPERCILEX/forkfs) ⭐ 85 | 🐛 1 | 🌐 Rust | 📅 2025-03-12 - ForkFS allows you to sandbox a process's changes to your file system.
* [lib-x](https://github.com/Benexl/lib-x) ⭐ 75 | 🐛 0 | 🌐 Shell | 📅 2026-08-09 - Browse your calibre library from the terminal.
...
* [shallow-backup](https://github.com/alichtman/shallow-backup) ⭐ 1,334 | 🐛 23 | 🌐 Python | 📅 2026-03-21 - Git integrated backup tool.
...
* [reflex](https://github.com/cespare/reflex) ⭐ 3,548 | 🐛 28 | 🌐 Go | 📅 2026-02-26 - Reflex is a small tool to watch a directory and rerun a command when certain files change.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,431 | 🐛 4 | 🌐 Go | 📅 2026-06-22 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
* [massren](https://github.com/laurent22/massren) ⭐ 1,395 | 🐛 14 | 🌐 Go | 📅 2024-12-08 - Easily rename multiple files using your text editor.
* [mmv](https://github.com/itchyny/mmv) ⭐ 805 | 🐛 0 | 🌐 Go | 📅 2023-04-26 - Rename multiple files using your $EDITOR. The command name is named after multi-mv.
...
* [VisioNomicon](https://github.com/rehanzo/VisioNomicon) ⭐ 47 | 🐛 0 | 🌐 Python | 📅 2025-01-07 - A utility that leverages GPT-4V to rename image files based on their content.
* [moove](https://github.com/urin/moove) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2026-07-19 - Manipulate file names and locations using a text editor.
* [mmv-c](https://github.com/mcauley-penney/mmv-c) ⭐ 13 | 🐛 5 | 🌐 C | 📅 2025-12-27 - Interactively rename files with your favorite editor.
* [Tempren](https://github.com/idle-code/tempren) ⭐ 12 | 🐛 33 | 🌐 Python | 📅 2026-08-10 - A powerful file renaming utility that uses flexible template expressions to create new file paths and names.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,611 | 🐛 60 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 173,617 | 🐛 857 | 🌐 Python | 📅 2026-07-29 - Python tool for converting files and office documents to Markdown.
...
* [lx](https://github.com/rasros/lx) ⭐ 50 | 🐛 0 | 🌐 Go | 📅 2026-07-29 - Convert arbitrary files into Markdown-fenced blocks for LLM context.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-08-13 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,276 | 🐛 526 | 🌐 Rust | 📅 2026-08-13 - Cross-platform Text Expander written in Rust. Not limited to the command line.
* [Ultimate Plumber](https://github.com/akavel/up) ⭐ 8,839 | 🐛 30 | 🌐 Go | 📅 2024-09-05 - Helps to interactively and incrementally explore textual data in Linux, by making it easier to quickly build complex pipelines, thanks to a fast feedback loop.
* [pup](https://github.com/ericchiang/pup) ⭐ 8,439 | 🐛 106 | 🌐 HTML | 📅 2024-05-02 - Parsing HTML at the command line.
* [lolcat](https://github.com/busyloop/lolcat) ⭐ 6,565 | 🐛 33 | 🌐 Ruby | 📅 2024-03-05 - Ruby Gem to colorize the output of the cat command.
* [toolong](https://github.com/Textualize/toolong) ⭐ 3,938 | 🐛 37 | 🌐 Python | 📅 2024-08-05 - A terminal application to view, tail, merge, and search log files (plus JSONL).
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,708 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,071 | 🐛 369 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,347 | 🐛 5 | 🌐 Perl | 📅 2026-07-16 - Command line tool for URL parsing and manipulation.
* [yek](https://github.com/bodo-run/yek) ⭐ 2,470 | 🐛 12 | 🌐 Rust | 📅 2026-06-29 - A fast Rust based tool to serialize text-based files in a repository or directory for LLM consumption.
...
* [awk](https://github.com/onetrueawk/awk) ⭐ 2,218 | 🐛 13 | 🌐 C | 📅 2026-04-26 - A historical, general-purpose text file processor, implements a domain-specific language designed for text processing and typically used as a data extraction and reporting tool.
...
* [hck](https://github.com/sstadick/hck) ⭐ 742 | 🐛 7 | 🌐 Rust | 📅 2026-06-15 - A sharp cut clone.
* [as-tree](https://github.com/jez/as-tree) ⭐ 503 | 🐛 19 | 🌐 Rust | 📅 2021-10-07 - Print a list of paths as a tree of paths.
* [brok](https://github.com/smallhadroncollider/brok) ⭐ 423 | 🐛 13 | 🌐 Haskell | 📅 2023-03-06 - Find broken links in text documents.
* [gtree](https://github.com/ddddddO/gtree) ⭐ 358 | 🐛 37 | 🌐 Go | 📅 2026-07-27 - Using either Markdown or programmatically to generate directory trees and directories, and to verify directories.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,736 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
* [ROAPI](https://github.com/roapi/roapi) ⭐ 3,417 | 🐛 66 | 🌐 Rust | 📅 2026-03-25 - ROAPI automatically spins up read-only APIs for static datasets without requiring you to write a single line of code.
...
* [ttyplot](https://github.com/tenox7/ttyplot) ⭐ 1,371 | 🐛 10 | 🌐 C | 📅 2026-07-28 - A realtime plotting utility for terminals with data input from stdin/pipe.
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,022 | 🐛 14 | 🌐 Python | 📅 2026-03-02 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [datadash](https://github.com/keithknott26/datadash) ⭐ 314 | 🐛 0 | 🌐 Go | 📅 2026-05-07 - Visualize and graph data in the terminal.
...
* [lowcharts](https://github.com/juan-leon/lowcharts) ⭐ 249 | 🐛 10 | 🌐 Rust | 📅 2025-12-22 - lowcharts is meant to be used in those scenarios where we have numerical data in text files that we want to display in the terminal to do a basic analysis.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,578 | 🐛 24 | 🌐 Go | 📅 2026-07-28 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,826 | 🐛 284 | 🌐 Go | 📅 2026-08-06 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,500 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,663 | 🐛 50 | 🌐 Python | 📅 2026-06-18 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,132 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,088 | 🐛 31 | 🌐 Rust | 📅 2026-07-27 - Interactive JSON filter using jq.
* [jo](https://github.com/jpmens/jo) ⭐ 4,864 | 🐛 7 | 🌐 C | 📅 2025-06-20 - A small utility to create JSON objects from the command line.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,793 | 🐛 13 | 🌐 Go | 📅 2026-07-20 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,705 | 🐛 22 | 🌐 Rust | 📅 2026-08-07 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,830 | 🐛 23 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,477 | 🐛 29 | 🌐 Python | 📅 2026-08-04 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [JSON.sh](https://github.com/dominictarr/JSON.sh) ⭐ 2,030 | 🐛 19 | 🌐 Shell | 📅 2020-12-15 - A JSON parser written in shell, compatible with ash, bash, dash and zsh.
...
* [jp](https://github.com/jmespath/jp) ⭐ 787 | 🐛 19 | 🌐 Python | 📅 2023-06-15 - A command line interface to JMESPath, an expression language for manipulating JSON.
...
* [jello](https://github.com/kellyjonbrazil/jello) ⭐ 530 | 🐛 7 | 🌐 Python | 📅 2025-05-30 - CLI tool to filter JSON and JSON Lines data with Python syntax, similar to - surprise :-), jq!
...
* [jtbl](https://github.com/kellyjonbrazil/jtbl) ⭐ 340 | 🐛 2 | 🌐 Python | 📅 2024-04-02 - A simple CLI tool to print JSON and JSON Lines data as a table in the terminal.
...
* [YAML Paths](https://github.com/wwkimball/yamlpath) ⭐ 137 | 🐛 0 | 🌐 Python | 📅 2026-05-02 - YAML/JSON/EYAML/Compatible get/set/merge/validate/scan/convert/diff processors using powerful, intuitive, command-line friendly syntax.
* [jellex](https://github.com/kellyjonbrazil/jellex) ⭐ 119 | 🐛 4 | 🌐 Python | 📅 2023-10-24 - TUI to filter JSON and JSON Lines data with Python syntax.
...
* [Konfigo](https://github.com/ebogdum/konfigo) ⭐ 18 | 🐛 0 | 🌐 Go | 📅 2026-07-31 - Command-line tool designed to work with multiple configuration file formats like JSON, YAML, TOML.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,173 | 🐛 696 | 🌐 Go | 📅 2026-08-13 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,349 | 🐛 36 | 🌐 Python | 📅 2026-08-03 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,963 | 🐛 4 | 🌐 Python | 📅 2026-08-12 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,068 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 9,995 | 🐛 73 | 🌐 Go | 📅 2026-08-12 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
* [textql](https://github.com/dinedal/textql) ⭐ 9,106 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,409 | 🐛 36 | 🌐 Python | 📅 2026-08-03 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,322 | 🐛 55 | 🌐 Python | 📅 2026-08-13 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,270 | 🐛 17 | 🌐 Rust | 📅 2026-08-08 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,214 | 🐛 50 | 🌐 Go | 📅 2026-07-26 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,920 | 🐛 57 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,753 | 🐛 31 | 🌐 Rust | 📅 2026-08-14 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,753 | 🐛 31 | 🌐 Rust | 📅 2026-08-14 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,289 | 🐛 44 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,183 | 🐛 14 | 🌐 Go | 📅 2026-08-14 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,071 | 🐛 15 | 🌐 Rust | 📅 2026-08-14 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,552 | 🐛 66 | 🌐 Go | 📅 2026-08-12 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,148 | 🐛 103 | 🌐 Python | 📅 2026-08-14 - Python CLI utility and library for manipulating SQLite databases.
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,817 | 🐛 6 | 🌐 Go | 📅 2022-06-11 - A TUI for viewing and editing databases, written in pure Go.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,190 | 🐛 2 | 🌐 Python | 📅 2026-07-15 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [zsv](https://github.com/liquidaty/zsv) ⭐ 395 | 🐛 25 | 🌐 C | 📅 2026-08-09 - The world's fastest (simd) CSV parser, with an extensible, multi-purpose CLI.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,552 | 🐛 327 | 🌐 Go | 📅 2026-08-11 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,919 | 🐛 4 | 🌐 Rust | 📅 2026-08-11 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,173 | 🐛 80 | 🌐 Rust | 📅 2026-07-30 - Blazing fast general purpose fuzzy finder TUI.
* [percol](https://github.com/mooz/percol) ⭐ 3,327 | 🐛 51 | 🌐 Python | 📅 2023-12-30 - A Python script that "1) receives input lines from `stdin` or a file, 2) lists the input lines and waits for input that filter/select the line(s), 3) outputs the selected line(s) to `stdout`"; can be used to add interactivity to many regular shell commands.
* [fzy](https://github.com/jhawthorn/fzy) ⭐ 3,293 | 🐛 57 | 🌐 C | 📅 2025-07-29 - Better fuzzy finder.
* [smenu](https://github.com/p-gen/smenu) ⭐ 2,491 | 🐛 4 | 🌐 C | 📅 2026-04-17 - Started as a lightweight and flexible terminal menu generator, it evolved into a powerful and versatile CLI selection tool for interactive or scripting use.
* [pick](https://github.com/mptre/pick) ⭐ 839 | 🐛 10 | 🌐 C | 📅 2023-05-17 - Choose one option from a set of choices using an interface with fuzzy search functionality.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 26,869 | 🐛 219 | 🌐 Go | 📅 2026-08-13 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,071 | 🐛 707 | 🌐 Rust | 📅 2026-08-03 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,823 | 🐛 126 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
* [DocToc](https://github.com/thlorenz/doctoc) ⭐ 4,461 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-04 - Generates table of contents for Markdown files inside local git repository. Links are compatible with anchors generated by GitHub or other sites.
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,262 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 810 | 🐛 58 | 🌐 Python | 📅 2026-08-10 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,332 | 🐛 1,030 | 🌐 Go | 📅 2026-08-14 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,452 | 🐛 160 | 🌐 Rust | 📅 2026-08-13 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
* [slap](https://github.com/slap-editor/slap) ⭐ 6,190 | 🐛 115 | 🌐 JavaScript | 📅 2021-11-01 - Text editor inspired by [Sublime Text](https://www.sublimetext.com/) written in NodeJS, extendable in JavaScript.
* [vis](https://github.com/martanne/vis) ⭐ 4,684 | 🐛 142 | 🌐 C | 📅 2026-08-10 - "a modern, legacy free, simple yet efficient vim-like editor", and more: "The intention is not to be bug for bug compatible with vim, instead a similar editing experience should be provided. The goal could thus be summarized as 80% of vim's features implemented in roughly 1% of the code"; the editor is scriptable in LUA and supports editing large files.
* [Amp](https://github.com/jmacdonald/amp) ⭐ 4,119 | 🐛 94 | 🌐 Rust | 📅 2026-06-10 - A complete text editor for your terminal.
* [ox](https://github.com/curlpipe/ox) ⭐ 3,727 | 🐛 33 | 🌐 Rust | 📅 2026-04-23 - An independent Rust text editor.
* [zee](https://github.com/zee-editor/zee) ⭐ 1,800 | 🐛 44 | 🌐 Rust | 📅 2025-02-06 - Zee is a modern editor for the terminal, in the spirit of Emacs. It is written in Rust and it is somewhat experimental.
* [vy](https://github.com/vyapp/vy) ⚠️ Archived - A vim-like in Python made from scratch.
* [o](https://github.com/xyproto/orbiton) ⭐ 693 | 🐛 1 | 🌐 Go | 📅 2026-08-13 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
* [Turbo](https://github.com/magiblot/turbo) ⭐ 672 | 🐛 37 | 🌐 C++ | 📅 2026-05-10 - An experimental text editor for the terminal, based on Scintilla and Turbo Vision.
* [C-EDIT](https://github.com/velorek1/c-edit) ⭐ 300 | 🐛 4 | 🌐 C | 📅 2026-01-29 - A text editor in C with drop down menus in the style of MS-DOS Editor.
* [aretext](https://github.com/aretext/aretext) ⭐ 285 | 🐛 5 | 🌐 Go | 📅 2026-07-21 - Minimalist text editor with vim-compatible key bindings.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,317 | 🐛 1,019 | 🌐 Go | 📅 2026-08-13 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,697 | 🐛 462 | 🌐 Go | 📅 2026-07-29 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,390 | 🐛 331 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,096 | 🐛 99 | 🌐 Shell | 📅 2026-08-12 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,302 | 🐛 225 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,301 | 🐛 95 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
* [BFG Repo-Cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,167 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,117 | 🐛 142 | 🌐 Rust | 📅 2026-08-04 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,020 | 🐛 61 | 🌐 Rust | 📅 2026-08-11 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 9,980 | 🐛 174 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,147 | 🐛 79 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 6,994 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - A simple and efficient way to access various statistics in a git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,058 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,035 | 🐛 246 | 🌐 Shell | 📅 2026-08-11 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
* [mergestat-lite](https://github.com/mergestat/mergestat-lite) ⭐ 3,518 | 🐛 45 | 🌐 Go | 📅 2026-08-13 - A command-line tool for running SQL queries on git repositories and related data sources.
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,295 | 🐛 11 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,922 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
* [git-cz](https://github.com/streamich/git-cz) ⭐ 1,876 | 🐛 86 | 🌐 JavaScript | 📅 2025-09-10 - Semantic Git commits.
* [czg](https://github.com/Zhengqbbb/cz-git) ⭐ 1,519 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-11 - Interactively generate standardized commit messages.
* [fzf-git.sh](https://github.com/junegunn/fzf-git.sh) ⭐ 1,174 | 🐛 13 | 🌐 Shell | 📅 2026-08-06 - bash and zsh key bindings for Git objects, powered by fzf.
...
* [Froggit](https://github.com/thewizardshell/froggit) ⭐ 480 | 🐛 3 | 🌐 Go | 📅 2026-03-20 - Minimalist Git TUI with GitHub CLI integration.
* [gh-s](https://github.com/gennaro-tedesco/gh-s) ⭐ 411 | 🐛 1 | 🌐 Go | 📅 2025-08-20 - Search GitHub repositories interactively.
...
* [ggc](https://github.com/bmf-san/ggc) ⭐ 284 | 🐛 0 | 🌐 Go | 📅 2026-08-10 - A modern Git CLI tool with both traditional command-line and interactive incremental-search UI.
* [gitlab-cli](https://github.com/vishwanatharondekar/gitlab-cli) ⭐ 266 | 🐛 5 | 🌐 JavaScript | 📅 2024-01-19 - Create GitLab merge requests.
* [gitnr](https://github.com/reemus-dev/gitnr) ⭐ 235 | 🐛 4 | 🌐 Rust | 📅 2026-05-28 - Create `.gitignore` files using one or more templates from TopTal, GitHub or your own collection.
* [git-crecord](https://github.com/andrewshadura/git-crecord) ⭐ 216 | 🐛 21 | 🌐 Python | 📅 2025-05-23 - Git subcommand to interactively select changes to commit or stage.
* [gmap](https://github.com/seeyebe/gmap) ⚠️ Archived - Command-line tool for visualizing Git activity.
* [Git Auto Sync](https://github.com/GitJournal/git-auto-sync) ⭐ 200 | 🐛 17 | 🌐 Go | 📅 2024-07-16 - Automatically commits changes to a git repository, and always keep that repository up to date.
...
* [prs](https://github.com/dhth/prs) ⭐ 185 | 🐛 2 | 🌐 Go | 📅 2026-06-08 - Stay updated on PRs without leaving the terminal.
...
* [git-cc](https://github.com/SKalt/git-cc) ⭐ 140 | 🐛 10 | 🌐 Go | 📅 2026-08-04 - A git extension to help write conventional commits.
* [Kusa](https://github.com/Ryu0118/Kusa) ⭐ 136 | 🐛 2 | 🌐 Rust | 📅 2023-06-25 - Displays GitHub contribution graphs.
* [AI Git Narrator](https://github.com/pmusolino/AI-Git-Narrator) ⭐ 119 | 🐛 4 | 🌐 Swift | 📅 2026-01-18 - Command-line tool for generating Git commit messages and PR descriptions with AI based on Git diffs and commits. Supports staged/unstaged changes and customizable AI parameters.
...
* [gitsnip](https://github.com/dagimg-dot/gitsnip) ⭐ 88 | 🐛 3 | 🌐 Go | 📅 2025-04-19 - A CLI tool to download specific folders from a git repository.
...
* [gh-repo-man](https://github.com/2KAbhishek/gh-repo-man) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2026-08-09 - GitHub CLI extension that allows developers to browse, clone and work with multiple repositories interactively.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 30,970 | 🐛 1,201 | 🌐 Rust | 📅 2026-08-14 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,135 | 🐛 20 | 🌐 Rust | 📅 2026-08-13 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,822 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-11 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,354 | 🐛 629 | 🌐 Go | 📅 2026-08-14 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,975 | 🐛 404 | 🌐 JavaScript | 📅 2026-08-08 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,875 | 🐛 4 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,428 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,801 | 🐛 242 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,267 | 🐛 489 | 🌐 Go | 📅 2026-08-13 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,238 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,841 | 🐛 29 | 🌐 Python | 📅 2026-04-15 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,026 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,620 | 🐛 27 | 🌐 Go | 📅 2026-08-11 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,169 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
* [np](https://github.com/sindresorhus/np) ⭐ 7,711 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-30 - A better `npm publish`.
* [blinkenlights](https://github.com/jart/blink) ⭐ 7,568 | 🐛 55 | 🌐 C | 📅 2025-12-10 - TUI that may be used for debugging x86\_64-linux or i8086 programs across platforms.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,379 | 🐛 35 | 🌐 Rust | 📅 2026-08-09 - A TUI for analyzing Linux binaries.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,087 | 🐛 439 | 🌐 Rust | 📅 2026-08-13 - Developer environments you can take with you.
* [PuDB](https://github.com/inducer/pudb) ⭐ 3,250 | 🐛 164 | 🌐 Python | 📅 2026-08-04 - Allows you to debug code right where you write and test it in a terminal.
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,631 | 🐛 14 | 🌐 Python | 📅 2026-08-12 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [stepci](https://github.com/stepci/stepci) ⭐ 1,867 | 🐛 73 | 🌐 TypeScript | 📅 2024-08-03 - Automated API Testing and Quality Assurance.
* [cgdb](https://github.com/cgdb/cgdb) ⭐ 1,836 | 🐛 45 | 🌐 C | 📅 2026-02-27 - Console front-end to the GNU debugger.
...
* [scriptisto](https://github.com/igor-petruk/scriptisto) ⭐ 1,087 | 🐛 10 | 🌐 Rust | 📅 2025-02-08 - A language-agnostic "shebang interpreter" that enables you to write scripts in compiled languages.
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 158 | 🌐 Rust | 📅 2026-08-14 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
* [sls-dev-tools](https://github.com/Theodo-UK/sls-dev-tools) ⭐ 872 | 🐛 62 | 🌐 JavaScript | 📅 2023-04-25 - Interactive in-terminal dashboard that allows to monitor and manage the resources of  AWS-based Serverless applications.
* [nbterm](https://github.com/davidbrochart/nbterm) ⭐ 778 | 🐛 31 | 🌐 Python | 📅 2023-08-10 - Jupyter Notebooks in the terminal.
* [Kool](https://github.com/kool-dev/kool) ⭐ 724 | 🐛 13 | 🌐 Go | 📅 2026-08-12 - CLI tool that brings the complexities of modern software development making these environments lightweight, fast and reproducible.
* [gup](https://github.com/nao1215/gup) ⭐ 596 | 🐛 5 | 🌐 Go | 📅 2026-08-10 - Update binaries installed by "go install" with goroutines.
* [DevTUI](https://github.com/skatkov/devtui) ⭐ 553 | 🐛 41 | 🌐 Go | 📅 2026-07-27 - All-in-one terminal toolkit that consolidates everyday developer utilities into a unified TUI and CLI.
...
* [pproftui](https://github.com/Oloruntobi1/pproftui) ⭐ 281 | 🐛 2 | 🌐 Go | 📅 2025-07-28 - TUI for Go's pprof that makes profiling interactive, intuitive, and fast.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 12 | 🌐 Python | 📅 2026-08-13 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
* [pire](https://github.com/johannestaas/pire) ⭐ 124 | 🐛 1 | 🌐 Python | 📅 2019-09-26 - Python Interactive Regular Expressions.
* [suss](https://github.com/shobrook/suss) ⭐ 122 | 🐛 0 | 🌐 Python | 📅 2025-05-01 - AI-powered bug finder that knows your codebase.
* [umake](https://github.com/mcandre/unmake) ⭐ 118 | 🐛 66 | 🌐 Rust | 📅 2026-08-01 - Makefile linter emphasizing portability, targeting the POSIX make standard.
...
* [codegrab](https://github.com/epilande/codegrab) ⭐ 95 | 🐛 4 | 🌐 Go | 📅 2026-01-02 - Interactive CLI tool for selecting and bundling code into a single, LLM-ready output file.
* [Scrut](https://github.com/facebookincubator/scrut) ⭐ 82 | 🐛 8 | 🌐 Rust | 📅 2026-07-31 - A testing toolkit for CLI applications designed to rigorously test terminal programs, inspired by Cram and focuses on providing a straightforward way to validate CLI behaviour.
...
* [Tokui](https://github.com/zdyxry/tokui) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2026-07-30 - An interactive TUI for visualizing code statistics from tockei.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,055 | 🐛 310 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [add-gitignore](https://github.com/TejasQ/add-gitignore) ⭐ 729 | 🐛 5 | 🌐 JavaScript | 📅 2023-11-20 - Interactively generate a .gitignore for software projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,344 | 🐛 122 | 🌐 Go | 📅 2026-08-08 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,267 | 🐛 489 | 🌐 Go | 📅 2026-08-13 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,826 | 🐛 38 | 🌐 Go | 📅 2026-07-24 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,519 | 🐛 3 | 🌐 Rust | 📅 2026-08-12 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,634 | 🐛 27 | 🌐 Go | 📅 2026-07-27 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,509 | 🐛 144 | 🌐 Go | 📅 2026-08-02 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,177 | 🐛 79 | 🌐 C | 📅 2026-08-09 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,177 | 🐛 79 | 🌐 C | 📅 2026-08-09 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,378 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,289 | 🐛 12 | 🌐 Python | 📅 2024-07-09 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,200 | 🐛 11 | 🌐 Go | 📅 2026-08-03 - TUI for Podman environment.
* [ktop](https://github.com/vladimirvivien/ktop) ⭐ 1,102 | 🐛 11 | 🌐 Go | 📅 2026-07-03 - Tool that displays useful metrics information about nodes, pods, and other workload.
* [sen](https://github.com/TomasTomecek/sen) ⭐ 1,051 | 🐛 35 | 🌐 Python | 📅 2025-08-12 - TUI for containers (manages interactively and inspects containers, dashboard view for containers and images, searching and filtering, real-time updates, tree view of all images).
...
* [Ducker](https://github.com/robertpsoane/ducker) ⭐ 918 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - TUI for managing docker containers.
* [E1S](https://github.com/keidarcy/e1s) ⭐ 917 | 🐛 2 | 🌐 Go | 📅 2026-08-03 - TUI for browsing and managing AWS ECS resources.
* [PUG](https://github.com/leg100/pug) ⭐ 691 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - TUI for Terraform (perform tasks in parallel, manage state resources, calculate costs, automatically loads workspace variable files).
...
* [lazycontainer](https://github.com/andreybleme/lazycontainer) ⭐ 371 | 🐛 9 | 🌐 Go | 📅 2026-08-10 - TUI for managing Apple containers.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,419 | 🐛 329 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,420 | 🐛 72 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,262 | 🐛 80 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,899 | 🐛 311 | 🌐 Python | 📅 2025-10-22 - Command line tool for managing Amazon S3 and CloudFront services.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,907 | 🐛 4 | 🌐 Go | 📅 2026-08-13 - Domain Availability Research Tool.
* [pageres-cli](https://github.com/sindresorhus/pageres-cli) ⭐ 1,742 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-09 - Capture screenshots of websites in various resolutions. A good way to make sure your websites are responsive.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,211 | 🐛 9 | 🌐 Rust | 📅 2026-07-04 - TUI-based HTTP/REST client.
...
* [beachpatrol](https://github.com/sebastiancarlos/beachpatrol) ⭐ 917 | 🐛 4 | 🌐 JavaScript | 📅 2025-10-30 - A CLI tool to replace and automate your everyday web browser.
* [Discharge](https://github.com/brandonweiss/discharge) ⭐ 647 | 🐛 20 | 🌐 JavaScript | 📅 2021-04-09 - Deploy static websites to Amazon S3.
* [ain](https://github.com/jonaslu/ain) ⭐ 622 | 🐛 1 | 🌐 Go | 📅 2025-10-17 - An HTTP API client for the terminal.
...
* [crawley](https://github.com/s0rg/crawley) ⭐ 341 | 🐛 8 | 🌐 Go | 📅 2026-07-31 - Unix-way web crawler: crawls web pages and prints any link it can find.
* [kanha](https://github.com/pwnwriter/kanha) ⭐ 324 | 🐛 7 | 🌐 Rust | 📅 2025-01-08 - A web-app pentesting suite written in Rust.
* [domain-check](https://github.com/saidutt46/domain-check) ⭐ 301 | 🐛 4 | 🌐 Rust | 📅 2026-05-14 - Universal domain exploration engine: fast domain availability checks across the internet.
* [django-tui](https://github.com/anze3db/django-tui) ⭐ 294 | 🐛 1 | 🌐 Python | 📅 2024-10-16 - Inspect and run Django Commands in a text-based user interface (TUI).
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-08-14 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
* [xpe](https://github.com/charmparticle/xpe) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2025-05-12 - A command-line xpath tool that is easy to use.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,008 | 🐛 3 | 🌐 Rust | 📅 2026-08-08 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,183 | 🐛 1,797 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
* [Yai](https://github.com/ekkinox/yai) ⭐ 867 | 🐛 28 | 🌐 Go | 📅 2024-07-31 - Yai (your AI) is an assistant for your terminal, using OpenAI ChatGPT to build and run commands for you.
...
* [just](https://github.com/casey/just) ⭐ 35,295 | 🐛 169 | 🌐 Rust | 📅 2026-08-12 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,303 | 🐛 295 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,614 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,721 | 🐛 82 | 🌐 Python | 📅 2026-08-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 6,998 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
* [Ntfy](https://github.com/dschep/ntfy) ⭐ 4,975 | 🐛 104 | 🌐 Python | 📅 2025-10-27 - Cross-platform Python utility that enables you to automatically get desktop notifications on demand or when long-running commands complete. It can as well send push notifications to your phone once a particular command completes.
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,264 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,031 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
* [sysz](https://github.com/joehillen/sysz) ⭐ 1,883 | 🐛 5 | 🌐 Shell | 📅 2024-04-22 - fzf terminal UI for systemctl.
* [killport](https://github.com/jkfran/killport) ⭐ 1,839 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A command-line tool to easily kill processes running on a specified port.
* [systeroid](https://github.com/orhun/systeroid) ⭐ 1,462 | 🐛 16 | 🌐 Rust | 📅 2026-07-30 - A more powerful alternative to sysctl(8) with a terminal user interface.
* [brightnessctl](https://github.com/Hummer12007/brightnessctl) ⭐ 1,256 | 🐛 24 | 🌐 C | 📅 2024-12-16 - Read and control device brightness. Devices, by default, include backlight and LEDs - searched for in corresponding classes.
* [tufw](https://github.com/peltho/tufw) ⭐ 855 | 🐛 4 | 🌐 Go | 📅 2026-06-08 - Terminal UI for the UFW Linux firewall.
* [immortal](https://github.com/immortal/immortal) ⭐ 837 | 🐛 2 | 🌐 Go | 📅 2026-08-04 - A \*nix cross-platform (OS agnostic) supervisor.
...
* [qman](https://github.com/plp13/qman) ⭐ 594 | 🐛 13 | 🌐 C | 📅 2026-03-17 - A more modern man page viewer for our terminals.
* [damon](https://github.com/hashicorp/damon) ⭐ 486 | 🐛 8 | 🌐 Go | 📅 2026-05-11 - TUI interface for Hashicorp Nomad, it provides functionality to observe and interact with Nomad resources such as Jobs, Deployments, or Allocations.
...
* [dtui](https://github.com/Troels51/dtui) ⭐ 316 | 🐛 1 | 🌐 Rust | 📅 2026-08-06 - Small TUI for introspecting the state of the system/session dbus.
...
* [empiriqa](https://github.com/ynqa/empiriqa) ⭐ 119 | 🐛 5 | 🌐 Rust | 📅 2025-07-11 - empiriqa (command name is epiq) is a tool for interactively manipulating UNIX pipelines.
...
* [Marstui-rustio](https://github.com/schooldanlp6/marstui-rustio) ⭐ 14 | 🐛 3 | 🌐 Rust | 📅 2025-09-30 - A nice audio management Interface, similar to pavucontrol with the benefit of customizing everything.
...
* [diskroaster](https://github.com/favoritelotus/diskroaster) ⭐ 5 | 🐛 0 | 🌐 C | 📅 2025-10-01 - Multi-threaded disk testing utility that writes and verifies data on a raw disk device (designed to stress-test hard drives and SSDs by dividing the disk into sections, writing data in parallel using multiple threads and verifying the written content).
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 59,614 | 🐛 255 | 🌐 Zig | 📅 2026-08-14 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,341 | 🐛 1,806 | 🌐 Rust | 📅 2026-08-12 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,617 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,441 | 🐛 22 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
* [dtach](https://github.com/crigler/dtach) ⭐ 736 | 🐛 20 | 🌐 C | 📅 2025-06-21 - A program written in C that emulates the detach feature of screen.
* [tvterm](https://github.com/magiblot/tvterm) ⭐ 276 | 🐛 8 | 🌐 C++ | 📅 2026-05-12 - A terminal emulator that runs in your terminal (Unix and Windows).
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 34,884 | 🐛 1,858 | 🌐 Rust | 📅 2026-08-13 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,357 | 🐛 20 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,357 | 🐛 20 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
* [mtm](https://github.com/deadpixi/mtm) ⭐ 1,219 | 🐛 43 | 🌐 C | 📅 2024-07-18 - Micro Terminal Multiplexer - Simple but usable, stable and minimalistic terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,260 | 🐛 1,409 | 🌐 Rust | 📅 2026-08-14 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,353 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
* [Oils](https://github.com/oilshell/oil) ⭐ 3,379 | 🐛 610 | 🌐 Python | 📅 2026-05-31 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [Twin](https://github.com/cosmos72/twin) ⭐ 1,053 | 🐛 37 | 🌐 C | 📅 2026-08-03 - Text mode window environment. A "retro" program for embedded or remote systems, that doubles as X11 terminal and text-mode equivalent of VNC server.
* [Cat9](https://github.com/letoram/cat9) ⭐ 529 | 🐛 3 | 🌐 Lua | 📅 2025-05-03 - Cat9 is a user shell script for LASH - a command-line shell that discriminates against terminal emulators, written in Lua.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 276 | 🐛 76 | 🌐 C | 📅 2026-08-14 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [cosh](https://github.com/tomhrr/cosh) ⭐ 137 | 🐛 18 | 🌐 Rust | 📅 2026-01-22 - Concatenative command-line shell.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 52 | 🌐 C++ | 📅 2026-08-13 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,907 | 🐛 152 | 🌐 Shell | 📅 2026-06-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,801 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,385 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,672 | 🐛 29 | 🌐 Shell | 📅 2026-08-13 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
* [geometry](https://github.com/geometry-zsh/geometry) ⭐ 996 | 🐛 13 | 🌐 Shell | 📅 2025-01-13 - A minimalistic, fully customizable Zsh prompt theme with support for asynchronous functions.
...
* [synth-shell-prompt](https://github.com/andresgongora/synth-shell-prompt) ⭐ 62 | 🐛 12 | 🌐 Shell | 📅 2024-06-04 - A small eye-candy shell prompt with Git status displaying, a clock, intelligent $PWD shortening, and much more.
* [blaze](https://github.com/danieltodor/blaze) ⭐ 42 | 🐛 0 | 🌐 C++ | 📅 2026-05-16 - A customizable and informative prompt for bash, zsh, fish, on linux distributions.
* [bashorg-motd](https://github.com/graydot/bashorg-motd) ⭐ 22 | 🐛 0 | 🌐 Shell | 📅 2025-07-17 - More than 10 thousand quotes from the legendary bash\_org archives to see when you open a new terminal.
...
* [yank](https://github.com/mptre/yank) ⭐ 1,706 | 🐛 2 | 🌐 C | 📅 2026-07-16 - Reads input from stdin and display a selection interface that allows a field to be selected and copied to the clipboard.
* [extrakto](https://github.com/laktak/extrakto) ⭐ 1,136 | 🐛 1 | 🌐 Python | 📅 2026-03-02 - extrakto for tmux - quickly select, copy/insert/complete text without a mouse.
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,028 | 🐛 44 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
* [pcopy](https://github.com/binwiederhier/pcopy) ⭐ 421 | 🐛 15 | 🌐 Go | 📅 2024-04-04 - A temporary file host, nopaste and clipboard across machines. It can be used from the Web UI, via a CLI or without a client by using curl.
* [pbproxy](https://github.com/nikvdp/pbproxy) ⭐ 257 | 🐛 0 | 🌐 Shell | 📅 2022-12-30 - Send your clipboard anywhere you can ssh to.
* [shcopy](https://github.com/aymanbagabas/shcopy) ⭐ 85 | 🐛 0 | 🌐 Go | 📅 2026-07-17 - Copy text to your system clipboard locally and remotely using ANSI OSC52 sequence.
...
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,194 | 🐛 69 | 🌐 C | 📅 2026-08-13 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,194 | 🐛 69 | 🌐 C | 📅 2026-08-13 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,801 | 🐛 455 | 🌐 C | 📅 2026-08-05 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,053 | 🐛 101 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,582 | 🐛 106 | 🌐 Go | 📅 2025-07-10 - Cross-platform and fully-customizable TUI dashboard and widget library.
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,625 | 🐛 35 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
* [noti](https://github.com/variadico/noti) ⚠️ Archived - Monitor a process and trigger a notification.
* [screenFetch](https://github.com/KittyKatt/screenFetch) ⭐ 4,068 | 🐛 169 | 🌐 Shell | 📅 2026-03-02 - It can be used to generate one of those nifty terminal theme information + ASCII distribution logos. It auto-detects the distribution and display an ASCII version of that distribution's logo and some valuable information to the right.
* [kmon](https://github.com/orhun/kmon) ⭐ 2,931 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux TUI Kernel manager and activity monitor.
* [CoreFreq](https://github.com/cyring/CoreFreq) ⭐ 2,241 | 🐛 1 | 🌐 C | 📅 2026-08-13 - CPU monitoring TUI software designed for the 64-bits Processors.
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,085 | 🐛 9 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,960 | 🐛 11 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,803 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,635 | 🐛 13 | 🌐 Rust | 📅 2026-07-26 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,084 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,061 | 🐛 29 | 🌐 Go | 📅 2026-08-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [chdig](https://github.com/azat/chdig) ⭐ 291 | 🐛 5 | 🌐 Rust | 📅 2026-08-13 - Dig into ClickHouse with TUI interface.
* [amtui](https://github.com/pehlicd/amtui/) ⭐ 111 | 🐛 4 | 🌐 Go | 📅 2026-06-20 - A terminal-based user interface (TUI) application that allows you to interact with Prometheus Alertmanager using your terminal. It provides a convenient way to monitor alerts, view silences, and check the status of Alertmanager instances.
...
* [tinyfetch](https://github.com/beucismis/tinyfetch) ⚠️ Archived - Python and system information command-line fetch tool.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,388 | 🐛 206 | 🌐 Rust | 📅 2026-08-13 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,054 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,262 | 🐛 88 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
* [upt](https://github.com/sigoden/upt) ⭐ 530 | 🐛 3 | 🌐 Rust | 📅 2024-10-31 - Universal Package-management Tool for any OS.
* [stew](https://github.com/marwanhawari/stew) ⭐ 353 | 🐛 24 | 🌐 Go | 📅 2025-05-06 - An independent package manager for compiled binaries.
* [Shell Bling Ubuntu](https://github.com/hiAndrewQuinn/shell-bling-ubuntu) ⭐ 230 | 🐛 5 | 🌐 Shell | 📅 2026-05-23 - A few scripts to be run on a fresh-off-the-presses Ubuntu VM, in order to get its shell nice 'n purdy.
...
* [getghrel](https://github.com/kavishgr/getghrel) ⭐ 25 | 🐛 0 | 🌐 Go | 📅 2026-01-10 - A user-friendly command-line tool that fetches and installs the latest release assets from GitHub for macOS and Linux; it automatically detects your operating system and architecture, downloads the relevant binary, and unpacks it, ensuring a hassle-free experience.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,453 | 🐛 209 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,461 | 🐛 293 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,817 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,644 | 🐛 64 | 🌐 Shell | 📅 2026-07-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,857 | 🐛 140 | 🌐 Go | 📅 2026-08-09 - Use any Linux distribution inside your terminal as docker or podman containers.
* [bocker](https://github.com/p8952/bocker) ⭐ 12,661 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in around 100 lines of bash.
* [Dockly](https://github.com/lirantal/dockly) ⭐ 4,030 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-23 - Immersive terminal interface for managing docker containers, services, and images.
* [dry](https://github.com/moncho/dry) ⭐ 3,266 | 🐛 27 | 🌐 Go | 📅 2026-04-09 - A Docker manager for the terminal.
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,071 | 🐛 57 | 🌐 Go | 📅 2026-08-09 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,799 | 🐛 24 | 🌐 Rust | 📅 2026-07-24 - A simple TUI to view & control docker containers.
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 595 | 🐛 16 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,316 | 🐛 116 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,289 | 🐛 19 | 🌐 Rust | 📅 2026-07-28 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,650 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,692 | 🐛 66 | 🌐 Rust | 📅 2026-07-20 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,672 | 🐛 20 | 🌐 Go | 📅 2026-08-01 - TUI for running apps and processes.
* [Marker](https://github.com/pindexis/marker) ⭐ 2,092 | 🐛 49 | 🌐 Python | 📅 2024-04-06 - The terminal command palette.
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,499 | 🐛 6 | 🌐 Go | 📅 2026-08-08 - Executing shell commands via HTTP server.
* [Steam TUI](https://github.com/dmadisetti/steam-tui) ⭐ 1,030 | 🐛 9 | 🌐 Rust | 📅 2026-03-12 - A simple TUI client for steamcmd, allows for the graphical launching, updating, and downloading of steam games through a simple terminal client.
* [sake](https://github.com/alajmo/sake) ⭐ 749 | 🐛 16 | 🌐 Go | 📅 2026-05-31 - A command runner for local and remote hosts. You define servers and tasks in sake.yaml file and then run the tasks on the servers.
* [sunbeam](https://github.com/pomdtr/sunbeam) ⭐ 552 | 🐛 10 | 🌐 Go | 📅 2025-05-30 - General purpose command-line launcher that defines UIs composed of a succession of views from simple scripts written in any language; a mix between an application launcher like `raycast` or `rofi` and a fuzzy-finder like `fzf` or `telescope`.
...
* [procmux](https://github.com/napisani/procmux) ⭐ 110 | 🐛 2 | 🌐 Python | 📅 2025-11-23 - A TUI utility for running multiple commands in parallel in easily switchable terminals.
...
* [paneru](https://github.com/pondda/paneru) ⭐ 41 | 🐛 0 | 🌐 C++ | 📅 2025-10-01 - Launcher panel from the terminal.
* [climenu](https://github.com/10xJSChad/climenu) ⭐ 40 | 🐛 0 | 🌐 C | 📅 2025-11-10 - Compact application for creating shell menus with executable entries. Use it to build straightforward static shortcut menus or dynamically generate advanced menus for more complex programs.
...
* [dotbins](https://github.com/basnijholt/dotbins) ⭐ 270 | 🐛 28 | 🌐 Python | 📅 2026-08-12 - Keep updated binaries in your dotfiles.
...
* [fyora](https://github.com/wenbang24/fyora) ⭐ 15 | 🐛 0 | 🌐 Go | 📅 2025-09-21 - Intuitive declarative dotfile management.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,883 | 🐛 3 | 🌐 Rust | 📅 2026-08-14 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,016 | 🐛 14 | 🌐 Rust | 📅 2026-08-13 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,016 | 🐛 14 | 🌐 Rust | 📅 2026-08-13 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,885 | 🐛 27 | 🌐 Go | 📅 2026-08-12 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,233 | 🐛 213 | 🌐 TypeScript | 📅 2026-08-13 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 879 | 🐛 4 | 🌐 Rust | 📅 2026-08-13 - Terminal mail client.
* [alot](https://github.com/pazz/alot) ⭐ 753 | 🐛 225 | 🌐 Python | 📅 2026-07-29 - MUA written in Python using the [NotMuch](https://notmuchmail.org/) backend, MailDir format support.
* [mailsy](https://github.com/BalliAsghar/Mailsy.git) ⭐ 596 | 🐛 1 | 🌐 JavaScript | 📅 2024-12-03 - Generates disposable emails in the CLI through [mail.tm](https://mail.tm).
...
* [nmail](https://github.com/d99kris/nmail) ⭐ 254 | 🐛 0 | 🌐 C++ | 📅 2026-08-08 - nmail is a console-based email client for Linux and macOS with a user interface similar to alpine / pine.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,151 | 🐛 1,188 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
* [slack-term](https://github.com/erroneousboat/slack-term) ⭐ 6,608 | 🐛 68 | 🌐 Go | 📅 2024-04-23 - Slack client for the  terminal.
* [ssh-chat](https://github.com/shazow/ssh-chat) ⭐ 5,905 | 🐛 54 | 🌐 Go | 📅 2026-01-10 - Custom SSH server written in Go. Instead of a shell, you get a chat prompt.
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,729 | 🐛 53 | 🌐 Go | 📅 2026-08-13 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,861 | 🐛 102 | 🌐 Java | 📅 2026-08-10 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
* [devzat](https://github.com/quackduck/devzat) ⭐ 4,063 | 🐛 26 | 🌐 Go | 📅 2026-07-23 - Custom SSH server that takes you to a chat instead of a shell prompt.
* [Sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,482 | 🐛 44 | 🌐 Python | 📅 2022-12-08 - CLI client for Slack.
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,112 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-01 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,912 | 🐛 21 | 🌐 C++ | 📅 2026-08-08 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,707 | 🐛 73 | 🌐 Go | 📅 2026-08-12 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,360 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,323 | 🐛 127 | 🌐 Python | 📅 2026-07-04 - Mastodon CLI & TUI.
* [toxic](https://github.com/Jfreegman/toxic) ⭐ 1,301 | 🐛 19 | 🌐 C | 📅 2026-07-14 - A Tox-based instant messaging and video chat client.
* [tiny](https://github.com/osa1/tiny) ⭐ 1,179 | 🐛 94 | 🌐 Rust | 📅 2026-03-19 - tiny is an IRC client written in Rust.
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,150 | 🐛 22 | 🌐 Haskell | 📅 2026-08-13 - A terminal client for the Mattermost chat system.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 985 | 🐛 15 | 🌐 Rust | 📅 2026-08-10 - A TUI for Telegram written in Rust.
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 938 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 853 | 🐛 483 | 🌐 Python | 📅 2026-08-03 - Official Zulip terminal client with TUI.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 748 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [ZUSE](https://github.com/babycommando/zuse) ⭐ 320 | 🐛 1 | 🌐 Go | 📅 2025-07-28 - Minimal IRC client for the terminal written in Go with Bubbletea.
...
* [Gomphotherium](https://github.com/mrusme/gomphotherium) ⭐ 108 | 🐛 1 | 🌐 Go | 📅 2026-07-03 - A command line Mastodon client, offering a CLI and TUI with usage similar to rainbowstream; Intended to be used at 80 characters width maximum, ideally inside tmux as a sidebar-style program.
* [Servitor](https://github.com/bentonedmondson/servitor) ⭐ 82 | 🐛 2 | 🌐 Go | 📅 2024-07-22 - A command-line Fediverse client that doesn’t require a server.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 67 | 🐛 4 | 🌐 Rust | 📅 2026-08-11 - TUI client for Nostr.
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,543 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Turn CLI tools into web applications; basically, it runs a command and starts a server so that the output can be displayed in a web page.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,196 | 🐛 111 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,896 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,390 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,716 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,479 | 🐛 58 | 🌐 Rust | 📅 2026-08-02 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,894 | 🐛 150 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,658 | 🐛 157 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,647 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,481 | 🐛 79 | 🌐 Rust | 📅 2026-08-13 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,083 | 🐛 41 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,065 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,100 | 🐛 47 | 🌐 C | 📅 2026-08-02 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,064 | 🐛 32 | 🌐 C | 📅 2026-08-08 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,848 | 🐛 16 | 🌐 Rust | 📅 2026-08-13 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,696 | 🐛 20 | 🌐 Rust | 📅 2026-03-09 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
* [tproxy](https://github.com/kevwan/tproxy) ⭐ 3,695 | 🐛 6 | 🌐 Go | 📅 2026-07-09 - A CLI tool to proxy and analyze TCP connections.
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,334 | 🐛 136 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,687 | 🐛 34 | 🌐 Go | 📅 2026-08-08 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,554 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - TUI for sniffing network traffic using eBPF on Linux.
* [gg](https://github.com/mzz2017/gg) ⭐ 1,929 | 🐛 48 | 🌐 Go | 📅 2026-07-06 - A command-line tool for one-click proxy in your research and development without installing v2ray or anything else.
* [asn](https://github.com/nitefood/asn) ⭐ 1,918 | 🐛 3 | 🌐 Shell | 📅 2026-06-22 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,811 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
* [Wishlist](https://github.com/charmbracelet/wishlist) ⭐ 1,646 | 🐛 19 | 🌐 Go | 📅 2026-08-12 - With Wishlist you can have a single entrypoint for multiple SSH endpoints.
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,567 | 🐛 25 | 🌐 Rust | 📅 2026-07-09 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,543 | 🐛 15 | 🌐 Rust | 📅 2026-08-13 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,379 | 🐛 38 | 🌐 C | 📅 2026-08-03 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,226 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,203 | 🐛 72 | 🌐 C | 📅 2026-08-11 - Ncurses SIP Messages flow viewer.
...
* [ggh](https://github.com/byawitz/ggh) ⭐ 946 | 🐛 26 | 🌐 Go | 📅 2026-02-10 - Recall your SSH sessions, also searching your SSH config file.
* [Rustcat](https://github.com/robiot/rustcat) ⭐ 810 | 🐛 4 | 🌐 Rust | 📅 2024-07-20 - Netcat Alternative in Rust.
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 712 | 🐛 10 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 525 | 🐛 0 | 🌐 Go | 📅 2026-07-25 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [havn](https://github.com/mrjackwills/havn) ⭐ 318 | 🐛 2 | 🌐 Rust | 📅 2026-07-15 - A fast configurable port scanner with reasonable defaults.
* [packemon](https://github.com/ddddddO/packemon) ⭐ 305 | 🐛 34 | 🌐 Go | 📅 2026-07-31 - TUI tool and Go library for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).
...
* [neoss](https://github.com/PabloLec/neoss) ⭐ 229 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-10 - User-friendly and detailed socket statistics with a Terminal UI.
...
* [sshsync](https://github.com/Blackmamoth/sshsync) ⭐ 158 | 🐛 3 | 🌐 Python | 📅 2025-06-18 - Fast and minimal CLI tool to run shell commands across multiple remote servers via SSH.
* [humble-explorer](https://github.com/koenvervloesem/humble-explorer) ⭐ 83 | 🐛 0 | 🌐 Python | 📅 2023-11-25 - Cross-platform, command-line and human-friendly Bluetooth Low Energy scanner.
...
* [SMBScan](https://github.com/jeffhacks/smbscan) ⭐ 49 | 🐛 19 | 🌐 Python | 📅 2026-06-22 - SMBScan is a tool to enumerate file shares on an internal network.
...
* [netdump](https://github.com/giorgiopapini/netdump) ⭐ 35 | 🐛 1 | 🌐 C | 📅 2025-09-01 - A simple network packet analyzer using libpcap, supporting both real-time and offline analysis with ASCII visualization.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,929 | 🐛 20 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,775 | 🐛 6 | 🌐 Rust | 📅 2026-05-21 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,379 | 🐛 11 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [ssm](https://github.com/lfaoro/ssm) ⭐ 112 | 🐛 15 | 🌐 Go | 📅 2026-08-10 - SSH connection manager designed to connect, filter, tag, and much more from a simple terminal interface.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 184,333 | 🐛 2,606 | 🌐 Python | 📅 2026-08-04 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,957 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,711 | 🐛 1,158 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 39,731 | 🐛 7 | 🌐 Go | 📅 2026-08-12 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,622 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,814 | 🐛 178 | 🌐 Python | 📅 2026-07-26 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,207 | 🐛 1,156 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,013 | 🐛 38 | 🌐 Rust | 📅 2026-07-26 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 7,927 | 🐛 210 | 🌐 Go | 📅 2026-08-10 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,620 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,709 | 🐛 25 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,529 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,043 | 🐛 6 | 🌐 Rust | 📅 2026-07-29 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [Yark](https://github.com/Owez/yark) ⭐ 2,181 | 🐛 21 | 🌐 Python | 📅 2026-07-30 - YouTube archiving made simple.
* [sharing](https://github.com/parvardegr/sharing) ⭐ 1,841 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-17 - Sharing is a command-line tool to share directories and files from the CLI to iOS and Android devices without the need of an extra client app.
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,763 | 🐛 29 | 🌐 Go | 📅 2024-08-20 - A quick and easy command-line file transfer utility from any computer to another.
...
* [downloader-cli](https://github.com/deepjyoti30/downloader-cli) ⭐ 468 | 🐛 3 | 🌐 Python | 📅 2023-11-23 - A simple downloader written in Python with an awesome customizable progress bar.
...
* [tshare](https://github.com/trikko/tshare) ⭐ 141 | 🐛 0 | 🌐 D | 📅 2023-12-13 - The fastest way to share your files on the web, for free.
...
* [shbin](https://github.com/Shiphero/shbin) ⭐ 68 | 🐛 17 | 🌐 Python | 📅 2025-04-22 - Upload code snippets, notebooks, images or any other content to a GitHub repository that acts as your internal pastebin, and returns the URL to share it with your team.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,839 | 🐛 403 | 🌐 C++ | 📅 2026-08-13 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,212 | 🐛 18 | 🌐 Python | 📅 2026-08-10 - A Python tool that lets you find and download torrents without leaving your CLI.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 691 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
* [Stig](https://github.com/rndusr/stig) ⭐ 627 | 🐛 52 | 🌐 Python | 📅 2026-01-24 - Stig is a client application to connect and control the BitTorrent Transmission client app.
...
* [toru](https://github.com/sweetbbak/toru) ⭐ 385 | 🐛 1 | 🌐 Go | 📅 2024-10-24 - BitTorrent streaming CLI tool to stream anime torrents in real-time with no waiting for downloads.
* [Transgression TUI](https://github.com/PanAeon/transg-tui) ⭐ 108 | 🐛 6 | 🌐 Rust | 📅 2026-03-02 - A remote TUI client for the Transmission BitTorrent program.
...
* [nom](https://github.com/guyfedwards/nom) ⭐ 738 | 🐛 33 | 🌐 Go | 📅 2026-07-08 - RSS reader for the terminal.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,342 | 🐛 89 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
* [s](https://github.com/zquestz/s) ⭐ 2,593 | 🐛 0 | 🌐 Go | 📅 2026-07-27 - Web search from the terminal. Just opens in your browser.
* [Amfora](https://github.com/makew0rld/amfora) ⭐ 1,349 | 🐛 10 | 🌐 Go | 📅 2026-07-03 - Amfora aims to be the best looking Gemini client with the most features. It does not support Gopher or other non-Web protocols.
* [Graphene](https://github.com/atsepkov/Graphene) ⭐ 74 | 🐛 1 | 🌐 JavaScript | 📅 2019-08-30 - A text-based web browser that's a joy to use.
* [gplaces](https://github.com/dimkr/gplaces) ⭐ 48 | 🐛 1 | 🌐 C | 📅 2026-06-18 - Simple but powerful terminal Gemini client.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,902 | 🐛 163 | 🌐 Go | 📅 2026-08-12 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,523 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,813 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
* [so](https://github.com/samtay/so) ⭐ 1,422 | 🐛 19 | 🌐 Rust | 📅 2025-06-30 - Terminal interface for Stack Overflow.
* [socli](https://github.com/gautamkrishnar/socli) ⭐ 1,112 | 🐛 11 | 🌐 Python | 📅 2026-03-30 - Stack overflow command line client written in Python. Search and browse stack overflow without leaving the terminal
* [STU](https://github.com/lusingander/stu) ⭐ 905 | 🐛 15 | 🌐 Rust | 📅 2026-04-30 - S3 Terminal UI, is a interactive terminal-based explorer for Amazon S3 (AWS S3).
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 796 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
* [wiki-tui](https://github.com/Builditluc/wiki-tui) ⚠️ Archived - A simple and easy to use Wikipedia Text User Interface.
* [Neon Modem Overdrive](https://github.com/mrusme/neonmodem) ⭐ 699 | 🐛 21 | 🌐 Go | 📅 2026-07-21 - The program allows you to manage and read content from various popular platforms without having to use a browser or separate apps.
* [av](https://github.com/aviator-co/av) ⭐ 507 | 🐛 75 | 🌐 Go | 📅 2026-08-14 - A command line tool to manage stacked PRs with Aviator.
* [pockyt](https://github.com/achembarpu/pockyt) ⭐ 499 | 🐛 5 | 🌐 Python | 📅 2024-04-25 - Read, manage, and automate the collection of articles in [Pocket](https://getpocket.com), an application for managing a reading list of articles from the Internet.
...
* [Awesome Finder](https://github.com/mingrammer/awesome-finder) ⭐ 284 | 🐛 9 | 🌐 Python | 📅 2022-12-08 - Search the awesome lists from the command line.
* [Fjira](https://github.com/mk-5/fjira) ⭐ 275 | 🐛 22 | 🌐 Go | 📅 2026-07-07 - The fuzziest Jira command line tool in the world.
...
* [IMDb Terminal Browser](https://github.com/isene/IMDB) ⭐ 76 | 🐛 0 | 🌐 Ruby | 📅 2026-04-11 - Ruby-based terminal application for discovering and managing movies and TV series from IMDb's Top lists.
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-14 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [taskbook](https://github.com/klaudiosinani/taskbook) ⭐ 9,339 | 🐛 101 | 🌐 JavaScript | 📅 2025-11-03 - Tasks, boards & notes for the command-line habitat.
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,933 | 🐛 26 | 🌐 Python | 📅 2026-07-02 - Todo manager with interactive and beautiful UI, and vim keybindings.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,106 | 🐛 129 | 🌐 Rust | 📅 2026-08-10 - A terminal user interface for taskwarrior.
* [grit](https://github.com/climech/grit) ⭐ 1,700 | 🐛 19 | 🌐 Go | 📅 2021-09-01 - A multitree-based personal task manager.
...
* [xit](https://github.com/jotaen/xit) ⭐ 1,120 | 🐛 0 | 📅 2024-01-27 - A plain-text file format for todos and check lists. So, not really a program, but I believe it is worth to list :-)
* [topydo](https://github.com/topydo/topydo) ⭐ 934 | 🐛 81 | 🌐 Python | 📅 2026-03-18 - A powerful todo list application for the console, using the todo.txt format.
* [t](https://github.com/sjl/t) ⭐ 808 | 🐛 10 | 🌐 Python | 📅 2023-10-27 - A command-line todo list manager for people that want to finish tasks, not organize them.
* [Todoman](https://github.com/pimutils/todoman) ⭐ 588 | 🐛 113 | 🌐 Python | 📅 2026-05-25 - A simple, standards-based, CLI todo (aka: task) manager.
...
* [omm](https://github.com/dhth/omm) ⭐ 329 | 🐛 11 | 🌐 Go | 📅 2026-08-05 - "on-my-mind" is a keyboard-driven task manager for the command line.
...
* [TODO-CLI-and-TUI](https://github.com/Harsh-bin/TODO-CLI-and-TUI) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2025-05-06 - A small todo app which is both "TUI" and "CLI" based on gum with features like adding tasks for day, week or months, setting target date, adding notes, reward window and many more.
...
* [dijo](https://github.com/NerdyPepper/dijo) ⭐ 2,917 | 🐛 36 | 🌐 Rust | 📅 2024-08-13 - Scriptable, curses-based, digital habit tracker.
* [Watson](https://github.com/TailorDev/Watson) ⭐ 2,536 | 🐛 141 | 🌐 Python | 📅 2025-12-15 - Time tracking CLI to know how much time you are spending on your projects. It can generate nice reports for clients.
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,639 | 🐛 125 | 🌐 C++ | 📅 2026-08-08 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,375 | 🐛 6 | 🌐 Shell | 📅 2026-05-10 - A feature-rich clock/ timer/ pattern-based time manager in terminal with curated text-art.
...
* [Bartib](https://github.com/nikolassv/bartib) ⭐ 842 | 🐛 19 | 🌐 Rust | 📅 2026-03-25 - Easy to use time tracking tool for the command line. It saves a log of all tracked activities as a plain-text file and allows you to create flexible reports.
...
* [tim:r](https://github.com/sectore/timr) ⭐ 367 | 🐛 1 | 🌐 Rust | 📅 2026-07-12 - A TUI for organizing your time: Pomodoro Countdown counter.
...
* [hours](https://github.com/dhth/hours) ⭐ 346 | 🐛 16 | 🌐 Go | 📅 2026-08-07 - A no-frills time tracking toolkit for command line nerds.
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - Simple timer for the terminal with timer-mode and alarm.
...
* [Timer-CLI](https://github.com/1Blademaster/timer-cli) ⭐ 59 | 🐛 12 | 🌐 Python | 📅 2026-01-10 - A very simple countdown timer.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,353 | 🐛 150 | 🌐 Shell | 📅 2026-08-13 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,291 | 🐛 149 | 🌐 Python | 📅 2026-08-13 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,414 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,053 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,759 | 🐛 24 | 🌐 Go | 📅 2026-08-03 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 873 | 🐛 8 | 🌐 Rust | 📅 2023-11-04 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 770 | 🐛 24 | 🌐 Rust | 📅 2026-08-01 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 523 | 🐛 2 | 🌐 Rust | 📅 2026-07-30 - Terminal-based markdown note manager.
...
* [Captain's Log](https://github.com/NikolaDucak/caps-log) ⭐ 391 | 🐛 15 | 🌐 C++ | 📅 2026-07-13 - A small TUI journaling tool (daily entries saved as md files, tags for organizing entries, browse tags, calendar view, encrypted logs, storage using a git repository).
...
* [buku](https://github.com/jarun/buku) ⭐ 7,177 | 🐛 6 | 🌐 Python | 📅 2026-08-04 - A powerful bookmark manager written in Python3 and SQLite3.
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,755 | 🐛 171 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,040 | 🐛 263 | 🌐 Python | 📅 2026-08-10 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,859 | 🐛 222 | 🌐 Python | 📅 2026-07-10.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,331 | 🐛 8 | 🌐 Python | 📅 2026-06-17 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,859 | 🐛 222 | 🌐 Python | 📅 2026-07-10 - CalDAV synchronization program.
* [tz](https://github.com/oz/tz) ⭐ 896 | 🐛 8 | 🌐 Go | 📅 2025-02-14 - tz helps you schedule things across time zones. It's an interactive TUI program that displays time across the time zones of your choosing.
* [khard](https://github.com/lucc/khard) ⭐ 670 | 🐛 34 | 🌐 Python | 📅 2026-06-20 - vCard address book written in Python. Supports CardDAV.
...
* [plann](https://github.com/tobixen/plann) ⭐ 81 | 🐛 10 | 🌐 Python | 📅 2026-06-15 - Command-line interface to online calendars.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,191 | 🐛 36 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,869 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
* [mop](https://github.com/mop-tracker/mop) ⭐ 2,199 | 🐛 6 | 🌐 Go | 📅 2025-12-28 - Stock market tracker for hackers.
* [Invoice](https://github.com/maaslalani/invoice) ⭐ 2,191 | 🐛 25 | 🌐 Go | 📅 2024-06-18 - Generate invoices from the command line.
* [Puffin](https://github.com/siddhantac/puffin) ⭐ 566 | 🐛 11 | 🌐 Go | 📅 2026-03-11 - A beautiful TUI dashboard for hledger.
* [cash-cli](https://github.com/xxczaki/cash-cli) ⭐ 266 | 🐛 16 | 🌐 JavaScript | 📅 2026-04-30 - Convert Currency Rates.
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 261 | 🐛 11 | 🌐 Rust | 📅 2026-08-05 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
* [abandon](https://github.com/hrj/abandon) ⭐ 185 | 🐛 33 | 🌐 Scala | 📅 2026-08-12 - A text based, double-entry accounting system inspired by Ledger with infinite precision arithmetic. Made in Java. Includes a GUI.
* [stocksTUI](https://github.com/andriy-git/stocksTUI) ⭐ 156 | 🐛 2 | 🌐 Python | 📅 2026-07-09 - StocksTUI: Real-time stock market data in your terminal.
...
* [Lakshmi](https://github.com/sarvjeets/lakshmi) ⭐ 148 | 🐛 0 | 🌐 Python | 📅 2026-08-11 - Investing library and command-line interface inspired by the Bogleheads philosophy.
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 90 | 🐛 5 | 🌐 Rust | 📅 2026-08-10 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,512 | 🐛 832 | 🌐 TypeScript | 📅 2026-08-14 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,430 | 🐛 61 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,349 | 🐛 94 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [tenere](https://github.com/pythops/tenere) ⭐ 679 | 🐛 10 | 🌐 Rust | 📅 2026-05-10 - A TUI for LLMs (ChatGPT, llama\_cpp, ollama) written in Rust.
...
* [parllama](https://github.com/paulrobello/parllama) ⭐ 484 | 🐛 4 | 🌐 Python | 📅 2026-07-11 - TUI designed for easy management and use of Ollama based LLMs.
...
* [termite](https://github.com/shobrook/termite) ⭐ 418 | 🐛 7 | 🌐 Python | 📅 2025-01-06 - Generative UI in your terminal.
...
* [cai](https://github.com/ad-si/cai) ⭐ 202 | 🐛 6 | 🌐 Rust | 📅 2026-08-09 - The fastest CLI tool for prompting LLMs. Including support for prompting several LLMs at once!
* [clevercli](https://github.com/clevercli/clevercli) ⚠️ Archived - ChatGPT powered CLI utilities. Easily add new prompt types.
* [hns](https://github.com/primaprashant/hns) ⭐ 115 | 🐛 4 | 🌐 Python | 📅 2026-07-21 - A privacy-focused open-source command-line tool for on-device speech-to-text. It records your voice, transcribes it completely locally using faster-whisper, and automatically copies the text to clipboard for immediate use in any application.
...
* [Context Extractor](https://github.com/vaibhav-mattoo/cxt) ⭐ 50 | 🐛 1 | 🌐 Rust | 📅 2026-07-27 - Command line tool that aggregates file and directory contents into the clipboard, for providing project context to AI chatbots in the browser like ChatGPT and Perplexity.
* [Browser CLI](https://github.com/browsemake/browser-cli) ⭐ 45 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-09 - AI agent browser automation tool.
...
* [Alibaba-CLI-Scraper](https://github.com/poneoneo/Alibaba-CLI-Scraper) ⭐ 36 | 🐛 0 | 🌐 Python | 📅 2024-09-24 - Create your own Alibaba dataset and interact with it in plain English.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,053 | 🐛 101 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
* [h-m-m](https://github.com/nadrad/h-m-m) ⭐ 2,281 | 🐛 4 | 🌐 PHP | 📅 2026-07-06 - h-m-m (pronounced like the interjection "hmm") is a simple, fast, keyboard-centric terminal-based tool for working with mind maps.
...
* [speedread](https://github.com/pasky/speedread) ⭐ 1,255 | 🐛 13 | 🌐 Perl | 📅 2024-06-11 - A simple terminal-based open source Spritz-alike filter that shows input text as a per-word RSVP (rapid serial visual presentation) aligned on optimal reading points.
* [Sinkzone](https://github.com/berbyte/sinkzone) ⭐ 345 | 🐛 4 | 🌐 Go | 📅 2026-07-16 - Application that blocks everything by default unless you explicitly allow it; A DNS tool for productivity, focus, and child safety.
...
* [telert](https://github.com/navig-me/telert) ⭐ 286 | 🐛 8 | 🌐 Python | 📅 2026-08-07 - Lightweight CLI and Python utility that sends alerts (Telegram, Slack, Teams, Desktop, Audio) when commands complete.
* [ancv](https://github.com/alexpovel/ancv) ⭐ 268 | 🐛 3 | 🌐 Python | 📅 2026-08-04 - Renders your (JSON) resume/CV for online & pretty terminal display.
* [DDQA](https://github.com/DataDog/ddqa) ⭐ 109 | 🐛 3 | 🌐 Python | 📅 2026-08-12 - Jira TUI to help with software releasestool for users of Jira to perform QA of anticipated releases of code on GitHub.
...
* [hnjobs](https://github.com/mwinters0/hnjobs) ⭐ 37 | 🐛 0 | 🌐 Go | 📅 2025-09-10 - Console tool to find the best match on Who's Hiring.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,612 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,763 | 🐛 74 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,315 | 🐛 173 | 🌐 C++ | 📅 2026-08-13 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
* [mdp](https://github.com/visit1985/mdp) ⭐ 5,273 | 🐛 12 | 🌐 C | 📅 2025-07-09 - A command-line based Markdown presentation tool.
...
* [Lotus 1-2-3 for Linux](https://github.com/taviso/123elf) ⭐ 1,281 | 🐛 40 | 🌐 C | 📅 2026-06-27 - A native port of Lotus 1-2-3 Release 3 to Linux.
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-08-13 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
* [pysentation](https://github.com/mimseyedi/pysentation) ⭐ 263 | 🐛 2 | 🌐 Python | 📅 2025-03-18 - pysentation is a CLI for displaying Python presentations.
* [SheetsUI](https://github.com/zaphar/sheetsui) ⭐ 245 | 🐛 3 | 🌐 Rust | 📅 2026-03-03 - A console based (TUI) spreadsheet application.
...
* [tui-slides](https://github.com/Chleba/tui-slides) ⭐ 82 | 🐛 2 | 🌐 Rust | 📅 2024-09-12 - TerminalpPresentation program with modern TUI.
...
* [alex](https://github.com/get-alex/alex) ⭐ 5,097 | 🐛 28 | 🌐 JavaScript | 📅 2024-11-27 - Catch insensitive, inconsiderate writing, by finding gender favoring, polarizing, race related, or other unequal phrasing in text.
* [write good](https://github.com/btford/write-good) ⭐ 5,077 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English prose.
* [sdcv](https://github.com/Dushistov/sdcv) ⭐ 364 | 🐛 43 | 🌐 C++ | 📅 2025-12-17 - Simple, cross-platform, text-based utility for working with dictionaries in StarDict format.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 156 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [rdict](https://github.com/Lodobo/rdict) ⭐ 21 | 🐛 2 | 🌐 Rust | 📅 2024-11-27 - Offline dictionary using data from wiktionary written in Rust.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,640 | 🐛 124 | 🌐 Rust | 📅 2026-03-13 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,906 | 🐛 40 | 🌐 Rust | 📅 2026-07-10 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 718 | 🐛 13 | 🌐 C | 📅 2026-05-17 - Base conversion and bit manipulator in ncurses.
* [bcal](https://github.com/jarun/bcal) ⭐ 697 | 🐛 0 | 🌐 C | 📅 2026-07-03 - Byte CALculator - A REPL CLI utility for storage expression evaluation, SI/IEC conversion, byte address calculation, base conversion and LBA/CHS calculation.
...
* [pdd](https://github.com/jarun/pdd) ⭐ 406 | 🐛 0 | 🌐 Python | 📅 2026-07-03 - Tiny date, time diff calculator.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,685 | 🐛 454 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,425 | 🐛 109 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,421 | 🐛 16 | 🌐 Rust | 📅 2026-08-12 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,323 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
* [Nap](https://github.com/maaslalani/nap) ⭐ 2,218 | 🐛 17 | 🌐 Go | 📅 2024-05-18 - Code snippet manager that allows creating and access new snippets quickly with the command-line interface or browse, manage, and organize them with the text-user interface.
* [eg](https://github.com/srsudar/eg) ⭐ 2,040 | 🐛 15 | 🌐 Python | 📅 2025-02-06 - Useful examples at the command line.
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,920 | 🐛 81 | 🌐 Go | 📅 2026-08-13 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,271 | 🐛 5 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
* [halp](https://github.com/orhun/halp) ⭐ 764 | 🐛 5 | 🌐 Rust | 📅 2026-08-01 - halp aims to help find the correct arguments for command-line tools by checking the predefined list of commonly used options/flags.
* [Wat](https://github.com/dthree/wat) ⭐ 509 | 🐛 18 | 🌐 JavaScript | 📅 2016-09-18 - Instant, central, community-built docs.
* [gocheat](https://github.com/Achno/gocheat) ⭐ 340 | 🐛 8 | 🌐 Go | 📅 2025-10-26 - Customizable TUI cheatsheet for keybindings, hotkeys, gestures and aliases.
* [docfd](https://github.com/darrenldl/docfd) ⭐ 288 | 🐛 4 | 🌐 OCaml | 📅 2026-07-20 - TUI fuzzy document finder that looks for documentation files in Markdown and txt format in the directory tree.
* [bkmr](https://github.com/sysid/bkmr) ⭐ 261 | 🐛 0 | 🌐 Rust | 📅 2026-07-12 - A unified CLI tool for bookmark, snippet, and knowledge management.
* [MUC](https://github.com/nate-sys/muc) ⚠️ Archived - Visualize your most used commands.
* [cheatshh](https://github.com/AnirudhG07/cheatshh) ⭐ 188 | 🐛 0 | 🌐 Shell | 📅 2025-08-15 - A fzf based cheatsheet to store commands and their descriptions in a place you can look into so you dont have to remember them.
* [tome](https://github.com/laktak/tome) ⭐ 174 | 🐛 1 | 🌐 Vim Script | 📅 2026-08-13 - Interactive Script playbooks for your terminal with Vim/Neovim (and Tmux).
* [snipt](https://github.com/snipt/snipt) ⭐ 149 | 🐛 5 | 🌐 Rust | 📅 2026-04-02 - Snipt is a powerful text snippet expansion tool.
* [alman](https://github.com/vaibhav-mattoo/alman) ⭐ 90 | 🐛 3 | 🌐 Rust | 📅 2026-06-17 - TUI for managing shell aliases with intelligent suggestions based on you command history (organize, create and manage aliases across multiple files and shells).
...
* [fzf-help](https://github.com/BartSte/fzf-help) ⭐ 60 | 🐛 1 | 🌐 Shell | 📅 2025-03-22 - An fzf extension that allows you to select command line options of a given command; the options are retrieved from the command its `--help` documentation.
...
* [wut](https://github.com/shobrook/wut) ⭐ 1,426 | 🐛 18 | 🌐 Python | 📅 2024-12-20 - An terminal assistant for the hopelessly confused; it explains the meaning of the output from the last command.
* [zev](https://github.com/dtnewman/zev) ⭐ 720 | 🐛 3 | 🌐 Python | 📅 2026-06-17 - A simple CLI tool to generate terminal commands using AI.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 106 | 🐛 2 | 🌐 Rust | 📅 2026-08-12 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 10 | 🐛 0 | 🌐 Zig | 📅 2026-08-13 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 24,917 | 🐛 544 | 🌐 Go | 📅 2026-08-12 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,629 | 🐛 255 | 🌐 JavaScript | 📅 2026-08-13 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,216 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,447 | 🐛 36 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,128 | 🐛 57 | 🌐 C | 📅 2026-07-26 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,300 | 🐛 27 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
* [GiF for CLI](https://github.com/google/gif-for-cli) ⚠️ Archived - Convert a GIF, short video or a query into ASCII art.
* [gowall](https://github.com/Achno/gowall) ⭐ 2,298 | 🐛 13 | 🌐 Go | 📅 2026-06-10 - A tool to convert a Wallpaper's color scheme / palette, image to pixel art, color palette extraction, image upsacling with Adversarial Networks  and more image processing features.
* [Diagon](https://github.com/ArthurSonzogni/Diagon) ⭐ 2,216 | 🐛 21 | 🌐 C++ | 📅 2025-05-16 - Diagon is an interactive interpreter, that transforms Markdown-style expression into an ASCII-art representation.
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,005 | 🐛 37 | 🌐 C | 📅 2026-04-01 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,783 | 🐛 4 | 🌐 Python | 📅 2026-08-11 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [imgp](https://github.com/jarun/imgp) ⭐ 1,090 | 🐛 0 | 🌐 Python | 📅 2026-07-03 - A command line image resizer and rotator for JPEG and PNG images. It can resize (or thumbnail) and rotate thousands of images in a go, at lightning speed, while saving significantly on storage.
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 987 | 🐛 16 | 🌐 Python | 📅 2026-08-11 - AI-Powered Command-Line Photo Search Tool.
...
* [figma-use](https://github.com/dannote/figma-use) ⭐ 592 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-03 - Control Figma from the command line with full read/write access for AI agents.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 413 | 🐛 3 | 🌐 Rust | 📅 2026-08-12 - A powerful Rust image optimization CLI tool.
...
* [Artem](https://github.com/FineFindus/artem) ⭐ 341 | 🐛 1 | 🌐 HTML | 📅 2025-06-15 - Convert images from multiple formats (JPG, PNG, WEBP, etc.) to ASCII art, written in Rust.
...
* [objcurses](https://github.com/admtrv/objcurses) ⭐ 230 | 🐛 3 | 🌐 C++ | 📅 2025-05-24 - ncurses 3d object viewer.
...
* [img2ascii](https://github.com/JosefVesely/Image-to-ASCII) ⭐ 73 | 🐛 2 | 🌐 C | 📅 2026-05-05 - Convert images to ASCII art.
...
* [greentext](https://github.com/jasonuc/greentext) ⭐ 35 | 🐛 0 | 🌐 Go | 📅 2026-08-10 - A CLI tool for creating green-text memes.
...
* [Favicon Editor](https://github.com/xyproto/favicon-editor) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2023-02-25 - Minimalist grayscale favicon editor for the terminal.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,689 | 🐛 74 | 🌐 Python | 📅 2026-08-12 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,471 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
* [ffscreencast](https://github.com/cytopia/ffscreencast) ⭐ 1,822 | 🐛 20 | 🌐 Shell | 📅 2024-07-16 - A FFmpeg screencast with video overlay and multi monitor support.
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,633 | 🐛 11 | 🌐 Shell | 📅 2026-08-13 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 560 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
* [invidtui](https://github.com/darkhz/invidtui) ⭐ 206 | 🐛 8 | 🌐 Go | 📅 2024-07-14 - Invidious TUI client, which fetches data from invidious instances and displays a user interface in the terminal, and allows for selecting and playing YouTube audio and video.
...
* [Pyutube](https://github.com/Hetari/pyutube) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2026-05-18 - A simple tool to download YouTube video shorts and playlist in just one click.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,294 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,537 | 🐛 708 | 🌐 Python | 📅 2026-08-13 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,779 | 🐛 226 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,065 | 🐛 161 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,730 | 🐛 211 | 🌐 Rust | 📅 2026-08-10 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,732 | 🐛 170 | 🌐 C | 📅 2026-07-27 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [PyRadio](https://github.com/coderholic/pyradio) ⭐ 1,088 | 🐛 11 | 🌐 Python | 📅 2026-05-07 - Curses based internet radio player.
* [pulsemixer](https://github.com/GeorgeFilipkin/pulsemixer) ⭐ 810 | 🐛 36 | 🌐 Python | 📅 2024-03-14 - CLI and curses mixer for PulseAudio.
* [upiano](https://github.com/eliasdorneles/upiano) ⭐ 793 | 🐛 5 | 🌐 Python | 📅 2025-07-09 - A Piano in your terminal (TUI).
* [ytui-music](https://github.com/sudipghimire533/ytui-music) ⭐ 771 | 🐛 37 | 🌐 Rust | 📅 2025-03-03 - YouTube client in terminal for music (lightweight YouTube client).
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 572 | 🐛 24 | 🌐 Rust | 📅 2026-08-09 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
* [opencubicplayer](https://github.com/mywave82/opencubicplayer) ⭐ 434 | 🐛 18 | 🌐 C | 📅 2026-08-12 - Open Cubic Player (UNIX fork) is a music visualizer for various tracked music formats (amiga modules, S3M, IT), chiptunes and other formats related to demoscene.
...
* [mufetch](https://github.com/ashish0kumar/mufetch) ⭐ 207 | 🐛 0 | 🌐 Go | 📅 2026-02-20 - CLI for music display (album covers and artist information) with comprehensive metadata, clickable links, responsive sizing and cross-platform support.
...
* [Tera](https://github.com/shinokada/tera) ⭐ 164 | 🐛 17 | 🌐 Go | 📅 2026-04-09 - Terminal Radio: an easy-to-use CLI music player to play favorite music, radio stations and explore various radio stations from the terminal only.
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 157 | 🐛 1 | 🌐 Shell | 📅 2026-08-11 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [cli-viz](https://github.com/sam1am/cli-viz) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2026-05-27 - An audio visualizer that runs in the linux terminal and reacts to the microphone.
...
* [Detify](https://github.com/omenmn/detify) ⭐ 31 | 🐛 0 | 🌐 Shell | 📅 2025-07-06 - CLI tool that automatically downloads your currently playing Spotify track using spotdl, with both manual and auto-download modes.
...
* [spytorec](https://github.com/Danidukiyu/SpytoRec) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2026-06-28 - Real-time Spotify recorder with automatic track splitting, metadata tagging, and high-quality FLAC/OGG output.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,819 | 🐛 177 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 2,970 | 🐛 1 | 🌐 C | 📅 2026-08-14 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,970 | 🐛 1 | 🌐 C | 📅 2026-08-14 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,171 | 🐛 51 | 🌐 Rust | 📅 2026-08-01 - Terminal Music Player written in Rust.
...
* [Gomu](https://github.com/issadarkthing/gomu) ⭐ 209 | 🐛 11 | 🌐 Go | 📅 2026-06-05 - Gomu is intuitive, powerful CLI music player. It has embedded scripting language and event hook to enable user to customize their config extensively.
* [jammer](https://github.com/jooapa/jammer) ⭐ 159 | 🐛 0 | 🌐 C# | 📅 2026-08-13 - Multiplatform light-weight TUI music player with Soundcloud & Youtube support, with effects.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,145 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ternimal](https://github.com/p-e-w/ternimal) ⭐ 1,113 | 🐛 14 | 🌐 Rust | 📅 2018-11-19 - Simulate a life form in the terminal.
* [neo](https://github.com/st3w/neo) ⭐ 947 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 611 | 🐛 43 | 🌐 Go | 📅 2026-08-14 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
* [firew0rks](https://github.com/addyosmani/firew0rks) ⭐ 574 | 🐛 2 | 🌐 JavaScript | 📅 2024-12-31 - Fireworks in your terminal.
* [rusty-rain](https://github.com/cowboy8625/rusty-rain) ⭐ 472 | 🐛 3 | 🌐 Rust | 📅 2026-05-11 - A cross platform matrix rain made with Rust.
* [paclear](https://github.com/orangekame3/paclear) ⭐ 236 | 🐛 2 | 🌐 Go | 📅 2024-05-17 - paclear is a clear command with pacman animation.
...
* [cpond](https://github.com/ayuzur/cpond) ⭐ 81 | 🐛 3 | 🌐 C | 📅 2025-11-23 - The program creates procedurally animated fish to swim around your terminal.
...
* [cellscape](https://github.com/ashish0kumar/cellscape) ⭐ 20 | 🐛 0 | 🌐 Go | 📅 2025-07-09 - TUI simulator for eight classic cellular automata.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,232 | 🐛 420 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,255 | 🐛 33 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
...
* [ccat](https://github.com/owenthereal/ccat) ⭐ 3,208 | 🐛 41 | 🌐 Go | 📅 2022-09-05 - `cat` with colorized output.
* [timg](https://github.com/hzeller/timg) ⭐ 2,722 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 1,995 | 🐛 27 | 🌐 Go | 📅 2026-08-11 - Feature-rich terminal-based text viewer.
* [TerminalImageViewer](https://github.com/stefanhaustein/TerminalImageViewer) ⭐ 1,684 | 🐛 17 | 🌐 C++ | 📅 2026-08-03 - Small C++ program to display images in a (modern) terminal using RGB ANSI codes and Unicode block graphics characters.
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,545 | 🐛 15 | 🌐 Go | 📅 2025-06-22 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,372 | 🐛 12 | 🌐 Rust | 📅 2026-08-01 - Terminal image, video, directory, and Markdown viewer.
* [youtube-viewer](https://github.com/trizen/youtube-viewer) ⭐ 1,310 | 🐛 45 | 🌐 Perl | 📅 2026-06-15 - Lightweight application that searches and streams videos from YouTube.
* [epy](https://github.com/wustho/epy) ⭐ 1,209 | 🐛 72 | 🌐 Python | 📅 2024-03-17 - CLI Ebook (epub2, epub3, fb2, mobi) Reader.
* [medium-cli](https://github.com/djadmin/medium-cli) ⭐ 733 | 🐛 42 | 🌐 JavaScript | 📅 2026-02-13 - Medium for Hackers - Read [medium.com](https://medium.com/) stories in the terminal.
* [hackernews-TUI](https://github.com/aome510/hackernews-TUI) ⭐ 718 | 🐛 9 | 🌐 Rust | 📅 2026-03-29 - A Terminal UI to browse Hacker News.
* [fancy-cat](https://github.com/freref/fancy-cat) ⭐ 551 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - CLI PDF reader with Vim keybindings.
* [baca](https://github.com/wustho/baca) ⭐ 520 | 🐛 12 | 🌐 Python | 📅 2024-03-05 - Lets you indulge in your favorite e-books in the comfort of your terminal.
* [viu](https://github.com/learn-anything/command-line-tools) ⭐ 491 | 🐛 13 | 📅 2026-07-25 - Command-line application to view images from the terminal written in Rust.
* [GopherTube](https://github.com/krishnassh/gophertube) ⭐ 421 | 🐛 2 | 🌐 Go | 📅 2026-08-08 - A terminal-based YouTube client that scrapes YouTube search results and uses mpv for video playback.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 347 | 🐛 14 | 🌐 Rust | 📅 2026-07-17 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 335 | 🐛 11 | 🌐 Rust | 📅 2026-08-11 - An TUI for exploring data of a Kafka cluster.
...
* [moulti](https://github.com/xavierog/moulti) ⭐ 164 | 🐛 2 | 🌐 Python | 📅 2026-02-05 - Moulti is a CLI-driven Terminal User Interface (TUI) displaying arbitrary outputs inside visual, collapsible blocks called steps.
* [bbcli](https://github.com/hako/bbcli) ⭐ 141 | 🐛 0 | 🌐 Rust | 📅 2026-07-02 - Browse BBC News like a hacker.
...
* [rfc\_reader](https://github.com/ozan2003/rfc_reader) ⭐ 72 | 🐛 0 | 🌐 Rust | 📅 2026-07-26 - A tool to read RFCs (Request for Comments) with a TUI, allowing you to fetch, cache, and browse RFC documents.
...
* [lspp](https://github.com/terroo/lspp) ⭐ 30 | 🐛 1 | 🌐 C++ | 📅 2025-05-20 - An alternative to the `ls` command with display of icons of files and folders and with colors.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,918 | 🐛 13 | 🌐 Rust | 📅 2026-08-12 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,623 | 🐛 169 | 🌐 Go | 📅 2026-08-12 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,674 | 🐛 8 | 🌐 Rust | 📅 2026-08-13 - Terminal session recorder.
* [terminalizer](https://github.com/faressoft/terminalizer) ⭐ 16,145 | 🐛 108 | 🌐 JavaScript | 📅 2024-08-29 - Record your terminal and generate animated GIF images or share a web player link [www.terminalizer.com](www.terminalizer.com).
...
* [ttygif](https://github.com/icholy/ttygif) ⭐ 4,015 | 🐛 17 | 🌐 C | 📅 2025-08-02 - ttygif converts a ttyrec file into GIF files. It's a stripped down version of ttyplay that screenshots every frame.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,685 | 🐛 5 | 🌐 Rust | 📅 2026-08-13 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
* [t-rec](https://github.com/sassman/t-rec-rs) ⭐ 1,246 | 🐛 27 | 🌐 Rust | 📅 2026-08-10 - Blazingly fast terminal recorder that generates animated GIF images for the web written in rust.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,797 | 🐛 438 | 🌐 Go | 📅 2026-08-10 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,803 | 🐛 0 | 🌐 C | 📅 2026-05-11 - A dead simple tool to sign files and verify digital signatures.
* [ots](https://github.com/sniptt-official/ots) ⭐ 1,847 | 🐛 2 | 🌐 Go | 📅 2025-02-08 - Share end-to-end encrypted secrets with others via a one-time URL.
...
* [PaperAge](https://github.com/matiaskorhonen/paper-age) ⭐ 608 | 🐛 10 | 🌐 Rust | 📅 2026-07-01 - Easy and secure paper backups of secrets, which takes a text and generates an encrypted QR code to print on paper.
...
* [jdvrif](https://github.com/CleasbyCode/jdvrif) ⭐ 69 | 🐛 0 | 🌐 C++ | 📅 2026-07-31 - CLI tool to embed or extract files via a JPG image. Post and share your embedded JPG image on compatible sites.
* [eddy](https://github.com/70sh1/eddy) ⭐ 56 | 🐛 0 | 🌐 Go | 📅 2026-07-11 - Simple, fast CLI file encryption tool.
* [secret\_share](https://github.com/scosman/secret_share) ⭐ 24 | 🐛 2 | 🌐 Go | 📅 2025-12-28 - The program allows you to share messages (secrets and passwords) securely with a CLI.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,010 | 🐛 44 | 🌐 Rust | 📅 2026-04-15 - A fast, simple, recursive content discovery tool written in Rust.
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,061 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,752 | 🐛 13 | 🌐 Rust | 📅 2026-08-10 - Manage your GnuPG keys with ease!
...
* [vet](https://github.com/safedep/vet) ⭐ 1,097 | 🐛 96 | 🌐 Go | 📅 2026-08-13 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 937 | 🐛 3 | 🌐 Go | 📅 2026-08-07 - A command-line tool for interacting with OAuth 2.0 authorization servers.
* [flawz](https://github.com/orhun/flawz) ⭐ 597 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A Terminal UI for browsing security vulnerabilities (CVEs).
* [uacme](https://github.com/ndilieto/uacme) ⭐ 512 | 🐛 0 | 🌐 C | 📅 2026-07-07 - ACMEv2 client written in plain C with minimal dependencies.
...
* [pdvzip](https://github.com/CleasbyCode/pdvzip) ⭐ 63 | 🐛 0 | 🌐 C++ | 📅 2026-08-02 - CLI tool to embed a ZIP file within a PNG image to create a tweetable and "executable" PNG-ZIP polyglot file. Post & share your PNG-ZIP image on compatible sites.
* [fubar](https://github.com/irishmaestro/fubar) ⭐ 62 | 🐛 1 | 🌐 Rust | 📅 2024-10-09 - Formidable Unix Binary Arsenal and Repository. TUI built for offline payload generation, retrieval, and exfiltration.
* [keeenv](https://github.com/scross01/keeenv) ⭐ 27 | 🐛 0 | 🌐 Python | 📅 2026-06-22 - Command-line tool that populates environment variables from a local configuration file with encrypted Keepass database to dynamically fetch sensitive data.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,439 | 🐛 92 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
* [passage](https://github.com/FiloSottile/passage) ⭐ 1,180 | 🐛 34 | 🌐 Shell | 📅 2024-08-30 - A fork of [password-store](https://www.passwordstore.org) that uses [age](https://age-encryption.org) as a backend instead of GnuPG.
* [pa](https://github.com/biox/pa) ⭐ 564 | 🐛 3 | 🌐 Shell | 📅 2026-07-21 - A simple password manager; encryption via age, written in portable POSIX shell.
...
* [oama](https://github.com/pdobsan/oama) ⭐ 254 | 🐛 9 | 🌐 Haskell | 📅 2025-08-29 - OAuth credential Manager.
* [Tlock](https://github.com/eklairs/tlock) ⭐ 202 | 🐛 7 | 🌐 Go | 📅 2024-09-01 - Two-Factor Authentication Tokens Manager in Terminal (Windows, Linux and MacOS).
* [keydex](https://github.com/shikaan/keydex) ⭐ 97 | 🐛 2 | 🌐 Go | 📅 2026-08-03 - Manage KeePass databases from your terminal.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,203 | 🐛 555 | 🌐 Python | 📅 2026-08-08 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,678 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [flog](https://github.com/mingrammer/flog) ⭐ 1,330 | 🐛 32 | 🌐 Go | 📅 2025-06-05 - A fake log generator for log formats such as apache-common, apache error and RFC3164 syslog.
* [Python re(gex)? exercises](https://github.com/learnbyexample/TUI-apps/tree/main/PyRegexExercises) ⭐ 1,013 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - TUI application intended to help you practice Python regular expressions there are more than 100 exercises covering both the builtin re and third-party regex module.
* [envio](https://github.com/envio-cli/envio) ⭐ 988 | 🐛 14 | 🌐 Rust | 📅 2026-06-23 - Envio is a command-line tool that simplifies the management of environment variables across multiple profiles. It allows users to easily switch between different configurations and apply them to their current environment.
* [fzf-tab-completion](https://github.com/lincheney/fzf-tab-completion) ⭐ 859 | 🐛 33 | 🌐 Shell | 📅 2026-07-31 - Tab completion using fzf.
* [gentoo-install](https://github.com/oddlama/gentoo-install) ⭐ 777 | 🐛 23 | 🌐 Shell | 📅 2026-08-08 - This project aspires to be your favorite way to install gentoo. It aims to provide a smooth installation experience, both for beginners and experts. You may configure it by using a menuconfig-inspired interface or simply via a config file.
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 759 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing your arr servers.
* [oji](https://github.com/xxczaki/oji) ⭐ 733 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-30 - Interactive text emoji creator.
* [play](https://github.com/paololazzari/play) ⭐ 582 | 🐛 3 | 🌐 Go | 📅 2025-03-28 - TUI playground for your favorite programs, such as grep, sed and awk.
* [sisi](https://github.com/frost-beta/sisi) ⭐ 581 | 🐛 4 | 🌐 TypeScript | 📅 2024-09-16 - Semantic image search CLI tool.
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 512 | 🐛 33 | 🌐 Go | 📅 2026-08-10 - Cross Platform tool to validate configuration files.
...
* [Skylab](https://github.com/SerhiiStets/skylab) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2024-02-11 - A text user interface (TUI) tool that displays upcoming space launches in a user-friendly way.
...
* [tempy](https://github.com/noprobelm/tempy) ⭐ 195 | 🐛 4 | 🌐 Python | 📅 2024-03-07 - A simple, visually pleasing weather report in your terminal.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,153 | 🐛 12 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
* [TUI apps](https://github.com/learnbyexample/TUI-apps) ⭐ 1,013 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - A repository containing a couple of one-script programs, mainly dedicated to training/learning CLI tools such as grep, awk, etc.
...
* [lexy](https://github.com/antoniorodr/lexy) ⭐ 120 | 🐛 0 | 🌐 Python | 📅 2026-08-10 - Lexy is a lightweight CLI tool that fetches programming tutorials from "Learn X in Y Minutes" directly into your terminal. Quickly search, learn, and reference code examples without leaving your workflow.
* [minicloze](https://github.com/benmanone/minicloze) ⭐ 23 | 🐛 6 | 🌐 Rust | 📅 2025-12-26 - Rust-based command-line language-learning game using the Tatoeba database.
...
* [flash-tui](https://github.com/TBS1996/speki) ⭐ 511 | 🐛 10 | 🌐 Rust | 📅 2024-12-22 - Flashcard app for the terminal.
* [speki](https://github.com/tbs1996/speki) ⭐ 511 | 🐛 10 | 🌐 Rust | 📅 2024-12-22 - Manage flashcards in the terminal similar to anki.
...
* [ToRRential Card processor](https://github.com/Constantin1489/trrc) ⭐ 25 | 🐛 0 | 🌐 Python | 📅 2023-06-17 - A command-line program to add a card to Anki using AnkiConnect API.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,031 | 🐛 13 | 🌐 Python | 📅 2026-05-16 - A TUI based typing test app inspired by MonkeyType.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,580 | 🐛 35 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
...
* [typing-game-cli](https://github.com/akgondber/typing-game-cli) ⭐ 63 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-06 - Command line game to practice typing speed by competing against typer-robot or against your best result.
...
* [typeinc](https://github.com/AnirudhG07/Typeinc) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2025-06-28 - An ncurses based terminal typing speed test with different difficulty levels and cool typing UI.
...
* [Pokete](https://github.com/lxgr-linux/pokete) ⭐ 3,147 | 🐛 31 | 🌐 Python | 📅 2026-05-22 - A terminal based Pokemon like game.
* [SSHTron](https://github.com/zachlatta/sshtron) ⭐ 2,488 | 🐛 12 | 🌐 Go | 📅 2023-07-17 - Multiplayer lightcycle game that runs through SSH.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,147 | 🐛 29 | 🌐 Rust | 📅 2026-08-13 - Play chess from your terminal.
* [Square Tic Tac Toe](https://github.com/learnbyexample/TUI-apps/tree/main/SquareTicTacToe) ⭐ 1,013 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - A game like Tic Tac Toe, but you have to form a square with 4 corners instead of a line.
* [gambit](https://github.com/maaslalani/gambit) ⭐ 906 | 🐛 10 | 🌐 Go | 📅 2024-01-25 - Chess board in your terminal.
* [DOOM-ASCII](https://github.com/wojciech-graj/doom-ascii) ⭐ 875 | 🐛 0 | 🌐 C | 📅 2025-07-21 - Text-based DOOM running in terminal without sound.
* [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 723 | 🐛 4 | 🌐 Rust | 📅 2026-08-08 - P2P terminal game about spacepirates playing basketball across the galaxy.
* [clidle](https://github.com/ajeetdsouza/clidle) ⭐ 632 | 🐛 2 | 🌐 Go | 📅 2025-03-28 - Wordle, now over SSH.
* [botany](https://github.com/jifunks/botany/) ⭐ 545 | 🐛 10 | 🌐 Python | 📅 2026-07-18 - A command line, realtime, virtual plant buddy.
* [terminal-doom](https://github.com/cryptocode/terminal-doom) ⭐ 434 | 🐛 2 | 🌐 C | 📅 2026-04-26 - Play DOOM in modern terminals.
* [nudoku](https://github.com/jubalh/nudoku) ⭐ 373 | 🐛 2 | 🌐 C | 📅 2026-07-08 - ncurses based sudoku game.
* [Solitaire TUI](https://github.com/brianstrauch/solitaire-tui) ⭐ 364 | 🐛 4 | 🌐 Go | 📅 2023-09-20 - Klondike solitaire for the terminal.
* [tty-solitaire](https://github.com/mpereira/tty-solitaire) ⭐ 358 | 🐛 24 | 🌐 C | 📅 2025-05-03 - Solitaire game for the terminal ncurses based.
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 299 | 🐛 11 | 🌐 Python | 📅 2026-08-08 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
* [nSnake](https://github.com/alexdantas/nSnake) ⭐ 226 | 🐛 23 | 🌐 C++ | 📅 2023-09-27 - The classic snake game in terminal with textual interface.
* [chs](https://github.com/nickzuber/chs) ⭐ 219 | 🐛 21 | 🌐 Python | 📅 2022-07-28 - Play chess against the Stockfish engine in your terminal.
* [Balatro TUI ](https://github.com/Passeriform/BalatroTUI) ⭐ 200 | 🐛 5 | 🌐 Rust | 📅 2026-05-01 - A minimal TUI clone of Balatro built in Rust.
...
* [Moon-Buggy](https://github.com/seehuhn/moon-buggy) ⭐ 109 | 🐛 7 | 🌐 C | 📅 2025-11-17 - Game where you drive a car across the moon and jump over craters.
...
* [sudoku-rs](https://github.com/MitchelPaulin/sudoku-rs) ⭐ 30 | 🐛 0 | 🌐 Rust | 📅 2024-08-17 - Sudoku game for the terminal, built with tui-rs.
* [Brick Game emulator](https://github.com/ilyakurdyukov/brickgame-4bit) ⭐ 28 | 🐛 1 | 🌐 C | 📅 2024-05-11 - Brick Game emulator that uses 4-bit microcontroller from Holtek.
...
* [nchess](https://github.com/billyvinning/nchess) ⭐ 20 | 🐛 0 | 🌐 C | 📅 2023-05-03 - Chess in the terminal, written in C (player vs player in the same terminal).
...
* [Noughts & Crosses (Tic Tac Toe)](https://github.com/vyalovvldmr/onx) ⭐ 14 | 🐛 4 | 🌐 Python | 📅 2022-10-06 - Noughts & Crosses client-server online game with your partner through websockets.
...
* [shellphone](https://github.com/kokasmark/shellphone) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2025-01-18 - Terminal based Terraria player file editor.
...
* [Sweeper](https://github.com/igor47/sweeper) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-04-30 - Basic ncurses Minesweeper game, wirtten in python, using curtsies library.
...
* [NCurses Pacman](https://github.com/woodrowb96/ncurses-pacman) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2026-02-26 - Terminal-based Pac Man game written in c++.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,232 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
* [bucklespring](https://github.com/zevv/bucklespring) ⭐ 1,552 | 🐛 40 | 🌐 C | 📅 2025-08-24 - Emulates the sound of the old IBM Model-M space saver bucklespring keyboard while typing.
* [matrix-webcam](https://github.com/joschuck/matrix-webcam) ⭐ 1,489 | 🐛 0 | 🌐 Python | 📅 2022-10-05 - Take your video conference from within the matrix.
* [ponysay](https://github.com/erkin/ponysay) ⭐ 1,318 | 🐛 79 | 🌐 Pony | 📅 2024-08-14 - Pony rewrite of cowsay.
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,251 | 🐛 19 | 🌐 Rust | 📅 2026-08-11 - Turn your keyboard into a typewriter adding sounds at each keystroke.
...
* [Draw](https://github.com/maaslalani/draw) ⭐ 544 | 🐛 6 | 🌐 Go | 📅 2023-12-04 - draw is an simple drawing tool in the terminal. Hold your mouse down and move it across the screen to draw anything you want!
* [pyjokes](https://github.com/pyjokes/pyjokes) ⭐ 367 | 🐛 6 | 🌐 Python | 📅 2026-05-06 - One line jokes for programmers (jokes as a service).
* [pokeget](https://github.com/talwat/pokeget-rs) ⭐ 293 | 🐛 5 | 🌐 Rust | 📅 2026-07-13 - A bash script you can use to display cool sprites of Pokemon in your terminal.
...
* [bbl](https://github.com/nehemiaharchives/bbl) ⭐ 96 | 🐛 5 | 🌐 Kotlin | 📅 2026-07-11 - Read, search Holy Bible in command line.
...
* [periodic-table-cli](https://github.com/spirometaxas/periodic-table-cli) ⭐ 302 | 🐛 2 | 🌐 JavaScript | 📅 2025-08-03 - An interactive Periodic Table of Elements app for the console!
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 254 | 🐛 36 | 🌐 Python | 📅 2026-08-13 - Track conferences and meetups.
...
* [oeis-tui](https://github.com/hako/oeis-tui) ⭐ 90 | 🐛 0 | 🌐 Rust | 📅 2026-02-03 - A TUI and CLI for browsing the On-Line Encyclopedia of Integer Sequences (OEIS) in the terminal.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,104 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,440 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,154 | 🐛 0 | 🌐 Shell | 📅 2026-08-04 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,187 | 🐛 15 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome Terminal Recorder](https://github.com/orangekame3/awesome-terminal-recorder) ⭐ 252 | 🐛 1 | 📅 2026-05-05 - Curated list of outstanding terminal Recorder that make your day brighter! Each item is associated with an animated GIF that shows some examples of usage.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,169 | 🐛 58 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
