...
* [eza](https://github.com/eza-community/eza) ⭐ 23,055 | 🐛 438 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,195 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,922 | 🐛 138 | 🌐 Rust | 📅 2026-08-24 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,213 | 🐛 190 | 🌐 Rust | 📅 2026-08-26 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,259 | 🐛 12 | 🌐 C | 📅 2026-08-24 - A breadth-first version of the UNIX find command.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,454 | 🐛 185 | 🌐 C | 📅 2026-08-26 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,869 | 🐛 429 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,821 | 🐛 298 | 🌐 Rust | 📅 2026-08-25 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,877 | 🐛 69 | 🌐 Go | 📅 2026-08-17 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,631 | 🐛 182 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,259 | 🐛 7 | 🌐 C++ | 📅 2026-08-24 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,327 | 🐛 77 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,188 | 🐛 8 | 🌐 Rust | 📅 2026-08-19 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,179 | 🐛 27 | 🌐 Rust | 📅 2026-08-25 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,934 | 🐛 57 | 🌐 Go | 📅 2026-08-27 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,118 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,942 | 🐛 146 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
* [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,922 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/macOS/FreeBSD resource monitor with a nice interface.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,123 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,147 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,071 | 🐛 41 | 🌐 Python | 📅 2026-08-27 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,493 | 🐛 31 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,683 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,412 | 🐛 129 | 🌐 C | 📅 2026-08-27 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,719 | 🐛 69 | 🌐 Rust | 📅 2026-08-26 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,884 | 🐛 260 | 🌐 Go | 📅 2026-08-26 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,835 | 🐛 4 | 🌐 C | 📅 2026-08-26 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 476 | 🌐 C++ | 📅 2026-08-27 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,722 | 🐛 26 | 🌐 C | 📅 2026-08-22 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,810 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,724 | 🐛 98 | 🌐 Rust | 📅 2026-08-25 - Painless compression and decompression in the terminal.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,636 | 🐛 62 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 176,568 | 🐛 900 | 🌐 Python | 📅 2026-08-19 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-08-25 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,363 | 🐛 535 | 🌐 Rust | 📅 2026-08-24 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,716 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,256 | 🐛 372 | 🌐 Python | 📅 2026-06-23.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,792 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
* [ROAPI](https://github.com/roapi/roapi) ⭐ 3,425 | 🐛 66 | 🌐 Rust | 📅 2026-03-25 - ROAPI automatically spins up read-only APIs for static datasets without requiring you to write a single line of code.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,023 | 🐛 16 | 🌐 Python | 📅 2026-08-26 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,596 | 🐛 26 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,667 | 🐛 40 | 🌐 Python | 📅 2026-08-26 - Serializes the output of command line tools to JSON.
...
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,728 | 🐛 23 | 🌐 Rust | 📅 2026-08-19 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,279 | 🐛 706 | 🌐 Go | 📅 2026-08-27 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
...
* [usql](https://github.com/xo/usql) ⭐ 10,089 | 🐛 118 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,003 | 🐛 69 | 🌐 Go | 📅 2026-08-25 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,354 | 🐛 39 | 🌐 Python | 📅 2026-08-27 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,296 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,241 | 🐛 47 | 🌐 Go | 📅 2026-08-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,943 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,767 | 🐛 27 | 🌐 Rust | 📅 2026-08-27 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,767 | 🐛 27 | 🌐 Rust | 📅 2026-08-27 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,190 | 🐛 14 | 🌐 Go | 📅 2026-08-26 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,091 | 🐛 15 | 🌐 Rust | 📅 2026-08-26 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,674 | 🐛 326 | 🌐 Go | 📅 2026-08-26 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,077 | 🐛 223 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,101 | 🐛 676 | 🌐 Rust | 📅 2026-08-26 - Create book from Markdown files.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 812 | 🐛 62 | 🌐 Python | 📅 2026-08-17 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,445 | 🐛 990 | 🌐 Go | 📅 2026-08-27 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,504 | 🐛 171 | 🌐 Rust | 📅 2026-08-26 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [Turbo](https://github.com/magiblot/turbo) ⭐ 678 | 🐛 37 | 🌐 C++ | 📅 2026-08-14 - An experimental text editor for the terminal, based on Scintilla and Turbo Vision.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,679 | 🐛 1,022 | 🌐 Go | 📅 2026-08-27 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,971 | 🐛 466 | 🌐 Go | 📅 2026-08-26 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,437 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,422 | 🐛 98 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
* [BFG Repo-Cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,176 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,164 | 🐛 122 | 🌐 Rust | 📅 2026-08-22 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,204 | 🐛 78 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [mergestat-lite](https://github.com/mergestat/mergestat-lite) ⭐ 3,518 | 🐛 45 | 🌐 Go | 📅 2026-08-26 - A command-line tool for running SQL queries on git repositories and related data sources.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,927 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,219 | 🐛 1,214 | 🌐 Rust | 📅 2026-08-27 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,141 | 🐛 18 | 🌐 Rust | 📅 2026-08-25 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,081 | 🐛 137 | 🌐 TypeScript | 📅 2026-08-26 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,724 | 🐛 675 | 🌐 Go | 📅 2026-08-27 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,007 | 🐛 404 | 🌐 JavaScript | 📅 2026-08-26 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,926 | 🐛 6 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,470 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,854 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,306 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Instant, easy, and predictable development environments.
...
* [release-it](https://github.com/release-it/release-it) ⭐ 9,038 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,666 | 🐛 25 | 🌐 Go | 📅 2026-08-27 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,174 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
* [np](https://github.com/sindresorhus/np) ⭐ 7,712 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-30 - A better `npm publish`.
* [blinkenlights](https://github.com/jart/blink) ⭐ 7,575 | 🐛 55 | 🌐 C | 📅 2025-12-10 - TUI that may be used for debugging x86\_64-linux or i8086 programs across platforms.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,405 | 🐛 38 | 🌐 Rust | 📅 2026-08-23 - A TUI for analyzing Linux binaries.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,105 | 🐛 444 | 🌐 Rust | 📅 2026-08-27 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,641 | 🐛 15 | 🌐 Python | 📅 2026-08-24 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 892 | 🐛 166 | 🌐 Rust | 📅 2026-08-27 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 598 | 🐛 2 | 🌐 Go | 📅 2026-08-25 - Update binaries installed by "go install" with goroutines.
...
* [cargo-seek](https://github.com/tareqimbasher/cargo-seek) ⭐ 194 | 🐛 6 | 🌐 Rust | 📅 2026-08-12 - A TUI for searching, adding and installing cargo crates.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,448 | 🐛 98 | 🌐 Go | 📅 2026-08-25 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,306 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,528 | 🐛 3 | 🌐 Rust | 📅 2026-08-26 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,637 | 🐛 24 | 🌐 Go | 📅 2026-08-24 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,512 | 🐛 143 | 🌐 Go | 📅 2026-08-23 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,186 | 🐛 81 | 🌐 C | 📅 2026-08-22 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,186 | 🐛 81 | 🌐 C | 📅 2026-08-22 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,390 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 11 | 🌐 Rust | 📅 2026-08-26 - A TUI tool designed for monitoring Kubernetes resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,460 | 🐛 334 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,454 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,220 | 🐛 9 | 🌐 Rust | 📅 2026-07-04 - TUI-based HTTP/REST client.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,162 | 🐛 7 | 🌐 Rust | 📅 2026-08-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,527 | 🐛 1,825 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,683 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-26 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,739 | 🐛 78 | 🌐 Python | 📅 2026-08-26 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,040 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [systeroid](https://github.com/orhun/systeroid) ⭐ 1,463 | 🐛 17 | 🌐 Rust | 📅 2026-07-30 - A more powerful alternative to sysctl(8) with a terminal user interface.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,325 | 🐛 236 | 🌐 Zig | 📅 2026-08-27 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,583 | 🐛 1,825 | 🌐 Rust | 📅 2026-08-27 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,618 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,448 | 🐛 23 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,145 | 🐛 1,871 | 🌐 Rust | 📅 2026-08-26 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,353 | 🐛 1,435 | 🌐 Rust | 📅 2026-08-27 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,367 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 51 | 🌐 C++ | 📅 2026-08-26 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,982 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,400 | 🐛 76 | 🌐 C | 📅 2026-08-27 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,400 | 🐛 76 | 🌐 C | 📅 2026-08-27 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,871 | 🐛 457 | 🌐 C | 📅 2026-08-20 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,063 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,094 | 🐛 11 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,963 | 🐛 11 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,838 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,642 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,070 | 🐛 31 | 🌐 Go | 📅 2026-08-24 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [chdig](https://github.com/azat/chdig) ⭐ 292 | 🐛 5 | 🌐 Rust | 📅 2026-08-26 - Dig into ClickHouse with TUI interface.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,440 | 🐛 212 | 🌐 Rust | 📅 2026-08-26 - Upgrade all the things.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,506 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,629 | 🐛 296 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,824 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,726 | 🐛 68 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,909 | 🐛 147 | 🌐 Go | 📅 2026-08-21 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,269 | 🐛 27 | 🌐 Go | 📅 2026-08-21 - A Docker manager for the terminal.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,351 | 🐛 114 | 🌐 C | 📅 2026-08-27 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,301 | 🐛 21 | 🌐 Rust | 📅 2026-08-16 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,721 | 🐛 18 | 🌐 Go | 📅 2026-08-17 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,702 | 🐛 67 | 🌐 Rust | 📅 2026-08-25 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,887 | 🐛 3 | 🌐 Rust | 📅 2026-08-26 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,115 | 🐛 6 | 🌐 Rust | 📅 2026-08-25 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,115 | 🐛 6 | 🌐 Rust | 📅 2026-08-25 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,901 | 🐛 29 | 🌐 Go | 📅 2026-08-20 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,282 | 🐛 209 | 🌐 TypeScript | 📅 2026-08-24 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 887 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - Terminal mail client.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,742 | 🐛 57 | 🌐 Go | 📅 2026-08-27 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,887 | 🐛 107 | 🌐 Java | 📅 2026-08-21 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,927 | 🐛 17 | 🌐 C++ | 📅 2026-08-23 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,719 | 🐛 73 | 🌐 Go | 📅 2026-08-26 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,365 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,322 | 🐛 127 | 🌐 Python | 📅 2026-07-04 - Mastodon CLI & TUI.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 966 | 🐛 3 | 🌐 Python | 📅 2026-08-27 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,267 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,925 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,445 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,722 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,510 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - oha is a tiny program that sends some load to a web application and show real-time TUI.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,541 | 🐛 78 | 🌐 Rust | 📅 2026-08-27 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,093 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,066 | 🐛 32 | 🌐 C | 📅 2026-08-27 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,949 | 🐛 18 | 🌐 Rust | 📅 2026-08-27 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,704 | 🐛 20 | 🌐 Rust | 📅 2026-08-23 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
* [tproxy](https://github.com/kevwan/tproxy) ⭐ 3,701 | 🐛 6 | 🌐 Go | 📅 2026-07-09 - A CLI tool to proxy and analyze TCP connections.
...
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,696 | 🐛 33 | 🌐 Go | 📅 2026-08-15 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,569 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - TUI for sniffing network traffic using eBPF on Linux.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,816 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,554 | 🐛 19 | 🌐 Rust | 📅 2026-08-26 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,384 | 🐛 38 | 🌐 C | 📅 2026-08-24 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
...
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,202 | 🐛 74 | 🌐 C | 📅 2026-08-17 - Ncurses SIP Messages flow viewer.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,974 | 🐛 16 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,799 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,391 | 🐛 11 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 187,272 | 🐛 2,596 | 🌐 Python | 📅 2026-08-26 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,041 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,840 | 🐛 1,174 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,115 | 🐛 4 | 🌐 Go | 📅 2026-08-26 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,654 | 🐛 544 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,886 | 🐛 181 | 🌐 Python | 📅 2026-08-27 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,336 | 🐛 1,149 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
...
* [tdl](https://github.com/iyear/tdl) ⭐ 7,982 | 🐛 180 | 🌐 Go | 📅 2026-08-26 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,648 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,849 | 🐛 402 | 🌐 C++ | 📅 2026-08-27 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,223 | 🐛 2 | 🌐 Python | 📅 2026-08-26 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,464 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,921 | 🐛 163 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,535 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,826 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-27 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,110 | 🐛 132 | 🌐 Rust | 📅 2026-08-23 - A terminal user interface for taskwarrior.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,643 | 🐛 125 | 🌐 C++ | 📅 2026-08-22 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [tim:r](https://github.com/sectore/timr) ⭐ 370 | 🐛 1 | 🌐 Rust | 📅 2026-08-26 - A TUI for organizing your time: Pomodoro Countdown counter.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,377 | 🐛 151 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,300 | 🐛 151 | 🌐 Python | 📅 2026-08-25 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,414 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,071 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
...
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,757 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,042 | 🐛 261 | 🌐 Python | 📅 2026-08-24 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,865 | 🐛 222 | 🌐 Python | 📅 2026-08-20.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,340 | 🐛 7 | 🌐 Python | 📅 2026-08-27 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,865 | 🐛 222 | 🌐 Python | 📅 2026-08-20 - CalDAV synchronization program.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,219 | 🐛 33 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,886 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
* [mop](https://github.com/mop-tracker/mop) ⭐ 2,204 | 🐛 6 | 🌐 Go | 📅 2025-12-28 - Stock market tracker for hackers.
...
* [cash-cli](https://github.com/xxczaki/cash-cli) ⭐ 265 | 🐛 16 | 🌐 JavaScript | 📅 2026-04-30 - Convert Currency Rates.
...
* [abandon](https://github.com/hrj/abandon) ⭐ 185 | 🐛 32 | 🌐 Scala | 📅 2026-08-25 - A text based, double-entry accounting system inspired by Ledger with infinite precision arithmetic. Made in Java. Includes a GUI.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,708 | 🐛 866 | 🌐 TypeScript | 📅 2026-08-27 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,538 | 🐛 68 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,399 | 🐛 98 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,063 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,630 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,793 | 🐛 76 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,350 | 🐛 174 | 🌐 C++ | 📅 2026-08-22 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-08-26 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [pet](https://github.com/knqyf263/pet) ⭐ 5,336 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,938 | 🐛 104 | 🌐 Go | 📅 2026-08-27 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [docfd](https://github.com/darrenldl/docfd) ⭐ 288 | 🐛 4 | 🌐 OCaml | 📅 2026-08-27 - TUI fuzzy document finder that looks for documentation files in Markdown and txt format in the directory tree.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 115 | 🐛 1 | 🌐 Rust | 📅 2026-08-26 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 9 | 🐛 0 | 🌐 Zig | 📅 2026-08-27 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,084 | 🐛 552 | 🌐 Go | 📅 2026-08-25 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,654 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-25 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,227 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,468 | 🐛 38 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,179 | 🐛 57 | 🌐 C | 📅 2026-08-21 - Terminal graphics for the 21 st century.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,021 | 🐛 38 | 🌐 C | 📅 2026-08-20 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,801 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [ArTTY](https://github.com/mjwhitta/artty) ⭐ 133 | 🐛 0 | 🌐 Go | 📅 2026-08-26 - Pixel art with optional system info, similar to Neofetch.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,715 | 🐛 75 | 🌐 Python | 📅 2026-08-26 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,478 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,644 | 🐛 14 | 🌐 Shell | 📅 2026-08-26 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,322 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,591 | 🐛 712 | 🌐 Python | 📅 2026-08-27 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,135 | 🐛 171 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,742 | 🐛 211 | 🌐 Rust | 📅 2026-08-26 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 157 | 🐛 1 | 🌐 Shell | 📅 2026-08-27 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,828 | 🐛 178 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 2,990 | 🐛 2 | 🌐 C | 📅 2026-08-27 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,990 | 🐛 2 | 🌐 C | 📅 2026-08-27 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,182 | 🐛 50 | 🌐 Rust | 📅 2026-08-26 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,187 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,276 | 🐛 423 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,734 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,011 | 🐛 31 | 🌐 Go | 📅 2026-08-25 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,549 | 🐛 15 | 🌐 Go | 📅 2025-06-22 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,389 | 🐛 12 | 🌐 Rust | 📅 2026-08-22 - Terminal image, video, directory, and Markdown viewer.
...
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 344 | 🐛 7 | 🌐 Rust | 📅 2026-08-27 - An TUI for exploring data of a Kafka cluster.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,936 | 🐛 13 | 🌐 Rust | 📅 2026-08-26 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,748 | 🐛 170 | 🌐 Go | 📅 2026-08-24 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,738 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
* [terminalizer](https://github.com/faressoft/terminalizer) ⭐ 16,155 | 🐛 108 | 🌐 JavaScript | 📅 2024-08-29 - Record your terminal and generate animated GIF images or share a web player link [www.terminalizer.com](www.terminalizer.com).
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,936 | 🐛 443 | 🌐 Go | 📅 2026-08-26 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [jdvrif](https://github.com/CleasbyCode/jdvrif) ⭐ 69 | 🐛 0 | 🌐 C++ | 📅 2026-08-26 - CLI tool to embed or extract files via a JPG image. Post and share your embedded JPG image on compatible sites.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,459 | 🐛 96 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,255 | 🐛 575 | 🌐 Python | 📅 2026-08-24 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [envio](https://github.com/envio-cli/envio) ⭐ 990 | 🐛 14 | 🌐 Rust | 📅 2026-06-23 - Envio is a command-line tool that simplifies the management of environment variables across multiple profiles. It allows users to easily switch between different configurations and apply them to their current environment.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 514 | 🐛 12 | 🌐 Go | 📅 2026-08-26 - Cross Platform tool to validate configuration files.
...
* [Balatro TUI ](https://github.com/Passeriform/BalatroTUI) ⭐ 202 | 🐛 5 | 🌐 Rust | 📅 2026-05-01 - A minimal TUI clone of Balatro built in Rust.
...
[Awesome Modern CLI](https://github.com/thegdsks/awesome-modern-cli/) ⭐ 415 | 🐛 6 | 📅 2026-07-13 - A curated list of modern alternatives to classic command-line tools. Faster, prettier, smarter replacements for the Unix utilities you use every day.

[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,175 | 🐛 257 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,514 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,253 | 🐛 1 | 🌐 Shell | 📅 2026-08-22 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,195 | 🐛 15 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,351 | 🐛 94 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
