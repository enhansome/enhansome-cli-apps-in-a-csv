...
* [eza](https://github.com/eza-community/eza) ⭐ 23,363 | 🐛 455 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,240 | 🐛 210 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,269 | 🐛 32 | 🌐 Rust | 📅 2026-09-21 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,681 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,054 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [pm](https://github.com/Angelmmiguel/pm) ⭐ 206 | 🐛 8 | 🌐 Shell | 📅 2021-04-14 - The easy way to switch between your projects on ZSH. In short, another directory changer.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,533 | 🐛 198 | 🌐 Rust | 📅 2026-09-24 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [rip](https://github.com/nivekuil/rip) ⭐ 1,739 | 🐛 26 | 🌐 Rust | 📅 2024-04-08 - Move and restore items from the graveyard (by default, `/tmp/graveyard-$USER` if $XDG\_DATA\_HOME is not set and `$XDG_DATA_HOME/graveyard` otherwise)
...
* [atuin](https://github.com/ellie/atuin) ⭐ 47 | 🐛 0 | 📅 2026-02-10 - Atuin replaces your existing shell history with a SQLite database, and records additional context for your commands. Additionally, it provides optional and fully encrypted synchronization of your history between machines, via an Atuin server.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,333 | 🐛 452 | 🌐 Rust | 📅 2026-09-19 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,933 | 🐛 289 | 🌐 Rust | 📅 2026-09-22 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,886 | 🐛 71 | 🌐 Go | 📅 2026-09-21 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,583 | 🐛 203 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,125 | 🐛 563 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 16,026 | 🐛 69 | 🌐 Rust | 📅 2026-09-24 - A CLI tool for code structural search, lint and rewriting.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 539 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,329 | 🐛 10 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,297 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 6,010 | 🐛 48 | 🌐 Go | 📅 2026-09-23 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,136 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,164 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,522 | 🐛 32 | 🌐 Rust | 📅 2026-09-21 - A time traveling resource monitor for modern Linux systems
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,410 | 🐛 64 | 🌐 Rust | 📅 2026-09-21 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,377 | 🐛 271 | 🌐 Go | 📅 2026-09-24 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 22,007 | 🐛 1 | 🌐 C | 📅 2026-09-21 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,522 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,219 | 🐛 482 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,829 | 🐛 12 | 🌐 Rust | 📅 2026-09-23 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,769 | 🐛 95 | 🌐 Rust | 📅 2026-09-24 - Painless compression and decompression in the terminal.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,452 | 🐛 4 | 🌐 Go | 📅 2026-09-24 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 186,894 | 🐛 695 | 🌐 Python | 📅 2026-09-21 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-24 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,533 | 🐛 543 | 🌐 Rust | 📅 2026-09-20 - Cross-platform Text Expander written in Rust. Not limited to the command line.
* [Ultimate Plumber](https://github.com/akavel/up) ⭐ 8,846 | 🐛 30 | 🌐 Go | 📅 2024-09-05 - Helps to interactively and incrementally explore textual data in Linux, by making it easier to quickly build complex pipelines, thanks to a fast feedback loop.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,726 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,432 | 🐛 381 | 🌐 Python | 📅 2026-06-23.
...
* [gtree](https://github.com/ddddddO/gtree) ⭐ 364 | 🐛 38 | 🌐 Go | 📅 2026-09-18 - Using either Markdown or programmatically to generate directory trees and directories, and to verify directories.
* [rare](https://github.com/zix99/rare) ⭐ 358 | 🐛 2 | 🌐 Go | 📅 2026-02-08 - Real-time regex-extraction and aggregation into common formats such as histograms, bar graphs, numerical summaries, tables, and more!
...
* [gzip-size-cli](https://github.com/sindresorhus/gzip-size-cli) ⭐ 194 | 🐛 0 | 🌐 JavaScript | 📅 2021-11-23 - Get the gzipped size of a file.
* [deadlink](https://github.com/nschloe/deadlink) ⭐ 179 | 🐛 6 | 📅 2025-12-17 - Parses text files for HTTP URLs and checks if they are still valid. Good to use on Markdown documentation files.
...
* [HASHA CLI](https://github.com/sindresorhus/hasha-cli) ⭐ 81 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-12 - Hashing made simple. Get the hash of text or stdin.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,808 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,755 | 🐛 49 | 🌐 Python | 📅 2026-09-21 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,039 | 🐛 19 | 🌐 Python | 📅 2026-09-25 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [lowcharts](https://github.com/juan-leon/lowcharts) ⭐ 255 | 🐛 10 | 🌐 Rust | 📅 2025-12-22 - lowcharts is meant to be used in those scenarios where we have numerical data in text files that we want to display in the terminal to do a basic analysis.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,640 | 🐛 34 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,188 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,807 | 🐛 16 | 🌐 Go | 📅 2026-09-24 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,774 | 🐛 24 | 🌐 Rust | 📅 2026-09-24 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,846 | 🐛 24 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,486 | 🐛 22 | 🌐 Python | 📅 2026-09-24 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,507 | 🐛 598 | 🌐 Go | 📅 2026-09-25 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
...
* [usql](https://github.com/xo/usql) ⭐ 10,127 | 🐛 74 | 🌐 Go | 📅 2026-09-23 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,418 | 🐛 32 | 🌐 Python | 📅 2026-09-21 - The SQL IDE for Your Terminal.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,347 | 🐛 13 | 🌐 Rust | 📅 2026-09-24 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,323 | 🐛 39 | 🌐 Go | 📅 2026-09-25 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,986 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,796 | 🐛 35 | 🌐 Rust | 📅 2026-09-25 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,796 | 🐛 35 | 🌐 Rust | 📅 2026-09-25 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,238 | 🐛 12 | 🌐 Go | 📅 2026-09-25 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,121 | 🐛 17 | 🌐 Rust | 📅 2026-09-24 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,172 | 🐛 127 | 🌐 Python | 📅 2026-09-22 - Python CLI utility and library for manipulating SQLite databases.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,242 | 🐛 331 | 🌐 Go | 📅 2026-09-21 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,970 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,289 | 🐛 79 | 🌐 Rust | 📅 2026-09-23 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,462 | 🐛 235 | 🌐 Go | 📅 2026-09-22 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,173 | 🐛 657 | 🌐 Rust | 📅 2026-09-18 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,832 | 🐛 125 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,297 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 824 | 🐛 68 | 🌐 Python | 📅 2026-08-31 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,638 | 🐛 914 | 🌐 Go | 📅 2026-09-25 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,608 | 🐛 167 | 🌐 Rust | 📅 2026-09-23 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 705 | 🐛 0 | 🌐 Go | 📅 2026-09-24 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,655 | 🐛 1,054 | 🌐 Go | 📅 2026-09-24 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,474 | 🐛 484 | 🌐 Go | 📅 2026-09-23 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,519 | 🐛 346 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,113 | 🐛 93 | 🌐 Shell | 📅 2026-09-21 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,551 | 🐛 101 | 🌐 Go | 📅 2026-09-22 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,266 | 🐛 116 | 🌐 Rust | 📅 2026-09-18 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,073 | 🐛 153 | 🌐 Go | 📅 2026-09-24 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,231 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,085 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,047 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,742 | 🐛 1,268 | 🌐 Rust | 📅 2026-09-25 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,485 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-23 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,285 | 🐛 794 | 🌐 Go | 📅 2026-09-25 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,069 | 🐛 402 | 🌐 JavaScript | 📅 2026-09-22 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 24,015 | 🐛 9 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,557 | 🐛 26 | 🌐 Perl | 📅 2026-09-20 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,940 | 🐛 247 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,373 | 🐛 414 | 🌐 Go | 📅 2026-09-24 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,257 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,844 | 🐛 18 | 🌐 Python | 📅 2026-09-12 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,063 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-17 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,777 | 🐛 26 | 🌐 Go | 📅 2026-09-24 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,198 | 🐛 19 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,444 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,141 | 🐛 442 | 🌐 Rust | 📅 2026-09-24 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,666 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [argbash](https://github.com/matejak/argbash) ⭐ 1,486 | 🐛 44 | 🌐 M4 | 📅 2025-07-17 - Bash argument parsing code generator.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 907 | 🐛 170 | 🌐 Rust | 📅 2026-09-25 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [Kool](https://github.com/kool-dev/kool) ⭐ 725 | 🐛 11 | 🌐 Go | 📅 2026-08-15 - CLI tool that brings the complexities of modern software development making these environments lightweight, fast and reproducible.
* [gup](https://github.com/nao1215/gup) ⭐ 604 | 🐛 0 | 🌐 Go | 📅 2026-09-25 - Update binaries installed by "go install" with goroutines.
...
* [cgasm](https://github.com/bnagy/cgasm) ⭐ 388 | 🐛 3 | 🌐 PLpgSQL | 📅 2020-09-19 - Pronounced “SeekAzzem”, it is a standalone, offline terminal-based tool with no dependencies that gives me x86 assembly documentation.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 142 | 🐛 13 | 🌐 Python | 📅 2026-09-25 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,109 | 🐛 319 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [clog](https://github.com/clog-tool/clog-cli) ⭐ 922 | 🐛 27 | 🌐 Rust | 📅 2024-08-15 - Creates a changelog automatically from local git metadata.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,672 | 🐛 78 | 🌐 Go | 📅 2026-09-24 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,373 | 🐛 414 | 🌐 Go | 📅 2026-09-24 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,542 | 🐛 4 | 🌐 Rust | 📅 2026-09-24 - A simple and fast terminal dashboard for Kubernetes.
...
* [OPS](https://github.com/nanovms/ops) ⭐ 1,519 | 🐛 143 | 🌐 Go | 📅 2026-09-22 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 89 | 🌐 C | 📅 2026-09-21 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 89 | 🌐 C | 📅 2026-09-21 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,411 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,294 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,238 | 🐛 13 | 🌐 Go | 📅 2026-09-18 - TUI for Podman environment.
* [ktop](https://github.com/vladimirvivien/ktop) ⭐ 1,110 | 🐛 11 | 🌐 Go | 📅 2026-07-03 - Tool that displays useful metrics information about nodes, pods, and other workload.
...
* [Ducker](https://github.com/robertpsoane/ducker) ⭐ 932 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - TUI for managing docker containers.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 396 | 🐛 12 | 🌐 Rust | 📅 2026-09-24 - A TUI tool designed for monitoring Kubernetes resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,579 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,447 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,929 | 🐛 7 | 🌐 Go | 📅 2026-09-21 - Domain Availability Research Tool.
* [pageres-cli](https://github.com/sindresorhus/pageres-cli) ⭐ 1,745 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-09 - Capture screenshots of websites in various resolutions. A good way to make sure your websites are responsive.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,228 | 🐛 9 | 🌐 Rust | 📅 2026-09-24 - TUI-based HTTP/REST client.
...
* [iola](https://github.com/pvarentsov/iola) ⭐ 171 | 🐛 0 | 🌐 TypeScript | 📅 2023-10-12 - A command-line socket client with REST API. It helps to work with socket servers using your favorite REST client.
...
* [viewport-list-cli](https://github.com/kevva/viewport-list-cli) ⭐ 61 | 🐛 1 | 🌐 JavaScript | 📅 2016-01-06 - Return a list of devices and their viewports.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,432 | 🐛 1 | 🌐 Rust | 📅 2026-09-25 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,167 | 🐛 1,893 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 36,002 | 🐛 171 | 🌐 Rust | 📅 2026-09-24 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,330 | 🐛 292 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,706 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-18 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,769 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,299 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,521 | 🐛 248 | 🌐 Zig | 📅 2026-09-25 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 29,020 | 🐛 1,881 | 🌐 Rust | 📅 2026-09-21 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,533 | 🐛 1,939 | 🌐 Rust | 📅 2026-09-24 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,367 | 🐛 21 | 🌐 C++ | 📅 2026-09-24 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,367 | 🐛 21 | 🌐 C++ | 📅 2026-09-24 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,571 | 🐛 1,436 | 🌐 Rust | 📅 2026-09-25 - A modern shell written in Rust, where all data is structured.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 283 | 🐛 65 | 🌐 C | 📅 2026-09-25 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-24 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,145 | 🐛 152 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,424 | 🐛 0 | 🌐 Shell | 📅 2026-09-19 - Pretty, minimal, and fast ZSH prompt.
...
* [yank](https://github.com/mptre/yank) ⭐ 1,714 | 🐛 2 | 🌐 C | 📅 2026-07-16 - Reads input from stdin and display a selection interface that allows a field to be selected and copied to the clipboard.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,046 | 🐛 47 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,904 | 🐛 101 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,761 | 🐛 96 | 🌐 C | 📅 2026-09-25 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,761 | 🐛 96 | 🌐 C | 📅 2026-09-25 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
...
* [TermUI](https://github.com/gizak/termui) ⭐ 13,589 | 🐛 106 | 🌐 Go | 📅 2025-07-10 - Cross-platform and fully-customizable TUI dashboard and widget library.
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,723 | 🐛 38 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
* [noti](https://github.com/variadico/noti) ⚠️ Archived - Monitor a process and trigger a notification.
* [screenFetch](https://github.com/KittyKatt/screenFetch) ⭐ 4,077 | 🐛 171 | 🌐 Shell | 📅 2026-03-02 - It can be used to generate one of those nifty terminal theme information + ASCII distribution logos. It auto-detects the distribution and display an ASCII version of that distribution's logo and some valuable information to the right.
...
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,976 | 🐛 11 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,900 | 🐛 18 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,137 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,091 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,579 | 🐛 210 | 🌐 Rust | 📅 2026-09-25 - Upgrade all the things.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,606 | 🐛 216 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,948 | 🐛 301 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,840 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,288 | 🐛 72 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 13,008 | 🐛 155 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
* [bocker](https://github.com/p8952/bocker) ⭐ 12,680 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in around 100 lines of bash.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,858 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 608 | 🐛 16 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,413 | 🐛 117 | 🌐 C | 📅 2026-09-17 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,347 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,799 | 🐛 26 | 🌐 Go | 📅 2026-09-21 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,726 | 🐛 69 | 🌐 Rust | 📅 2026-09-24 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [Marker](https://github.com/pindexis/marker) ⭐ 2,093 | 🐛 49 | 🌐 Python | 📅 2024-04-06 - The terminal command palette.
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,507 | 🐛 6 | 🌐 Go | 📅 2026-08-08 - Executing shell commands via HTTP server.
...
* [foy](https://github.com/zaaack/foy) ⭐ 291 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-12 - A simple, light-weight, type-friendly and modern task runner for general purpose.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,895 | 🐛 3 | 🌐 Rust | 📅 2026-09-22 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,318 | 🐛 22 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,318 | 🐛 22 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,379 | 🐛 223 | 🌐 TypeScript | 📅 2026-09-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,209 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,786 | 🐛 53 | 🌐 Go | 📅 2026-09-24 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,935 | 🐛 109 | 🌐 Java | 📅 2026-09-22 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
* [devzat](https://github.com/quackduck/devzat) ⭐ 4,070 | 🐛 25 | 🌐 Go | 📅 2026-07-23 - Custom SSH server that takes you to a chat instead of a shell prompt.
* [Sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,478 | 🐛 44 | 🌐 Python | 📅 2022-12-08 - CLI client for Slack.
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,155 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 995 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 866 | 🐛 475 | 🌐 Python | 📅 2026-08-16 - Official Zulip terminal client with TUI.
...
* [ttchat](https://github.com/atye/ttchat) ⭐ 63 | 🐛 10 | 🌐 Go | 📅 2025-01-06 - Twitch chats in the terminal.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,413 | 🐛 115 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,986 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,508 | 🐛 17 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,735 | 🐛 41 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,558 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,905 | 🐛 151 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,695 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,959 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - A network diagnostic tool.
...
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,070 | 🐛 32 | 🌐 C | 📅 2026-09-16 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,053 | 🐛 28 | 🌐 Rust | 📅 2026-09-24 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,730 | 🐛 22 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
* [tproxy](https://github.com/kevwan/tproxy) ⭐ 3,706 | 🐛 6 | 🌐 Go | 📅 2026-07-09 - A CLI tool to proxy and analyze TCP connections.
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,347 | 🐛 141 | 🌐 C | 📅 2026-09-24 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,724 | 🐛 36 | 🌐 Go | 📅 2026-09-12 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,581 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - TUI for sniffing network traffic using eBPF on Linux.
* [asn](https://github.com/nitefood/asn) ⭐ 1,935 | 🐛 4 | 🌐 Shell | 📅 2026-09-22 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,861 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,563 | 🐛 4 | 🌐 Rust | 📅 2026-09-25 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [chiko](https://github.com/felangga/chiko) ⭐ 355 | 🐛 1 | 🌐 Go | 📅 2026-04-15 - The ultimate beauty gRPC Client on your Terminal: a simple tool to interact with gRPC services using a beautiful terminal interface.
* [havn](https://github.com/mrjackwills/havn) ⭐ 318 | 🐛 2 | 🌐 Rust | 📅 2026-08-23 - A fast configurable port scanner with reasonable defaults.
* [packemon](https://github.com/ddddddO/packemon) ⭐ 308 | 🐛 36 | 🌐 Go | 📅 2026-09-19 - TUI tool and Go library for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).
...
* [netdump](https://github.com/giorgiopapini/netdump) ⭐ 37 | 🐛 1 | 🌐 C | 📅 2025-09-01 - A simple network packet analyzer using libpcap, supporting both real-time and offline analysis with ASCII visualization.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,016 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,863 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,410 | 🐛 15 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,451 | 🐛 2,677 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,348 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,702 | 🐛 1,179 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,443 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,699 | 🐛 546 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,947 | 🐛 182 | 🌐 Python | 📅 2026-09-23 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,833 | 🐛 1,137 | 🌐 Python | 📅 2026-09-19 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,099 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,096 | 🐛 202 | 🌐 Go | 📅 2026-09-24 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,721 | 🐛 125 | 🌐 Go | 📅 2026-09-24 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,867 | 🐛 388 | 🌐 C++ | 📅 2026-09-24 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,235 | 🐛 10 | 🌐 Python | 📅 2026-09-21 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [nom](https://github.com/guyfedwards/nom) ⭐ 748 | 🐛 33 | 🌐 Go | 📅 2026-07-08 - RSS reader for the terminal.
...
* [Amfora](https://github.com/makew0rld/amfora) ⭐ 1,357 | 🐛 11 | 🌐 Go | 📅 2026-07-03 - Amfora aims to be the best looking Gemini client with the most features. It does not support Gopher or other non-Web protocols.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,989 | 🐛 175 | 🌐 Go | 📅 2026-09-22 - Feature-rich interactive Jira command line.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 818 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-09-25 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,131 | 🐛 135 | 🌐 Rust | 📅 2026-09-20 - A terminal user interface for taskwarrior.
...
* [Todoman](https://github.com/pimutils/todoman) ⭐ 597 | 🐛 113 | 🌐 Python | 📅 2026-05-25 - A simple, standards-based, CLI todo (aka: task) manager.
...
* [td-cli](https://github.com/darrikonn/td-cli) ⭐ 216 | 🐛 11 | 🌐 Python | 📅 2026-04-14 - A command line todo manager, where you can organize and manage your todos across multiple projects.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,664 | 🐛 126 | 🌐 C++ | 📅 2026-09-19 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 1 | 🌐 Python | 📅 2026-09-24 - Simple timer for the terminal with timer-mode and alarm.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,413 | 🐛 153 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,323 | 🐛 152 | 🌐 Python | 📅 2026-09-24 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,412 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,085 | 🐛 41 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,814 | 🐛 26 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 883 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Store your ideas without leaving the terminal.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,208 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - A powerful bookmark manager written in Python3 and SQLite3.
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,770 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,056 | 🐛 264 | 🌐 Python | 📅 2026-09-23 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,880 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,362 | 🐛 7 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,880 | 🐛 225 | 🌐 Python | 📅 2026-09-04 - CalDAV synchronization program.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,239 | 🐛 34 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 341 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Lakshmi](https://github.com/sarvjeets/lakshmi) ⭐ 149 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Investing library and command-line interface inspired by the Bogleheads philosophy.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,157 | 🐛 814 | 🌐 TypeScript | 📅 2026-09-25 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 44,069 | 🐛 73 | 🌐 Go | 📅 2026-09-24 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,465 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [parllama](https://github.com/paulrobello/parllama) ⭐ 492 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - TUI designed for easy management and use of Ollama based LLMs.
...
* [hns](https://github.com/primaprashant/hns) ⭐ 118 | 🐛 4 | 🌐 Python | 📅 2026-09-16 - A privacy-focused open-source command-line tool for on-device speech-to-text. It records your voice, transcribes it completely locally using faster-whisper, and automatically copies the text to clipboard for immediate use in any application.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,101 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [gtt](https://github.com/eeeXun/gtt) ⭐ 306 | 🐛 1 | 🌐 Go | 📅 2026-09-25 - Google Translate TUI (Originally), now supporting Apertium, Argos, Bing, ChatGPT, DeepL, DeepLX, Google, Reverso.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,666 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,875 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,440 | 🐛 172 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [DeckTape](https://github.com/astefanutti/decktape) ⭐ 2,429 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - DeckTape is a high-quality PDF exporter for HTML presentation frameworks.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 528 | 🐛 15 | 🌐 Python | 📅 2026-09-24 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [trino](https://github.com/eneserdogan/trino) ⭐ 145 | 🐛 2 | 🌐 JavaScript | 📅 2022-12-06 - Quick and easy translation of words and phrases entered in the command line.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,694 | 🐛 130 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [bcal](https://github.com/jarun/bcal) ⭐ 702 | 🐛 0 | 🌐 C | 📅 2026-09-17 - Byte CALculator - A REPL CLI utility for storage expression evaluation, SI/IEC conversion, byte address calculation, base conversion and LBA/CHS calculation.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,876 | 🐛 461 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,628 | 🐛 111 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,547 | 🐛 15 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,352 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,966 | 🐛 93 | 🌐 Go | 📅 2026-09-24 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,292 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
* [halp](https://github.com/orhun/halp) ⭐ 769 | 🐛 6 | 🌐 Rust | 📅 2026-09-01 - halp aims to help find the correct arguments for command-line tools by checking the predefined list of commonly used options/flags.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 144 | 🐛 2 | 🌐 Rust | 📅 2026-09-23 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-24 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,506 | 🐛 530 | 🌐 Go | 📅 2026-09-20 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,698 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,273 | 🐛 54 | 🌐 C | 📅 2026-09-24 - Terminal graphics for the 21 st century.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,055 | 🐛 36 | 🌐 C | 📅 2026-09-11 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,828 | 🐛 7 | 🌐 Python | 📅 2026-09-24 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 1,008 | 🐛 15 | 🌐 Python | 📅 2026-09-23 - AI-Powered Command-Line Photo Search Tool.
* [figma-use](https://github.com/dannote/figma-use) ⭐ 604 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-03 - Control Figma from the command line with full read/write access for AI agents.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,801 | 🐛 76 | 🌐 Python | 📅 2026-09-24 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,509 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 607 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,705 | 🐛 709 | 🌐 Python | 📅 2026-09-25 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,793 | 🐛 227 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,236 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
...
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,741 | 🐛 168 | 🌐 C | 📅 2026-09-24 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 599 | 🐛 19 | 🌐 Rust | 📅 2026-09-20 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 160 | 🐛 1 | 🌐 Shell | 📅 2026-09-24 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [spytorec](https://github.com/Danidukiyu/SpytoRec) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Real-time Spotify recorder with automatic track splitting, metadata tagging, and high-quality FLAC/OGG output.
...
* [music](https://github.com/kitesi/music) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2026-07-05 - Command line tool to help with music related tasks, such as querying songs, lastfm scrobbling, lastfm suggestions, spotify - local playlist sync.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,847 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,107 | 🐛 1 | 🌐 C | 📅 2026-09-24 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,107 | 🐛 1 | 🌐 C | 📅 2026-09-24 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,217 | 🐛 49 | 🌐 Rust | 📅 2026-09-22 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,268 | 🐛 9 | 🌐 Python | 📅 2026-09-25 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,570 | 🐛 519 | 🌐 Rust | 📅 2026-09-22 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,764 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,025 | 🐛 29 | 🌐 Go | 📅 2026-09-24 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,563 | 🐛 12 | 🌐 Go | 📅 2026-09-24 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,421 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - Terminal image, video, directory, and Markdown viewer.
...
* [fancy-cat](https://github.com/freref/fancy-cat) ⭐ 565 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - CLI PDF reader with Vim keybindings.
* [baca](https://github.com/wustho/baca) ⭐ 526 | 🐛 12 | 🌐 Python | 📅 2024-03-05 - Lets you indulge in your favorite e-books in the comfort of your terminal.
...
* [reader](https://github.com/mrusme/reader) ⭐ 415 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Reader parses a web page for its actual content and displays it in nicely highlighted text on the command line
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,998 | 🐛 12 | 🌐 Rust | 📅 2026-09-25 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,978 | 🐛 173 | 🌐 Go | 📅 2026-09-24 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,829 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,207 | 🐛 448 | 🌐 Go | 📅 2026-09-21 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,207 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,107 | 🐛 99 | 🌐 Go | 📅 2026-09-23 - Tool for identifying risks in open source software supply chain.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,503 | 🐛 105 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,357 | 🐛 636 | 🌐 Python | 📅 2026-09-19 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [envio](https://github.com/envio-cli/envio) ⭐ 993 | 🐛 14 | 🌐 Rust | 📅 2026-06-23 - Envio is a command-line tool that simplifies the management of environment variables across multiple profiles. It allows users to easily switch between different configurations and apply them to their current environment.
* [fzf-tab-completion](https://github.com/lincheney/fzf-tab-completion) ⭐ 865 | 🐛 33 | 🌐 Shell | 📅 2026-07-31 - Tab completion using fzf.
* [gentoo-install](https://github.com/oddlama/gentoo-install) ⭐ 780 | 🐛 24 | 🌐 Shell | 📅 2026-08-08 - This project aspires to be your favorite way to install gentoo. It aims to provide a smooth installation experience, both for beginners and experts. You may configure it by using a menuconfig-inspired interface or simply via a config file.
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 775 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A TUI and CLI for managing your arr servers.
* [oji](https://github.com/xxczaki/oji) ⭐ 734 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-30 - Interactive text emoji creator.
* [play](https://github.com/paololazzari/play) ⭐ 590 | 🐛 3 | 🌐 Go | 📅 2025-03-28 - TUI playground for your favorite programs, such as grep, sed and awk.
* [sisi](https://github.com/frost-beta/sisi) ⭐ 581 | 🐛 4 | 🌐 TypeScript | 📅 2024-09-16 - Semantic image search CLI tool.
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 517 | 🐛 18 | 🌐 Go | 📅 2026-09-24 - Cross Platform tool to validate configuration files.
...
* [guesswidth](https://github.com/noborus/guesswidth) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-08-10 - Guess the width output without delimiters in commands that output to the terminal.
...
* [gtime](https://github.com/savitojs/gtime) ⭐ 11 | 🐛 2 | 🌐 Python | 📅 2026-09-24 - Python CLI utility for global time zone lookup, comparison, and management; The program supports fuzzy search, favorites, city comparison, meeting time conversion, and a live/watch mode.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,323 | 🐛 14 | 🌐 Shell | 📅 2026-09-21 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,185 | 🐛 36 | 🌐 Rust | 📅 2026-09-24 - Play chess from your terminal.
...
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 304 | 🐛 17 | 🌐 Python | 📅 2026-08-30 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
* [bucklespring](https://github.com/zevv/bucklespring) ⭐ 1,556 | 🐛 42 | 🌐 C | 📅 2025-08-24 - Emulates the sound of the old IBM Model-M space saver bucklespring keyboard while typing.
...
* [pokeget](https://github.com/talwat/pokeget-rs) ⭐ 300 | 🐛 5 | 🌐 Rust | 📅 2026-07-13 - A bash script you can use to display cool sprites of Pokemon in your terminal.
...
* [periodic-table-cli](https://github.com/spirometaxas/periodic-table-cli) ⭐ 308 | 🐛 2 | 🌐 JavaScript | 📅 2025-08-03 - An interactive Periodic Table of Elements app for the console!
* [Pubs](https://github.com/pubs/pubs) ⭐ 292 | 🐛 69 | 🌐 Python | 📅 2024-06-01 - Pubs organizes your scientific papers together with their bibliographic data and provides command line access to basic and advanced manipulation of your library.
...
* [papis](https://github.com/alejandrogallo/papis) ⭐ 27 | 🐛 0 | 🌐 HTML | 📅 2026-09-24 - Extensible document and bibliography manager.
...
* [FAWOC](https://github.com/robolab-pavia/fawoc) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2023-03-27 - FAWOC is a TUI program for manually labelling a list of words. It has been developed to support the efficient clustering of documents based on topic modeling algorithms such as Dirichlet Latent Allocation.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,506 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,671 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,461 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,202 | 🐛 17 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,722 | 🐛 46 | 📅 2026-09-22 - An awesome list dedicated to TUI programs.
