...
* [eza](https://github.com/eza-community/eza) ⭐ 23,345 | 🐛 454 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,238 | 🐛 210 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,657 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,052 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,517 | 🐛 199 | 🌐 Rust | 📅 2026-09-20 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,273 | 🐛 14 | 🌐 C | 📅 2026-09-21 - A breadth-first version of the UNIX find command.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,791 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,798 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Intelligent context-aware search engine for your shell history with TUI.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,464 | 🐛 186 | 🌐 C | 📅 2026-09-16 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [atuin](https://github.com/ellie/atuin) ⭐ 46 | 🐛 0 | 📅 2026-02-10 - Atuin replaces your existing shell history with a SQLite database, and records additional context for your commands. Additionally, it provides optional and fully encrypted synchronization of your history between machines, via an Atuin server.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,306 | 🐛 447 | 🌐 Rust | 📅 2026-09-19 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,923 | 🐛 287 | 🌐 Rust | 📅 2026-09-22 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,885 | 🐛 71 | 🌐 Go | 📅 2026-09-21 - A diff tool for YAML files, and sometimes JSON.
...
* [diff2html-cli](https://github.com/rtfpessoa/diff2html-cli) ⭐ 606 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-06 - Parse git diffs as JSON and generate pretty HTML.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,518 | 🐛 201 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,123 | 🐛 563 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 16,003 | 🐛 69 | 🌐 Rust | 📅 2026-09-23 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,854 | 🐛 80 | 🌐 Rust | 📅 2026-09-17 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,299 | 🐛 8 | 🌐 C++ | 📅 2026-09-21 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,361 | 🐛 79 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 537 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [duf](https://github.com/muesli/duf) ⭐ 15,312 | 🐛 81 | 🌐 Go | 📅 2026-01-13 - Disk Usage/Free Utility.
* [Dust](https://github.com/bootandy/dust) ⭐ 12,292 | 🐛 10 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,292 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,998 | 🐛 53 | 🌐 Go | 📅 2026-09-21 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,133 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
* [erdtree](https://github.com/solidiquis/erdtree) ⭐ 2,603 | 🐛 36 | 🌐 Rust | 📅 2024-05-19 - A multithreaded file-tree visualizer and disk usage analyzer.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,714 | 🐛 545 | 🌐 C++ | 📅 2026-09-19 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,117 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,929 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,043 | 🐛 105 | 🌐 Rust | 📅 2026-09-23 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,022 | 🐛 134 | 🌐 C | 📅 2026-09-20 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,157 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,182 | 🐛 36 | 🌐 Rust | 📅 2026-09-22 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,100 | 🐛 39 | 🌐 Python | 📅 2026-09-15 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,521 | 🐛 32 | 🌐 Rust | 📅 2026-09-21 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,710 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,424 | 🐛 110 | 🌐 C | 📅 2026-09-19 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,367 | 🐛 62 | 🌐 Rust | 📅 2026-09-21 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,350 | 🐛 270 | 🌐 Go | 📅 2026-09-18 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,996 | 🐛 1 | 🌐 C | 📅 2026-09-21 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,520 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,731 | 🐛 102 | 🌐 Rust | 📅 2026-09-17 - Ranger-like terminal file manager written in Go with fuzzy search, tabs bulk rename, file preview, exit to current directory, themes and trash support.
* [walk](https://github.com/antonmedv/walk) ⭐ 3,640 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,218 | 🐛 482 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
...
* [felix](https://github.com/kyoheiu/felix) ⭐ 921 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager with vim-like key mapping
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,827 | 🐛 12 | 🌐 Rust | 📅 2026-09-22 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [progress](https://github.com/Xfennec/progress) ⭐ 8,854 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Monitor the progress of common Coreutils command-line tools (`cp`, `mv`, `dd`, `tar`, `rsync`, etc.); it uses a ncurses interface to display the percentage of data copied; it works by reading from system files and retrieving the necessary information for the estimation.
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,766 | 🐛 96 | 🌐 Rust | 📅 2026-09-21 - Painless compression and decompression in the terminal.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,758 | 🐛 9 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,549 | 🐛 61 | 🌐 C | 📅 2026-09-02 - Rotate, compress and mail logs.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,452 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,674 | 🐛 61 | 🌐 C | 📅 2026-09-16 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 186,498 | 🐛 693 | 🌐 Python | 📅 2026-09-21 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-22 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,524 | 🐛 541 | 🌐 Rust | 📅 2026-09-20 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,724 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,418 | 🐛 379 | 🌐 Python | 📅 2026-06-23.
...
* [deadlink](https://github.com/nschloe/deadlink) ⭐ 178 | 🐛 6 | 📅 2025-12-17 - Parses text files for HTTP URLs and checks if they are still valid. Good to use on Markdown documentation files.
...
* [Line Select](https://github.com/urbanogilson/lineselect) ⭐ 74 | 🐛 2 | 🌐 Rust | 📅 2026-09-22 - A powerful utility enabling interactive line selection from stdin, allowing to seamlessly integrate, pause, select, and refine your pipeline, enhancing data processing precision.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,749 | 🐛 49 | 🌐 Python | 📅 2026-09-21 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,039 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,639 | 🐛 34 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,998 | 🐛 303 | 🌐 Go | 📅 2026-09-23 - Portable command-line YAML processor.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,684 | 🐛 32 | 🌐 Python | 📅 2026-09-22 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,185 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,806 | 🐛 16 | 🌐 Go | 📅 2026-09-23 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,771 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,844 | 🐛 24 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,486 | 🐛 21 | 🌐 Python | 📅 2026-09-21 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [jello](https://github.com/kellyjonbrazil/jello) ⭐ 534 | 🐛 7 | 🌐 Python | 📅 2025-05-30 - CLI tool to filter JSON and JSON Lines data with Python syntax, similar to - surprise :-), jq!
...
* [jtbl](https://github.com/kellyjonbrazil/jtbl) ⭐ 346 | 🐛 2 | 🌐 Python | 📅 2024-04-02 - A simple CLI tool to print JSON and JSON Lines data as a table in the terminal.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,503 | 🐛 592 | 🌐 Go | 📅 2026-09-23 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,393 | 🐛 49 | 🌐 Python | 📅 2026-09-20 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,977 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,122 | 🐛 121 | 🌐 Go | 📅 2026-09-22 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,024 | 🐛 73 | 🌐 Go | 📅 2026-09-21 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
* [textql](https://github.com/dinedal/textql) ⭐ 9,104 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,414 | 🐛 32 | 🌐 Python | 📅 2026-09-21 - The SQL IDE for Your Terminal.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,409 | 🐛 44 | 🌐 Python | 📅 2026-09-21 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,344 | 🐛 14 | 🌐 Rust | 📅 2026-09-23 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,321 | 🐛 38 | 🌐 Go | 📅 2026-09-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,979 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,793 | 🐛 34 | 🌐 Rust | 📅 2026-09-23 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,793 | 🐛 34 | 🌐 Rust | 📅 2026-09-23 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,321 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - A cross-platform TUI database management tool written in Rust.
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,235 | 🐛 12 | 🌐 Go | 📅 2026-09-09 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,117 | 🐛 17 | 🌐 Rust | 📅 2026-09-23 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,567 | 🐛 75 | 🌐 Go | 📅 2026-09-23 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,198 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [zsv](https://github.com/liquidaty/zsv) ⭐ 397 | 🐛 24 | 🌐 C | 📅 2026-09-23 - The world's fastest (simd) CSV parser, with an extensible, multi-purpose CLI.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,203 | 🐛 330 | 🌐 Go | 📅 2026-09-21 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,968 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,286 | 🐛 80 | 🌐 Rust | 📅 2026-09-22 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,435 | 🐛 235 | 🌐 Go | 📅 2026-09-22 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,164 | 🐛 657 | 🌐 Rust | 📅 2026-09-18 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,828 | 🐛 125 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,294 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,623 | 🐛 914 | 🌐 Go | 📅 2026-09-23 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,604 | 🐛 167 | 🌐 Rust | 📅 2026-09-21 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 703 | 🐛 0 | 🌐 Go | 📅 2026-09-22 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [aretext](https://github.com/aretext/aretext) ⭐ 286 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - Minimalist text editor with vim-compatible key bindings.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,585 | 🐛 1,052 | 🌐 Go | 📅 2026-09-23 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,437 | 🐛 483 | 🌐 Go | 📅 2026-09-23 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,515 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,109 | 🐛 93 | 🌐 Shell | 📅 2026-09-21 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,348 | 🐛 231 | 🌐 C | 📅 2026-09-19 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,542 | 🐛 101 | 🌐 Go | 📅 2026-09-22 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,259 | 🐛 115 | 🌐 Rust | 📅 2026-09-18 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,050 | 🐛 63 | 🌐 Rust | 📅 2026-09-22 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,048 | 🐛 150 | 🌐 Go | 📅 2026-09-22 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,226 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [git absorb](https://github.com/tummychow/git-absorb) ⭐ 5,727 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - git commit --fixup, but automatic.
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,083 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,046 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,320 | 🐛 14 | 🌐 Rust | 📅 2026-09-08 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [ggc](https://github.com/bmf-san/ggc) ⭐ 283 | 🐛 0 | 🌐 Go | 📅 2026-09-22 - A modern Git CLI tool with both traditional command-line and interactive incremental-search UI.
...
* [git-remote-aws](https://github.com/nathants/git-remote-aws) ⭐ 169 | 🐛 0 | 🌐 Go | 📅 2026-09-21 - Management of encrypted git hosting.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,705 | 🐛 1,265 | 🌐 Rust | 📅 2026-09-23 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,143 | 🐛 14 | 🌐 Rust | 📅 2026-09-22 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,468 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-21 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,248 | 🐛 785 | 🌐 Go | 📅 2026-09-23 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,058 | 🐛 402 | 🌐 JavaScript | 📅 2026-09-22 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 24,011 | 🐛 8 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,555 | 🐛 26 | 🌐 Perl | 📅 2026-09-20 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,932 | 🐛 247 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,371 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,255 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,842 | 🐛 18 | 🌐 Python | 📅 2026-09-12 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,061 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-17 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,771 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,197 | 🐛 19 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,437 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,140 | 🐛 438 | 🌐 Rust | 📅 2026-09-22 - Developer environments you can take with you.
...
* [PuDB](https://github.com/inducer/pudb) ⭐ 3,245 | 🐛 164 | 🌐 Python | 📅 2026-09-20 - Allows you to debug code right where you write and test it in a terminal.
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,658 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 905 | 🐛 163 | 🌐 Rust | 📅 2026-09-23 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 604 | 🐛 1 | 🌐 Go | 📅 2026-09-22 - Update binaries installed by "go install" with goroutines.
* [DevTUI](https://github.com/skatkov/devtui) ⭐ 556 | 🐛 41 | 🌐 Go | 📅 2026-09-21 - All-in-one terminal toolkit that consolidates everyday developer utilities into a unified TUI and CLI.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 141 | 🐛 13 | 🌐 Python | 📅 2026-09-23 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Scrut](https://github.com/facebookincubator/scrut) ⭐ 82 | 🐛 8 | 🌐 Rust | 📅 2026-09-21 - A testing toolkit for CLI applications designed to rigorously test terminal programs, inspired by Cram and focuses on providing a straightforward way to validate CLI behaviour.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,104 | 🐛 318 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [boilr](https://github.com/tmrts/boilr) ⭐ 1,764 | 🐛 44 | 🌐 Go | 📅 2023-03-07 - Boilerplate template manager that generates files or directories from template repositories.
...
* [add-gitignore](https://github.com/TejasQ/add-gitignore) ⭐ 731 | 🐛 5 | 🌐 JavaScript | 📅 2023-11-20 - Interactively generate a .gitignore for software projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,650 | 🐛 81 | 🌐 Go | 📅 2026-09-22 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,371 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,871 | 🐛 39 | 🌐 Go | 📅 2026-09-14 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,540 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,643 | 🐛 25 | 🌐 Go | 📅 2026-09-21 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,516 | 🐛 143 | 🌐 Go | 📅 2026-09-22 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 89 | 🌐 C | 📅 2026-09-21 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 89 | 🌐 C | 📅 2026-09-21 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,409 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
...
* [E1S](https://github.com/keidarcy/e1s) ⭐ 929 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - TUI for browsing and managing AWS ECS resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,566 | 🐛 336 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,491 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,440 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,931 | 🐛 72 | 🌐 Rust | 📅 2026-09-21 - Fast, async, resource-friendly link checker written in Rust.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,925 | 🐛 7 | 🌐 Go | 📅 2026-09-21 - Domain Availability Research Tool.
...
* [ain](https://github.com/jonaslu/ain) ⭐ 620 | 🐛 1 | 🌐 Go | 📅 2025-10-17 - An HTTP API client for the terminal.
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-09-22 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,410 | 🐛 3 | 🌐 Rust | 📅 2026-09-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,122 | 🐛 1,884 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,962 | 🐛 171 | 🌐 Rust | 📅 2026-09-22 - Handy way to save and run project-specific commands.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,298 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
...
* [qman](https://github.com/plp13/qman) ⭐ 605 | 🐛 14 | 🌐 C | 📅 2026-09-06 - A more modern man page viewer for our terminals.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,441 | 🐛 251 | 🌐 Zig | 📅 2026-09-22 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,991 | 🐛 1,873 | 🌐 Rust | 📅 2026-09-21 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,617 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,468 | 🐛 23 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,513 | 🐛 1,939 | 🌐 Rust | 📅 2026-09-22 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,366 | 🐛 21 | 🌐 C++ | 📅 2026-09-19 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,366 | 🐛 21 | 🌐 C++ | 📅 2026-09-19 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
* [mtm](https://github.com/deadpixi/mtm) ⭐ 1,226 | 🐛 43 | 🌐 C | 📅 2024-07-18 - Micro Terminal Multiplexer - Simple but usable, stable and minimalistic terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,553 | 🐛 1,445 | 🌐 Rust | 📅 2026-09-23 - A modern shell written in Rust, where all data is structured.
...
* [Oils](https://github.com/oilshell/oil) ⭐ 3,394 | 🐛 610 | 🌐 Python | 📅 2026-09-17 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [Twin](https://github.com/cosmos72/twin) ⭐ 1,064 | 🐛 37 | 🌐 C | 📅 2026-08-03 - Text mode window environment. A "retro" program for embedded or remote systems, that doubles as X11 terminal and text-mode equivalent of VNC server.
* [sshrc](https://github.com/cdown/sshrc) ⭐ 530 | 🐛 4 | 🌐 Shell | 📅 2023-01-27 - The program works just like ssh while also sourcing your local sshrc configuration file upon logging in remotely.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 281 | 🐛 60 | 🌐 C | 📅 2026-09-23 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-22 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,140 | 🐛 152 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,044 | 🐛 47 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,734 | 🐛 91 | 🌐 C | 📅 2026-09-21 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,734 | 🐛 91 | 🌐 C | 📅 2026-09-21 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,943 | 🐛 449 | 🌐 C | 📅 2026-09-19 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,100 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,588 | 🐛 106 | 🌐 Go | 📅 2025-07-10 - Cross-platform and fully-customizable TUI dashboard and widget library.
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,716 | 🐛 38 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
* [noti](https://github.com/variadico/noti) ⚠️ Archived - Monitor a process and trigger a notification.
* [screenFetch](https://github.com/KittyKatt/screenFetch) ⭐ 4,076 | 🐛 171 | 🌐 Shell | 📅 2026-03-02 - It can be used to generate one of those nifty terminal theme information + ASCII distribution logos. It auto-detects the distribution and display an ASCII version of that distribution's logo and some valuable information to the right.
* [kmon](https://github.com/orhun/kmon) ⭐ 2,951 | 🐛 23 | 🌐 Rust | 📅 2026-09-21 - Linux TUI Kernel manager and activity monitor.
* [CoreFreq](https://github.com/cyring/CoreFreq) ⭐ 2,244 | 🐛 2 | 🌐 C | 📅 2026-08-16 - CPU monitoring TUI software designed for the 64-bits Processors.
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,108 | 🐛 11 | 🌐 Shell | 📅 2026-09-23 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,973 | 🐛 11 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,892 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,661 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,088 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,577 | 🐛 208 | 🌐 Rust | 📅 2026-09-22 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,076 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,294 | 🐛 86 | 🌐 Go | 📅 2026-09-22 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,597 | 🐛 214 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,919 | 🐛 301 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,840 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,232 | 🐛 74 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,997 | 🐛 154 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,279 | 🐛 27 | 🌐 Go | 📅 2026-09-04 - A Docker manager for the terminal.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,853 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,409 | 🐛 115 | 🌐 C | 📅 2026-09-17 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,344 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,793 | 🐛 28 | 🌐 Go | 📅 2026-09-21 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,725 | 🐛 69 | 🌐 Rust | 📅 2026-09-13 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [Marker](https://github.com/pindexis/marker) ⭐ 2,093 | 🐛 49 | 🌐 Python | 📅 2024-04-06 - The terminal command palette.
...
* [dotbins](https://github.com/basnijholt/dotbins) ⭐ 271 | 🐛 27 | 🌐 Python | 📅 2026-09-21 - Keep updated binaries in your dotfiles.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,894 | 🐛 3 | 🌐 Rust | 📅 2026-09-22 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,307 | 🐛 20 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,307 | 🐛 20 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,910 | 🐛 30 | 🌐 Go | 📅 2026-09-01 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,370 | 🐛 223 | 🌐 TypeScript | 📅 2026-09-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 889 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - Terminal mail client.
...
* [nmail](https://github.com/d99kris/nmail) ⭐ 258 | 🐛 0 | 🌐 C++ | 📅 2026-09-12 - nmail is a console-based email client for Linux and macOS with a user interface similar to alpine / pine.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,204 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,782 | 🐛 53 | 🌐 Go | 📅 2026-09-22 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,931 | 🐛 109 | 🌐 Java | 📅 2026-09-22 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
* [devzat](https://github.com/quackduck/devzat) ⭐ 4,068 | 🐛 25 | 🌐 Go | 📅 2026-07-23 - Custom SSH server that takes you to a chat instead of a shell prompt.
* [Sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,478 | 🐛 44 | 🌐 Python | 📅 2022-12-08 - CLI client for Slack.
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,152 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,967 | 🐛 20 | 🌐 C++ | 📅 2026-09-20 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,726 | 🐛 80 | 🌐 Go | 📅 2026-09-22 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,381 | 🐛 98 | 🌐 Rust | 📅 2026-09-15 - Signal Messenger client for terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,324 | 🐛 128 | 🌐 Python | 📅 2026-09-12 - Mastodon CLI & TUI.
* [toxic](https://github.com/Jfreegman/toxic) ⭐ 1,305 | 🐛 20 | 🌐 C | 📅 2026-07-14 - A Tox-based instant messaging and video chat client.
* [tiny](https://github.com/osa1/tiny) ⭐ 1,180 | 🐛 94 | 🌐 Rust | 📅 2026-03-19 - tiny is an IRC client written in Rust.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,014 | 🐛 15 | 🌐 Rust | 📅 2026-09-21 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 994 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 865 | 🐛 475 | 🌐 Python | 📅 2026-08-16 - Official Zulip terminal client with TUI.
* [PingMe](https://github.com/kha7iq/pingme) ⭐ 864 | 🐛 4 | 🌐 Go | 📅 2026-07-15 - Sends messages or alerts to multiple messaging platforms & email, including Slack, Telegram, Mattermost, WeChat, and others.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 759 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [Servitor](https://github.com/bentonedmondson/servitor) ⭐ 84 | 🐛 2 | 🌐 Go | 📅 2024-07-22 - A command-line Fediverse client that doesn’t require a server.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,408 | 🐛 116 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,984 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,507 | 🐛 16 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,736 | 🐛 41 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,553 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,903 | 🐛 151 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,695 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,946 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,671 | 🐛 26 | 🌐 Rust | 📅 2026-09-21 - Fast, collaborative live terminal sharing over the web.
* [dog](https://github.com/ogham/dog) ⭐ 6,691 | 🐛 78 | 🌐 Rust | 📅 2024-05-29 - dog is a command-line DNS client. It has colorful output, understands normal command-line argument syntax, supports the DNS-over-TLS and DNS-over-HTTPS protocols, and can emit JSON.
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,119 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,049 | 🐛 29 | 🌐 Rust | 📅 2026-09-21 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,721 | 🐛 35 | 🌐 Go | 📅 2026-09-12 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,581 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - TUI for sniffing network traffic using eBPF on Linux.
* [asn](https://github.com/nitefood/asn) ⭐ 1,936 | 🐛 4 | 🌐 Shell | 📅 2026-09-22 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [Tunnelmole](https://github.com/robbie-cahill/tunnelmole-client) ⭐ 1,891 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-13 - Connect to local servers from anywhere.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,858 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,612 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
...
* [neoss](https://github.com/PabloLec/neoss) ⭐ 231 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-22 - User-friendly and detailed socket statistics with a Terminal UI.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,012 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,861 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,410 | 🐛 13 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [goto](https://github.com/grafviktor/goto) ⭐ 533 | 🐛 11 | 🌐 Go | 📅 2026-09-22 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
* [sshed](https://github.com/trntv/sshed) ⭐ 158 | 🐛 5 | 🌐 Go | 📅 2024-05-23 - sshed is a ssh config editor and bookmarks manager.
* [ssm](https://github.com/lfaoro/ssm) ⭐ 113 | 🐛 10 | 🌐 Go | 📅 2026-09-21 - SSH connection manager designed to connect, filter, tag, and much more from a simple terminal interface.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,021 | 🐛 2,665 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,321 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,644 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,420 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,694 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,945 | 🐛 182 | 🌐 Python | 📅 2026-09-22 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,809 | 🐛 1,135 | 🌐 Python | 📅 2026-09-19 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,088 | 🐛 202 | 🌐 Go | 📅 2026-09-21 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,718 | 🐛 125 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,101 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
...
* [shbin](https://github.com/Shiphero/shbin) ⭐ 70 | 🐛 17 | 🌐 Python | 📅 2025-04-22 - Upload code snippets, notebooks, images or any other content to a GitHub repository that acts as your internal pastebin, and returns the URL to share it with your team.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,864 | 🐛 391 | 🌐 C++ | 📅 2026-09-22 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,234 | 🐛 10 | 🌐 Python | 📅 2026-09-21 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,499 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,985 | 🐛 174 | 🌐 Go | 📅 2026-09-22 - Feature-rich interactive Jira command line.
...
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,845 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [is-fast](https://github.com/Magic-JD/is-fast) ⭐ 172 | 🐛 3 | 🌐 Rust | 📅 2025-11-03 - A TUI tool designed for quick and efficient internet searches directly from the terminal, ideal for environments where you don't have easy access to a browser.
...
* [Todoman](https://github.com/pimutils/todoman) ⭐ 595 | 🐛 113 | 🌐 Python | 📅 2026-05-25 - A simple, standards-based, CLI todo (aka: task) manager.
...
* [omm](https://github.com/dhth/omm) ⭐ 333 | 🐛 11 | 🌐 Go | 📅 2026-09-20 - "on-my-mind" is a keyboard-driven task manager for the command line.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,663 | 🐛 127 | 🌐 C++ | 📅 2026-09-19 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 2 | 🌐 Python | 📅 2026-09-22 - Simple timer for the terminal with timer-mode and alarm.
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,322 | 🐛 152 | 🌐 Python | 📅 2026-09-22 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,412 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,084 | 🐛 41 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,810 | 🐛 26 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 880 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Store your ideas without leaving the terminal.
...
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 536 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - Terminal-based markdown note manager.
...
* [Toney](https://github.com/SourcewareLab/Toney) ⭐ 209 | 🐛 5 | 🌐 Go | 📅 2026-05-27 - A fast, lightweight, terminal-based note-taking TUI app built with Bubbletea; Offers markdown rendering, file navigation and native Neovim editing.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,207 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - A powerful bookmark manager written in Python3 and SQLite3.
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,767 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,053 | 🐛 265 | 🌐 Python | 📅 2026-09-21 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,878 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,360 | 🐛 7 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,878 | 🐛 225 | 🌐 Python | 📅 2026-09-04 - CalDAV synchronization program.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,237 | 🐛 34 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Puffin](https://github.com/siddhantac/puffin) ⭐ 571 | 🐛 11 | 🌐 Go | 📅 2026-03-11 - A beautiful TUI dashboard for hledger.
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 335 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 96 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,132 | 🐛 824 | 🌐 TypeScript | 📅 2026-09-23 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 44,047 | 🐛 74 | 🌐 Go | 📅 2026-09-21 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,461 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,100 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [gtt](https://github.com/eeeXun/gtt) ⭐ 306 | 🐛 4 | 🌐 Go | 📅 2026-08-02 - Google Translate TUI (Originally), now supporting Apertium, Argos, Bing, ChatGPT, DeepL, DeepLX, Google, Reverso.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,665 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,865 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,431 | 🐛 172 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
* [mdp](https://github.com/visit1985/mdp) ⭐ 5,280 | 🐛 7 | 🌐 C | 📅 2026-09-09 - A command-line based Markdown presentation tool.
...
* [DeckTape](https://github.com/astefanutti/decktape) ⭐ 2,428 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - DeckTape is a high-quality PDF exporter for HTML presentation frameworks.
* [Lotus 1-2-3 for Linux](https://github.com/taviso/123elf) ⭐ 1,292 | 🐛 40 | 🌐 C | 📅 2026-06-27 - A native port of Lotus 1-2-3 Release 3 to Linux.
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 528 | 🐛 15 | 🌐 Python | 📅 2026-09-23 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [write good](https://github.com/btford/write-good) ⭐ 5,091 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English prose.
...
* [GTT - Google Translate TUI](https://github.com/eeeXun/GTT) ⭐ 306 | 🐛 4 | 🌐 Go | 📅 2026-08-02 - A TUI interface to bring Google Translation in the terminal.
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 169 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,690 | 🐛 130 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,868 | 🐛 461 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,612 | 🐛 111 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,963 | 🐛 94 | 🌐 Go | 📅 2026-09-22 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,290 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 143 | 🐛 2 | 🌐 Rust | 📅 2026-09-23 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [c0admin](https://github.com/mbrell/c0admin) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2026-08-06 - A terminal-based AI assistant for Linux sysadmins. Uses the Gemini API.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-22 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,487 | 🐛 530 | 🌐 Go | 📅 2026-09-20 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,696 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,505 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,266 | 🐛 53 | 🌐 C | 📅 2026-09-22 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,321 | 🐛 29 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
...
* [Diagon](https://github.com/ArthurSonzogni/Diagon) ⭐ 2,224 | 🐛 21 | 🌐 C++ | 📅 2025-05-16 - Diagon is an interactive interpreter, that transforms Markdown-style expression into an ASCII-art representation.
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,049 | 🐛 36 | 🌐 C | 📅 2026-09-11 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,824 | 🐛 8 | 🌐 Python | 📅 2026-09-23 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 419 | 🐛 7 | 🌐 Rust | 📅 2026-09-22 - A powerful Rust image optimization CLI tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,783 | 🐛 72 | 🌐 Python | 📅 2026-09-22 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,660 | 🐛 11 | 🌐 Shell | 📅 2026-08-30 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 606 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,695 | 🐛 708 | 🌐 Python | 📅 2026-09-22 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,229 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,779 | 🐛 214 | 🌐 Rust | 📅 2026-09-21 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [PyRadio](https://github.com/coderholic/pyradio) ⭐ 1,096 | 🐛 11 | 🌐 Python | 📅 2026-05-07 - Curses based internet radio player.
...
* [ytui-music](https://github.com/sudipghimire533/ytui-music) ⭐ 773 | 🐛 38 | 🌐 Rust | 📅 2025-03-03 - YouTube client in terminal for music (lightweight YouTube client).
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 595 | 🐛 19 | 🌐 Rust | 📅 2026-09-20 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-22 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,844 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,097 | 🐛 1 | 🌐 C | 📅 2026-09-23 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,097 | 🐛 1 | 🌐 C | 📅 2026-09-23 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,214 | 🐛 49 | 🌐 Rust | 📅 2026-09-22 - Terminal Music Player written in Rust.
...
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,818 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,263 | 🐛 9 | 🌐 Python | 📅 2026-09-22 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [neo](https://github.com/st3w/neo) ⭐ 962 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,548 | 🐛 517 | 🌐 Rust | 📅 2026-09-22 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,282 | 🐛 36 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,431 | 🐛 18 | 🌐 C | 📅 2026-09-21 - Cross-platform Audio Visualizer.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,760 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,024 | 🐛 28 | 🌐 Go | 📅 2026-09-22 - Feature-rich terminal-based text viewer.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,418 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - Terminal image, video, directory, and Markdown viewer.
...
* [epy](https://github.com/wustho/epy) ⭐ 1,217 | 🐛 72 | 🌐 Python | 📅 2024-03-17 - CLI Ebook (epub2, epub3, fb2, mobi) Reader.
* [medium-cli](https://github.com/djadmin/medium-cli) ⭐ 735 | 🐛 42 | 🌐 JavaScript | 📅 2026-02-13 - Medium for Hackers - Read [medium.com](https://medium.com/) stories in the terminal.
* [hackernews-TUI](https://github.com/aome510/hackernews-TUI) ⭐ 720 | 🐛 10 | 🌐 Rust | 📅 2026-03-29 - A Terminal UI to browse Hacker News.
* [fancy-cat](https://github.com/freref/fancy-cat) ⭐ 562 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - CLI PDF reader with Vim keybindings.
* [baca](https://github.com/wustho/baca) ⭐ 525 | 🐛 12 | 🌐 Python | 📅 2024-03-05 - Lets you indulge in your favorite e-books in the comfort of your terminal.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 356 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 - Minimalistic Vim-like TUI document reader.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,994 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,960 | 🐛 176 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,823 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
* [terminalizer](https://github.com/faressoft/terminalizer) ⭐ 16,161 | 🐛 108 | 🌐 JavaScript | 📅 2024-08-29 - Record your terminal and generate animated GIF images or share a web player link [www.terminalizer.com](www.terminalizer.com).
...
* [t-rec](https://github.com/sassman/t-rec-rs) ⭐ 1,254 | 🐛 29 | 🌐 Rust | 📅 2026-09-21 - Blazingly fast terminal recorder that generates animated GIF images for the web written in rust.
...
* [goscript](https://github.com/elisescu/goscript) ⭐ 40 | 🐛 1 | 🌐 CSS | 📅 2024-08-21 - Goscript is a tool that records the terminal session (well, any command you run it with) and saves the output in a self contained HTML file that can be run in the browser, to playback the session.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,192 | 🐛 448 | 🌐 Go | 📅 2026-09-21 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,830 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [PaperAge](https://github.com/matiaskorhonen/paper-age) ⭐ 614 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - Easy and secure paper backups of secrets, which takes a text and generates an encrypted QR code to print on paper.
...
* [eddy](https://github.com/70sh1/eddy) ⭐ 54 | 🐛 0 | 🌐 Go | 📅 2026-09-22 - Simple, fast CLI file encryption tool.
* [secret\_share](https://github.com/scosman/secret_share) ⭐ 26 | 🐛 3 | 🌐 Go | 📅 2026-08-21 - The program allows you to share messages (secrets and passwords) securely with a CLI.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,763 | 🐛 14 | 🌐 Rust | 📅 2026-09-21 - Manage your GnuPG keys with ease!
...
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 948 | 🐛 5 | 🌐 Go | 📅 2026-09-17 - A command-line tool for interacting with OAuth 2.0 authorization servers.
...
* [teller](https://github.com/tellerops/teller) ⭐ 3,229 | 🐛 52 | 🌐 Rust | 📅 2026-01-27 - Cloud native secrets management for developers - never leave your command line for secrets.
* [rbw](https://github.com/doy/rbw) ⭐ 1,497 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,346 | 🐛 632 | 🌐 Python | 📅 2026-09-19 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 774 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A TUI and CLI for managing your arr servers.
...
* [Raijin](https://github.com/MasonStooksbury/Raijin) ⭐ 173 | 🐛 2 | 🌐 Rust | 📅 2026-09-22 - A free, simple weather TUI that pulls data without the need for an API key, account, or subscription.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,320 | 🐛 14 | 🌐 Shell | 📅 2026-09-21 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,051 | 🐛 12 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [tinytetris](https://github.com/taylorconor/tinytetris) ⭐ 3,288 | 🐛 29 | 🌐 C++ | 📅 2024-07-09 - 80x23 terminal tetris game.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,183 | 🐛 34 | 🌐 Rust | 📅 2026-09-17 - Play chess from your terminal.
...
* [terminal-doom](https://github.com/cryptocode/terminal-doom) ⭐ 443 | 🐛 2 | 🌐 C | 📅 2026-04-26 - Play DOOM in modern terminals.
...
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 303 | 🐛 17 | 🌐 Python | 📅 2026-08-30 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
* [2048-cli](https://github.com/Frost-Phoenix/2048-cli) ⭐ 50 | 🐛 1 | 🌐 C | 📅 2024-04-12 - A 2048 clone that run in the terminal.
...
* [Terminal Ping Pong](https://github.com/IshmamR/terminal.pong) ⭐ 35 | 🐛 0 | 🌐 Rust | 📅 2025-07-09 - A ping pong game in your terminal (play against AI opponent or a friend locally).
...
* [Maze of Me](https://github.com/bakill3/maze-of-me) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2025-09-02 - A deeply personal psychological game powered by AI and real user data.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,252 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,253 | 🐛 19 | 🌐 Rust | 📅 2026-09-22 - Turn your keyboard into a typewriter adding sounds at each keystroke.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,489 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,661 | 🐛 187 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,449 | 🐛 0 | 🌐 Shell | 📅 2026-09-21 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,201 | 🐛 16 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,703 | 🐛 45 | 📅 2026-09-22 - An awesome list dedicated to TUI programs.
