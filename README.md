...
* [eza](https://github.com/eza-community/eza) ⭐ 23,206 | 🐛 445 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,215 | 🐛 207 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,259 | 🐛 32 | 🌐 Rust | 📅 2026-09-07 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,330 | 🐛 144 | 🌐 Rust | 📅 2026-09-08 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,042 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,146 | 🐛 75 | 🌐 Lua | 📅 2026-08-10 - Directory changer that learns your habits.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,348 | 🐛 203 | 🌐 Rust | 📅 2026-09-09 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,787 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,455 | 🐛 186 | 🌐 C | 📅 2026-08-28 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,135 | 🐛 436 | 🌐 Rust | 📅 2026-09-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,872 | 🐛 292 | 🌐 Rust | 📅 2026-09-08 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,881 | 🐛 70 | 🌐 Go | 📅 2026-09-08 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,134 | 🐛 191 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,829 | 🐛 52 | 🌐 Rust | 📅 2026-09-09 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,839 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,347 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 531 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,240 | 🐛 8 | 🌐 Rust | 📅 2026-09-09 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,244 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,968 | 🐛 54 | 🌐 Go | 📅 2026-09-10 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,981 | 🐛 142 | 🌐 C | 📅 2026-09-07 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [procs](https://github.com/dalance/procs) ⭐ 6,163 | 🐛 34 | 🌐 Rust | 📅 2026-09-09 - A modern replacement for ps written in Rust.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,514 | 🐛 32 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,418 | 🐛 116 | 🌐 C | 📅 2026-09-09 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,086 | 🐛 70 | 🌐 Rust | 📅 2026-09-09 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,141 | 🐛 268 | 🌐 Go | 📅 2026-09-09 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,879 | 🐛 4 | 🌐 C | 📅 2026-09-09 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,500 | 🐛 85 | 🌐 Go | 📅 2026-09-09 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,726 | 🐛 102 | 🌐 Rust | 📅 2026-08-20 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,638 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 474 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,722 | 🐛 27 | 🌐 C | 📅 2026-09-09 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,749 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,745 | 🐛 90 | 🌐 Rust | 📅 2026-09-07 - Painless compression and decompression in the terminal.
...
* [compsize](https://github.com/kilobyte/compsize) ⭐ 413 | 🐛 22 | 🌐 C | 📅 2023-12-25 - Find compression type/ratio on a file or set of files on a btrfs file system.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,442 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,663 | 🐛 62 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 182,238 | 🐛 626 | 🌐 Python | 📅 2026-09-09 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,456 | 🐛 537 | 🌐 Rust | 📅 2026-09-07 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,720 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,345 | 🐛 374 | 🌐 Python | 📅 2026-06-23.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,743 | 🐛 51 | 🌐 Python | 📅 2026-09-08 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,025 | 🐛 7 | 🌐 Python | 📅 2026-09-05 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,621 | 🐛 29 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,943 | 🐛 299 | 🌐 Go | 📅 2026-09-10 - Portable command-line YAML processor.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,670 | 🐛 40 | 🌐 Python | 📅 2026-08-28 - Serializes the output of command line tools to JSON.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,802 | 🐛 18 | 🌐 Go | 📅 2026-09-04 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,744 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,834 | 🐛 24 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,482 | 🐛 20 | 🌐 Python | 📅 2026-09-09 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,408 | 🐛 630 | 🌐 Go | 📅 2026-09-10 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,377 | 🐛 39 | 🌐 Python | 📅 2026-09-09 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,977 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,107 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,015 | 🐛 72 | 🌐 Go | 📅 2026-09-09 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,392 | 🐛 44 | 🌐 Python | 📅 2026-09-07 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,323 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,284 | 🐛 46 | 🌐 Go | 📅 2026-09-09 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,959 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,777 | 🐛 30 | 🌐 Rust | 📅 2026-09-10 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,777 | 🐛 30 | 🌐 Rust | 📅 2026-09-10 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,200 | 🐛 12 | 🌐 Go | 📅 2026-09-09 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,099 | 🐛 17 | 🌐 Rust | 📅 2026-09-09 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,561 | 🐛 73 | 🌐 Go | 📅 2026-09-10 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,821 | 🐛 6 | 🌐 Go | 📅 2022-06-11 - A TUI for viewing and editing databases, written in pure Go.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,196 | 🐛 2 | 🌐 Python | 📅 2026-09-10 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,884 | 🐛 330 | 🌐 Go | 📅 2026-09-09 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,947 | 🐛 4 | 🌐 Rust | 📅 2026-09-08 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,255 | 🐛 81 | 🌐 Rust | 📅 2026-09-08 - Blazing fast general purpose fuzzy finder TUI.
...
* [fzy](https://github.com/jhawthorn/fzy) ⭐ 3,302 | 🐛 57 | 🌐 C | 📅 2025-07-29 - Better fuzzy finder.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,241 | 🐛 230 | 🌐 Go | 📅 2026-09-07 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,128 | 🐛 661 | 🌐 Rust | 📅 2026-09-08 - Create book from Markdown files.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 819 | 🐛 65 | 🌐 Python | 📅 2026-08-31 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,555 | 🐛 960 | 🌐 Go | 📅 2026-09-10 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,560 | 🐛 174 | 🌐 Rust | 📅 2026-08-27 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [zee](https://github.com/zee-editor/zee) ⭐ 1,804 | 🐛 44 | 🌐 Rust | 📅 2025-02-06 - Zee is a modern editor for the terminal, in the spirit of Emacs. It is written in Rust and it is somewhat experimental.
* [vy](https://github.com/vyapp/vy) ⚠️ Archived - A vim-like in Python made from scratch.
* [o](https://github.com/xyproto/orbiton) ⭐ 700 | 🐛 0 | 🌐 Go | 📅 2026-09-09 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,181 | 🐛 1,032 | 🌐 Go | 📅 2026-09-09 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,193 | 🐛 473 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,473 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,100 | 🐛 96 | 🌐 Shell | 📅 2026-09-01 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,328 | 🐛 233 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,493 | 🐛 101 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,224 | 🐛 114 | 🌐 Rust | 📅 2026-09-07 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,045 | 🐛 65 | 🌐 Rust | 📅 2026-09-09 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,024 | 🐛 179 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,214 | 🐛 81 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 7,002 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - A simple and efficient way to access various statistics in a git repository.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,939 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [Froggit](https://github.com/thewizardshell/froggit) ⭐ 486 | 🐛 3 | 🌐 Go | 📅 2026-03-20 - Minimalist Git TUI with GitHub CLI integration.
...
* [gitnr](https://github.com/reemus-dev/gitnr) ⭐ 237 | 🐛 4 | 🌐 Rust | 📅 2026-08-29 - Create `.gitignore` files using one or more templates from TopTal, GitHub or your own collection.
...
* [git-remote-aws](https://github.com/nathants/git-remote-aws) ⭐ 169 | 🐛 0 | 🌐 Go | 📅 2026-09-09 - Management of encrypted git hosting.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,489 | 🐛 1,233 | 🌐 Rust | 📅 2026-09-10 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,269 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-10 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,983 | 🐛 706 | 🌐 Go | 📅 2026-09-10 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,031 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-08 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,973 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,515 | 🐛 27 | 🌐 Perl | 📅 2026-09-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,896 | 🐛 241 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,345 | 🐛 498 | 🌐 Go | 📅 2026-09-04 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,247 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,844 | 🐛 17 | 🌐 Python | 📅 2026-09-09 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,053 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,729 | 🐛 26 | 🌐 Go | 📅 2026-09-07 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,420 | 🐛 38 | 🌐 Rust | 📅 2026-09-06 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,123 | 🐛 444 | 🌐 Rust | 📅 2026-09-09 - Developer environments you can take with you.
...
* [PuDB](https://github.com/inducer/pudb) ⭐ 3,247 | 🐛 164 | 🌐 Python | 📅 2026-09-02 - Allows you to debug code right where you write and test it in a terminal.
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,650 | 🐛 15 | 🌐 Python | 📅 2026-08-27 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
* [scons](https://github.com/SCons/scons) ⭐ 2,418 | 🐛 652 | 🌐 Python | 📅 2026-09-08 - Software construction tool.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 895 | 🐛 166 | 🌐 Rust | 📅 2026-09-09 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 600 | 🐛 4 | 🌐 Go | 📅 2026-09-09 - Update binaries installed by "go install" with goroutines.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 13 | 🌐 Python | 📅 2026-09-09 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Tokui](https://github.com/zdyxry/tokui) ⭐ 52 | 🐛 1 | 🌐 Go | 📅 2026-09-09 - An interactive TUI for visualizing code statistics from tockei.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,085 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
* [readme-md-generator](https://github.com/kefranabg/readme-md-generator) ⭐ 11,132 | 🐛 30 | 🌐 JavaScript | 📅 2022-09-20 - CLI that generates beautiful README.md files.
...
* [mklicense](https://github.com/cezaraugusto/mklicense) ⭐ 208 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-03 - CLI tool for easily generating the text of the most common licenses.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,553 | 🐛 81 | 🌐 Go | 📅 2026-09-09 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,345 | 🐛 498 | 🌐 Go | 📅 2026-09-04 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,856 | 🐛 42 | 🌐 Go | 📅 2026-08-19 - Multi pod and container log tailing for Kubernetes.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,402 | 🐛 8 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
...
* [Ducker](https://github.com/robertpsoane/ducker) ⭐ 927 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - TUI for managing docker containers.
* [E1S](https://github.com/keidarcy/e1s) ⭐ 927 | 🐛 0 | 🌐 Go | 📅 2026-09-07 - TUI for browsing and managing AWS ECS resources.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 12 | 🌐 Rust | 📅 2026-09-07 - A TUI tool designed for monitoring Kubernetes resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,489 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,471 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,388 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,898 | 🐛 80 | 🌐 Rust | 📅 2026-09-08 - Fast, async, resource-friendly link checker written in Rust.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,918 | 🐛 7 | 🌐 Go | 📅 2026-09-07 - Domain Availability Research Tool.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,279 | 🐛 1 | 🌐 Rust | 📅 2026-09-09 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,863 | 🐛 1,859 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,716 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,320 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,690 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,754 | 🐛 78 | 🌐 Python | 📅 2026-09-05 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,050 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [brightnessctl](https://github.com/Hummer12007/brightnessctl) ⭐ 1,265 | 🐛 24 | 🌐 C | 📅 2024-12-16 - Read and control device brightness. Devices, by default, include backlight and LEDs - searched for in corresponding classes.
* [tufw](https://github.com/peltho/tufw) ⭐ 864 | 🐛 4 | 🌐 Go | 📅 2026-06-08 - Terminal UI for the UFW Linux firewall.
* [immortal](https://github.com/immortal/immortal) ⭐ 838 | 🐛 2 | 🌐 Go | 📅 2026-08-16 - A \*nix cross-platform (OS agnostic) supervisor.
* [has](https://github.com/kdabir/has) ⭐ 820 | 🐛 14 | 🌐 Shell | 📅 2026-09-05 - Checks presence of various command line tools on the PATH and reports their installed version.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,904 | 🐛 250 | 🌐 Zig | 📅 2026-09-10 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,838 | 🐛 1,846 | 🌐 Rust | 📅 2026-09-09 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,350 | 🐛 1,913 | 🌐 Rust | 📅 2026-09-09 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,467 | 🐛 1,445 | 🌐 Rust | 📅 2026-09-09 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,376 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
* [Oils](https://github.com/oilshell/oil) ⭐ 3,389 | 🐛 611 | 🌐 Python | 📅 2026-09-08 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 281 | 🐛 70 | 🌐 C | 📅 2026-09-09 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,072 | 🐛 150 | 🌐 Shell | 📅 2026-09-06 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,812 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,417 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,675 | 🐛 29 | 🌐 Shell | 📅 2026-09-07 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,035 | 🐛 45 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,830 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,578 | 🐛 87 | 🌐 C | 📅 2026-09-09 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,578 | 🐛 87 | 🌐 C | 📅 2026-09-09 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,917 | 🐛 449 | 🌐 C | 📅 2026-09-10 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,078 | 🐛 105 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,690 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,968 | 🐛 12 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,872 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [Grafterm](https://github.com/slok/grafterm) ⭐ 1,139 | 🐛 11 | 🌐 Go | 📅 2022-06-10 - Metrics TUI dashboards on terminal, a Grafana inspired terminal version.
* [updo](https://github.com/Owloops/updo) ⭐ 1,132 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,078 | 🐛 30 | 🌐 Go | 📅 2026-09-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,504 | 🐛 209 | 🌐 Rust | 📅 2026-09-09 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,071 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,281 | 🐛 88 | 🌐 Go | 📅 2026-09-08 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,551 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,771 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,837 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,150 | 🐛 70 | 🌐 Shell | 📅 2026-08-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,964 | 🐛 150 | 🌐 Go | 📅 2026-09-02 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,275 | 🐛 27 | 🌐 Go | 📅 2026-09-04 - A Docker manager for the terminal.
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,075 | 🐛 59 | 🌐 Go | 📅 2026-08-21 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,833 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,377 | 🐛 115 | 🌐 C | 📅 2026-09-06 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,324 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,764 | 🐛 23 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
...
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,505 | 🐛 6 | 🌐 Go | 📅 2026-08-08 - Executing shell commands via HTTP server.
...
* [dotbins](https://github.com/basnijholt/dotbins) ⭐ 271 | 🐛 28 | 🌐 Python | 📅 2026-09-02 - Keep updated binaries in your dotfiles.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,215 | 🐛 8 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,215 | 🐛 8 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,321 | 🐛 222 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 890 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - Terminal mail client.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,189 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,767 | 🐛 54 | 🌐 Go | 📅 2026-09-10 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,907 | 🐛 111 | 🌐 Java | 📅 2026-08-21 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,943 | 🐛 14 | 🌐 C++ | 📅 2026-08-30 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
...
* [Weechat-Matrix](https://github.com/poljar/weechat-matrix) ⭐ 994 | 🐛 127 | 🌐 Python | 📅 2023-07-23 - A Python script for Weechat that lets Weechat communicate over the Matrix protocol.
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 980 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 71 | 🐛 16 | 🌐 Rust | 📅 2026-09-08 - TUI client for Nostr.
...
* [gping](https://github.com/orf/gping) ⭐ 12,676 | 🐛 38 | 🌐 Rust | 📅 2026-08-31 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,340 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,959 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,492 | 🐛 15 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,733 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,539 | 🐛 57 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,898 | 🐛 150 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,689 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,891 | 🐛 83 | 🌐 Rust | 📅 2026-09-09 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,656 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [dog](https://github.com/ogham/dog) ⭐ 6,693 | 🐛 79 | 🌐 Rust | 📅 2024-05-29 - dog is a command-line DNS client. It has colorful output, understands normal command-line argument syntax, supports the DNS-over-TLS and DNS-over-HTTPS protocols, and can emit JSON.
...
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,111 | 🐛 49 | 🌐 C | 📅 2026-08-20 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,069 | 🐛 32 | 🌐 C | 📅 2026-09-08 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,012 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,720 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
* [tproxy](https://github.com/kevwan/tproxy) ⭐ 3,705 | 🐛 6 | 🌐 Go | 📅 2026-07-09 - A CLI tool to proxy and analyze TCP connections.
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,341 | 🐛 139 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,714 | 🐛 34 | 🌐 Go | 📅 2026-09-05 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,577 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - TUI for sniffing network traffic using eBPF on Linux.
* [asn](https://github.com/nitefood/asn) ⭐ 1,932 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
* [gg](https://github.com/mzz2017/gg) ⭐ 1,931 | 🐛 48 | 🌐 Go | 📅 2026-07-06 - A command-line tool for one-click proxy in your research and development without installing v2ray or anything else.
* [Tunnelmole](https://github.com/robbie-cahill/tunnelmole-client) ⭐ 1,887 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-13 - Connect to local servers from anywhere.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,835 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
* [Wishlist](https://github.com/charmbracelet/wishlist) ⭐ 1,661 | 🐛 20 | 🌐 Go | 📅 2026-09-01 - With Wishlist you can have a single entrypoint for multiple SSH endpoints.
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,599 | 🐛 23 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,560 | 🐛 2 | 🌐 Rust | 📅 2026-09-09 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,236 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 538 | 🐛 0 | 🌐 Go | 📅 2026-09-05 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
* [dug](https://github.com/unfrl/dug) ⭐ 371 | 🐛 13 | 🌐 C# | 📅 2026-01-11 - A global DNS propagation checker that gives pretty output.
* [chiko](https://github.com/felangga/chiko) ⭐ 355 | 🐛 0 | 🌐 Go | 📅 2026-04-15 - The ultimate beauty gRPC Client on your Terminal: a simple tool to interact with gRPC services using a beautiful terminal interface.
...
* [neoss](https://github.com/PabloLec/neoss) ⭐ 230 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-04 - User-friendly and detailed socket statistics with a Terminal UI.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,999 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,844 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,405 | 🐛 12 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [goto](https://github.com/grafviktor/goto) ⭐ 533 | 🐛 13 | 🌐 Go | 📅 2026-09-09 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 190,041 | 🐛 2,644 | 🌐 Python | 📅 2026-08-30 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,176 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,965 | 🐛 1,177 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,286 | 🐛 4 | 🌐 Go | 📅 2026-09-10 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,670 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,919 | 🐛 182 | 🌐 Python | 📅 2026-09-06 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,466 | 🐛 1,139 | 🌐 Python | 📅 2026-09-04 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,064 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,054 | 🐛 189 | 🌐 Go | 📅 2026-09-09 - Beautiful and feature-rich Telegram downloader, written in Go.
* [ffsend](https://github.com/timvisee/ffsend) ⭐ 7,410 | 🐛 33 | 🌐 Rust | 📅 2025-11-20 - Easily and securely share files from the command line. A fully featured Firefox Send client.
* [zrok](https://github.com/openziti/zrok) ⭐ 4,669 | 🐛 124 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
* [ytfzf](https://github.com/pystardust/ytfzf) ⭐ 4,150 | 🐛 66 | 🌐 Shell | 📅 2024-09-27 - A POSIX script that helps you find YouTube videos (without API) and opens/downloads them using mpv/youtube-dl.
* [curlie](https://github.com/rs/curlie) ⭐ 3,717 | 🐛 26 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,529 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,075 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [Yark](https://github.com/Owez/yark) ⭐ 2,184 | 🐛 21 | 🌐 Python | 📅 2026-07-30 - YouTube archiving made simple.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,857 | 🐛 380 | 🌐 C++ | 📅 2026-09-06 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
...
* [nom](https://github.com/guyfedwards/nom) ⭐ 743 | 🐛 33 | 🌐 Go | 📅 2026-07-08 - RSS reader for the terminal.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,489 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
* [s](https://github.com/zquestz/s) ⭐ 2,599 | 🐛 0 | 🌐 Go | 📅 2026-07-27 - Web search from the terminal. Just opens in your browser.
* [Amfora](https://github.com/makew0rld/amfora) ⭐ 1,357 | 🐛 10 | 🌐 Go | 📅 2026-07-03 - Amfora aims to be the best looking Gemini client with the most features. It does not support Gopher or other non-Web protocols.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,959 | 🐛 170 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,542 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,833 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 811 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [av](https://github.com/aviator-co/av) ⭐ 511 | 🐛 76 | 🌐 Go | 📅 2026-09-07 - A command line tool to manage stacked PRs with Aviator.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,120 | 🐛 133 | 🌐 Rust | 📅 2026-09-06 - A terminal user interface for taskwarrior.
...
* [topydo](https://github.com/topydo/topydo) ⭐ 935 | 🐛 78 | 🌐 Python | 📅 2026-09-07 - A powerful todo list application for the console, using the todo.txt format.
...
* [omm](https://github.com/dhth/omm) ⭐ 331 | 🐛 11 | 🌐 Go | 📅 2026-08-05 - "on-my-mind" is a keyboard-driven task manager for the command line.
...
* [zeit](https://github.com/mrusme/zeit) ⭐ 587 | 🐛 0 | 🌐 Go | 📅 2026-09-09 - A command line tool for tracking time spent on activities.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,401 | 🐛 151 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,310 | 🐛 152 | 🌐 Python | 📅 2026-09-09 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,793 | 🐛 27 | 🌐 Go | 📅 2026-08-31 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [Toney](https://github.com/SourcewareLab/Toney) ⭐ 206 | 🐛 4 | 🌐 Go | 📅 2026-05-27 - A fast, lightweight, terminal-based note-taking TUI app built with Bubbletea; Offers markdown rendering, file navigation and native Neovim editing.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,196 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,044 | 🐛 264 | 🌐 Python | 📅 2026-09-07 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,873 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,350 | 🐛 5 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,229 | 🐛 33 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,900 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 288 | 🐛 9 | 🌐 Rust | 📅 2026-09-09 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 93 | 🐛 4 | 🌐 Rust | 📅 2026-09-07 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,885 | 🐛 814 | 🌐 TypeScript | 📅 2026-09-10 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,873 | 🐛 69 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,433 | 🐛 103 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [tenere](https://github.com/pythops/tenere) ⭐ 682 | 🐛 11 | 🌐 Rust | 📅 2026-05-10 - A TUI for LLMs (ChatGPT, llama\_cpp, ollama) written in Rust.
...
* [cai](https://github.com/ad-si/cai) ⭐ 202 | 🐛 6 | 🌐 Rust | 📅 2026-09-04 - The fastest CLI tool for prompting LLMs. Including support for prompting several LLMs at once!
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,078 | 🐛 105 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,652 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,829 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,399 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
* [mdp](https://github.com/visit1985/mdp) ⭐ 5,276 | 🐛 7 | 🌐 C | 📅 2026-09-09 - A command-line based Markdown presentation tool.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-09-09 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [sdcv](https://github.com/Dushistov/sdcv) ⭐ 366 | 🐛 43 | 🌐 C++ | 📅 2025-12-17 - Simple, cross-platform, text-based utility for working with dictionaries in StarDict format.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 166 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,683 | 🐛 109 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,913 | 🐛 41 | 🌐 Rust | 📅 2026-07-10 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 721 | 🐛 12 | 🌐 C | 📅 2026-09-05 - Base conversion and bit manipulator in ncurses.
* [bcal](https://github.com/jarun/bcal) ⭐ 702 | 🐛 0 | 🌐 C | 📅 2026-09-05 - Byte CALculator - A REPL CLI utility for storage expression evaluation, SI/IEC conversion, byte address calculation, base conversion and LBA/CHS calculation.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,791 | 🐛 457 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
...
* [pet](https://github.com/knqyf263/pet) ⭐ 5,344 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [eg](https://github.com/srsudar/eg) ⭐ 2,041 | 🐛 15 | 🌐 Python | 📅 2025-02-06 - Useful examples at the command line.
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,949 | 🐛 90 | 🌐 Go | 📅 2026-09-09 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,284 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 135 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-09 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,353 | 🐛 525 | 🌐 Go | 📅 2026-09-09 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,667 | 🐛 262 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,232 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,225 | 🐛 54 | 🌐 C | 📅 2026-09-06 - Terminal graphics for the 21 st century.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,038 | 🐛 38 | 🌐 C | 📅 2026-08-20 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,812 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 418 | 🐛 12 | 🌐 Rust | 📅 2026-09-05 - A powerful Rust image optimization CLI tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,743 | 🐛 76 | 🌐 Python | 📅 2026-09-09 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,486 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,653 | 🐛 11 | 🌐 Shell | 📅 2026-08-30 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,345 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,642 | 🐛 711 | 🌐 Python | 📅 2026-09-08 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,789 | 🐛 227 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,194 | 🐛 154 | 🌐 Rust | 📅 2026-09-09 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
...
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,737 | 🐛 168 | 🌐 C | 📅 2026-09-05 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [radio-active](https://github.com/deep5050/radio-active) ⭐ 598 | 🐛 17 | 🌐 Python | 📅 2026-06-30 - Internet radio player with 40k+ stations.
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 587 | 🐛 27 | 🌐 Rust | 📅 2026-09-09 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-09 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [spytorec](https://github.com/Danidukiyu/SpytoRec) ⭐ 16 | 🐛 2 | 🌐 Python | 📅 2026-09-03 - Real-time Spotify recorder with automatic track splitting, metadata tagging, and high-quality FLAC/OGG output.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,834 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,038 | 🐛 2 | 🌐 C | 📅 2026-09-09 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,038 | 🐛 2 | 🌐 C | 📅 2026-09-09 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,196 | 🐛 50 | 🌐 Rust | 📅 2026-09-08 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,237 | 🐛 7 | 🌐 Python | 📅 2026-09-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 617 | 🐛 43 | 🌐 Go | 📅 2026-09-09 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,394 | 🐛 514 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,749 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,019 | 🐛 28 | 🌐 Go | 📅 2026-09-08 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,557 | 🐛 15 | 🌐 Go | 📅 2026-08-30 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,406 | 🐛 8 | 🌐 Rust | 📅 2026-09-05 - Terminal image, video, directory, and Markdown viewer.
...
* [GopherTube](https://github.com/krishnassh/gophertube) ⭐ 429 | 🐛 2 | 🌐 Go | 📅 2026-09-05 - A terminal-based YouTube client that scrapes YouTube search results and uses mpv for video playback.
* [reader](https://github.com/mrusme/reader) ⭐ 413 | 🐛 0 | 🌐 Go | 📅 2026-07-21 - Reader parses a web page for its actual content and displays it in nicely highlighted text on the command line
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,966 | 🐛 12 | 🌐 Rust | 📅 2026-09-09 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,845 | 🐛 172 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,789 | 🐛 10 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
* [terminalizer](https://github.com/faressoft/terminalizer) ⭐ 16,162 | 🐛 108 | 🌐 JavaScript | 📅 2024-08-29 - Record your terminal and generate animated GIF images or share a web player link [www.terminalizer.com](www.terminalizer.com).
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,721 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,074 | 🐛 446 | 🌐 Go | 📅 2026-09-07 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,060 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,761 | 🐛 14 | 🌐 Rust | 📅 2026-09-07 - Manage your GnuPG keys with ease!
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,181 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,104 | 🐛 98 | 🌐 Go | 📅 2026-09-03 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 945 | 🐛 5 | 🌐 Go | 📅 2026-08-19 - A command-line tool for interacting with OAuth 2.0 authorization servers.
...
* [pdvzip](https://github.com/CleasbyCode/pdvzip) ⭐ 63 | 🐛 1 | 🌐 C++ | 📅 2026-08-18 - CLI tool to embed a ZIP file within a PNG image to create a tweetable and "executable" PNG-ZIP polyglot file. Post & share your PNG-ZIP image on compatible sites.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,471 | 🐛 103 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [pa](https://github.com/biox/pa) ⭐ 571 | 🐛 3 | 🌐 Shell | 📅 2026-08-30 - A simple password manager; encryption via age, written in portable POSIX shell.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,301 | 🐛 609 | 🌐 Python | 📅 2026-09-09 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,691 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 765 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing your arr servers.
* [oji](https://github.com/xxczaki/oji) ⭐ 733 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-30 - Interactive text emoji creator.
* [play](https://github.com/paololazzari/play) ⭐ 586 | 🐛 3 | 🌐 Go | 📅 2025-03-28 - TUI playground for your favorite programs, such as grep, sed and awk.
* [sisi](https://github.com/frost-beta/sisi) ⭐ 581 | 🐛 4 | 🌐 TypeScript | 📅 2024-09-16 - Semantic image search CLI tool.
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 516 | 🐛 15 | 🌐 Go | 📅 2026-09-07 - Cross Platform tool to validate configuration files.
...
* [anbu](https://github.com/tanq16/anbu) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2026-08-29 - A swiss army knife for CLI operations catered to devs and security professionals.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,298 | 🐛 13 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Countryfetch](https://github.com/nik-rev/countryfetch) ⭐ 280 | 🐛 5 | 🌐 Rust | 📅 2026-03-06 - A Command-line tool similar to Neofetch for obtaining information about your country.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,044 | 🐛 11 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [tinytetris](https://github.com/taylorconor/tinytetris) ⭐ 3,293 | 🐛 29 | 🌐 C++ | 📅 2024-07-09 - 80x23 terminal tetris game.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,172 | 🐛 32 | 🌐 Rust | 📅 2026-08-27 - Play chess from your terminal.
...
* [DOOM-ASCII](https://github.com/wojciech-graj/doom-ascii) ⭐ 881 | 🐛 0 | 🌐 C | 📅 2025-07-21 - Text-based DOOM running in terminal without sound.
* [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 735 | 🐛 3 | 🌐 Rust | 📅 2026-09-05 - P2P terminal game about spacepirates playing basketball across the galaxy.
...
* [Solitaire TUI](https://github.com/brianstrauch/solitaire-tui) ⭐ 367 | 🐛 4 | 🌐 Go | 📅 2023-09-20 - Klondike solitaire for the terminal.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,243 | 🐛 2 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
* [bucklespring](https://github.com/zevv/bucklespring) ⭐ 1,553 | 🐛 42 | 🌐 C | 📅 2025-08-24 - Emulates the sound of the old IBM Model-M space saver bucklespring keyboard while typing.
...
* [periodic-table-cli](https://github.com/spirometaxas/periodic-table-cli) ⭐ 306 | 🐛 2 | 🌐 JavaScript | 📅 2025-08-03 - An interactive Periodic Table of Elements app for the console!
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 253 | 🐛 37 | 🌐 Python | 📅 2026-09-10 - Track conferences and meetups.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,327 | 🐛 257 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,584 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,355 | 🐛 1 | 🌐 Shell | 📅 2026-09-05 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,197 | 🐛 18 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,543 | 🐛 70 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
