...
* [eza](https://github.com/eza-community/eza) ⭐ 23,302 | 🐛 452 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,228 | 🐛 208 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
* [colorls](https://github.com/athityakumar/colorls) ⭐ 5,139 | 🐛 87 | 🌐 Ruby | 📅 2026-07-27 - A Ruby script that colorizes the `ls` output with color and icons.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,545 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,051 | 🐛 109 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,469 | 🐛 200 | 🌐 Rust | 📅 2026-09-16 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,270 | 🐛 13 | 🌐 C | 📅 2026-09-14 - A breadth-first version of the UNIX find command.
...
* [rip](https://github.com/nivekuil/rip) ⭐ 1,737 | 🐛 26 | 🌐 Rust | 📅 2024-04-08 - Move and restore items from the graveyard (by default, `/tmp/graveyard-$USER` if $XDG\_DATA\_HOME is not set and `$XDG_DATA_HOME/graveyard` otherwise)
...
* [gtrash](https://github.com/umlx5h/gtrash) ⭐ 322 | 🐛 13 | 🌐 Go | 📅 2025-05-22 - TUI for moving and restoring items from the XDG trash. Fully compliant with the FreeDesktop.org specification.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,797 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Intelligent context-aware search engine for your shell history with TUI.
...
* [atuin](https://github.com/ellie/atuin) ⭐ 43 | 🐛 0 | 📅 2026-02-10 - Atuin replaces your existing shell history with a SQLite database, and records additional context for your commands. Additionally, it provides optional and fully encrypted synchronization of your history between machines, via an Atuin server.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,218 | 🐛 441 | 🌐 Rust | 📅 2026-09-15 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,912 | 🐛 290 | 🌐 Rust | 📅 2026-09-14 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,882 | 🐛 70 | 🌐 Go | 📅 2026-09-14 - A diff tool for YAML files, and sometimes JSON.
...
* [diff2html-cli](https://github.com/rtfpessoa/diff2html-cli) ⭐ 605 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-06 - Parse git diffs as JSON and generate pretty HTML.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,383 | 🐛 199 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,943 | 🐛 55 | 🌐 Rust | 📅 2026-09-17 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,847 | 🐛 72 | 🌐 Rust | 📅 2026-09-17 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,297 | 🐛 7 | 🌐 C++ | 📅 2026-09-15 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,354 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,295 | 🐛 18 | 🌐 Rust | 📅 2026-09-17 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 534 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,271 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,270 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,980 | 🐛 54 | 🌐 Go | 📅 2026-09-16 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,131 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,626 | 🐛 541 | 🌐 C++ | 📅 2026-09-18 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,112 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,929 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,010 | 🐛 141 | 🌐 C | 📅 2026-09-16 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [gtop](https://github.com/aksakalli/gtop) ⭐ 9,931 | 🐛 40 | 🌐 JavaScript | 📅 2025-11-06 - System monitoring dashboard for terminal written in Node.js.
...
* [procs](https://github.com/dalance/procs) ⭐ 6,175 | 🐛 36 | 🌐 Rust | 📅 2026-09-16 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,093 | 🐛 39 | 🌐 Python | 📅 2026-09-15 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,518 | 🐛 32 | 🌐 Rust | 📅 2026-09-18 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,707 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [FClones](https://github.com/pkolaczk/fclones) ⭐ 2,939 | 🐛 102 | 🌐 Rust | 📅 2025-03-03 - Efficient Duplicate File Finder.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,263 | 🐛 64 | 🌐 Rust | 📅 2026-09-17 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,272 | 🐛 269 | 🌐 Go | 📅 2026-09-18 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,890 | 🐛 2 | 🌐 C | 📅 2026-09-16 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,514 | 🐛 84 | 🌐 Go | 📅 2026-09-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,728 | 🐛 102 | 🌐 Rust | 📅 2026-09-17 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,638 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,215 | 🐛 477 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,726 | 🐛 27 | 🌐 C | 📅 2026-09-15 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,825 | 🐛 11 | 🌐 Rust | 📅 2026-09-16 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,760 | 🐛 95 | 🌐 Rust | 📅 2026-09-17 - Painless compression and decompression in the terminal.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,755 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,668 | 🐛 61 | 🌐 C | 📅 2026-09-16 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 185,193 | 🐛 679 | 🌐 Python | 📅 2026-09-16 - Python tool for converting files and office documents to Markdown.
* [unoserver](https://github.com/unoconv/unoserver) ⭐ 935 | 🐛 11 | 🌐 Python | 📅 2026-06-10 - Using LibreOffice as a server for converting documents, it allows converting multiple documents without loading libreoffice into memory every time.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-17 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,497 | 🐛 538 | 🌐 Rust | 📅 2026-09-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,722 | 🐛 47 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,385 | 🐛 377 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,352 | 🐛 5 | 🌐 Perl | 📅 2026-09-02 - Command line tool for URL parsing and manipulation.
...
* [catdir](https://github.com/emilastanov/catdir) ⭐ 5 | 🐛 3 | 🌐 Python | 📅 2025-05-14 - A simple CLI utility that traverses directories and concatenates the contents of all files within a folder and its subfolders, similar to the Unix cat command, but for entire directory trees.
...
* [ttyplot](https://github.com/tenox7/ttyplot) ⭐ 1,380 | 🐛 11 | 🌐 C | 📅 2026-07-28 - A realtime plotting utility for terminals with data input from stdin/pipe.
...
* [lowcharts](https://github.com/juan-leon/lowcharts) ⭐ 254 | 🐛 10 | 🌐 Rust | 📅 2025-12-22 - lowcharts is meant to be used in those scenarios where we have numerical data in text files that we want to display in the terminal to do a basic analysis.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,630 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,971 | 🐛 300 | 🌐 Go | 📅 2026-09-17 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,519 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,677 | 🐛 44 | 🌐 Python | 📅 2026-09-17 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,175 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,114 | 🐛 32 | 🌐 Rust | 📅 2026-09-17 - Interactive JSON filter using jq.
* [jo](https://github.com/jpmens/jo) ⭐ 4,867 | 🐛 7 | 🌐 C | 📅 2025-06-20 - A small utility to create JSON objects from the command line.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Pure Go implementation of jq.
...
* [GROQ](https://github.com/sanity-io/groq-cli) ⭐ 236 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-17 - The CLI tool consumes both JSON and NDJSON documents. You can pass in data from a local file, or from piping to standard input.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,462 | 🐛 582 | 🌐 Go | 📅 2026-09-18 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,392 | 🐛 45 | 🌐 Python | 📅 2026-09-16 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,976 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,118 | 🐛 121 | 🌐 Go | 📅 2026-09-13 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
...
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,408 | 🐛 44 | 🌐 Python | 📅 2026-09-17 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,403 | 🐛 32 | 🌐 Python | 📅 2026-09-17 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,337 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,307 | 🐛 42 | 🌐 Go | 📅 2026-09-17 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,970 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,787 | 🐛 33 | 🌐 Rust | 📅 2026-09-17 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,787 | 🐛 33 | 🌐 Rust | 📅 2026-09-17 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,110 | 🐛 17 | 🌐 Rust | 📅 2026-09-18 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,567 | 🐛 74 | 🌐 Go | 📅 2026-09-17 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,170 | 🐛 116 | 🌐 Python | 📅 2026-09-02 - Python CLI utility and library for manipulating SQLite databases.
...
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,823 | 🐛 6 | 🌐 Go | 📅 2022-06-11 - A TUI for viewing and editing databases, written in pure Go.
...
* [zsv](https://github.com/liquidaty/zsv) ⭐ 397 | 🐛 24 | 🌐 C | 📅 2026-09-18 - The world's fastest (simd) CSV parser, with an extensible, multi-purpose CLI.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,088 | 🐛 329 | 🌐 Go | 📅 2026-09-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,965 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,278 | 🐛 79 | 🌐 Rust | 📅 2026-09-11 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,360 | 🐛 234 | 🌐 Go | 📅 2026-09-14 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,155 | 🐛 656 | 🌐 Rust | 📅 2026-09-15 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,827 | 🐛 125 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,292 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 822 | 🐛 65 | 🌐 Python | 📅 2026-08-31 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,599 | 🐛 935 | 🌐 Go | 📅 2026-09-18 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,573 | 🐛 166 | 🌐 Rust | 📅 2026-09-17 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,435 | 🐛 1,031 | 🌐 Go | 📅 2026-09-17 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,368 | 🐛 482 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,501 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
...
* [tig](https://github.com/jonas/tig) ⭐ 13,341 | 🐛 234 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,529 | 🐛 101 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,245 | 🐛 117 | 🌐 Rust | 📅 2026-09-13 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [BFG Repo-Cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,191 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,049 | 🐛 66 | 🌐 Rust | 📅 2026-09-18 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,039 | 🐛 151 | 🌐 Go | 📅 2026-09-17 - Distributed, offline-first bug tracker embedded in git, with bridges.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,078 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - A utility tool powered by fzf for using git interactively.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,320 | 🐛 13 | 🌐 Rust | 📅 2026-09-08 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [czg](https://github.com/Zhengqbbb/cz-git) ⭐ 1,528 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22 - Interactively generate standardized commit messages.
* [fzf-git.sh](https://github.com/junegunn/fzf-git.sh) ⭐ 1,184 | 🐛 13 | 🌐 Shell | 📅 2026-08-06 - bash and zsh key bindings for Git objects, powered by fzf.
...
* [Froggit](https://github.com/thewizardshell/froggit) ⭐ 484 | 🐛 3 | 🌐 Go | 📅 2026-03-20 - Minimalist Git TUI with GitHub CLI integration.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,637 | 🐛 1,252 | 🌐 Rust | 📅 2026-09-18 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,393 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-13 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,157 | 🐛 757 | 🌐 Go | 📅 2026-09-18 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,045 | 🐛 406 | 🌐 JavaScript | 📅 2026-09-16 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,990 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,543 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,920 | 🐛 243 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,363 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,252 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,845 | 🐛 18 | 🌐 Python | 📅 2026-09-12 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,059 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-17 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,761 | 🐛 26 | 🌐 Go | 📅 2026-09-15 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,190 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,128 | 🐛 434 | 🌐 Rust | 📅 2026-09-17 - Developer environments you can take with you.
* [rebound](https://github.com/shobrook/rebound) ⭐ 4,112 | 🐛 24 | 🌐 Python | 📅 2022-02-16 - Fetch Stack Overflow results in your terminal when you get an error. Supported languages: Python, Node.js, Ruby, Go, and Java.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,655 | 🐛 15 | 🌐 Python | 📅 2026-09-17 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 901 | 🐛 161 | 🌐 Rust | 📅 2026-09-18 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 140 | 🐛 13 | 🌐 Python | 📅 2026-09-18 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Scrut](https://github.com/facebookincubator/scrut) ⭐ 82 | 🐛 8 | 🌐 Rust | 📅 2026-09-17 - A testing toolkit for CLI applications designed to rigorously test terminal programs, inspired by Cram and focuses on providing a straightforward way to validate CLI behaviour.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,091 | 🐛 313 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,621 | 🐛 78 | 🌐 Go | 📅 2026-09-18 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,363 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,862 | 🐛 39 | 🌐 Go | 📅 2026-09-14 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,537 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,641 | 🐛 24 | 🌐 Go | 📅 2026-09-14 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,516 | 🐛 143 | 🌐 Go | 📅 2026-09-09 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,194 | 🐛 88 | 🌐 C | 📅 2026-08-30 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,194 | 🐛 88 | 🌐 C | 📅 2026-08-30 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,406 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,229 | 🐛 9 | 🌐 Go | 📅 2026-09-11 - TUI for Podman environment.
...
* [E1S](https://github.com/keidarcy/e1s) ⭐ 929 | 🐛 1 | 🌐 Go | 📅 2026-09-07 - TUI for browsing and managing AWS ECS resources.
* [PUG](https://github.com/leg100/pug) ⭐ 701 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - TUI for Terraform (perform tasks in parallel, manage state resources, calculate costs, automatically loads workspace variable files).
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 394 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 - A TUI tool designed for monitoring Kubernetes resources.
...
* [lazycontainer](https://github.com/andreybleme/lazycontainer) ⭐ 373 | 🐛 8 | 🌐 Go | 📅 2026-08-17 - TUI for managing Apple containers.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,524 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,423 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,919 | 🐛 81 | 🌐 Rust | 📅 2026-09-14 - Fast, async, resource-friendly link checker written in Rust.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,922 | 🐛 7 | 🌐 Go | 📅 2026-09-14 - Domain Availability Research Tool.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,377 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,030 | 🐛 1,876 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,855 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,326 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,702 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,760 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,294 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,057 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [brightnessctl](https://github.com/Hummer12007/brightnessctl) ⭐ 1,270 | 🐛 24 | 🌐 C | 📅 2024-12-16 - Read and control device brightness. Devices, by default, include backlight and LEDs - searched for in corresponding classes.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,241 | 🐛 259 | 🌐 Zig | 📅 2026-09-18 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,933 | 🐛 1,862 | 🌐 Rust | 📅 2026-09-17 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [dtach](https://github.com/crigler/dtach) ⭐ 742 | 🐛 20 | 🌐 C | 📅 2025-06-21 - A program written in C that emulates the detach feature of screen.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,447 | 🐛 1,926 | 🌐 Rust | 📅 2026-09-14 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,521 | 🐛 1,437 | 🌐 Rust | 📅 2026-09-17 - A modern shell written in Rust, where all data is structured.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 282 | 🐛 62 | 🌐 C | 📅 2026-09-18 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-17 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,115 | 🐛 150 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,419 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,875 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,674 | 🐛 92 | 🌐 C | 📅 2026-09-18 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,674 | 🐛 92 | 🌐 C | 📅 2026-09-18 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,932 | 🐛 449 | 🌐 C | 📅 2026-09-16 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,092 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,584 | 🐛 106 | 🌐 Go | 📅 2025-07-10 - Cross-platform and fully-customizable TUI dashboard and widget library.
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,712 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [kmon](https://github.com/orhun/kmon) ⭐ 2,946 | 🐛 23 | 🌐 Rust | 📅 2026-09-17 - Linux TUI Kernel manager and activity monitor.
...
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,971 | 🐛 12 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,887 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [Grafterm](https://github.com/slok/grafterm) ⭐ 1,142 | 🐛 11 | 🌐 Go | 📅 2022-06-10 - Metrics TUI dashboards on terminal, a Grafana inspired terminal version.
* [updo](https://github.com/Owloops/updo) ⭐ 1,133 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,086 | 🐛 28 | 🌐 Go | 📅 2026-09-14 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,550 | 🐛 210 | 🌐 Rust | 📅 2026-09-17 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,075 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,292 | 🐛 87 | 🌐 Go | 📅 2026-09-17 - Manages binary files downloaded from different sources.
...
* [getghrel](https://github.com/kavishgr/getghrel) ⚠️ Archived - A user-friendly command-line tool that fetches and installs the latest release assets from GitHub for macOS and Linux; it automatically detects your operating system and architecture, downloads the relevant binary, and unpacks it, ensuring a hassle-free experience.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,573 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,857 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,838 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,190 | 🐛 74 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,982 | 🐛 153 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,078 | 🐛 64 | 🌐 Go | 📅 2026-09-17 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,396 | 🐛 115 | 🌐 C | 📅 2026-09-17 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,336 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,684 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,779 | 🐛 26 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,724 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,895 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 - А command line tool for generating ANSI fonts in the console.
* [fnt](https://github.com/alexmyczko/fnt) ⭐ 639 | 🐛 8 | 🌐 Shell | 📅 2026-09-18 - apt for fonts, the missing font manager for macOS/Linux.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,264 | 🐛 17 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,264 | 🐛 17 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,907 | 🐛 30 | 🌐 Go | 📅 2026-09-01 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,339 | 🐛 222 | 🌐 TypeScript | 📅 2026-09-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 889 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 - Terminal mail client.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,200 | 🐛 1,186 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,776 | 🐛 54 | 🌐 Go | 📅 2026-09-12 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,916 | 🐛 109 | 🌐 Java | 📅 2026-09-17 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,145 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,959 | 🐛 16 | 🌐 C++ | 📅 2026-09-12 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 992 | 🐛 4 | 🌐 Python | 📅 2026-09-16 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,386 | 🐛 116 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,976 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,500 | 🐛 15 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,735 | 🐛 41 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,551 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,902 | 🐛 151 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,692 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,934 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,664 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [dog](https://github.com/ogham/dog) ⭐ 6,694 | 🐛 78 | 🌐 Rust | 📅 2024-05-29 - dog is a command-line DNS client. It has colorful output, understands normal command-line argument syntax, supports the DNS-over-TLS and DNS-over-HTTPS protocols, and can emit JSON.
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,112 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,030 | 🐛 32 | 🌐 Rust | 📅 2026-09-17 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,344 | 🐛 140 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,716 | 🐛 35 | 🌐 Go | 📅 2026-09-12 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,580 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - TUI for sniffing network traffic using eBPF on Linux.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,852 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,606 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
...
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,241 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
...
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 730 | 🐛 12 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,007 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 191,810 | 🐛 2,657 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,262 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,468 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,367 | 🐛 7 | 🌐 Go | 📅 2026-09-14 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,687 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,935 | 🐛 182 | 🌐 Python | 📅 2026-09-14 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,727 | 🐛 1,133 | 🌐 Python | 📅 2026-09-12 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,084 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,073 | 🐛 193 | 🌐 Go | 📅 2026-09-14 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,681 | 🐛 125 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,084 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [Yark](https://github.com/Owez/yark) ⭐ 2,188 | 🐛 21 | 🌐 Python | 📅 2026-07-30 - YouTube archiving made simple.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,863 | 🐛 383 | 🌐 C++ | 📅 2026-09-17 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,234 | 🐛 10 | 🌐 Python | 📅 2026-09-14 - A Python tool that lets you find and download torrents without leaving your CLI.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 695 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
* [Stig](https://github.com/rndusr/stig) ⭐ 629 | 🐛 59 | 🌐 Python | 📅 2026-01-24 - Stig is a client application to connect and control the BitTorrent Transmission client app.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,978 | 🐛 172 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,555 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
...
* [Neon Modem Overdrive](https://github.com/mrusme/neonmodem) ⭐ 697 | 🐛 21 | 🌐 Go | 📅 2026-07-21 - The program allows you to manage and read content from various popular platforms without having to use a browser or separate apps.
* [av](https://github.com/aviator-co/av) ⭐ 510 | 🐛 75 | 🌐 Go | 📅 2026-09-14 - A command line tool to manage stacked PRs with Aviator.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,950 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,128 | 🐛 132 | 🌐 Rust | 📅 2026-09-13 - A terminal user interface for taskwarrior.
...
* [Togo](https://github.com/prime-run/togo) ⭐ 189 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - A fast and simple terminal-based task and todo manager built in go.
...
* [doing](https://github.com/ttscoff/doing) ⭐ 1,293 | 🐛 2 | 🌐 Ruby | 📅 2026-07-27 - A command line tool for remembering what you were doing and tracking what you've done.
...
* [zeit](https://github.com/mrusme/zeit) ⭐ 590 | 🐛 0 | 🌐 Go | 📅 2026-09-09 - A command line tool for tracking time spent on activities.
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,322 | 🐛 152 | 🌐 Python | 📅 2026-09-17 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,801 | 🐛 24 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,765 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,051 | 🐛 264 | 🌐 Python | 📅 2026-09-14 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,877 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,360 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,877 | 🐛 225 | 🌐 Python | 📅 2026-09-04 - CalDAV synchronization program.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,234 | 🐛 34 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,905 | 🐛 17 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
* [mop](https://github.com/mop-tracker/mop) ⭐ 2,211 | 🐛 7 | 🌐 Go | 📅 2025-12-28 - Stock market tracker for hackers.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 331 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,051 | 🐛 839 | 🌐 TypeScript | 📅 2026-09-18 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,967 | 🐛 72 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,452 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [kwaak](https://github.com/bosun-ai/kwaak) ⭐ 333 | 🐛 33 | 🌐 Rust | 📅 2026-01-27 - Run a team of autonomous AI agents on your code.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,092 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,661 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,855 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,421 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [Lotus 1-2-3 for Linux](https://github.com/taviso/123elf) ⭐ 1,291 | 🐛 40 | 🌐 C | 📅 2026-06-27 - A native port of Lotus 1-2-3 Release 3 to Linux.
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 528 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [SheetsUI](https://github.com/zaphar/sheetsui) ⭐ 246 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 - A console based (TUI) spreadsheet application.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,688 | 🐛 123 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [navi](https://github.com/denisidoro/navi) ⭐ 17,562 | 🐛 111 | 🌐 Rust | 📅 2026-09-15 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,530 | 🐛 15 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,349 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,957 | 🐛 93 | 🌐 Go | 📅 2026-09-16 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [docfd](https://github.com/darrenldl/docfd) ⭐ 290 | 🐛 3 | 🌐 OCaml | 📅 2026-09-08 - TUI fuzzy document finder that looks for documentation files in Markdown and txt format in the directory tree.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 139 | 🐛 1 | 🌐 Rust | 📅 2026-09-17 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,457 | 🐛 527 | 🌐 Go | 📅 2026-09-15 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,677 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,236 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,496 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,258 | 🐛 55 | 🌐 C | 📅 2026-09-06 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,319 | 🐛 29 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,821 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 1,003 | 🐛 15 | 🌐 Python | 📅 2026-09-15 - AI-Powered Command-Line Photo Search Tool.
...
* [asciiMOL](https://github.com/dewberryants/asciiMol) ⭐ 419 | 🐛 0 | 🌐 Python | 📅 2026-06-24 - Curses based ASCII molecule viewer for terminals.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,766 | 🐛 70 | 🌐 Python | 📅 2026-09-16 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,504 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 604 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,672 | 🐛 706 | 🌐 Python | 📅 2026-09-18 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,221 | 🐛 155 | 🌐 Rust | 📅 2026-09-12 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
...
* [PyRadio](https://github.com/coderholic/pyradio) ⭐ 1,094 | 🐛 11 | 🌐 Python | 📅 2026-05-07 - Curses based internet radio player.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-17 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [cue](https://github.com/ravachol/cue) ⭐ 3,079 | 🐛 1 | 🌐 C | 📅 2026-09-17 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,079 | 🐛 1 | 🌐 C | 📅 2026-09-17 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,209 | 🐛 51 | 🌐 Rust | 📅 2026-09-16 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,251 | 🐛 9 | 🌐 Python | 📅 2026-09-18 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 619 | 🐛 43 | 🌐 Go | 📅 2026-09-18 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [The Cognitive Sandbox](https://github.com/sylcrala/cognitive_sandbox) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-01-04 - The project is a local simulation environment that allows individual agents (particles) to interact with and remeber each other across sessions.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,489 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,758 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,021 | 🐛 28 | 🌐 Go | 📅 2026-09-15 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,563 | 🐛 14 | 🌐 Go | 📅 2026-09-17 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,416 | 🐛 11 | 🌐 Rust | 📅 2026-09-14 - Terminal image, video, directory, and Markdown viewer.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 354 | 🐛 15 | 🌐 Rust | 📅 2026-08-26 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 347 | 🐛 6 | 🌐 Rust | 📅 2026-08-27 - An TUI for exploring data of a Kafka cluster.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,981 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
* [pipes.sh](https://github.com/pipeseroni/pipes.sh) ⭐ 3,026 | 🐛 14 | 🌐 Shell | 📅 2024-08-12 - Animated pipes terminal screensaver.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,924 | 🐛 175 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,814 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,724 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,148 | 🐛 446 | 🌐 Go | 📅 2026-09-18 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,080 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,201 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,106 | 🐛 99 | 🌐 Go | 📅 2026-09-16 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 945 | 🐛 5 | 🌐 Go | 📅 2026-09-17 - A command-line tool for interacting with OAuth 2.0 authorization servers.
...
* [pdvzip](https://github.com/CleasbyCode/pdvzip) ⭐ 64 | 🐛 1 | 🌐 C++ | 📅 2026-09-15 - CLI tool to embed a ZIP file within a PNG image to create a tweetable and "executable" PNG-ZIP polyglot file. Post & share your PNG-ZIP image on compatible sites.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,486 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [pa](https://github.com/biox/pa) ⭐ 574 | 🐛 5 | 🌐 Shell | 📅 2026-08-30 - A simple password manager; encryption via age, written in portable POSIX shell.
...
* [oama](https://github.com/pdobsan/oama) ⭐ 256 | 🐛 11 | 🌐 Haskell | 📅 2025-08-29 - OAuth credential Manager.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,331 | 🐛 615 | 🌐 Python | 📅 2026-09-13 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,695 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [fzf-tab-completion](https://github.com/lincheney/fzf-tab-completion) ⭐ 863 | 🐛 33 | 🌐 Shell | 📅 2026-07-31 - Tab completion using fzf.
...
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 770 | 🐛 2 | 🌐 Rust | 📅 2026-09-17 - A TUI and CLI for managing your arr servers.
* [oji](https://github.com/xxczaki/oji) ⭐ 733 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-30 - Interactive text emoji creator.
* [play](https://github.com/paololazzari/play) ⭐ 589 | 🐛 3 | 🌐 Go | 📅 2025-03-28 - TUI playground for your favorite programs, such as grep, sed and awk.
* [sisi](https://github.com/frost-beta/sisi) ⭐ 580 | 🐛 4 | 🌐 TypeScript | 📅 2024-09-16 - Semantic image search CLI tool.
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 517 | 🐛 14 | 🌐 Go | 📅 2026-09-17 - Cross Platform tool to validate configuration files.
...
* [Raijin](https://github.com/MasonStooksbury/Raijin) ⭐ 173 | 🐛 2 | 🌐 Rust | 📅 2026-09-18 - A free, simple weather TUI that pulls data without the need for an API key, account, or subscription.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,314 | 🐛 16 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [thokr](https://github.com/jrnxf/thokr) ⭐ 601 | 🐛 8 | 🌐 Rust | 📅 2026-06-12 - Sleek typing TUI with visualized results and historical logging.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,179 | 🐛 33 | 🌐 Rust | 📅 2026-09-17 - Play chess from your terminal.
...
* [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 740 | 🐛 5 | 🌐 Rust | 📅 2026-09-11 - P2P terminal game about spacepirates playing basketball across the galaxy.
...
* [Solitaire TUI](https://github.com/brianstrauch/solitaire-tui) ⭐ 370 | 🐛 4 | 🌐 Go | 📅 2023-09-20 - Klondike solitaire for the terminal.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,252 | 🐛 19 | 🌐 Rust | 📅 2026-09-17 - Turn your keyboard into a typewriter adding sounds at each keystroke.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,441 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,635 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,415 | 🐛 0 | 🌐 Shell | 📅 2026-09-13 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Terminals Are Sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,118 | 🐛 153 | 🌐 Shell | 📅 2024-07-26 - A curated list of Terminal frameworks, plugins & resources for CLI lovers.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,643 | 🐛 46 | 📅 2026-09-16 - An awesome list dedicated to TUI programs.
