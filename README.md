...
* [eza](https://github.com/eza-community/eza) ⭐ 23,311 | 🐛 453 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,233 | 🐛 208 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,266 | 🐛 31 | 🌐 Rust | 📅 2026-09-14 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,568 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,482 | 🐛 201 | 🌐 Rust | 📅 2026-09-16 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,271 | 🐛 13 | 🌐 C | 📅 2026-09-14 - A breadth-first version of the UNIX find command.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,789 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
...
* [trash-cli](https://github.com/sindresorhus/trash-cli) ⭐ 1,414 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-18 - Move files and folders to the trash on Linux (XDG trash), macOS (`macOS-trash` library) and Windows (`recycle-bin` library).
* [gomi](https://github.com/babarot/gomi) ⭐ 570 | 🐛 2 | 🌐 Go | 📅 2026-06-07 - UNIX rm command with a safety net.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,462 | 🐛 186 | 🌐 C | 📅 2026-09-16 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [atuin](https://github.com/ellie/atuin) ⭐ 44 | 🐛 0 | 📅 2026-02-10 - Atuin replaces your existing shell history with a SQLite database, and records additional context for your commands. Additionally, it provides optional and fully encrypted synchronization of your history between machines, via an Atuin server.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,230 | 🐛 442 | 🌐 Rust | 📅 2026-09-15 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,915 | 🐛 288 | 🌐 Rust | 📅 2026-09-18 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,882 | 🐛 71 | 🌐 Go | 📅 2026-09-14 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,425 | 🐛 199 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,957 | 🐛 56 | 🌐 Rust | 📅 2026-09-19 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,848 | 🐛 70 | 🌐 Rust | 📅 2026-09-17 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,355 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,296 | 🐛 18 | 🌐 Rust | 📅 2026-09-17 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 535 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,273 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,278 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,982 | 🐛 54 | 🌐 Go | 📅 2026-09-16 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,649 | 🐛 544 | 🌐 C++ | 📅 2026-09-19 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,113 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,929 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,011 | 🐛 141 | 🌐 C | 📅 2026-09-16 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,095 | 🐛 39 | 🌐 Python | 📅 2026-09-15 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,708 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,421 | 🐛 109 | 🌐 C | 📅 2026-09-18 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,286 | 🐛 65 | 🌐 Rust | 📅 2026-09-18 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,287 | 🐛 269 | 🌐 Go | 📅 2026-09-18 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,930 | 🐛 1 | 🌐 C | 📅 2026-09-16 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,516 | 🐛 84 | 🌐 Go | 📅 2026-09-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,729 | 🐛 102 | 🌐 Rust | 📅 2026-09-17 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,640 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,216 | 🐛 477 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,726 | 🐛 26 | 🌐 C | 📅 2026-09-19 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,826 | 🐛 12 | 🌐 Rust | 📅 2026-09-16 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,761 | 🐛 95 | 🌐 Rust | 📅 2026-09-17 - Painless compression and decompression in the terminal.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,449 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,672 | 🐛 61 | 🌐 C | 📅 2026-09-16 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 185,453 | 🐛 695 | 🌐 Python | 📅 2026-09-16 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-18 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,506 | 🐛 539 | 🌐 Rust | 📅 2026-09-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,723 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,391 | 🐛 378 | 🌐 Python | 📅 2026-06-23.
...
* [awk](https://github.com/onetrueawk/awk) ⭐ 2,228 | 🐛 15 | 🌐 C | 📅 2026-08-19 - A historical, general-purpose text file processor, implements a domain-specific language designed for text processing and typically used as a data extraction and reporting tool.
...
* [gtree](https://github.com/ddddddO/gtree) ⭐ 362 | 🐛 38 | 🌐 Go | 📅 2026-09-18 - Using either Markdown or programmatically to generate directory trees and directories, and to verify directories.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,744 | 🐛 49 | 🌐 Python | 📅 2026-09-18 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,039 | 🐛 9 | 🌐 Python | 📅 2026-09-18 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,632 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,974 | 🐛 301 | 🌐 Go | 📅 2026-09-17 - Portable command-line YAML processor.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,677 | 🐛 47 | 🌐 Python | 📅 2026-09-17 - Serializes the output of command line tools to JSON.
* [dasel](https://github.com/TomWright/dasel) ⭐ 8,036 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Allows you to query and modify data structures using selector strings.
* [jid](https://github.com/simeji/jid) ⭐ 7,177 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 18 | 🌐 Go | 📅 2026-09-18 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,759 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [GROQ](https://github.com/sanity-io/groq-cli) ⭐ 236 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-18 - The CLI tool consumes both JSON and NDJSON documents. You can pass in data from a local file, or from piping to standard input.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,469 | 🐛 579 | 🌐 Go | 📅 2026-09-18 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,394 | 🐛 45 | 🌐 Python | 📅 2026-09-16 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,977 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,117 | 🐛 121 | 🌐 Go | 📅 2026-09-13 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,019 | 🐛 72 | 🌐 Go | 📅 2026-09-14 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,404 | 🐛 32 | 🌐 Python | 📅 2026-09-17 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,338 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,308 | 🐛 42 | 🌐 Go | 📅 2026-09-17 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,971 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,788 | 🐛 34 | 🌐 Rust | 📅 2026-09-18 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,788 | 🐛 34 | 🌐 Rust | 📅 2026-09-18 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [Soul](https://github.com/thevahidal/soul) ⭐ 1,683 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-03 - A SQLite REST and real-time server.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,121 | 🐛 329 | 🌐 Go | 📅 2026-09-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,965 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,282 | 🐛 79 | 🌐 Rust | 📅 2026-09-11 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,381 | 🐛 235 | 🌐 Go | 📅 2026-09-14 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,158 | 🐛 656 | 🌐 Rust | 📅 2026-09-18 - Create book from Markdown files.
...
* [DocToc](https://github.com/thlorenz/doctoc) ⭐ 4,465 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-04 - Generates table of contents for Markdown files inside local git repository. Links are compatible with anchors generated by GitHub or other sites.
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,290 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 823 | 🐛 67 | 🌐 Python | 📅 2026-08-31 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,605 | 🐛 935 | 🌐 Go | 📅 2026-09-19 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,589 | 🐛 165 | 🌐 Rust | 📅 2026-09-18 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 703 | 🐛 0 | 🌐 Go | 📅 2026-09-18 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,465 | 🐛 1,033 | 🌐 Go | 📅 2026-09-18 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,387 | 🐛 481 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,504 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,105 | 🐛 100 | 🌐 Shell | 📅 2026-09-01 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,533 | 🐛 100 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,246 | 🐛 114 | 🌐 Rust | 📅 2026-09-18 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,048 | 🐛 63 | 🌐 Rust | 📅 2026-09-18 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,042 | 🐛 150 | 🌐 Go | 📅 2026-09-17 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,223 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [git absorb](https://github.com/tummychow/git-absorb) ⭐ 5,726 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - git commit --fixup, but automatic.
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,080 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - A utility tool powered by fzf for using git interactively.
...
* [czg](https://github.com/Zhengqbbb/cz-git) ⭐ 1,529 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-22 - Interactively generate standardized commit messages.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,647 | 🐛 1,252 | 🌐 Rust | 📅 2026-09-19 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,143 | 🐛 17 | 🌐 Rust | 📅 2026-09-19 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,405 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-19 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,177 | 🐛 766 | 🌐 Go | 📅 2026-09-19 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,048 | 🐛 406 | 🌐 JavaScript | 📅 2026-09-16 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,997 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,544 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,921 | 🐛 244 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,366 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,254 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,845 | 🐛 18 | 🌐 Python | 📅 2026-09-12 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,062 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-17 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,762 | 🐛 26 | 🌐 Go | 📅 2026-09-15 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,432 | 🐛 37 | 🌐 Rust | 📅 2026-09-18 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,129 | 🐛 435 | 🌐 Rust | 📅 2026-09-18 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,655 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 901 | 🐛 164 | 🌐 Rust | 📅 2026-09-19 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 602 | 🐛 4 | 🌐 Go | 📅 2026-09-18 - Update binaries installed by "go install" with goroutines.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 140 | 🐛 13 | 🌐 Python | 📅 2026-09-19 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,094 | 🐛 313 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,627 | 🐛 76 | 🌐 Go | 📅 2026-09-18 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,366 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,865 | 🐛 39 | 🌐 Go | 📅 2026-09-14 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,537 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,643 | 🐛 24 | 🌐 Go | 📅 2026-09-14 - Tool for visualizing dynamic node usage within a kubernetes cluster.
...
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,233 | 🐛 13 | 🌐 Go | 📅 2026-09-18 - TUI for Podman environment.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 395 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 - A TUI tool designed for monitoring Kubernetes resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,533 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,426 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,383 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,048 | 🐛 1,880 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,883 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,326 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,703 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-18 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,761 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,006 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
* [Ntfy](https://github.com/dschep/ntfy) ⭐ 4,982 | 🐛 103 | 🌐 Python | 📅 2025-10-27 - Cross-platform Python utility that enables you to automatically get desktop notifications on demand or when long-running commands complete. It can as well send push notifications to your phone once a particular command completes.
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,295 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
...
* [brightnessctl](https://github.com/Hummer12007/brightnessctl) ⭐ 1,272 | 🐛 24 | 🌐 C | 📅 2024-12-16 - Read and control device brightness. Devices, by default, include backlight and LEDs - searched for in corresponding classes.
...
* [has](https://github.com/kdabir/has) ⭐ 823 | 🐛 14 | 🌐 Shell | 📅 2026-09-11 - Checks presence of various command line tools on the PATH and reports their installed version.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,279 | 🐛 255 | 🌐 Zig | 📅 2026-09-18 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,946 | 🐛 1,869 | 🌐 Rust | 📅 2026-09-17 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [dtach](https://github.com/crigler/dtach) ⭐ 743 | 🐛 20 | 🌐 C | 📅 2025-06-21 - A program written in C that emulates the detach feature of screen.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,459 | 🐛 1,927 | 🌐 Rust | 📅 2026-09-18 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,365 | 🐛 21 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,365 | 🐛 21 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,527 | 🐛 1,439 | 🌐 Rust | 📅 2026-09-18 - A modern shell written in Rust, where all data is structured.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 282 | 🐛 62 | 🌐 C | 📅 2026-09-19 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-18 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,122 | 🐛 150 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,822 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,420 | 🐛 1 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,679 | 🐛 30 | 🌐 Shell | 📅 2026-09-13 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,881 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,690 | 🐛 93 | 🌐 C | 📅 2026-09-19 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,690 | 🐛 93 | 🌐 C | 📅 2026-09-19 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,936 | 🐛 449 | 🌐 C | 📅 2026-09-19 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,094 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,585 | 🐛 106 | 🌐 Go | 📅 2025-07-10 - Cross-platform and fully-customizable TUI dashboard and widget library.
...
* [kmon](https://github.com/orhun/kmon) ⭐ 2,948 | 🐛 23 | 🌐 Rust | 📅 2026-09-17 - Linux TUI Kernel manager and activity monitor.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,105 | 🐛 13 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,973 | 🐛 12 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,889 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,134 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,087 | 🐛 28 | 🌐 Go | 📅 2026-09-14 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,556 | 🐛 212 | 🌐 Rust | 📅 2026-09-18 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,075 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,293 | 🐛 87 | 🌐 Go | 📅 2026-09-17 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,580 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,865 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,837 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,198 | 🐛 74 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,985 | 🐛 153 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,841 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,397 | 🐛 115 | 🌐 C | 📅 2026-09-17 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,337 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,685 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,779 | 🐛 26 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,725 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [Steam TUI](https://github.com/dmadisetti/steam-tui) ⭐ 1,036 | 🐛 9 | 🌐 Rust | 📅 2026-03-12 - A simple TUI client for steamcmd, allows for the graphical launching, updating, and downloading of steam games through a simple terminal client.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,894 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,268 | 🐛 17 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,268 | 🐛 17 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
* [tmpmail](https://github.com/sdushantha/tmpmail) ⭐ 4,189 | 🐛 7 | 🌐 Shell | 📅 2024-08-17 - A command line utility written in POSIX sh that allows you to create a temporary email address and receive emails to the temporary email address.
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,908 | 🐛 30 | 🌐 Go | 📅 2026-09-01 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,343 | 🐛 222 | 🌐 TypeScript | 📅 2026-09-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,201 | 🐛 1,186 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
* [slack-term](https://github.com/erroneousboat/slack-term) ⭐ 6,614 | 🐛 68 | 🌐 Go | 📅 2024-04-23 - Slack client for the  terminal.
* [ssh-chat](https://github.com/shazow/ssh-chat) ⭐ 5,912 | 🐛 54 | 🌐 Go | 📅 2026-01-10 - Custom SSH server written in Go. Instead of a shell, you get a chat prompt.
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,777 | 🐛 54 | 🌐 Go | 📅 2026-09-12 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,919 | 🐛 109 | 🌐 Java | 📅 2026-09-18 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
* [devzat](https://github.com/quackduck/devzat) ⭐ 4,067 | 🐛 25 | 🌐 Go | 📅 2026-07-23 - Custom SSH server that takes you to a chat instead of a shell prompt.
* [Sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,478 | 🐛 44 | 🌐 Python | 📅 2022-12-08 - CLI client for Slack.
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,147 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,962 | 🐛 16 | 🌐 C++ | 📅 2026-09-12 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,722 | 🐛 78 | 🌐 Go | 📅 2026-09-18 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,378 | 🐛 98 | 🌐 Rust | 📅 2026-09-15 - Signal Messenger client for terminal.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,387 | 🐛 116 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,977 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,498 | 🐛 15 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,735 | 🐛 41 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,552 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,939 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,665 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,113 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,092 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,115 | 🐛 49 | 🌐 C | 📅 2026-08-20 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,068 | 🐛 32 | 🌐 C | 📅 2026-09-16 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,033 | 🐛 32 | 🌐 Rust | 📅 2026-09-18 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,344 | 🐛 141 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,853 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,607 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,564 | 🐛 2 | 🌐 Rust | 📅 2026-09-18 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [ggh](https://github.com/byawitz/ggh) ⭐ 955 | 🐛 26 | 🌐 Go | 📅 2026-02-10 - Recall your SSH sessions, also searching your SSH config file.
* [Rustcat](https://github.com/robiot/rustcat) ⭐ 812 | 🐛 4 | 🌐 Rust | 📅 2024-07-20 - Netcat Alternative in Rust.
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 731 | 🐛 12 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 542 | 🐛 1 | 🌐 Go | 📅 2026-09-12 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
* [dug](https://github.com/unfrl/dug) ⭐ 371 | 🐛 13 | 🌐 C# | 📅 2026-01-11 - A global DNS propagation checker that gives pretty output.
* [chiko](https://github.com/felangga/chiko) ⭐ 354 | 🐛 1 | 🌐 Go | 📅 2026-04-15 - The ultimate beauty gRPC Client on your Terminal: a simple tool to interact with gRPC services using a beautiful terminal interface.
* [havn](https://github.com/mrjackwills/havn) ⭐ 318 | 🐛 2 | 🌐 Rust | 📅 2026-08-23 - A fast configurable port scanner with reasonable defaults.
* [packemon](https://github.com/ddddddO/packemon) ⭐ 307 | 🐛 36 | 🌐 Go | 📅 2026-09-19 - TUI tool and Go library for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).
...
* [neoss](https://github.com/PabloLec/neoss) ⭐ 230 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-18 - User-friendly and detailed socket statistics with a Terminal UI.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,855 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,019 | 🐛 2,658 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,267 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,507 | 🐛 1,179 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,377 | 🐛 8 | 🌐 Go | 📅 2026-09-18 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,690 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,937 | 🐛 182 | 🌐 Python | 📅 2026-09-14 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,747 | 🐛 1,132 | 🌐 Python | 📅 2026-09-12 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,085 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,076 | 🐛 194 | 🌐 Go | 📅 2026-09-14 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,684 | 🐛 125 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,726 | 🐛 26 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,533 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,089 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,864 | 🐛 399 | 🌐 C++ | 📅 2026-09-18 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
...
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 696 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
...
* [nom](https://github.com/guyfedwards/nom) ⭐ 745 | 🐛 33 | 🌐 Go | 📅 2026-07-08 - RSS reader for the terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,979 | 🐛 172 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,556 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,842 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [MAL-Cli](https://github.com/L4z3x/mal-cli) ⭐ 161 | 🐛 0 | 🌐 Rust | 📅 2025-07-17 - A terminal interface for the official myanimelist api written in Rust and Ratatui.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,952 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,130 | 🐛 132 | 🌐 Rust | 📅 2026-09-13 - A terminal user interface for taskwarrior.
...
* [topydo](https://github.com/topydo/topydo) ⭐ 940 | 🐛 77 | 🌐 Python | 📅 2026-09-16 - A powerful todo list application for the console, using the todo.txt format.
...
* [Togo](https://github.com/prime-run/togo) ⭐ 190 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - A fast and simple terminal-based task and todo manager built in go.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,660 | 🐛 127 | 🌐 C++ | 📅 2026-09-18 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [hours](https://github.com/dhth/hours) ⭐ 347 | 🐛 17 | 🌐 Go | 📅 2026-09-11 - A no-frills time tracking toolkit for command line nerds.
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - Simple timer for the terminal with timer-mode and alarm.
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,323 | 🐛 152 | 🌐 Python | 📅 2026-09-17 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,412 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,082 | 🐛 41 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,805 | 🐛 24 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,202 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - A powerful bookmark manager written in Python3 and SQLite3.
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,766 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,051 | 🐛 265 | 🌐 Python | 📅 2026-09-14 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,877 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 333 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 95 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,074 | 🐛 835 | 🌐 TypeScript | 📅 2026-09-19 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,997 | 🐛 72 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,453 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [parllama](https://github.com/paulrobello/parllama) ⭐ 491 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - TUI designed for easy management and use of Ollama based LLMs.
...
* [Browser CLI](https://github.com/browsemake/browser-cli) ⭐ 48 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-13 - AI agent browser automation tool.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,094 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [ancv](https://github.com/alexpovel/ancv) ⭐ 269 | 🐛 11 | 🌐 Python | 📅 2026-09-18 - Renders your (JSON) resume/CV for online & pretty terminal display.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,856 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,420 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 528 | 🐛 15 | 🌐 Python | 📅 2026-09-19 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,688 | 🐛 129 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,916 | 🐛 40 | 🌐 Rust | 📅 2026-09-18 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,862 | 🐛 458 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,567 | 🐛 112 | 🌐 Rust | 📅 2026-09-15 - An interactive cheatsheet tool for the command-line.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,959 | 🐛 91 | 🌐 Go | 📅 2026-09-18 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 139 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,461 | 🐛 528 | 🌐 Go | 📅 2026-09-15 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,681 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,237 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,498 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,046 | 🐛 36 | 🌐 C | 📅 2026-09-11 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,822 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 1,004 | 🐛 15 | 🌐 Python | 📅 2026-09-19 - AI-Powered Command-Line Photo Search Tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,769 | 🐛 70 | 🌐 Python | 📅 2026-09-18 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,657 | 🐛 11 | 🌐 Shell | 📅 2026-08-30 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 605 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,676 | 🐛 707 | 🌐 Python | 📅 2026-09-19 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,224 | 🐛 156 | 🌐 Rust | 📅 2026-09-12 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,776 | 🐛 213 | 🌐 Rust | 📅 2026-09-14 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 593 | 🐛 17 | 🌐 Rust | 📅 2026-09-14 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-18 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,842 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,086 | 🐛 1 | 🌐 C | 📅 2026-09-19 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,086 | 🐛 1 | 🌐 C | 📅 2026-09-19 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,210 | 🐛 51 | 🌐 Rust | 📅 2026-09-16 - Terminal Music Player written in Rust.
...
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,817 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,251 | 🐛 9 | 🌐 Python | 📅 2026-09-19 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,502 | 🐛 517 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [ov](https://github.com/noborus/ov) ⭐ 2,021 | 🐛 28 | 🌐 Go | 📅 2026-09-19 - Feature-rich terminal-based text viewer.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,417 | 🐛 11 | 🌐 Rust | 📅 2026-09-14 - Terminal image, video, directory, and Markdown viewer.
...
* [epy](https://github.com/wustho/epy) ⭐ 1,215 | 🐛 72 | 🌐 Python | 📅 2024-03-17 - CLI Ebook (epub2, epub3, fb2, mobi) Reader.
...
* [baca](https://github.com/wustho/baca) ⭐ 524 | 🐛 12 | 🌐 Python | 📅 2024-03-05 - Lets you indulge in your favorite e-books in the comfort of your terminal.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 355 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 - Minimalistic Vim-like TUI document reader.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,983 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,934 | 🐛 176 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,818 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,158 | 🐛 447 | 🌐 Go | 📅 2026-09-18 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,075 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,763 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 - Manage your GnuPG keys with ease!
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,202 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,488 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
* [passage](https://github.com/FiloSottile/passage) ⭐ 1,190 | 🐛 34 | 🌐 Shell | 📅 2024-08-30 - A fork of [password-store](https://www.passwordstore.org) that uses [age](https://age-encryption.org) as a backend instead of GnuPG.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,336 | 🐛 618 | 🌐 Python | 📅 2026-09-13 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 770 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A TUI and CLI for managing your arr servers.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 517 | 🐛 11 | 🌐 Go | 📅 2026-09-19 - Cross Platform tool to validate configuration files.
...
* [Raijin](https://github.com/MasonStooksbury/Raijin) ⭐ 173 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A free, simple weather TUI that pulls data without the need for an API key, account, or subscription.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,315 | 🐛 16 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,049 | 🐛 12 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,596 | 🐛 36 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
...
* [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 739 | 🐛 5 | 🌐 Rust | 📅 2026-09-11 - P2P terminal game about spacepirates playing basketball across the galaxy.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,252 | 🐛 19 | 🌐 Rust | 📅 2026-09-18 - Turn your keyboard into a typewriter adding sounds at each keystroke.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,444 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,642 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,426 | 🐛 2 | 🌐 Shell | 📅 2026-09-13 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,200 | 🐛 19 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,656 | 🐛 48 | 📅 2026-09-16 - An awesome list dedicated to TUI programs.
