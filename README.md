...
* [eza](https://github.com/eza-community/eza) ⭐ 23,217 | 🐛 445 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,216 | 🐛 207 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,260 | 🐛 32 | 🌐 Rust | 📅 2026-09-07 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,373 | 🐛 144 | 🌐 Rust | 📅 2026-09-08 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,044 | 🐛 109 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [Shunpo](https://github.com/egurapha/Shunpo) ⭐ 446 | 🐛 1 | 🌐 Shell | 📅 2026-08-03 - A minimalist bash tool that makes directory navigation just a little bit faster.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,363 | 🐛 204 | 🌐 Rust | 📅 2026-09-09 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,789 | 🐛 134 | 🌐 Rust | 📅 2026-09-01 - Intelligent context-aware search engine for your shell history with TUI.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,455 | 🐛 186 | 🌐 C | 📅 2026-09-10 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,143 | 🐛 437 | 🌐 Rust | 📅 2026-09-11 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,878 | 🐛 291 | 🌐 Rust | 📅 2026-09-08 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,086 | 🐛 5 | 🌐 Perl | 📅 2026-08-31 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,883 | 🐛 70 | 🌐 Go | 📅 2026-09-08 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,166 | 🐛 191 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,119 | 🐛 563 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,846 | 🐛 53 | 🌐 Rust | 📅 2026-09-10 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,840 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,284 | 🐛 9 | 🌐 C++ | 📅 2026-08-31 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,291 | 🐛 18 | 🌐 Rust | 📅 2026-09-05 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
* [amber](https://github.com/dalance/amber) ⭐ 953 | 🐛 20 | 🌐 Rust | 📅 2026-09-08 - Code search / replace tool.
* [srgn](https://github.com/alexpovel/srgn) ⭐ 911 | 🐛 7 | 🌐 Rust | 📅 2026-09-01 - A code surgeon for precise text and code transplantation. A marriage of `tr`/`sed`, `rg` and `tree-sitter`.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,246 | 🐛 8 | 🌐 Rust | 📅 2026-09-09 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,245 | 🐛 2 | 🌐 Rust | 📅 2026-09-11 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,970 | 🐛 53 | 🌐 Go | 📅 2026-09-10 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,518 | 🐛 535 | 🌐 C++ | 📅 2026-09-09 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,118 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,930 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,013 | 🐛 107 | 🌐 Rust | 📅 2026-09-10 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,985 | 🐛 142 | 🌐 C | 📅 2026-09-07 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [gtop](https://github.com/aksakalli/gtop) ⭐ 9,928 | 🐛 40 | 🌐 JavaScript | 📅 2025-11-06 - System monitoring dashboard for terminal written in Node.js.
...
* [procs](https://github.com/dalance/procs) ⭐ 6,165 | 🐛 34 | 🌐 Rust | 📅 2026-09-09 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,086 | 🐛 42 | 🌐 Python | 📅 2026-08-27 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,702 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,417 | 🐛 114 | 🌐 C | 📅 2026-09-09 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,109 | 🐛 68 | 🌐 Rust | 📅 2026-09-10 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,151 | 🐛 269 | 🌐 Go | 📅 2026-09-11 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,878 | 🐛 4 | 🌐 C | 📅 2026-09-09 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,503 | 🐛 85 | 🌐 Go | 📅 2026-09-09 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 475 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,723 | 🐛 27 | 🌐 C | 📅 2026-09-11 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,748 | 🐛 91 | 🌐 Rust | 📅 2026-09-07 - Painless compression and decompression in the terminal.
...
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,177 | 🐛 37 | 🌐 Rust | 📅 2026-09-07 - Executes commands in response to file modifications.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,664 | 🐛 62 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 182,481 | 🐛 632 | 🌐 Python | 📅 2026-09-10 - Python tool for converting files and office documents to Markdown.
* [unoserver](https://github.com/unoconv/unoserver) ⭐ 932 | 🐛 11 | 🌐 Python | 📅 2026-06-10 - Using LibreOffice as a server for converting documents, it allows converting multiple documents without loading libreoffice into memory every time.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,460 | 🐛 539 | 🌐 Rust | 📅 2026-09-07 - Cross-platform Text Expander written in Rust. Not limited to the command line.
* [Ultimate Plumber](https://github.com/akavel/up) ⭐ 8,842 | 🐛 30 | 🌐 Go | 📅 2024-09-05 - Helps to interactively and incrementally explore textual data in Linux, by making it easier to quickly build complex pipelines, thanks to a fast feedback loop.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,720 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,352 | 🐛 374 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,348 | 🐛 5 | 🌐 Perl | 📅 2026-09-02 - Command line tool for URL parsing and manipulation.
...
* [gtree](https://github.com/ddddddO/gtree) ⭐ 359 | 🐛 37 | 🌐 Go | 📅 2026-08-26 - Using either Markdown or programmatically to generate directory trees and directories, and to verify directories.
* [rare](https://github.com/zix99/rare) ⭐ 355 | 🐛 2 | 🌐 Go | 📅 2026-02-08 - Real-time regex-extraction and aggregation into common formats such as histograms, bar graphs, numerical summaries, tables, and more!
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,796 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,026 | 🐛 7 | 🌐 Python | 📅 2026-09-05 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,622 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,947 | 🐛 300 | 🌐 Go | 📅 2026-09-10 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,514 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,673 | 🐛 41 | 🌐 Python | 📅 2026-09-10 - Serializes the output of command line tools to JSON.
...
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,748 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,835 | 🐛 24 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,483 | 🐛 20 | 🌐 Python | 📅 2026-09-09 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,414 | 🐛 615 | 🌐 Go | 📅 2026-09-11 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,379 | 🐛 39 | 🌐 Python | 📅 2026-09-09 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,977 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - A command line client for MySQL that can do autocompletion and syntax highlighting.
...
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,016 | 🐛 72 | 🌐 Go | 📅 2026-09-09 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,394 | 🐛 45 | 🌐 Python | 📅 2026-09-11 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,324 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,285 | 🐛 46 | 🌐 Go | 📅 2026-09-09 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,961 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,780 | 🐛 27 | 🌐 Rust | 📅 2026-09-11 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,780 | 🐛 27 | 🌐 Rust | 📅 2026-09-11 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,201 | 🐛 12 | 🌐 Go | 📅 2026-09-09 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,100 | 🐛 17 | 🌐 Rust | 📅 2026-09-09 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,564 | 🐛 74 | 🌐 Go | 📅 2026-09-10 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,900 | 🐛 328 | 🌐 Go | 📅 2026-09-11 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,948 | 🐛 5 | 🌐 Rust | 📅 2026-09-08 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,256 | 🐛 77 | 🌐 Rust | 📅 2026-09-10 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,254 | 🐛 230 | 🌐 Go | 📅 2026-09-07 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,128 | 🐛 663 | 🌐 Rust | 📅 2026-09-08 - Create book from Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,560 | 🐛 945 | 🌐 Go | 📅 2026-09-11 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,568 | 🐛 175 | 🌐 Rust | 📅 2026-08-27 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [ox](https://github.com/curlpipe/ox) ⭐ 3,741 | 🐛 33 | 🌐 Rust | 📅 2026-04-23 - An independent Rust text editor.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 700 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
* [Turbo](https://github.com/magiblot/turbo) ⭐ 680 | 🐛 38 | 🌐 C++ | 📅 2026-08-28 - An experimental text editor for the terminal, based on Scintilla and Turbo Vision.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,215 | 🐛 1,033 | 🌐 Go | 📅 2026-09-09 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,224 | 🐛 473 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,477 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
...
* [tig](https://github.com/jonas/tig) ⭐ 13,329 | 🐛 233 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,500 | 🐛 101 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,225 | 🐛 115 | 🌐 Rust | 📅 2026-09-07 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [BFG Repo-Cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,182 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,046 | 🐛 65 | 🌐 Rust | 📅 2026-09-09 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,026 | 🐛 179 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,075 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 - A utility tool powered by fzf for using git interactively.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,936 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [gitnr](https://github.com/reemus-dev/gitnr) ⭐ 235 | 🐛 4 | 🌐 Rust | 📅 2026-08-29 - Create `.gitignore` files using one or more templates from TopTal, GitHub or your own collection.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,510 | 🐛 1,237 | 🌐 Rust | 📅 2026-09-10 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,141 | 🐛 17 | 🌐 Rust | 📅 2026-09-10 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,287 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-10 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,003 | 🐛 711 | 🌐 Go | 📅 2026-09-11 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,030 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-08 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,976 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,516 | 🐛 27 | 🌐 Perl | 📅 2026-09-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,900 | 🐛 242 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,349 | 🐛 498 | 🌐 Go | 📅 2026-09-04 - Instant, easy, and predictable development environments.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,729 | 🐛 26 | 🌐 Go | 📅 2026-09-11 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,182 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,422 | 🐛 38 | 🌐 Rust | 📅 2026-09-06 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,124 | 🐛 443 | 🌐 Rust | 📅 2026-09-10 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,652 | 🐛 15 | 🌐 Python | 📅 2026-08-27 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [argbash](https://github.com/matejak/argbash) ⭐ 1,484 | 🐛 33 | 🌐 M4 | 📅 2025-07-17 - Bash argument parsing code generator.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 896 | 🐛 166 | 🌐 Rust | 📅 2026-09-10 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
* [sls-dev-tools](https://github.com/Theodo-UK/sls-dev-tools) ⭐ 870 | 🐛 62 | 🌐 JavaScript | 📅 2023-04-25 - Interactive in-terminal dashboard that allows to monitor and manage the resources of  AWS-based Serverless applications.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 13 | 🌐 Python | 📅 2026-09-11 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,559 | 🐛 81 | 🌐 Go | 📅 2026-09-10 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,349 | 🐛 498 | 🌐 Go | 📅 2026-09-04 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,532 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast terminal dashboard for Kubernetes.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,401 | 🐛 8 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,222 | 🐛 8 | 🌐 Go | 📅 2026-09-07 - TUI for Podman environment.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,494 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,470 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,393 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [crawley](https://github.com/s0rg/crawley) ⭐ 340 | 🐛 8 | 🌐 Go | 📅 2026-08-21 - Unix-way web crawler: crawls web pages and prints any link it can find.
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-09-08 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,295 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,889 | 🐛 1,860 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,736 | 🐛 172 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,320 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,693 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,756 | 🐛 79 | 🌐 Python | 📅 2026-09-05 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,004 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
* [Ntfy](https://github.com/dschep/ntfy) ⭐ 4,977 | 🐛 104 | 🌐 Python | 📅 2025-10-27 - Cross-platform Python utility that enables you to automatically get desktop notifications on demand or when long-running commands complete. It can as well send push notifications to your phone once a particular command completes.
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,285 | 🐛 6 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,052 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,936 | 🐛 251 | 🌐 Zig | 📅 2026-09-10 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,846 | 🐛 1,849 | 🌐 Rust | 📅 2026-09-11 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [dtach](https://github.com/crigler/dtach) ⭐ 740 | 🐛 20 | 🌐 C | 📅 2025-06-21 - A program written in C that emulates the detach feature of screen.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,369 | 🐛 1,915 | 🌐 Rust | 📅 2026-09-09 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [mtm](https://github.com/deadpixi/mtm) ⭐ 1,223 | 🐛 43 | 🌐 C | 📅 2024-07-18 - Micro Terminal Multiplexer - Simple but usable, stable and minimalistic terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,476 | 🐛 1,439 | 🌐 Rust | 📅 2026-09-10 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,378 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
* [Oils](https://github.com/oilshell/oil) ⭐ 3,390 | 🐛 610 | 🌐 Python | 📅 2026-09-08 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 281 | 🐛 70 | 🌐 C | 📅 2026-09-11 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-08 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,083 | 🐛 150 | 🌐 Shell | 📅 2026-09-06 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,813 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,036 | 🐛 45 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,835 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,585 | 🐛 89 | 🌐 C | 📅 2026-09-09 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,585 | 🐛 89 | 🌐 C | 📅 2026-09-09 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,918 | 🐛 449 | 🌐 C | 📅 2026-09-10 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,079 | 🐛 105 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,697 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [CoreFreq](https://github.com/cyring/CoreFreq) ⭐ 2,240 | 🐛 1 | 🌐 C | 📅 2026-08-16 - CPU monitoring TUI software designed for the 64-bits Processors.
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,104 | 🐛 12 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,877 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,080 | 🐛 30 | 🌐 Go | 📅 2026-09-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [senzu](https://github.com/Hakky54/senzu) ⭐ 5 | 🐛 1 | 🌐 Java | 📅 2026-09-07 - CLI tool to get the battery percentage.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,505 | 🐛 206 | 🌐 Rust | 📅 2026-09-11 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,071 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,280 | 🐛 88 | 🌐 Go | 📅 2026-09-08 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,555 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,777 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,837 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,154 | 🐛 70 | 🌐 Shell | 📅 2026-08-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,967 | 🐛 150 | 🌐 Go | 📅 2026-09-10 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,075 | 🐛 60 | 🌐 Go | 📅 2026-08-21 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,832 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 604 | 🐛 17 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,325 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,676 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,767 | 🐛 23 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,717 | 🐛 68 | 🌐 Rust | 📅 2026-09-08 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [sake](https://github.com/alajmo/sake) ⭐ 751 | 🐛 16 | 🌐 Go | 📅 2026-05-31 - A command runner for local and remote hosts. You define servers and tasks in sake.yaml file and then run the tasks on the servers.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,893 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,221 | 🐛 8 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,221 | 🐛 8 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,323 | 🐛 221 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 888 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - Terminal mail client.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,770 | 🐛 54 | 🌐 Go | 📅 2026-09-10 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,906 | 🐛 109 | 🌐 Java | 📅 2026-09-10 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,944 | 🐛 15 | 🌐 C++ | 📅 2026-08-30 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,720 | 🐛 78 | 🌐 Go | 📅 2026-09-09 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,371 | 🐛 101 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,010 | 🐛 15 | 🌐 Rust | 📅 2026-09-07 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 982 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 863 | 🐛 475 | 🌐 Python | 📅 2026-08-16 - Official Zulip terminal client with TUI.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 71 | 🐛 23 | 🌐 Rust | 📅 2026-09-11 - TUI client for Nostr.
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,548 | 🐛 212 | 🌐 Python | 📅 2026-09-07 - Transparent proxy server that works as a poor man's VPN. Forwards over ssh. Doesn't require admin. Works with Linux and macOS. Supports DNS tunneling.
* [gping](https://github.com/orf/gping) ⭐ 12,678 | 🐛 39 | 🌐 Rust | 📅 2026-09-10 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,345 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,690 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,899 | 🐛 84 | 🌐 Rust | 📅 2026-09-09 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,658 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,104 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,016 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [Tunnelmole](https://github.com/robbie-cahill/tunnelmole-client) ⭐ 1,888 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-13 - Connect to local servers from anywhere.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,836 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,601 | 🐛 23 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,388 | 🐛 38 | 🌐 C | 📅 2026-08-24 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
...
* [packemon](https://github.com/ddddddO/packemon) ⭐ 307 | 🐛 34 | 🌐 Go | 📅 2026-09-04 - TUI tool and Go library for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).
...
* [goto](https://github.com/grafviktor/goto) ⭐ 533 | 🐛 12 | 🌐 Go | 📅 2026-09-10 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 190,280 | 🐛 2,647 | 🌐 Python | 📅 2026-08-30 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,181 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,970 | 🐛 1,177 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,294 | 🐛 2 | 🌐 Go | 📅 2026-09-10 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,673 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,922 | 🐛 182 | 🌐 Python | 📅 2026-09-06 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,470 | 🐛 1,141 | 🌐 Python | 📅 2026-09-04 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,066 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,057 | 🐛 189 | 🌐 Go | 📅 2026-09-09 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,669 | 🐛 125 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,076 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,857 | 🐛 381 | 🌐 C++ | 📅 2026-09-06 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,227 | 🐛 9 | 🌐 Python | 📅 2026-09-08 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,491 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,959 | 🐛 171 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,547 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,835 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,121 | 🐛 134 | 🌐 Rust | 📅 2026-09-06 - A terminal user interface for taskwarrior.
...
* [topydo](https://github.com/topydo/topydo) ⭐ 936 | 🐛 79 | 🌐 Python | 📅 2026-09-07 - A powerful todo list application for the console, using the todo.txt format.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,654 | 🐛 125 | 🌐 C++ | 📅 2026-09-09 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [hours](https://github.com/dhth/hours) ⭐ 347 | 🐛 16 | 🌐 Go | 📅 2026-09-09 - A no-frills time tracking toolkit for command line nerds.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,402 | 🐛 153 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,311 | 🐛 152 | 🌐 Python | 📅 2026-09-10 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,795 | 🐛 27 | 🌐 Go | 📅 2026-08-31 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 877 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 778 | 🐛 13 | 🌐 Rust | 📅 2026-09-06 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 534 | 🐛 2 | 🌐 Rust | 📅 2026-08-25 - Terminal-based markdown note manager.
...
* [Captain's Log](https://github.com/NikolaDucak/caps-log) ⭐ 400 | 🐛 16 | 🌐 C++ | 📅 2026-08-14 - A small TUI journaling tool (daily entries saved as md files, tags for organizing entries, browse tags, calendar view, encrypted logs, storage using a git repository).
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,046 | 🐛 264 | 🌐 Python | 📅 2026-09-07 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,873 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,902 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
* [mop](https://github.com/mop-tracker/mop) ⭐ 2,210 | 🐛 6 | 🌐 Go | 📅 2025-12-28 - Stock market tracker for hackers.
* [Invoice](https://github.com/maaslalani/invoice) ⭐ 2,192 | 🐛 25 | 🌐 Go | 📅 2024-06-18 - Generate invoices from the command line.
* [Puffin](https://github.com/siddhantac/puffin) ⭐ 569 | 🐛 11 | 🌐 Go | 📅 2026-03-11 - A beautiful TUI dashboard for hledger.
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 314 | 🐛 7 | 🌐 Rust | 📅 2026-09-10 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,908 | 🐛 817 | 🌐 TypeScript | 📅 2026-09-11 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,884 | 🐛 69 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,435 | 🐛 103 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,079 | 🐛 105 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [telert](https://github.com/navig-me/telert) ⭐ 288 | 🐛 8 | 🌐 Python | 📅 2026-08-07 - Lightweight CLI and Python utility that sends alerts (Telegram, Slack, Teams, Desktop, Audio) when commands complete.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,656 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,831 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,401 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,684 | 🐛 110 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 721 | 🐛 10 | 🌐 C | 📅 2026-09-10 - Base conversion and bit manipulator in ncurses.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,795 | 🐛 457 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,950 | 🐛 90 | 🌐 Go | 📅 2026-09-10 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [wut](https://github.com/shobrook/wut) ⭐ 1,423 | 🐛 18 | 🌐 Python | 📅 2024-12-20 - An terminal assistant for the hopelessly confused; it explains the meaning of the output from the last command.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-10 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,369 | 🐛 525 | 🌐 Go | 📅 2026-09-10 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,667 | 🐛 263 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,487 | 🐛 40 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,230 | 🐛 54 | 🌐 C | 📅 2026-09-06 - Terminal graphics for the 21 st century.
...
* [gowall](https://github.com/Achno/gowall) ⭐ 2,311 | 🐛 12 | 🌐 Go | 📅 2026-06-10 - A tool to convert a Wallpaper's color scheme / palette, image to pixel art, color palette extraction, image upsacling with Adversarial Networks  and more image processing features.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,040 | 🐛 38 | 🌐 C | 📅 2026-09-10 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,813 | 🐛 4 | 🌐 Python | 📅 2026-09-11 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 998 | 🐛 16 | 🌐 Python | 📅 2026-09-07 - AI-Powered Command-Line Photo Search Tool.
* [figma-use](https://github.com/dannote/figma-use) ⭐ 597 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-03 - Control Figma from the command line with full read/write access for AI agents.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 418 | 🐛 11 | 🌐 Rust | 📅 2026-09-10 - A powerful Rust image optimization CLI tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,746 | 🐛 75 | 🌐 Python | 📅 2026-09-10 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,487 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,646 | 🐛 717 | 🌐 Python | 📅 2026-09-11 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,201 | 🐛 154 | 🌐 Rust | 📅 2026-09-09 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,769 | 🐛 212 | 🌐 Rust | 📅 2026-09-09 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,739 | 🐛 168 | 🌐 C | 📅 2026-09-05 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 588 | 🐛 28 | 🌐 Rust | 📅 2026-09-10 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-10 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [spytorec](https://github.com/Danidukiyu/SpytoRec) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Real-time Spotify recorder with automatic track splitting, metadata tagging, and high-quality FLAC/OGG output.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,836 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,040 | 🐛 2 | 🌐 C | 📅 2026-09-10 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,040 | 🐛 2 | 🌐 C | 📅 2026-09-10 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,200 | 🐛 50 | 🌐 Rust | 📅 2026-09-08 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,238 | 🐛 7 | 🌐 Python | 📅 2026-09-11 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ternimal](https://github.com/p-e-w/ternimal) ⭐ 1,110 | 🐛 14 | 🌐 Rust | 📅 2018-11-19 - Simulate a life form in the terminal.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,405 | 🐛 514 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [ov](https://github.com/noborus/ov) ⭐ 2,019 | 🐛 29 | 🌐 Go | 📅 2026-09-10 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,558 | 🐛 15 | 🌐 Go | 📅 2026-08-30 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,407 | 🐛 8 | 🌐 Rust | 📅 2026-09-05 - Terminal image, video, directory, and Markdown viewer.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 351 | 🐛 14 | 🌐 Rust | 📅 2026-08-26 - Minimalistic Vim-like TUI document reader.
...
* [rfc\_reader](https://github.com/ozan2003/rfc_reader) ⭐ 73 | 🐛 0 | 🌐 Rust | 📅 2026-09-05 - A tool to read RFCs (Request for Comments) with a TUI, allowing you to fetch, cache, and browse RFC documents.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,967 | 🐛 13 | 🌐 Rust | 📅 2026-09-09 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,854 | 🐛 173 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,791 | 🐛 10 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,720 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,087 | 🐛 446 | 🌐 Go | 📅 2026-09-07 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [wifi-password](https://github.com/rauchg/wifi-password) ⭐ 4,568 | 🐛 27 | 🌐 Shell | 📅 2024-06-13 - Get Wi-Fi pass.
...
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,182 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,472 | 🐛 103 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [pa](https://github.com/biox/pa) ⭐ 573 | 🐛 3 | 🌐 Shell | 📅 2026-08-30 - A simple password manager; encryption via age, written in portable POSIX shell.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,307 | 🐛 609 | 🌐 Python | 📅 2026-09-09 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [gentoo-install](https://github.com/oddlama/gentoo-install) ⭐ 787 | 🐛 24 | 🌐 Shell | 📅 2026-08-08 - This project aspires to be your favorite way to install gentoo. It aims to provide a smooth installation experience, both for beginners and experts. You may configure it by using a menuconfig-inspired interface or simply via a config file.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 516 | 🐛 15 | 🌐 Go | 📅 2026-09-11 - Cross Platform tool to validate configuration files.
...
* [anbu](https://github.com/tanq16/anbu) ⭐ 30 | 🐛 1 | 🌐 Go | 📅 2026-09-11 - A swiss army knife for CLI operations catered to devs and security professionals.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,300 | 🐛 13 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,593 | 🐛 36 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
...
* [Pokete](https://github.com/lxgr-linux/pokete) ⭐ 3,152 | 🐛 30 | 🌐 Python | 📅 2026-05-22 - A terminal based Pokemon like game.
...
* [rpg-cli](https://github.com/facundoolano/rpg-cli) ⭐ 1,678 | 🐛 6 | 🌐 Rust | 📅 2025-05-03 - Your filesystem as a dungeon!
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,173 | 🐛 35 | 🌐 Rust | 📅 2026-09-10 - Play chess from your terminal.
...
* [DOOM-ASCII](https://github.com/wojciech-graj/doom-ascii) ⭐ 881 | 🐛 2 | 🌐 C | 📅 2025-07-21 - Text-based DOOM running in terminal without sound.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,245 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
* [bucklespring](https://github.com/zevv/bucklespring) ⭐ 1,554 | 🐛 42 | 🌐 C | 📅 2025-08-24 - Emulates the sound of the old IBM Model-M space saver bucklespring keyboard while typing.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,253 | 🐛 19 | 🌐 Rust | 📅 2026-09-08 - Turn your keyboard into a typewriter adding sounds at each keystroke.
* [boxes](https://github.com/ascii-boxes/boxes) ⭐ 688 | 🐛 0 | 🌐 C | 📅 2026-08-30 - Boxes is a command line filter program which draws ASCII art boxes around your input text.
* [Draw](https://github.com/maaslalani/draw) ⭐ 546 | 🐛 6 | 🌐 Go | 📅 2023-12-04 - draw is an simple drawing tool in the terminal. Hold your mouse down and move it across the screen to draw anything you want!
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,329 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,588 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,363 | 🐛 1 | 🌐 Shell | 📅 2026-09-05 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,558 | 🐛 71 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
