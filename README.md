...
* [eza](https://github.com/eza-community/eza) ⭐ 23,333 | 🐛 454 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,235 | 🐛 210 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,267 | 🐛 32 | 🌐 Rust | 📅 2026-09-21 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,629 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,050 | 🐛 109 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,497 | 🐛 198 | 🌐 Rust | 📅 2026-09-20 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,790 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,799 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Intelligent context-aware search engine for your shell history with TUI.
...
* [Bevel](https://github.com/NorfairKing/bevel) ⭐ 44 | 🐛 7 | 🌐 Haskell | 📅 2026-09-07 - Command line history in an SQLite database for effective reuse.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,281 | 🐛 444 | 🌐 Rust | 📅 2026-09-19 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,917 | 🐛 288 | 🌐 Rust | 📅 2026-09-18 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,092 | 🐛 5 | 🌐 Perl | 📅 2026-09-19 - Make your diffs human-readable instead of machine-readable.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,478 | 🐛 202 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,977 | 🐛 68 | 🌐 Rust | 📅 2026-09-20 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,853 | 🐛 71 | 🌐 Rust | 📅 2026-09-17 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,297 | 🐛 8 | 🌐 C++ | 📅 2026-09-21 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,358 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,282 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,287 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,994 | 🐛 54 | 🌐 Go | 📅 2026-09-16 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [erdtree](https://github.com/solidiquis/erdtree) ⭐ 2,602 | 🐛 36 | 🌐 Rust | 📅 2024-05-19 - A multithreaded file-tree visualizer and disk usage analyzer.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,017 | 🐛 134 | 🌐 C | 📅 2026-09-20 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,156 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,180 | 🐛 36 | 🌐 Rust | 📅 2026-09-16 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,097 | 🐛 39 | 🌐 Python | 📅 2026-09-15 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [FClones](https://github.com/pkolaczk/fclones) ⭐ 2,943 | 🐛 105 | 🌐 Rust | 📅 2025-03-03 - Efficient Duplicate File Finder.
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,423 | 🐛 110 | 🌐 C | 📅 2026-09-19 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,325 | 🐛 63 | 🌐 Rust | 📅 2026-09-20 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,321 | 🐛 269 | 🌐 Go | 📅 2026-09-18 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,974 | 🐛 2 | 🌐 C | 📅 2026-09-19 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,518 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,216 | 🐛 481 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
...
* [fml](https://github.com/wick3dr0se/fml) ⭐ 107 | 🐛 0 | 🌐 Shell | 📅 2024-02-03 - Simple and fast file manager written in BASH.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,828 | 🐛 12 | 🌐 Rust | 📅 2026-09-16 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [browsr](https://github.com/juftin/browsr) ⭐ 649 | 🐛 13 | 🌐 Python | 📅 2026-04-22 - A pleasant file explorer that can browse the contents of local and remote filesystems with your keyboard or mouse; remotes include GitHub, over SSH, in AWS S3, Google Cloud Storage, or Azure Blob Storage.
...
* [progress](https://github.com/Xfennec/progress) ⭐ 8,855 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Monitor the progress of common Coreutils command-line tools (`cp`, `mv`, `dd`, `tar`, `rsync`, etc.); it uses a ncurses interface to display the percentage of data copied; it works by reading from system files and retrieving the necessary information for the estimation.
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,764 | 🐛 96 | 🌐 Rust | 📅 2026-09-17 - Painless compression and decompression in the terminal.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,759 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
...
* [treegen](https://github.com/bilbilak/treegen) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2026-06-11 - ASCII tree directory and file structure generator.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 185,991 | 🐛 695 | 🌐 Python | 📅 2026-09-16 - Python tool for converting files and office documents to Markdown.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,515 | 🐛 540 | 🌐 Rust | 📅 2026-09-20 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [toolong](https://github.com/Textualize/toolong) ⭐ 3,949 | 🐛 37 | 🌐 Python | 📅 2024-08-05 - A terminal application to view, tail, merge, and search log files (plus JSONL).
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,724 | 🐛 47 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,410 | 🐛 377 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,353 | 🐛 5 | 🌐 Perl | 📅 2026-09-02 - Command line tool for URL parsing and manipulation.
* [yek](https://github.com/bodo-run/yek) ⭐ 2,477 | 🐛 12 | 🌐 Rust | 📅 2026-06-29 - A fast Rust based tool to serialize text-based files in a repository or directory for LLM consumption.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,803 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,039 | 🐛 8 | 🌐 Python | 📅 2026-09-18 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,634 | 🐛 33 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,679 | 🐛 27 | 🌐 Python | 📅 2026-09-19 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,180 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,805 | 🐛 18 | 🌐 Go | 📅 2026-09-19 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,766 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [jp](https://github.com/jmespath/jp) ⭐ 788 | 🐛 20 | 🌐 Python | 📅 2023-06-15 - A command line interface to JMESPath, an expression language for manipulating JSON.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,481 | 🐛 580 | 🌐 Go | 📅 2026-09-18 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
...
* [usql](https://github.com/xo/usql) ⭐ 10,117 | 🐛 121 | 🌐 Go | 📅 2026-09-21 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,023 | 🐛 72 | 🌐 Go | 📅 2026-09-14 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
* [textql](https://github.com/dinedal/textql) ⭐ 9,104 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,409 | 🐛 44 | 🌐 Python | 📅 2026-09-17 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,405 | 🐛 32 | 🌐 Python | 📅 2026-09-17 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,343 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,315 | 🐛 46 | 🌐 Go | 📅 2026-09-17 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,976 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,790 | 🐛 32 | 🌐 Rust | 📅 2026-09-20 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,790 | 🐛 32 | 🌐 Rust | 📅 2026-09-20 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,304 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
...
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,116 | 🐛 17 | 🌐 Rust | 📅 2026-09-20 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,567 | 🐛 74 | 🌐 Go | 📅 2026-09-20 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [zsv](https://github.com/liquidaty/zsv) ⭐ 397 | 🐛 25 | 🌐 C | 📅 2026-09-21 - The world's fastest (simd) CSV parser, with an extensible, multi-purpose CLI.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,161 | 🐛 330 | 🌐 Go | 📅 2026-09-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,968 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,280 | 🐛 78 | 🌐 Rust | 📅 2026-09-19 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,400 | 🐛 236 | 🌐 Go | 📅 2026-09-14 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,159 | 🐛 657 | 🌐 Rust | 📅 2026-09-18 - Create book from Markdown files.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,293 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,611 | 🐛 914 | 🌐 Go | 📅 2026-09-21 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,595 | 🐛 166 | 🌐 Rust | 📅 2026-09-18 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,538 | 🐛 1,049 | 🌐 Go | 📅 2026-09-20 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,407 | 🐛 484 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,538 | 🐛 100 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,249 | 🐛 114 | 🌐 Rust | 📅 2026-09-18 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [BFG Repo-Cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,190 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,048 | 🐛 62 | 🌐 Rust | 📅 2026-09-20 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,045 | 🐛 150 | 🌐 Go | 📅 2026-09-20 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,225 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,081 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - A utility tool powered by fzf for using git interactively.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,319 | 🐛 14 | 🌐 Rust | 📅 2026-09-08 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,941 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [ggc](https://github.com/bmf-san/ggc) ⭐ 285 | 🐛 10 | 🌐 Go | 📅 2026-09-21 - A modern Git CLI tool with both traditional command-line and interactive incremental-search UI.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,678 | 🐛 1,253 | 🌐 Rust | 📅 2026-09-21 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,143 | 🐛 15 | 🌐 Rust | 📅 2026-09-19 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,434 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-20 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,210 | 🐛 774 | 🌐 Go | 📅 2026-09-21 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,053 | 🐛 406 | 🌐 JavaScript | 📅 2026-09-21 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 24,002 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,550 | 🐛 26 | 🌐 Perl | 📅 2026-09-20 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,931 | 🐛 245 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,368 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,253 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,768 | 🐛 27 | 🌐 Go | 📅 2026-09-15 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,196 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,137 | 🐛 435 | 🌐 Rust | 📅 2026-09-18 - Developer environments you can take with you.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 902 | 🐛 163 | 🌐 Rust | 📅 2026-09-21 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 603 | 🐛 2 | 🌐 Go | 📅 2026-09-20 - Update binaries installed by "go install" with goroutines.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 140 | 🐛 13 | 🌐 Python | 📅 2026-09-20 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,097 | 🐛 316 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,633 | 🐛 78 | 🌐 Go | 📅 2026-09-18 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,368 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,538 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A simple and fast terminal dashboard for Kubernetes.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,407 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,236 | 🐛 13 | 🌐 Go | 📅 2026-09-18 - TUI for Podman environment.
...
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,487 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,922 | 🐛 72 | 🌐 Rust | 📅 2026-09-20 - Fast, async, resource-friendly link checker written in Rust.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,923 | 🐛 7 | 🌐 Go | 📅 2026-09-21 - Domain Availability Research Tool.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,395 | 🐛 2 | 🌐 Rust | 📅 2026-09-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,087 | 🐛 1,884 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,925 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,329 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,704 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-18 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,765 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,061 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [brightnessctl](https://github.com/Hummer12007/brightnessctl) ⭐ 1,273 | 🐛 24 | 🌐 C | 📅 2024-12-16 - Read and control device brightness. Devices, by default, include backlight and LEDs - searched for in corresponding classes.
* [tufw](https://github.com/peltho/tufw) ⭐ 865 | 🐛 4 | 🌐 Go | 📅 2026-06-08 - Terminal UI for the UFW Linux firewall.
...
* [qman](https://github.com/plp13/qman) ⭐ 603 | 🐛 14 | 🌐 C | 📅 2026-09-06 - A more modern man page viewer for our terminals.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,373 | 🐛 250 | 🌐 Zig | 📅 2026-09-21 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,965 | 🐛 1,872 | 🌐 Rust | 📅 2026-09-17 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,617 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,466 | 🐛 23 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,481 | 🐛 1,932 | 🌐 Rust | 📅 2026-09-18 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,364 | 🐛 21 | 🌐 C++ | 📅 2026-09-19 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,364 | 🐛 21 | 🌐 C++ | 📅 2026-09-19 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,535 | 🐛 1,434 | 🌐 Rust | 📅 2026-09-21 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,382 | 🐛 351 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 282 | 🐛 64 | 🌐 C | 📅 2026-09-20 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,130 | 🐛 152 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,422 | 🐛 0 | 🌐 Shell | 📅 2026-09-19 - Pretty, minimal, and fast ZSH prompt.
...
* [extrakto](https://github.com/laktak/extrakto) ⭐ 1,143 | 🐛 1 | 🌐 Python | 📅 2026-03-02 - extrakto for tmux - quickly select, copy/insert/complete text without a mouse.
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,043 | 🐛 47 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,884 | 🐛 99 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,711 | 🐛 94 | 🌐 C | 📅 2026-09-21 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,711 | 🐛 94 | 🌐 C | 📅 2026-09-21 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
...
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,096 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,715 | 🐛 38 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [kmon](https://github.com/orhun/kmon) ⭐ 2,949 | 🐛 23 | 🌐 Rust | 📅 2026-09-17 - Linux TUI Kernel manager and activity monitor.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,105 | 🐛 14 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,890 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,087 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [senzu](https://github.com/Hakky54/senzu) ⭐ 5 | 🐛 2 | 🌐 Java | 📅 2026-09-21 - CLI tool to get the battery percentage.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,568 | 🐛 208 | 🌐 Rust | 📅 2026-09-21 - Upgrade all the things.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,589 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,884 | 🐛 301 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,839 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,220 | 🐛 74 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,990 | 🐛 154 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,278 | 🐛 27 | 🌐 Go | 📅 2026-09-04 - A Docker manager for the terminal.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,850 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,403 | 🐛 115 | 🌐 C | 📅 2026-09-17 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,338 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,786 | 🐛 28 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
...
* [sunbeam](https://github.com/pomdtr/sunbeam) ⭐ 556 | 🐛 10 | 🌐 Go | 📅 2025-05-30 - General purpose command-line launcher that defines UIs composed of a succession of views from simple scripts written in any language; a mix between an application launcher like `raycast` or `rofi` and a fuzzy-finder like `fzf` or `telescope`.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,292 | 🐛 19 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,292 | 🐛 19 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,352 | 🐛 223 | 🌐 TypeScript | 📅 2026-09-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,780 | 🐛 53 | 🌐 Go | 📅 2026-09-20 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,926 | 🐛 108 | 🌐 Java | 📅 2026-09-20 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,148 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,964 | 🐛 18 | 🌐 C++ | 📅 2026-09-20 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,724 | 🐛 78 | 🌐 Go | 📅 2026-09-20 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,380 | 🐛 98 | 🌐 Rust | 📅 2026-09-15 - Signal Messenger client for terminal.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 993 | 🐛 1 | 🌐 Python | 📅 2026-09-20 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,398 | 🐛 116 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,981 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,502 | 🐛 15 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,693 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,946 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,667 | 🐛 26 | 🌐 Rust | 📅 2026-09-21 - Fast, collaborative live terminal sharing over the web.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,116 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,095 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
...
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,069 | 🐛 32 | 🌐 C | 📅 2026-09-16 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,041 | 🐛 29 | 🌐 Rust | 📅 2026-09-20 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,345 | 🐛 141 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
...
* [Tunnelmole](https://github.com/robbie-cahill/tunnelmole-client) ⭐ 1,890 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-13 - Connect to local servers from anywhere.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,855 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,610 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,564 | 🐛 2 | 🌐 Rust | 📅 2026-09-20 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,391 | 🐛 37 | 🌐 C | 📅 2026-09-19 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
...
* [ggh](https://github.com/byawitz/ggh) ⭐ 956 | 🐛 26 | 🌐 Go | 📅 2026-02-10 - Recall your SSH sessions, also searching your SSH config file.
* [Rustcat](https://github.com/robiot/rustcat) ⭐ 812 | 🐛 4 | 🌐 Rust | 📅 2024-07-20 - Netcat Alternative in Rust.
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 731 | 🐛 13 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 543 | 🐛 0 | 🌐 Go | 📅 2026-09-19 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,408 | 🐛 13 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,405 | 🐛 2,664 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,291 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,575 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,400 | 🐛 2 | 🌐 Go | 📅 2026-09-20 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,696 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
...
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,782 | 🐛 1,136 | 🌐 Python | 📅 2026-09-19 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,087 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,083 | 🐛 197 | 🌐 Go | 📅 2026-09-14 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,716 | 🐛 125 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,094 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [Yark](https://github.com/Owez/yark) ⭐ 2,189 | 🐛 21 | 🌐 Python | 📅 2026-07-30 - YouTube archiving made simple.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,863 | 🐛 392 | 🌐 C++ | 📅 2026-09-20 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
...
* [nom](https://github.com/guyfedwards/nom) ⭐ 746 | 🐛 33 | 🌐 Go | 📅 2026-07-08 - RSS reader for the terminal.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,500 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,558 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,843 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,131 | 🐛 134 | 🌐 Rust | 📅 2026-09-20 - A terminal user interface for taskwarrior.
...
* [omm](https://github.com/dhth/omm) ⭐ 332 | 🐛 11 | 🌐 Go | 📅 2026-09-20 - "on-my-mind" is a keyboard-driven task manager for the command line.
...
* [hours](https://github.com/dhth/hours) ⭐ 347 | 🐛 17 | 🌐 Go | 📅 2026-09-20 - A no-frills time tracking toolkit for command line nerds.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,808 | 🐛 24 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,359 | 🐛 7 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,101 | 🐛 838 | 🌐 TypeScript | 📅 2026-09-21 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 44,023 | 🐛 72 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,460 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,096 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,664 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,863 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,428 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,686 | 🐛 130 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,918 | 🐛 40 | 🌐 Rust | 📅 2026-09-18 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,860 | 🐛 460 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,596 | 🐛 110 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,536 | 🐛 16 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,350 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,961 | 🐛 92 | 🌐 Go | 📅 2026-09-21 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [cheatshh](https://github.com/AnirudhG07/cheatshh) ⭐ 193 | 🐛 0 | 🌐 Shell | 📅 2025-08-15 - A fzf based cheatsheet to store commands and their descriptions in a place you can look into so you dont have to remember them.
...
* [ManPDF & ManWEB](https://github.com/sebastiancarlos/manpdf) ⭐ 37 | 🐛 2 | 🌐 Shell | 📅 2024-04-19 - Read your Man pages in PDF format. Even online!
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-20 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,471 | 🐛 529 | 🌐 Go | 📅 2026-09-20 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,689 | 🐛 276 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,238 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,502 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,262 | 🐛 54 | 🌐 C | 📅 2026-09-19 - Terminal graphics for the 21 st century.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,822 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,777 | 🐛 71 | 🌐 Python | 📅 2026-09-18 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,506 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,659 | 🐛 11 | 🌐 Shell | 📅 2026-08-30 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,683 | 🐛 710 | 🌐 Python | 📅 2026-09-20 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,227 | 🐛 155 | 🌐 Rust | 📅 2026-09-19 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,777 | 🐛 213 | 🌐 Rust | 📅 2026-09-14 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 594 | 🐛 18 | 🌐 Rust | 📅 2026-09-20 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-20 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [spytorec](https://github.com/Danidukiyu/SpytoRec) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Real-time Spotify recorder with automatic track splitting, metadata tagging, and high-quality FLAC/OGG output.
...
* [cue](https://github.com/ravachol/cue) ⭐ 3,092 | 🐛 1 | 🌐 C | 📅 2026-09-19 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,092 | 🐛 1 | 🌐 C | 📅 2026-09-19 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,210 | 🐛 49 | 🌐 Rust | 📅 2026-09-21 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,255 | 🐛 9 | 🌐 Python | 📅 2026-09-20 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 620 | 🐛 43 | 🌐 Go | 📅 2026-09-18 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,515 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,280 | 🐛 35 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,428 | 🐛 19 | 🌐 C | 📅 2026-08-18 - Cross-platform Audio Visualizer.
...
* [ov](https://github.com/noborus/ov) ⭐ 2,023 | 🐛 30 | 🌐 Go | 📅 2026-09-21 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,563 | 🐛 12 | 🌐 Go | 📅 2026-09-20 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,992 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,946 | 🐛 176 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,821 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [t-rec](https://github.com/sassman/t-rec-rs) ⭐ 1,253 | 🐛 29 | 🌐 Rust | 📅 2026-09-21 - Blazingly fast terminal recorder that generates animated GIF images for the web written in rust.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,174 | 🐛 447 | 🌐 Go | 📅 2026-09-18 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,824 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,204 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,105 | 🐛 99 | 🌐 Go | 📅 2026-09-16 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 946 | 🐛 5 | 🌐 Go | 📅 2026-09-17 - A command-line tool for interacting with OAuth 2.0 authorization servers.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,491 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,336 | 🐛 621 | 🌐 Python | 📅 2026-09-19 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,696 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 517 | 🐛 12 | 🌐 Go | 📅 2026-09-21 - Cross Platform tool to validate configuration files.
...
* [Raijin](https://github.com/MasonStooksbury/Raijin) ⭐ 173 | 🐛 2 | 🌐 Rust | 📅 2026-09-21 - A free, simple weather TUI that pulls data without the need for an API key, account, or subscription.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,317 | 🐛 16 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [DOOM-ASCII](https://github.com/wojciech-graj/doom-ascii) ⭐ 882 | 🐛 0 | 🌐 C | 📅 2026-09-11 - Text-based DOOM running in terminal without sound.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,249 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 253 | 🐛 37 | 🌐 Python | 📅 2026-09-21 - Track conferences and meetups.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,470 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,654 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,434 | 🐛 1 | 🌐 Shell | 📅 2026-09-13 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,200 | 🐛 16 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,679 | 🐛 49 | 📅 2026-09-16 - An awesome list dedicated to TUI programs.
