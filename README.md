...
* [eza](https://github.com/eza-community/eza) ⭐ 22,932 | 🐛 425 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,168 | 🐛 204 | 🌐 Rust | 📅 2026-07-25 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,254 | 🐛 31 | 🌐 Rust | 📅 2026-08-10 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,655 | 🐛 135 | 🌐 Rust | 📅 2026-08-10 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,141 | 🐛 73 | 🌐 Lua | 📅 2026-08-10 - Directory changer that learns your habits.
* [enhancd](https://github.com/babarot/enhancd) ⭐ 2,709 | 🐛 17 | 🌐 Shell | 📅 2025-01-24 - A next-generation cd command with your interactive filter.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,087 | 🐛 186 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,256 | 🐛 13 | 🌐 C | 📅 2026-08-10 - A breadth-first version of the UNIX find command.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,785 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,778 | 🐛 135 | 🌐 Rust | 📅 2026-04-14 - Intelligent context-aware search engine for your shell history with TUI.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,452 | 🐛 185 | 🌐 C | 📅 2026-05-29 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,751 | 🐛 426 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,773 | 🐛 295 | 🌐 Rust | 📅 2026-08-14 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,080 | 🐛 4 | 🌐 Perl | 📅 2026-08-11 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,870 | 🐛 69 | 🌐 Go | 📅 2026-08-14 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,286 | 🐛 176 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,109 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,518 | 🐛 46 | 🌐 Rust | 📅 2026-08-14 - A CLI tool for code structural search, lint and rewriting.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,297 | 🐛 74 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,120 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,134 | 🐛 30 | 🌐 Rust | 📅 2026-08-14 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,896 | 🐛 65 | 🌐 Go | 📅 2026-08-13 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 33,986 | 🐛 522 | 🌐 C++ | 📅 2026-08-08 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,119 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,916 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,886 | 🐛 109 | 🌐 Rust | 📅 2026-08-15 - Yet another cross-platform graphical process/system monitor.
...
* [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,916 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/macOS/FreeBSD resource monitor with a nice interface.
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,915 | 🐛 142 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
* [gtop](https://github.com/aksakalli/gtop) ⭐ 9,925 | 🐛 42 | 🌐 JavaScript | 📅 2025-11-06 - System monitoring dashboard for terminal written in Node.js.
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,101 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,133 | 🐛 39 | 🌐 Rust | 📅 2026-08-10 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,065 | 🐛 38 | 🌐 Python | 📅 2026-08-05 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,044 | 🐛 40 | 🌐 Rust | 📅 2026-07-13 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
* [below](https://github.com/facebookincubator/below) ⭐ 2,490 | 🐛 34 | 🌐 Rust | 📅 2026-08-13 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,676 | 🐛 4 | 🌐 Rust | 📅 2026-08-13 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [FClones](https://github.com/pkolaczk/fclones) ⭐ 2,882 | 🐛 98 | 🌐 Rust | 📅 2025-03-03 - Efficient Duplicate File Finder.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,327 | 🐛 67 | 🌐 Rust | 📅 2026-08-14 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,533 | 🐛 251 | 🌐 Go | 📅 2026-08-11 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,788 | 🐛 4 | 🌐 C | 📅 2026-08-11 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,466 | 🐛 81 | 🌐 Go | 📅 2026-08-13 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,719 | 🐛 107 | 🌐 Rust | 📅 2026-07-19 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,634 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,206 | 🐛 482 | 🌐 C++ | 📅 2026-08-14 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,716 | 🐛 26 | 🌐 C | 📅 2026-08-15 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
* [hunter](https://github.com/rabite0/hunter) ⭐ 1,339 | 🐛 40 | 🌐 Rust | 📅 2022-09-26 - Ranger-like file browser written in rust.
* [felix](https://github.com/kyoheiu/felix) ⭐ 913 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager with vim-like key mapping
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,804 | 🐛 14 | 🌐 Rust | 📅 2026-08-10 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,710 | 🐛 98 | 🌐 Rust | 📅 2026-08-10 - Painless compression and decompression in the terminal.
* [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,542 | 🐛 63 | 🌐 C | 📅 2026-08-01 - Rotate, compress and mail logs.
* [xcp](https://github.com/tarka/xcp) ⭐ 925 | 🐛 18 | 🌐 Rust | 📅 2026-06-23 - Extended cp.
* [compsize](https://github.com/kilobyte/compsize) ⭐ 411 | 🐛 22 | 🌐 C | 📅 2023-12-25 - Find compression type/ratio on a file or set of files on a btrfs file system.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,614 | 🐛 60 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 173,789 | 🐛 861 | 🌐 Python | 📅 2026-07-29 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-08-14 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,279 | 🐛 529 | 🌐 Rust | 📅 2026-08-14 - Cross-platform Text Expander written in Rust. Not limited to the command line.
* [Ultimate Plumber](https://github.com/akavel/up) ⭐ 8,838 | 🐛 30 | 🌐 Go | 📅 2024-09-05 - Helps to interactively and incrementally explore textual data in Linux, by making it easier to quickly build complex pipelines, thanks to a fast feedback loop.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,709 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,071 | 🐛 369 | 🌐 Python | 📅 2026-06-23.
...
* [awk](https://github.com/onetrueawk/awk) ⭐ 2,219 | 🐛 13 | 🌐 C | 📅 2026-04-26 - A historical, general-purpose text file processor, implements a domain-specific language designed for text processing and typically used as a data extraction and reporting tool.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,746 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [ttyplot](https://github.com/tenox7/ttyplot) ⭐ 1,372 | 🐛 10 | 🌐 C | 📅 2026-07-28 - A realtime plotting utility for terminals with data input from stdin/pipe.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,663 | 🐛 54 | 🌐 Python | 📅 2026-06-18 - Serializes the output of command line tools to JSON.
...
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,091 | 🐛 31 | 🌐 Rust | 📅 2026-07-27 - Interactive JSON filter using jq.
* [jo](https://github.com/jpmens/jo) ⭐ 4,863 | 🐛 7 | 🌐 C | 📅 2025-06-20 - A small utility to create JSON objects from the command line.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,794 | 🐛 13 | 🌐 Go | 📅 2026-07-20 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,707 | 🐛 23 | 🌐 Rust | 📅 2026-08-07 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,183 | 🐛 697 | 🌐 Go | 📅 2026-08-14 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,350 | 🐛 36 | 🌐 Python | 📅 2026-08-03 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,962 | 🐛 5 | 🌐 Python | 📅 2026-08-12 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,070 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 9,995 | 🐛 69 | 🌐 Go | 📅 2026-08-14 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,324 | 🐛 57 | 🌐 Python | 📅 2026-08-14 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,274 | 🐛 17 | 🌐 Rust | 📅 2026-08-08 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,215 | 🐛 51 | 🌐 Go | 📅 2026-07-26 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,929 | 🐛 57 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,754 | 🐛 27 | 🌐 Rust | 📅 2026-08-14 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,754 | 🐛 27 | 🌐 Rust | 📅 2026-08-14 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,290 | 🐛 44 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,184 | 🐛 11 | 🌐 Go | 📅 2026-08-14 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,075 | 🐛 15 | 🌐 Rust | 📅 2026-08-14 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,552 | 🐛 66 | 🌐 Go | 📅 2026-08-14 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,150 | 🐛 104 | 🌐 Python | 📅 2026-08-14 - Python CLI utility and library for manipulating SQLite databases.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,190 | 🐛 3 | 🌐 Python | 📅 2026-07-15 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,526 | 🐛 326 | 🌐 Go | 📅 2026-08-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,921 | 🐛 4 | 🌐 Rust | 📅 2026-08-11 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,174 | 🐛 80 | 🌐 Rust | 📅 2026-07-30 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 26,885 | 🐛 220 | 🌐 Go | 📅 2026-08-13 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,069 | 🐛 709 | 🌐 Rust | 📅 2026-08-03 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,824 | 🐛 126 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
* [DocToc](https://github.com/thlorenz/doctoc) ⭐ 4,461 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-04 - Generates table of contents for Markdown files inside local git repository. Links are compatible with anchors generated by GitHub or other sites.
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,264 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,342 | 🐛 1,033 | 🌐 Go | 📅 2026-08-15 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,453 | 🐛 160 | 🌐 Rust | 📅 2026-08-13 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [Turbo](https://github.com/magiblot/turbo) ⭐ 673 | 🐛 37 | 🌐 C++ | 📅 2026-08-14 - An experimental text editor for the terminal, based on Scintilla and Turbo Vision.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,338 | 🐛 1,020 | 🌐 Go | 📅 2026-08-14 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,722 | 🐛 462 | 🌐 Go | 📅 2026-07-29 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,393 | 🐛 332 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,096 | 🐛 98 | 🌐 Shell | 📅 2026-08-14 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,305 | 🐛 225 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,306 | 🐛 96 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
...
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,122 | 🐛 142 | 🌐 Rust | 📅 2026-08-04 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,022 | 🐛 61 | 🌐 Rust | 📅 2026-08-11 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 9,983 | 🐛 175 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,155 | 🐛 79 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 6,995 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - A simple and efficient way to access various statistics in a git repository.
...
* [git absorb](https://github.com/tummychow/git-absorb) ⭐ 5,686 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - git commit --fixup, but automatic.
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,059 | 🐛 12 | 🌐 Shell | 📅 2026-08-01 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,035 | 🐛 247 | 🌐 Shell | 📅 2026-08-11 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
* [mergestat-lite](https://github.com/mergestat/mergestat-lite) ⭐ 3,518 | 🐛 45 | 🌐 Go | 📅 2026-08-14 - A command-line tool for running SQL queries on git repositories and related data sources.
...
* [czg](https://github.com/Zhengqbbb/cz-git) ⭐ 1,519 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-11 - Interactively generate standardized commit messages.
...
* [gitnr](https://github.com/reemus-dev/gitnr) ⭐ 236 | 🐛 4 | 🌐 Rust | 📅 2026-05-28 - Create `.gitignore` files using one or more templates from TopTal, GitHub or your own collection.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 30,981 | 🐛 1,199 | 🌐 Rust | 📅 2026-08-14 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,852 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-11 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,382 | 🐛 630 | 🌐 Go | 📅 2026-08-14 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,977 | 🐛 404 | 🌐 JavaScript | 📅 2026-08-08 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,877 | 🐛 4 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,433 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,805 | 🐛 242 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,272 | 🐛 489 | 🌐 Go | 📅 2026-08-13 - Instant, easy, and predictable development environments.
...
* [release-it](https://github.com/release-it/release-it) ⭐ 9,027 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,621 | 🐛 27 | 🌐 Go | 📅 2026-08-11 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [blinkenlights](https://github.com/jart/blink) ⭐ 7,569 | 🐛 55 | 🌐 C | 📅 2025-12-10 - TUI that may be used for debugging x86\_64-linux or i8086 programs across platforms.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,382 | 🐛 35 | 🌐 Rust | 📅 2026-08-09 - A TUI for analyzing Linux binaries.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,090 | 🐛 441 | 🌐 Rust | 📅 2026-08-14 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,632 | 🐛 14 | 🌐 Python | 📅 2026-08-12 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 159 | 🌐 Rust | 📅 2026-08-14 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [Kool](https://github.com/kool-dev/kool) ⭐ 724 | 🐛 13 | 🌐 Go | 📅 2026-08-15 - CLI tool that brings the complexities of modern software development making these environments lightweight, fast and reproducible.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 12 | 🌐 Python | 📅 2026-08-14 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,054 | 🐛 309 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
* [readme-md-generator](https://github.com/kefranabg/readme-md-generator) ⭐ 11,128 | 🐛 30 | 🌐 JavaScript | 📅 2022-09-20 - CLI that generates beautiful README.md files.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,353 | 🐛 115 | 🌐 Go | 📅 2026-08-14 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,272 | 🐛 489 | 🌐 Go | 📅 2026-08-13 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,379 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,289 | 🐛 12 | 🌐 Python | 📅 2024-07-09 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,200 | 🐛 12 | 🌐 Go | 📅 2026-08-14 - TUI for Podman environment.
* [ktop](https://github.com/vladimirvivien/ktop) ⭐ 1,103 | 🐛 11 | 🌐 Go | 📅 2026-07-03 - Tool that displays useful metrics information about nodes, pods, and other workload.
...
* [PUG](https://github.com/leg100/pug) ⭐ 692 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - TUI for Terraform (perform tasks in parallel, manage state resources, calculate costs, automatically loads workspace variable files).
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,419 | 🐛 330 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,419 | 🐛 72 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,266 | 🐛 81 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,910 | 🐛 5 | 🌐 Go | 📅 2026-08-13 - Domain Availability Research Tool.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,212 | 🐛 9 | 🌐 Rust | 📅 2026-07-04 - TUI-based HTTP/REST client.
...
* [crawley](https://github.com/s0rg/crawley) ⭐ 341 | 🐛 8 | 🌐 Go | 📅 2026-08-14 - Unix-way web crawler: crawls web pages and prints any link it can find.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 67,999 | 🐛 3 | 🌐 Rust | 📅 2026-08-14 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,217 | 🐛 1,798 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,619 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,723 | 🐛 82 | 🌐 Python | 📅 2026-08-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 6,998 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
* [Ntfy](https://github.com/dschep/ntfy) ⭐ 4,976 | 🐛 104 | 🌐 Python | 📅 2025-10-27 - Cross-platform Python utility that enables you to automatically get desktop notifications on demand or when long-running commands complete. It can as well send push notifications to your phone once a particular command completes.
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,265 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
...
* [killport](https://github.com/jkfran/killport) ⭐ 1,840 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A command-line tool to easily kill processes running on a specified port.
...
* [has](https://github.com/kdabir/has) ⭐ 817 | 🐛 20 | 🌐 Shell | 📅 2026-02-26 - Checks presence of various command line tools on the PATH and reports their installed version.
* [qman](https://github.com/plp13/qman) ⭐ 595 | 🐛 13 | 🌐 C | 📅 2026-03-17 - A more modern man page viewer for our terminals.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 59,653 | 🐛 253 | 🌐 Zig | 📅 2026-08-14 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,362 | 🐛 1,808 | 🌐 Rust | 📅 2026-08-12 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,617 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,442 | 🐛 23 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 34,902 | 🐛 1,861 | 🌐 Rust | 📅 2026-08-13 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [mtm](https://github.com/deadpixi/mtm) ⭐ 1,220 | 🐛 43 | 🌐 C | 📅 2024-07-18 - Micro Terminal Multiplexer - Simple but usable, stable and minimalistic terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,266 | 🐛 1,413 | 🌐 Rust | 📅 2026-08-14 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,355 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [Twin](https://github.com/cosmos72/twin) ⭐ 1,054 | 🐛 37 | 🌐 C | 📅 2026-08-03 - Text mode window environment. A "retro" program for embedded or remote systems, that doubles as X11 terminal and text-mode equivalent of VNC server.
* [Cat9](https://github.com/letoram/cat9) ⭐ 528 | 🐛 3 | 🌐 Lua | 📅 2025-05-03 - Cat9 is a user shell script for LASH - a command-line shell that discriminates against terminal emulators, written in Lua.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 276 | 🐛 73 | 🌐 C | 📅 2026-08-14 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,911 | 🐛 152 | 🌐 Shell | 📅 2026-06-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,803 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,387 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
...
* [synth-shell-prompt](https://github.com/andresgongora/synth-shell-prompt) ⭐ 63 | 🐛 12 | 🌐 Shell | 📅 2024-06-04 - A small eye-candy shell prompt with Git status displaying, a clock, intelligent $PWD shortening, and much more.
...
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,203 | 🐛 66 | 🌐 C | 📅 2026-08-15 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,203 | 🐛 66 | 🌐 C | 📅 2026-08-15 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,816 | 🐛 455 | 🌐 C | 📅 2026-08-05 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,055 | 🐛 101 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,630 | 🐛 35 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [kmon](https://github.com/orhun/kmon) ⭐ 2,932 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux TUI Kernel manager and activity monitor.
* [CoreFreq](https://github.com/cyring/CoreFreq) ⭐ 2,241 | 🐛 1 | 🌐 C | 📅 2026-08-14 - CPU monitoring TUI software designed for the 64-bits Processors.
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,081 | 🐛 10 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,805 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,635 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,093 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,063 | 🐛 29 | 🌐 Go | 📅 2026-08-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [amtui](https://github.com/pehlicd/amtui/) ⭐ 112 | 🐛 4 | 🌐 Go | 📅 2026-06-20 - A terminal-based user interface (TUI) application that allows you to interact with Prometheus Alertmanager using your terminal. It provides a convenient way to monitor alerts, view silences, and check the status of Alertmanager instances.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,393 | 🐛 209 | 🌐 Rust | 📅 2026-08-13 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,054 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,261 | 🐛 88 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,454 | 🐛 209 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,480 | 🐛 292 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,820 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,649 | 🐛 66 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,860 | 🐛 140 | 🌐 Go | 📅 2026-08-09 - Use any Linux distribution inside your terminal as docker or podman containers.
* [bocker](https://github.com/p8952/bocker) ⭐ 12,664 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in around 100 lines of bash.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,802 | 🐛 24 | 🌐 Rust | 📅 2026-07-24 - A simple TUI to view & control docker containers.
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 596 | 🐛 16 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,317 | 🐛 116 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,289 | 🐛 19 | 🌐 Rust | 📅 2026-08-14 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,692 | 🐛 67 | 🌐 Rust | 📅 2026-07-20 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,675 | 🐛 21 | 🌐 Go | 📅 2026-08-01 - TUI for running apps and processes.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,027 | 🐛 15 | 🌐 Rust | 📅 2026-08-14 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,027 | 🐛 15 | 🌐 Rust | 📅 2026-08-14 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,233 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-14 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 880 | 🐛 4 | 🌐 Rust | 📅 2026-08-14 - Terminal mail client.
...
* [ssh-chat](https://github.com/shazow/ssh-chat) ⭐ 5,903 | 🐛 54 | 🌐 Go | 📅 2026-01-10 - Custom SSH server written in Go. Instead of a shell, you get a chat prompt.
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,731 | 🐛 56 | 🌐 Go | 📅 2026-08-13 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,862 | 🐛 102 | 🌐 Java | 📅 2026-08-10 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,113 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-14 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,917 | 🐛 21 | 🌐 C++ | 📅 2026-08-08 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,709 | 🐛 74 | 🌐 Go | 📅 2026-08-14 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,361 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
...
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,151 | 🐛 22 | 🌐 Haskell | 📅 2026-08-13 - A terminal client for the Mattermost chat system.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 986 | 🐛 15 | 🌐 Rust | 📅 2026-08-10 - A TUI for Telegram written in Rust.
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 939 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 749 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,200 | 🐛 112 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,897 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,394 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,717 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,481 | 🐛 58 | 🌐 Rust | 📅 2026-08-02 - oha is a tiny program that sends some load to a web application and show real-time TUI.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,661 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,648 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,484 | 🐛 79 | 🌐 Rust | 📅 2026-08-13 - A network diagnostic tool.
* [dog](https://github.com/ogham/dog) ⭐ 6,686 | 🐛 79 | 🌐 Rust | 📅 2024-05-29 - dog is a command-line DNS client. It has colorful output, understands normal command-line argument syntax, supports the DNS-over-TLS and DNS-over-HTTPS protocols, and can emit JSON.
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,083 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,068 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,101 | 🐛 47 | 🌐 C | 📅 2026-08-02 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,065 | 🐛 32 | 🌐 C | 📅 2026-08-08 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,852 | 🐛 16 | 🌐 Rust | 📅 2026-08-14 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [tproxy](https://github.com/kevwan/tproxy) ⭐ 3,696 | 🐛 6 | 🌐 Go | 📅 2026-07-09 - A CLI tool to proxy and analyze TCP connections.
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,334 | 🐛 137 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,688 | 🐛 34 | 🌐 Go | 📅 2026-08-08 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
...
* [asn](https://github.com/nitefood/asn) ⭐ 1,919 | 🐛 3 | 🌐 Shell | 📅 2026-06-22 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [Wishlist](https://github.com/charmbracelet/wishlist) ⭐ 1,647 | 🐛 19 | 🌐 Go | 📅 2026-08-12 - With Wishlist you can have a single entrypoint for multiple SSH endpoints.
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,568 | 🐛 25 | 🌐 Rust | 📅 2026-07-09 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,544 | 🐛 15 | 🌐 Rust | 📅 2026-08-14 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,203 | 🐛 76 | 🌐 C | 📅 2026-08-11 - Ncurses SIP Messages flow viewer.
...
* [packemon](https://github.com/ddddddO/packemon) ⭐ 305 | 🐛 35 | 🌐 Go | 📅 2026-08-14 - TUI tool and Go library for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,953 | 🐛 20 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,777 | 🐛 6 | 🌐 Rust | 📅 2026-05-21 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,383 | 🐛 11 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 184,487 | 🐛 2,609 | 🌐 Python | 📅 2026-08-04 - A youtube-dl fork with additional features and fixes.
...
* [aria2](https://github.com/aria2/aria2) ⭐ 41,717 | 🐛 1,159 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 39,778 | 🐛 8 | 🌐 Go | 📅 2026-08-12 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,625 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,816 | 🐛 178 | 🌐 Python | 📅 2026-07-26 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,217 | 🐛 1,157 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,016 | 🐛 38 | 🌐 Rust | 📅 2026-07-26 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 7,924 | 🐛 210 | 🌐 Go | 📅 2026-08-14 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,840 | 🐛 399 | 🌐 C++ | 📅 2026-08-14 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,213 | 🐛 7 | 🌐 Python | 📅 2026-08-14 - A Python tool that lets you find and download torrents without leaving your CLI.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 690 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
* [Stig](https://github.com/rndusr/stig) ⭐ 627 | 🐛 53 | 🌐 Python | 📅 2026-01-24 - Stig is a client application to connect and control the BitTorrent Transmission client app.
...
* [nom](https://github.com/guyfedwards/nom) ⭐ 739 | 🐛 33 | 🌐 Go | 📅 2026-07-08 - RSS reader for the terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,903 | 🐛 163 | 🌐 Go | 📅 2026-08-12 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,525 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,814 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [STU](https://github.com/lusingander/stu) ⭐ 906 | 🐛 15 | 🌐 Rust | 📅 2026-04-30 - S3 Terminal UI, is a interactive terminal-based explorer for Amazon S3 (AWS S3).
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-15 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,935 | 🐛 26 | 🌐 Python | 📅 2026-07-02 - Todo manager with interactive and beautiful UI, and vim keybindings.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,107 | 🐛 129 | 🌐 Rust | 📅 2026-08-10 - A terminal user interface for taskwarrior.
...
* [dijo](https://github.com/NerdyPepper/dijo) ⭐ 2,918 | 🐛 36 | 🌐 Rust | 📅 2024-08-13 - Scriptable, curses-based, digital habit tracker.
* [Watson](https://github.com/TailorDev/Watson) ⭐ 2,536 | 🐛 142 | 🌐 Python | 📅 2025-12-15 - Time tracking CLI to know how much time you are spending on your projects. It can generate nice reports for clients.
...
* [tim:r](https://github.com/sectore/timr) ⭐ 368 | 🐛 1 | 🌐 Rust | 📅 2026-07-12 - A TUI for organizing your time: Pomodoro Countdown counter.
...
* [hours](https://github.com/dhth/hours) ⭐ 345 | 🐛 16 | 🌐 Go | 📅 2026-08-07 - A no-frills time tracking toolkit for command line nerds.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,354 | 🐛 150 | 🌐 Shell | 📅 2026-08-13 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,291 | 🐛 149 | 🌐 Python | 📅 2026-08-14 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,414 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,054 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,761 | 🐛 24 | 🌐 Go | 📅 2026-08-03 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 873 | 🐛 8 | 🌐 Rust | 📅 2023-11-04 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 770 | 🐛 25 | 🌐 Rust | 📅 2026-08-01 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [Captain's Log](https://github.com/NikolaDucak/caps-log) ⭐ 391 | 🐛 16 | 🌐 C++ | 📅 2026-08-14 - A small TUI journaling tool (daily entries saved as md files, tags for organizing entries, browse tags, calendar view, encrypted logs, storage using a git repository).
...
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,333 | 🐛 8 | 🌐 Python | 📅 2026-06-17 - Modern TUI calendar and task manager with customizable interface.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,199 | 🐛 36 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,871 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,523 | 🐛 839 | 🌐 TypeScript | 📅 2026-08-15 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,441 | 🐛 61 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
...
* [parllama](https://github.com/paulrobello/parllama) ⭐ 485 | 🐛 4 | 🌐 Python | 📅 2026-07-11 - TUI designed for easy management and use of Ollama based LLMs.
...
* [cai](https://github.com/ad-si/cai) ⭐ 202 | 🐛 6 | 🌐 Rust | 📅 2026-08-14 - The fastest CLI tool for prompting LLMs. Including support for prompting several LLMs at once!
...
* [Browser CLI](https://github.com/browsemake/browser-cli) ⭐ 46 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-09 - AI agent browser automation tool.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,055 | 🐛 101 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,613 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,768 | 🐛 74 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,320 | 🐛 173 | 🌐 C++ | 📅 2026-08-13 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-08-14 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 155 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,642 | 🐛 124 | 🌐 Rust | 📅 2026-03-13 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,907 | 🐛 40 | 🌐 Rust | 📅 2026-07-10 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 719 | 🐛 13 | 🌐 C | 📅 2026-05-17 - Base conversion and bit manipulator in ncurses.
* [bcal](https://github.com/jarun/bcal) ⭐ 698 | 🐛 0 | 🌐 C | 📅 2026-07-03 - Byte CALculator - A REPL CLI utility for storage expression evaluation, SI/IEC conversion, byte address calculation, base conversion and LBA/CHS calculation.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,700 | 🐛 454 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,429 | 🐛 109 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,421 | 🐛 16 | 🌐 Rust | 📅 2026-08-14 - Very fast implementation of tldr in Rust.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,920 | 🐛 85 | 🌐 Go | 📅 2026-08-14 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [cheatshh](https://github.com/AnirudhG07/cheatshh) ⭐ 189 | 🐛 0 | 🌐 Shell | 📅 2025-08-15 - A fzf based cheatsheet to store commands and their descriptions in a place you can look into so you dont have to remember them.
* [tome](https://github.com/laktak/tome) ⭐ 175 | 🐛 1 | 🌐 Vim Script | 📅 2026-08-13 - Interactive Script playbooks for your terminal with Vim/Neovim (and Tmux).
...
* [wut](https://github.com/shobrook/wut) ⭐ 1,427 | 🐛 18 | 🌐 Python | 📅 2024-12-20 - An terminal assistant for the hopelessly confused; it explains the meaning of the output from the last command.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 106 | 🐛 3 | 🌐 Rust | 📅 2026-08-14 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 10 | 🐛 0 | 🌐 Zig | 📅 2026-08-14 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 24,929 | 🐛 544 | 🌐 Go | 📅 2026-08-12 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,632 | 🐛 256 | 🌐 JavaScript | 📅 2026-08-14 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,217 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,450 | 🐛 36 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,134 | 🐛 57 | 🌐 C | 📅 2026-07-26 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,301 | 🐛 28 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
...
* [Diagon](https://github.com/ArthurSonzogni/Diagon) ⭐ 2,217 | 🐛 21 | 🌐 C++ | 📅 2025-05-16 - Diagon is an interactive interpreter, that transforms Markdown-style expression into an ASCII-art representation.
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,007 | 🐛 37 | 🌐 C | 📅 2026-04-01 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 989 | 🐛 16 | 🌐 Python | 📅 2026-08-11 - AI-Powered Command-Line Photo Search Tool.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 413 | 🐛 3 | 🌐 Rust | 📅 2026-08-15 - A powerful Rust image optimization CLI tool.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,636 | 🐛 11 | 🌐 Shell | 📅 2026-08-13 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 561 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,296 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,541 | 🐛 707 | 🌐 Python | 📅 2026-08-15 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,781 | 🐛 226 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,068 | 🐛 161 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,729 | 🐛 211 | 🌐 Rust | 📅 2026-08-10 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 573 | 🐛 24 | 🌐 Rust | 📅 2026-08-09 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
* [opencubicplayer](https://github.com/mywave82/opencubicplayer) ⭐ 435 | 🐛 18 | 🌐 C | 📅 2026-08-12 - Open Cubic Player (UNIX fork) is a music visualizer for various tracked music formats (amiga modules, S3M, IT), chiptunes and other formats related to demoscene.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,820 | 🐛 177 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 2,973 | 🐛 1 | 🌐 C | 📅 2026-08-14 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,973 | 🐛 1 | 🌐 C | 📅 2026-08-14 - A command-line music player with gapless playback and simple playlist management.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,152 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 612 | 🐛 43 | 🌐 Go | 📅 2026-08-14 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,182 | 🐛 420 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
...
* [haxor-news](https://github.com/donnemartin/haxor-news) ⭐ 4,087 | 🐛 42 | 🌐 Python | 📅 2022-04-22 - Browse Hacker News like a haxor: A Hacker News command line interface (CLI).
* [ccat](https://github.com/owenthereal/ccat) ⭐ 3,207 | 🐛 41 | 🌐 Go | 📅 2022-09-05 - `cat` with colorized output.
* [timg](https://github.com/hzeller/timg) ⭐ 2,725 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 1,994 | 🐛 27 | 🌐 Go | 📅 2026-08-11 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,546 | 🐛 15 | 🌐 Go | 📅 2025-06-22 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,377 | 🐛 12 | 🌐 Rust | 📅 2026-08-01 - Terminal image, video, directory, and Markdown viewer.
...
* [epy](https://github.com/wustho/epy) ⭐ 1,210 | 🐛 72 | 🌐 Python | 📅 2024-03-17 - CLI Ebook (epub2, epub3, fb2, mobi) Reader.
...
* [fancy-cat](https://github.com/freref/fancy-cat) ⭐ 553 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - CLI PDF reader with Vim keybindings.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 348 | 🐛 14 | 🌐 Rust | 📅 2026-07-17 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 336 | 🐛 11 | 🌐 Rust | 📅 2026-08-11 - An TUI for exploring data of a Kafka cluster.
...
* [moulti](https://github.com/xavierog/moulti) ⭐ 165 | 🐛 2 | 🌐 Python | 📅 2026-02-05 - Moulti is a CLI-driven Terminal User Interface (TUI) displaying arbitrary outputs inside visual, collapsible blocks called steps.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,922 | 🐛 13 | 🌐 Rust | 📅 2026-08-12 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
* [pipes.sh](https://github.com/pipeseroni/pipes.sh) ⭐ 3,009 | 🐛 13 | 🌐 Shell | 📅 2024-08-12 - Animated pipes terminal screensaver.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,635 | 🐛 169 | 🌐 Go | 📅 2026-08-12 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,678 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
* [terminalizer](https://github.com/faressoft/terminalizer) ⭐ 16,151 | 🐛 108 | 🌐 JavaScript | 📅 2024-08-29 - Record your terminal and generate animated GIF images or share a web player link [www.terminalizer.com](www.terminalizer.com).
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,685 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,805 | 🐛 438 | 🌐 Go | 📅 2026-08-10 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,065 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,753 | 🐛 13 | 🌐 Rust | 📅 2026-08-10 - Manage your GnuPG keys with ease!
...
* [vet](https://github.com/safedep/vet) ⭐ 1,097 | 🐛 97 | 🌐 Go | 📅 2026-08-13 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 939 | 🐛 3 | 🌐 Go | 📅 2026-08-07 - A command-line tool for interacting with OAuth 2.0 authorization servers.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,441 | 🐛 95 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
* [passage](https://github.com/FiloSottile/passage) ⭐ 1,182 | 🐛 34 | 🌐 Shell | 📅 2024-08-30 - A fork of [password-store](https://www.passwordstore.org) that uses [age](https://age-encryption.org) as a backend instead of GnuPG.
...
* [oama](https://github.com/pdobsan/oama) ⭐ 254 | 🐛 10 | 🌐 Haskell | 📅 2025-08-29 - OAuth credential Manager.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,209 | 🐛 557 | 🌐 Python | 📅 2026-08-08 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,679 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [fzf-tab-completion](https://github.com/lincheney/fzf-tab-completion) ⭐ 858 | 🐛 33 | 🌐 Shell | 📅 2026-07-31 - Tab completion using fzf.
* [gentoo-install](https://github.com/oddlama/gentoo-install) ⭐ 778 | 🐛 23 | 🌐 Shell | 📅 2026-08-08 - This project aspires to be your favorite way to install gentoo. It aims to provide a smooth installation experience, both for beginners and experts. You may configure it by using a menuconfig-inspired interface or simply via a config file.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 512 | 🐛 34 | 🌐 Go | 📅 2026-08-10 - Cross Platform tool to validate configuration files.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,154 | 🐛 12 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,148 | 🐛 29 | 🌐 Rust | 📅 2026-08-13 - Play chess from your terminal.
...
* [terminal-doom](https://github.com/cryptocode/terminal-doom) ⭐ 435 | 🐛 2 | 🌐 C | 📅 2026-04-26 - Play DOOM in modern terminals.
...
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 299 | 🐛 14 | 🌐 Python | 📅 2026-08-14 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,233 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,111 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,446 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,153 | 🐛 1 | 🌐 Shell | 📅 2026-08-04 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,185 | 🐛 61 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
