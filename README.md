...
* [eza](https://github.com/eza-community/eza) ⭐ 23,374 | 🐛 455 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,268 | 🐛 32 | 🌐 Rust | 📅 2026-09-21 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,700 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,054 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
* [autojump](https://github.com/wting/autojump) ⭐ 16,962 | 🐛 232 | 🌐 Python | 📅 2025-02-27 - A cd command that maintains a database of most visited paths and allows the access to a directory with shortened versions of the path.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,542 | 🐛 198 | 🌐 Rust | 📅 2026-09-24 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,800 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Intelligent context-aware search engine for your shell history with TUI.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,348 | 🐛 452 | 🌐 Rust | 📅 2026-09-19 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,933 | 🐛 289 | 🌐 Rust | 📅 2026-09-22 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,096 | 🐛 5 | 🌐 Perl | 📅 2026-09-19 - Make your diffs human-readable instead of machine-readable.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,610 | 🐛 204 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 16,040 | 🐛 69 | 🌐 Rust | 📅 2026-09-25 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,857 | 🐛 80 | 🌐 Rust | 📅 2026-09-17 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,370 | 🐛 10 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
...
* [gdu](https://github.com/dundee/gdu) ⭐ 6,015 | 🐛 48 | 🌐 Go | 📅 2026-09-23 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,754 | 🐛 550 | 🌐 C++ | 📅 2026-09-25 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,117 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,928 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,165 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,429 | 🐛 110 | 🌐 C | 📅 2026-09-19 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,434 | 🐛 64 | 🌐 Rust | 📅 2026-09-21 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,376 | 🐛 271 | 🌐 Go | 📅 2026-09-24 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 22,011 | 🐛 1 | 🌐 C | 📅 2026-09-26 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
...
* [fman](https://github.com/nore-dev/fman) ⭐ 341 | 🐛 7 | 🌐 Go | 📅 2022-11-28 - TUI file manager written in Go with mouse support, file preview, syntax highlighting and support for themes.
* [sfm](https://github.com/afify/sfm) ⭐ 262 | 🐛 6 | 🌐 C | 📅 2025-11-14 - Simple file manager for unix-like systems with kernel event notifications, monitoring filesystem events, dual pane and more.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,831 | 🐛 12 | 🌐 Rust | 📅 2026-09-23 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [browsr](https://github.com/juftin/browsr) ⭐ 651 | 🐛 13 | 🌐 Python | 📅 2026-04-22 - A pleasant file explorer that can browse the contents of local and remote filesystems with your keyboard or mouse; remotes include GitHub, over SSH, in AWS S3, Google Cloud Storage, or Azure Blob Storage.
...
* [ictree](https://github.com/NikitaIvanovV/ictree) ⭐ 171 | 🐛 6 | 🌐 C | 📅 2024-03-26 - Like tree but interactive.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,770 | 🐛 96 | 🌐 Rust | 📅 2026-09-24 - Painless compression and decompression in the terminal.
...
* [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,548 | 🐛 61 | 🌐 C | 📅 2026-09-02 - Rotate, compress and mail logs.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,678 | 🐛 63 | 🌐 C | 📅 2026-09-16 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 187,076 | 🐛 695 | 🌐 Python | 📅 2026-09-21 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-25 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,539 | 🐛 544 | 🌐 Rust | 📅 2026-09-20 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [lolcat](https://github.com/busyloop/lolcat) ⭐ 6,580 | 🐛 33 | 🌐 Ruby | 📅 2024-03-05 - Ruby Gem to colorize the output of the cat command.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,726 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,439 | 🐛 381 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,354 | 🐛 5 | 🌐 Perl | 📅 2026-09-02 - Command line tool for URL parsing and manipulation.
...
* [gtree](https://github.com/ddddddO/gtree) ⭐ 364 | 🐛 38 | 🌐 Go | 📅 2026-09-25 - Using either Markdown or programmatically to generate directory trees and directories, and to verify directories.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,807 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,756 | 🐛 49 | 🌐 Python | 📅 2026-09-21 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,039 | 🐛 22 | 🌐 Python | 📅 2026-09-26 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,641 | 🐛 35 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 16,013 | 🐛 296 | 🌐 Go | 📅 2026-09-25 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,521 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,686 | 🐛 35 | 🌐 Python | 📅 2026-09-23 - Serializes the output of command line tools to JSON.
* [dasel](https://github.com/TomWright/dasel) ⭐ 8,042 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Allows you to query and modify data structures using selector strings.
...
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,775 | 🐛 24 | 🌐 Rust | 📅 2026-09-24 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,515 | 🐛 598 | 🌐 Go | 📅 2026-09-25 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,404 | 🐛 49 | 🌐 Python | 📅 2026-09-20 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,978 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,126 | 🐛 74 | 🌐 Go | 📅 2026-09-26 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,026 | 🐛 72 | 🌐 Go | 📅 2026-09-25 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
* [textql](https://github.com/dinedal/textql) ⭐ 9,103 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,420 | 🐛 30 | 🌐 Python | 📅 2026-09-26 - The SQL IDE for Your Terminal.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,412 | 🐛 44 | 🌐 Python | 📅 2026-09-21 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,349 | 🐛 13 | 🌐 Rust | 📅 2026-09-24 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,326 | 🐛 39 | 🌐 Go | 📅 2026-09-25 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,987 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,796 | 🐛 34 | 🌐 Rust | 📅 2026-09-26 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,796 | 🐛 34 | 🌐 Rust | 📅 2026-09-26 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,236 | 🐛 11 | 🌐 Go | 📅 2026-09-25 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,125 | 🐛 17 | 🌐 Rust | 📅 2026-09-25 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,252 | 🐛 331 | 🌐 Go | 📅 2026-09-21 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,970 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,291 | 🐛 80 | 🌐 Rust | 📅 2026-09-23 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,473 | 🐛 235 | 🌐 Go | 📅 2026-09-22 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,175 | 🐛 657 | 🌐 Rust | 📅 2026-09-18 - Create book from Markdown files.
...
* [DocToc](https://github.com/thlorenz/doctoc) ⭐ 4,466 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-04 - Generates table of contents for Markdown files inside local git repository. Links are compatible with anchors generated by GitHub or other sites.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,642 | 🐛 917 | 🌐 Go | 📅 2026-09-26 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,628 | 🐛 167 | 🌐 Rust | 📅 2026-09-23 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 705 | 🐛 0 | 🌐 Go | 📅 2026-09-25 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,679 | 🐛 1,057 | 🌐 Go | 📅 2026-09-25 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,487 | 🐛 484 | 🌐 Go | 📅 2026-09-23 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,523 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,112 | 🐛 93 | 🌐 Shell | 📅 2026-09-21 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,349 | 🐛 232 | 🌐 C | 📅 2026-09-19 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,559 | 🐛 101 | 🌐 Go | 📅 2026-09-22 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,269 | 🐛 116 | 🌐 Rust | 📅 2026-09-18 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,052 | 🐛 63 | 🌐 Rust | 📅 2026-09-26 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,493 | 🐛 154 | 🌐 Go | 📅 2026-09-25 - Distributed, offline-first bug tracker embedded in git, with bridges.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,085 | 🐛 7 | 🌐 Shell | 📅 2026-09-25 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,048 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,753 | 🐛 1,271 | 🌐 Rust | 📅 2026-09-26 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,495 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-26 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,307 | 🐛 796 | 🌐 Go | 📅 2026-09-26 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,068 | 🐛 403 | 🌐 JavaScript | 📅 2026-09-25 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 24,021 | 🐛 9 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,558 | 🐛 26 | 🌐 Perl | 📅 2026-09-20 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,943 | 🐛 247 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,375 | 🐛 415 | 🌐 Go | 📅 2026-09-25 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,258 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,778 | 🐛 26 | 🌐 Go | 📅 2026-09-25 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,199 | 🐛 19 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,143 | 🐛 442 | 🌐 Rust | 📅 2026-09-25 - Developer environments you can take with you.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 907 | 🐛 178 | 🌐 Rust | 📅 2026-09-26 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 604 | 🐛 2 | 🌐 Go | 📅 2026-09-26 - Update binaries installed by "go install" with goroutines.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,110 | 🐛 319 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,682 | 🐛 79 | 🌐 Go | 📅 2026-09-25 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,375 | 🐛 415 | 🌐 Go | 📅 2026-09-25 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,541 | 🐛 4 | 🌐 Rust | 📅 2026-09-24 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,643 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,519 | 🐛 143 | 🌐 Go | 📅 2026-09-22 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 88 | 🌐 C | 📅 2026-09-21 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 88 | 🌐 C | 📅 2026-09-21 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,413 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
...
* [E1S](https://github.com/keidarcy/e1s) ⭐ 931 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - TUI for browsing and managing AWS ECS resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,585 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,498 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,451 | 🐛 85 | 🌐 Python | 📅 2026-09-26 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,947 | 🐛 72 | 🌐 Rust | 📅 2026-09-21 - Fast, async, resource-friendly link checker written in Rust.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,443 | 🐛 3 | 🌐 Rust | 📅 2026-09-25 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,193 | 🐛 1,896 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 36,013 | 🐛 170 | 🌐 Rust | 📅 2026-09-26 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,330 | 🐛 292 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,708 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-18 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,771 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,063 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [brightnessctl](https://github.com/Hummer12007/brightnessctl) ⭐ 1,273 | 🐛 25 | 🌐 C | 📅 2024-12-16 - Read and control device brightness. Devices, by default, include backlight and LEDs - searched for in corresponding classes.
...
* [qman](https://github.com/plp13/qman) ⭐ 606 | 🐛 16 | 🌐 C | 📅 2026-09-06 - A more modern man page viewer for our terminals.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,552 | 🐛 251 | 🌐 Zig | 📅 2026-09-25 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 29,028 | 🐛 1,883 | 🌐 Rust | 📅 2026-09-21 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,546 | 🐛 1,935 | 🌐 Rust | 📅 2026-09-25 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,366 | 🐛 21 | 🌐 C++ | 📅 2026-09-25 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,366 | 🐛 21 | 🌐 C++ | 📅 2026-09-25 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,577 | 🐛 1,436 | 🌐 Rust | 📅 2026-09-25 - A modern shell written in Rust, where all data is structured.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 283 | 🐛 63 | 🌐 C | 📅 2026-09-26 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-25 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,155 | 🐛 152 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,425 | 🐛 0 | 🌐 Shell | 📅 2026-09-19 - Pretty, minimal, and fast ZSH prompt.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,047 | 🐛 47 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,774 | 🐛 99 | 🌐 C | 📅 2026-09-25 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,774 | 🐛 99 | 🌐 C | 📅 2026-09-25 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,953 | 🐛 448 | 🌐 C | 📅 2026-09-24 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,725 | 🐛 38 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,110 | 🐛 11 | 🌐 Shell | 📅 2026-09-23 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,902 | 🐛 18 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,580 | 🐛 211 | 🌐 Rust | 📅 2026-09-25 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,076 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,294 | 🐛 84 | 🌐 Go | 📅 2026-09-26 - Manages binary files downloaded from different sources.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,955 | 🐛 301 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,842 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,317 | 🐛 72 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 13,011 | 🐛 157 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,862 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,418 | 🐛 114 | 🌐 C | 📅 2026-09-25 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,348 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,689 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,800 | 🐛 26 | 🌐 Go | 📅 2026-09-21 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,728 | 🐛 69 | 🌐 Rust | 📅 2026-09-24 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,896 | 🐛 3 | 🌐 Rust | 📅 2026-09-26 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,329 | 🐛 23 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,329 | 🐛 23 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
* [tmpmail](https://github.com/sdushantha/tmpmail) ⭐ 4,185 | 🐛 7 | 🌐 Shell | 📅 2024-08-17 - A command line utility written in POSIX sh that allows you to create a temporary email address and receive emails to the temporary email address.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,380 | 🐛 223 | 🌐 TypeScript | 📅 2026-09-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 892 | 🐛 3 | 🌐 Rust | 📅 2026-09-25 - Terminal mail client.
...
* [nmail](https://github.com/d99kris/nmail) ⭐ 261 | 🐛 0 | 🌐 C++ | 📅 2026-09-26 - nmail is a console-based email client for Linux and macOS with a user interface similar to alpine / pine.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,210 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,785 | 🐛 53 | 🌐 Go | 📅 2026-09-26 - A lightweight, secure, and feature-rich Discord terminal client.
...
* [devzat](https://github.com/quackduck/devzat) ⭐ 4,071 | 🐛 25 | 🌐 Go | 📅 2026-07-23 - Custom SSH server that takes you to a chat instead of a shell prompt.
* [Sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,477 | 🐛 44 | 🌐 Python | 📅 2022-12-08 - CLI client for Slack.
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,157 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,965 | 🐛 27 | 🌐 C++ | 📅 2026-09-26 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,727 | 🐛 81 | 🌐 Go | 📅 2026-09-25 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,382 | 🐛 98 | 🌐 Rust | 📅 2026-09-15 - Signal Messenger client for terminal.
...
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,153 | 🐛 22 | 🌐 Haskell | 📅 2026-09-26 - A terminal client for the Mattermost chat system.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,422 | 🐛 115 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* [oha](https://github.com/hatoo/oha) ⭐ 10,562 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,697 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,960 | 🐛 86 | 🌐 Rust | 📅 2026-09-26 - A network diagnostic tool.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,054 | 🐛 33 | 🌐 Rust | 📅 2026-09-25 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,348 | 🐛 141 | 🌐 C | 📅 2026-09-24 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,725 | 🐛 36 | 🌐 Go | 📅 2026-09-12 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,582 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - TUI for sniffing network traffic using eBPF on Linux.
...
* [Tunnelmole](https://github.com/robbie-cahill/tunnelmole-client) ⭐ 1,893 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-13 - Connect to local servers from anywhere.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,863 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,614 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,563 | 🐛 5 | 🌐 Rust | 📅 2026-09-26 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [packemon](https://github.com/ddddddO/packemon) ⭐ 308 | 🐛 37 | 🌐 Go | 📅 2026-09-25 - TUI tool and Go library for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,019 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,867 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,412 | 🐛 15 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,630 | 🐛 2,685 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,369 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,726 | 🐛 1,179 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,446 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,700 | 🐛 546 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,953 | 🐛 182 | 🌐 Python | 📅 2026-09-23 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,837 | 🐛 1,138 | 🌐 Python | 📅 2026-09-19 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,102 | 🐛 202 | 🌐 Go | 📅 2026-09-24 - Beautiful and feature-rich Telegram downloader, written in Go.
* [xh](https://github.com/ducaale/xh) ⭐ 8,101 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,721 | 🐛 126 | 🌐 Go | 📅 2026-09-25 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,730 | 🐛 27 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,538 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,868 | 🐛 386 | 🌐 C++ | 📅 2026-09-25 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
...
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 702 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
* [Stig](https://github.com/rndusr/stig) ⭐ 629 | 🐛 60 | 🌐 Python | 📅 2026-01-24 - Stig is a client application to connect and control the BitTorrent Transmission client app.
...
* [Romulus](https://github.com/LukeEmmet/Romulus) ⭐ 14 | 🐛 3 | 🌐 C# | 📅 2022-07-21 - A cross-platform Gemini console client in C# with a simple user interface, interactive menus and mouse support.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,992 | 🐛 175 | 🌐 Go | 📅 2026-09-22 - Feature-rich interactive Jira command line.
...
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,846 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-09-26 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,957 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
...
* [Watson](https://github.com/TailorDev/Watson) ⭐ 2,539 | 🐛 142 | 🌐 Python | 📅 2025-12-15 - Time tracking CLI to know how much time you are spending on your projects. It can generate nice reports for clients.
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,664 | 🐛 127 | 🌐 C++ | 📅 2026-09-25 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - Simple timer for the terminal with timer-mode and alarm.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,414 | 🐛 153 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,325 | 🐛 152 | 🌐 Python | 📅 2026-09-26 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,057 | 🐛 264 | 🌐 Python | 📅 2026-09-23 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,882 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
...
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,882 | 🐛 225 | 🌐 Python | 📅 2026-09-04 - CalDAV synchronization program.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,240 | 🐛 34 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,911 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [abandon](https://github.com/hrj/abandon) ⭐ 186 | 🐛 32 | 🌐 Scala | 📅 2026-09-07 - A text based, double-entry accounting system inspired by Ledger with infinite precision arithmetic. Made in Java. Includes a GUI.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,166 | 🐛 804 | 🌐 TypeScript | 📅 2026-09-26 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 44,076 | 🐛 73 | 🌐 Go | 📅 2026-09-26 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,469 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [OrChat](https://github.com/oop7/OrChat) ⭐ 79 | 🐛 0 | 🌐 Python | 📅 2026-02-15 - A powerful, feature-rich command-line interface for interacting with AI models through OpenRouter.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,667 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,878 | 🐛 80 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,443 | 🐛 173 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 528 | 🐛 15 | 🌐 Python | 📅 2026-09-25 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,881 | 🐛 461 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,637 | 🐛 111 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,550 | 🐛 15 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,355 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,965 | 🐛 90 | 🌐 Go | 📅 2026-09-25 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 144 | 🐛 1 | 🌐 Rust | 📅 2026-09-26 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [c0admin](https://github.com/mbrell/c0admin) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-09-26 - A terminal-based AI assistant for Linux sysadmins. Uses the Gemini API.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-25 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,512 | 🐛 530 | 🌐 Go | 📅 2026-09-20 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,701 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,242 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,276 | 🐛 54 | 🌐 C | 📅 2026-09-25 - Terminal graphics for the 21 st century.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 420 | 🐛 7 | 🌐 Rust | 📅 2026-09-22 - A powerful Rust image optimization CLI tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,804 | 🐛 76 | 🌐 Python | 📅 2026-09-25 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,510 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 609 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,716 | 🐛 710 | 🌐 Python | 📅 2026-09-25 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,794 | 🐛 227 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,239 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
...
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,741 | 🐛 168 | 🌐 C | 📅 2026-09-25 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 600 | 🐛 19 | 🌐 Rust | 📅 2026-09-20 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 160 | 🐛 1 | 🌐 Shell | 📅 2026-09-25 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [discodos](https://github.com/JOJ0/discodos) ⭐ 86 | 🐛 4 | 🌐 Python | 📅 2025-08-27 - A CLI tool for DJ's and record collectors based on the discogs.com collection feature that allows analyzing and organize DJ sets.
...
* [cue](https://github.com/ravachol/cue) ⭐ 3,111 | 🐛 2 | 🌐 C | 📅 2026-09-25 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,111 | 🐛 2 | 🌐 C | 📅 2026-09-25 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,218 | 🐛 49 | 🌐 Rust | 📅 2026-09-22 - Terminal Music Player written in Rust.
...
* [Gomu](https://github.com/issadarkthing/gomu) ⭐ 213 | 🐛 11 | 🌐 Go | 📅 2026-06-05 - Gomu is intuitive, powerful CLI music player. It has embedded scripting language and event hook to enable user to customize their config extensively.
...
* [neo](https://github.com/st3w/neo) ⭐ 964 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,579 | 🐛 519 | 🌐 Rust | 📅 2026-09-22 - A cat clone with syntax highlighting and Git integration.
...
* [ov](https://github.com/noborus/ov) ⭐ 2,025 | 🐛 29 | 🌐 Go | 📅 2026-09-25 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,566 | 🐛 12 | 🌐 Go | 📅 2026-09-24 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 360 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 349 | 🐛 6 | 🌐 Rust | 📅 2026-08-27 - An TUI for exploring data of a Kafka cluster.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 5,000 | 🐛 12 | 🌐 Rust | 📅 2026-09-25 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,986 | 🐛 173 | 🌐 Go | 📅 2026-09-24 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,834 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,223 | 🐛 448 | 🌐 Go | 📅 2026-09-21 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,831 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,088 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,764 | 🐛 14 | 🌐 Rust | 📅 2026-09-21 - Manage your GnuPG keys with ease!
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,506 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
* [passage](https://github.com/FiloSottile/passage) ⭐ 1,193 | 🐛 34 | 🌐 Shell | 📅 2024-08-30 - A fork of [password-store](https://www.passwordstore.org) that uses [age](https://age-encryption.org) as a backend instead of GnuPG.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,356 | 🐛 636 | 🌐 Python | 📅 2026-09-19 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [Raijin](https://github.com/MasonStooksbury/Raijin) ⭐ 173 | 🐛 2 | 🌐 Rust | 📅 2026-09-26 - A free, simple weather TUI that pulls data without the need for an API key, account, or subscription.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,326 | 🐛 14 | 🌐 Shell | 📅 2026-09-21 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,053 | 🐛 12 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,186 | 🐛 36 | 🌐 Rust | 📅 2026-09-24 - Play chess from your terminal.
...
* [Micro Snake](https://github.com/troglobit/snake) ⭐ 37 | 🐛 1 | 🌐 C | 📅 2023-04-16 - A small snake game, utilizing ANSI escape sequences to draw the board.
...
* [Pubs](https://github.com/pubs/pubs) ⭐ 292 | 🐛 70 | 🌐 Python | 📅 2024-06-01 - Pubs organizes your scientific papers together with their bibliographic data and provides command line access to basic and advanced manipulation of your library.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,516 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,678 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,469 | 🐛 2 | 🌐 Shell | 📅 2026-09-21 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,732 | 🐛 48 | 📅 2026-09-22 - An awesome list dedicated to TUI programs.
