...
* [eza](https://github.com/eza-community/eza) ⭐ 23,174 | 🐛 445 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,216 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,259 | 🐛 34 | 🌐 Rust | 📅 2026-09-07 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,198 | 🐛 143 | 🌐 Rust | 📅 2026-08-31 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,145 | 🐛 74 | 🌐 Lua | 📅 2026-08-10 - Directory changer that learns your habits.
* [enhancd](https://github.com/babarot/enhancd) ⭐ 2,716 | 🐛 17 | 🌐 Shell | 📅 2025-01-24 - A next-generation cd command with your interactive filter.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,329 | 🐛 202 | 🌐 Rust | 📅 2026-09-07 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,264 | 🐛 13 | 🌐 C | 📅 2026-08-31 - A breadth-first version of the UNIX find command.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,101 | 🐛 435 | 🌐 Rust | 📅 2026-09-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,862 | 🐛 294 | 🌐 Rust | 📅 2026-09-06 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,089 | 🐛 5 | 🌐 Perl | 📅 2026-08-31 - Make your diffs human-readable instead of machine-readable.
...
* [csv-diff](https://github.com/simonw/csv-diff) ⭐ 341 | 🐛 38 | 🌐 Python | 📅 2024-09-06 - Python CLI tool and library for diffing CSV and JSON files
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,021 | 🐛 188 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,119 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,775 | 🐛 48 | 🌐 Rust | 📅 2026-09-06 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,830 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,274 | 🐛 9 | 🌐 C++ | 📅 2026-08-31 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [krep](https://github.com/davidesantangelo/krep) ⭐ 454 | 🐛 6 | 🌐 C | 📅 2026-09-03 - Blazingly fast text search tool with multiple algorithms (Boyer-Moore, KMP, Rabin-Karp), SIMD acceleration, multi-threading, and regex support. Outperforms traditional tools with memory-mapped I/O and hardware optimizations for who need rapid pattern matching at scale.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,345 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,226 | 🐛 10 | 🌐 Rust | 📅 2026-08-19 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,230 | 🐛 1 | 🌐 Rust | 📅 2026-09-06 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,964 | 🐛 54 | 🌐 Go | 📅 2026-09-04 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,974 | 🐛 149 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,140 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,156 | 🐛 34 | 🌐 Rust | 📅 2026-09-07 - A modern replacement for ps written in Rust.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,047 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
* [below](https://github.com/facebookincubator/below) ⭐ 2,508 | 🐛 32 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,696 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [FClones](https://github.com/pkolaczk/fclones) ⭐ 2,928 | 🐛 102 | 🌐 Rust | 📅 2025-03-03 - Efficient Duplicate File Finder.
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,420 | 🐛 118 | 🌐 C | 📅 2026-09-05 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,993 | 🐛 69 | 🌐 Rust | 📅 2026-09-01 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,115 | 🐛 263 | 🌐 Go | 📅 2026-09-06 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,871 | 🐛 6 | 🌐 C | 📅 2026-09-05 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,491 | 🐛 84 | 🌐 Go | 📅 2026-08-25 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 472 | 🌐 C++ | 📅 2026-09-06 - Linux port of Far v2 file manager.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,817 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,746 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,741 | 🐛 86 | 🌐 Rust | 📅 2026-09-05 - Painless compression and decompression in the terminal.
...
* [reflex](https://github.com/cespare/reflex) ⭐ 3,552 | 🐛 28 | 🌐 Go | 📅 2026-02-26 - Reflex is a small tool to watch a directory and rerun a command when certain files change.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,657 | 🐛 62 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 178,948 | 🐛 610 | 🌐 Python | 📅 2026-09-07 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,442 | 🐛 539 | 🌐 Rust | 📅 2026-09-06 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [lolcat](https://github.com/busyloop/lolcat) ⭐ 6,572 | 🐛 33 | 🌐 Ruby | 📅 2024-03-05 - Ruby Gem to colorize the output of the cat command.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,716 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,334 | 🐛 375 | 🌐 Python | 📅 2026-06-23.
...
* [stam-tools](https://github.com/annotation/stam-tools) ⭐ 4 | 🐛 7 | 🌐 Rust | 📅 2026-09-03 - A collection of command-line tools for working with STAM, a data-model for stand-off annotations on text.
...
* [ROAPI](https://github.com/roapi/roapi) ⭐ 3,431 | 🐛 66 | 🌐 Rust | 📅 2026-03-25 - ROAPI automatically spins up read-only APIs for static datasets without requiring you to write a single line of code.
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,741 | 🐛 52 | 🌐 Python | 📅 2026-09-02 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
* [ttyplot](https://github.com/tenox7/ttyplot) ⭐ 1,378 | 🐛 11 | 🌐 C | 📅 2026-07-28 - A realtime plotting utility for terminals with data input from stdin/pipe.
...
* [lowcharts](https://github.com/juan-leon/lowcharts) ⭐ 251 | 🐛 10 | 🌐 Rust | 📅 2025-12-22 - lowcharts is meant to be used in those scenarios where we have numerical data in text files that we want to display in the terminal to do a basic analysis.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,619 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,796 | 🐛 18 | 🌐 Go | 📅 2026-09-04 - Pure Go implementation of jq.
...
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,480 | 🐛 29 | 🌐 Python | 📅 2026-08-04 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,371 | 🐛 646 | 🌐 Go | 📅 2026-09-06 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,373 | 🐛 37 | 🌐 Python | 📅 2026-09-04 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,974 | 🐛 2 | 🌐 Python | 📅 2026-09-05 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,099 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,009 | 🐛 71 | 📅 2026-09-01 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
* [textql](https://github.com/dinedal/textql) ⭐ 9,103 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,411 | 🐛 40 | 🌐 Python | 📅 2026-08-03 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
...
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,275 | 🐛 49 | 🌐 Go | 📅 2026-08-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,955 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,775 | 🐛 31 | 🌐 Rust | 📅 2026-09-06 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,775 | 🐛 31 | 🌐 Rust | 📅 2026-09-06 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,199 | 🐛 15 | 🌐 Go | 📅 2026-09-04 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,095 | 🐛 18 | 🌐 Rust | 📅 2026-09-06 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,558 | 🐛 69 | 🌐 Go | 📅 2026-09-06 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,849 | 🐛 328 | 🌐 Go | 📅 2026-09-06 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,943 | 🐛 6 | 🌐 Rust | 📅 2026-09-06 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,246 | 🐛 79 | 🌐 Rust | 📅 2026-09-06 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,212 | 🐛 230 | 🌐 Go | 📅 2026-09-06 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,124 | 🐛 661 | 🌐 Rust | 📅 2026-09-03 - Create book from Markdown files.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 818 | 🐛 66 | 🌐 Python | 📅 2026-08-31 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,535 | 🐛 975 | 🌐 Go | 📅 2026-09-07 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,543 | 🐛 174 | 🌐 Rust | 📅 2026-08-27 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [zee](https://github.com/zee-editor/zee) ⭐ 1,803 | 🐛 44 | 🌐 Rust | 📅 2025-02-06 - Zee is a modern editor for the terminal, in the spirit of Emacs. It is written in Rust and it is somewhat experimental.
...
* [Turbo](https://github.com/magiblot/turbo) ⭐ 679 | 🐛 37 | 🌐 C++ | 📅 2026-08-28 - An experimental text editor for the terminal, based on Scintilla and Turbo Vision.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,084 | 🐛 1,029 | 🌐 Go | 📅 2026-09-06 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,138 | 🐛 473 | 🌐 Go | 📅 2026-08-26 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,468 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,482 | 🐛 100 | 🌐 Go | 📅 2026-09-02 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,217 | 🐛 113 | 🌐 Rust | 📅 2026-09-06 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,044 | 🐛 68 | 🌐 Rust | 📅 2026-09-07 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,020 | 🐛 179 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,214 | 🐛 80 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,076 | 🐛 10 | 🌐 Shell | 📅 2026-09-05 - A utility tool powered by fzf for using git interactively.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,314 | 🐛 13 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,935 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [ggc](https://github.com/bmf-san/ggc) ⭐ 284 | 🐛 5 | 🌐 Go | 📅 2026-09-07 - A modern Git CLI tool with both traditional command-line and interactive incremental-search UI.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,431 | 🐛 1,222 | 🌐 Rust | 📅 2026-09-07 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,225 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-06 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,939 | 🐛 693 | 🌐 Go | 📅 2026-09-06 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,026 | 🐛 405 | 🌐 JavaScript | 📅 2026-09-05 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,970 | 🐛 6 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,505 | 🐛 28 | 🌐 Perl | 📅 2026-09-02 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,882 | 🐛 241 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,339 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Instant, easy, and predictable development environments.
...
* [release-it](https://github.com/release-it/release-it) ⭐ 9,045 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,723 | 🐛 27 | 🌐 Go | 📅 2026-09-07 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,418 | 🐛 37 | 🌐 Rust | 📅 2026-09-06 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,123 | 🐛 444 | 🌐 Rust | 📅 2026-09-06 - Developer environments you can take with you.
* [rebound](https://github.com/shobrook/rebound) ⭐ 4,113 | 🐛 24 | 🌐 Python | 📅 2022-02-16 - Fetch Stack Overflow results in your terminal when you get an error. Supported languages: Python, Node.js, Ruby, Go, and Java.
...
* [gup](https://github.com/nao1215/gup) ⭐ 602 | 🐛 2 | 🌐 Go | 📅 2026-09-06 - Update binaries installed by "go install" with goroutines.
* [DevTUI](https://github.com/skatkov/devtui) ⭐ 553 | 🐛 41 | 🌐 Go | 📅 2026-08-31 - All-in-one terminal toolkit that consolidates everyday developer utilities into a unified TUI and CLI.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,077 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,522 | 🐛 82 | 🌐 Go | 📅 2026-09-06 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,339 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,530 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - A simple and fast terminal dashboard for Kubernetes.
...
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 11 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,215 | 🐛 7 | 🌐 Go | 📅 2026-09-06 - TUI for Podman environment.
...
* [E1S](https://github.com/keidarcy/e1s) ⭐ 923 | 🐛 0 | 🌐 Go | 📅 2026-09-07 - TUI for browsing and managing AWS ECS resources.
...
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,469 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,378 | 🐛 85 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,920 | 🐛 7 | 🌐 Go | 📅 2026-09-07 - Domain Availability Research Tool.
...
* [beachpatrol](https://github.com/sebastiancarlos/beachpatrol) ⭐ 922 | 🐛 4 | 🌐 JavaScript | 📅 2025-10-30 - A CLI tool to replace and automate your everyday web browser.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,260 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,800 | 🐛 1,853 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,667 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,319 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,693 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-04 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,749 | 🐛 75 | 🌐 Python | 📅 2026-09-05 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,002 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
...
* [qman](https://github.com/plp13/qman) ⭐ 599 | 🐛 12 | 🌐 C | 📅 2026-09-06 - A more modern man page viewer for our terminals.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,788 | 🐛 246 | 🌐 Zig | 📅 2026-09-07 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,790 | 🐛 1,841 | 🌐 Rust | 📅 2026-09-06 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,302 | 🐛 1,900 | 🌐 Rust | 📅 2026-08-31 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,360 | 🐛 21 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,360 | 🐛 21 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,430 | 🐛 1,434 | 🌐 Rust | 📅 2026-09-06 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,375 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
* [Oils](https://github.com/oilshell/oil) ⭐ 3,389 | 🐛 611 | 🌐 Python | 📅 2026-05-31 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [Twin](https://github.com/cosmos72/twin) ⭐ 1,057 | 🐛 37 | 🌐 C | 📅 2026-08-03 - Text mode window environment. A "retro" program for embedded or remote systems, that doubles as X11 terminal and text-mode equivalent of VNC server.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 281 | 🐛 70 | 🌐 C | 📅 2026-09-06 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,047 | 🐛 150 | 🌐 Shell | 📅 2026-09-06 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,810 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,414 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,673 | 🐛 30 | 🌐 Shell | 📅 2026-09-01 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,811 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,545 | 🐛 84 | 🌐 C | 📅 2026-09-07 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,545 | 🐛 84 | 🌐 C | 📅 2026-09-07 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,910 | 🐛 449 | 🌐 C | 📅 2026-09-03 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,075 | 🐛 105 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,675 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [kmon](https://github.com/orhun/kmon) ⭐ 2,943 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux TUI Kernel manager and activity monitor.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,868 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,652 | 🐛 7 | 🌐 Rust | 📅 2026-08-14 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,131 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,076 | 🐛 32 | 🌐 Go | 📅 2026-09-07 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [chdig](https://github.com/azat/chdig) ⭐ 294 | 🐛 5 | 🌐 Rust | 📅 2026-09-06 - Dig into ClickHouse with TUI interface.
...
* [senzu](https://github.com/Hakky54/senzu) ⭐ 5 | 🐛 2 | 🌐 Java | 📅 2026-09-07 - CLI tool to get the battery percentage.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,495 | 🐛 212 | 🌐 Rust | 📅 2026-09-07 - Upgrade all the things.
...
* [stew](https://github.com/marwanhawari/stew) ⭐ 356 | 🐛 24 | 🌐 Go | 📅 2025-05-06 - An independent package manager for compiled binaries.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,535 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,753 | 🐛 299 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,838 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,126 | 🐛 69 | 🌐 Shell | 📅 2026-08-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,958 | 🐛 149 | 🌐 Go | 📅 2026-09-02 - Use any Linux distribution inside your terminal as docker or podman containers.
* [bocker](https://github.com/p8952/bocker) ⭐ 12,676 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in around 100 lines of bash.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,829 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,375 | 🐛 116 | 🌐 C | 📅 2026-09-06 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,320 | 🐛 19 | 🌐 Rust | 📅 2026-09-03 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,750 | 🐛 21 | 🌐 Go | 📅 2026-08-29 - TUI for running apps and processes.
...
* [dotbins](https://github.com/basnijholt/dotbins) ⭐ 272 | 🐛 28 | 🌐 Python | 📅 2026-09-02 - Keep updated binaries in your dotfiles.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,891 | 🐛 3 | 🌐 Rust | 📅 2026-09-06 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,200 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,200 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,319 | 🐛 218 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 889 | 🐛 3 | 🌐 Rust | 📅 2026-09-06 - Terminal mail client.
...
* [nmail](https://github.com/d99kris/nmail) ⭐ 255 | 🐛 1 | 🌐 C++ | 📅 2026-08-30 - nmail is a console-based email client for Linux and macOS with a user interface similar to alpine / pine.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,182 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,766 | 🐛 54 | 🌐 Go | 📅 2026-09-07 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,901 | 🐛 111 | 🌐 Java | 📅 2026-08-21 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,479 | 🐛 44 | 🌐 Python | 📅 2022-12-08 - CLI client for Slack.
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,133 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,006 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 978 | 🐛 5 | 🌐 Python | 📅 2026-09-06 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 69 | 🐛 4 | 🌐 Rust | 📅 2026-08-31 - TUI client for Nostr.
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,547 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Turn CLI tools into web applications; basically, it runs a command and starts a server so that the output can be displayed in a web page.
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,542 | 🐛 212 | 🌐 Python | 📅 2026-08-31 - Transparent proxy server that works as a poor man's VPN. Forwards over ssh. Doesn't require admin. Works with Linux and macOS. Supports DNS tunneling.
* [gping](https://github.com/orf/gping) ⭐ 12,670 | 🐛 38 | 🌐 Rust | 📅 2026-08-31 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,317 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,953 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,489 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,731 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,532 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,899 | 🐛 148 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,688 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,870 | 🐛 81 | 🌐 Rust | 📅 2026-09-07 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,657 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,102 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,082 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,110 | 🐛 49 | 🌐 C | 📅 2026-08-20 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,071 | 🐛 32 | 🌐 C | 📅 2026-09-03 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,997 | 🐛 19 | 🌐 Rust | 📅 2026-09-06 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,715 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,557 | 🐛 20 | 🌐 Rust | 📅 2026-09-06 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [ggh](https://github.com/byawitz/ggh) ⭐ 953 | 🐛 26 | 🌐 Go | 📅 2026-02-10 - Recall your SSH sessions, also searching your SSH config file.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,840 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,400 | 🐛 12 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [goto](https://github.com/grafviktor/goto) ⭐ 534 | 🐛 12 | 🌐 Go | 📅 2026-09-02 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
* [sshed](https://github.com/trntv/sshed) ⭐ 158 | 🐛 5 | 🌐 Go | 📅 2024-05-23 - sshed is a ssh config editor and bookmarks manager.
* [ssm](https://github.com/lfaoro/ssm) ⭐ 113 | 🐛 7 | 🌐 Go | 📅 2026-09-04 - SSH connection manager designed to connect, filter, tag, and much more from a simple terminal interface.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 189,485 | 🐛 2,633 | 🌐 Python | 📅 2026-08-30 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,143 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,938 | 🐛 1,176 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,259 | 🐛 1 | 🌐 Go | 📅 2026-09-06 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,671 | 🐛 544 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,911 | 🐛 182 | 🌐 Python | 📅 2026-09-06 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,436 | 🐛 1,152 | 🌐 Python | 📅 2026-09-04 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,060 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,039 | 🐛 183 | 🌐 Go | 📅 2026-08-31 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,665 | 🐛 124 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [qr-filetransfer](https://github.com/sdushantha/qr-filetransfer) ⭐ 1,030 | 🐛 5 | 🌐 Python | 📅 2024-04-10 - Transfer files over Wi-Fi between your computer and your smartphone from the terminal.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,856 | 🐛 397 | 🌐 C++ | 📅 2026-09-06 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,227 | 🐛 3 | 🌐 Python | 📅 2026-09-04 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,479 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
* [s](https://github.com/zquestz/s) ⭐ 2,598 | 🐛 0 | 🌐 Go | 📅 2026-07-27 - Web search from the terminal. Just opens in your browser.
* [Amfora](https://github.com/makew0rld/amfora) ⭐ 1,355 | 🐛 10 | 🌐 Go | 📅 2026-07-03 - Amfora aims to be the best looking Gemini client with the most features. It does not support Gopher or other non-Web protocols.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,949 | 🐛 169 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,541 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,831 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 810 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-09-07 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [taskbook](https://github.com/klaudiosinani/taskbook) ⭐ 9,340 | 🐛 102 | 🌐 JavaScript | 📅 2025-11-03 - Tasks, boards & notes for the command-line habitat.
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,945 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
...
* [topydo](https://github.com/topydo/topydo) ⭐ 934 | 🐛 81 | 🌐 Python | 📅 2026-08-31 - A powerful todo list application for the console, using the todo.txt format.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,653 | 🐛 126 | 🌐 C++ | 📅 2026-09-04 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,384 | 🐛 6 | 🌐 Shell | 📅 2026-08-18 - A feature-rich clock/ timer/ pattern-based time manager in terminal with curated text-art.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,397 | 🐛 151 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,310 | 🐛 151 | 🌐 Python | 📅 2026-09-04 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 778 | 🐛 15 | 🌐 Rust | 📅 2026-09-06 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [Captain's Log](https://github.com/NikolaDucak/caps-log) ⭐ 399 | 🐛 16 | 🌐 C++ | 📅 2026-08-14 - A small TUI journaling tool (daily entries saved as md files, tags for organizing entries, browse tags, calendar view, encrypted logs, storage using a git repository).
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,047 | 🐛 263 | 🌐 Python | 📅 2026-08-31 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,872 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,350 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
...
* [khard](https://github.com/lucc/khard) ⭐ 671 | 🐛 36 | 🌐 Python | 📅 2026-06-20 - vCard address book written in Python. Supports CardDAV.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,226 | 🐛 33 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,898 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 274 | 🐛 8 | 🌐 Rust | 📅 2026-09-03 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
* [cash-cli](https://github.com/xxczaki/cash-cli) ⭐ 266 | 🐛 16 | 🌐 JavaScript | 📅 2026-04-30 - Convert Currency Rates.
* [abandon](https://github.com/hrj/abandon) ⭐ 185 | 🐛 33 | 🌐 Scala | 📅 2026-09-07 - A text based, double-entry accounting system inspired by Ledger with infinite precision arithmetic. Made in Java. Includes a GUI.
...
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 92 | 🐛 3 | 🌐 Rust | 📅 2026-09-01 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,841 | 🐛 836 | 🌐 TypeScript | 📅 2026-09-07 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,858 | 🐛 70 | 🌐 Go | 📅 2026-09-03 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,075 | 🐛 105 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
* [h-m-m](https://github.com/nadrad/h-m-m) ⭐ 2,287 | 🐛 4 | 🌐 PHP | 📅 2026-07-06 - h-m-m (pronounced like the interjection "hmm") is a simple, fast, keyboard-centric terminal-based tool for working with mind maps.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,648 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,827 | 🐛 77 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,389 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [Lotus 1-2-3 for Linux](https://github.com/taviso/123elf) ⭐ 1,288 | 🐛 40 | 🌐 C | 📅 2026-06-27 - A native port of Lotus 1-2-3 Release 3 to Linux.
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-09-05 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,679 | 🐛 109 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [bcal](https://github.com/jarun/bcal) ⭐ 701 | 🐛 0 | 🌐 C | 📅 2026-09-05 - Byte CALculator - A REPL CLI utility for storage expression evaluation, SI/IEC conversion, byte address calculation, base conversion and LBA/CHS calculation.
* [Programmer calculator](https://github.com/alt-romes/programmer-calculator) ⭐ 590 | 🐛 5 | 🌐 C | 📅 2025-11-06 - Terminal calculator made for programmers working with multiple number representations, sizes, and overall close to the bits.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,771 | 🐛 456 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,517 | 🐛 112 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,499 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,343 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [halp](https://github.com/orhun/halp) ⭐ 766 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - halp aims to help find the correct arguments for command-line tools by checking the predefined list of commonly used options/flags.
...
* [docfd](https://github.com/darrenldl/docfd) ⭐ 288 | 🐛 3 | 🌐 OCaml | 📅 2026-09-06 - TUI fuzzy document finder that looks for documentation files in Markdown and txt format in the directory tree.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 132 | 🐛 1 | 🌐 Rust | 📅 2026-09-06 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-04 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,169 | 🐛 519 | 🌐 Go | 📅 2026-09-05 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,664 | 🐛 261 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,219 | 🐛 54 | 🌐 C | 📅 2026-09-06 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,313 | 🐛 29 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
* [GiF for CLI](https://github.com/google/gif-for-cli) ⚠️ Archived - Convert a GIF, short video or a query into ASCII art.
* [gowall](https://github.com/Achno/gowall) ⭐ 2,307 | 🐛 12 | 🌐 Go | 📅 2026-06-10 - A tool to convert a Wallpaper's color scheme / palette, image to pixel art, color palette extraction, image upsacling with Adversarial Networks  and more image processing features.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,809 | 🐛 4 | 🌐 Python | 📅 2026-09-05 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 997 | 🐛 18 | 🌐 Python | 📅 2026-09-07 - AI-Powered Command-Line Photo Search Tool.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 416 | 🐛 8 | 🌐 Rust | 📅 2026-09-05 - A powerful Rust image optimization CLI tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,737 | 🐛 72 | 🌐 Python | 📅 2026-09-06 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,485 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,650 | 🐛 11 | 🌐 Shell | 📅 2026-08-30 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 600 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,343 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,628 | 🐛 712 | 🌐 Python | 📅 2026-09-06 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,186 | 🐛 170 | 🌐 Rust | 📅 2026-09-07 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,767 | 🐛 210 | 🌐 Rust | 📅 2026-08-31 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [ytui-music](https://github.com/sudipghimire533/ytui-music) ⭐ 772 | 🐛 37 | 🌐 Rust | 📅 2025-03-03 - YouTube client in terminal for music (lightweight YouTube client).
* [castero](https://github.com/xgi/castero) ⭐ 684 | 🐛 33 | 🌐 Python | 📅 2026-04-21 - A TUI podcast client for the terminal.
* [radio-active](https://github.com/deep5050/radio-active) ⭐ 597 | 🐛 16 | 🌐 Python | 📅 2026-06-30 - Internet radio player with 40k+ stations.
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 586 | 🐛 27 | 🌐 Rust | 📅 2026-09-06 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,834 | 🐛 178 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,025 | 🐛 3 | 🌐 C | 📅 2026-09-07 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,025 | 🐛 3 | 🌐 C | 📅 2026-09-07 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,195 | 🐛 51 | 🌐 Rust | 📅 2026-09-07 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,235 | 🐛 7 | 🌐 Python | 📅 2026-09-07 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,383 | 🐛 447 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,747 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,017 | 🐛 28 | 🌐 Go | 📅 2026-09-05 - Feature-rich terminal-based text viewer.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,401 | 🐛 8 | 🌐 Rust | 📅 2026-09-05 - Terminal image, video, directory, and Markdown viewer.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,962 | 🐛 14 | 🌐 Rust | 📅 2026-09-07 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,828 | 🐛 173 | 🌐 Go | 📅 2026-09-01 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,773 | 🐛 10 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,718 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,042 | 🐛 443 | 🌐 Go | 📅 2026-09-02 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [jdvrif](https://github.com/CleasbyCode/jdvrif) ⭐ 72 | 🐛 0 | 📅 2026-09-06 - CLI tool to embed or extract files via a JPG image. Post and share your embedded JPG image on compatible sites.
...
* [vet](https://github.com/safedep/vet) ⭐ 1,103 | 🐛 95 | 🌐 Go | 📅 2026-09-03 - Tool for identifying risks in open source software supply chain.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,290 | 🐛 598 | 🌐 Python | 📅 2026-09-06 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,689 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [flog](https://github.com/mingrammer/flog) ⭐ 1,331 | 🐛 32 | 🌐 Go | 📅 2025-06-05 - A fake log generator for log formats such as apache-common, apache error and RFC3164 syslog.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 516 | 🐛 13 | 🌐 Go | 📅 2026-09-07 - Cross Platform tool to validate configuration files.
...
* [gtime](https://github.com/savitojs/gtime) ⭐ 11 | 🐛 2 | 🌐 Python | 📅 2026-08-26 - Python CLI utility for global time zone lookup, comparison, and management; The program supports fuzzy search, favorites, city comparison, meeting time conversion, and a live/watch mode.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,286 | 🐛 12 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [tinytetris](https://github.com/taylorconor/tinytetris) ⭐ 3,294 | 🐛 29 | 🌐 C++ | 📅 2024-07-09 - 80x23 terminal tetris game.
* [Pokete](https://github.com/lxgr-linux/pokete) ⭐ 3,153 | 🐛 30 | 🌐 Python | 📅 2026-05-22 - A terminal based Pokemon like game.
* [SSHTron](https://github.com/zachlatta/sshtron) ⭐ 2,495 | 🐛 12 | 🌐 Go | 📅 2023-07-17 - Multiplayer lightcycle game that runs through SSH.
...
* [DOOM-ASCII](https://github.com/wojciech-graj/doom-ascii) ⭐ 879 | 🐛 0 | 🌐 C | 📅 2025-07-21 - Text-based DOOM running in terminal without sound.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,253 | 🐛 19 | 🌐 Rust | 📅 2026-08-17 - Turn your keyboard into a typewriter adding sounds at each keystroke.
* [boxes](https://github.com/ascii-boxes/boxes) ⭐ 687 | 🐛 0 | 🌐 C | 📅 2026-08-30 - Boxes is a command line filter program which draws ASCII art boxes around your input text.
...
* [kyun](https://github.com/file-acomplaint/kyun) ⭐ 276 | 🐛 0 | 🌐 Rust | 📅 2025-04-06 - Kyun is a low productivity, low fidelity, low customizablity text editor that has its focus firm on user discomfort.
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 253 | 🐛 37 | 🌐 Python | 📅 2026-09-07 - Track conferences and meetups.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,280 | 🐛 257 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,572 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,342 | 🐛 1 | 🌐 Shell | 📅 2026-09-05 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,502 | 🐛 104 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
