...
* [eza](https://github.com/eza-community/eza) ⭐ 23,292 | 🐛 451 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,224 | 🐛 208 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
* [colorls](https://github.com/athityakumar/colorls) ⭐ 5,138 | 🐛 87 | 🌐 Ruby | 📅 2026-07-27 - A Ruby script that colorizes the `ls` output with color and icons.
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,265 | 🐛 31 | 🌐 Rust | 📅 2026-09-14 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,520 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,049 | 🐛 109 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
* [autojump](https://github.com/wting/autojump) ⭐ 16,958 | 🐛 232 | 🌐 Python | 📅 2025-02-27 - A cd command that maintains a database of most visited paths and allows the access to a directory with shortened versions of the path.
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,147 | 🐛 75 | 🌐 Lua | 📅 2026-08-10 - Directory changer that learns your habits.
* [enhancd](https://github.com/babarot/enhancd) ⭐ 2,719 | 🐛 17 | 🌐 Shell | 📅 2025-01-24 - A next-generation cd command with your interactive filter.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,546 | 🐛 200 | 🌐 Rust | 📅 2026-09-16 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,269 | 🐛 13 | 🌐 C | 📅 2026-09-14 - A breadth-first version of the UNIX find command.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,788 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,795 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Intelligent context-aware search engine for your shell history with TUI.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,461 | 🐛 186 | 🌐 C | 📅 2026-09-16 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [atuin](https://github.com/ellie/atuin) ⭐ 37 | 🐛 0 | 📅 2026-02-10 - Atuin replaces your existing shell history with a SQLite database, and records additional context for your commands. Additionally, it provides optional and fully encrypted synchronization of your history between machines, via an Atuin server.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,210 | 🐛 441 | 🌐 Rust | 📅 2026-09-15 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,907 | 🐛 291 | 🌐 Rust | 📅 2026-09-14 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,088 | 🐛 5 | 🌐 Perl | 📅 2026-09-14 - Make your diffs human-readable instead of machine-readable.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,337 | 🐛 199 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,932 | 🐛 54 | 🌐 Rust | 📅 2026-09-16 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,845 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,294 | 🐛 7 | 🌐 C++ | 📅 2026-09-15 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,353 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,295 | 🐛 20 | 🌐 Rust | 📅 2026-09-12 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 533 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,268 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,265 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,979 | 🐛 54 | 🌐 Go | 📅 2026-09-16 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,130 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
* [erdtree](https://github.com/solidiquis/erdtree) ⭐ 2,601 | 🐛 36 | 🌐 Rust | 📅 2024-05-19 - A multithreaded file-tree visualizer and disk usage analyzer.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,608 | 🐛 539 | 🌐 C++ | 📅 2026-09-16 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,113 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,929 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,025 | 🐛 103 | 🌐 Rust | 📅 2026-09-17 - Yet another cross-platform graphical process/system monitor.
* [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,113 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes.
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,007 | 🐛 141 | 🌐 C | 📅 2026-09-16 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
* [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,929 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/macOS/FreeBSD resource monitor with a nice interface.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,153 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,173 | 🐛 36 | 🌐 Rust | 📅 2026-09-16 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,092 | 🐛 39 | 🌐 Python | 📅 2026-09-15 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
* [gputop](https://github.com/wookayin/gpustat) ⭐ 4,394 | 🐛 30 | 🌐 Python | 📅 2026-09-15 - A simple command-line utility for querying and monitoring GPU status.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,518 | 🐛 32 | 🌐 Rust | 📅 2026-09-15 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,706 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,421 | 🐛 117 | 🌐 C | 📅 2026-09-14 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,238 | 🐛 64 | 🌐 Rust | 📅 2026-09-16 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,263 | 🐛 269 | 🌐 Go | 📅 2026-09-16 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,883 | 🐛 1 | 🌐 C | 📅 2026-09-16 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,513 | 🐛 84 | 🌐 Go | 📅 2026-09-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,728 | 🐛 102 | 🌐 Rust | 📅 2026-08-20 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,638 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,215 | 🐛 476 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,725 | 🐛 27 | 🌐 C | 📅 2026-09-15 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [projectable](https://github.com/dzfrias/projectable) ⭐ 462 | 🐛 11 | 🌐 Rust | 📅 2025-05-28 - A TUI file manager built for projects.
...
* [sfm](https://github.com/afify/sfm) ⭐ 260 | 🐛 6 | 🌐 C | 📅 2025-11-14 - Simple file manager for unix-like systems with kernel event notifications, monitoring filesystem events, dual pane and more.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 11 | 🌐 Rust | 📅 2026-09-16 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [browsr](https://github.com/juftin/browsr) ⭐ 648 | 🐛 13 | 🌐 Python | 📅 2026-04-22 - A pleasant file explorer that can browse the contents of local and remote filesystems with your keyboard or mouse; remotes include GitHub, over SSH, in AWS S3, Google Cloud Storage, or Azure Blob Storage.
...
* [progress](https://github.com/Xfennec/progress) ⭐ 8,857 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Monitor the progress of common Coreutils command-line tools (`cp`, `mv`, `dd`, `tar`, `rsync`, etc.); it uses a ncurses interface to display the percentage of data copied; it works by reading from system files and retrieving the necessary information for the estimation.
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,757 | 🐛 93 | 🌐 Rust | 📅 2026-09-14 - Painless compression and decompression in the terminal.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,754 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,549 | 🐛 60 | 🌐 C | 📅 2026-09-02 - Rotate, compress and mail logs.
...
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,188 | 🐛 35 | 🌐 Rust | 📅 2026-09-15 - Executes commands in response to file modifications.
* [Viddy](https://github.com/sachaos/viddy) ⭐ 5,419 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - Modern watch command. Time machine and pager etc.
* [reflex](https://github.com/cespare/reflex) ⭐ 3,550 | 🐛 29 | 🌐 Go | 📅 2026-02-26 - Reflex is a small tool to watch a directory and rerun a command when certain files change.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,448 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,667 | 🐛 61 | 🌐 C | 📅 2026-09-16 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 184,903 | 🐛 678 | 🌐 Python | 📅 2026-09-16 - Python tool for converting files and office documents to Markdown.
* [unoserver](https://github.com/unoconv/unoserver) ⭐ 934 | 🐛 11 | 🌐 Python | 📅 2026-06-10 - Using LibreOffice as a server for converting documents, it allows converting multiple documents without loading libreoffice into memory every time.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-16 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,491 | 🐛 537 | 🌐 Rust | 📅 2026-09-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [toolong](https://github.com/Textualize/toolong) ⭐ 3,948 | 🐛 37 | 🌐 Python | 📅 2024-08-05 - A terminal application to view, tail, merge, and search log files (plus JSONL).
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,722 | 🐛 47 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,375 | 🐛 377 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,350 | 🐛 5 | 🌐 Perl | 📅 2026-09-02 - Command line tool for URL parsing and manipulation.
* [yek](https://github.com/bodo-run/yek) ⭐ 2,476 | 🐛 12 | 🌐 Rust | 📅 2026-06-29 - A fast Rust based tool to serialize text-based files in a repository or directory for LLM consumption.
...
* [awk](https://github.com/onetrueawk/awk) ⭐ 2,227 | 🐛 15 | 🌐 C | 📅 2026-08-19 - A historical, general-purpose text file processor, implements a domain-specific language designed for text processing and typically used as a data extraction and reporting tool.
...
* [gtree](https://github.com/ddddddO/gtree) ⭐ 362 | 🐛 37 | 🌐 Go | 📅 2026-09-12 - Using either Markdown or programmatically to generate directory trees and directories, and to verify directories.
...
* [logu](https://github.com/ynqa/logu) ⭐ 124 | 🐛 0 | 🌐 Rust | 📅 2025-07-11 - Extract patterns from (streaming) unstructured log messages.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,039 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,629 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,969 | 🐛 299 | 🌐 Go | 📅 2026-09-17 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,518 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,678 | 🐛 44 | 🌐 Python | 📅 2026-09-17 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,170 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,112 | 🐛 32 | 🌐 Rust | 📅 2026-09-17 - Interactive JSON filter using jq.
* [jo](https://github.com/jpmens/jo) ⭐ 4,867 | 🐛 7 | 🌐 C | 📅 2025-06-20 - A small utility to create JSON objects from the command line.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 19 | 🌐 Go | 📅 2026-09-14 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,758 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,840 | 🐛 24 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,486 | 🐛 20 | 🌐 Python | 📅 2026-09-16 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [jtbl](https://github.com/kellyjonbrazil/jtbl) ⭐ 344 | 🐛 2 | 🌐 Python | 📅 2024-04-02 - A simple CLI tool to print JSON and JSON Lines data as a table in the terminal.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,451 | 🐛 578 | 🌐 Go | 📅 2026-09-17 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,389 | 🐛 42 | 🌐 Python | 📅 2026-09-16 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,975 | 🐛 0 | 🌐 Python | 📅 2026-09-16 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,116 | 🐛 121 | 🌐 Go | 📅 2026-09-13 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
...
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,410 | 🐛 44 | 🌐 Python | 📅 2026-08-03 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,399 | 🐛 34 | 🌐 Python | 📅 2026-09-17 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,334 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,306 | 🐛 40 | 🌐 Go | 📅 2026-09-14 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,967 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,786 | 🐛 31 | 🌐 Rust | 📅 2026-09-16 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,786 | 🐛 31 | 🌐 Rust | 📅 2026-09-16 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,319 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - A cross-platform TUI database management tool written in Rust.
...
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,106 | 🐛 17 | 🌐 Rust | 📅 2026-09-15 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,567 | 🐛 71 | 🌐 Go | 📅 2026-09-16 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,196 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,034 | 🐛 328 | 🌐 Go | 📅 2026-09-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,959 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,276 | 🐛 79 | 🌐 Rust | 📅 2026-09-11 - Blazing fast general purpose fuzzy finder TUI.
...
* [Fnf](https://github.com/leo-arch/fnf) ⭐ 53 | 🐛 3 | 🌐 C | 📅 2026-04-04 - An interactive fuzzy finder for the terminal; As you type a query, fnf  filters candidates and instantly updates the sorted list.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,346 | 🐛 233 | 🌐 Go | 📅 2026-09-14 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,148 | 🐛 656 | 🌐 Rust | 📅 2026-09-15 - Create book from Markdown files.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,289 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 820 | 🐛 65 | 🌐 Python | 📅 2026-08-31 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,600 | 🐛 934 | 🌐 Go | 📅 2026-09-17 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,572 | 🐛 171 | 🌐 Rust | 📅 2026-09-16 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [ox](https://github.com/curlpipe/ox) ⭐ 3,742 | 🐛 33 | 🌐 Rust | 📅 2026-04-23 - An independent Rust text editor.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 703 | 🐛 0 | 🌐 Go | 📅 2026-09-16 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,407 | 🐛 1,031 | 🌐 Go | 📅 2026-09-16 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,348 | 🐛 481 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,498 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,106 | 🐛 100 | 🌐 Shell | 📅 2026-09-01 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,339 | 🐛 234 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,519 | 🐛 101 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,240 | 🐛 116 | 🌐 Rust | 📅 2026-09-13 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [BFG Repo-Cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,187 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,048 | 🐛 65 | 🌐 Rust | 📅 2026-09-16 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,034 | 🐛 155 | 🌐 Go | 📅 2026-09-16 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,220 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,076 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,044 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,318 | 🐛 13 | 🌐 Rust | 📅 2026-09-08 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
* [git-fuzzy](https://github.com/bigH/git-fuzzy) ⭐ 2,433 | 🐛 2 | 🌐 Shell | 📅 2026-06-19 - Interactive `git` with the help of `fzf`.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,940 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [gh-f](https://github.com/gennaro-tedesco/gh-f) ⭐ 394 | 🐛 0 | 🌐 Shell | 📅 2025-09-23 - The ultimate, compact and snappy fzf extension for gh CLI.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,623 | 🐛 1,253 | 🌐 Rust | 📅 2026-09-17 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,143 | 🐛 17 | 🌐 Rust | 📅 2026-09-16 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,384 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-13 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,140 | 🐛 750 | 🌐 Go | 📅 2026-09-17 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,042 | 🐛 406 | 🌐 JavaScript | 📅 2026-09-16 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,985 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,538 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,914 | 🐛 243 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,361 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,251 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,845 | 🐛 18 | 🌐 Python | 📅 2026-09-12 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,056 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-14 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,756 | 🐛 26 | 🌐 Go | 📅 2026-09-15 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,188 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
* [np](https://github.com/sindresorhus/np) ⭐ 7,713 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-09 - A better `npm publish`.
* [blinkenlights](https://github.com/jart/blink) ⭐ 7,587 | 🐛 55 | 🌐 C | 📅 2025-12-10 - TUI that may be used for debugging x86\_64-linux or i8086 programs across platforms.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,432 | 🐛 38 | 🌐 Rust | 📅 2026-09-13 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,126 | 🐛 434 | 🌐 Rust | 📅 2026-09-16 - Developer environments you can take with you.
...
* [stepci](https://github.com/stepci/stepci) ⭐ 1,869 | 🐛 73 | 🌐 TypeScript | 📅 2024-08-03 - Automated API Testing and Quality Assurance.
* [cgdb](https://github.com/cgdb/cgdb) ⭐ 1,844 | 🐛 46 | 🌐 C | 📅 2026-02-27 - Console front-end to the GNU debugger.
* [argbash](https://github.com/matejak/argbash) ⭐ 1,485 | 🐛 44 | 🌐 M4 | 📅 2025-07-17 - Bash argument parsing code generator.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 901 | 🐛 161 | 🌐 Rust | 📅 2026-09-17 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 602 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Update binaries installed by "go install" with goroutines.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 140 | 🐛 13 | 🌐 Python | 📅 2026-09-17 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,089 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
* [readme-md-generator](https://github.com/kefranabg/readme-md-generator) ⭐ 11,134 | 🐛 30 | 🌐 JavaScript | 📅 2022-09-20 - CLI that generates beautiful README.md files.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,605 | 🐛 76 | 🌐 Go | 📅 2026-09-15 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,361 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,863 | 🐛 39 | 🌐 Go | 📅 2026-09-14 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,536 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,640 | 🐛 24 | 🌐 Go | 📅 2026-09-14 - Tool for visualizing dynamic node usage within a kubernetes cluster.
...
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,228 | 🐛 9 | 🌐 Go | 📅 2026-09-11 - TUI for Podman environment.
* [ktop](https://github.com/vladimirvivien/ktop) ⭐ 1,109 | 🐛 11 | 🌐 Go | 📅 2026-07-03 - Tool that displays useful metrics information about nodes, pods, and other workload.
...
* [Ducker](https://github.com/robertpsoane/ducker) ⭐ 930 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - TUI for managing docker containers.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,520 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,485 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,424 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,906 | 🐛 311 | 🌐 Python | 📅 2025-10-22 - Command line tool for managing Amazon S3 and CloudFront services.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,921 | 🐛 7 | 🌐 Go | 📅 2026-09-14 - Domain Availability Research Tool.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,229 | 🐛 9 | 🌐 Rust | 📅 2026-09-02 - TUI-based HTTP/REST client.
...
* [domain-check](https://github.com/saidutt46/domain-check) ⭐ 309 | 🐛 4 | 🌐 Rust | 📅 2026-05-14 - Universal domain exploration engine: fast domain availability checks across the internet.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,351 | 🐛 1 | 🌐 Rust | 📅 2026-09-15 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,009 | 🐛 1,873 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,828 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,324 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,700 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,762 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,006 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
* [Ntfy](https://github.com/dschep/ntfy) ⭐ 4,981 | 🐛 103 | 🌐 Python | 📅 2025-10-27 - Cross-platform Python utility that enables you to automatically get desktop notifications on demand or when long-running commands complete. It can as well send push notifications to your phone once a particular command completes.
...
* [killport](https://github.com/jkfran/killport) ⭐ 1,841 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A command-line tool to easily kill processes running on a specified port.
...
* [brightnessctl](https://github.com/Hummer12007/brightnessctl) ⭐ 1,269 | 🐛 24 | 🌐 C | 📅 2024-12-16 - Read and control device brightness. Devices, by default, include backlight and LEDs - searched for in corresponding classes.
* [tufw](https://github.com/peltho/tufw) ⭐ 864 | 🐛 4 | 🌐 Go | 📅 2026-06-08 - Terminal UI for the UFW Linux firewall.
* [immortal](https://github.com/immortal/immortal) ⭐ 840 | 🐛 2 | 🌐 Go | 📅 2026-08-16 - A \*nix cross-platform (OS agnostic) supervisor.
* [has](https://github.com/kdabir/has) ⭐ 822 | 🐛 14 | 🌐 Shell | 📅 2026-09-11 - Checks presence of various command line tools on the PATH and reports their installed version.
* [qman](https://github.com/plp13/qman) ⭐ 602 | 🐛 14 | 🌐 C | 📅 2026-09-06 - A more modern man page viewer for our terminals.
...
* [rs-env](https://github.com/sysid/rs-env) ⭐ 42 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - Hierarchical environment variable management, compiling the resulting set of from a hierarchical list of `<name>.env` files.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,201 | 🐛 250 | 🌐 Zig | 📅 2026-09-16 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,922 | 🐛 1,851 | 🌐 Rust | 📅 2026-09-15 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,617 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,463 | 🐛 23 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,434 | 🐛 1,924 | 🌐 Rust | 📅 2026-09-14 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,363 | 🐛 21 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,363 | 🐛 21 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,520 | 🐛 1,437 | 🌐 Rust | 📅 2026-09-16 - A modern shell written in Rust, where all data is structured.
...
* [Oils](https://github.com/oilshell/oil) ⭐ 3,391 | 🐛 610 | 🌐 Python | 📅 2026-09-17 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 282 | 🐛 62 | 🌐 C | 📅 2026-09-17 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-16 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,113 | 🐛 150 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,815 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,418 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,677 | 🐛 29 | 🌐 Shell | 📅 2026-09-13 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
...
* [extrakto](https://github.com/laktak/extrakto) ⭐ 1,142 | 🐛 1 | 🌐 Python | 📅 2026-03-02 - extrakto for tmux - quickly select, copy/insert/complete text without a mouse.
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,043 | 🐛 46 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,662 | 🐛 92 | 🌐 C | 📅 2026-09-16 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,662 | 🐛 92 | 🌐 C | 📅 2026-09-16 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,929 | 🐛 449 | 🌐 C | 📅 2026-09-16 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,707 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
* [noti](https://github.com/variadico/noti) ⚠️ Archived - Monitor a process and trigger a notification.
* [screenFetch](https://github.com/KittyKatt/screenFetch) ⭐ 4,076 | 🐛 170 | 🌐 Shell | 📅 2026-03-02 - It can be used to generate one of those nifty terminal theme information + ASCII distribution logos. It auto-detects the distribution and display an ASCII version of that distribution's logo and some valuable information to the right.
* [kmon](https://github.com/orhun/kmon) ⭐ 2,944 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux TUI Kernel manager and activity monitor.
* [CoreFreq](https://github.com/cyring/CoreFreq) ⭐ 2,242 | 🐛 1 | 🌐 C | 📅 2026-08-16 - CPU monitoring TUI software designed for the 64-bits Processors.
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,103 | 🐛 12 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,886 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,660 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
* [Grafterm](https://github.com/slok/grafterm) ⭐ 1,141 | 🐛 11 | 🌐 Go | 📅 2022-06-10 - Metrics TUI dashboards on terminal, a Grafana inspired terminal version.
* [updo](https://github.com/Owloops/updo) ⭐ 1,132 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,084 | 🐛 28 | 🌐 Go | 📅 2026-09-14 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [chdig](https://github.com/azat/chdig) ⭐ 294 | 🐛 4 | 🌐 Rust | 📅 2026-09-15 - Dig into ClickHouse with TUI interface.
...
* [nitchplusplus](https://github.com/clamsfeel2/nitchplusplus) ⭐ 13 | 🐛 0 | 🌐 C++ | 📅 2026-09-16 - A fast system information fetch tool.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,543 | 🐛 208 | 🌐 Rust | 📅 2026-09-16 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,074 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,290 | 🐛 87 | 🌐 Go | 📅 2026-09-17 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,569 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,846 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,837 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,185 | 🐛 73 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,983 | 🐛 153 | 🌐 Go | 📅 2026-09-14 - Use any Linux distribution inside your terminal as docker or podman containers.
* [bocker](https://github.com/p8952/bocker) ⭐ 12,679 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in around 100 lines of bash.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,276 | 🐛 27 | 🌐 Go | 📅 2026-09-04 - A Docker manager for the terminal.
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,078 | 🐛 64 | 🌐 Go | 📅 2026-08-21 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,840 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 606 | 🐛 16 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,396 | 🐛 116 | 🌐 C | 📅 2026-09-06 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,335 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,682 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,776 | 🐛 26 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,723 | 🐛 67 | 🌐 Rust | 📅 2026-09-13 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [sunbeam](https://github.com/pomdtr/sunbeam) ⭐ 555 | 🐛 10 | 🌐 Go | 📅 2025-05-30 - General purpose command-line launcher that defines UIs composed of a succession of views from simple scripts written in any language; a mix between an application launcher like `raycast` or `rofi` and a fuzzy-finder like `fzf` or `telescope`.
...
* [dotbins](https://github.com/basnijholt/dotbins) ⭐ 271 | 🐛 27 | 🌐 Python | 📅 2026-09-10 - Keep updated binaries in your dotfiles.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,895 | 🐛 3 | 🌐 Rust | 📅 2026-09-16 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,258 | 🐛 17 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,258 | 🐛 17 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,335 | 🐛 221 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 890 | 🐛 3 | 🌐 Rust | 📅 2026-09-16 - Terminal mail client.
...
* [mailsy](https://github.com/BalliAsghar/Mailsy.git) ⭐ 599 | 🐛 1 | 🌐 JavaScript | 📅 2024-12-03 - Generates disposable emails in the CLI through [mail.tm](https://mail.tm).
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,198 | 🐛 1,186 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
* [slack-term](https://github.com/erroneousboat/slack-term) ⭐ 6,613 | 🐛 68 | 🌐 Go | 📅 2024-04-23 - Slack client for the  terminal.
* [ssh-chat](https://github.com/shazow/ssh-chat) ⭐ 5,911 | 🐛 54 | 🌐 Go | 📅 2026-01-10 - Custom SSH server written in Go. Instead of a shell, you get a chat prompt.
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,775 | 🐛 54 | 🌐 Go | 📅 2026-09-12 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,912 | 🐛 108 | 🌐 Java | 📅 2026-09-14 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
* [devzat](https://github.com/quackduck/devzat) ⭐ 4,066 | 🐛 25 | 🌐 Go | 📅 2026-07-23 - Custom SSH server that takes you to a chat instead of a shell prompt.
* [Sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,478 | 🐛 44 | 🌐 Python | 📅 2022-12-08 - CLI client for Slack.
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,142 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,955 | 🐛 16 | 🌐 C++ | 📅 2026-09-12 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,722 | 🐛 78 | 🌐 Go | 📅 2026-09-16 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,377 | 🐛 98 | 🌐 Rust | 📅 2026-09-15 - Signal Messenger client for terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,323 | 🐛 128 | 🌐 Python | 📅 2026-09-12 - Mastodon CLI & TUI.
* [toxic](https://github.com/Jfreegman/toxic) ⭐ 1,304 | 🐛 20 | 🌐 C | 📅 2026-07-14 - A Tox-based instant messaging and video chat client.
* [tiny](https://github.com/osa1/tiny) ⭐ 1,181 | 🐛 94 | 🌐 Rust | 📅 2026-03-19 - tiny is an IRC client written in Rust.
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,152 | 🐛 22 | 🌐 Haskell | 📅 2026-08-25 - A terminal client for the Mattermost chat system.
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,013 | 🐛 15 | 🌐 Rust | 📅 2026-09-15 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 992 | 🐛 3 | 🌐 Python | 📅 2026-09-16 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 865 | 🐛 475 | 🌐 Python | 📅 2026-08-16 - Official Zulip terminal client with TUI.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 757 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 71 | 🐛 30 | 🌐 Rust | 📅 2026-09-15 - TUI client for Nostr.
...
* [gping](https://github.com/orf/gping) ⭐ 12,682 | 🐛 40 | 🌐 Rust | 📅 2026-09-10 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,382 | 🐛 116 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,973 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,499 | 🐛 15 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,732 | 🐛 41 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,548 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,901 | 🐛 151 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,691 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,932 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,664 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,110 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,092 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,113 | 🐛 49 | 🌐 C | 📅 2026-08-20 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,067 | 🐛 32 | 🌐 C | 📅 2026-09-16 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,030 | 🐛 34 | 🌐 Rust | 📅 2026-09-14 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,729 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
* [tproxy](https://github.com/kevwan/tproxy) ⭐ 3,705 | 🐛 6 | 🌐 Go | 📅 2026-07-09 - A CLI tool to proxy and analyze TCP connections.
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,341 | 🐛 140 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,717 | 🐛 35 | 🌐 Go | 📅 2026-09-12 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,579 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - TUI for sniffing network traffic using eBPF on Linux.
* [asn](https://github.com/nitefood/asn) ⭐ 1,936 | 🐛 3 | 🌐 Shell | 📅 2026-09-16 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
* [gg](https://github.com/mzz2017/gg) ⭐ 1,933 | 🐛 48 | 🌐 Go | 📅 2026-07-06 - A command-line tool for one-click proxy in your research and development without installing v2ray or anything else.
* [Tunnelmole](https://github.com/robbie-cahill/tunnelmole-client) ⭐ 1,890 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-13 - Connect to local servers from anywhere.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,850 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,604 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,562 | 🐛 2 | 🌐 Rust | 📅 2026-09-17 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,389 | 🐛 38 | 🌐 C | 📅 2026-09-15 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,240 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,204 | 🐛 73 | 🌐 C | 📅 2026-09-15 - Ncurses SIP Messages flow viewer.
...
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 728 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,008 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,853 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 191,668 | 🐛 2,656 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,254 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,414 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,354 | 🐛 7 | 🌐 Go | 📅 2026-09-14 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,685 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,933 | 🐛 182 | 🌐 Python | 📅 2026-09-14 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,713 | 🐛 1,132 | 🌐 Python | 📅 2026-09-12 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,080 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,068 | 🐛 193 | 🌐 Go | 📅 2026-09-14 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,680 | 🐛 125 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,725 | 🐛 26 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,534 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,083 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [Yark](https://github.com/Owez/yark) ⭐ 2,187 | 🐛 21 | 🌐 Python | 📅 2026-07-30 - YouTube archiving made simple.
...
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,768 | 🐛 29 | 🌐 Go | 📅 2024-08-20 - A quick and easy command-line file transfer utility from any computer to another.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,863 | 🐛 387 | 🌐 C++ | 📅 2026-09-16 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,233 | 🐛 10 | 🌐 Python | 📅 2026-09-14 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,496 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,974 | 🐛 172 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,554 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,840 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,949 | 🐛 27 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,127 | 🐛 132 | 🌐 Rust | 📅 2026-09-13 - A terminal user interface for taskwarrior.
...
* [topydo](https://github.com/topydo/topydo) ⭐ 939 | 🐛 77 | 🌐 Python | 📅 2026-09-16 - A powerful todo list application for the console, using the todo.txt format.
...
* [Todoman](https://github.com/pimutils/todoman) ⭐ 594 | 🐛 113 | 🌐 Python | 📅 2026-05-25 - A simple, standards-based, CLI todo (aka: task) manager.
...
* [Togo](https://github.com/prime-run/togo) ⭐ 188 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - A fast and simple terminal-based task and todo manager built in go.
* [todocli](https://github.com/HxX2/todocli) ⭐ 157 | 🐛 3 | 🌐 Go | 📅 2025-04-18 - Todo CLI to manage your to do list in a neat way.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,659 | 🐛 126 | 🌐 C++ | 📅 2026-09-09 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,385 | 🐛 6 | 🌐 Shell | 📅 2026-08-18 - A feature-rich clock/ timer/ pattern-based time manager in terminal with curated text-art.
* [doing](https://github.com/ttscoff/doing) ⭐ 1,292 | 🐛 2 | 🌐 Ruby | 📅 2026-07-27 - A command line tool for remembering what you were doing and tracking what you've done.
* [Bartib](https://github.com/nikolassv/bartib) ⭐ 848 | 🐛 19 | 🌐 Rust | 📅 2026-03-25 - Easy to use time tracking tool for the command line. It saves a log of all tracked activities as a plain-text file and allows you to create flexible reports.
...
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - Simple timer for the terminal with timer-mode and alarm.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,407 | 🐛 153 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,319 | 🐛 152 | 🌐 Python | 📅 2026-09-16 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,411 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,079 | 🐛 41 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,800 | 🐛 24 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 878 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 783 | 🐛 13 | 🌐 Rust | 📅 2026-09-06 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 536 | 🐛 2 | 🌐 Rust | 📅 2026-08-25 - Terminal-based markdown note manager.
...
* [Captain's Log](https://github.com/NikolaDucak/caps-log) ⭐ 402 | 🐛 16 | 🌐 C++ | 📅 2026-08-14 - A small TUI journaling tool (daily entries saved as md files, tags for organizing entries, browse tags, calendar view, encrypted logs, storage using a git repository).
...
* [buku](https://github.com/jarun/buku) ⭐ 7,199 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - A powerful bookmark manager written in Python3 and SQLite3.
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,764 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,050 | 🐛 264 | 🌐 Python | 📅 2026-09-14 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,876 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,358 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,876 | 🐛 225 | 🌐 Python | 📅 2026-09-04 - CalDAV synchronization program.
...
* [khard](https://github.com/lucc/khard) ⭐ 670 | 🐛 35 | 🌐 Python | 📅 2026-09-07 - vCard address book written in Python. Supports CardDAV.
...
* [plann](https://github.com/tobixen/plann) ⭐ 82 | 🐛 19 | 🌐 Python | 📅 2026-09-16 - Command-line interface to online calendars.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,233 | 🐛 34 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,906 | 🐛 17 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
* [mop](https://github.com/mop-tracker/mop) ⭐ 2,211 | 🐛 6 | 🌐 Go | 📅 2025-12-28 - Stock market tracker for hackers.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 329 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 95 | 🐛 5 | 🌐 Rust | 📅 2026-09-14 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,023 | 🐛 846 | 🌐 TypeScript | 📅 2026-09-17 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,942 | 🐛 71 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,449 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [tenere](https://github.com/pythops/tenere) ⭐ 684 | 🐛 11 | 🌐 Rust | 📅 2026-05-10 - A TUI for LLMs (ChatGPT, llama\_cpp, ollama) written in Rust.
...
* [ata](https://github.com/transformrs/ata) ⭐ 287 | 🐛 9 | 🌐 Rust | 📅 2025-04-01 - Ask the Terminal Anything: OpenAI GPT in the terminal.
...
* [cai](https://github.com/ad-si/cai) ⭐ 202 | 🐛 6 | 🌐 Rust | 📅 2026-09-16 - The fastest CLI tool for prompting LLMs. Including support for prompting several LLMs at once!
* [clevercli](https://github.com/clevercli/clevercli) ⚠️ Archived - ChatGPT powered CLI utilities. Easily add new prompt types.
* [hns](https://github.com/primaprashant/hns) ⭐ 117 | 🐛 4 | 🌐 Python | 📅 2026-09-16 - A privacy-focused open-source command-line tool for on-device speech-to-text. It records your voice, transcribes it completely locally using faster-whisper, and automatically copies the text to clipboard for immediate use in any application.
...
* [speedread](https://github.com/pasky/speedread) ⭐ 1,258 | 🐛 13 | 🌐 Perl | 📅 2024-06-11 - A simple terminal-based open source Spritz-alike filter that shows input text as a per-word RSVP (rapid serial visual presentation) aligned on optimal reading points.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,659 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,847 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,419 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
* [mdp](https://github.com/visit1985/mdp) ⭐ 5,279 | 🐛 7 | 🌐 C | 📅 2026-09-09 - A command-line based Markdown presentation tool.
...
* [DeckTape](https://github.com/astefanutti/decktape) ⭐ 2,426 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - DeckTape is a high-quality PDF exporter for HTML presentation frameworks.
...
* [SheetsUI](https://github.com/zaphar/sheetsui) ⭐ 246 | 🐛 6 | 🌐 Rust | 📅 2026-03-03 - A console based (TUI) spreadsheet application.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 168 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,688 | 🐛 117 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [bcal](https://github.com/jarun/bcal) ⭐ 700 | 🐛 0 | 🌐 C | 📅 2026-09-17 - Byte CALculator - A REPL CLI utility for storage expression evaluation, SI/IEC conversion, byte address calculation, base conversion and LBA/CHS calculation.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,861 | 🐛 458 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,558 | 🐛 111 | 🌐 Rust | 📅 2026-09-15 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,527 | 🐛 15 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,346 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,955 | 🐛 91 | 🌐 Go | 📅 2026-09-16 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,289 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 138 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-15 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,445 | 🐛 527 | 🌐 Go | 📅 2026-09-15 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,676 | 🐛 270 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,235 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,493 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,253 | 🐛 55 | 🌐 C | 📅 2026-09-06 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,317 | 🐛 29 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
* [GiF for CLI](https://github.com/google/gif-for-cli) ⚠️ Archived - Convert a GIF, short video or a query into ASCII art.
* [gowall](https://github.com/Achno/gowall) ⭐ 2,309 | 🐛 12 | 🌐 Go | 📅 2026-06-10 - A tool to convert a Wallpaper's color scheme / palette, image to pixel art, color palette extraction, image upsacling with Adversarial Networks  and more image processing features.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,045 | 🐛 36 | 🌐 C | 📅 2026-09-11 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,820 | 🐛 5 | 🌐 Python | 📅 2026-09-16 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [textual-paint](https://github.com/1j01/textual-paint) ⭐ 1,122 | 🐛 10 | 🌐 Python | 📅 2026-02-21 - MS Paint in your terminal (TUI).
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 1,002 | 🐛 15 | 🌐 Python | 📅 2026-09-15 - AI-Powered Command-Line Photo Search Tool.
* [figma-use](https://github.com/dannote/figma-use) ⭐ 601 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-03 - Control Figma from the command line with full read/write access for AI agents.
* [deviceframe](https://github.com/c0bra/deviceframe) ⭐ 597 | 🐛 16 | 🌐 JavaScript | 📅 2020-11-09 - Put device frames around mobile/web/progressive app screenshots.
* [gifgen](https://github.com/lukechilds/gifgen) ⭐ 565 | 🐛 2 | 🌐 Shell | 📅 2023-01-22 - Simple high quality GIF encoding.
* [cmdpxl](https://github.com/knosmos/cmdpxl) ⭐ 548 | 🐛 2 | 🌐 Python | 📅 2021-08-27 - Command-line image editor (edit pixels, save images, undo function, fill tool and filters).
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,763 | 🐛 70 | 🌐 Python | 📅 2026-09-16 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,503 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 603 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,350 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,668 | 🐛 710 | 🌐 Python | 📅 2026-09-16 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,217 | 🐛 155 | 🌐 Rust | 📅 2026-09-12 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,775 | 🐛 213 | 🌐 Rust | 📅 2026-09-14 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 592 | 🐛 17 | 🌐 Rust | 📅 2026-09-14 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-16 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [cli-viz](https://github.com/sam1am/cli-viz) ⭐ 79 | 🐛 0 | 🌐 Python | 📅 2026-05-27 - An audio visualizer that runs in the linux terminal and reacts to the microphone.
...
* [cTune](https://github.com/An7ar35/ctune) ⭐ 32 | 🐛 3 | 🌐 C | 📅 2026-04-18 - A ncurses based internet radio player written in C for Linux.
...
* [spytorec](https://github.com/Danidukiyu/SpytoRec) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Real-time Spotify recorder with automatic track splitting, metadata tagging, and high-quality FLAC/OGG output.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,841 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,077 | 🐛 1 | 🌐 C | 📅 2026-09-17 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,077 | 🐛 1 | 🌐 C | 📅 2026-09-17 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,208 | 🐛 49 | 🌐 Rust | 📅 2026-09-16 - Terminal Music Player written in Rust.
...
* [lowfi](https://github.com/remvze/lowfi) ⭐ 52 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-09 - A music player through your terminal, with the option to open YouTube in the browser.
...
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,816 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,250 | 🐛 9 | 🌐 Python | 📅 2026-09-17 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
* [sha256-animation](https://github.com/in3rsha/sha256-animation) ⭐ 3,401 | 🐛 3 | 🌐 Ruby | 📅 2024-03-06 - Animation of the SHA-256 hash function in your terminal.
...
* [neo](https://github.com/st3w/neo) ⭐ 960 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 619 | 🐛 43 | 🌐 Go | 📅 2026-09-16 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,472 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,757 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,019 | 🐛 28 | 🌐 Go | 📅 2026-09-15 - Feature-rich terminal-based text viewer.
* [TerminalImageViewer](https://github.com/stefanhaustein/TerminalImageViewer) ⭐ 1,686 | 🐛 16 | 🌐 C++ | 📅 2026-09-03 - Small C++ program to display images in a (modern) terminal using RGB ANSI codes and Unicode block graphics characters.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,415 | 🐛 11 | 🌐 Rust | 📅 2026-09-14 - Terminal image, video, directory, and Markdown viewer.
...
* [epy](https://github.com/wustho/epy) ⭐ 1,214 | 🐛 72 | 🌐 Python | 📅 2024-03-17 - CLI Ebook (epub2, epub3, fb2, mobi) Reader.
...
* [viu](https://github.com/learn-anything/command-line-tools) ⭐ 495 | 🐛 17 | 📅 2026-08-16 - Command-line application to view images from the terminal written in Rust.
...
* [reader](https://github.com/mrusme/reader) ⭐ 414 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Reader parses a web page for its actual content and displays it in nicely highlighted text on the command line
* [hygg](https://github.com/kruserr/hygg) ⭐ 353 | 🐛 14 | 🌐 Rust | 📅 2026-08-26 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 346 | 🐛 6 | 🌐 Rust | 📅 2026-08-27 - An TUI for exploring data of a Kafka cluster.
...
* [see](https://github.com/guilhermeprokisch/see) ⭐ 292 | 🐛 5 | 🌐 Rust | 📅 2026-08-26 - A cute cat for the terminal with advanced code viewing, Markdown rendering, tree-sitter syntax highlighting, images view and more.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,980 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,916 | 🐛 174 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,809 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,723 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,143 | 🐛 446 | 🌐 Go | 📅 2026-09-14 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,819 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,079 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
* [wifi-password](https://github.com/rauchg/wifi-password) ⭐ 4,567 | 🐛 27 | 🌐 Shell | 📅 2024-06-13 - Get Wi-Fi pass.
...
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,200 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,105 | 🐛 99 | 🌐 Go | 📅 2026-09-16 - Tool for identifying risks in open source software supply chain.
...
* [pdvzip](https://github.com/CleasbyCode/pdvzip) ⭐ 63 | 🐛 1 | 🌐 C++ | 📅 2026-09-15 - CLI tool to embed a ZIP file within a PNG image to create a tweetable and "executable" PNG-ZIP polyglot file. Post & share your PNG-ZIP image on compatible sites.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,481 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Autocomplete](https://github.com/withfig/autocomplete) ⭐ 25,216 | 🐛 195 | 🌐 TypeScript | 📅 2025-05-05 - IDE-style autocomplete for your existing terminal & shell.
* [Keep](https://github.com/keephq/keep) ⭐ 12,326 | 🐛 614 | 🌐 Python | 📅 2026-09-13 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 770 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing your arr servers.
* [oji](https://github.com/xxczaki/oji) ⭐ 733 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-30 - Interactive text emoji creator.
* [play](https://github.com/paololazzari/play) ⭐ 588 | 🐛 3 | 🌐 Go | 📅 2025-03-28 - TUI playground for your favorite programs, such as grep, sed and awk.
* [sisi](https://github.com/frost-beta/sisi) ⭐ 580 | 🐛 4 | 🌐 TypeScript | 📅 2024-09-16 - Semantic image search CLI tool.
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 517 | 🐛 13 | 🌐 Go | 📅 2026-09-14 - Cross Platform tool to validate configuration files.
...
* [Raijin](https://github.com/MasonStooksbury/Raijin) ⭐ 173 | 🐛 2 | 🌐 Rust | 📅 2026-09-17 - A free, simple weather TUI that pulls data without the need for an API key, account, or subscription.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,313 | 🐛 16 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,048 | 🐛 12 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [toipe](https://github.com/Samyak2/toipe) ⭐ 670 | 🐛 25 | 🌐 Rust | 📅 2024-06-10 - Yet another typing test, but crab flavored.
...
* [Pokete](https://github.com/lxgr-linux/pokete) ⭐ 3,156 | 🐛 30 | 🌐 Python | 📅 2026-05-22 - A terminal based Pokemon like game.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,178 | 🐛 30 | 🌐 Rust | 📅 2026-09-14 - Play chess from your terminal.
...
* [gambit](https://github.com/maaslalani/gambit) ⭐ 903 | 🐛 10 | 🌐 Go | 📅 2024-01-25 - Chess board in your terminal.
...
* [Balatro TUI ](https://github.com/Passeriform/BalatroTUI) ⭐ 204 | 🐛 5 | 🌐 Rust | 📅 2026-05-01 - A minimal TUI clone of Balatro built in Rust.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,247 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,252 | 🐛 19 | 🌐 Rust | 📅 2026-09-16 - Turn your keyboard into a typewriter adding sounds at each keystroke.
...
* [Draw](https://github.com/maaslalani/draw) ⭐ 548 | 🐛 6 | 🌐 Go | 📅 2023-12-04 - draw is an simple drawing tool in the terminal. Hold your mouse down and move it across the screen to draw anything you want!
* [pyjokes](https://github.com/pyjokes/pyjokes) ⭐ 367 | 🐛 6 | 🌐 Python | 📅 2026-09-12 - One line jokes for programmers (jokes as a service).
* [pokeget](https://github.com/talwat/pokeget-rs) ⭐ 298 | 🐛 5 | 🌐 Rust | 📅 2026-07-13 - A bash script you can use to display cool sprites of Pokemon in your terminal.
...
* [bbl](https://github.com/nehemiaharchives/bbl) ⭐ 95 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-28 - Read, search Holy Bible in command line.
...
* [CatenaVetus](https://github.com/jimbob88/CatenaVetus) ⭐ 22 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - A TUI for reading the Church Fathers.
...
* [starfetch](https://github.com/Haruno19/starfetch) ⭐ 358 | 🐛 3 | 🌐 C++ | 📅 2025-12-01 - Command line tool that displays constellations.
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 253 | 🐛 37 | 🌐 Python | 📅 2026-09-17 - Track conferences and meetups.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,421 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,631 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,410 | 🐛 0 | 🌐 Shell | 📅 2026-09-13 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome CLI by sintaxi](https://github.com/sintaxi/awesome-cli) ⭐ 54 | 🐛 4 | 📅 2019-08-09 - Relatively short list with short descriptions; with some original entries.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,199 | 🐛 19 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,627 | 🐛 45 | 📅 2026-09-16 - An awesome list dedicated to TUI programs.
