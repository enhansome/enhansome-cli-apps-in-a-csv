...
* [eza](https://github.com/eza-community/eza) ⭐ 23,143 | 🐛 445 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,209 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,258 | 🐛 31 | 🌐 Rust | 📅 2026-09-01 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,152 | 🐛 141 | 🌐 Rust | 📅 2026-08-31 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [enhancd](https://github.com/babarot/enhancd) ⭐ 2,712 | 🐛 17 | 🌐 Shell | 📅 2025-01-24 - A next-generation cd command with your interactive filter.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,299 | 🐛 198 | 🌐 Rust | 📅 2026-09-02 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [rip](https://github.com/nivekuil/rip) ⭐ 1,732 | 🐛 26 | 🌐 Rust | 📅 2024-04-08 - Move and restore items from the graveyard (by default, `/tmp/graveyard-$USER` if $XDG\_DATA\_HOME is not set and `$XDG_DATA_HOME/graveyard` otherwise)
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,454 | 🐛 185 | 🌐 C | 📅 2026-08-28 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,077 | 🐛 434 | 🌐 Rust | 📅 2026-09-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,854 | 🐛 293 | 🌐 Rust | 📅 2026-09-04 - Syntax-aware structured diff tool.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,881 | 🐛 69 | 🌐 Go | 📅 2026-08-31 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,939 | 🐛 185 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,116 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,749 | 🐛 47 | 🌐 Rust | 📅 2026-09-03 - A CLI tool for code structural search, lint and rewriting.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,342 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 528 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A replacer that uses ripgrep for finding and provides an interactive interface to replace the text.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,216 | 🐛 9 | 🌐 Rust | 📅 2026-08-19 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,222 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,959 | 🐛 53 | 🌐 Go | 📅 2026-09-03 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [erdtree](https://github.com/solidiquis/erdtree) ⭐ 2,597 | 🐛 36 | 🌐 Rust | 📅 2024-05-19 - A multithreaded file-tree visualizer and disk usage analyzer.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,394 | 🐛 533 | 🌐 C++ | 📅 2026-09-01 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,121 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,930 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,972 | 🐛 108 | 🌐 Rust | 📅 2026-09-04 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,964 | 🐛 147 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,133 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,153 | 🐛 46 | 🌐 Rust | 📅 2026-09-02 - A modern replacement for ps written in Rust.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,502 | 🐛 32 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
* [tiptop](https://github.com/nschloe/tiptop) ⭐ 2,123 | 🐛 25 | 🌐 Python | 📅 2025-09-04 - A command-line system monitoring tool in the spirit of top, written in Python. It displays various interesting system stats and graphs them. Works on all operating systems.
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,692 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,418 | 🐛 118 | 🌐 C | 📅 2026-09-03 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,925 | 🐛 67 | 🌐 Rust | 📅 2026-09-01 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,071 | 🐛 264 | 🌐 Go | 📅 2026-09-03 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,859 | 🐛 4 | 🌐 C | 📅 2026-09-03 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,486 | 🐛 84 | 🌐 Go | 📅 2026-08-25 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,209 | 🐛 474 | 🌐 C++ | 📅 2026-09-03 - Linux port of Far v2 file manager.
...
* [felix](https://github.com/kyoheiu/felix) ⭐ 916 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager with vim-like key mapping
...
* [tre](https://github.com/dduan/tre) ⭐ 1,222 | 🐛 23 | 🌐 Rust | 📅 2024-09-03 - `tree` command improved with git awareness, editor aliasing, and colors.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,739 | 🐛 88 | 🌐 Rust | 📅 2026-09-02 - Painless compression and decompression in the terminal.
...
* [qcp](https://github.com/crazyscot/qcp) ⭐ 284 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - Quick File Copy using QUIC.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,440 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 178,032 | 🐛 702 | 🌐 Python | 📅 2026-09-04 - Python tool for converting files and office documents to Markdown.
...
* [hget](https://github.com/bevacqua/hget) ⭐ 388 | 🐛 0 | 🌐 HTML | 📅 2024-03-16 - A CLI to convert HTML into plain text. Can be used to fetch a site's HTML version and convert it into plain text, or to deliver plain text versions of your site dynamically.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,412 | 🐛 534 | 🌐 Rust | 📅 2026-09-02 - Cross-platform Text Expander written in Rust. Not limited to the command line.
* [Ultimate Plumber](https://github.com/akavel/up) ⭐ 8,841 | 🐛 30 | 🌐 Go | 📅 2024-09-05 - Helps to interactively and incrementally explore textual data in Linux, by making it easier to quickly build complex pipelines, thanks to a fast feedback loop.
...
* [toolong](https://github.com/Textualize/toolong) ⭐ 3,943 | 🐛 37 | 🌐 Python | 📅 2024-08-05 - A terminal application to view, tail, merge, and search log files (plus JSONL).
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,715 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,316 | 🐛 374 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,347 | 🐛 5 | 🌐 Perl | 📅 2026-09-02 - Command line tool for URL parsing and manipulation.
...
* [trre](https://github.com/c0stya/trre) ⭐ 258 | 🐛 2 | 🌐 C | 📅 2026-09-03 - Transductive regular expressions: an extension of the regular expressions for text editing and a grep-like command line tool.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,794 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,740 | 🐛 51 | 🌐 Python | 📅 2026-09-02 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,024 | 🐛 8 | 🌐 Python | 📅 2026-09-04 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,796 | 🐛 19 | 🌐 Go | 📅 2026-08-23 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,742 | 🐛 22 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,355 | 🐛 664 | 🌐 Go | 📅 2026-09-04 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,373 | 🐛 38 | 🌐 Python | 📅 2026-09-03 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,971 | 🐛 1 | 🌐 Python | 📅 2026-09-02 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,097 | 🐛 118 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,008 | 🐛 71 | 📅 2026-09-01 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,373 | 🐛 40 | 🌐 Python | 📅 2026-09-04 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,317 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,265 | 🐛 48 | 🌐 Go | 📅 2026-08-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,953 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,775 | 🐛 29 | 🌐 Rust | 📅 2026-09-04 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,775 | 🐛 29 | 🌐 Rust | 📅 2026-09-04 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,296 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,197 | 🐛 14 | 🌐 Go | 📅 2026-09-03 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,094 | 🐛 16 | 🌐 Rust | 📅 2026-09-04 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,556 | 🐛 69 | 🌐 Go | 📅 2026-08-29 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,811 | 🐛 329 | 🌐 Go | 📅 2026-09-04 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,941 | 🐛 5 | 🌐 Rust | 📅 2026-09-03 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,238 | 🐛 83 | 🌐 Rust | 📅 2026-09-02 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,181 | 🐛 229 | 🌐 Go | 📅 2026-09-02 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,116 | 🐛 663 | 🌐 Rust | 📅 2026-09-03 - Create book from Markdown files.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 698 | 🐛 0 | 🌐 Go | 📅 2026-09-03 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,969 | 🐛 1,028 | 🌐 Go | 📅 2026-09-03 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,092 | 🐛 474 | 🌐 Go | 📅 2026-08-26 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,461 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,103 | 🐛 95 | 🌐 Shell | 📅 2026-09-01 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,320 | 🐛 232 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,471 | 🐛 100 | 🌐 Go | 📅 2026-09-02 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,209 | 🐛 117 | 🌐 Rust | 📅 2026-09-01 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,071 | 🐛 9 | 🌐 Shell | 📅 2026-09-01 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,040 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,311 | 🐛 13 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,934 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,372 | 🐛 1,226 | 🌐 Rust | 📅 2026-09-04 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,182 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-03 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,887 | 🐛 686 | 🌐 Go | 📅 2026-09-04 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,021 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-03 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,959 | 🐛 6 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,501 | 🐛 27 | 🌐 Perl | 📅 2026-09-02 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,878 | 🐛 245 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,329 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,244 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,844 | 🐛 28 | 🌐 Python | 📅 2026-04-15 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,041 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,718 | 🐛 26 | 🌐 Go | 📅 2026-09-04 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,180 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,413 | 🐛 39 | 🌐 Rust | 📅 2026-08-30 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,120 | 🐛 445 | 🌐 Rust | 📅 2026-09-04 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,647 | 🐛 15 | 🌐 Python | 📅 2026-08-27 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [gup](https://github.com/nao1215/gup) ⭐ 601 | 🐛 1 | 🌐 Go | 📅 2026-09-02 - Update binaries installed by "go install" with goroutines.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,073 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,496 | 🐛 83 | 🌐 Go | 📅 2026-09-03 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,329 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,396 | 🐛 8 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
...
* [Ducker](https://github.com/robertpsoane/ducker) ⭐ 923 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - TUI for managing docker containers.
* [E1S](https://github.com/keidarcy/e1s) ⭐ 923 | 🐛 9 | 🌐 Go | 📅 2026-09-01 - TUI for browsing and managing AWS ECS resources.
* [PUG](https://github.com/leg100/pug) ⭐ 698 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - TUI for Terraform (perform tasks in parallel, manage state resources, calculate costs, automatically loads workspace variable files).
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,479 | 🐛 336 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,461 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,362 | 🐛 84 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,224 | 🐛 9 | 🌐 Rust | 📅 2026-09-02 - TUI-based HTTP/REST client.
...
* [beachpatrol](https://github.com/sebastiancarlos/beachpatrol) ⭐ 921 | 🐛 4 | 🌐 JavaScript | 📅 2025-10-30 - A CLI tool to replace and automate your everyday web browser.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,232 | 🐛 11 | 🌐 Rust | 📅 2026-08-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,718 | 🐛 1,853 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,618 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,319 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,689 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-04 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,745 | 🐛 76 | 🌐 Python | 📅 2026-09-03 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [Marstui-rustio](https://github.com/schooldanlp6/marstui-rustio) ⭐ 15 | 🐛 3 | 🌐 Rust | 📅 2026-08-31 - A nice audio management Interface, similar to pavucontrol with the benefit of customizing everything.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,673 | 🐛 244 | 🌐 Zig | 📅 2026-09-03 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,736 | 🐛 1,836 | 🌐 Rust | 📅 2026-08-31 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,273 | 🐛 1,894 | 🌐 Rust | 📅 2026-08-31 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,411 | 🐛 1,424 | 🌐 Rust | 📅 2026-09-03 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,368 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [Ion](https://github.com/redox-os/ion) ⭐ 1,655 | 🐛 60 | 🌐 Rust | 📅 2026-05-02 - Ion is a modern system shell that features a simple, yet powerful, syntax.
...
* [oksh](https://github.com/ibara/oksh) ⭐ 455 | 🐛 17 | 🌐 C | 📅 2026-06-10 - Portable OpenBSD ksh.
* [ksh93](https://github.com/ksh93/ksh) ⭐ 280 | 🐛 70 | 🌐 C | 📅 2026-09-04 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-03 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,032 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,806 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,409 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
...
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,515 | 🐛 83 | 🌐 C | 📅 2026-09-03 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,515 | 🐛 83 | 🌐 C | 📅 2026-09-03 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,902 | 🐛 449 | 🌐 C | 📅 2026-09-03 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,072 | 🐛 105 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,673 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [kmon](https://github.com/orhun/kmon) ⭐ 2,940 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux TUI Kernel manager and activity monitor.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,863 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,649 | 🐛 7 | 🌐 Rust | 📅 2026-08-14 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,479 | 🐛 214 | 🌐 Rust | 📅 2026-09-03 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,068 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,525 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,720 | 🐛 297 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,836 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,097 | 🐛 69 | 🌐 Shell | 📅 2026-08-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,936 | 🐛 148 | 🌐 Go | 📅 2026-09-02 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,275 | 🐛 27 | 🌐 Go | 📅 2026-09-03 - A Docker manager for the terminal.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,367 | 🐛 114 | 🌐 C | 📅 2026-09-03 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,315 | 🐛 19 | 🌐 Rust | 📅 2026-09-03 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,745 | 🐛 17 | 🌐 Go | 📅 2026-08-29 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,709 | 🐛 68 | 🌐 Rust | 📅 2026-09-03 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,888 | 🐛 3 | 🌐 Rust | 📅 2026-09-03 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,180 | 🐛 8 | 🌐 Rust | 📅 2026-08-29 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,180 | 🐛 8 | 🌐 Rust | 📅 2026-08-29 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,313 | 🐛 217 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 888 | 🐛 3 | 🌐 Rust | 📅 2026-09-03 - Terminal mail client.
...
* [nmail](https://github.com/d99kris/nmail) ⭐ 255 | 🐛 0 | 🌐 C++ | 📅 2026-08-30 - nmail is a console-based email client for Linux and macOS with a user interface similar to alpine / pine.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,179 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,759 | 🐛 54 | 🌐 Go | 📅 2026-09-03 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,898 | 🐛 110 | 🌐 Java | 📅 2026-08-21 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,934 | 🐛 14 | 🌐 C++ | 📅 2026-08-30 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,721 | 🐛 76 | 🌐 Go | 📅 2026-09-01 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,369 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,001 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 977 | 🐛 5 | 🌐 Python | 📅 2026-09-03 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 862 | 🐛 474 | 🌐 Python | 📅 2026-08-16 - Official Zulip terminal client with TUI.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 753 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,298 | 🐛 114 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,948 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,483 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,730 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,524 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,901 | 🐛 149 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,683 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,834 | 🐛 79 | 🌐 Rust | 📅 2026-09-04 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,097 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,993 | 🐛 21 | 🌐 Rust | 📅 2026-09-03 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,707 | 🐛 34 | 🌐 Go | 📅 2026-08-15 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
...
* [asn](https://github.com/nitefood/asn) ⭐ 1,929 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,590 | 🐛 23 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
...
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,233 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
...
* [ggh](https://github.com/byawitz/ggh) ⭐ 951 | 🐛 26 | 🌐 Go | 📅 2026-02-10 - Recall your SSH sessions, also searching your SSH config file.
...
* [speedtest-net](https://github.com/ddsol/speedtest.net) ⭐ 625 | 🐛 18 | 🌐 JavaScript | 📅 2022-02-11 - Test internet connection speed and ping using speedtest.net.
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 534 | 🐛 0 | 🌐 Go | 📅 2026-08-30 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [packemon](https://github.com/ddddddO/packemon) ⭐ 306 | 🐛 33 | 🌐 Go | 📅 2026-08-26 - TUI tool and Go library for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).
...
* [neoss](https://github.com/PabloLec/neoss) ⭐ 230 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-31 - User-friendly and detailed socket statistics with a Terminal UI.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,831 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,399 | 🐛 11 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [ssm](https://github.com/lfaoro/ssm) ⭐ 113 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - SSH connection manager designed to connect, filter, tag, and much more from a simple terminal interface.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 188,796 | 🐛 2,624 | 🌐 Python | 📅 2026-08-30 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,101 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,908 | 🐛 1,175 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,216 | 🐛 1 | 🌐 Go | 📅 2026-09-04 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,660 | 🐛 544 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,907 | 🐛 182 | 🌐 Python | 📅 2026-09-02 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,400 | 🐛 1,155 | 🌐 Python | 📅 2026-08-29 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,054 | 🐛 38 | 🌐 Rust | 📅 2026-08-23 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,033 | 🐛 182 | 🌐 Go | 📅 2026-08-31 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,661 | 🐛 124 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,714 | 🐛 25 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,528 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,067 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,857 | 🐛 398 | 🌐 C++ | 📅 2026-09-03 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,225 | 🐛 2 | 🌐 Python | 📅 2026-09-04 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [Amfora](https://github.com/makew0rld/amfora) ⭐ 1,355 | 🐛 9 | 🌐 Go | 📅 2026-07-03 - Amfora aims to be the best looking Gemini client with the most features. It does not support Gopher or other non-Web protocols.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,942 | 🐛 169 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-09-04 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [taskbook](https://github.com/klaudiosinani/taskbook) ⭐ 9,340 | 🐛 101 | 🌐 JavaScript | 📅 2025-11-03 - Tasks, boards & notes for the command-line habitat.
...
* [xit](https://github.com/jotaen/xit) ⭐ 1,122 | 🐛 0 | 📅 2024-01-27 - A plain-text file format for todos and check lists. So, not really a program, but I believe it is worth to list :-)
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,651 | 🐛 125 | 🌐 C++ | 📅 2026-08-29 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [doing](https://github.com/ttscoff/doing) ⭐ 1,290 | 🐛 2 | 🌐 Ruby | 📅 2026-07-27 - A command line tool for remembering what you were doing and tracking what you've done.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,392 | 🐛 151 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,307 | 🐛 151 | 🌐 Python | 📅 2026-09-04 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 528 | 🐛 2 | 🌐 Rust | 📅 2026-08-25 - Terminal-based markdown note manager.
...
* [Captain's Log](https://github.com/NikolaDucak/caps-log) ⭐ 395 | 🐛 16 | 🌐 C++ | 📅 2026-08-14 - A small TUI journaling tool (daily entries saved as md files, tags for organizing entries, browse tags, calendar view, encrypted logs, storage using a git repository).
...
* [Toney](https://github.com/SourcewareLab/Toney) ⭐ 204 | 🐛 4 | 🌐 Go | 📅 2026-05-27 - A fast, lightweight, terminal-based note-taking TUI app built with Bubbletea; Offers markdown rendering, file navigation and native Neovim editing.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,189 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,347 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,893 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 265 | 🐛 8 | 🌐 Rust | 📅 2026-09-03 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,807 | 🐛 849 | 🌐 TypeScript | 📅 2026-09-04 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,797 | 🐛 67 | 🌐 Go | 📅 2026-09-03 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,426 | 🐛 100 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [tenere](https://github.com/pythops/tenere) ⭐ 682 | 🐛 10 | 🌐 Rust | 📅 2026-05-10 - A TUI for LLMs (ChatGPT, llama\_cpp, ollama) written in Rust.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,072 | 🐛 105 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,645 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,815 | 🐛 77 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,377 | 🐛 176 | 🌐 C++ | 📅 2026-08-30 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [DeckTape](https://github.com/astefanutti/decktape) ⭐ 2,424 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - DeckTape is a high-quality PDF exporter for HTML presentation frameworks.
* [Lotus 1-2-3 for Linux](https://github.com/taviso/123elf) ⭐ 1,287 | 🐛 40 | 🌐 C | 📅 2026-06-27 - A native port of Lotus 1-2-3 Release 3 to Linux.
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 14 | 🌐 Python | 📅 2026-09-04 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 164 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [bcal](https://github.com/jarun/bcal) ⭐ 698 | 🐛 0 | 🌐 C | 📅 2026-08-16 - Byte CALculator - A REPL CLI utility for storage expression evaluation, SI/IEC conversion, byte address calculation, base conversion and LBA/CHS calculation.
...
* [navi](https://github.com/denisidoro/navi) ⭐ 17,504 | 🐛 112 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,493 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,341 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,945 | 🐛 97 | 🌐 Go | 📅 2026-09-03 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [fzf-help](https://github.com/BartSte/fzf-help) ⭐ 61 | 🐛 3 | 🌐 Shell | 📅 2026-08-20 - An fzf extension that allows you to select command line options of a given command; the options are retrieved from the command its `--help` documentation.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 120 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 10 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,140 | 🐛 520 | 🌐 Go | 📅 2026-09-03 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,665 | 🐛 260 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,230 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,206 | 🐛 54 | 🌐 C | 📅 2026-09-03 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,311 | 🐛 28 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
* [GiF for CLI](https://github.com/google/gif-for-cli) ⚠️ Archived - Convert a GIF, short video or a query into ASCII art.
* [gowall](https://github.com/Achno/gowall) ⭐ 2,303 | 🐛 12 | 🌐 Go | 📅 2026-06-10 - A tool to convert a Wallpaper's color scheme / palette, image to pixel art, color palette extraction, image upsacling with Adversarial Networks  and more image processing features.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,033 | 🐛 38 | 🌐 C | 📅 2026-08-20 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,804 | 🐛 4 | 🌐 Python | 📅 2026-08-30 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 996 | 🐛 18 | 🌐 Python | 📅 2026-08-30 - AI-Powered Command-Line Photo Search Tool.
* [figma-use](https://github.com/dannote/figma-use) ⭐ 596 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-03 - Control Figma from the command line with full read/write access for AI agents.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 416 | 🐛 7 | 🌐 Rust | 📅 2026-09-02 - A powerful Rust image optimization CLI tool.
...
* [ArTTY](https://github.com/mjwhitta/artty) ⭐ 134 | 🐛 0 | 🌐 Go | 📅 2026-08-26 - Pixel art with optional system info, similar to Neofetch.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,728 | 🐛 82 | 🌐 Python | 📅 2026-09-03 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,342 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,615 | 🐛 717 | 🌐 Python | 📅 2026-09-03 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,787 | 🐛 227 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,174 | 🐛 176 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,763 | 🐛 210 | 🌐 Rust | 📅 2026-08-31 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-03 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [cue](https://github.com/ravachol/cue) ⭐ 3,017 | 🐛 3 | 🌐 C | 📅 2026-09-02 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,017 | 🐛 3 | 🌐 C | 📅 2026-09-02 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,190 | 🐛 52 | 🌐 Rust | 📅 2026-09-02 - Terminal Music Player written in Rust.
...
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,811 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,223 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [neo](https://github.com/st3w/neo) ⭐ 956 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,366 | 🐛 422 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,745 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,015 | 🐛 30 | 🌐 Go | 📅 2026-09-04 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,553 | 🐛 15 | 🌐 Go | 📅 2026-08-30 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
...
* [baca](https://github.com/wustho/baca) ⭐ 521 | 🐛 12 | 🌐 Python | 📅 2024-03-05 - Lets you indulge in your favorite e-books in the comfort of your terminal.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,959 | 🐛 12 | 🌐 Rust | 📅 2026-09-02 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,805 | 🐛 173 | 🌐 Go | 📅 2026-09-01 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,762 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,714 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,019 | 🐛 442 | 🌐 Go | 📅 2026-09-02 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,813 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,052 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - A fast, simple, recursive content discovery tool written in Rust.
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,076 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [flawz](https://github.com/orhun/flawz) ⭐ 604 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A Terminal UI for browsing security vulnerabilities (CVEs).
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,469 | 🐛 101 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Autocomplete](https://github.com/withfig/autocomplete) ⭐ 25,225 | 🐛 195 | 🌐 TypeScript | 📅 2025-05-05 - IDE-style autocomplete for your existing terminal & shell.
* [Keep](https://github.com/keephq/keep) ⭐ 12,278 | 🐛 594 | 🌐 Python | 📅 2026-09-02 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 516 | 🐛 12 | 🌐 Go | 📅 2026-09-03 - Cross Platform tool to validate configuration files.
...
* [sauce](https://github.com/cadecuddy/sauce) ⭐ 50 | 🐛 0 | 🌐 Go | 📅 2022-10-17 - A novelty CLI tool that identifies an anime from an image and yields key data about it.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,167 | 🐛 11 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,042 | 🐛 11 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,167 | 🐛 32 | 🌐 Rust | 📅 2026-08-27 - Play chess from your terminal.
...
* [bucklespring](https://github.com/zevv/bucklespring) ⭐ 1,552 | 🐛 42 | 🌐 C | 📅 2025-08-24 - Emulates the sound of the old IBM Model-M space saver bucklespring keyboard while typing.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,236 | 🐛 257 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,558 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,315 | 🐛 0 | 🌐 Shell | 📅 2026-09-02 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,460 | 🐛 102 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
