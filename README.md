...
* [eza](https://github.com/eza-community/eza) ⭐ 23,187 | 🐛 445 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,214 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,238 | 🐛 144 | 🌐 Rust | 📅 2026-09-08 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,043 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,145 | 🐛 75 | 🌐 Lua | 📅 2026-08-10 - Directory changer that learns your habits.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,334 | 🐛 202 | 🌐 Rust | 📅 2026-09-07 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,788 | 🐛 134 | 🌐 Rust | 📅 2026-09-01 - Intelligent context-aware search engine for your shell history with TUI.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,113 | 🐛 435 | 🌐 Rust | 📅 2026-09-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,864 | 🐛 293 | 🌐 Rust | 📅 2026-09-06 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,090 | 🐛 5 | 🌐 Perl | 📅 2026-08-31 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,882 | 🐛 70 | 🌐 Go | 📅 2026-08-31 - A diff tool for YAML files, and sometimes JSON.
* [ydiff](https://github.com/ymattw/ydiff) ⭐ 931 | 🐛 1 | 🌐 Python | 📅 2026-05-20 - View colored, incremental diff.
* [pdf-diff](https://github.com/serhack/pdf-diff) ⭐ 867 | 🐛 5 | 🌐 Go | 📅 2023-05-08 - A tool for visualizing differences between two PDF files. Mainly dedicated to editors that usually spends a lot of hours on several PDFs.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,067 | 🐛 190 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,120 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,792 | 🐛 50 | 🌐 Rust | 📅 2026-09-08 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,831 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,279 | 🐛 9 | 🌐 C++ | 📅 2026-08-31 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,229 | 🐛 10 | 🌐 Rust | 📅 2026-08-19 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,232 | 🐛 0 | 🌐 Rust | 📅 2026-09-07 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,967 | 🐛 54 | 🌐 Go | 📅 2026-09-04 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,451 | 🐛 534 | 🌐 C++ | 📅 2026-09-05 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,120 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,931 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,995 | 🐛 107 | 🌐 Rust | 📅 2026-09-08 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,979 | 🐛 142 | 🌐 C | 📅 2026-09-07 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,142 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,158 | 🐛 32 | 🌐 Rust | 📅 2026-09-07 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,082 | 🐛 42 | 🌐 Python | 📅 2026-08-27 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,048 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
* [below](https://github.com/facebookincubator/below) ⭐ 2,511 | 🐛 32 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,698 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,421 | 🐛 115 | 🌐 C | 📅 2026-09-07 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,034 | 🐛 72 | 🌐 Rust | 📅 2026-09-08 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,125 | 🐛 263 | 🌐 Go | 📅 2026-09-07 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,875 | 🐛 4 | 🌐 C | 📅 2026-09-05 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,493 | 🐛 87 | 🌐 Go | 📅 2026-09-07 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 473 | 🌐 C++ | 📅 2026-09-06 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,722 | 🐛 26 | 🌐 C | 📅 2026-09-06 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,816 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [progress](https://github.com/Xfennec/progress) ⭐ 8,859 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Monitor the progress of common Coreutils command-line tools (`cp`, `mv`, `dd`, `tar`, `rsync`, etc.); it uses a ncurses interface to display the percentage of data copied; it works by reading from system files and retrieving the necessary information for the estimation.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,742 | 🐛 90 | 🌐 Rust | 📅 2026-09-07 - Painless compression and decompression in the terminal.
...
* [qcp](https://github.com/crazyscot/qcp) ⭐ 285 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - Quick File Copy using QUIC.
...
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,177 | 🐛 36 | 🌐 Rust | 📅 2026-09-07 - Executes commands in response to file modifications.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,441 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 180,637 | 🐛 625 | 🌐 Python | 📅 2026-09-07 - Python tool for converting files and office documents to Markdown.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,446 | 🐛 537 | 🌐 Rust | 📅 2026-09-07 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [lolcat](https://github.com/busyloop/lolcat) ⭐ 6,574 | 🐛 33 | 🌐 Ruby | 📅 2024-03-05 - Ruby Gem to colorize the output of the cat command.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,719 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,341 | 🐛 375 | 🌐 Python | 📅 2026-06-23.
...
* [ROAPI](https://github.com/roapi/roapi) ⭐ 3,432 | 🐛 66 | 🌐 Rust | 📅 2026-03-25 - ROAPI automatically spins up read-only APIs for static datasets without requiring you to write a single line of code.
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,743 | 🐛 52 | 🌐 Python | 📅 2026-09-02 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,024 | 🐛 6 | 🌐 Python | 📅 2026-09-05 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [lowcharts](https://github.com/juan-leon/lowcharts) ⭐ 252 | 🐛 10 | 🌐 Rust | 📅 2025-12-22 - lowcharts is meant to be used in those scenarios where we have numerical data in text files that we want to display in the terminal to do a basic analysis.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,620 | 🐛 28 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,933 | 🐛 299 | 🌐 Go | 📅 2026-09-03 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,515 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,798 | 🐛 18 | 🌐 Go | 📅 2026-09-04 - Pure Go implementation of jq.
...
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,480 | 🐛 29 | 🌐 Python | 📅 2026-09-07 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [GROQ](https://github.com/sanity-io/groq-cli) ⭐ 236 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-30 - The CLI tool consumes both JSON and NDJSON documents. You can pass in data from a local file, or from piping to standard input.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,393 | 🐛 649 | 🌐 Go | 📅 2026-09-06 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,374 | 🐛 40 | 🌐 Python | 📅 2026-09-04 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,974 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,100 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,010 | 🐛 72 | 📅 2026-09-07 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
* [textql](https://github.com/dinedal/textql) ⭐ 9,103 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,412 | 🐛 40 | 🌐 Python | 📅 2026-08-03 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,381 | 🐛 43 | 🌐 Python | 📅 2026-09-07 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,323 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,278 | 🐛 49 | 🌐 Go | 📅 2026-08-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,956 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,776 | 🐛 32 | 🌐 Rust | 📅 2026-09-08 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,776 | 🐛 32 | 🌐 Rust | 📅 2026-09-08 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,295 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,200 | 🐛 15 | 🌐 Go | 📅 2026-09-04 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,097 | 🐛 18 | 🌐 Rust | 📅 2026-09-06 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,560 | 🐛 67 | 🌐 Go | 📅 2026-09-07 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [TV](https://github.com/alexhallam/tv) ⭐ 2,166 | 🐛 28 | 🌐 Rust | 📅 2025-08-21 - Cross-platform CSV pretty printer made to maximize viewer enjoyment.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,864 | 🐛 329 | 🌐 Go | 📅 2026-09-06 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,945 | 🐛 8 | 🌐 Rust | 📅 2026-09-07 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,251 | 🐛 80 | 🌐 Rust | 📅 2026-09-06 - Blazing fast general purpose fuzzy finder TUI.
* [percol](https://github.com/mooz/percol) ⭐ 3,325 | 🐛 51 | 🌐 Python | 📅 2023-12-30 - A Python script that "1) receives input lines from `stdin` or a file, 2) lists the input lines and waits for input that filter/select the line(s), 3) outputs the selected line(s) to `stdout`"; can be used to add interactivity to many regular shell commands.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,223 | 🐛 229 | 🌐 Go | 📅 2026-09-07 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,126 | 🐛 659 | 🌐 Rust | 📅 2026-09-07 - Create book from Markdown files.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,279 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,542 | 🐛 978 | 🌐 Go | 📅 2026-09-08 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,547 | 🐛 174 | 🌐 Rust | 📅 2026-08-27 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,121 | 🐛 1,030 | 🌐 Go | 📅 2026-09-07 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,157 | 🐛 473 | 🌐 Go | 📅 2026-08-26 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,102 | 🐛 95 | 🌐 Shell | 📅 2026-09-01 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,326 | 🐛 232 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,486 | 🐛 100 | 🌐 Go | 📅 2026-09-02 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,219 | 🐛 114 | 🌐 Rust | 📅 2026-09-07 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,046 | 🐛 68 | 🌐 Rust | 📅 2026-09-07 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,023 | 🐛 179 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,213 | 🐛 80 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,075 | 🐛 11 | 🌐 Shell | 📅 2026-09-05 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,043 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,312 | 🐛 13 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [gh-repo-man](https://github.com/2KAbhishek/gh-repo-man) ⭐ 31 | 🐛 0 | 🌐 Go | 📅 2026-09-03 - GitHub CLI extension that allows developers to browse, clone and work with multiple repositories interactively.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,449 | 🐛 1,222 | 🌐 Rust | 📅 2026-09-08 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,141 | 🐛 17 | 🌐 Rust | 📅 2026-09-07 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,236 | 🐛 139 | 🌐 TypeScript | 📅 2026-09-07 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,951 | 🐛 700 | 🌐 Go | 📅 2026-09-08 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,028 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-05 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,971 | 🐛 6 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,508 | 🐛 27 | 🌐 Perl | 📅 2026-09-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,887 | 🐛 241 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,342 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,246 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,844 | 🐛 28 | 🌐 Python | 📅 2026-04-15 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,049 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,726 | 🐛 26 | 🌐 Go | 📅 2026-09-07 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,123 | 🐛 444 | 🌐 Rust | 📅 2026-09-06 - Developer environments you can take with you.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 894 | 🐛 165 | 🌐 Rust | 📅 2026-08-30 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 602 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - Update binaries installed by "go install" with goroutines.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,081 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
* [readme-md-generator](https://github.com/kefranabg/readme-md-generator) ⭐ 11,131 | 🐛 30 | 🌐 JavaScript | 📅 2022-09-20 - CLI that generates beautiful README.md files.
* [boilr](https://github.com/tmrts/boilr) ⭐ 1,761 | 🐛 44 | 🌐 Go | 📅 2023-03-07 - Boilerplate template manager that generates files or directories from template repositories.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,537 | 🐛 85 | 🌐 Go | 📅 2026-09-07 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,342 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,851 | 🐛 42 | 🌐 Go | 📅 2026-08-19 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,531 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - A simple and fast terminal dashboard for Kubernetes.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,398 | 🐛 8 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,218 | 🐛 8 | 🌐 Go | 📅 2026-09-07 - TUI for Podman environment.
...
* [Ducker](https://github.com/robertpsoane/ducker) ⭐ 925 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - TUI for managing docker containers.
* [E1S](https://github.com/keidarcy/e1s) ⭐ 925 | 🐛 0 | 🌐 Go | 📅 2026-09-07 - TUI for browsing and managing AWS ECS resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,485 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,467 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,381 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,892 | 🐛 79 | 🌐 Rust | 📅 2026-09-07 - Fast, async, resource-friendly link checker written in Rust.
...
* [beachpatrol](https://github.com/sebastiancarlos/beachpatrol) ⭐ 922 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-08 - A CLI tool to replace and automate your everyday web browser.
...
* [domain-check](https://github.com/saidutt46/domain-check) ⭐ 305 | 🐛 4 | 🌐 Rust | 📅 2026-05-14 - Universal domain exploration engine: fast domain availability checks across the internet.
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-09-03 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,270 | 🐛 1 | 🌐 Rust | 📅 2026-09-08 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,825 | 🐛 1,855 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,682 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,318 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,694 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,753 | 🐛 76 | 🌐 Python | 📅 2026-09-05 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,003 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
...
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,051 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [has](https://github.com/kdabir/has) ⭐ 819 | 🐛 14 | 🌐 Shell | 📅 2026-09-05 - Checks presence of various command line tools on the PATH and reports their installed version.
* [qman](https://github.com/plp13/qman) ⭐ 599 | 🐛 13 | 🌐 C | 📅 2026-09-06 - A more modern man page viewer for our terminals.
...
* [argc-completions](https://github.com/sigoden/argc-completions) ⭐ 460 | 🐛 2 | 🌐 Shell | 📅 2024-11-27 - Autocompletion for any shell and any command.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,827 | 🐛 245 | 🌐 Zig | 📅 2026-09-08 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,810 | 🐛 1,845 | 🌐 Rust | 📅 2026-09-06 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,314 | 🐛 1,903 | 🌐 Rust | 📅 2026-08-31 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,442 | 🐛 1,436 | 🌐 Rust | 📅 2026-09-06 - A modern shell written in Rust, where all data is structured.
...
* [Ion](https://github.com/redox-os/ion) ⭐ 1,656 | 🐛 60 | 🌐 Rust | 📅 2026-09-07 - Ion is a modern system shell that features a simple, yet powerful, syntax.
* [dune](https://github.com/adam-mcdaniel/dune) ⭐ 1,086 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - A customizable shell that aims to be cozy.
* [Twin](https://github.com/cosmos72/twin) ⭐ 1,059 | 🐛 37 | 🌐 C | 📅 2026-08-03 - Text mode window environment. A "retro" program for embedded or remote systems, that doubles as X11 terminal and text-mode equivalent of VNC server.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 281 | 🐛 70 | 🌐 C | 📅 2026-09-08 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-06 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,053 | 🐛 150 | 🌐 Shell | 📅 2026-09-06 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,414 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,674 | 🐛 29 | 🌐 Shell | 📅 2026-09-07 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
...
* [extrakto](https://github.com/laktak/extrakto) ⭐ 1,139 | 🐛 1 | 🌐 Python | 📅 2026-03-02 - extrakto for tmux - quickly select, copy/insert/complete text without a mouse.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,817 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,560 | 🐛 86 | 🌐 C | 📅 2026-09-07 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,560 | 🐛 86 | 🌐 C | 📅 2026-09-07 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,912 | 🐛 449 | 🌐 C | 📅 2026-09-03 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,682 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,871 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,651 | 🐛 7 | 🌐 Rust | 📅 2026-08-14 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,077 | 🐛 32 | 🌐 Go | 📅 2026-09-07 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [chdig](https://github.com/azat/chdig) ⭐ 294 | 🐛 5 | 🌐 Rust | 📅 2026-09-07 - Dig into ClickHouse with TUI interface.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,498 | 🐛 208 | 🌐 Rust | 📅 2026-09-07 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,071 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,282 | 🐛 91 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [app](https://github.com/hkdb/app) ⭐ 176 | 🐛 4 | 🌐 Go | 📅 2026-04-15 - A cross-platform package management assistant with super powers.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,538 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,756 | 🐛 299 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,838 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,135 | 🐛 70 | 🌐 Shell | 📅 2026-08-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,961 | 🐛 149 | 🌐 Go | 📅 2026-09-02 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,831 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 603 | 🐛 17 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,375 | 🐛 115 | 🌐 C | 📅 2026-09-06 - A window switcher, application launcher and dmenu replacement.
...
* [entr](https://github.com/eradman/entr) ⭐ 5,673 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,753 | 🐛 23 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,712 | 🐛 69 | 🌐 Rust | 📅 2026-09-05 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [Marker](https://github.com/pindexis/marker) ⭐ 2,091 | 🐛 49 | 🌐 Python | 📅 2024-04-06 - The terminal command palette.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,891 | 🐛 3 | 🌐 Rust | 📅 2026-09-08 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,205 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,205 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,318 | 🐛 218 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 889 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - Terminal mail client.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,185 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,941 | 🐛 14 | 🌐 C++ | 📅 2026-08-30 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,723 | 🐛 78 | 🌐 Go | 📅 2026-09-06 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,371 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,006 | 🐛 15 | 🌐 Rust | 📅 2026-09-07 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 979 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [ZUSE](https://github.com/babycommando/zuse) ⭐ 324 | 🐛 1 | 🌐 Go | 📅 2025-07-28 - Minimal IRC client for the terminal written in Go with Bubbletea.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 69 | 🐛 15 | 🌐 Rust | 📅 2026-09-08 - TUI client for Nostr.
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,549 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Turn CLI tools into web applications; basically, it runs a command and starts a server so that the output can be displayed in a web page.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,326 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,954 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,489 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,732 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,533 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,900 | 🐛 149 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,689 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,877 | 🐛 82 | 🌐 Rust | 📅 2026-09-08 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,103 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,070 | 🐛 32 | 🌐 C | 📅 2026-09-03 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,001 | 🐛 19 | 🌐 Rust | 📅 2026-09-06 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,717 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,574 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - TUI for sniffing network traffic using eBPF on Linux.
...
* [Wishlist](https://github.com/charmbracelet/wishlist) ⭐ 1,661 | 🐛 19 | 🌐 Go | 📅 2026-09-01 - With Wishlist you can have a single entrypoint for multiple SSH endpoints.
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,596 | 🐛 23 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,557 | 🐛 20 | 🌐 Rust | 📅 2026-09-07 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,387 | 🐛 38 | 🌐 C | 📅 2026-08-24 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,235 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,996 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,842 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
...
* [goto](https://github.com/grafviktor/goto) ⭐ 533 | 🐛 12 | 🌐 Go | 📅 2026-09-07 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 189,712 | 🐛 2,636 | 🌐 Python | 📅 2026-08-30 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,155 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,951 | 🐛 1,177 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,275 | 🐛 2 | 🌐 Go | 📅 2026-09-06 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,672 | 🐛 544 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,918 | 🐛 182 | 🌐 Python | 📅 2026-09-06 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,446 | 🐛 1,140 | 🌐 Python | 📅 2026-09-04 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
...
* [tdl](https://github.com/iyear/tdl) ⭐ 8,042 | 🐛 186 | 🌐 Go | 📅 2026-09-07 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,070 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
...
* [tran](https://github.com/abdfnx/tran) ⭐ 448 | 🐛 10 | 🌐 Go | 📅 2026-02-16 - Securely transfer and send anything between computers with TUI.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,855 | 🐛 381 | 🌐 C++ | 📅 2026-09-06 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,227 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,481 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,951 | 🐛 169 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
...
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,832 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-09-08 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,654 | 🐛 126 | 🌐 C++ | 📅 2026-09-04 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [Bartib](https://github.com/nikolassv/bartib) ⭐ 846 | 🐛 19 | 🌐 Rust | 📅 2026-03-25 - Easy to use time tracking tool for the command line. It saves a log of all tracked activities as a plain-text file and allows you to create flexible reports.
...
* [utt](https://github.com/larose/utt) ⭐ 350 | 🐛 1 | 🌐 Python | 📅 2026-01-08 - Ultimate Time Tracker - A simple command-line time tracker written in Python.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,399 | 🐛 151 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,309 | 🐛 152 | 🌐 Python | 📅 2026-09-04 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,787 | 🐛 27 | 🌐 Go | 📅 2026-08-31 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,193 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,351 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 278 | 🐛 7 | 🌐 Rust | 📅 2026-09-08 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,857 | 🐛 829 | 🌐 TypeScript | 📅 2026-09-08 - It provides lightweight access to Gemini from the terminal.
...
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,435 | 🐛 101 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [parllama](https://github.com/paulrobello/parllama) ⭐ 486 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - TUI designed for easy management and use of Ollama based LLMs.
...
* [DDQA](https://github.com/DataDog/ddqa) ⭐ 109 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Jira TUI to help with software releasestool for users of Jira to perform QA of anticipated releases of code on GitHub.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,827 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 165 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,680 | 🐛 110 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,911 | 🐛 41 | 🌐 Rust | 📅 2026-07-10 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,772 | 🐛 456 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,948 | 🐛 92 | 🌐 Go | 📅 2026-09-06 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 134 | 🐛 2 | 🌐 Rust | 📅 2026-09-08 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-07 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,233 | 🐛 520 | 🌐 Go | 📅 2026-09-07 - D2 is a modern diagram scripting language that turns text to diagrams.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,484 | 🐛 40 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,221 | 🐛 54 | 🌐 C | 📅 2026-09-06 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,315 | 🐛 29 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,810 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 417 | 🐛 9 | 🌐 Rust | 📅 2026-09-05 - A powerful Rust image optimization CLI tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,742 | 🐛 72 | 🌐 Python | 📅 2026-09-07 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,344 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,640 | 🐛 711 | 🌐 Python | 📅 2026-09-08 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,186 | 🐛 156 | 🌐 Rust | 📅 2026-09-08 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
...
* [RadioGoGo](https://github.com/Zi0P4tch0/RadioGoGo) ⭐ 165 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - Go-powered CLI to surf global radio waves with TUI.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,833 | 🐛 178 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,030 | 🐛 2 | 🌐 C | 📅 2026-09-07 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,030 | 🐛 2 | 🌐 C | 📅 2026-09-07 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,195 | 🐛 50 | 🌐 Rust | 📅 2026-09-08 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,234 | 🐛 7 | 🌐 Python | 📅 2026-09-07 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 617 | 🐛 43 | 🌐 Go | 📅 2026-09-02 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,389 | 🐛 510 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,268 | 🐛 35 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,400 | 🐛 18 | 🌐 C | 📅 2026-08-18 - Cross-platform Audio Visualizer.
...
* [ov](https://github.com/noborus/ov) ⭐ 2,017 | 🐛 30 | 🌐 Go | 📅 2026-09-07 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,555 | 🐛 15 | 🌐 Go | 📅 2026-08-30 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
...
* [reader](https://github.com/mrusme/reader) ⭐ 412 | 🐛 0 | 🌐 Go | 📅 2026-07-21 - Reader parses a web page for its actual content and displays it in nicely highlighted text on the command line
...
* [brows](https://github.com/rubysolo/brows) ⭐ 84 | 🐛 0 | 🌐 Go | 📅 2026-06-01 - CLI GitHub release browser.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,963 | 🐛 12 | 🌐 Rust | 📅 2026-09-07 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,833 | 🐛 174 | 🌐 Go | 📅 2026-09-01 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,779 | 🐛 10 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [ttystudio](https://github.com/chjj/ttystudio) ⭐ 3,234 | 🐛 20 | 🌐 JavaScript | 📅 2017-07-10 - Record your terminal and compile it to a GIF or APNG without any external dependencies, bash scripts, GIF concatenation, etc.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,054 | 🐛 445 | 🌐 Go | 📅 2026-09-07 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
* [StegCloak](https://github.com/kurolabs/stegcloak) ⭐ 3,883 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 - Hide secrets with invisible characters in plain text securely using passwords
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,759 | 🐛 14 | 🌐 Rust | 📅 2026-09-07 - Manage your GnuPG keys with ease!
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,182 | 🐛 0 | 🌐 Go | 📅 2026-09-07 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,104 | 🐛 95 | 🌐 Go | 📅 2026-09-03 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 945 | 🐛 4 | 🌐 Go | 📅 2026-08-19 - A command-line tool for interacting with OAuth 2.0 authorization servers.
...
* [passage](https://github.com/FiloSottile/passage) ⭐ 1,188 | 🐛 34 | 🌐 Shell | 📅 2024-08-30 - A fork of [password-store](https://www.passwordstore.org) that uses [age](https://age-encryption.org) as a backend instead of GnuPG.
* [pa](https://github.com/biox/pa) ⭐ 562 | 🐛 3 | 🌐 Shell | 📅 2026-08-30 - A simple password manager; encryption via age, written in portable POSIX shell.
...
* [Autocomplete](https://github.com/withfig/autocomplete) ⭐ 25,222 | 🐛 195 | 🌐 TypeScript | 📅 2025-05-05 - IDE-style autocomplete for your existing terminal & shell.
* [Keep](https://github.com/keephq/keep) ⭐ 12,293 | 🐛 608 | 🌐 Python | 📅 2026-09-07 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,690 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 763 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing your arr servers.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,289 | 🐛 12 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,168 | 🐛 32 | 🌐 Rust | 📅 2026-08-27 - Play chess from your terminal.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,243 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,253 | 🐛 19 | 🌐 Rust | 📅 2026-09-07 - Turn your keyboard into a typewriter adding sounds at each keystroke.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,299 | 🐛 257 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,578 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,348 | 🐛 0 | 🌐 Shell | 📅 2026-09-05 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,518 | 🐛 105 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
