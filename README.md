...
* [eza](https://github.com/eza-community/eza) ⭐ 23,355 | 🐛 453 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,666 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,053 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,525 | 🐛 202 | 🌐 Rust | 📅 2026-09-20 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,274 | 🐛 14 | 🌐 C | 📅 2026-09-21 - A breadth-first version of the UNIX find command.
...
* [trash-cli](https://github.com/sindresorhus/trash-cli) ⭐ 1,415 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-18 - Move files and folders to the trash on Linux (XDG trash), macOS (`macOS-trash` library) and Windows (`recycle-bin` library).
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,465 | 🐛 187 | 🌐 C | 📅 2026-09-16 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,317 | 🐛 449 | 🌐 Rust | 📅 2026-09-19 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,924 | 🐛 287 | 🌐 Rust | 📅 2026-09-22 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,094 | 🐛 5 | 🌐 Perl | 📅 2026-09-19 - Make your diffs human-readable instead of machine-readable.
...
* [diff2html-cli](https://github.com/rtfpessoa/diff2html-cli) ⭐ 607 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-06 - Parse git diffs as JSON and generate pretty HTML.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,555 | 🐛 200 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,124 | 🐛 563 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 16,012 | 🐛 67 | 🌐 Rust | 📅 2026-09-24 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,855 | 🐛 80 | 🌐 Rust | 📅 2026-09-17 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,302 | 🐛 8 | 🌐 C++ | 📅 2026-09-21 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,364 | 🐛 79 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,297 | 🐛 18 | 🌐 Rust | 📅 2026-09-19 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
...
* [duf](https://github.com/muesli/duf) ⭐ 15,316 | 🐛 81 | 🌐 Go | 📅 2026-01-13 - Disk Usage/Free Utility.
* [Dust](https://github.com/bootandy/dust) ⭐ 12,296 | 🐛 10 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,295 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 6,003 | 🐛 49 | 🌐 Go | 📅 2026-09-23 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,134 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,732 | 🐛 546 | 🌐 C++ | 📅 2026-09-19 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,118 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,929 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,053 | 🐛 106 | 🌐 Rust | 📅 2026-09-23 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,023 | 🐛 134 | 🌐 C | 📅 2026-09-20 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,163 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,713 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,428 | 🐛 110 | 🌐 C | 📅 2026-09-19 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,383 | 🐛 63 | 🌐 Rust | 📅 2026-09-21 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,363 | 🐛 270 | 🌐 Go | 📅 2026-09-23 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 22,002 | 🐛 1 | 🌐 C | 📅 2026-09-21 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,521 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,732 | 🐛 102 | 🌐 Rust | 📅 2026-09-24 - Ranger-like terminal file manager written in Go with fuzzy search, tabs bulk rename, file preview, exit to current directory, themes and trash support.
...
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,725 | 🐛 26 | 🌐 C | 📅 2026-09-19 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,828 | 🐛 12 | 🌐 Rust | 📅 2026-09-23 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,767 | 🐛 96 | 🌐 Rust | 📅 2026-09-21 - Painless compression and decompression in the terminal.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,677 | 🐛 62 | 🌐 C | 📅 2026-09-16 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 186,680 | 🐛 694 | 🌐 Python | 📅 2026-09-21 - Python tool for converting files and office documents to Markdown.
* [unoserver](https://github.com/unoconv/unoserver) ⭐ 936 | 🐛 11 | 🌐 Python | 📅 2026-06-10 - Using LibreOffice as a server for converting documents, it allows converting multiple documents without loading libreoffice into memory every time.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-23 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,528 | 🐛 543 | 🌐 Rust | 📅 2026-09-20 - Cross-platform Text Expander written in Rust. Not limited to the command line.
* [Ultimate Plumber](https://github.com/akavel/up) ⭐ 8,845 | 🐛 30 | 🌐 Go | 📅 2024-09-05 - Helps to interactively and incrementally explore textual data in Linux, by making it easier to quickly build complex pipelines, thanks to a fast feedback loop.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,726 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,423 | 🐛 379 | 🌐 Python | 📅 2026-06-23.
...
* [Line Select](https://github.com/urbanogilson/lineselect) ⭐ 75 | 🐛 2 | 🌐 Rust | 📅 2026-09-22 - A powerful utility enabling interactive line selection from stdin, allowing to seamlessly integrate, pause, select, and refine your pipeline, enhancing data processing precision.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,805 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,753 | 🐛 49 | 🌐 Python | 📅 2026-09-21 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
* [ttyplot](https://github.com/tenox7/ttyplot) ⭐ 1,380 | 🐛 12 | 🌐 C | 📅 2026-07-28 - A realtime plotting utility for terminals with data input from stdin/pipe.
...
* [yq](https://github.com/mikefarah/yq) ⭐ 16,001 | 🐛 303 | 🌐 Go | 📅 2026-09-24 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,520 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,684 | 🐛 33 | 🌐 Python | 📅 2026-09-23 - Serializes the output of command line tools to JSON.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,807 | 🐛 16 | 🌐 Go | 📅 2026-09-23 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,773 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [underscore-cli](https://github.com/ddopson/underscore-cli) ⭐ 1,731 | 🐛 34 | 🌐 JavaScript | 📅 2020-11-02 - Command-line utility-belt for hacking JSON and JavaScript.
...
* [jsonpp](https://github.com/jmhodges/jsonpp) ⭐ 333 | 🐛 5 | 🌐 Go | 📅 2022-07-14 - A fast command line JSON pretty printer.
...
* [GROQ](https://github.com/sanity-io/groq-cli) ⭐ 236 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-24 - The CLI tool consumes both JSON and NDJSON documents. You can pass in data from a local file, or from piping to standard input.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,503 | 🐛 596 | 🌐 Go | 📅 2026-09-24 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,397 | 🐛 49 | 🌐 Python | 📅 2026-09-20 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,978 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,124 | 🐛 74 | 🌐 Go | 📅 2026-09-23 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,027 | 🐛 72 | 🌐 Go | 📅 2026-09-23 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
* [textql](https://github.com/dinedal/textql) ⭐ 9,103 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,416 | 🐛 32 | 🌐 Python | 📅 2026-09-21 - The SQL IDE for Your Terminal.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,411 | 🐛 44 | 🌐 Python | 📅 2026-09-21 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,345 | 🐛 15 | 🌐 Rust | 📅 2026-09-24 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,322 | 🐛 38 | 🌐 Go | 📅 2026-09-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,983 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,795 | 🐛 34 | 🌐 Rust | 📅 2026-09-24 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,795 | 🐛 34 | 🌐 Rust | 📅 2026-09-24 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,305 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,237 | 🐛 11 | 🌐 Go | 📅 2026-09-09 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,118 | 🐛 17 | 🌐 Rust | 📅 2026-09-23 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,171 | 🐛 129 | 🌐 Python | 📅 2026-09-22 - Python CLI utility and library for manipulating SQLite databases.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,226 | 🐛 331 | 🌐 Go | 📅 2026-09-21 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,968 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,288 | 🐛 79 | 🌐 Rust | 📅 2026-09-23 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,443 | 🐛 235 | 🌐 Go | 📅 2026-09-22 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,167 | 🐛 657 | 🌐 Rust | 📅 2026-09-18 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,829 | 🐛 125 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,296 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 824 | 🐛 67 | 🌐 Python | 📅 2026-08-31 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,628 | 🐛 915 | 🌐 Go | 📅 2026-09-24 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,604 | 🐛 167 | 🌐 Rust | 📅 2026-09-23 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 703 | 🐛 0 | 🌐 Go | 📅 2026-09-23 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [aretext](https://github.com/aretext/aretext) ⭐ 285 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - Minimalist text editor with vim-compatible key bindings.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,627 | 🐛 1,053 | 🌐 Go | 📅 2026-09-23 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,457 | 🐛 483 | 🌐 Go | 📅 2026-09-23 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,515 | 🐛 346 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,111 | 🐛 93 | 🌐 Shell | 📅 2026-09-21 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,547 | 🐛 101 | 🌐 Go | 📅 2026-09-22 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,264 | 🐛 115 | 🌐 Rust | 📅 2026-09-18 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,051 | 🐛 63 | 🌐 Rust | 📅 2026-09-24 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,061 | 🐛 152 | 🌐 Go | 📅 2026-09-23 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,228 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [git absorb](https://github.com/tummychow/git-absorb) ⭐ 5,730 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - git commit --fixup, but automatic.
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,084 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - A utility tool powered by fzf for using git interactively.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,321 | 🐛 14 | 🌐 Rust | 📅 2026-09-08 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [fzf-git.sh](https://github.com/junegunn/fzf-git.sh) ⭐ 1,184 | 🐛 13 | 🌐 Shell | 📅 2026-09-24 - bash and zsh key bindings for Git objects, powered by fzf.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,719 | 🐛 1,268 | 🌐 Rust | 📅 2026-09-24 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,142 | 🐛 13 | 🌐 Rust | 📅 2026-09-23 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,476 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-23 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,276 | 🐛 795 | 🌐 Go | 📅 2026-09-24 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,068 | 🐛 403 | 🌐 JavaScript | 📅 2026-09-22 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 24,013 | 🐛 9 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,554 | 🐛 26 | 🌐 Perl | 📅 2026-09-20 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,937 | 🐛 247 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,372 | 🐛 415 | 🌐 Go | 📅 2026-09-23 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,256 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,773 | 🐛 28 | 🌐 Go | 📅 2026-09-21 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,439 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,141 | 🐛 441 | 🌐 Rust | 📅 2026-09-24 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,659 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 905 | 🐛 167 | 🌐 Rust | 📅 2026-09-24 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,106 | 🐛 319 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,665 | 🐛 82 | 🌐 Go | 📅 2026-09-22 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,372 | 🐛 415 | 🌐 Go | 📅 2026-09-23 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
...
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,540 | 🐛 4 | 🌐 Rust | 📅 2026-09-24 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,643 | 🐛 26 | 🌐 Go | 📅 2026-09-21 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,517 | 🐛 143 | 🌐 Go | 📅 2026-09-22 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 89 | 🌐 C | 📅 2026-09-21 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 89 | 🌐 C | 📅 2026-09-21 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,410 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,294 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
...
* [E1S](https://github.com/keidarcy/e1s) ⭐ 930 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - TUI for browsing and managing AWS ECS resources.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 396 | 🐛 12 | 🌐 Rust | 📅 2026-09-23 - A TUI tool designed for monitoring Kubernetes resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,575 | 🐛 340 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,496 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,443 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,926 | 🐛 7 | 🌐 Go | 📅 2026-09-21 - Domain Availability Research Tool.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,418 | 🐛 2 | 🌐 Rust | 📅 2026-09-23 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,137 | 🐛 1,891 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [mackup](https://github.com/lra/mackup) ⭐ 15,330 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
...
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,768 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [has](https://github.com/kdabir/has) ⭐ 824 | 🐛 14 | 🌐 Shell | 📅 2026-09-11 - Checks presence of various command line tools on the PATH and reports their installed version.
...
* [rs-env](https://github.com/sysid/rs-env) ⭐ 42 | 🐛 0 | 🌐 Rust | 📅 2026-09-23 - Hierarchical environment variable management, compiling the resulting set of from a hierarchical list of `<name>.env` files.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,483 | 🐛 255 | 🌐 Zig | 📅 2026-09-24 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 29,008 | 🐛 1,875 | 🌐 Rust | 📅 2026-09-21 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [dtach](https://github.com/crigler/dtach) ⭐ 744 | 🐛 20 | 🌐 C | 📅 2025-06-21 - A program written in C that emulates the detach feature of screen.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,518 | 🐛 1,942 | 🌐 Rust | 📅 2026-09-23 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,366 | 🐛 21 | 🌐 C++ | 📅 2026-09-24 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,366 | 🐛 21 | 🌐 C++ | 📅 2026-09-24 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,560 | 🐛 1,435 | 🌐 Rust | 📅 2026-09-24 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,382 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 283 | 🐛 65 | 🌐 C | 📅 2026-09-24 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-23 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,144 | 🐛 152 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,045 | 🐛 47 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,896 | 🐛 101 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,747 | 🐛 95 | 🌐 C | 📅 2026-09-23 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,747 | 🐛 95 | 🌐 C | 📅 2026-09-23 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,949 | 🐛 448 | 🌐 C | 📅 2026-09-24 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,099 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,587 | 🐛 106 | 🌐 Go | 📅 2025-07-10 - Cross-platform and fully-customizable TUI dashboard and widget library.
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,718 | 🐛 38 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,974 | 🐛 11 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,897 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,662 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,135 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,089 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,578 | 🐛 209 | 🌐 Rust | 📅 2026-09-22 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,076 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,293 | 🐛 86 | 🌐 Go | 📅 2026-09-23 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,599 | 🐛 215 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,939 | 🐛 301 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,840 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,244 | 🐛 70 | 🌐 Shell | 📅 2026-09-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 13,005 | 🐛 154 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,854 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,413 | 🐛 115 | 🌐 C | 📅 2026-09-17 - A window switcher, application launcher and dmenu replacement.
...
* [entr](https://github.com/eradman/entr) ⭐ 5,688 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,794 | 🐛 26 | 🌐 Go | 📅 2026-09-21 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,725 | 🐛 69 | 🌐 Rust | 📅 2026-09-23 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [dotbins](https://github.com/basnijholt/dotbins) ⭐ 273 | 🐛 27 | 🌐 Python | 📅 2026-09-21 - Keep updated binaries in your dotfiles.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,311 | 🐛 20 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,311 | 🐛 20 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,376 | 🐛 223 | 🌐 TypeScript | 📅 2026-09-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 891 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - Terminal mail client.
...
* [nmail](https://github.com/d99kris/nmail) ⭐ 260 | 🐛 0 | 🌐 C++ | 📅 2026-09-12 - nmail is a console-based email client for Linux and macOS with a user interface similar to alpine / pine.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,783 | 🐛 53 | 🌐 Go | 📅 2026-09-22 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,932 | 🐛 109 | 🌐 Java | 📅 2026-09-22 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
* [devzat](https://github.com/quackduck/devzat) ⭐ 4,069 | 🐛 25 | 🌐 Go | 📅 2026-07-23 - Custom SSH server that takes you to a chat instead of a shell prompt.
* [Sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,478 | 🐛 44 | 🌐 Python | 📅 2022-12-08 - CLI client for Slack.
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,153 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,966 | 🐛 20 | 🌐 C++ | 📅 2026-09-20 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,727 | 🐛 80 | 🌐 Go | 📅 2026-09-23 - A terminal based Matrix client written in Go.
...
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,153 | 🐛 22 | 🌐 Haskell | 📅 2026-08-25 - A terminal client for the Mattermost chat system.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,411 | 🐛 115 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,986 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,506 | 🐛 16 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,736 | 🐛 41 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,555 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,904 | 🐛 151 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,695 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,954 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - A network diagnostic tool.
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,729 | 🐛 21 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
* [tproxy](https://github.com/kevwan/tproxy) ⭐ 3,706 | 🐛 6 | 🌐 Go | 📅 2026-07-09 - A CLI tool to proxy and analyze TCP connections.
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,346 | 🐛 142 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,724 | 🐛 35 | 🌐 Go | 📅 2026-09-12 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
...
* [Tunnelmole](https://github.com/robbie-cahill/tunnelmole-client) ⭐ 1,892 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-13 - Connect to local servers from anywhere.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,859 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,613 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,563 | 🐛 4 | 🌐 Rust | 📅 2026-09-23 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,392 | 🐛 37 | 🌐 C | 📅 2026-09-19 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 544 | 🐛 0 | 🌐 Go | 📅 2026-09-19 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,015 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,863 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi networks and connections on Linux.
...
* [goto](https://github.com/grafviktor/goto) ⭐ 533 | 🐛 12 | 🌐 Go | 📅 2026-09-23 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,259 | 🐛 2,674 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,330 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,675 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,431 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,696 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,946 | 🐛 182 | 🌐 Python | 📅 2026-09-23 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,817 | 🐛 1,134 | 🌐 Python | 📅 2026-09-19 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,091 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,090 | 🐛 202 | 🌐 Go | 📅 2026-09-21 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,720 | 🐛 125 | 🌐 Go | 📅 2026-09-23 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,727 | 🐛 27 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,537 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,865 | 🐛 389 | 🌐 C++ | 📅 2026-09-23 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
...
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 701 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,988 | 🐛 175 | 🌐 Go | 📅 2026-09-22 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,559 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
...
* [STU](https://github.com/lusingander/stu) ⭐ 911 | 🐛 15 | 🌐 Rust | 📅 2026-04-30 - S3 Terminal UI, is a interactive terminal-based explorer for Amazon S3 (AWS S3).
...
* [Todoman](https://github.com/pimutils/todoman) ⭐ 596 | 🐛 113 | 🌐 Python | 📅 2026-05-25 - A simple, standards-based, CLI todo (aka: task) manager.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,663 | 🐛 126 | 🌐 C++ | 📅 2026-09-19 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,410 | 🐛 153 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,321 | 🐛 152 | 🌐 Python | 📅 2026-09-24 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,813 | 🐛 26 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 882 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Store your ideas without leaving the terminal.
...
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 537 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - Terminal-based markdown note manager.
...
* [sncli](https://github.com/insanum/sncli) ⭐ 432 | 🐛 34 | 🌐 Python | 📅 2025-06-01 - A Python application that gives you access to your Simplenote account via the command line.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,054 | 🐛 264 | 🌐 Python | 📅 2026-09-23 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,879 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
...
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,879 | 🐛 225 | 🌐 Python | 📅 2026-09-04 - CalDAV synchronization program.
...
* [khard](https://github.com/lucc/khard) ⭐ 672 | 🐛 35 | 🌐 Python | 📅 2026-09-07 - vCard address book written in Python. Supports CardDAV.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,236 | 🐛 34 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,907 | 🐛 17 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 338 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,139 | 🐛 819 | 🌐 TypeScript | 📅 2026-09-24 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 44,053 | 🐛 74 | 🌐 Go | 📅 2026-09-23 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,462 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,099 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,869 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,438 | 🐛 172 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [write good](https://github.com/btford/write-good) ⭐ 5,091 | 🐛 25 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English prose.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,691 | 🐛 130 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,917 | 🐛 40 | 🌐 Rust | 📅 2026-09-18 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,874 | 🐛 461 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,618 | 🐛 111 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,965 | 🐛 93 | 🌐 Go | 📅 2026-09-23 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [cmd-ai](https://github.com/BrodaNoel/cmd-ai) ⭐ 52 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-04 - Natural language shell command generator and executor powered by AI.
* [c0admin](https://github.com/mbrell/c0admin) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - A terminal-based AI assistant for Linux sysadmins. Uses the Gemini API.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,495 | 🐛 530 | 🌐 Go | 📅 2026-09-20 - D2 is a modern diagram scripting language that turns text to diagrams.
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,269 | 🐛 53 | 🌐 C | 📅 2026-09-23 - Terminal graphics for the 21 st century.
...
* [gowall](https://github.com/Achno/gowall) ⭐ 2,314 | 🐛 12 | 🌐 Go | 📅 2026-06-10 - A tool to convert a Wallpaper's color scheme / palette, image to pixel art, color palette extraction, image upsacling with Adversarial Networks  and more image processing features.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,051 | 🐛 36 | 🌐 C | 📅 2026-09-11 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,828 | 🐛 9 | 🌐 Python | 📅 2026-09-23 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 1,007 | 🐛 15 | 🌐 Python | 📅 2026-09-23 - AI-Powered Command-Line Photo Search Tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,798 | 🐛 72 | 🌐 Python | 📅 2026-09-22 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,508 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [Pyutube](https://github.com/Hetari/pyutube) ⭐ 80 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - A simple tool to download YouTube video shorts and playlist in just one click.
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,702 | 🐛 708 | 🌐 Python | 📅 2026-09-23 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,234 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,784 | 🐛 214 | 🌐 Rust | 📅 2026-09-21 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 597 | 🐛 19 | 🌐 Rust | 📅 2026-09-20 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-24 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [sonicradio](https://github.com/dancnb/sonicradio) ⭐ 85 | 🐛 5 | 🌐 Go | 📅 2026-01-23 - A TUI radio player making use of Radio Browser API and Bubbletea.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,845 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,103 | 🐛 1 | 🌐 C | 📅 2026-09-24 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,103 | 🐛 1 | 🌐 C | 📅 2026-09-24 - A command-line music player with gapless playback and simple playlist management.
...
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,819 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,265 | 🐛 9 | 🌐 Python | 📅 2026-09-24 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [neo](https://github.com/st3w/neo) ⭐ 963 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,557 | 🐛 518 | 🌐 Rust | 📅 2026-09-22 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,761 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,025 | 🐛 28 | 🌐 Go | 📅 2026-09-22 - Feature-rich terminal-based text viewer.
...
* [youtube-viewer](https://github.com/trizen/youtube-viewer) ⭐ 1,315 | 🐛 47 | 🌐 Perl | 📅 2026-06-15 - Lightweight application that searches and streams videos from YouTube.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 357 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 348 | 🐛 6 | 🌐 Rust | 📅 2026-08-27 - An TUI for exploring data of a Kafka cluster.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,995 | 🐛 13 | 🌐 Rust | 📅 2026-09-24 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,969 | 🐛 176 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,824 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,200 | 🐛 448 | 🌐 Go | 📅 2026-09-21 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,832 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,082 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,081 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,206 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,106 | 🐛 99 | 🌐 Go | 📅 2026-09-23 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 949 | 🐛 3 | 🌐 Go | 📅 2026-09-23 - A command-line tool for interacting with OAuth 2.0 authorization servers.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,500 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
* [passage](https://github.com/FiloSottile/passage) ⭐ 1,191 | 🐛 34 | 🌐 Shell | 📅 2024-08-30 - A fork of [password-store](https://www.passwordstore.org) that uses [age](https://age-encryption.org) as a backend instead of GnuPG.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,352 | 🐛 632 | 🌐 Python | 📅 2026-09-19 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,697 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [Python re(gex)? exercises](https://github.com/learnbyexample/TUI-apps/tree/main/PyRegexExercises) ⭐ 1,016 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - TUI application intended to help you practice Python regular expressions there are more than 100 exercises covering both the builtin re and third-party regex module.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 516 | 🐛 12 | 🌐 Go | 📅 2026-09-21 - Cross Platform tool to validate configuration files.
...
* [Raijin](https://github.com/MasonStooksbury/Raijin) ⭐ 173 | 🐛 2 | 🌐 Rust | 📅 2026-09-24 - A free, simple weather TUI that pulls data without the need for an API key, account, or subscription.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,322 | 🐛 14 | 🌐 Shell | 📅 2026-09-21 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
* [TUI apps](https://github.com/learnbyexample/TUI-apps) ⭐ 1,016 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - A repository containing a couple of one-script programs, mainly dedicated to training/learning CLI tools such as grep, awk, etc.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,050 | 🐛 12 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [Pokete](https://github.com/lxgr-linux/pokete) ⭐ 3,158 | 🐛 30 | 🌐 Python | 📅 2026-05-22 - A terminal based Pokemon like game.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,184 | 🐛 34 | 🌐 Rust | 📅 2026-09-17 - Play chess from your terminal.
* [Square Tic Tac Toe](https://github.com/learnbyexample/TUI-apps/tree/main/SquareTicTacToe) ⭐ 1,016 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - A game like Tic Tac Toe, but you have to form a square with 4 corners instead of a line.
* [gambit](https://github.com/maaslalani/gambit) ⭐ 903 | 🐛 10 | 🌐 Go | 📅 2024-01-25 - Chess board in your terminal.
* [DOOM-ASCII](https://github.com/wojciech-graj/doom-ascii) ⭐ 883 | 🐛 0 | 🌐 C | 📅 2026-09-11 - Text-based DOOM running in terminal without sound.
...
* [tty-solitaire](https://github.com/mpereira/tty-solitaire) ⭐ 362 | 🐛 24 | 🌐 C | 📅 2025-05-03 - Solitaire game for the terminal ncurses based.
...
* [Terminal Ping Pong](https://github.com/IshmamR/terminal.pong) ⭐ 36 | 🐛 0 | 🌐 Rust | 📅 2025-07-09 - A ping pong game in your terminal (play against AI opponent or a friend locally).
...
* [pokeget](https://github.com/talwat/pokeget-rs) ⭐ 299 | 🐛 5 | 🌐 Rust | 📅 2026-07-13 - A bash script you can use to display cool sprites of Pokemon in your terminal.
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 253 | 🐛 37 | 🌐 Python | 📅 2026-09-24 - Track conferences and meetups.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,667 | 🐛 187 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,453 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,713 | 🐛 45 | 📅 2026-09-22 - An awesome list dedicated to TUI programs.
