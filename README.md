...
* [eza](https://github.com/eza-community/eza) ⭐ 23,135 | 🐛 445 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,207 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,134 | 🐛 141 | 🌐 Rust | 📅 2026-08-31 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,042 | 🐛 107 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,294 | 🐛 199 | 🌐 Rust | 📅 2026-09-02 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,784 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
* [rip](https://github.com/nivekuil/rip) ⭐ 1,731 | 🐛 26 | 🌐 Rust | 📅 2024-04-08 - Move and restore items from the graveyard (by default, `/tmp/graveyard-$USER` if $XDG\_DATA\_HOME is not set and `$XDG_DATA_HOME/graveyard` otherwise)
...
* [gomi](https://github.com/babarot/gomi) ⭐ 567 | 🐛 2 | 🌐 Go | 📅 2026-06-07 - UNIX rm command with a safety net.
...
* [hiSHtory](https://github.com/ddworken/hishtory) ⭐ 3,115 | 🐛 63 | 🌐 Go | 📅 2026-03-18 - A better shell history that stores context (directory, succeeded or failed, how long it took, etc). The history is stored locally and end-to-end encrypted for syncing to other computers.
* [his](https://github.com/terroo/his) ⭐ 67 | 🐛 2 | 🌐 C++ | 📅 2025-07-24 - A command history utility with icons and colors that works on Windows and GNU/Linux.
...
* [atuin](https://github.com/ellie/atuin) ⭐ 24 | 🐛 0 | 📅 2026-02-10 - Atuin replaces your existing shell history with a SQLite database, and records additional context for your commands. Additionally, it provides optional and fully encrypted synchronization of your history between machines, via an Atuin server.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,070 | 🐛 434 | 🌐 Rust | 📅 2026-09-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,850 | 🐛 293 | 🌐 Rust | 📅 2026-09-02 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,086 | 🐛 4 | 🌐 Perl | 📅 2026-08-31 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,880 | 🐛 69 | 🌐 Go | 📅 2026-08-31 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,891 | 🐛 185 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,114 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,732 | 🐛 46 | 🌐 Rust | 📅 2026-09-02 - A CLI tool for code structural search, lint and rewriting.
...
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,269 | 🐛 9 | 🌐 C++ | 📅 2026-08-31 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [krep](https://github.com/davidesantangelo/krep) ⭐ 454 | 🐛 7 | 🌐 C | 📅 2026-08-25 - Blazingly fast text search tool with multiple algorithms (Boyer-Moore, KMP, Rabin-Karp), SIMD acceleration, multi-threading, and regex support. Outperforms traditional tools with memory-mapped I/O and hardware optimizations for who need rapid pattern matching at scale.
...
* [srgn](https://github.com/alexpovel/srgn) ⭐ 910 | 🐛 7 | 🌐 Rust | 📅 2026-09-01 - A code surgeon for precise text and code transplantation. A marriage of `tr`/`sed`, `rg` and `tree-sitter`.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,211 | 🐛 9 | 🌐 Rust | 📅 2026-08-19 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,215 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,957 | 🐛 53 | 🌐 Go | 📅 2026-09-02 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,124 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
* [erdtree](https://github.com/solidiquis/erdtree) ⭐ 2,596 | 🐛 36 | 🌐 Rust | 📅 2024-05-19 - A multithreaded file-tree visualizer and disk usage analyzer.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,380 | 🐛 532 | 🌐 C++ | 📅 2026-09-01 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,120 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,928 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,968 | 🐛 106 | 🌐 Rust | 📅 2026-09-03 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,957 | 🐛 147 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [procs](https://github.com/dalance/procs) ⭐ 6,151 | 🐛 43 | 🌐 Rust | 📅 2026-09-02 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,079 | 🐛 42 | 🌐 Python | 📅 2026-08-27 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,046 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
* [below](https://github.com/facebookincubator/below) ⭐ 2,499 | 🐛 32 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,689 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
* [radeontop](https://github.com/clbr/radeontop) ⭐ 916 | 🐛 50 | 🌐 C | 📅 2026-03-20 - View your AMD GPU utilization, both for the total activity percent and individual blocks.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,416 | 🐛 125 | 🌐 C | 📅 2026-09-02 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,890 | 🐛 67 | 🌐 Rust | 📅 2026-09-01 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,060 | 🐛 264 | 🌐 Go | 📅 2026-09-02 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,856 | 🐛 6 | 🌐 C | 📅 2026-09-01 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,484 | 🐛 84 | 🌐 Go | 📅 2026-08-25 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,722 | 🐛 26 | 🌐 C | 📅 2026-09-03 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,738 | 🐛 88 | 🌐 Rust | 📅 2026-09-02 - Painless compression and decompression in the terminal.
...
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,168 | 🐛 35 | 🌐 Rust | 📅 2026-09-01 - Executes commands in response to file modifications.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,652 | 🐛 61 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 177,848 | 🐛 816 | 🌐 Python | 📅 2026-09-03 - Python tool for converting files and office documents to Markdown.
...
* [lx](https://github.com/rasros/lx) ⭐ 52 | 🐛 0 | 🌐 Go | 📅 2026-08-30 - Convert arbitrary files into Markdown-fenced blocks for LLM context.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,404 | 🐛 533 | 🌐 Rust | 📅 2026-09-02 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [lolcat](https://github.com/busyloop/lolcat) ⭐ 6,568 | 🐛 33 | 🌐 Ruby | 📅 2024-03-05 - Ruby Gem to colorize the output of the cat command.
* [toolong](https://github.com/Textualize/toolong) ⭐ 3,942 | 🐛 37 | 🌐 Python | 📅 2024-08-05 - A terminal application to view, tail, merge, and search log files (plus JSONL).
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,716 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,312 | 🐛 373 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,346 | 🐛 5 | 🌐 Perl | 📅 2026-09-02 - Command line tool for URL parsing and manipulation.
...
* [awk](https://github.com/onetrueawk/awk) ⭐ 2,225 | 🐛 15 | 🌐 C | 📅 2026-08-19 - A historical, general-purpose text file processor, implements a domain-specific language designed for text processing and typically used as a data extraction and reporting tool.
...
* [trre](https://github.com/c0stya/trre) ⭐ 258 | 🐛 2 | 🌐 C | 📅 2025-09-25 - Transductive regular expressions: an extension of the regular expressions for text editing and a grep-like command line tool.
...
* [ROAPI](https://github.com/roapi/roapi) ⭐ 3,429 | 🐛 66 | 🌐 Rust | 📅 2026-03-25 - ROAPI automatically spins up read-only APIs for static datasets without requiring you to write a single line of code.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,024 | 🐛 6 | 🌐 Python | 📅 2026-09-03 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,617 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,916 | 🐛 297 | 🌐 Go | 📅 2026-09-03 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,502 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
...
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,741 | 🐛 22 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,833 | 🐛 24 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,343 | 🐛 684 | 🌐 Go | 📅 2026-09-03 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
...
* [usql](https://github.com/xo/usql) ⭐ 10,096 | 🐛 118 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,365 | 🐛 36 | 🌐 Python | 📅 2026-09-03 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,317 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,262 | 🐛 48 | 🌐 Go | 📅 2026-08-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,952 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,774 | 🐛 34 | 🌐 Rust | 📅 2026-09-03 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,774 | 🐛 34 | 🌐 Rust | 📅 2026-09-03 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,197 | 🐛 14 | 🌐 Go | 📅 2026-09-02 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,093 | 🐛 15 | 🌐 Rust | 📅 2026-09-01 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
...
* [Soul](https://github.com/thevahidal/soul) ⭐ 1,684 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-10 - A SQLite REST and real-time server.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,790 | 🐛 328 | 🌐 Go | 📅 2026-08-31 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,941 | 🐛 4 | 🌐 Rust | 📅 2026-09-02 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,237 | 🐛 82 | 🌐 Rust | 📅 2026-09-02 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,168 | 🐛 229 | 🌐 Go | 📅 2026-09-02 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,114 | 🐛 664 | 🌐 Rust | 📅 2026-09-02 - Create book from Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,509 | 🐛 972 | 🌐 Go | 📅 2026-09-03 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,533 | 🐛 173 | 🌐 Rust | 📅 2026-08-27 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [aretext](https://github.com/aretext/aretext) ⭐ 285 | 🐛 5 | 🌐 Go | 📅 2026-08-27 - Minimalist text editor with vim-compatible key bindings.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,927 | 🐛 1,028 | 🌐 Go | 📅 2026-09-02 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,082 | 🐛 475 | 🌐 Go | 📅 2026-08-26 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,460 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
...
* [tig](https://github.com/jonas/tig) ⭐ 13,318 | 🐛 232 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,467 | 🐛 100 | 🌐 Go | 📅 2026-09-02 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,206 | 🐛 117 | 🌐 Rust | 📅 2026-09-01 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,037 | 🐛 64 | 🌐 Rust | 📅 2026-09-02 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,018 | 🐛 178 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,071 | 🐛 10 | 🌐 Shell | 📅 2026-09-01 - A utility tool powered by fzf for using git interactively.
...
* [mergestat-lite](https://github.com/mergestat/mergestat-lite) ⭐ 3,520 | 🐛 46 | 🌐 Go | 📅 2026-09-03 - A command-line tool for running SQL queries on git repositories and related data sources.
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,310 | 🐛 13 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [fzf-git.sh](https://github.com/junegunn/fzf-git.sh) ⭐ 1,179 | 🐛 13 | 🌐 Shell | 📅 2026-08-06 - bash and zsh key bindings for Git objects, powered by fzf.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,350 | 🐛 1,223 | 🌐 Rust | 📅 2026-09-03 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,141 | 🐛 16 | 🌐 Rust | 📅 2026-09-01 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,170 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-03 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,875 | 🐛 682 | 🌐 Go | 📅 2026-09-02 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,016 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-03 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,951 | 🐛 6 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,497 | 🐛 26 | 🌐 Perl | 📅 2026-09-02 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,876 | 🐛 244 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,326 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Instant, easy, and predictable development environments.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,710 | 🐛 25 | 🌐 Go | 📅 2026-09-02 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,178 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,116 | 🐛 442 | 🌐 Rust | 📅 2026-09-03 - Developer environments you can take with you.
...
* [fastmod](https://github.com/facebookincubator/fastmod) ⭐ 1,925 | 🐛 16 | 🌐 Rust | 📅 2026-07-28 - A tool to assist you with large-scale codebase refactors, and it supports most of codemod's options. It is focused on improving the use case "I want to use interactive mode to make sure my regex is correct, and then I want to apply the regex everywhere".
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 13 | 🌐 Python | 📅 2026-09-03 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,072 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [mklicense](https://github.com/cezaraugusto/mklicense) ⭐ 207 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-27 - CLI tool for easily generating the text of the most common licenses.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,490 | 🐛 85 | 🌐 Go | 📅 2026-09-02 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,326 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,303 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,853 | 🐛 41 | 🌐 Go | 📅 2026-08-19 - Multi pod and container log tailing for Kubernetes.
...
* [OPS](https://github.com/nanovms/ops) ⭐ 1,513 | 🐛 144 | 🌐 Go | 📅 2026-08-23 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,189 | 🐛 86 | 🌐 C | 📅 2026-08-30 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,189 | 🐛 86 | 🌐 C | 📅 2026-08-30 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,394 | 🐛 8 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
...
* [ktop](https://github.com/vladimirvivien/ktop) ⭐ 1,105 | 🐛 11 | 🌐 Go | 📅 2026-07-03 - Tool that displays useful metrics information about nodes, pods, and other workload.
...
* [Ducker](https://github.com/robertpsoane/ducker) ⭐ 922 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - TUI for managing docker containers.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,479 | 🐛 335 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,459 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,352 | 🐛 84 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-09-02 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,224 | 🐛 10 | 🌐 Rust | 📅 2026-08-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,688 | 🐛 1,845 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [Llama Terminal Completion](https://github.com/adammpkins/llama-terminal-completion) ⭐ 192 | 🐛 1 | 🌐 Go | 📅 2026-05-31 - Application that interacts with the llama.cpp library to provide virtual assistant capabilities through the command line. It allows you to ask questions and receive intelligent responses, as well as generate Linux commands based on your prompts.
...
* [shy-sh](https://github.com/mceck/shy-sh) ⭐ 54 | 🐛 0 | 🌐 Python | 📅 2025-09-16 - Shell AI copilot.
...
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,687 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-02 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,745 | 🐛 77 | 🌐 Python | 📅 2026-08-29 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,001 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,280 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,047 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [systeroid](https://github.com/orhun/systeroid) ⭐ 1,467 | 🐛 17 | 🌐 Rust | 📅 2026-07-30 - A more powerful alternative to sysctl(8) with a terminal user interface.
...
* [damon](https://github.com/hashicorp/damon) ⭐ 486 | 🐛 10 | 🌐 Go | 📅 2026-08-24 - TUI interface for Hashicorp Nomad, it provides functionality to observe and interact with Nomad resources such as Jobs, Deployments, or Allocations.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,619 | 🐛 242 | 🌐 Zig | 📅 2026-09-03 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,715 | 🐛 1,833 | 🌐 Rust | 📅 2026-08-31 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,254 | 🐛 1,890 | 🌐 Rust | 📅 2026-08-31 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [mtm](https://github.com/deadpixi/mtm) ⭐ 1,222 | 🐛 43 | 🌐 C | 📅 2024-07-18 - Micro Terminal Multiplexer - Simple but usable, stable and minimalistic terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,408 | 🐛 1,423 | 🌐 Rust | 📅 2026-09-02 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,366 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [Cat9](https://github.com/letoram/cat9) ⭐ 525 | 🐛 3 | 🌐 Lua | 📅 2025-05-03 - Cat9 is a user shell script for LASH - a command-line shell that discriminates against terminal emulators, written in Lua.
* [oksh](https://github.com/ibara/oksh) ⭐ 454 | 🐛 17 | 🌐 C | 📅 2026-06-10 - Portable OpenBSD ksh.
* [ksh93](https://github.com/ksh93/ksh) ⭐ 280 | 🐛 72 | 🌐 C | 📅 2026-09-03 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-02 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,019 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,808 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,410 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
...
* [yank](https://github.com/mptre/yank) ⭐ 1,709 | 🐛 2 | 🌐 C | 📅 2026-07-16 - Reads input from stdin and display a selection interface that allows a field to be selected and copied to the clipboard.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,797 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,493 | 🐛 82 | 🌐 C | 📅 2026-09-03 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,493 | 🐛 82 | 🌐 C | 📅 2026-09-03 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,895 | 🐛 449 | 🌐 C | 📅 2026-09-03 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,071 | 🐛 104 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,671 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,860 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,647 | 🐛 7 | 🌐 Rust | 📅 2026-08-14 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,127 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,473 | 🐛 212 | 🌐 Rust | 📅 2026-09-02 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,066 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,277 | 🐛 92 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,519 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,708 | 🐛 297 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,834 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,087 | 🐛 69 | 🌐 Shell | 📅 2026-08-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,935 | 🐛 148 | 🌐 Go | 📅 2026-09-02 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,275 | 🐛 34 | 🌐 Go | 📅 2026-09-03 - A Docker manager for the terminal.
...
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 601 | 🐛 16 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,368 | 🐛 114 | 🌐 C | 📅 2026-09-01 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,315 | 🐛 20 | 🌐 Rust | 📅 2026-09-02 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,670 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,742 | 🐛 16 | 🌐 Go | 📅 2026-08-29 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,709 | 🐛 67 | 🌐 Rust | 📅 2026-08-29 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,887 | 🐛 3 | 🌐 Rust | 📅 2026-09-01 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,173 | 🐛 8 | 🌐 Rust | 📅 2026-08-29 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,173 | 🐛 8 | 🌐 Rust | 📅 2026-08-29 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,308 | 🐛 217 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 888 | 🐛 3 | 🌐 Rust | 📅 2026-09-02 - Terminal mail client.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,177 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,755 | 🐛 54 | 🌐 Go | 📅 2026-09-03 - A lightweight, secure, and feature-rich Discord terminal client.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,129 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-22 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,932 | 🐛 14 | 🌐 C++ | 📅 2026-08-30 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,720 | 🐛 74 | 🌐 Go | 📅 2026-09-01 - A terminal based Matrix client written in Go.
...
* [toxic](https://github.com/Jfreegman/toxic) ⭐ 1,305 | 🐛 19 | 🌐 C | 📅 2026-07-14 - A Tox-based instant messaging and video chat client.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 975 | 🐛 5 | 🌐 Python | 📅 2026-09-02 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,295 | 🐛 114 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,948 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,482 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,684 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,813 | 🐛 79 | 🌐 Rust | 📅 2026-09-03 - A network diagnostic tool.
...
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,109 | 🐛 48 | 🌐 C | 📅 2026-08-20 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,069 | 🐛 32 | 🌐 C | 📅 2026-09-03 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,989 | 🐛 19 | 🌐 Rust | 📅 2026-09-02 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,713 | 🐛 20 | 🌐 Rust | 📅 2026-08-23 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
* [tproxy](https://github.com/kevwan/tproxy) ⭐ 3,705 | 🐛 6 | 🌐 Go | 📅 2026-07-09 - A CLI tool to proxy and analyze TCP connections.
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,343 | 🐛 139 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,705 | 🐛 34 | 🌐 Go | 📅 2026-08-15 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,834 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
* [Wishlist](https://github.com/charmbracelet/wishlist) ⭐ 1,659 | 🐛 19 | 🌐 Go | 📅 2026-09-01 - With Wishlist you can have a single entrypoint for multiple SSH endpoints.
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,589 | 🐛 23 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,557 | 🐛 19 | 🌐 Rust | 📅 2026-09-02 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,231 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
...
* [neoss](https://github.com/PabloLec/neoss) ⭐ 229 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-31 - User-friendly and detailed socket statistics with a Terminal UI.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,988 | 🐛 16 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,827 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 188,595 | 🐛 2,616 | 🌐 Python | 📅 2026-08-30 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,089 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,900 | 🐛 1,175 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,205 | 🐛 1 | 🌐 Go | 📅 2026-09-01 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,659 | 🐛 544 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,903 | 🐛 182 | 🌐 Python | 📅 2026-09-02 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,389 | 🐛 1,157 | 🌐 Python | 📅 2026-08-29 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,051 | 🐛 38 | 🌐 Rust | 📅 2026-08-23 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,029 | 🐛 182 | 🌐 Go | 📅 2026-08-31 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,660 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,713 | 🐛 25 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,856 | 🐛 398 | 🌐 C++ | 📅 2026-09-02 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,225 | 🐛 7 | 🌐 Python | 📅 2026-09-01 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,474 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,936 | 🐛 167 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,540 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,830 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-09-03 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,648 | 🐛 124 | 🌐 C++ | 📅 2026-08-29 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
* [Timetrap](https://github.com/samg/timetrap) ⭐ 1,511 | 🐛 33 | 🌐 Ruby | 📅 2025-03-12 - A simple command line time tracker written in Ruby. It provides an easy-to-use command line interface for tracking what you spend your time on.
...
* [hours](https://github.com/dhth/hours) ⭐ 345 | 🐛 16 | 🌐 Go | 📅 2026-08-25 - A no-frills time tracking toolkit for command line nerds.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,390 | 🐛 151 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,306 | 🐛 151 | 🌐 Python | 📅 2026-08-31 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,412 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,077 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,782 | 🐛 26 | 🌐 Go | 📅 2026-08-31 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 876 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 777 | 🐛 23 | 🌐 Rust | 📅 2026-09-02 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 527 | 🐛 2 | 🌐 Rust | 📅 2026-08-25 - Terminal-based markdown note manager.
...
* [idea](https://github.com/IonicaBizau/idea) ⭐ 279 | 🐛 2 | 🌐 JavaScript | 📅 2025-02-13 - A lightweight tool for keeping ideas in a safe place quick and easy.
...
* [tdo](https://github.com/2KAbhishek/tdo) ⭐ 76 | 🐛 0 | 🌐 Shell | 📅 2026-08-29 - Fast and Simple Note Taking.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,188 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,047 | 🐛 261 | 🌐 Python | 📅 2026-08-31 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,870 | 🐛 224 | 🌐 Python | 📅 2026-08-20.
...
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,870 | 🐛 224 | 🌐 Python | 📅 2026-08-20 - CalDAV synchronization program.
...
* [Puffin](https://github.com/siddhantac/puffin) ⭐ 568 | 🐛 11 | 🌐 Go | 📅 2026-03-11 - A beautiful TUI dashboard for hledger.
* [cash-cli](https://github.com/xxczaki/cash-cli) ⭐ 266 | 🐛 16 | 🌐 JavaScript | 📅 2026-04-30 - Convert Currency Rates.
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 260 | 🐛 7 | 🌐 Rust | 📅 2026-09-03 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 91 | 🐛 3 | 🌐 Rust | 📅 2026-09-01 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,780 | 🐛 846 | 🌐 TypeScript | 📅 2026-09-03 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,759 | 🐛 69 | 🌐 Go | 📅 2026-09-03 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,422 | 🐛 100 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,071 | 🐛 104 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,810 | 🐛 77 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,372 | 🐛 176 | 🌐 C++ | 📅 2026-08-30 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-09-02 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,675 | 🐛 108 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,761 | 🐛 456 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,502 | 🐛 111 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,489 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,340 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,943 | 🐛 96 | 🌐 Go | 📅 2026-09-02 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,282 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
* [halp](https://github.com/orhun/halp) ⭐ 764 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - halp aims to help find the correct arguments for command-line tools by checking the predefined list of commonly used options/flags.
* [Wat](https://github.com/dthree/wat) ⭐ 509 | 🐛 18 | 🌐 JavaScript | 📅 2016-09-18 - Instant, central, community-built docs.
* [gocheat](https://github.com/Achno/gocheat) ⭐ 343 | 🐛 8 | 🌐 Go | 📅 2025-10-26 - Customizable TUI cheatsheet for keybindings, hotkeys, gestures and aliases.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 120 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [reTermAI](https://github.com/pie0902/reTermAI) ⭐ 54 | 🐛 0 | 🌐 Python | 📅 2025-07-06 - Smart command assistant for your terminal, using LLM.
...
* [c0admin](https://github.com/mbrell/c0admin) ⭐ 38 | 🐛 0 | 🌐 Python | 📅 2026-08-06 - A terminal-based AI assistant for Linux sysadmins. Uses the Gemini API.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 10 | 🐛 0 | 🌐 Zig | 📅 2026-09-02 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,128 | 🐛 543 | 🌐 Go | 📅 2026-09-02 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,666 | 🐛 258 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,231 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,482 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,202 | 🐛 54 | 🌐 C | 📅 2026-09-01 - Terminal graphics for the 21 st century.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,031 | 🐛 38 | 🌐 C | 📅 2026-08-20 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,802 | 🐛 4 | 🌐 Python | 📅 2026-08-30 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [figma-use](https://github.com/dannote/figma-use) ⭐ 595 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-03 - Control Figma from the command line with full read/write access for AI agents.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,728 | 🐛 83 | 🌐 Python | 📅 2026-09-02 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,483 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,648 | 🐛 11 | 🌐 Shell | 📅 2026-08-30 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 597 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,610 | 🐛 714 | 🌐 Python | 📅 2026-09-02 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,785 | 🐛 227 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,167 | 🐛 174 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,757 | 🐛 210 | 🌐 Rust | 📅 2026-08-31 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,736 | 🐛 169 | 🌐 C | 📅 2026-08-28 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-02 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,832 | 🐛 178 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,016 | 🐛 3 | 🌐 C | 📅 2026-09-02 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,016 | 🐛 3 | 🌐 C | 📅 2026-09-02 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,188 | 🐛 53 | 🌐 Rust | 📅 2026-09-02 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,219 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,354 | 🐛 424 | 🌐 Rust | 📅 2026-09-01 - A cat clone with syntax highlighting and Git integration.
...
* [ov](https://github.com/noborus/ov) ⭐ 2,013 | 🐛 29 | 🌐 Go | 📅 2026-09-01 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,552 | 🐛 15 | 🌐 Go | 📅 2026-08-30 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,953 | 🐛 12 | 🌐 Rust | 📅 2026-09-02 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,801 | 🐛 173 | 🌐 Go | 📅 2026-09-01 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,759 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,007 | 🐛 442 | 🌐 Go | 📅 2026-09-02 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [jdvrif](https://github.com/CleasbyCode/jdvrif) ⭐ 70 | 🐛 0 | 🌐 C++ | 📅 2026-09-02 - CLI tool to embed or extract files via a JPG image. Post and share your embedded JPG image on compatible sites.
...
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,050 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - A fast, simple, recursive content discovery tool written in Rust.
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,074 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,757 | 🐛 14 | 🌐 Rust | 📅 2026-08-26 - Manage your GnuPG keys with ease!
...
* [pgen](https://github.com/ctsrc/Pgen) ⭐ 142 | 🐛 5 | 🌐 Rust | 📅 2026-04-22 - Generate passphrases using the wordlists for random passphrases made by the EFF.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,466 | 🐛 97 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,272 | 🐛 584 | 🌐 Python | 📅 2026-09-02 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [Python re(gex)? exercises](https://github.com/learnbyexample/TUI-apps/tree/main/PyRegexExercises) ⭐ 1,012 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - TUI application intended to help you practice Python regular expressions there are more than 100 exercises covering both the builtin re and third-party regex module.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 516 | 🐛 11 | 🌐 Go | 📅 2026-09-02 - Cross Platform tool to validate configuration files.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,166 | 🐛 11 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
* [TUI apps](https://github.com/learnbyexample/TUI-apps) ⭐ 1,012 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - A repository containing a couple of one-script programs, mainly dedicated to training/learning CLI tools such as grep, awk, etc.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,165 | 🐛 31 | 🌐 Rust | 📅 2026-08-27 - Play chess from your terminal.
* [Square Tic Tac Toe](https://github.com/learnbyexample/TUI-apps/tree/main/SquareTicTacToe) ⭐ 1,012 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - A game like Tic Tac Toe, but you have to form a square with 4 corners instead of a line.
* [gambit](https://github.com/maaslalani/gambit) ⭐ 906 | 🐛 10 | 🌐 Go | 📅 2024-01-25 - Chess board in your terminal.
* [DOOM-ASCII](https://github.com/wojciech-graj/doom-ascii) ⭐ 877 | 🐛 0 | 🌐 C | 📅 2025-07-21 - Text-based DOOM running in terminal without sound.
* [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 733 | 🐛 5 | 🌐 Rust | 📅 2026-09-02 - P2P terminal game about spacepirates playing basketball across the galaxy.
...
* [hollywood](https://github.com/dustinkirkland/hollywood) ⭐ 3,240 | 🐛 3 | 🌐 Shell | 📅 2026-07-06 - Runs a script turning your Linux terminal into a Hollywood style real-time hacking terminal.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,252 | 🐛 19 | 🌐 Rust | 📅 2026-08-17 - Turn your keyboard into a typewriter adding sounds at each keystroke.
* [boxes](https://github.com/ascii-boxes/boxes) ⭐ 686 | 🐛 0 | 🌐 C | 📅 2026-08-30 - Boxes is a command line filter program which draws ASCII art boxes around your input text.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,216 | 🐛 257 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,555 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,309 | 🐛 0 | 🌐 Shell | 📅 2026-09-02 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,450 | 🐛 100 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
