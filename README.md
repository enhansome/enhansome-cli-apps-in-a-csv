...
* [eza](https://github.com/eza-community/eza) ⭐ 22,946 | 🐛 425 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,170 | 🐛 206 | 🌐 Rust | 📅 2026-07-25 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,255 | 🐛 31 | 🌐 Rust | 📅 2026-08-10 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,662 | 🐛 135 | 🌐 Rust | 📅 2026-08-10 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,096 | 🐛 188 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,779 | 🐛 135 | 🌐 Rust | 📅 2026-04-14 - Intelligent context-aware search engine for your shell history with TUI.
...
* [hiSHtory](https://github.com/ddworken/hishtory) ⭐ 3,106 | 🐛 62 | 🌐 Go | 📅 2026-03-18 - A better shell history that stores context (directory, succeeded or failed, how long it took, etc). The history is stored locally and end-to-end encrypted for syncing to other computers.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,755 | 🐛 428 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,779 | 🐛 296 | 🌐 Rust | 📅 2026-08-14 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,080 | 🐛 4 | 🌐 Perl | 📅 2026-08-15 - Make your diffs human-readable instead of machine-readable.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,315 | 🐛 176 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,110 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,531 | 🐛 46 | 🌐 Rust | 📅 2026-08-14 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,803 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,239 | 🐛 7 | 🌐 C++ | 📅 2026-08-07 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,300 | 🐛 74 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,285 | 🐛 17 | 🌐 Rust | 📅 2026-08-15 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,124 | 🐛 11 | 🌐 Rust | 📅 2026-08-15 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,140 | 🐛 31 | 🌐 Rust | 📅 2026-08-15 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,899 | 🐛 70 | 🌐 Go | 📅 2026-08-13 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,920 | 🐛 142 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
* [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,917 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/macOS/FreeBSD resource monitor with a nice interface.
...
* [procs](https://github.com/dalance/procs) ⭐ 6,134 | 🐛 40 | 🌐 Rust | 📅 2026-08-10 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,067 | 🐛 38 | 🌐 Python | 📅 2026-08-15 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,489 | 🐛 34 | 🌐 Rust | 📅 2026-08-15 - A time traveling resource monitor for modern Linux systems
* [tiptop](https://github.com/nschloe/tiptop) ⭐ 2,122 | 🐛 25 | 🌐 Python | 📅 2025-09-04 - A command-line system monitoring tool in the spirit of top, written in Python. It displays various interesting system stats and graphs them. Works on all operating systems.
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,676 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [FClones](https://github.com/pkolaczk/fclones) ⭐ 2,890 | 🐛 99 | 🌐 Rust | 📅 2025-03-03 - Efficient Duplicate File Finder.
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,397 | 🐛 135 | 🌐 C | 📅 2026-08-15 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Dext](https://github.com/AfzGit/dext) ⭐ 16 | 🐛 1 | 🌐 Shell | 📅 2026-08-15 - (Directories by Extensions) is a script that moves (or copies) files of the same extension into a folder.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,362 | 🐛 66 | 🌐 Rust | 📅 2026-08-15 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,557 | 🐛 252 | 🌐 Go | 📅 2026-08-15 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,792 | 🐛 4 | 🌐 C | 📅 2026-08-15 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,467 | 🐛 79 | 🌐 Go | 📅 2026-08-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,719 | 🐛 107 | 🌐 Rust | 📅 2026-07-19 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,635 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,206 | 🐛 484 | 🌐 C++ | 📅 2026-08-15 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,717 | 🐛 26 | 🌐 C | 📅 2026-08-15 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,804 | 🐛 14 | 🌐 Rust | 📅 2026-08-15 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,736 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,710 | 🐛 99 | 🌐 Rust | 📅 2026-08-10 - Painless compression and decompression in the terminal.
...
* [Viddy](https://github.com/sachaos/viddy) ⭐ 5,397 | 🐛 33 | 🌐 Rust | 📅 2026-06-14 - Modern watch command. Time machine and pager etc.
* [reflex](https://github.com/cespare/reflex) ⭐ 3,549 | 🐛 28 | 🌐 Go | 📅 2026-02-26 - Reflex is a small tool to watch a directory and rerun a command when certain files change.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,432 | 🐛 4 | 🌐 Go | 📅 2026-06-22 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 173,933 | 🐛 864 | 🌐 Python | 📅 2026-07-29 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-08-15 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,292 | 🐛 532 | 🌐 Rust | 📅 2026-08-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,710 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,072 | 🐛 369 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,348 | 🐛 5 | 🌐 Perl | 📅 2026-07-16 - Command line tool for URL parsing and manipulation.
* [yek](https://github.com/bodo-run/yek) ⭐ 2,471 | 🐛 12 | 🌐 Rust | 📅 2026-06-29 - A fast Rust based tool to serialize text-based files in a repository or directory for LLM consumption.
...
* [awk](https://github.com/onetrueawk/awk) ⭐ 2,220 | 🐛 13 | 🌐 C | 📅 2026-04-26 - A historical, general-purpose text file processor, implements a domain-specific language designed for text processing and typically used as a data extraction and reporting tool.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,770 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,580 | 🐛 24 | 🌐 Go | 📅 2026-07-28 - Command-line JSON viewer.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,663 | 🐛 59 | 🌐 Python | 📅 2026-06-18 - Serializes the output of command line tools to JSON.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,795 | 🐛 13 | 🌐 Go | 📅 2026-07-20 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,712 | 🐛 24 | 🌐 Rust | 📅 2026-08-15 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,189 | 🐛 697 | 🌐 Go | 📅 2026-08-14 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,352 | 🐛 37 | 🌐 Python | 📅 2026-08-03 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,963 | 🐛 6 | 🌐 Python | 📅 2026-08-15 - A command line client for MySQL that can do autocompletion and syntax highlighting.
...
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,409 | 🐛 39 | 🌐 Python | 📅 2026-08-03 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,324 | 🐛 56 | 🌐 Python | 📅 2026-08-15 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,274 | 🐛 19 | 🌐 Rust | 📅 2026-08-08 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,216 | 🐛 52 | 🌐 Go | 📅 2026-07-26 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,933 | 🐛 57 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,755 | 🐛 30 | 🌐 Rust | 📅 2026-08-15 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,755 | 🐛 30 | 🌐 Rust | 📅 2026-08-15 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,290 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,185 | 🐛 13 | 🌐 Go | 📅 2026-08-14 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,076 | 🐛 15 | 🌐 Rust | 📅 2026-08-15 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,551 | 🐛 66 | 🌐 Go | 📅 2026-08-15 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,544 | 🐛 326 | 🌐 Go | 📅 2026-08-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,923 | 🐛 6 | 🌐 Rust | 📅 2026-08-11 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,179 | 🐛 80 | 🌐 Rust | 📅 2026-08-15 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 26,893 | 🐛 221 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,074 | 🐛 707 | 🌐 Rust | 📅 2026-08-15 - Create book from Markdown files.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,267 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,345 | 🐛 1,033 | 🌐 Go | 📅 2026-08-16 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,452 | 🐛 162 | 🌐 Rust | 📅 2026-08-13 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,360 | 🐛 1,018 | 🌐 Go | 📅 2026-08-15 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,743 | 🐛 463 | 🌐 Go | 📅 2026-07-29 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,396 | 🐛 335 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,095 | 🐛 98 | 🌐 Shell | 📅 2026-08-14 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,306 | 🐛 225 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,309 | 🐛 96 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
...
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,125 | 🐛 143 | 🌐 Rust | 📅 2026-08-04 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,158 | 🐛 79 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,061 | 🐛 12 | 🌐 Shell | 📅 2026-08-01 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,035 | 🐛 248 | 🌐 Shell | 📅 2026-08-11 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,923 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [fzf-git.sh](https://github.com/junegunn/fzf-git.sh) ⭐ 1,175 | 🐛 13 | 🌐 Shell | 📅 2026-08-06 - bash and zsh key bindings for Git objects, powered by fzf.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 30,987 | 🐛 1,197 | 🌐 Rust | 📅 2026-08-14 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,136 | 🐛 20 | 🌐 Rust | 📅 2026-08-16 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,868 | 🐛 131 | 🌐 TypeScript | 📅 2026-08-15 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,403 | 🐛 631 | 🌐 Go | 📅 2026-08-14 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,979 | 🐛 404 | 🌐 JavaScript | 📅 2026-08-08 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,882 | 🐛 4 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,436 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,812 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,275 | 🐛 490 | 🌐 Go | 📅 2026-08-15 - Instant, easy, and predictable development environments.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,624 | 🐛 30 | 🌐 Go | 📅 2026-08-11 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [blinkenlights](https://github.com/jart/blink) ⭐ 7,571 | 🐛 55 | 🌐 C | 📅 2025-12-10 - TUI that may be used for debugging x86\_64-linux or i8086 programs across platforms.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,385 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - A TUI for analyzing Linux binaries.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,093 | 🐛 446 | 🌐 Rust | 📅 2026-08-15 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,633 | 🐛 15 | 🌐 Python | 📅 2026-08-12 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 160 | 🌐 Rust | 📅 2026-08-15 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 595 | 🐛 1 | 🌐 Go | 📅 2026-08-16 - Update binaries installed by "go install" with goroutines.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 12 | 🌐 Python | 📅 2026-08-15 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Scrut](https://github.com/facebookincubator/scrut) ⭐ 82 | 🐛 8 | 🌐 Rust | 📅 2026-08-15 - A testing toolkit for CLI applications designed to rigorously test terminal programs, inspired by Cram and focuses on providing a straightforward way to validate CLI behaviour.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,057 | 🐛 310 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
* [readme-md-generator](https://github.com/kefranabg/readme-md-generator) ⭐ 11,126 | 🐛 30 | 🌐 JavaScript | 📅 2022-09-20 - CLI that generates beautiful README.md files.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,360 | 🐛 111 | 🌐 Go | 📅 2026-08-14 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,275 | 🐛 490 | 🌐 Go | 📅 2026-08-15 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,826 | 🐛 40 | 🌐 Go | 📅 2026-07-24 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,519 | 🐛 0 | 🌐 Rust | 📅 2026-08-15 - A simple and fast terminal dashboard for Kubernetes.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,381 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,289 | 🐛 12 | 🌐 Python | 📅 2024-07-09 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,199 | 🐛 12 | 🌐 Go | 📅 2026-08-14 - TUI for Podman environment.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,424 | 🐛 330 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,423 | 🐛 72 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,269 | 🐛 81 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,901 | 🐛 311 | 🌐 Python | 📅 2025-10-22 - Command line tool for managing Amazon S3 and CloudFront services.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,912 | 🐛 5 | 🌐 Go | 📅 2026-08-13 - Domain Availability Research Tool.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,213 | 🐛 9 | 🌐 Rust | 📅 2026-07-04 - TUI-based HTTP/REST client.
...
* [beachpatrol](https://github.com/sebastiancarlos/beachpatrol) ⭐ 918 | 🐛 4 | 🌐 JavaScript | 📅 2025-10-30 - A CLI tool to replace and automate your everyday web browser.
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-08-15 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,023 | 🐛 4 | 🌐 Rust | 📅 2026-08-15 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,248 | 🐛 1,801 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,305 | 🐛 168 | 🌐 Rust | 📅 2026-08-12 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,305 | 🐛 295 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,621 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,727 | 🐛 82 | 🌐 Python | 📅 2026-08-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,266 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,035 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 59,698 | 🐛 256 | 🌐 Zig | 📅 2026-08-16 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,376 | 🐛 1,810 | 🌐 Rust | 📅 2026-08-15 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 34,918 | 🐛 1,862 | 🌐 Rust | 📅 2026-08-13 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,274 | 🐛 1,417 | 🌐 Rust | 📅 2026-08-15 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,356 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 277 | 🐛 72 | 🌐 C | 📅 2026-08-16 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 52 | 🌐 C++ | 📅 2026-08-15 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,917 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,389 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,673 | 🐛 29 | 🌐 Shell | 📅 2026-08-13 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
...
* [pcopy](https://github.com/binwiederhier/pcopy) ⭐ 422 | 🐛 15 | 🌐 Go | 📅 2024-04-04 - A temporary file host, nopaste and clipboard across machines. It can be used from the Web UI, via a CLI or without a client by using curl.
* [pbproxy](https://github.com/nikvdp/pbproxy) ⭐ 257 | 🐛 0 | 🌐 Shell | 📅 2022-12-30 - Send your clipboard anywhere you can ssh to.
* [shcopy](https://github.com/aymanbagabas/shcopy) ⭐ 85 | 🐛 0 | 🌐 Go | 📅 2026-08-15 - Copy text to your system clipboard locally and remotely using ANSI OSC52 sequence.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,657 | 🐛 95 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,211 | 🐛 69 | 🌐 C | 📅 2026-08-15 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,211 | 🐛 69 | 🌐 C | 📅 2026-08-15 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,822 | 🐛 455 | 🌐 C | 📅 2026-08-05 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,058 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,634 | 🐛 35 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [kmon](https://github.com/orhun/kmon) ⭐ 2,933 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux TUI Kernel manager and activity monitor.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,083 | 🐛 9 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,962 | 🐛 11 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,807 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,109 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,397 | 🐛 209 | 🌐 Rust | 📅 2026-08-13 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,055 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,263 | 🐛 89 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,493 | 🐛 292 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,823 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,655 | 🐛 66 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,863 | 🐛 140 | 🌐 Go | 📅 2026-08-09 - Use any Linux distribution inside your terminal as docker or podman containers.
* [bocker](https://github.com/p8952/bocker) ⭐ 12,663 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in around 100 lines of bash.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,803 | 🐛 24 | 🌐 Rust | 📅 2026-07-24 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,322 | 🐛 116 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,290 | 🐛 18 | 🌐 Rust | 📅 2026-08-15 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,693 | 🐛 67 | 🌐 Rust | 📅 2026-07-20 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,677 | 🐛 21 | 🌐 Go | 📅 2026-08-01 - TUI for running apps and processes.
...
* [Steam TUI](https://github.com/dmadisetti/steam-tui) ⭐ 1,031 | 🐛 9 | 🌐 Rust | 📅 2026-03-12 - A simple TUI client for steamcmd, allows for the graphical launching, updating, and downloading of steam games through a simple terminal client.
...
* [sunbeam](https://github.com/pomdtr/sunbeam) ⭐ 551 | 🐛 10 | 🌐 Go | 📅 2025-05-30 - General purpose command-line launcher that defines UIs composed of a succession of views from simple scripts written in any language; a mix between an application launcher like `raycast` or `rofi` and a fuzzy-finder like `fzf` or `telescope`.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,883 | 🐛 3 | 🌐 Rust | 📅 2026-08-15 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,032 | 🐛 15 | 🌐 Rust | 📅 2026-08-15 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,032 | 🐛 15 | 🌐 Rust | 📅 2026-08-15 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,888 | 🐛 27 | 🌐 Go | 📅 2026-08-16 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,234 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-14 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
...
* [nmail](https://github.com/d99kris/nmail) ⭐ 254 | 🐛 0 | 🌐 C++ | 📅 2026-08-15 - nmail is a console-based email client for Linux and macOS with a user interface similar to alpine / pine.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,152 | 🐛 1,188 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,734 | 🐛 56 | 🌐 Go | 📅 2026-08-13 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,866 | 🐛 102 | 🌐 Java | 📅 2026-08-10 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,113 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-15 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,919 | 🐛 21 | 🌐 C++ | 📅 2026-08-15 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,710 | 🐛 74 | 🌐 Go | 📅 2026-08-14 - A terminal based Matrix client written in Go.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 987 | 🐛 15 | 🌐 Rust | 📅 2026-08-10 - A TUI for Telegram written in Rust.
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 940 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 853 | 🐛 474 | 🌐 Python | 📅 2026-08-16 - Official Zulip terminal client with TUI.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 750 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [ZUSE](https://github.com/babycommando/zuse) ⭐ 321 | 🐛 1 | 🌐 Go | 📅 2025-07-28 - Minimal IRC client for the terminal written in Go with Bubbletea.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,203 | 🐛 112 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,897 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,396 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,717 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,486 | 🐛 58 | 🌐 Rust | 📅 2026-08-02 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,895 | 🐛 150 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,488 | 🐛 79 | 🌐 Rust | 📅 2026-08-13 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,082 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,069 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,103 | 🐛 47 | 🌐 C | 📅 2026-08-02 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,853 | 🐛 14 | 🌐 Rust | 📅 2026-08-15 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,335 | 🐛 137 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,690 | 🐛 34 | 🌐 Go | 📅 2026-08-15 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,555 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - TUI for sniffing network traffic using eBPF on Linux.
...
* [asn](https://github.com/nitefood/asn) ⭐ 1,921 | 🐛 3 | 🌐 Shell | 📅 2026-06-22 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,569 | 🐛 25 | 🌐 Rust | 📅 2026-07-09 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,545 | 🐛 15 | 🌐 Rust | 📅 2026-08-15 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,380 | 🐛 38 | 🌐 C | 📅 2026-08-03 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
...
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,203 | 🐛 72 | 🌐 C | 📅 2026-08-15 - Ncurses SIP Messages flow viewer.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,956 | 🐛 20 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,782 | 🐛 6 | 🌐 Rust | 📅 2026-05-21 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,384 | 🐛 11 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 184,665 | 🐛 2,603 | 🌐 Python | 📅 2026-08-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,953 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,722 | 🐛 1,159 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 39,806 | 🐛 9 | 🌐 Go | 📅 2026-08-16 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,623 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,821 | 🐛 177 | 🌐 Python | 📅 2026-07-26 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,225 | 🐛 1,155 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,018 | 🐛 38 | 🌐 Rust | 📅 2026-07-26 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 7,926 | 🐛 210 | 🌐 Go | 📅 2026-08-14 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,622 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,708 | 🐛 25 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,529 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,045 | 🐛 6 | 🌐 Rust | 📅 2026-07-29 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,841 | 🐛 401 | 🌐 C++ | 📅 2026-08-14 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,214 | 🐛 9 | 🌐 Python | 📅 2026-08-16 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,369 | 🐛 89 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,904 | 🐛 163 | 🌐 Go | 📅 2026-08-12 - Feature-rich interactive Jira command line.
...
* [MAL-Cli](https://github.com/L4z3x/mal-cli) ⭐ 158 | 🐛 0 | 🌐 Rust | 📅 2025-07-17 - A terminal interface for the official myanimelist api written in Rust and Ratatui.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-16 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,936 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,640 | 🐛 125 | 🌐 C++ | 📅 2026-08-08 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [tim:r](https://github.com/sectore/timr) ⭐ 368 | 🐛 1 | 🌐 Rust | 📅 2026-08-15 - A TUI for organizing your time: Pomodoro Countdown counter.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,355 | 🐛 150 | 🌐 Shell | 📅 2026-08-13 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,041 | 🐛 263 | 🌐 Python | 📅 2026-08-10 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,860 | 🐛 222 | 🌐 Python | 📅 2026-07-10.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,335 | 🐛 8 | 🌐 Python | 📅 2026-06-17 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,860 | 🐛 222 | 🌐 Python | 📅 2026-07-10 - CalDAV synchronization program.
...
* [plann](https://github.com/tobixen/plann) ⭐ 81 | 🐛 10 | 🌐 Python | 📅 2026-08-16 - Command-line interface to online calendars.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,198 | 🐛 36 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,873 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,531 | 🐛 842 | 🌐 TypeScript | 📅 2026-08-16 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,450 | 🐛 63 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,353 | 🐛 94 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [Browser CLI](https://github.com/browsemake/browser-cli) ⭐ 46 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-16 - AI agent browser automation tool.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,058 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
* [h-m-m](https://github.com/nadrad/h-m-m) ⭐ 2,283 | 🐛 4 | 🌐 PHP | 📅 2026-07-06 - h-m-m (pronounced like the interjection "hmm") is a simple, fast, keyboard-centric terminal-based tool for working with mind maps.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,616 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,771 | 🐛 74 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,326 | 🐛 171 | 🌐 C++ | 📅 2026-08-16 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [write good](https://github.com/btford/write-good) ⭐ 5,076 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English prose.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,643 | 🐛 124 | 🌐 Rust | 📅 2026-03-13 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,908 | 🐛 40 | 🌐 Rust | 📅 2026-07-10 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 721 | 🐛 13 | 🌐 C | 📅 2026-05-17 - Base conversion and bit manipulator in ncurses.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,708 | 🐛 454 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,437 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,424 | 🐛 18 | 🌐 Rust | 📅 2026-08-14 - Very fast implementation of tldr in Rust.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,921 | 🐛 89 | 🌐 Go | 📅 2026-08-15 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [gocheat](https://github.com/Achno/gocheat) ⭐ 342 | 🐛 8 | 🌐 Go | 📅 2025-10-26 - Customizable TUI cheatsheet for keybindings, hotkeys, gestures and aliases.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 106 | 🐛 3 | 🌐 Rust | 📅 2026-08-15 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 10 | 🐛 0 | 🌐 Zig | 📅 2026-08-15 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 24,941 | 🐛 545 | 🌐 Go | 📅 2026-08-12 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,632 | 🐛 256 | 🌐 JavaScript | 📅 2026-08-15 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,218 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,453 | 🐛 36 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,137 | 🐛 57 | 🌐 C | 📅 2026-08-16 - Terminal graphics for the 21 st century.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,010 | 🐛 37 | 🌐 C | 📅 2026-04-01 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,784 | 🐛 4 | 🌐 Python | 📅 2026-08-11 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 991 | 🐛 17 | 🌐 Python | 📅 2026-08-11 - AI-Powered Command-Line Photo Search Tool.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 413 | 🐛 2 | 🌐 Rust | 📅 2026-08-15 - A powerful Rust image optimization CLI tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,691 | 🐛 74 | 🌐 Python | 📅 2026-08-12 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,472 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
* [ffscreencast](https://github.com/cytopia/ffscreencast) ⭐ 1,823 | 🐛 20 | 🌐 Shell | 📅 2024-07-16 - A FFmpeg screencast with video overlay and multi monitor support.
...
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 566 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [lotc](https://github.com/ranelpadon/lord-of-the-clips) ⭐ 69 | 🐛 1 | 🌐 Python | 📅 2023-02-20 - (Lord Of The Clips) Video downloader, trimmer, and merger using the terminal. Supports YouTube, Facebook, Reddit, Twitter, etc. Downloads/trims at multiple points. Merges multiple clips.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,298 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,544 | 🐛 707 | 🌐 Python | 📅 2026-08-15 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,780 | 🐛 226 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,071 | 🐛 162 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
...
* [PyRadio](https://github.com/coderholic/pyradio) ⭐ 1,089 | 🐛 11 | 🌐 Python | 📅 2026-05-07 - Curses based internet radio player.
...
* [Tera](https://github.com/shinokada/tera) ⭐ 165 | 🐛 17 | 🌐 Go | 📅 2026-04-09 - Terminal Radio: an easy-to-use CLI music player to play favorite music, radio stations and explore various radio stations from the terminal only.
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 157 | 🐛 1 | 🌐 Shell | 📅 2026-08-15 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [cue](https://github.com/ravachol/cue) ⭐ 2,975 | 🐛 1 | 🌐 C | 📅 2026-08-14 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,975 | 🐛 1 | 🌐 C | 📅 2026-08-14 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,172 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,157 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [neo](https://github.com/st3w/neo) ⭐ 948 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,190 | 🐛 420 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,256 | 🐛 34 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,346 | 🐛 17 | 🌐 C | 📅 2026-08-01 - Cross-platform Audio Visualizer.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,727 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 1,995 | 🐛 27 | 🌐 Go | 📅 2026-08-16 - Feature-rich terminal-based text viewer.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,379 | 🐛 12 | 🌐 Rust | 📅 2026-08-01 - Terminal image, video, directory, and Markdown viewer.
...
* [epy](https://github.com/wustho/epy) ⭐ 1,211 | 🐛 72 | 🌐 Python | 📅 2024-03-17 - CLI Ebook (epub2, epub3, fb2, mobi) Reader.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 348 | 🐛 15 | 🌐 Rust | 📅 2026-07-17 - Minimalistic Vim-like TUI document reader.
...
* [rfc\_reader](https://github.com/ozan2003/rfc_reader) ⭐ 72 | 🐛 0 | 🌐 Rust | 📅 2026-08-15 - A tool to read RFCs (Request for Comments) with a TUI, allowing you to fetch, cache, and browse RFC documents.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,924 | 🐛 13 | 🌐 Rust | 📅 2026-08-12 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,644 | 🐛 168 | 🌐 Go | 📅 2026-08-12 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,682 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,686 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
* [t-rec](https://github.com/sassman/t-rec-rs) ⭐ 1,248 | 🐛 27 | 🌐 Rust | 📅 2026-08-10 - Blazingly fast terminal recorder that generates animated GIF images for the web written in rust.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,824 | 🐛 438 | 🌐 Go | 📅 2026-08-10 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,804 | 🐛 0 | 🌐 C | 📅 2026-05-11 - A dead simple tool to sign files and verify digital signatures.
...
* [Image Steganography Tool](https://github.com/7thSamurai/steganography) ⭐ 1,083 | 🐛 1 | 🌐 C++ | 📅 2024-05-10 - Simple C++ Encryption and Steganography tool that uses Password-Protected-Encryption to secure a file's contents.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,754 | 🐛 13 | 🌐 Rust | 📅 2026-08-10 - Manage your GnuPG keys with ease!
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,179 | 🐛 0 | 🌐 Go | 📅 2026-07-28 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,097 | 🐛 98 | 🌐 Go | 📅 2026-08-15 - Tool for identifying risks in open source software supply chain.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,442 | 🐛 95 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
* [passage](https://github.com/FiloSottile/passage) ⭐ 1,183 | 🐛 34 | 🌐 Shell | 📅 2024-08-30 - A fork of [password-store](https://www.passwordstore.org) that uses [age](https://age-encryption.org) as a backend instead of GnuPG.
...
* [Autocomplete](https://github.com/withfig/autocomplete) ⭐ 25,217 | 🐛 195 | 🌐 TypeScript | 📅 2025-05-05 - IDE-style autocomplete for your existing terminal & shell.
* [Keep](https://github.com/keephq/keep) ⭐ 12,211 | 🐛 560 | 🌐 Python | 📅 2026-08-08 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,680 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,155 | 🐛 12 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,031 | 🐛 12 | 🌐 Python | 📅 2026-05-16 - A TUI based typing test app inspired by MonkeyType.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,581 | 🐛 35 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,148 | 🐛 30 | 🌐 Rust | 📅 2026-08-13 - Play chess from your terminal.
...
* [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 726 | 🐛 4 | 🌐 Rust | 📅 2026-08-08 - P2P terminal game about spacepirates playing basketball across the galaxy.
...
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 299 | 🐛 18 | 🌐 Python | 📅 2026-08-15 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
* [sudoku-rs](https://github.com/MitchelPaulin/sudoku-rs) ⭐ 31 | 🐛 0 | 🌐 Rust | 📅 2024-08-17 - Sudoku game for the terminal, built with tui-rs.
...
* [chadsay](https://github.com/agvxov/chadsay) ⭐ 89 | 🐛 0 | 🌐 Shell | 📅 2025-05-16 - Like cowsay, but pronounced by GigaChad.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,126 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,456 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,161 | 🐛 1 | 🌐 Shell | 📅 2026-08-04 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,188 | 🐛 15 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,194 | 🐛 64 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
