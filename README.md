...
* [eza](https://github.com/eza-community/eza) ⭐ 23,038 | 🐛 437 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,193 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,839 | 🐛 136 | 🌐 Rust | 📅 2026-08-24 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,202 | 🐛 190 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,781 | 🐛 136 | 🌐 Rust | 📅 2026-04-14 - Intelligent context-aware search engine for your shell history with TUI.
...
* [hiSHtory](https://github.com/ddworken/hishtory) ⭐ 3,113 | 🐛 63 | 🌐 Go | 📅 2026-03-18 - A better shell history that stores context (directory, succeeded or failed, how long it took, etc). The history is stored locally and end-to-end encrypted for syncing to other computers.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,856 | 🐛 430 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,819 | 🐛 298 | 🌐 Rust | 📅 2026-08-25 - Syntax-aware structured diff tool.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,593 | 🐛 182 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,642 | 🐛 45 | 🌐 Rust | 📅 2026-08-24 - A CLI tool for code structural search, lint and rewriting.
...
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,256 | 🐛 7 | 🌐 C++ | 📅 2026-08-24 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,324 | 🐛 77 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,181 | 🐛 8 | 🌐 Rust | 📅 2026-08-19 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,172 | 🐛 27 | 🌐 Rust | 📅 2026-08-25 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,929 | 🐛 56 | 🌐 Go | 📅 2026-08-24 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,216 | 🐛 529 | 🌐 C++ | 📅 2026-08-23 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,119 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,921 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,931 | 🐛 107 | 🌐 Rust | 📅 2026-08-26 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,941 | 🐛 147 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
* [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,921 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/macOS/FreeBSD resource monitor with a nice interface.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,122 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,142 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,070 | 🐛 39 | 🌐 Python | 📅 2026-08-19 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,493 | 🐛 32 | 🌐 Rust | 📅 2026-08-25 - A time traveling resource monitor for modern Linux systems
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,684 | 🐛 66 | 🌐 Rust | 📅 2026-08-25 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,838 | 🐛 258 | 🌐 Go | 📅 2026-08-20 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,830 | 🐛 4 | 🌐 C | 📅 2026-08-25 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 478 | 🌐 C++ | 📅 2026-08-25 - Linux port of Far v2 file manager.
...
* [tre](https://github.com/dduan/tre) ⭐ 1,218 | 🐛 23 | 🌐 Rust | 📅 2024-09-03 - `tree` command improved with git awareness, editor aliasing, and colors.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,723 | 🐛 98 | 🌐 Rust | 📅 2026-08-25 - Painless compression and decompression in the terminal.
* [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,545 | 🐛 68 | 🌐 C | 📅 2026-08-01 - Rotate, compress and mail logs.
...
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,133 | 🐛 28 | 🌐 Rust | 📅 2026-08-24 - Executes commands in response to file modifications.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,635 | 🐛 62 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 176,269 | 🐛 894 | 🌐 Python | 📅 2026-08-19 - Python tool for converting files and office documents to Markdown.
* [unoserver](https://github.com/unoconv/unoserver) ⭐ 931 | 🐛 9 | 🌐 Python | 📅 2026-06-10 - Using LibreOffice as a server for converting documents, it allows converting multiple documents without loading libreoffice into memory every time.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,354 | 🐛 535 | 🌐 Rust | 📅 2026-08-24 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,712 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,247 | 🐛 373 | 🌐 Python | 📅 2026-06-23.
...
* [ROAPI](https://github.com/roapi/roapi) ⭐ 3,420 | 🐛 66 | 🌐 Rust | 📅 2026-03-25 - ROAPI automatically spins up read-only APIs for static datasets without requiring you to write a single line of code.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,590 | 🐛 25 | 🌐 Go | 📅 2026-07-28 - Command-line JSON viewer.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,666 | 🐛 40 | 🌐 Python | 📅 2026-08-26 - Serializes the output of command line tools to JSON.
...
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,726 | 🐛 22 | 🌐 Rust | 📅 2026-08-19 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,266 | 🐛 707 | 🌐 Go | 📅 2026-08-25 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,367 | 🐛 41 | 🌐 Python | 📅 2026-08-24 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,967 | 🐛 2 | 🌐 Python | 📅 2026-08-25 - A command line client for MySQL that can do autocompletion and syntax highlighting.
...
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,002 | 🐛 68 | 🌐 Go | 📅 2026-08-25 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,349 | 🐛 41 | 🌐 Python | 📅 2026-08-26 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,292 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,242 | 🐛 47 | 🌐 Go | 📅 2026-08-22 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,941 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,766 | 🐛 28 | 🌐 Rust | 📅 2026-08-25 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,766 | 🐛 28 | 🌐 Rust | 📅 2026-08-25 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,190 | 🐛 15 | 🌐 Go | 📅 2026-08-18 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,089 | 🐛 17 | 🌐 Rust | 📅 2026-08-25 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,555 | 🐛 69 | 🌐 Go | 📅 2026-08-24 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,158 | 🐛 107 | 🌐 Python | 📅 2026-08-14 - Python CLI utility and library for manipulating SQLite databases.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,649 | 🐛 326 | 🌐 Go | 📅 2026-08-26 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,934 | 🐛 4 | 🌐 Rust | 📅 2026-08-22 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,209 | 🐛 83 | 🌐 Rust | 📅 2026-08-16 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,046 | 🐛 222 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,096 | 🐛 676 | 🌐 Rust | 📅 2026-08-22 - Create book from Markdown files.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 812 | 🐛 60 | 🌐 Python | 📅 2026-08-17 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,437 | 🐛 1,015 | 🌐 Go | 📅 2026-08-26 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,497 | 🐛 171 | 🌐 Rust | 📅 2026-08-25 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [ox](https://github.com/curlpipe/ox) ⭐ 3,734 | 🐛 33 | 🌐 Rust | 📅 2026-04-23 - An independent Rust text editor.
...
* [Turbo](https://github.com/magiblot/turbo) ⭐ 677 | 🐛 37 | 🌐 C++ | 📅 2026-08-14 - An experimental text editor for the terminal, based on Scintilla and Turbo Vision.
...
* [aretext](https://github.com/aretext/aretext) ⭐ 285 | 🐛 7 | 🌐 Go | 📅 2026-08-24 - Minimalist text editor with vim-compatible key bindings.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,633 | 🐛 1,026 | 🌐 Go | 📅 2026-08-26 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,959 | 🐛 463 | 🌐 Go | 📅 2026-08-19 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,432 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,098 | 🐛 98 | 🌐 Shell | 📅 2026-08-17 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,405 | 🐛 98 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
...
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,164 | 🐛 121 | 🌐 Rust | 📅 2026-08-22 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,032 | 🐛 65 | 🌐 Rust | 📅 2026-08-25 - Git repository summary on your terminal.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,304 | 🐛 11 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,191 | 🐛 1,218 | 🌐 Rust | 📅 2026-08-26 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,062 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-25 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,683 | 🐛 671 | 🌐 Go | 📅 2026-08-26 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,004 | 🐛 404 | 🌐 JavaScript | 📅 2026-08-22 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,917 | 🐛 6 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,462 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,853 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,303 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Instant, easy, and predictable development environments.
...
* [release-it](https://github.com/release-it/release-it) ⭐ 9,035 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,655 | 🐛 25 | 🌐 Go | 📅 2026-08-24 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,173 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,403 | 🐛 38 | 🌐 Rust | 📅 2026-08-23 - A TUI for analyzing Linux binaries.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,104 | 🐛 444 | 🌐 Rust | 📅 2026-08-25 - Developer environments you can take with you.
...
* [Kool](https://github.com/kool-dev/kool) ⭐ 724 | 🐛 9 | 🌐 Go | 📅 2026-08-15 - CLI tool that brings the complexities of modern software development making these environments lightweight, fast and reproducible.
* [gup](https://github.com/nao1215/gup) ⭐ 597 | 🐛 2 | 🌐 Go | 📅 2026-08-25 - Update binaries installed by "go install" with goroutines.
...
* [cargo-seek](https://github.com/tareqimbasher/cargo-seek) ⭐ 189 | 🐛 6 | 🌐 Rust | 📅 2026-08-12 - A TUI for searching, adding and installing cargo crates.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 13 | 🌐 Python | 📅 2026-08-25 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,068 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,433 | 🐛 98 | 🌐 Go | 📅 2026-08-25 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,303 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,846 | 🐛 41 | 🌐 Go | 📅 2026-08-19 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,526 | 🐛 3 | 🌐 Rust | 📅 2026-08-26 - A simple and fast terminal dashboard for Kubernetes.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,389 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,450 | 🐛 332 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,450 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,314 | 🐛 83 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,152 | 🐛 6 | 🌐 Rust | 📅 2026-08-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,488 | 🐛 1,828 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,476 | 🐛 170 | 🌐 Rust | 📅 2026-08-20 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,314 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,676 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-25 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,740 | 🐛 78 | 🌐 Python | 📅 2026-08-24 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,225 | 🐛 237 | 🌐 Zig | 📅 2026-08-25 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,551 | 🐛 1,826 | 🌐 Rust | 📅 2026-08-26 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,114 | 🐛 1,869 | 🌐 Rust | 📅 2026-08-25 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,336 | 🐛 1,437 | 🌐 Rust | 📅 2026-08-26 - A modern shell written in Rust, where all data is structured.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 279 | 🐛 72 | 🌐 C | 📅 2026-08-26 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 52 | 🌐 C++ | 📅 2026-08-25 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,974 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,031 | 🐛 44 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,732 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,371 | 🐛 77 | 🌐 C | 📅 2026-08-25 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,371 | 🐛 77 | 🌐 C | 📅 2026-08-25 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,850 | 🐛 457 | 🌐 C | 📅 2026-08-20 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,062 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,832 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [chdig](https://github.com/azat/chdig) ⭐ 292 | 🐛 5 | 🌐 Rust | 📅 2026-08-25 - Dig into ClickHouse with TUI interface.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,438 | 🐛 212 | 🌐 Rust | 📅 2026-08-24 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,061 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,492 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,609 | 🐛 296 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,824 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,716 | 🐛 68 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,903 | 🐛 144 | 🌐 Go | 📅 2026-08-21 - Use any Linux distribution inside your terminal as docker or podman containers.
* [bocker](https://github.com/p8952/bocker) ⭐ 12,667 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in around 100 lines of bash.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,267 | 🐛 27 | 🌐 Go | 📅 2026-08-21 - A Docker manager for the terminal.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,820 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
...
* [entr](https://github.com/eradman/entr) ⭐ 5,657 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,717 | 🐛 16 | 🌐 Go | 📅 2026-08-17 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,701 | 🐛 67 | 🌐 Rust | 📅 2026-08-25 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,887 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,106 | 🐛 5 | 🌐 Rust | 📅 2026-08-25 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,106 | 🐛 5 | 🌐 Rust | 📅 2026-08-25 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,280 | 🐛 208 | 🌐 TypeScript | 📅 2026-08-24 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 886 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - Terminal mail client.
...
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,884 | 🐛 107 | 🌐 Java | 📅 2026-08-21 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,719 | 🐛 73 | 🌐 Go | 📅 2026-08-25 - A terminal based Matrix client written in Go.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 68 | 🐛 5 | 🌐 Rust | 📅 2026-08-25 - TUI client for Nostr.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,262 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,919 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,426 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,722 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,506 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - oha is a tiny program that sends some load to a web application and show real-time TUI.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,526 | 🐛 77 | 🌐 Rust | 📅 2026-08-25 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,091 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,066 | 🐛 32 | 🌐 C | 📅 2026-08-20 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,932 | 🐛 17 | 🌐 Rust | 📅 2026-08-24 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,703 | 🐛 20 | 🌐 Rust | 📅 2026-08-23 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,553 | 🐛 19 | 🌐 Rust | 📅 2026-08-25 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,797 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - TUI for managing wifi networks and connections on Linux.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 186,933 | 🐛 2,602 | 🌐 Python | 📅 2026-08-25 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,030 | 🐛 4,128 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,819 | 🐛 1,175 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,096 | 🐛 3 | 🌐 Go | 📅 2026-08-25 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,654 | 🐛 546 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,871 | 🐛 180 | 🌐 Python | 📅 2026-08-26 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,323 | 🐛 1,150 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
...
* [tdl](https://github.com/iyear/tdl) ⭐ 7,978 | 🐛 182 | 🌐 Go | 📅 2026-08-24 - Beautiful and feature-rich Telegram downloader, written in Go.
* [ffsend](https://github.com/timvisee/ffsend) ⭐ 7,380 | 🐛 33 | 🌐 Rust | 📅 2025-11-20 - Easily and securely share files from the command line. A fully featured Firefox Send client.
* [zrok](https://github.com/openziti/zrok) ⭐ 4,642 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,223 | 🐛 7 | 🌐 Python | 📅 2026-08-25 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,915 | 🐛 162 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 807 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-26 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [zeit](https://github.com/mrusme/zeit) ⭐ 586 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - A command line tool for tracking time spent on activities.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,375 | 🐛 151 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,299 | 🐛 151 | 🌐 Python | 📅 2026-08-25 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,414 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,070 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
...
* [FuzPad](https://github.com/JianZcar/FuzPad) ⭐ 165 | 🐛 6 | 🌐 Shell | 📅 2025-11-12 - A minimalistic note management solution, powered by fzf.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,184 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,041 | 🐛 260 | 🌐 Python | 📅 2026-08-24 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,863 | 🐛 222 | 🌐 Python | 📅 2026-08-20.
...
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,863 | 🐛 222 | 🌐 Python | 📅 2026-08-20 - CalDAV synchronization program.
...
* [plann](https://github.com/tobixen/plann) ⭐ 81 | 🐛 14 | 🌐 Python | 📅 2026-08-16 - Command-line interface to online calendars.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,218 | 🐛 36 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,685 | 🐛 870 | 🌐 TypeScript | 📅 2026-08-26 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,530 | 🐛 65 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,062 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,792 | 🐛 75 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-08-25 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,667 | 🐛 107 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,911 | 🐛 40 | 🌐 Rust | 📅 2026-07-10 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,747 | 🐛 455 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,479 | 🐛 113 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,459 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,335 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [eg](https://github.com/srsudar/eg) ⭐ 2,039 | 🐛 15 | 🌐 Python | 📅 2025-02-06 - Useful examples at the command line.
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,936 | 🐛 102 | 🌐 Go | 📅 2026-08-25 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 9 | 🐛 0 | 🌐 Zig | 📅 2026-08-25 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,069 | 🐛 552 | 🌐 Go | 📅 2026-08-25 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,651 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-25 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,465 | 🐛 38 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,171 | 🐛 57 | 🌐 C | 📅 2026-08-21 - Terminal graphics for the 21 st century.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,797 | 🐛 4 | 🌐 Python | 📅 2026-08-25 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 992 | 🐛 18 | 🌐 Python | 📅 2026-08-25 - AI-Powered Command-Line Photo Search Tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,713 | 🐛 75 | 🌐 Python | 📅 2026-08-25 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,644 | 🐛 13 | 🌐 Shell | 📅 2026-08-19 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,318 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,582 | 🐛 712 | 🌐 Python | 📅 2026-08-25 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,122 | 🐛 166 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,741 | 🐛 210 | 🌐 Rust | 📅 2026-08-21 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [cue](https://github.com/ravachol/cue) ⭐ 2,991 | 🐛 3 | 🌐 C | 📅 2026-08-25 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,991 | 🐛 3 | 🌐 C | 📅 2026-08-25 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,179 | 🐛 49 | 🌐 Rust | 📅 2026-08-24 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,179 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,258 | 🐛 424 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,263 | 🐛 34 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,367 | 🐛 17 | 🌐 C | 📅 2026-08-18 - Cross-platform Audio Visualizer.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,732 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,009 | 🐛 31 | 🌐 Go | 📅 2026-08-25 - Feature-rich terminal-based text viewer.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,388 | 🐛 12 | 🌐 Rust | 📅 2026-08-22 - Terminal image, video, directory, and Markdown viewer.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 350 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 344 | 🐛 17 | 🌐 Rust | 📅 2026-08-18 - An TUI for exploring data of a Kafka cluster.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,937 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,729 | 🐛 170 | 🌐 Go | 📅 2026-08-24 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,731 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,705 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,923 | 🐛 443 | 🌐 Go | 📅 2026-08-24 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [PaperAge](https://github.com/matiaskorhonen/paper-age) ⭐ 613 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - Easy and secure paper backups of secrets, which takes a text and generates an encrypted QR code to print on paper.
...
* [jdvrif](https://github.com/CleasbyCode/jdvrif) ⭐ 69 | 🐛 0 | 🌐 C++ | 📅 2026-08-25 - CLI tool to embed or extract files via a JPG image. Post and share your embedded JPG image on compatible sites.
...
* [vet](https://github.com/safedep/vet) ⭐ 1,102 | 🐛 94 | 🌐 Go | 📅 2026-08-25 - Tool for identifying risks in open source software supply chain.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,248 | 🐛 572 | 🌐 Python | 📅 2026-08-24 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [Python re(gex)? exercises](https://github.com/learnbyexample/TUI-apps/tree/main/PyRegexExercises) ⭐ 1,014 | 🐛 1 | 🌐 Python | 📅 2026-02-02 - TUI application intended to help you practice Python regular expressions there are more than 100 exercises covering both the builtin re and third-party regex module.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 514 | 🐛 18 | 🌐 Go | 📅 2026-08-25 - Cross Platform tool to validate configuration files.
...
* [TUI apps](https://github.com/learnbyexample/TUI-apps) ⭐ 1,014 | 🐛 1 | 🌐 Python | 📅 2026-02-02 - A repository containing a couple of one-script programs, mainly dedicated to training/learning CLI tools such as grep, awk, etc.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,041 | 🐛 11 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [Square Tic Tac Toe](https://github.com/learnbyexample/TUI-apps/tree/main/SquareTicTacToe) ⭐ 1,014 | 🐛 1 | 🌐 Python | 📅 2026-02-02 - A game like Tic Tac Toe, but you have to form a square with 4 corners instead of a line.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,166 | 🐛 258 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,509 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,240 | 🐛 1 | 🌐 Shell | 📅 2026-08-22 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,327 | 🐛 89 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
