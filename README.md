...
* [eza](https://github.com/eza-community/eza) ⭐ 22,957 | 🐛 428 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,175 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,258 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,692 | 🐛 139 | 🌐 Rust | 📅 2026-08-17 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,037 | 🐛 107 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,115 | 🐛 188 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,257 | 🐛 14 | 🌐 C | 📅 2026-08-17 - A breadth-first version of the UNIX find command.
...
* [rip](https://github.com/nivekuil/rip) ⭐ 1,730 | 🐛 26 | 🌐 Rust | 📅 2024-04-08 - Move and restore items from the graveyard (by default, `/tmp/graveyard-$USER` if $XDG\_DATA\_HOME is not set and `$XDG_DATA_HOME/graveyard` otherwise)
* [trash-cli](https://github.com/sindresorhus/trash-cli) ⭐ 1,407 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-02 - Move files and folders to the trash on Linux (XDG trash), macOS (`macOS-trash` library) and Windows (`recycle-bin` library).
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,449 | 🐛 185 | 🌐 C | 📅 2026-05-29 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,779 | 🐛 427 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,789 | 🐛 296 | 🌐 Rust | 📅 2026-08-18 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,080 | 🐛 5 | 🌐 Perl | 📅 2026-08-17 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,871 | 🐛 69 | 🌐 Go | 📅 2026-08-17 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,351 | 🐛 177 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,103 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,563 | 🐛 48 | 🌐 Rust | 📅 2026-08-17 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,809 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,305 | 🐛 75 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [srgn](https://github.com/alexpovel/srgn) ⭐ 908 | 🐛 4 | 🌐 Rust | 📅 2026-08-04 - A code surgeon for precise text and code transplantation. A marriage of `tr`/`sed`, `rg` and `tree-sitter`.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,139 | 🐛 10 | 🌐 Rust | 📅 2026-08-18 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,144 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,903 | 🐛 46 | 🌐 Go | 📅 2026-08-18 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,115 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,051 | 🐛 528 | 🌐 C++ | 📅 2026-08-08 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,118 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,916 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,902 | 🐛 109 | 🌐 Rust | 📅 2026-08-18 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,926 | 🐛 144 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [gtop](https://github.com/aksakalli/gtop) ⭐ 9,928 | 🐛 42 | 🌐 JavaScript | 📅 2025-11-06 - System monitoring dashboard for terminal written in Node.js.
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,105 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,140 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - A modern replacement for ps written in Rust.
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,678 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [FClones](https://github.com/pkolaczk/fclones) ⭐ 2,902 | 🐛 99 | 🌐 Rust | 📅 2025-03-03 - Efficient Duplicate File Finder.
...
* [classifier](https://github.com/bhrigu123/classifier) ⭐ 1,101 | 🐛 25 | 🌐 Python | 📅 2022-03-07 - Organize files in your current directory, by classifying them into folders of music, PDFs, images, etc.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,435 | 🐛 67 | 🌐 Rust | 📅 2026-08-17 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,589 | 🐛 254 | 🌐 Go | 📅 2026-08-15 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,803 | 🐛 4 | 🌐 C | 📅 2026-08-17 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,464 | 🐛 80 | 🌐 Go | 📅 2026-08-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,718 | 🐛 107 | 🌐 Rust | 📅 2026-07-19 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,635 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,207 | 🐛 476 | 🌐 C++ | 📅 2026-08-17 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,717 | 🐛 26 | 🌐 C | 📅 2026-08-17 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,803 | 🐛 14 | 🌐 Rust | 📅 2026-08-17 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,737 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,713 | 🐛 99 | 🌐 Rust | 📅 2026-08-17 - Painless compression and decompression in the terminal.
* [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,544 | 🐛 63 | 🌐 C | 📅 2026-08-01 - Rotate, compress and mail logs.
...
* [ForkFS](https://github.com/SUPERCILEX/forkfs) ⭐ 87 | 🐛 1 | 🌐 Rust | 📅 2025-03-12 - ForkFS allows you to sandbox a process's changes to your file system.
* [lib-x](https://github.com/Benexl/lib-x) ⭐ 75 | 🐛 0 | 🌐 Shell | 📅 2026-08-17 - Browse your calibre library from the terminal.
...
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,120 | 🐛 46 | 🌐 Rust | 📅 2026-08-17 - Executes commands in response to file modifications.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,435 | 🐛 4 | 🌐 Go | 📅 2026-06-22 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,615 | 🐛 60 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 174,291 | 🐛 868 | 🌐 Python | 📅 2026-07-29 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,302 | 🐛 531 | 🌐 Rust | 📅 2026-08-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,710 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,079 | 🐛 370 | 🌐 Python | 📅 2026-06-23.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,784 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [yq](https://github.com/mikefarah/yq) ⭐ 15,844 | 🐛 291 | 🌐 Go | 📅 2026-08-06 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,497 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,664 | 🐛 59 | 🌐 Python | 📅 2026-06-18 - Serializes the output of command line tools to JSON.
* [dasel](https://github.com/TomWright/dasel) ⭐ 8,018 | 🐛 26 | 🌐 Go | 📅 2026-08-16 - Allows you to query and modify data structures using selector strings.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,203 | 🐛 709 | 🌐 Go | 📅 2026-08-18 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,353 | 🐛 38 | 🌐 Python | 📅 2026-08-03 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,961 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,078 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,001 | 🐛 69 | 🌐 Go | 📅 2026-08-17 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
* [textql](https://github.com/dinedal/textql) ⭐ 9,106 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,408 | 🐛 39 | 🌐 Python | 📅 2026-08-03 - A suite of command-line tools for converting to and working with CSV, the king of tabular file formats.
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,327 | 🐛 54 | 🌐 Python | 📅 2026-08-18 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,278 | 🐛 17 | 🌐 Rust | 📅 2026-08-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,221 | 🐛 52 | 🌐 Go | 📅 2026-07-26 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,934 | 🐛 57 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,757 | 🐛 26 | 🌐 Rust | 📅 2026-08-18 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,757 | 🐛 26 | 🌐 Rust | 📅 2026-08-18 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,185 | 🐛 13 | 🌐 Go | 📅 2026-08-17 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,077 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,551 | 🐛 67 | 🌐 Go | 📅 2026-08-16 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,151 | 🐛 104 | 🌐 Python | 📅 2026-08-14 - Python CLI utility and library for manipulating SQLite databases.
...
* [zsv](https://github.com/liquidaty/zsv) ⭐ 396 | 🐛 25 | 🌐 C | 📅 2026-08-17 - The world's fastest (simd) CSV parser, with an extensible, multi-purpose CLI.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,554 | 🐛 327 | 🌐 Go | 📅 2026-08-17 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,928 | 🐛 9 | 🌐 Rust | 📅 2026-08-17 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,181 | 🐛 80 | 🌐 Rust | 📅 2026-08-16 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 26,921 | 🐛 222 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,080 | 🐛 702 | 🌐 Rust | 📅 2026-08-17 - Create book from Markdown files.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 810 | 🐛 58 | 🌐 Python | 📅 2026-08-17 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,363 | 🐛 1,034 | 🌐 Go | 📅 2026-08-18 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,461 | 🐛 161 | 🌐 Rust | 📅 2026-08-17 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 693 | 🐛 1 | 🌐 Go | 📅 2026-08-17 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [aretext](https://github.com/aretext/aretext) ⭐ 285 | 🐛 5 | 🌐 Go | 📅 2026-08-17 - Minimalist text editor with vim-compatible key bindings.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,412 | 🐛 1,020 | 🌐 Go | 📅 2026-08-17 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,786 | 🐛 466 | 🌐 Go | 📅 2026-07-29 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,402 | 🐛 337 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,093 | 🐛 96 | 🌐 Shell | 📅 2026-08-17 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,315 | 🐛 96 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
...
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,132 | 🐛 144 | 🌐 Rust | 📅 2026-08-17 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,024 | 🐛 61 | 🌐 Rust | 📅 2026-08-17 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 9,996 | 🐛 176 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,173 | 🐛 79 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,062 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,036 | 🐛 250 | 🌐 Shell | 📅 2026-08-11 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
* [mergestat-lite](https://github.com/mergestat/mergestat-lite) ⭐ 3,518 | 🐛 45 | 🌐 Go | 📅 2026-08-17 - A command-line tool for running SQL queries on git repositories and related data sources.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,025 | 🐛 1,202 | 🌐 Rust | 📅 2026-08-18 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,917 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-17 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,457 | 🐛 642 | 🌐 Go | 📅 2026-08-18 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,985 | 🐛 404 | 🌐 JavaScript | 📅 2026-08-18 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,884 | 🐛 4 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,441 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,823 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,280 | 🐛 495 | 🌐 Go | 📅 2026-08-17 - Instant, easy, and predictable development environments.
...
* [release-it](https://github.com/release-it/release-it) ⭐ 9,028 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,388 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - A TUI for analyzing Linux binaries.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,096 | 🐛 444 | 🌐 Rust | 📅 2026-08-17 - Developer environments you can take with you.
* [PuDB](https://github.com/inducer/pudb) ⭐ 3,251 | 🐛 164 | 🌐 Python | 📅 2026-08-16 - Allows you to debug code right where you write and test it in a terminal.
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,634 | 🐛 15 | 🌐 Python | 📅 2026-08-12 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 163 | 🌐 Rust | 📅 2026-08-17 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 595 | 🐛 2 | 🌐 Go | 📅 2026-08-17 - Update binaries installed by "go install" with goroutines.
* [DevTUI](https://github.com/skatkov/devtui) ⭐ 553 | 🐛 41 | 🌐 Go | 📅 2026-08-17 - All-in-one terminal toolkit that consolidates everyday developer utilities into a unified TUI and CLI.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 12 | 🌐 Python | 📅 2026-08-17 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [umake](https://github.com/mcandre/unmake) ⭐ 119 | 🐛 66 | 🌐 Rust | 📅 2026-08-01 - Makefile linter emphasizing portability, targeting the POSIX make standard.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,056 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,375 | 🐛 119 | 🌐 Go | 📅 2026-08-17 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,280 | 🐛 495 | 🌐 Go | 📅 2026-08-17 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,828 | 🐛 40 | 🌐 Go | 📅 2026-07-24 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,520 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,634 | 🐛 25 | 🌐 Go | 📅 2026-08-17 - Tool for visualizing dynamic node usage within a kubernetes cluster.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,383 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,291 | 🐛 12 | 🌐 Python | 📅 2024-07-09 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,201 | 🐛 15 | 🌐 Go | 📅 2026-08-17 - TUI for Podman environment.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,430 | 🐛 331 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,428 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,273 | 🐛 81 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,844 | 🐛 74 | 🌐 Rust | 📅 2026-08-17 - Fast, async, resource-friendly link checker written in Rust.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,914 | 🐛 5 | 🌐 Go | 📅 2026-08-17 - Domain Availability Research Tool.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,048 | 🐛 5 | 🌐 Rust | 📅 2026-08-17 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,287 | 🐛 1,816 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,331 | 🐛 168 | 🌐 Rust | 📅 2026-08-12 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,308 | 🐛 295 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,640 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,730 | 🐛 88 | 🌐 Python | 📅 2026-08-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,269 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
...
* [killport](https://github.com/jkfran/killport) ⭐ 1,839 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 - A command-line tool to easily kill processes running on a specified port.
...
* [brightnessctl](https://github.com/Hummer12007/brightnessctl) ⭐ 1,255 | 🐛 24 | 🌐 C | 📅 2024-12-16 - Read and control device brightness. Devices, by default, include backlight and LEDs - searched for in corresponding classes.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 59,788 | 🐛 249 | 🌐 Zig | 📅 2026-08-17 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,408 | 🐛 1,811 | 🌐 Rust | 📅 2026-08-17 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,617 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,443 | 🐛 23 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 34,965 | 🐛 1,858 | 🌐 Rust | 📅 2026-08-17 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,278 | 🐛 1,424 | 🌐 Rust | 📅 2026-08-16 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,358 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
* [Oils](https://github.com/oilshell/oil) ⭐ 3,380 | 🐛 610 | 🌐 Python | 📅 2026-05-31 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [Twin](https://github.com/cosmos72/twin) ⭐ 1,055 | 🐛 37 | 🌐 C | 📅 2026-08-03 - Text mode window environment. A "retro" program for embedded or remote systems, that doubles as X11 terminal and text-mode equivalent of VNC server.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 52 | 🌐 C++ | 📅 2026-08-17 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,927 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
* [powerline](https://github.com/powerline/powerline) ⭐ 14,800 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - Powerline is a statusline plugin for vim, and provides statuslines and prompts for several other applications, including zsh, bash, tmux, IPython, Awesome and Qtile.
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,394 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,030 | 🐛 44 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,662 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,246 | 🐛 72 | 🌐 C | 📅 2026-08-18 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,246 | 🐛 72 | 🌐 C | 📅 2026-08-18 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,828 | 🐛 455 | 🌐 C | 📅 2026-08-05 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,055 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,636 | 🐛 36 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
* [noti](https://github.com/variadico/noti) ⚠️ Archived - Monitor a process and trigger a notification.
* [screenFetch](https://github.com/KittyKatt/screenFetch) ⭐ 4,071 | 🐛 169 | 🌐 Shell | 📅 2026-03-02 - It can be used to generate one of those nifty terminal theme information + ASCII distribution logos. It auto-detects the distribution and display an ASCII version of that distribution's logo and some valuable information to the right.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,084 | 🐛 9 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,810 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,065 | 🐛 29 | 🌐 Go | 📅 2026-08-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,407 | 🐛 208 | 🌐 Rust | 📅 2026-08-16 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,056 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,263 | 🐛 90 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,468 | 🐛 210 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,517 | 🐛 292 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,823 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,659 | 🐛 66 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,869 | 🐛 141 | 🌐 Go | 📅 2026-08-09 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,072 | 🐛 58 | 🌐 Go | 📅 2026-08-09 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
...
* [decompose](https://github.com/s0rg/decompose) ⭐ 140 | 🐛 7 | 🌐 Go | 📅 2026-07-31 - Reverse-engineering tool for docker environments.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,325 | 🐛 116 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,293 | 🐛 19 | 🌐 Rust | 📅 2026-08-16 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,696 | 🐛 67 | 🌐 Rust | 📅 2026-07-20 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,683 | 🐛 16 | 🌐 Go | 📅 2026-08-17 - TUI for running apps and processes.
...
* [Steam TUI](https://github.com/dmadisetti/steam-tui) ⭐ 1,032 | 🐛 9 | 🌐 Rust | 📅 2026-03-12 - A simple TUI client for steamcmd, allows for the graphical launching, updating, and downloading of steam games through a simple terminal client.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,885 | 🐛 3 | 🌐 Rust | 📅 2026-08-17 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,039 | 🐛 6 | 🌐 Rust | 📅 2026-08-16 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,039 | 🐛 6 | 🌐 Rust | 📅 2026-08-16 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,241 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-17 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 881 | 🐛 4 | 🌐 Rust | 📅 2026-08-14 - Terminal mail client.
...
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,870 | 🐛 102 | 🌐 Java | 📅 2026-08-17 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,116 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-16 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,920 | 🐛 20 | 🌐 C++ | 📅 2026-08-16 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,713 | 🐛 75 | 🌐 Go | 📅 2026-08-16 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,363 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
...
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,152 | 🐛 22 | 🌐 Haskell | 📅 2026-08-13 - A terminal client for the Mattermost chat system.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 987 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A TUI for Telegram written in Rust.
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 944 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 68 | 🐛 4 | 🌐 Rust | 📅 2026-08-17 - TUI client for Nostr.
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,542 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Turn CLI tools into web applications; basically, it runs a command and starts a server so that the output can be displayed in a web page.
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,520 | 🐛 211 | 🌐 Python | 📅 2026-08-17 - Transparent proxy server that works as a poor man's VPN. Forwards over ssh. Doesn't require admin. Works with Linux and macOS. Supports DNS tunneling.
* [gping](https://github.com/orf/gping) ⭐ 12,624 | 🐛 51 | 🌐 Rust | 📅 2026-08-10 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,212 | 🐛 112 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* [oha](https://github.com/hatoo/oha) ⭐ 10,493 | 🐛 58 | 🌐 Rust | 📅 2026-08-02 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,897 | 🐛 150 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,662 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,646 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,494 | 🐛 79 | 🌐 Rust | 📅 2026-08-13 - A network diagnostic tool.
* [dog](https://github.com/ogham/dog) ⭐ 6,687 | 🐛 79 | 🌐 Rust | 📅 2024-05-29 - dog is a command-line DNS client. It has colorful output, understands normal command-line argument syntax, supports the DNS-over-TLS and DNS-over-HTTPS protocols, and can emit JSON.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,861 | 🐛 14 | 🌐 Rust | 📅 2026-08-17 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,697 | 🐛 20 | 🌐 Rust | 📅 2026-03-09 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,690 | 🐛 33 | 🌐 Go | 📅 2026-08-15 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
...
* [Tunnelmole](https://github.com/robbie-cahill/tunnelmole-client) ⭐ 1,883 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-13 - Connect to local servers from anywhere.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,546 | 🐛 16 | 🌐 Rust | 📅 2026-08-17 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,203 | 🐛 73 | 🌐 C | 📅 2026-08-17 - Ncurses SIP Messages flow viewer.
...
* [ggh](https://github.com/byawitz/ggh) ⭐ 948 | 🐛 26 | 🌐 Go | 📅 2026-02-10 - Recall your SSH sessions, also searching your SSH config file.
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 527 | 🐛 0 | 🌐 Go | 📅 2026-07-25 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [SMBScan](https://github.com/jeffhacks/smbscan) ⭐ 49 | 🐛 18 | 🌐 Python | 📅 2026-08-18 - SMBScan is a tool to enumerate file shares on an internal network.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,957 | 🐛 21 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,781 | 🐛 6 | 🌐 Rust | 📅 2026-08-17 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,387 | 🐛 11 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [ssm](https://github.com/lfaoro/ssm) ⭐ 112 | 🐛 12 | 🌐 Go | 📅 2026-08-17 - SSH connection manager designed to connect, filter, tag, and much more from a simple terminal interface.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 185,141 | 🐛 2,598 | 🌐 Python | 📅 2026-08-17 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,970 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,736 | 🐛 1,159 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 39,861 | 🐛 5 | 🌐 Go | 📅 2026-08-17 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,629 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,825 | 🐛 177 | 🌐 Python | 📅 2026-08-17 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,246 | 🐛 1,158 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,022 | 🐛 38 | 🌐 Rust | 📅 2026-08-16 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 7,928 | 🐛 211 | 🌐 Go | 📅 2026-08-17 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,624 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
* [ytfzf](https://github.com/pystardust/ytfzf) ⭐ 4,141 | 🐛 66 | 🌐 Shell | 📅 2024-09-27 - A POSIX script that helps you find YouTube videos (without API) and opens/downloads them using mpv/youtube-dl.
* [curlie](https://github.com/rs/curlie) ⭐ 3,710 | 🐛 25 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,844 | 🐛 404 | 🌐 C++ | 📅 2026-08-17 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,217 | 🐛 9 | 🌐 Python | 📅 2026-08-17 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [toru](https://github.com/sweetbbak/toru) ⭐ 386 | 🐛 1 | 🌐 Go | 📅 2024-10-24 - BitTorrent streaming CLI tool to stream anime torrents in real-time with no waiting for downloads.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,444 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,904 | 🐛 163 | 🌐 Go | 📅 2026-08-17 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,528 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,816 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 800 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [av](https://github.com/aviator-co/av) ⭐ 509 | 🐛 72 | 🌐 Go | 📅 2026-08-18 - A command line tool to manage stacked PRs with Aviator.
...
* [Fjira](https://github.com/mk-5/fjira) ⭐ 272 | 🐛 22 | 🌐 Go | 📅 2026-07-07 - The fuzziest Jira command line tool in the world.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-18 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,937 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,106 | 🐛 130 | 🌐 Rust | 📅 2026-08-16 - A terminal user interface for taskwarrior.
...
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,375 | 🐛 6 | 🌐 Shell | 📅 2026-08-17 - A feature-rich clock/ timer/ pattern-based time manager in terminal with curated text-art.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,361 | 🐛 150 | 🌐 Shell | 📅 2026-08-13 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,294 | 🐛 149 | 🌐 Python | 📅 2026-08-14 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,764 | 🐛 24 | 🌐 Go | 📅 2026-08-03 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,756 | 🐛 171 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,041 | 🐛 263 | 🌐 Python | 📅 2026-08-17 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,862 | 🐛 222 | 🌐 Python | 📅 2026-07-10.
...
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,862 | 🐛 222 | 🌐 Python | 📅 2026-07-10 - CalDAV synchronization program.
...
* [Lakshmi](https://github.com/sarvjeets/lakshmi) ⭐ 148 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - Investing library and command-line interface inspired by the Bogleheads philosophy.
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 90 | 🐛 5 | 🌐 Rust | 📅 2026-08-17 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,545 | 🐛 797 | 🌐 TypeScript | 📅 2026-08-18 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,469 | 🐛 63 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,361 | 🐛 95 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,055 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [DDQA](https://github.com/DataDog/ddqa) ⭐ 109 | 🐛 3 | 🌐 Python | 📅 2026-08-17 - Jira TUI to help with software releasestool for users of Jira to perform QA of anticipated releases of code on GitHub.
...
* [hnjobs](https://github.com/mwinters0/hnjobs) ⭐ 38 | 🐛 0 | 🌐 Go | 📅 2025-09-10 - Console tool to find the best match on Who's Hiring.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,619 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,774 | 🐛 74 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,333 | 🐛 171 | 🌐 C++ | 📅 2026-08-16 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-08-17 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [write good](https://github.com/btford/write-good) ⭐ 5,078 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English prose.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 158 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,648 | 🐛 124 | 🌐 Rust | 📅 2026-03-13 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 721 | 🐛 13 | 🌐 C | 📅 2026-08-17 - Base conversion and bit manipulator in ncurses.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,716 | 🐛 455 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,449 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,433 | 🐛 14 | 🌐 Rust | 📅 2026-08-17 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,326 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,924 | 🐛 94 | 🌐 Go | 📅 2026-08-17 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,271 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 108 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 9 | 🐛 0 | 🌐 Zig | 📅 2026-08-17 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 24,942 | 🐛 547 | 🌐 Go | 📅 2026-08-12 - D2 is a modern diagram scripting language that turns text to diagrams.
...
* [MapSCII](https://github.com/rastapasta/mapscii) ⭐ 9,220 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Braille & ASCII world map renderer for your console
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,142 | 🐛 57 | 🌐 C | 📅 2026-08-17 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,302 | 🐛 28 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
* [GiF for CLI](https://github.com/google/gif-for-cli) ⚠️ Archived - Convert a GIF, short video or a query into ASCII art.
* [gowall](https://github.com/Achno/gowall) ⭐ 2,299 | 🐛 13 | 🌐 Go | 📅 2026-06-10 - A tool to convert a Wallpaper's color scheme / palette, image to pixel art, color palette extraction, image upsacling with Adversarial Networks  and more image processing features.
* [Diagon](https://github.com/ArthurSonzogni/Diagon) ⭐ 2,219 | 🐛 21 | 🌐 C++ | 📅 2025-05-16 - Diagon is an interactive interpreter, that transforms Markdown-style expression into an ASCII-art representation.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,787 | 🐛 4 | 🌐 Python | 📅 2026-08-18 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 415 | 🐛 2 | 🌐 Rust | 📅 2026-08-15 - A powerful Rust image optimization CLI tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,696 | 🐛 75 | 🌐 Python | 📅 2026-08-12 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,642 | 🐛 11 | 🌐 Shell | 📅 2026-08-17 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 579 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,303 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,552 | 🐛 707 | 🌐 Python | 📅 2026-08-18 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,080 | 🐛 163 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,729 | 🐛 211 | 🌐 Rust | 📅 2026-08-17 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,734 | 🐛 172 | 🌐 C | 📅 2026-08-16 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
* [Instant Music Downloader](https://github.com/yask123/Instant-Music-Downloader) ⭐ 1,444 | 🐛 48 | 🌐 Roff | 📅 2021-01-27 - Instantly download any song!
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 575 | 🐛 24 | 🌐 Rust | 📅 2026-08-09 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [cue](https://github.com/ravachol/cue) ⭐ 2,979 | 🐛 0 | 🌐 C | 📅 2026-08-14 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,979 | 🐛 0 | 🌐 C | 📅 2026-08-14 - A command-line music player with gapless playback and simple playlist management.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,163 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 611 | 🐛 43 | 🌐 Go | 📅 2026-08-17 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,196 | 🐛 420 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,729 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,002 | 🐛 28 | 🌐 Go | 📅 2026-08-17 - Feature-rich terminal-based text viewer.
...
* [viu](https://github.com/learn-anything/command-line-tools) ⭐ 492 | 🐛 14 | 📅 2026-08-16 - Command-line application to view images from the terminal written in Rust.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,928 | 🐛 13 | 🌐 Rust | 📅 2026-08-16 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,655 | 🐛 168 | 🌐 Go | 📅 2026-08-12 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,692 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [ttygif](https://github.com/icholy/ttygif) ⭐ 4,014 | 🐛 17 | 🌐 C | 📅 2025-08-02 - ttygif converts a ttyrec file into GIF files. It's a stripped down version of ttyplay that screenshots every frame.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,844 | 🐛 439 | 🌐 Go | 📅 2026-08-17 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,805 | 🐛 0 | 🌐 C | 📅 2026-05-11 - A dead simple tool to sign files and verify digital signatures.
...
* [sandsifter](https://github.com/xoreaxeaxeax/sandsifter) ⭐ 5,067 | 🐛 64 | 🌐 Python | 📅 2024-02-20 - The x86 processor fuzzer.
...
* [acmetool](https://github.com/hlandau/acmetool) ⭐ 2,091 | 🐛 72 | 🌐 Go | 📅 2023-05-27 - Easy-to-use command line tool for automatically acquiring certificates from ACME servers (such as Let's Encrypt).
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,443 | 🐛 95 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [oama](https://github.com/pdobsan/oama) ⭐ 255 | 🐛 10 | 🌐 Haskell | 📅 2025-08-29 - OAuth credential Manager.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,218 | 🐛 561 | 🌐 Python | 📅 2026-08-17 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 512 | 🐛 37 | 🌐 Go | 📅 2026-08-17 - Cross Platform tool to validate configuration files.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,156 | 🐛 11 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,031 | 🐛 11 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,583 | 🐛 35 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,151 | 🐛 29 | 🌐 Rust | 📅 2026-08-17 - Play chess from your terminal.
...
* [DOOM-ASCII](https://github.com/wojciech-graj/doom-ascii) ⭐ 876 | 🐛 0 | 🌐 C | 📅 2025-07-21 - Text-based DOOM running in terminal without sound.
...
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 300 | 🐛 15 | 🌐 Python | 📅 2026-08-17 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 254 | 🐛 36 | 🌐 Python | 📅 2026-08-17 - Track conferences and meetups.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,117 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,460 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,176 | 🐛 1 | 🌐 Shell | 📅 2026-08-17 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,222 | 🐛 72 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
