...
* [eza](https://github.com/eza-community/eza) ⭐ 22,952 | 🐛 425 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,174 | 🐛 207 | 🌐 Rust | 📅 2026-08-16 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,258 | 🐛 33 | 🌐 Rust | 📅 2026-08-17 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,680 | 🐛 137 | 🌐 Rust | 📅 2026-08-10 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,038 | 🐛 107 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
* [autojump](https://github.com/wting/autojump) ⭐ 16,957 | 🐛 231 | 🌐 Python | 📅 2025-02-27 - A cd command that maintains a database of most visited paths and allows the access to a directory with shortened versions of the path.
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,142 | 🐛 73 | 🌐 Lua | 📅 2026-08-10 - Directory changer that learns your habits.
* [enhancd](https://github.com/babarot/enhancd) ⭐ 2,710 | 🐛 17 | 🌐 Shell | 📅 2025-01-24 - A next-generation cd command with your interactive filter.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,106 | 🐛 187 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,257 | 🐛 13 | 🌐 C | 📅 2026-08-10 - A breadth-first version of the UNIX find command.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,448 | 🐛 185 | 🌐 C | 📅 2026-05-29 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
* [hiSHtory](https://github.com/ddworken/hishtory) ⭐ 3,107 | 🐛 62 | 🌐 Go | 📅 2026-03-18 - A better shell history that stores context (directory, succeeded or failed, how long it took, etc). The history is stored locally and end-to-end encrypted for syncing to other computers.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,769 | 🐛 428 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,782 | 🐛 297 | 🌐 Rust | 📅 2026-08-16 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,081 | 🐛 5 | 🌐 Perl | 📅 2026-08-16 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,871 | 🐛 69 | 🌐 Go | 📅 2026-08-14 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,332 | 🐛 177 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,102 | 🐛 564 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,549 | 🐛 47 | 🌐 Rust | 📅 2026-08-14 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,808 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,242 | 🐛 7 | 🌐 C++ | 📅 2026-08-17 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,301 | 🐛 74 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,133 | 🐛 14 | 🌐 Rust | 📅 2026-08-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,142 | 🐛 31 | 🌐 Rust | 📅 2026-08-16 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,903 | 🐛 70 | 🌐 Go | 📅 2026-08-13 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [erdtree](https://github.com/solidiquis/erdtree) ⭐ 2,595 | 🐛 36 | 🌐 Rust | 📅 2024-05-19 - A multithreaded file-tree visualizer and disk usage analyzer.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,013 | 🐛 527 | 🌐 C++ | 📅 2026-08-08 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,119 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,915 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,897 | 🐛 109 | 🌐 Rust | 📅 2026-08-17 - Yet another cross-platform graphical process/system monitor.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,922 | 🐛 144 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
* [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,915 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/macOS/FreeBSD resource monitor with a nice interface.
* [gtop](https://github.com/aksakalli/gtop) ⭐ 9,927 | 🐛 42 | 🌐 JavaScript | 📅 2025-11-06 - System monitoring dashboard for terminal written in Node.js.
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,104 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,139 | 🐛 41 | 🌐 Rust | 📅 2026-08-10 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,066 | 🐛 38 | 🌐 Python | 📅 2026-08-15 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
* [gputop](https://github.com/wookayin/gpustat) ⭐ 4,391 | 🐛 31 | 🌐 Python | 📅 2026-05-30 - A simple command-line utility for querying and monitoring GPU status.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,489 | 🐛 34 | 🌐 Rust | 📅 2026-08-16 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,675 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
* [radeontop](https://github.com/clbr/radeontop) ⭐ 913 | 🐛 50 | 🌐 C | 📅 2026-03-20 - View your AMD GPU utilization, both for the total activity percent and individual blocks.
* [ttop](https://github.com/inv2004/ttop) ⭐ 393 | 🐛 6 | 🌐 Nim | 📅 2026-08-16 - top-like system monitoring tool with TUI, historical data service and triggers.
...
* [FClones](https://github.com/pkolaczk/fclones) ⭐ 2,898 | 🐛 99 | 🌐 Rust | 📅 2025-03-03 - Efficient Duplicate File Finder.
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,398 | 🐛 134 | 🌐 C | 📅 2026-08-16 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Dext](https://github.com/AfzGit/dext) ⭐ 16 | 🐛 1 | 🌐 Shell | 📅 2026-08-16 - (Directories by Extensions) is a script that moves (or copies) files of the same extension into a folder.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,411 | 🐛 66 | 🌐 Rust | 📅 2026-08-16 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,573 | 🐛 253 | 🌐 Go | 📅 2026-08-15 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,794 | 🐛 4 | 🌐 C | 📅 2026-08-16 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,467 | 🐛 81 | 🌐 Go | 📅 2026-08-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,206 | 🐛 477 | 🌐 C++ | 📅 2026-08-16 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,717 | 🐛 26 | 🌐 C | 📅 2026-08-16 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,803 | 🐛 14 | 🌐 Rust | 📅 2026-08-15 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,711 | 🐛 97 | 🌐 Rust | 📅 2026-08-16 - Painless compression and decompression in the terminal.
...
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,117 | 🐛 61 | 🌐 Rust | 📅 2026-08-12 - Executes commands in response to file modifications.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,433 | 🐛 4 | 🌐 Go | 📅 2026-06-22 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 174,109 | 🐛 868 | 🌐 Python | 📅 2026-07-29 - Python tool for converting files and office documents to Markdown.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,297 | 🐛 531 | 🌐 Rust | 📅 2026-08-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
* [Ultimate Plumber](https://github.com/akavel/up) ⭐ 8,837 | 🐛 30 | 🌐 Go | 📅 2024-09-05 - Helps to interactively and incrementally explore textual data in Linux, by making it easier to quickly build complex pipelines, thanks to a fast feedback loop.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,710 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,076 | 🐛 370 | 🌐 Python | 📅 2026-06-23.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,779 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,579 | 🐛 24 | 🌐 Go | 📅 2026-07-28 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,839 | 🐛 287 | 🌐 Go | 📅 2026-08-06 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,499 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,664 | 🐛 59 | 🌐 Python | 📅 2026-06-18 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,133 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,795 | 🐛 14 | 🌐 Go | 📅 2026-07-20 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,711 | 🐛 24 | 🌐 Rust | 📅 2026-08-15 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,196 | 🐛 698 | 🌐 Go | 📅 2026-08-14 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,351 | 🐛 37 | 🌐 Python | 📅 2026-08-03 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,960 | 🐛 5 | 🌐 Python | 📅 2026-08-15 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,073 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 9,999 | 🐛 69 | 🌐 Go | 📅 2026-08-14 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,327 | 🐛 56 | 🌐 Python | 📅 2026-08-16 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,275 | 🐛 18 | 🌐 Rust | 📅 2026-08-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,218 | 🐛 52 | 🌐 Go | 📅 2026-07-26 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,933 | 🐛 57 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,756 | 🐛 26 | 🌐 Rust | 📅 2026-08-16 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,756 | 🐛 26 | 🌐 Rust | 📅 2026-08-16 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,291 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,185 | 🐛 16 | 🌐 Go | 📅 2026-08-14 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,078 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,551 | 🐛 66 | 🌐 Go | 📅 2026-08-16 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [zsv](https://github.com/liquidaty/zsv) ⭐ 396 | 🐛 25 | 🌐 C | 📅 2026-08-09 - The world's fastest (simd) CSV parser, with an extensible, multi-purpose CLI.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,549 | 🐛 327 | 🌐 Go | 📅 2026-08-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,926 | 🐛 6 | 🌐 Rust | 📅 2026-08-16 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,180 | 🐛 80 | 🌐 Rust | 📅 2026-08-16 - Blazing fast general purpose fuzzy finder TUI.
...
* [fzy](https://github.com/jhawthorn/fzy) ⭐ 3,294 | 🐛 57 | 🌐 C | 📅 2025-07-29 - Better fuzzy finder.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 26,909 | 🐛 222 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,077 | 🐛 709 | 🌐 Rust | 📅 2026-08-15 - Create book from Markdown files.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,266 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,354 | 🐛 1,034 | 🌐 Go | 📅 2026-08-17 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,455 | 🐛 162 | 🌐 Rust | 📅 2026-08-13 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [vis](https://github.com/martanne/vis) ⭐ 4,689 | 🐛 144 | 🌐 C | 📅 2026-08-17 - "a modern, legacy free, simple yet efficient vim-like editor", and more: "The intention is not to be bug for bug compatible with vim, instead a similar editing experience should be provided. The goal could thus be summarized as 80% of vim's features implemented in roughly 1% of the code"; the editor is scriptable in LUA and supports editing large files.
* [Amp](https://github.com/jmacdonald/amp) ⭐ 4,120 | 🐛 94 | 🌐 Rust | 📅 2026-06-10 - A complete text editor for your terminal.
* [ox](https://github.com/curlpipe/ox) ⭐ 3,730 | 🐛 33 | 🌐 Rust | 📅 2026-04-23 - An independent Rust text editor.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,386 | 🐛 1,019 | 🌐 Go | 📅 2026-08-16 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,762 | 🐛 464 | 🌐 Go | 📅 2026-07-29 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,399 | 🐛 335 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,313 | 🐛 96 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
...
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,128 | 🐛 146 | 🌐 Rust | 📅 2026-08-04 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,023 | 🐛 62 | 🌐 Rust | 📅 2026-08-17 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 9,985 | 🐛 175 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,163 | 🐛 79 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 6,997 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - A simple and efficient way to access various statistics in a git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,061 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,035 | 🐛 249 | 🌐 Shell | 📅 2026-08-11 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [ggc](https://github.com/bmf-san/ggc) ⭐ 284 | 🐛 1 | 🌐 Go | 📅 2026-08-17 - A modern Git CLI tool with both traditional command-line and interactive incremental-search UI.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,003 | 🐛 1,201 | 🌐 Rust | 📅 2026-08-17 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,890 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-16 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,423 | 🐛 631 | 🌐 Go | 📅 2026-08-17 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
...
* [air](https://github.com/air-verse/air) ⭐ 23,884 | 🐛 4 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,438 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,819 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,276 | 🐛 493 | 🌐 Go | 📅 2026-08-16 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,242 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,841 | 🐛 29 | 🌐 Python | 📅 2026-04-15 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,028 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,623 | 🐛 27 | 🌐 Go | 📅 2026-08-17 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,095 | 🐛 446 | 🌐 Rust | 📅 2026-08-15 - Developer environments you can take with you.
* [PuDB](https://github.com/inducer/pudb) ⭐ 3,250 | 🐛 164 | 🌐 Python | 📅 2026-08-16 - Allows you to debug code right where you write and test it in a terminal.
...
* [fastmod](https://github.com/facebookincubator/fastmod) ⭐ 1,924 | 🐛 16 | 🌐 Rust | 📅 2026-07-28 - A tool to assist you with large-scale codebase refactors, and it supports most of codemod's options. It is focused on improving the use case "I want to use interactive mode to make sure my regex is correct, and then I want to apply the regex everywhere".
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 161 | 🌐 Rust | 📅 2026-08-16 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 12 | 🌐 Python | 📅 2026-08-16 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Scrut](https://github.com/facebookincubator/scrut) ⭐ 82 | 🐛 8 | 🌐 Rust | 📅 2026-08-16 - A testing toolkit for CLI applications designed to rigorously test terminal programs, inspired by Cram and focuses on providing a straightforward way to validate CLI behaviour.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,057 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,370 | 🐛 112 | 🌐 Go | 📅 2026-08-14 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,276 | 🐛 493 | 🌐 Go | 📅 2026-08-16 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,827 | 🐛 40 | 🌐 Go | 📅 2026-07-24 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,520 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 - A simple and fast terminal dashboard for Kubernetes.
...
* [OPS](https://github.com/nanovms/ops) ⭐ 1,510 | 🐛 143 | 🌐 Go | 📅 2026-08-02 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,179 | 🐛 79 | 🌐 C | 📅 2026-08-09 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,179 | 🐛 79 | 🌐 C | 📅 2026-08-09 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,382 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,290 | 🐛 12 | 🌐 Python | 📅 2024-07-09 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,199 | 🐛 13 | 🌐 Go | 📅 2026-08-14 - TUI for Podman environment.
...
* [PUG](https://github.com/leg100/pug) ⭐ 693 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - TUI for Terraform (perform tasks in parallel, manage state resources, calculate costs, automatically loads workspace variable files).
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,426 | 🐛 330 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,424 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,270 | 🐛 81 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,913 | 🐛 5 | 🌐 Go | 📅 2026-08-13 - Domain Availability Research Tool.
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-08-17 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,036 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,273 | 🐛 1,806 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,318 | 🐛 168 | 🌐 Rust | 📅 2026-08-12 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,306 | 🐛 295 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,624 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,731 | 🐛 87 | 🌐 Python | 📅 2026-08-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 6,999 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,267 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,036 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
* [sysz](https://github.com/joehillen/sysz) ⭐ 1,884 | 🐛 5 | 🌐 Shell | 📅 2024-04-22 - fzf terminal UI for systemctl.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 59,746 | 🐛 255 | 🌐 Zig | 📅 2026-08-17 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,389 | 🐛 1,811 | 🌐 Rust | 📅 2026-08-15 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 34,939 | 🐛 1,864 | 🌐 Rust | 📅 2026-08-13 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,358 | 🐛 20 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,358 | 🐛 20 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,271 | 🐛 1,417 | 🌐 Rust | 📅 2026-08-16 - A modern shell written in Rust, where all data is structured.
...
* [Cat9](https://github.com/letoram/cat9) ⭐ 527 | 🐛 3 | 🌐 Lua | 📅 2025-05-03 - Cat9 is a user shell script for LASH - a command-line shell that discriminates against terminal emulators, written in Lua.
* [oksh](https://github.com/ibara/oksh) ⭐ 452 | 🐛 17 | 🌐 C | 📅 2026-06-10 - Portable OpenBSD ksh.
* [ksh93](https://github.com/ksh93/ksh) ⭐ 277 | 🐛 72 | 🌐 C | 📅 2026-08-17 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 53 | 🌐 C++ | 📅 2026-08-16 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,922 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,390 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,673 | 🐛 30 | 🌐 Shell | 📅 2026-08-13 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,660 | 🐛 96 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,229 | 🐛 70 | 🌐 C | 📅 2026-08-16 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,229 | 🐛 70 | 🌐 C | 📅 2026-08-16 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,825 | 🐛 455 | 🌐 C | 📅 2026-08-05 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,636 | 🐛 35 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
* [noti](https://github.com/variadico/noti) ⚠️ Archived - Monitor a process and trigger a notification.
* [screenFetch](https://github.com/KittyKatt/screenFetch) ⭐ 4,069 | 🐛 169 | 🌐 Shell | 📅 2026-03-02 - It can be used to generate one of those nifty terminal theme information + ASCII distribution logos. It auto-detects the distribution and display an ASCII version of that distribution's logo and some valuable information to the right.
* [kmon](https://github.com/orhun/kmon) ⭐ 2,933 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux TUI Kernel manager and activity monitor.
* [CoreFreq](https://github.com/cyring/CoreFreq) ⭐ 2,238 | 🐛 1 | 🌐 C | 📅 2026-08-16 - CPU monitoring TUI software designed for the 64-bits Processors.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,114 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,064 | 🐛 29 | 🌐 Go | 📅 2026-08-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,404 | 🐛 207 | 🌐 Rust | 📅 2026-08-16 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,055 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,262 | 🐛 90 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [Shell Bling Ubuntu](https://github.com/hiAndrewQuinn/shell-bling-ubuntu) ⭐ 230 | 🐛 5 | 🌐 Shell | 📅 2026-08-16 - A few scripts to be run on a fresh-off-the-presses Ubuntu VM, in order to get its shell nice 'n purdy.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,463 | 🐛 209 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,504 | 🐛 292 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,823 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,656 | 🐛 66 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,864 | 🐛 140 | 🌐 Go | 📅 2026-08-09 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,324 | 🐛 116 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,291 | 🐛 19 | 🌐 Rust | 📅 2026-08-16 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,648 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,694 | 🐛 67 | 🌐 Rust | 📅 2026-07-20 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,678 | 🐛 21 | 🌐 Go | 📅 2026-08-01 - TUI for running apps and processes.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,883 | 🐛 3 | 🌐 Rust | 📅 2026-08-16 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,033 | 🐛 6 | 🌐 Rust | 📅 2026-08-16 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,033 | 🐛 6 | 🌐 Rust | 📅 2026-08-16 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,890 | 🐛 27 | 🌐 Go | 📅 2026-08-16 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,236 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-14 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,153 | 🐛 1,188 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,870 | 🐛 102 | 🌐 Java | 📅 2026-08-10 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,114 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-16 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,919 | 🐛 20 | 🌐 C++ | 📅 2026-08-16 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,713 | 🐛 75 | 🌐 Go | 📅 2026-08-16 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,362 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,324 | 🐛 127 | 🌐 Python | 📅 2026-07-04 - Mastodon CLI & TUI.
* [toxic](https://github.com/Jfreegman/toxic) ⭐ 1,302 | 🐛 19 | 🌐 C | 📅 2026-07-14 - A Tox-based instant messaging and video chat client.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 941 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,540 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Turn CLI tools into web applications; basically, it runs a command and starts a server so that the output can be displayed in a web page.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,208 | 🐛 112 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,902 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,398 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,717 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,487 | 🐛 58 | 🌐 Rust | 📅 2026-08-02 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,896 | 🐛 150 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,492 | 🐛 78 | 🌐 Rust | 📅 2026-08-13 - A network diagnostic tool.
...
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,104 | 🐛 47 | 🌐 C | 📅 2026-08-02 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,065 | 🐛 33 | 🌐 C | 📅 2026-08-08 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,855 | 🐛 13 | 🌐 Rust | 📅 2026-08-16 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,336 | 🐛 137 | 🌐 C | 📅 2026-06-16 - mtr combines the functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,556 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - TUI for sniffing network traffic using eBPF on Linux.
...
* [asn](https://github.com/nitefood/asn) ⭐ 1,920 | 🐛 3 | 🌐 Shell | 📅 2026-06-22 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,545 | 🐛 16 | 🌐 Rust | 📅 2026-08-16 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 714 | 🐛 10 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 526 | 🐛 0 | 🌐 Go | 📅 2026-07-25 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,958 | 🐛 21 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,781 | 🐛 6 | 🌐 Rust | 📅 2026-05-21 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,385 | 🐛 11 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 184,904 | 🐛 2,603 | 🌐 Python | 📅 2026-08-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,975 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,730 | 🐛 1,159 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 39,834 | 🐛 9 | 🌐 Go | 📅 2026-08-16 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,628 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,823 | 🐛 177 | 🌐 Python | 📅 2026-07-26 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,238 | 🐛 1,157 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,020 | 🐛 38 | 🌐 Rust | 📅 2026-08-16 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,843 | 🐛 399 | 🌐 C++ | 📅 2026-08-16 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,216 | 🐛 8 | 🌐 Python | 📅 2026-08-16 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,416 | 🐛 89 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,526 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 799 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [av](https://github.com/aviator-co/av) ⭐ 508 | 🐛 75 | 🌐 Go | 📅 2026-08-14 - A command line tool to manage stacked PRs with Aviator.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-17 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [topydo](https://github.com/topydo/topydo) ⭐ 935 | 🐛 81 | 🌐 Python | 📅 2026-03-18 - A powerful todo list application for the console, using the todo.txt format.
...
* [Watson](https://github.com/TailorDev/Watson) ⭐ 2,535 | 🐛 142 | 🌐 Python | 📅 2025-12-15 - Time tracking CLI to know how much time you are spending on your projects. It can generate nice reports for clients.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,359 | 🐛 150 | 🌐 Shell | 📅 2026-08-13 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,762 | 🐛 24 | 🌐 Go | 📅 2026-08-03 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 873 | 🐛 8 | 🌐 Rust | 📅 2023-11-04 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 770 | 🐛 24 | 🌐 Rust | 📅 2026-08-16 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,178 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,042 | 🐛 263 | 🌐 Python | 📅 2026-08-10 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,861 | 🐛 222 | 🌐 Python | 📅 2026-07-10.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,336 | 🐛 8 | 🌐 Python | 📅 2026-06-17 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,861 | 🐛 222 | 🌐 Python | 📅 2026-07-10 - CalDAV synchronization program.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,201 | 🐛 36 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,874 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [stocksTUI](https://github.com/andriy-git/stocksTUI) ⭐ 157 | 🐛 2 | 🌐 Python | 📅 2026-07-09 - StocksTUI: Real-time stock market data in your terminal.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,536 | 🐛 848 | 🌐 TypeScript | 📅 2026-08-17 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,459 | 🐛 63 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,360 | 🐛 94 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [speedread](https://github.com/pasky/speedread) ⭐ 1,256 | 🐛 13 | 🌐 Perl | 📅 2024-06-11 - A simple terminal-based open source Spritz-alike filter that shows input text as a per-word RSVP (rapid serial visual presentation) aligned on optimal reading points.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,618 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,772 | 🐛 74 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,330 | 🐛 171 | 🌐 C++ | 📅 2026-08-16 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,645 | 🐛 124 | 🌐 Rust | 📅 2026-03-13 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,909 | 🐛 40 | 🌐 Rust | 📅 2026-07-10 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,713 | 🐛 454 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,445 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,432 | 🐛 15 | 🌐 Rust | 📅 2026-08-16 - Very fast implementation of tldr in Rust.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,923 | 🐛 94 | 🌐 Go | 📅 2026-08-16 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [docfd](https://github.com/darrenldl/docfd) ⭐ 288 | 🐛 4 | 🌐 OCaml | 📅 2026-08-17 - TUI fuzzy document finder that looks for documentation files in Markdown and txt format in the directory tree.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 107 | 🐛 2 | 🌐 Rust | 📅 2026-08-16 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 24,943 | 🐛 546 | 🌐 Go | 📅 2026-08-12 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,635 | 🐛 256 | 🌐 JavaScript | 📅 2026-08-16 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,455 | 🐛 37 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,139 | 🐛 57 | 🌐 C | 📅 2026-08-16 - Terminal graphics for the 21 st century.
...
* [gowall](https://github.com/Achno/gowall) ⭐ 2,300 | 🐛 13 | 🌐 Go | 📅 2026-06-10 - A tool to convert a Wallpaper's color scheme / palette, image to pixel art, color palette extraction, image upsacling with Adversarial Networks  and more image processing features.
* [Diagon](https://github.com/ArthurSonzogni/Diagon) ⭐ 2,218 | 🐛 21 | 🌐 C++ | 📅 2025-05-16 - Diagon is an interactive interpreter, that transforms Markdown-style expression into an ASCII-art representation.
...
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,784 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 991 | 🐛 17 | 🌐 Python | 📅 2026-08-17 - AI-Powered Command-Line Photo Search Tool.
...
* [rimage](https://github.com/SalOne22/rimage) ⭐ 414 | 🐛 2 | 🌐 Rust | 📅 2026-08-15 - A powerful Rust image optimization CLI tool.
...
* [Artem](https://github.com/FineFindus/artem) ⭐ 340 | 🐛 1 | 🌐 HTML | 📅 2025-06-15 - Convert images from multiple formats (JPG, PNG, WEBP, etc.) to ASCII art, written in Rust.
...
* [greentext](https://github.com/jasonuc/greentext) ⭐ 35 | 🐛 0 | 🌐 Go | 📅 2026-08-17 - A CLI tool for creating green-text memes.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,692 | 🐛 75 | 🌐 Python | 📅 2026-08-12 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,639 | 🐛 11 | 🌐 Shell | 📅 2026-08-16 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 571 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,301 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,547 | 🐛 708 | 🌐 Python | 📅 2026-08-16 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,074 | 🐛 162 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,728 | 🐛 211 | 🌐 Rust | 📅 2026-08-10 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,732 | 🐛 172 | 🌐 C | 📅 2026-08-16 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [opencubicplayer](https://github.com/mywave82/opencubicplayer) ⭐ 436 | 🐛 18 | 🌐 C | 📅 2026-08-12 - Open Cubic Player (UNIX fork) is a music visualizer for various tracked music formats (amiga modules, S3M, IT), chiptunes and other formats related to demoscene.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,822 | 🐛 177 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 2,977 | 🐛 0 | 🌐 C | 📅 2026-08-14 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,977 | 🐛 0 | 🌐 C | 📅 2026-08-14 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,173 | 🐛 49 | 🌐 Rust | 📅 2026-08-17 - Terminal Music Player written in Rust.
...
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,801 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,160 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [rusty-rain](https://github.com/cowboy8625/rusty-rain) ⭐ 473 | 🐛 3 | 🌐 Rust | 📅 2026-05-11 - A cross platform matrix rain made with Rust.
...
* [ov](https://github.com/noborus/ov) ⭐ 1,999 | 🐛 30 | 🌐 Go | 📅 2026-08-16 - Feature-rich terminal-based text viewer.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,378 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Terminal image, video, directory, and Markdown viewer.
...
* [viu](https://github.com/learn-anything/command-line-tools) ⭐ 492 | 🐛 13 | 📅 2026-08-16 - Command-line application to view images from the terminal written in Rust.
...
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 337 | 🐛 11 | 🌐 Rust | 📅 2026-08-11 - An TUI for exploring data of a Kafka cluster.
...
* [see](https://github.com/guilhermeprokisch/see) ⭐ 286 | 🐛 5 | 🌐 Rust | 📅 2026-07-22 - A cute cat for the terminal with advanced code viewing, Markdown rendering, tree-sitter syntax highlighting, images view and more.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,925 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,649 | 🐛 168 | 🌐 Go | 📅 2026-08-12 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,689 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,688 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
* [t-rec](https://github.com/sassman/t-rec-rs) ⭐ 1,249 | 🐛 27 | 🌐 Rust | 📅 2026-08-10 - Blazingly fast terminal recorder that generates animated GIF images for the web written in rust.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,837 | 🐛 438 | 🌐 Go | 📅 2026-08-10 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [jdvrif](https://github.com/CleasbyCode/jdvrif) ⭐ 69 | 🐛 0 | 🌐 C++ | 📅 2026-08-16 - CLI tool to embed or extract files via a JPG image. Post and share your embedded JPG image on compatible sites.
...
* [vet](https://github.com/safedep/vet) ⭐ 1,097 | 🐛 97 | 🌐 Go | 📅 2026-08-16 - Tool for identifying risks in open source software supply chain.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,215 | 🐛 560 | 🌐 Python | 📅 2026-08-16 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [gentoo-install](https://github.com/oddlama/gentoo-install) ⭐ 778 | 🐛 24 | 🌐 Shell | 📅 2026-08-08 - This project aspires to be your favorite way to install gentoo. It aims to provide a smooth installation experience, both for beginners and experts. You may configure it by using a menuconfig-inspired interface or simply via a config file.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 512 | 🐛 34 | 🌐 Go | 📅 2026-08-17 - Cross Platform tool to validate configuration files.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,149 | 🐛 29 | 🌐 Rust | 📅 2026-08-17 - Play chess from your terminal.
...
* [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 725 | 🐛 4 | 🌐 Rust | 📅 2026-08-08 - P2P terminal game about spacepirates playing basketball across the galaxy.
...
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 299 | 🐛 16 | 🌐 Python | 📅 2026-08-15 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,252 | 🐛 19 | 🌐 Rust | 📅 2026-08-11 - Turn your keyboard into a typewriter adding sounds at each keystroke.
* [boxes](https://github.com/ascii-boxes/boxes) ⭐ 682 | 🐛 0 | 🌐 C | 📅 2026-08-11 - Boxes is a command line filter program which draws ASCII art boxes around your input text.
...
* [periodic-table-cli](https://github.com/spirometaxas/periodic-table-cli) ⭐ 303 | 🐛 2 | 🌐 JavaScript | 📅 2025-08-03 - An interactive Periodic Table of Elements app for the console!
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 254 | 🐛 37 | 🌐 Python | 📅 2026-08-17 - Track conferences and meetups.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,453 | 🐛 185 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,165 | 🐛 1 | 🌐 Shell | 📅 2026-08-04 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,189 | 🐛 15 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,206 | 🐛 66 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
