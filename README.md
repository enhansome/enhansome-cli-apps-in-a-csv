...
* [eza](https://github.com/eza-community/eza) ⭐ 22,997 | 🐛 434 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,185 | 🐛 206 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,768 | 🐛 137 | 🌐 Rust | 📅 2026-08-22 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,040 | 🐛 107 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,143 | 🐛 73 | 🌐 Lua | 📅 2026-08-10 - Directory changer that learns your habits.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,161 | 🐛 189 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [gtrash](https://github.com/umlx5h/gtrash) ⭐ 318 | 🐛 13 | 🌐 Go | 📅 2025-05-22 - TUI for moving and restoring items from the XDG trash. Fully compliant with the FreeDesktop.org specification.
...
* [hiSHtory](https://github.com/ddworken/hishtory) ⭐ 3,111 | 🐛 63 | 🌐 Go | 📅 2026-03-18 - A better shell history that stores context (directory, succeeded or failed, how long it took, etc). The history is stored locally and end-to-end encrypted for syncing to other computers.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,824 | 🐛 429 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,804 | 🐛 295 | 🌐 Rust | 📅 2026-08-20 - Syntax-aware structured diff tool.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,480 | 🐛 179 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,246 | 🐛 9 | 🌐 C++ | 📅 2026-08-17 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,309 | 🐛 77 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,159 | 🐛 8 | 🌐 Rust | 📅 2026-08-19 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,153 | 🐛 36 | 🌐 Rust | 📅 2026-08-16 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,916 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,932 | 🐛 144 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,116 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
...
* [below](https://github.com/facebookincubator/below) ⭐ 2,492 | 🐛 34 | 🌐 Rust | 📅 2026-08-17 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,679 | 🐛 5 | 🌐 Rust | 📅 2026-08-16 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,405 | 🐛 128 | 🌐 C | 📅 2026-08-21 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,575 | 🐛 66 | 🌐 Rust | 📅 2026-08-21 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,710 | 🐛 257 | 🌐 Go | 📅 2026-08-20 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,820 | 🐛 5 | 🌐 C | 📅 2026-08-17 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,467 | 🐛 82 | 🌐 Go | 📅 2026-08-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 473 | 🌐 C++ | 📅 2026-08-21 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,719 | 🐛 27 | 🌐 C | 📅 2026-08-22 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [browsr](https://github.com/juftin/browsr) ⭐ 643 | 🐛 13 | 🌐 Python | 📅 2026-04-22 - A pleasant file explorer that can browse the contents of local and remote filesystems with your keyboard or mouse; remotes include GitHub, over SSH, in AWS S3, Google Cloud Storage, or Azure Blob Storage.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,741 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,717 | 🐛 102 | 🌐 Rust | 📅 2026-08-17 - Painless compression and decompression in the terminal.
...
* [lib-x](https://github.com/Benexl/lib-x) ⭐ 75 | 🐛 0 | 🌐 Shell | 📅 2026-08-21 - Browse your calibre library from the terminal.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,624 | 🐛 61 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 175,282 | 🐛 883 | 🌐 Python | 📅 2026-08-19 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-08-21 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,324 | 🐛 535 | 🌐 Rust | 📅 2026-08-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
* [Ultimate Plumber](https://github.com/akavel/up) ⭐ 8,835 | 🐛 30 | 🌐 Go | 📅 2024-09-05 - Helps to interactively and incrementally explore textual data in Linux, by making it easier to quickly build complex pipelines, thanks to a fast feedback loop.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,710 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,106 | 🐛 372 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,346 | 🐛 5 | 🌐 Perl | 📅 2026-07-16 - Command line tool for URL parsing and manipulation.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,244 | 🐛 704 | 🌐 Go | 📅 2026-08-21 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
...
* [usql](https://github.com/xo/usql) ⭐ 10,084 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,337 | 🐛 45 | 🌐 Python | 📅 2026-08-20 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,286 | 🐛 17 | 🌐 Rust | 📅 2026-08-21 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,234 | 🐛 50 | 🌐 Go | 📅 2026-08-20 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,937 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,764 | 🐛 30 | 🌐 Rust | 📅 2026-08-21 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,764 | 🐛 30 | 🌐 Rust | 📅 2026-08-21 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,188 | 🐛 15 | 🌐 Go | 📅 2026-08-18 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
...
* [sq](https://github.com/neilotoole/sq) ⭐ 2,550 | 🐛 67 | 🌐 Go | 📅 2026-08-16 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,819 | 🐛 6 | 🌐 Go | 📅 2022-06-11 - A TUI for viewing and editing databases, written in pure Go.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,600 | 🐛 330 | 🌐 Go | 📅 2026-08-21 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,930 | 🐛 7 | 🌐 Rust | 📅 2026-08-21 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,192 | 🐛 82 | 🌐 Rust | 📅 2026-08-16 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 26,990 | 🐛 221 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,083 | 🐛 678 | 🌐 Rust | 📅 2026-08-21 - Create book from Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,409 | 🐛 1,033 | 🌐 Go | 📅 2026-08-22 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,477 | 🐛 163 | 🌐 Rust | 📅 2026-08-19 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 695 | 🐛 1 | 🌐 Go | 📅 2026-08-21 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,541 | 🐛 1,033 | 🌐 Go | 📅 2026-08-21 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,892 | 🐛 461 | 🌐 Go | 📅 2026-08-19 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,410 | 🐛 341 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,094 | 🐛 98 | 🌐 Shell | 📅 2026-08-17 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,334 | 🐛 99 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
...
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,146 | 🐛 137 | 🌐 Rust | 📅 2026-08-21 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,026 | 🐛 62 | 🌐 Rust | 📅 2026-08-17 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,010 | 🐛 176 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
...
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 6,998 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - A simple and efficient way to access various statistics in a git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,064 | 🐛 14 | 🌐 Shell | 📅 2026-08-21 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,037 | 🐛 254 | 🌐 Shell | 📅 2026-08-11 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,298 | 🐛 11 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
* [git-fuzzy](https://github.com/bigH/git-fuzzy) ⭐ 2,434 | 🐛 2 | 🌐 Shell | 📅 2026-06-19 - Interactive `git` with the help of `fzf`.
* [git-recall](https://github.com/Fakerr/git-recall) ⭐ 2,113 | 🐛 7 | 🌐 Shell | 📅 2021-04-22 - A simple tool that allows you to easily go through your commits and check what you or other contributors in your team did.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,924 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repositories.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,118 | 🐛 1,217 | 🌐 Rust | 📅 2026-08-22 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,138 | 🐛 18 | 🌐 Rust | 📅 2026-08-22 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,996 | 🐛 137 | 🌐 TypeScript | 📅 2026-08-22 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,568 | 🐛 664 | 🌐 Go | 📅 2026-08-22 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,995 | 🐛 405 | 🌐 JavaScript | 📅 2026-08-18 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,905 | 🐛 4 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,456 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,837 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,295 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Instant, easy, and predictable development environments.
...
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,839 | 🐛 29 | 🌐 Python | 📅 2026-04-15 - Instant coding answers via the command line.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,635 | 🐛 25 | 🌐 Go | 📅 2026-08-21 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,395 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - A TUI for analyzing Linux binaries.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,102 | 🐛 441 | 🌐 Rust | 📅 2026-08-22 - Developer environments you can take with you.
* [PuDB](https://github.com/inducer/pudb) ⭐ 3,248 | 🐛 164 | 🌐 Python | 📅 2026-08-16 - Allows you to debug code right where you write and test it in a terminal.
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,637 | 🐛 15 | 🌐 Python | 📅 2026-08-21 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 888 | 🐛 163 | 🌐 Rust | 📅 2026-08-19 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,059 | 🐛 313 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,405 | 🐛 111 | 🌐 Go | 📅 2026-08-21 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,295 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,842 | 🐛 41 | 🌐 Go | 📅 2026-08-19 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,523 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 - A simple and fast terminal dashboard for Kubernetes.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,442 | 🐛 332 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,443 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,296 | 🐛 83 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,914 | 🐛 6 | 🌐 Go | 📅 2026-08-21 - Domain Availability Research Tool.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,216 | 🐛 9 | 🌐 Rust | 📅 2026-07-04 - TUI-based HTTP/REST client.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,102 | 🐛 4 | 🌐 Rust | 📅 2026-08-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,393 | 🐛 1,807 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,412 | 🐛 170 | 🌐 Rust | 📅 2026-08-20 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,310 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,665 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-22 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,733 | 🐛 84 | 🌐 Python | 📅 2026-08-21 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,034 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
* [sysz](https://github.com/joehillen/sysz) ⭐ 1,881 | 🐛 5 | 🌐 Shell | 📅 2024-04-22 - fzf terminal UI for systemctl.
* [killport](https://github.com/jkfran/killport) ⭐ 1,838 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 - A command-line tool to easily kill processes running on a specified port.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,036 | 🐛 240 | 🌐 Zig | 📅 2026-08-21 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,489 | 🐛 1,821 | 🌐 Rust | 📅 2026-08-20 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,035 | 🐛 1,866 | 🌐 Rust | 📅 2026-08-20 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,316 | 🐛 1,428 | 🌐 Rust | 📅 2026-08-21 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,361 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 52 | 🌐 C++ | 📅 2026-08-21 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,950 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,399 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
...
* [synth-shell-prompt](https://github.com/andresgongora/synth-shell-prompt) ⭐ 63 | 🐛 12 | 🌐 Shell | 📅 2026-08-21 - A small eye-candy shell prompt with Git status displaying, a clock, intelligent $PWD shortening, and much more.
...
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,309 | 🐛 76 | 🌐 C | 📅 2026-08-21 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,309 | 🐛 76 | 🌐 C | 📅 2026-08-21 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,829 | 🐛 455 | 🌐 C | 📅 2026-08-20 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,650 | 🐛 36 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,090 | 🐛 9 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,821 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,637 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,121 | 🐛 6 | 🌐 Go | 📅 2026-05-26 - Uptime monitoring CLI tool with alerting and advanced settings.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,068 | 🐛 29 | 🌐 Go | 📅 2026-08-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,422 | 🐛 206 | 🌐 Rust | 📅 2026-08-21 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,057 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,267 | 🐛 91 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,567 | 🐛 292 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,825 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,689 | 🐛 68 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,888 | 🐛 141 | 🌐 Go | 📅 2026-08-21 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,265 | 🐛 27 | 🌐 Go | 📅 2026-08-21 - A Docker manager for the terminal.
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,072 | 🐛 59 | 🌐 Go | 📅 2026-08-21 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,812 | 🐛 24 | 🌐 Rust | 📅 2026-07-24 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,341 | 🐛 116 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,297 | 🐛 20 | 🌐 Rust | 📅 2026-08-16 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,654 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,701 | 🐛 18 | 🌐 Go | 📅 2026-08-17 - TUI for running apps and processes.
...
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,502 | 🐛 6 | 🌐 Go | 📅 2026-08-08 - Executing shell commands via HTTP server.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,885 | 🐛 3 | 🌐 Rust | 📅 2026-08-22 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,074 | 🐛 7 | 🌐 Rust | 📅 2026-08-16 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,074 | 🐛 7 | 🌐 Rust | 📅 2026-08-16 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,900 | 🐛 28 | 🌐 Go | 📅 2026-08-20 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,264 | 🐛 206 | 🌐 TypeScript | 📅 2026-08-21 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 885 | 🐛 9 | 🌐 Rust | 📅 2026-08-14 - Terminal mail client.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,163 | 🐛 1,188 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,876 | 🐛 106 | 🌐 Java | 📅 2026-08-21 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,120 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-16 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
...
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,715 | 🐛 73 | 🌐 Go | 📅 2026-08-21 - A terminal based Matrix client written in Go.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 956 | 🐛 3 | 🌐 Python | 📅 2026-08-22 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 855 | 🐛 474 | 🌐 Python | 📅 2026-08-16 - Official Zulip terminal client with TUI.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,242 | 🐛 112 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,911 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,409 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,718 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,500 | 🐛 57 | 🌐 Rust | 📅 2026-08-19 - oha is a tiny program that sends some load to a web application and show real-time TUI.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,668 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,648 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,513 | 🐛 78 | 🌐 Rust | 📅 2026-08-13 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,087 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,065 | 🐛 33 | 🌐 C | 📅 2026-08-20 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,879 | 🐛 14 | 🌐 Rust | 📅 2026-08-21 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,702 | 🐛 20 | 🌐 Rust | 📅 2026-03-09 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,693 | 🐛 33 | 🌐 Go | 📅 2026-08-15 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,564 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - TUI for sniffing network traffic using eBPF on Linux.
...
* [asn](https://github.com/nitefood/asn) ⭐ 1,923 | 🐛 3 | 🌐 Shell | 📅 2026-06-22 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,812 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,550 | 🐛 18 | 🌐 Rust | 📅 2026-08-22 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,227 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
...
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 717 | 🐛 10 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 528 | 🐛 0 | 🌐 Go | 📅 2026-07-25 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,966 | 🐛 21 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing bluetooth devices on Linux.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 186,122 | 🐛 2,601 | 🌐 Python | 📅 2026-08-20 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,993 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,782 | 🐛 1,160 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,016 | 🐛 3 | 🌐 Go | 📅 2026-08-21 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,639 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,863 | 🐛 179 | 🌐 Python | 📅 2026-08-20 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,281 | 🐛 1,156 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,034 | 🐛 38 | 🌐 Rust | 📅 2026-08-16 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 7,961 | 🐛 211 | 🌐 Go | 📅 2026-08-21 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,629 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,845 | 🐛 400 | 🌐 C++ | 📅 2026-08-19 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,221 | 🐛 2 | 🌐 Python | 📅 2026-08-21 - A Python tool that lets you find and download torrents without leaving your CLI.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 692 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,461 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,911 | 🐛 162 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,533 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,821 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 803 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-22 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,935 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,108 | 🐛 130 | 🌐 Rust | 📅 2026-08-16 - A terminal user interface for taskwarrior.
...
* [Todoman](https://github.com/pimutils/todoman) ⭐ 589 | 🐛 113 | 🌐 Python | 📅 2026-05-25 - A simple, standards-based, CLI todo (aka: task) manager.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,640 | 🐛 127 | 🌐 C++ | 📅 2026-08-21 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [Bartib](https://github.com/nikolassv/bartib) ⭐ 843 | 🐛 19 | 🌐 Rust | 📅 2026-03-25 - Easy to use time tracking tool for the command line. It saves a log of all tracked activities as a plain-text file and allows you to create flexible reports.
* [zeit](https://github.com/mrusme/zeit) ⭐ 585 | 🐛 0 | 🌐 Go | 📅 2026-07-21 - A command line tool for tracking time spent on activities.
...
* [hours](https://github.com/dhth/hours) ⭐ 346 | 🐛 16 | 🌐 Go | 📅 2026-08-21 - A no-frills time tracking toolkit for command line nerds.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,369 | 🐛 150 | 🌐 Shell | 📅 2026-08-20 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,294 | 🐛 150 | 🌐 Python | 📅 2026-08-20 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,414 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,062 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,772 | 🐛 25 | 🌐 Go | 📅 2026-08-03 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
...
* [Toney](https://github.com/SourcewareLab/Toney) ⭐ 200 | 🐛 3 | 🌐 Go | 📅 2026-05-27 - A fast, lightweight, terminal-based note-taking TUI app built with Bubbletea; Offers markdown rendering, file navigation and native Neovim editing.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,179 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - A powerful bookmark manager written in Python3 and SQLite3.
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,755 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,042 | 🐛 260 | 🌐 Python | 📅 2026-08-21 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,861 | 🐛 222 | 🌐 Python | 📅 2026-08-20.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,213 | 🐛 35 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,880 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,608 | 🐛 800 | 🌐 TypeScript | 📅 2026-08-22 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,493 | 🐛 63 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,375 | 🐛 96 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [parllama](https://github.com/paulrobello/parllama) ⭐ 486 | 🐛 4 | 🌐 Python | 📅 2026-07-11 - TUI designed for easy management and use of Ollama based LLMs.
...
* [Context Extractor](https://github.com/vaibhav-mattoo/cxt) ⭐ 51 | 🐛 1 | 🌐 Rust | 📅 2026-07-27 - Command line tool that aggregates file and directory contents into the clipboard, for providing project context to AI chatbots in the browser like ChatGPT and Perplexity.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,622 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,787 | 🐛 75 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,345 | 🐛 172 | 🌐 C++ | 📅 2026-08-19 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 529 | 🐛 15 | 🌐 Python | 📅 2026-08-21 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [write good](https://github.com/btford/write-good) ⭐ 5,083 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English prose.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,656 | 🐛 125 | 🌐 Rust | 📅 2026-03-13 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 720 | 🐛 12 | 🌐 C | 📅 2026-08-21 - Base conversion and bit manipulator in ncurses.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,730 | 🐛 455 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
...
* [pet](https://github.com/knqyf263/pet) ⭐ 5,331 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,931 | 🐛 99 | 🌐 Go | 📅 2026-08-21 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,275 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 109 | 🐛 1 | 🌐 Rust | 📅 2026-08-21 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 9 | 🐛 0 | 🌐 Zig | 📅 2026-08-21 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,029 | 🐛 550 | 🌐 Go | 📅 2026-08-12 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,645 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-19 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,459 | 🐛 37 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,164 | 🐛 57 | 🌐 C | 📅 2026-08-21 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,306 | 🐛 28 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,014 | 🐛 38 | 🌐 C | 📅 2026-08-20 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,790 | 🐛 4 | 🌐 Python | 📅 2026-08-18 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,704 | 🐛 76 | 🌐 Python | 📅 2026-08-21 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,474 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,641 | 🐛 12 | 🌐 Shell | 📅 2026-08-19 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 590 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,310 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,566 | 🐛 710 | 🌐 Python | 📅 2026-08-21 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,103 | 🐛 164 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,727 | 🐛 209 | 🌐 Rust | 📅 2026-08-21 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 575 | 🐛 25 | 🌐 Rust | 📅 2026-08-09 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
* [spotui](https://github.com/ceuk/spotui) ⭐ 575 | 🐛 8 | 🌐 Python | 📅 2023-07-25 - TUI Spotify client written in Python.
* [opencubicplayer](https://github.com/mywave82/opencubicplayer) ⭐ 436 | 🐛 19 | 🌐 C | 📅 2026-08-21 - Open Cubic Player (UNIX fork) is a music visualizer for various tracked music formats (amiga modules, S3M, IT), chiptunes and other formats related to demoscene.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 156 | 🐛 1 | 🌐 Shell | 📅 2026-08-20 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,825 | 🐛 178 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 2,985 | 🐛 1 | 🌐 C | 📅 2026-08-22 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,985 | 🐛 1 | 🌐 C | 📅 2026-08-22 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,176 | 🐛 50 | 🌐 Rust | 📅 2026-08-17 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,171 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [neo](https://github.com/st3w/neo) ⭐ 949 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
* [ascii-movie](https://github.com/gabe565/ascii-movie) ⭐ 612 | 🐛 43 | 🌐 Go | 📅 2026-08-21 - Allows to play the ASCII art Star War movie locally or it can open a connection to play it over SSH or telnet.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,226 | 🐛 423 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
...
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,384 | 🐛 12 | 🌐 Rust | 📅 2026-08-22 - Terminal image, video, directory, and Markdown viewer.
...
* [reader](https://github.com/mrusme/reader) ⭐ 410 | 🐛 0 | 🌐 Go | 📅 2026-07-21 - Reader parses a web page for its actual content and displays it in nicely highlighted text on the command line
* [hygg](https://github.com/kruserr/hygg) ⭐ 350 | 🐛 15 | 🌐 Rust | 📅 2026-07-17 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 342 | 🐛 16 | 🌐 Rust | 📅 2026-08-18 - An TUI for exploring data of a Kafka cluster.
...
* [brows](https://github.com/rubysolo/brows) ⭐ 82 | 🐛 0 | 🌐 Go | 📅 2026-06-01 - CLI GitHub release browser.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,934 | 🐛 13 | 🌐 Rust | 📅 2026-08-16 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,683 | 🐛 168 | 🌐 Go | 📅 2026-08-12 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,705 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
* [terminalizer](https://github.com/faressoft/terminalizer) ⭐ 16,154 | 🐛 108 | 🌐 JavaScript | 📅 2024-08-29 - Record your terminal and generate animated GIF images or share a web player link [www.terminalizer.com](www.terminalizer.com).
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,699 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
* [t-rec](https://github.com/sassman/t-rec-rs) ⭐ 1,250 | 🐛 27 | 🌐 Rust | 📅 2026-08-10 - Blazingly fast terminal recorder that generates animated GIF images for the web written in rust.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,881 | 🐛 441 | 🌐 Go | 📅 2026-08-17 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [secret\_share](https://github.com/scosman/secret_share) ⭐ 24 | 🐛 2 | 🌐 Go | 📅 2026-08-21 - The program allows you to share messages (secrets and passwords) securely with a CLI.
...
* [vet](https://github.com/safedep/vet) ⭐ 1,101 | 🐛 96 | 🌐 Go | 📅 2026-08-16 - Tool for identifying risks in open source software supply chain.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,447 | 🐛 96 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,231 | 🐛 572 | 🌐 Python | 📅 2026-08-20 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [flog](https://github.com/mingrammer/flog) ⭐ 1,328 | 🐛 32 | 🌐 Go | 📅 2025-06-05 - A fake log generator for log formats such as apache-common, apache error and RFC3164 syslog.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 513 | 🐛 20 | 🌐 Go | 📅 2026-08-21 - Cross Platform tool to validate configuration files.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,159 | 🐛 11 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [flash-tui](https://github.com/TBS1996/speki) ⭐ 510 | 🐛 10 | 🌐 Rust | 📅 2024-12-22 - Flashcard app for the terminal.
* [speki](https://github.com/tbs1996/speki) ⭐ 510 | 🐛 10 | 🌐 Rust | 📅 2024-12-22 - Manage flashcards in the terminal similar to anki.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,036 | 🐛 11 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,588 | 🐛 35 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
...
* [typtea](https://github.com/ashish0kumar/typtea) ⭐ 241 | 🐛 2 | 🌐 Go | 📅 2026-02-20 - Minimal terminal-based typing speed tester with support for dozens of programming languages.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,157 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - Play chess from your terminal.
...
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 301 | 🐛 13 | 🌐 Python | 📅 2026-08-21 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,147 | 🐛 257 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,478 | 🐛 183 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,217 | 🐛 1 | 🌐 Shell | 📅 2026-08-19 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,191 | 🐛 15 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,267 | 🐛 76 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
