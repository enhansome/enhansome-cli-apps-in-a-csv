...
* [eza](https://github.com/eza-community/eza) ⭐ 23,233 | 🐛 446 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,218 | 🐛 207 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,262 | 🐛 31 | 🌐 Rust | 📅 2026-09-11 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,410 | 🐛 145 | 🌐 Rust | 📅 2026-09-08 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,043 | 🐛 109 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,375 | 🐛 204 | 🌐 Rust | 📅 2026-09-09 - A simple, fast, and user-friendly alternative to find. Written in Rust.
* [bfs](https://github.com/tavianator/bfs) ⭐ 1,265 | 🐛 13 | 🌐 C | 📅 2026-08-31 - A breadth-first version of the UNIX find command.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,789 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Recover deleted files and overwritten data. It scans every block of the partition. You can even find a string in binary files.
* [rip](https://github.com/nivekuil/rip) ⭐ 1,733 | 🐛 26 | 🌐 Rust | 📅 2024-04-08 - Move and restore items from the graveyard (by default, `/tmp/graveyard-$USER` if $XDG\_DATA\_HOME is not set and `$XDG_DATA_HOME/graveyard` otherwise)
...
* [undelete-btrfs](https://github.com/danthem/undelete-btrfs) ⭐ 293 | 🐛 4 | 🌐 Shell | 📅 2026-08-18 - Automate the generation of path regex for BTRFS restore and attempt the restore for you in 3 levels. The longer a file has existed prior to being deleted, the more likely it is to be recovered.
...
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,790 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Intelligent context-aware search engine for your shell history with TUI.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,456 | 🐛 186 | 🌐 C | 📅 2026-09-11 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
* [hiSHtory](https://github.com/ddworken/hishtory) ⭐ 3,118 | 🐛 63 | 🌐 Go | 📅 2026-03-18 - A better shell history that stores context (directory, succeeded or failed, how long it took, etc). The history is stored locally and end-to-end encrypted for syncing to other computers.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,155 | 🐛 439 | 🌐 Rust | 📅 2026-09-11 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,881 | 🐛 291 | 🌐 Rust | 📅 2026-09-11 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,087 | 🐛 5 | 🌐 Perl | 📅 2026-08-31 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,884 | 🐛 70 | 🌐 Go | 📅 2026-09-11 - A diff tool for YAML files, and sometimes JSON.
* [ydiff](https://github.com/ymattw/ydiff) ⭐ 932 | 🐛 1 | 🌐 Python | 📅 2026-05-20 - View colored, incremental diff.
...
* [csv-diff](https://github.com/simonw/csv-diff) ⭐ 342 | 🐛 38 | 🌐 Python | 📅 2024-09-06 - Python CLI tool and library for diffing CSV and JSON files
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,192 | 🐛 192 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,118 | 🐛 563 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,862 | 🐛 53 | 🌐 Rust | 📅 2026-09-11 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,841 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,286 | 🐛 9 | 🌐 C++ | 📅 2026-08-31 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [hypergrep](https://github.com/p-ranav/hypergrep) ⭐ 247 | 🐛 3 | 🌐 C++ | 📅 2023-06-09 - Recursively search directories for a regex pattern using Intel Hypescan.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,350 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,292 | 🐛 18 | 🌐 Rust | 📅 2026-09-05 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,252 | 🐛 8 | 🌐 Rust | 📅 2026-09-09 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,251 | 🐛 1 | 🌐 Rust | 📅 2026-09-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,972 | 🐛 55 | 🌐 Go | 📅 2026-09-10 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,125 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,533 | 🐛 535 | 🌐 C++ | 📅 2026-09-09 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,117 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,931 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,989 | 🐛 142 | 🌐 C | 📅 2026-09-07 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
* [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,931 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/macOS/FreeBSD resource monitor with a nice interface.
* [gtop](https://github.com/aksakalli/gtop) ⭐ 9,927 | 🐛 40 | 🌐 JavaScript | 📅 2025-11-06 - System monitoring dashboard for terminal written in Node.js.
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,146 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,165 | 🐛 35 | 🌐 Rust | 📅 2026-09-09 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,087 | 🐛 43 | 🌐 Python | 📅 2026-08-27 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,050 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
* [below](https://github.com/facebookincubator/below) ⭐ 2,516 | 🐛 32 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,703 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,419 | 🐛 116 | 🌐 C | 📅 2026-09-09 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,130 | 🐛 67 | 🌐 Rust | 📅 2026-09-12 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,157 | 🐛 269 | 🌐 Go | 📅 2026-09-11 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,878 | 🐛 5 | 🌐 C | 📅 2026-09-09 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,505 | 🐛 85 | 🌐 Go | 📅 2026-09-09 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 476 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
...
* [felix](https://github.com/kyoheiu/felix) ⭐ 917 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager with vim-like key mapping
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
* [tere](https://github.com/mgunyho/tere) ⭐ 1,799 | 🐛 16 | 🌐 Rust | 📅 2026-03-09 - Terminal file explorer that is a faster alternative to using cd and ls to browse folders in your terminal.
...
* [browsr](https://github.com/juftin/browsr) ⭐ 646 | 🐛 13 | 🌐 Python | 📅 2026-04-22 - A pleasant file explorer that can browse the contents of local and remote filesystems with your keyboard or mouse; remotes include GitHub, over SSH, in AWS S3, Google Cloud Storage, or Azure Blob Storage.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,750 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,750 | 🐛 91 | 🌐 Rust | 📅 2026-09-12 - Painless compression and decompression in the terminal.
...
* [compsize](https://github.com/kilobyte/compsize) ⭐ 414 | 🐛 22 | 🌐 C | 📅 2023-12-25 - Find compression type/ratio on a file or set of files on a btrfs file system.
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,444 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,666 | 🐛 63 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 182,719 | 🐛 634 | 🌐 Python | 📅 2026-09-11 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-11 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,463 | 🐛 539 | 🌐 Rust | 📅 2026-09-07 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [lolcat](https://github.com/busyloop/lolcat) ⭐ 6,573 | 🐛 33 | 🌐 Ruby | 📅 2024-03-05 - Ruby Gem to colorize the output of the cat command.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,721 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,358 | 🐛 374 | 🌐 Python | 📅 2026-06-23.
...
* [gtree](https://github.com/ddddddO/gtree) ⭐ 360 | 🐛 38 | 🌐 Go | 📅 2026-09-11 - Using either Markdown or programmatically to generate directory trees and directories, and to verify directories.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,795 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [IRedis](https://github.com/laixintao/iredis) ⭐ 2,744 | 🐛 51 | 🌐 Python | 📅 2026-09-08 - Interactive Redis: A CLI for Redis with autocompletion and Syntax Highlighting.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,027 | 🐛 7 | 🌐 Python | 📅 2026-09-11 - TUI for kafka, which allows you to interact and consume topics from your terminal in style.
* [ramda-cli](https://github.com/raine/ramda-cli) ⭐ 581 | 🐛 26 | 🌐 LiveScript | 📅 2022-12-30 - A tool for processing data with functional pipelines.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,623 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,949 | 🐛 301 | 🌐 Go | 📅 2026-09-10 - Portable command-line YAML processor.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,516 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - gron transforms JSON into discrete assignments to make it easier to grep for what you want and see the absolute 'path' to it.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,673 | 🐛 42 | 🌐 Python | 📅 2026-09-10 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,139 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
* [jnv](https://github.com/ynqa/jnv) ⭐ 6,103 | 🐛 31 | 🌐 Rust | 📅 2026-08-20 - Interactive JSON filter using jq.
* [jo](https://github.com/jpmens/jo) ⭐ 4,863 | 🐛 7 | 🌐 C | 📅 2025-06-20 - A small utility to create JSON objects from the command line.
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,803 | 🐛 19 | 🌐 Go | 📅 2026-09-04 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,749 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,839 | 🐛 24 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,483 | 🐛 21 | 🌐 Python | 📅 2026-09-09 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [jj](https://github.com/tidwall/jj) ⭐ 2,060 | 🐛 19 | 🌐 Go | 📅 2023-12-16 - A command line utility that provides a fast and simple way to retrieve or update values from JSON documents.
...
* [JSON.awk](https://github.com/step-/JSON.awk) ⭐ 451 | 🐛 1 | 🌐 Awk | 📅 2022-08-21 - A practical JSON parser written in awk.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,421 | 🐛 610 | 🌐 Go | 📅 2026-09-11 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,382 | 🐛 41 | 🌐 Python | 📅 2026-09-09 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,976 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,110 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,017 | 🐛 72 | 🌐 Go | 📅 2026-09-09 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,397 | 🐛 43 | 🌐 Python | 📅 2026-09-11 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,325 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,289 | 🐛 39 | 🌐 Go | 📅 2026-09-12 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,962 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,784 | 🐛 27 | 🌐 Rust | 📅 2026-09-12 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,784 | 🐛 27 | 🌐 Rust | 📅 2026-09-12 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,318 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - A cross-platform TUI database management tool written in Rust.
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,297 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with autocompletion and syntax highlighting.
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,212 | 🐛 12 | 🌐 Go | 📅 2026-09-09 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,102 | 🐛 18 | 🌐 Rust | 📅 2026-09-09 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,564 | 🐛 77 | 🌐 Go | 📅 2026-09-11 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,168 | 🐛 111 | 🌐 Python | 📅 2026-09-02 - Python CLI utility and library for manipulating SQLite databases.
...
* [Soul](https://github.com/thevahidal/soul) ⭐ 1,685 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-03 - A SQLite REST and real-time server.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,195 | 🐛 1 | 🌐 Python | 📅 2026-09-11 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,926 | 🐛 328 | 🌐 Go | 📅 2026-09-12 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,949 | 🐛 5 | 🌐 Rust | 📅 2026-09-08 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,260 | 🐛 78 | 🌐 Rust | 📅 2026-09-11 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,278 | 🐛 231 | 🌐 Go | 📅 2026-09-07 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,132 | 🐛 663 | 🌐 Rust | 📅 2026-09-08 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,824 | 🐛 125 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,284 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,568 | 🐛 945 | 🌐 Go | 📅 2026-09-12 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,570 | 🐛 176 | 🌐 Rust | 📅 2026-09-11 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [o](https://github.com/xyproto/orbiton) ⭐ 700 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Configuration-free text editor and IDE limited to VT100. Suitable for writing git commit messages, editing Markdown, config files, source code, viewing man pages and for quick edit-compile cycles when programming.
* [Turbo](https://github.com/magiblot/turbo) ⭐ 681 | 🐛 38 | 🌐 C++ | 📅 2026-08-28 - An experimental text editor for the terminal, based on Scintilla and Turbo Vision.
...
* [aretext](https://github.com/aretext/aretext) ⭐ 286 | 🐛 5 | 🌐 Go | 📅 2026-08-27 - Minimalist text editor with vim-compatible key bindings.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,252 | 🐛 1,035 | 🌐 Go | 📅 2026-09-11 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,248 | 🐛 474 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,478 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,103 | 🐛 97 | 🌐 Shell | 📅 2026-09-01 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,330 | 🐛 233 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,506 | 🐛 101 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,227 | 🐛 115 | 🌐 Rust | 📅 2026-09-07 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,047 | 🐛 65 | 🌐 Rust | 📅 2026-09-09 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,027 | 🐛 179 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,216 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 7,003 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - A simple and efficient way to access various statistics in a git repository.
...
* [mergestat-lite](https://github.com/mergestat/mergestat-lite) ⭐ 3,520 | 🐛 47 | 🌐 Go | 📅 2026-09-05 - A command-line tool for running SQL queries on git repositories and related data sources.
...
* [czg](https://github.com/Zhengqbbb/cz-git) ⭐ 1,524 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22 - Interactively generate standardized commit messages.
* [fzf-git.sh](https://github.com/junegunn/fzf-git.sh) ⭐ 1,182 | 🐛 13 | 🌐 Shell | 📅 2026-08-06 - bash and zsh key bindings for Git objects, powered by fzf.
...
* [gh-f](https://github.com/gennaro-tedesco/gh-f) ⭐ 392 | 🐛 0 | 🌐 Shell | 📅 2025-09-23 - The ultimate, compact and snappy fzf extension for gh CLI.
* [ggc](https://github.com/bmf-san/ggc) ⭐ 285 | 🐛 5 | 🌐 Go | 📅 2026-09-07 - A modern Git CLI tool with both traditional command-line and interactive incremental-search UI.
...
* [git-remote-aws](https://github.com/nathants/git-remote-aws) ⭐ 169 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Management of encrypted git hosting.
...
* [git-cc](https://github.com/SKalt/git-cc) ⭐ 141 | 🐛 10 | 🌐 Go | 📅 2026-08-29 - A git extension to help write conventional commits.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,538 | 🐛 1,241 | 🌐 Rust | 📅 2026-09-11 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,142 | 🐛 17 | 🌐 Rust | 📅 2026-09-10 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,300 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-12 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,022 | 🐛 711 | 🌐 Go | 📅 2026-09-12 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,035 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-08 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,977 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,520 | 🐛 27 | 🌐 Perl | 📅 2026-09-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,904 | 🐛 243 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,352 | 🐛 496 | 🌐 Go | 📅 2026-09-11 - Instant, easy, and predictable development environments.
* [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,248 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modular visual interface for GDB in Python.
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,844 | 🐛 17 | 🌐 Python | 📅 2026-09-09 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,055 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,736 | 🐛 26 | 🌐 Go | 📅 2026-09-11 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,184 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
* [np](https://github.com/sindresorhus/np) ⭐ 7,713 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-09 - A better `npm publish`.
* [blinkenlights](https://github.com/jart/blink) ⭐ 7,579 | 🐛 55 | 🌐 C | 📅 2025-12-10 - TUI that may be used for debugging x86\_64-linux or i8086 programs across platforms.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,423 | 🐛 38 | 🌐 Rust | 📅 2026-09-06 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,125 | 🐛 447 | 🌐 Rust | 📅 2026-09-11 - Developer environments you can take with you.
* [rebound](https://github.com/shobrook/rebound) ⭐ 4,114 | 🐛 24 | 🌐 Python | 📅 2022-02-16 - Fetch Stack Overflow results in your terminal when you get an error. Supported languages: Python, Node.js, Ruby, Go, and Java.
* [PuDB](https://github.com/inducer/pudb) ⭐ 3,249 | 🐛 164 | 🌐 Python | 📅 2026-09-02 - Allows you to debug code right where you write and test it in a terminal.
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,655 | 🐛 15 | 🌐 Python | 📅 2026-08-27 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
* [scons](https://github.com/SCons/scons) ⭐ 2,418 | 🐛 653 | 🌐 Python | 📅 2026-09-08 - Software construction tool.
* [fastmod](https://github.com/facebookincubator/fastmod) ⭐ 1,926 | 🐛 16 | 🌐 Rust | 📅 2026-07-28 - A tool to assist you with large-scale codebase refactors, and it supports most of codemod's options. It is focused on improving the use case "I want to use interactive mode to make sure my regex is correct, and then I want to apply the regex everywhere".
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 897 | 🐛 164 | 🌐 Rust | 📅 2026-09-12 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [gup](https://github.com/nao1215/gup) ⭐ 600 | 🐛 5 | 🌐 Go | 📅 2026-09-09 - Update binaries installed by "go install" with goroutines.
* [DevTUI](https://github.com/skatkov/devtui) ⭐ 553 | 🐛 42 | 🌐 Go | 📅 2026-09-07 - All-in-one terminal toolkit that consolidates everyday developer utilities into a unified TUI and CLI.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 140 | 🐛 13 | 🌐 Python | 📅 2026-09-11 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [Scrut](https://github.com/facebookincubator/scrut) ⭐ 82 | 🐛 8 | 🌐 Rust | 📅 2026-08-26 - A testing toolkit for CLI applications designed to rigorously test terminal programs, inspired by Cram and focuses on providing a straightforward way to validate CLI behaviour.
...
* [Tokui](https://github.com/zdyxry/tokui) ⭐ 53 | 🐛 1 | 🌐 Go | 📅 2026-09-09 - An interactive TUI for visualizing code statistics from tockei.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,086 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
* [readme-md-generator](https://github.com/kefranabg/readme-md-generator) ⭐ 11,133 | 🐛 30 | 🌐 JavaScript | 📅 2022-09-20 - CLI that generates beautiful README.md files.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,564 | 🐛 79 | 🌐 Go | 📅 2026-09-11 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,352 | 🐛 496 | 🌐 Go | 📅 2026-09-11 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,858 | 🐛 42 | 🌐 Go | 📅 2026-08-19 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,533 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,640 | 🐛 26 | 🌐 Go | 📅 2026-08-31 - Tool for visualizing dynamic node usage within a kubernetes cluster.
* [OPS](https://github.com/nanovms/ops) ⭐ 1,514 | 🐛 143 | 🌐 Go | 📅 2026-09-09 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,191 | 🐛 86 | 🌐 C | 📅 2026-08-30 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,191 | 🐛 86 | 🌐 C | 📅 2026-08-30 unikernel instance.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,403 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,223 | 🐛 8 | 🌐 Go | 📅 2026-09-11 - TUI for Podman environment.
* [ktop](https://github.com/vladimirvivien/ktop) ⭐ 1,107 | 🐛 11 | 🌐 Go | 📅 2026-07-03 - Tool that displays useful metrics information about nodes, pods, and other workload.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 12 | 🌐 Rust | 📅 2026-09-10 - A TUI tool designed for monitoring Kubernetes resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,501 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,474 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,400 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,919 | 🐛 7 | 🌐 Go | 📅 2026-09-07 - Domain Availability Research Tool.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,227 | 🐛 9 | 🌐 Rust | 📅 2026-09-02 - TUI-based HTTP/REST client.
...
* [domain-check](https://github.com/saidutt46/domain-check) ⭐ 307 | 🐛 4 | 🌐 Rust | 📅 2026-05-14 - Universal domain exploration engine: fast domain availability checks across the internet.
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,298 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,914 | 🐛 1,861 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,757 | 🐛 172 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,320 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,694 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,755 | 🐛 79 | 🌐 Python | 📅 2026-09-05 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
* [fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,004 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 - Simple cross-platform process killer.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,285 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,053 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast simple TUI for interacting with systemd services and their logs.
* [sysz](https://github.com/joehillen/sysz) ⭐ 1,882 | 🐛 5 | 🌐 Shell | 📅 2024-04-22 - fzf terminal UI for systemctl.
* [killport](https://github.com/jkfran/killport) ⭐ 1,839 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A command-line tool to easily kill processes running on a specified port.
...
* [qman](https://github.com/plp13/qman) ⭐ 600 | 🐛 13 | 🌐 C | 📅 2026-09-06 - A more modern man page viewer for our terminals.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 60,978 | 🐛 249 | 🌐 Zig | 📅 2026-09-12 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,855 | 🐛 1,850 | 🌐 Rust | 📅 2026-09-11 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
* [warp](https://github.com/spolu/warp) ⭐ 1,617 | 🐛 12 | 🌐 Go | 📅 2018-03-06 - Secure and simple terminal sharing.
* [Textual Web](https://github.com/Textualize/textual-web) ⭐ 1,465 | 🐛 23 | 🌐 Python | 📅 2024-08-30 - Run TUIs and terminals in your browser.
...
* [tvterm](https://github.com/magiblot/tvterm) ⭐ 279 | 🐛 8 | 🌐 C++ | 📅 2026-08-14 - A terminal emulator that runs in your terminal (Unix and Windows).
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,378 | 🐛 1,914 | 🌐 Rust | 📅 2026-09-09 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,360 | 🐛 20 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,360 | 🐛 20 | 🌐 C++ | 📅 2026-07-31 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
* [mtm](https://github.com/deadpixi/mtm) ⭐ 1,224 | 🐛 43 | 🌐 C | 📅 2024-07-18 - Micro Terminal Multiplexer - Simple but usable, stable and minimalistic terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,486 | 🐛 1,438 | 🌐 Rust | 📅 2026-09-11 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,380 | 🐛 351 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
* [Oils](https://github.com/oilshell/oil) ⭐ 3,391 | 🐛 610 | 🌐 Python | 📅 2026-09-08 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
* [Ion](https://github.com/redox-os/ion) ⭐ 1,655 | 🐛 60 | 🌐 Rust | 📅 2026-09-09 - Ion is a modern system shell that features a simple, yet powerful, syntax.
* [dune](https://github.com/adam-mcdaniel/dune) ⭐ 1,086 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - A customizable shell that aims to be cozy.
* [Twin](https://github.com/cosmos72/twin) ⭐ 1,061 | 🐛 37 | 🌐 C | 📅 2026-08-03 - Text mode window environment. A "retro" program for embedded or remote systems, that doubles as X11 terminal and text-mode equivalent of VNC server.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 281 | 🐛 68 | 🌐 C | 📅 2026-09-12 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-11 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,085 | 🐛 150 | 🌐 Shell | 📅 2026-09-06 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Liquid Prompt](https://github.com/liquidprompt/liquidprompt) ⭐ 4,674 | 🐛 29 | 🌐 Shell | 📅 2026-09-10 - Carefully designed prompt with useful information to show changes when it changes, saving time and frustration, and to show meaningful information with minimal visual clutter.
* [geometry](https://github.com/geometry-zsh/geometry) ⭐ 996 | 🐛 14 | 🌐 Shell | 📅 2025-01-13 - A minimalistic, fully customizable Zsh prompt theme with support for asynchronous functions.
...
* [yank](https://github.com/mptre/yank) ⭐ 1,712 | 🐛 2 | 🌐 C | 📅 2026-07-16 - Reads input from stdin and display a selection interface that allows a field to be selected and copied to the clipboard.
* [extrakto](https://github.com/laktak/extrakto) ⭐ 1,140 | 🐛 1 | 🌐 Python | 📅 2026-03-02 - extrakto for tmux - quickly select, copy/insert/complete text without a mouse.
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,037 | 🐛 45 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [shcopy](https://github.com/aymanbagabas/shcopy) ⭐ 88 | 🐛 0 | 🌐 Go | 📅 2026-08-15 - Copy text to your system clipboard locally and remotely using ANSI OSC52 sequence.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,841 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,594 | 🐛 88 | 🌐 C | 📅 2026-09-11 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,594 | 🐛 88 | 🌐 C | 📅 2026-09-11 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,919 | 🐛 449 | 🌐 C | 📅 2026-09-10 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,080 | 🐛 107 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,699 | 🐛 37 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,105 | 🐛 12 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,969 | 🐛 12 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,880 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
* [AdGuardian-Term](https://github.com/lissy93/AdGuardian-Term) ⭐ 1,653 | 🐛 7 | 🌐 Rust | 📅 2026-08-14 - A TUI dashboard for monitoring real-time traffic from an AdGuard Home instance.
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,083 | 🐛 30 | 🌐 Go | 📅 2026-09-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [amtui](https://github.com/pehlicd/amtui/) ⭐ 114 | 🐛 4 | 🌐 Go | 📅 2026-06-20 - A terminal-based user interface (TUI) application that allows you to interact with Prometheus Alertmanager using your terminal. It provides a convenient way to monitor alerts, view silences, and check the status of Alertmanager instances.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,511 | 🐛 206 | 🌐 Rust | 📅 2026-09-11 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,072 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,282 | 🐛 87 | 🌐 Go | 📅 2026-09-12 - Manages binary files downloaded from different sources.
* [upt](https://github.com/sigoden/upt) ⭐ 526 | 🐛 3 | 🌐 Rust | 📅 2024-10-31 - Universal Package-management Tool for any OS.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,558 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,795 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,836 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 16,157 | 🐛 70 | 🌐 Shell | 📅 2026-08-28 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,971 | 🐛 150 | 🌐 Go | 📅 2026-09-10 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,077 | 🐛 60 | 🌐 Go | 📅 2026-08-21 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,834 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 605 | 🐛 17 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,379 | 🐛 115 | 🌐 C | 📅 2026-09-06 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,327 | 🐛 20 | 🌐 Rust | 📅 2026-09-09 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,678 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,771 | 🐛 24 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,716 | 🐛 68 | 🌐 Rust | 📅 2026-09-08 - mprocs runs multiple commands in parallel and shows output of each command separately.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,894 | 🐛 3 | 🌐 Rust | 📅 2026-09-12 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,228 | 🐛 8 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,228 | 🐛 8 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
...
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,325 | 🐛 221 | 🌐 TypeScript | 📅 2026-08-28 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 889 | 🐛 3 | 🌐 Rust | 📅 2026-09-11 - Terminal mail client.
...
* [nmail](https://github.com/d99kris/nmail) ⭐ 256 | 🐛 1 | 🌐 C++ | 📅 2026-08-30 - nmail is a console-based email client for Linux and macOS with a user interface similar to alpine / pine.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,190 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
* [slack-term](https://github.com/erroneousboat/slack-term) ⭐ 6,614 | 🐛 68 | 🌐 Go | 📅 2024-04-23 - Slack client for the  terminal.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,772 | 🐛 54 | 🌐 Go | 📅 2026-09-10 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,907 | 🐛 110 | 🌐 Java | 📅 2026-09-10 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,134 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,947 | 🐛 17 | 🌐 C++ | 📅 2026-08-30 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,720 | 🐛 78 | 🌐 Go | 📅 2026-09-09 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,374 | 🐛 101 | 🌐 Rust | 📅 2026-07-29 - Signal Messenger client for terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,323 | 🐛 128 | 🌐 Python | 📅 2026-07-04 - Mastodon CLI & TUI.
* [toxic](https://github.com/Jfreegman/toxic) ⭐ 1,303 | 🐛 20 | 🌐 C | 📅 2026-07-14 - A Tox-based instant messaging and video chat client.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,012 | 🐛 15 | 🌐 Rust | 📅 2026-09-07 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 983 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 754 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 71 | 🐛 29 | 🌐 Rust | 📅 2026-09-12 - TUI client for Nostr.
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,550 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Turn CLI tools into web applications; basically, it runs a command and starts a server so that the output can be displayed in a web page.
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,552 | 🐛 212 | 🌐 Python | 📅 2026-09-07 - Transparent proxy server that works as a poor man's VPN. Forwards over ssh. Doesn't require admin. Works with Linux and macOS. Supports DNS tunneling.
* [gping](https://github.com/orf/gping) ⭐ 12,678 | 🐛 39 | 🌐 Rust | 📅 2026-09-10 - Ping, but with a graph.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,353 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,959 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,493 | 🐛 15 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,733 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,541 | 🐛 57 | 🌐 Rust | 📅 2026-09-10 - oha is a tiny program that sends some load to a web application and show real-time TUI.
* [serve](https://github.com/vercel/serve) ⭐ 9,900 | 🐛 150 | 🌐 TypeScript | 📅 2026-06-30 - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* [websocat](https://github.com/vi/websocat) ⭐ 8,690 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,909 | 🐛 84 | 🌐 Rust | 📅 2026-09-12 - A network diagnostic tool.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,659 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [dog](https://github.com/ogham/dog) ⭐ 6,691 | 🐛 79 | 🌐 Rust | 📅 2024-05-29 - dog is a command-line DNS client. It has colorful output, understands normal command-line argument syntax, supports the DNS-over-TLS and DNS-over-HTTPS protocols, and can emit JSON.
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,106 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
...
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,070 | 🐛 32 | 🌐 C | 📅 2026-09-08 - Kyanos is a networking analysis tool using eBPF. It can visualize the time packets spend in the kernel, capture requests/responses, makes troubleshooting more efficient.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,019 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,721 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,715 | 🐛 34 | 🌐 Go | 📅 2026-09-05 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,578 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - TUI for sniffing network traffic using eBPF on Linux.
* [asn](https://github.com/nitefood/asn) ⭐ 1,933 | 🐛 3 | 🌐 Shell | 📅 2026-09-10 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
* [gg](https://github.com/mzz2017/gg) ⭐ 1,932 | 🐛 48 | 🌐 Go | 📅 2026-07-06 - A command-line tool for one-click proxy in your research and development without installing v2ray or anything else.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,840 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,602 | 🐛 23 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,560 | 🐛 3 | 🌐 Rust | 📅 2026-09-11 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,237 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
...
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 725 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - MQTT Client written in rust (Subscribe to a MQTT topic or publish something quickly).
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 539 | 🐛 0 | 🌐 Go | 📅 2026-09-05 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [packemon](https://github.com/ddddddO/packemon) ⭐ 307 | 🐛 36 | 🌐 Go | 📅 2026-09-11 - TUI tool and Go library for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).
...
* [neoss](https://github.com/PabloLec/neoss) ⭐ 230 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - User-friendly and detailed socket statistics with a Terminal UI.
...
* [SMBScan](https://github.com/jeffhacks/smbscan) ⭐ 50 | 🐛 18 | 🌐 Python | 📅 2026-08-18 - SMBScan is a tool to enumerate file shares on an internal network.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,000 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing bluetooth devices on Linux.
* [impala](https://github.com/pythops/impala) ⭐ 2,847 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi networks and connections on Linux.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,406 | 🐛 12 | 🌐 Go | 📅 2026-07-01 - A TUI-based Bluetooth connection manager, which can interact with Bluetooth adapters and devices. It aims to be a replacement to most Bluetooth managers, like blueman.
...
* [goto](https://github.com/grafviktor/goto) ⭐ 533 | 🐛 12 | 🌐 Go | 📅 2026-09-11 - A simple terminal SSH manager that provides you with an easy access to the list of your favorite SSH servers, binaries included.
* [sshed](https://github.com/trntv/sshed) ⭐ 158 | 🐛 5 | 🌐 Go | 📅 2024-05-23 - sshed is a ssh config editor and bookmarks manager.
* [ssm](https://github.com/lfaoro/ssm) ⭐ 113 | 🐛 10 | 🌐 Go | 📅 2026-09-07 - SSH connection manager designed to connect, filter, tag, and much more from a simple terminal interface.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 190,523 | 🐛 2,648 | 🌐 Python | 📅 2026-08-30 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,188 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,066 | 🐛 1,177 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,303 | 🐛 2 | 🌐 Go | 📅 2026-09-10 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,676 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,924 | 🐛 182 | 🌐 Python | 📅 2026-09-06 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,479 | 🐛 1,142 | 🌐 Python | 📅 2026-09-04 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,069 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 8,057 | 🐛 190 | 🌐 Go | 📅 2026-09-09 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,675 | 🐛 125 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,718 | 🐛 26 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,529 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,077 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [Yark](https://github.com/Owez/yark) ⭐ 2,185 | 🐛 21 | 🌐 Python | 📅 2026-07-30 - YouTube archiving made simple.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,858 | 🐛 380 | 🌐 C++ | 📅 2026-09-11 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,228 | 🐛 9 | 🌐 Python | 📅 2026-09-08 - A Python tool that lets you find and download torrents without leaving your CLI.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 694 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,493 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 - Chromium running inside your terminal.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,962 | 🐛 171 | 🌐 Go | 📅 2026-08-19 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,548 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,836 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [STU](https://github.com/lusingander/stu) ⭐ 908 | 🐛 15 | 🌐 Rust | 📅 2026-04-30 - S3 Terminal UI, is a interactive terminal-based explorer for Amazon S3 (AWS S3).
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 813 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
* [wiki-tui](https://github.com/Builditluc/wiki-tui) ⚠️ Archived - A simple and easy to use Wikipedia Text User Interface.
* [Neon Modem Overdrive](https://github.com/mrusme/neonmodem) ⭐ 702 | 🐛 21 | 🌐 Go | 📅 2026-07-21 - The program allows you to manage and read content from various popular platforms without having to use a browser or separate apps.
* [av](https://github.com/aviator-co/av) ⭐ 511 | 🐛 75 | 🌐 Go | 📅 2026-09-07 - A command line tool to manage stacked PRs with Aviator.
...
* [taskbook](https://github.com/klaudiosinani/taskbook) ⭐ 9,345 | 🐛 102 | 🌐 JavaScript | 📅 2025-11-03 - Tasks, boards & notes for the command-line habitat.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,123 | 🐛 134 | 🌐 Rust | 📅 2026-09-06 - A terminal user interface for taskwarrior.
...
* [topydo](https://github.com/topydo/topydo) ⭐ 937 | 🐛 79 | 🌐 Python | 📅 2026-09-07 - A powerful todo list application for the console, using the todo.txt format.
...
* [Todoman](https://github.com/pimutils/todoman) ⭐ 592 | 🐛 113 | 🌐 Python | 📅 2026-05-25 - A simple, standards-based, CLI todo (aka: task) manager.
...
* [Watson](https://github.com/TailorDev/Watson) ⭐ 2,537 | 🐛 141 | 🌐 Python | 📅 2025-12-15 - Time tracking CLI to know how much time you are spending on your projects. It can generate nice reports for clients.
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,655 | 🐛 125 | 🌐 C++ | 📅 2026-09-09 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [zeit](https://github.com/mrusme/zeit) ⭐ 588 | 🐛 0 | 🌐 Go | 📅 2026-09-09 - A command line tool for tracking time spent on activities.
...
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - Simple timer for the terminal with timer-mode and alarm.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,404 | 🐛 153 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,312 | 🐛 152 | 🌐 Python | 📅 2026-09-10 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
...
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,798 | 🐛 27 | 🌐 Go | 📅 2026-08-31 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 877 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 780 | 🐛 13 | 🌐 Rust | 📅 2026-09-06 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 535 | 🐛 2 | 🌐 Rust | 📅 2026-08-25 - Terminal-based markdown note manager.
...
* [Toney](https://github.com/SourcewareLab/Toney) ⭐ 207 | 🐛 4 | 🌐 Go | 📅 2026-05-27 - A fast, lightweight, terminal-based note-taking TUI app built with Bubbletea; Offers markdown rendering, file navigation and native Neovim editing.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,198 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - A powerful bookmark manager written in Python3 and SQLite3.
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,762 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Access Google Calendars; supports the main tasks: create, delete, and list events.
* [khal](https://github.com/pimutils/khal) ⭐ 3,047 | 🐛 264 | 🌐 Python | 📅 2026-09-07 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,873 | 🐛 225 | 🌐 Python | 📅 2026-09-04.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,353 | 🐛 5 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
* [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,873 | 🐛 225 | 🌐 Python | 📅 2026-09-04 - CalDAV synchronization program.
* [tz](https://github.com/oz/tz) ⭐ 899 | 🐛 8 | 🌐 Go | 📅 2025-02-14 - tz helps you schedule things across time zones. It's an interactive TUI program that displays time across the time zones of your choosing.
* [khard](https://github.com/lucc/khard) ⭐ 671 | 🐛 35 | 🌐 Python | 📅 2026-09-07 - vCard address book written in Python. Supports CardDAV.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,228 | 🐛 32 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,903 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [Puffin](https://github.com/siddhantac/puffin) ⭐ 569 | 🐛 11 | 🌐 Go | 📅 2026-03-11 - A beautiful TUI dashboard for hledger.
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 324 | 🐛 7 | 🌐 Rust | 📅 2026-09-10 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Lakshmi](https://github.com/sarvjeets/lakshmi) ⭐ 148 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Investing library and command-line interface inspired by the Bogleheads philosophy.
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 94 | 🐛 4 | 🌐 Rust | 📅 2026-09-07 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,928 | 🐛 813 | 🌐 TypeScript | 📅 2026-09-12 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,895 | 🐛 69 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,440 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [parllama](https://github.com/paulrobello/parllama) ⭐ 488 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - TUI designed for easy management and use of Ollama based LLMs.
* [savvy-cli](https://github.com/getsavvyinc/savvy-cli) ⭐ 465 | 🐛 0 | 🌐 Go | 📅 2025-01-28 - Automatically capture and surface your team's tribal knowledge.
* [termite](https://github.com/shobrook/termite) ⭐ 419 | 🐛 7 | 🌐 Python | 📅 2025-01-06 - Generative UI in your terminal.
* [leettools](https://github.com/leettools-dev/leettools) ⭐ 342 | 🐛 10 | 🌐 Python | 📅 2026-04-19 - AI Search tools.
...
* [Browser CLI](https://github.com/browsemake/browser-cli) ⭐ 47 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-06 - AI agent browser automation tool.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,080 | 🐛 107 | 🌐 Go | 📅 2026-09-02 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
* [h-m-m](https://github.com/nadrad/h-m-m) ⭐ 2,290 | 🐛 4 | 🌐 PHP | 📅 2026-07-06 - h-m-m (pronounced like the interjection "hmm") is a simple, fast, keyboard-centric terminal-based tool for working with mind maps.
...
* [Sinkzone](https://github.com/berbyte/sinkzone) ⭐ 346 | 🐛 4 | 🌐 Go | 📅 2026-08-24 - Application that blocks everything by default unless you explicitly allow it; A DNS tool for productivity, focus, and child safety.
* [gtt](https://github.com/eeeXun/gtt) ⭐ 306 | 🐛 2 | 🌐 Go | 📅 2026-08-02 - Google Translate TUI (Originally), now supporting Apertium, Argos, Bing, ChatGPT, DeepL, DeepLX, Google, Reverso.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,657 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,832 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,408 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [tuitorial](https://github.com/basnijholt/tuitorial) ⭐ 528 | 🐛 15 | 🌐 Python | 📅 2026-09-10 - Create beautiful terminal-based code tutorials with syntax highlighting and interactive navigation.
...
* [alex](https://github.com/get-alex/alex) ⭐ 5,098 | 🐛 28 | 🌐 JavaScript | 📅 2024-11-27 - Catch insensitive, inconsiderate writing, by finding gender favoring, polarizing, race related, or other unequal phrasing in text.
* [write good](https://github.com/btford/write-good) ⭐ 5,089 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English prose.
...
* [GTT - Google Translate TUI](https://github.com/eeeXun/GTT) ⭐ 306 | 🐛 2 | 🌐 Go | 📅 2026-08-02 - A TUI interface to bring Google Translation in the terminal.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,685 | 🐛 110 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
* [kalker](https://github.com/PaddiM8/kalker) ⭐ 1,914 | 🐛 41 | 🌐 Rust | 📅 2026-07-10 - Calculator that supports math-like syntax with user-defined variables, functions, derivation, integration, and complex numbers.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,842 | 🐛 457 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,951 | 🐛 90 | 🌐 Go | 📅 2026-09-11 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,286 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
* [halp](https://github.com/orhun/halp) ⭐ 767 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - halp aims to help find the correct arguments for command-line tools by checking the predefined list of commonly used options/flags.
...
* [cmdCompass](https://github.com/johnwangwyx/cmdCompass) ⭐ 59 | 🐛 2 | 🌐 Python | 📅 2024-10-26 - Cross-platform terminal command manager/notebook with features like custom collections, tagging, variable substitution, and integrated man page with option highlighting.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 135 | 🐛 1 | 🌐 Rust | 📅 2026-09-11 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [LazyShell](https://github.com/bernoussama/lazyshell) ⭐ 44 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-04 - AI CLI tool that generates and executes shell commands using AI.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-11 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,387 | 🐛 541 | 🌐 Go | 📅 2026-09-11 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,669 | 🐛 263 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,489 | 🐛 40 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,235 | 🐛 54 | 🌐 C | 📅 2026-09-06 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,316 | 🐛 29 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,040 | 🐛 38 | 🌐 C | 📅 2026-09-11 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,814 | 🐛 4 | 🌐 Python | 📅 2026-09-11 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 999 | 🐛 16 | 🌐 Python | 📅 2026-09-07 - AI-Powered Command-Line Photo Search Tool.
* [figma-use](https://github.com/dannote/figma-use) ⭐ 599 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-03 - Control Figma from the command line with full read/write access for AI agents.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,746 | 🐛 74 | 🌐 Python | 📅 2026-09-11 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,488 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [yt-x](https://github.com/Benexl/yt-x) ⭐ 1,654 | 🐛 11 | 🌐 Shell | 📅 2026-08-30 - Browse youtube from your terminal, with text-based UI using `fzf` or `rofi` for seamless navigation.
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 601 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,347 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,650 | 🐛 718 | 🌐 Python | 📅 2026-09-12 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,790 | 🐛 227 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,202 | 🐛 154 | 🌐 Rust | 📅 2026-09-12 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,771 | 🐛 213 | 🌐 Rust | 📅 2026-09-09 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
* [Tizonia](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,740 | 🐛 168 | 🌐 C | 📅 2026-09-05 - Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, TuneIn, iHeartRadio, Plex servers and Chromecast devices.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 589 | 🐛 28 | 🌐 Rust | 📅 2026-09-11 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-11 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [spytorec](https://github.com/Danidukiyu/SpytoRec) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2026-09-10 - Real-time Spotify recorder with automatic track splitting, metadata tagging, and high-quality FLAC/OGG output.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,839 | 🐛 179 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 3,050 | 🐛 2 | 🌐 C | 📅 2026-09-12 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,050 | 🐛 2 | 🌐 C | 📅 2026-09-12 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,200 | 🐛 53 | 🌐 Rust | 📅 2026-09-08 - Terminal Music Player written in Rust.
...
* [lowfi](https://github.com/remvze/lowfi) ⭐ 50 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-09 - A music player through your terminal, with the option to open YouTube in the browser.
...
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,813 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,240 | 🐛 9 | 🌐 Python | 📅 2026-09-12 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [neo](https://github.com/st3w/neo) ⭐ 958 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 - Recreates the digital rain effect from "The Matrix". Streams of random characters will endlessly scroll down your terminal screen.
...
* [rusty-rain](https://github.com/cowboy8625/rusty-rain) ⭐ 476 | 🐛 4 | 🌐 Rust | 📅 2026-08-19 - A cross platform matrix rain made with Rust.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,422 | 🐛 514 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,270 | 🐛 35 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer.
* [CAVA](https://github.com/karlstav/cava) ⭐ 6,410 | 🐛 18 | 🌐 C | 📅 2026-08-18 - Cross-platform Audio Visualizer.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,751 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,018 | 🐛 28 | 🌐 Go | 📅 2026-09-12 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,559 | 🐛 15 | 🌐 Go | 📅 2026-08-30 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,409 | 🐛 9 | 🌐 Rust | 📅 2026-09-05 - Terminal image, video, directory, and Markdown viewer.
* [youtube-viewer](https://github.com/trizen/youtube-viewer) ⭐ 1,314 | 🐛 45 | 🌐 Perl | 📅 2026-06-15 - Lightweight application that searches and streams videos from YouTube.
* [epy](https://github.com/wustho/epy) ⭐ 1,212 | 🐛 72 | 🌐 Python | 📅 2024-03-17 - CLI Ebook (epub2, epub3, fb2, mobi) Reader.
...
* [GopherTube](https://github.com/krishnassh/gophertube) ⭐ 430 | 🐛 2 | 🌐 Go | 📅 2026-09-05 - A terminal-based YouTube client that scrapes YouTube search results and uses mpv for video playback.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 352 | 🐛 14 | 🌐 Rust | 📅 2026-08-26 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 344 | 🐛 6 | 🌐 Rust | 📅 2026-08-27 - An TUI for exploring data of a Kafka cluster.
* [hnterm](https://github.com/ggerganov/hnterm) ⭐ 321 | 🐛 5 | 🌐 C++ | 📅 2024-08-07 - Hacker News in the terminal.
* [termv](https://github.com/Roshan-R/termv) ⭐ 299 | 🐛 7 | 🌐 Shell | 📅 2026-05-27 - A terminal IPTV player written in bash.
* [see](https://github.com/guilhermeprokisch/see) ⭐ 290 | 🐛 5 | 🌐 Rust | 📅 2026-08-26 - A cute cat for the terminal with advanced code viewing, Markdown rendering, tree-sitter syntax highlighting, images view and more.
* [dashbrew](https://github.com/rasjonell/dashbrew) ⭐ 272 | 🐛 1 | 🌐 Go | 📅 2026-05-15 - TUI dashboard builder that lets you visualize data from scripts and APIs.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,969 | 🐛 13 | 🌐 Rust | 📅 2026-09-09 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,868 | 🐛 174 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,793 | 🐛 10 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [t-rec](https://github.com/sassman/t-rec-rs) ⭐ 1,253 | 🐛 28 | 🌐 Rust | 📅 2026-09-07 - Blazingly fast terminal recorder that generates animated GIF images for the web written in rust.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,092 | 🐛 446 | 🌐 Go | 📅 2026-09-07 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,815 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,760 | 🐛 14 | 🌐 Rust | 📅 2026-09-07 - Manage your GnuPG keys with ease!
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,182 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
* [vet](https://github.com/safedep/vet) ⭐ 1,106 | 🐛 98 | 🌐 Go | 📅 2026-09-03 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 946 | 🐛 6 | 🌐 Go | 📅 2026-09-10 - A command-line tool for interacting with OAuth 2.0 authorization servers.
* [flawz](https://github.com/orhun/flawz) ⭐ 606 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A Terminal UI for browsing security vulnerabilities (CVEs).
...
* [teller](https://github.com/tellerops/teller) ⭐ 3,230 | 🐛 51 | 🌐 Rust | 📅 2026-01-27 - Cloud native secrets management for developers - never leave your command line for secrets.
* [rbw](https://github.com/doy/rbw) ⭐ 1,475 | 🐛 103 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,309 | 🐛 614 | 🌐 Python | 📅 2026-09-11 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,693 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [Python re(gex)? exercises](https://github.com/learnbyexample/TUI-apps/tree/main/PyRegexExercises) ⭐ 1,015 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - TUI application intended to help you practice Python regular expressions there are more than 100 exercises covering both the builtin re and third-party regex module.
...
* [fzf-tab-completion](https://github.com/lincheney/fzf-tab-completion) ⭐ 861 | 🐛 33 | 🌐 Shell | 📅 2026-07-31 - Tab completion using fzf.
...
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 768 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing your arr servers.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 516 | 🐛 12 | 🌐 Go | 📅 2026-09-11 - Cross Platform tool to validate configuration files.
...
* [anbu](https://github.com/tanq16/anbu) ⭐ 30 | 🐛 1 | 🌐 Go | 📅 2026-09-12 - A swiss army knife for CLI operations catered to devs and security professionals.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,302 | 🐛 13 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
* [TUI apps](https://github.com/learnbyexample/TUI-apps) ⭐ 1,015 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - A repository containing a couple of one-script programs, mainly dedicated to training/learning CLI tools such as grep, awk, etc.
...
* [Smassh](https://github.com/kraanzu/smassh) ⭐ 2,045 | 🐛 11 | 🌐 Python | 📅 2026-08-17 - A TUI based typing test app inspired by MonkeyType.
...
* [Pokete](https://github.com/lxgr-linux/pokete) ⭐ 3,153 | 🐛 30 | 🌐 Python | 📅 2026-05-22 - A terminal based Pokemon like game.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,174 | 🐛 35 | 🌐 Rust | 📅 2026-09-10 - Play chess from your terminal.
* [Square Tic Tac Toe](https://github.com/learnbyexample/TUI-apps/tree/main/SquareTicTacToe) ⭐ 1,015 | 🐛 0 | 🌐 Python | 📅 2026-02-02 - A game like Tic Tac Toe, but you have to form a square with 4 corners instead of a line.
...
* [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 735 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - P2P terminal game about spacepirates playing basketball across the galaxy.
* [clidle](https://github.com/ajeetdsouza/clidle) ⭐ 633 | 🐛 2 | 🌐 Go | 📅 2025-03-28 - Wordle, now over SSH.
* [botany](https://github.com/jifunks/botany/) ⭐ 547 | 🐛 10 | 🌐 Python | 📅 2026-07-18 - A command line, realtime, virtual plant buddy.
* [terminal-doom](https://github.com/cryptocode/terminal-doom) ⭐ 441 | 🐛 2 | 🌐 C | 📅 2026-04-26 - Play DOOM in modern terminals.
* [nudoku](https://github.com/jubalh/nudoku) ⭐ 373 | 🐛 2 | 🌐 C | 📅 2026-07-08 - ncurses based sudoku game.
* [Solitaire TUI](https://github.com/brianstrauch/solitaire-tui) ⭐ 368 | 🐛 4 | 🌐 Go | 📅 2023-09-20 - Klondike solitaire for the terminal.
* [tty-solitaire](https://github.com/mpereira/tty-solitaire) ⭐ 360 | 🐛 24 | 🌐 C | 📅 2025-05-03 - Solitaire game for the terminal ncurses based.
...
* [daktilo](https://github.com/orhun/daktilo) ⭐ 1,252 | 🐛 19 | 🌐 Rust | 📅 2026-09-11 - Turn your keyboard into a typewriter adding sounds at each keystroke.
* [boxes](https://github.com/ascii-boxes/boxes) ⭐ 689 | 🐛 0 | 🌐 C | 📅 2026-08-30 - Boxes is a command line filter program which draws ASCII art boxes around your input text.
...
* [pyjokes](https://github.com/pyjokes/pyjokes) ⭐ 367 | 🐛 8 | 🌐 Python | 📅 2026-09-11 - One line jokes for programmers (jokes as a service).
* [pokeget](https://github.com/talwat/pokeget-rs) ⭐ 296 | 🐛 5 | 🌐 Rust | 📅 2026-07-13 - A bash script you can use to display cool sprites of Pokemon in your terminal.
...
* [conrad](https://github.com/vinayak-mehta/conrad) ⭐ 253 | 🐛 36 | 🌐 Python | 📅 2026-09-10 - Track conferences and meetups.
...
* [Physics TUI](https://github.com/ClaudioRMalvino/physics_TUI) ⭐ 29 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - TUI for physics reference and calculations, providing interactive access to physics equations, definitions, and calculator organized by chapter.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,347 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,597 | 🐛 184 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,372 | 🐛 3 | 🌐 Shell | 📅 2026-09-05 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,197 | 🐛 19 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome Terminal Recorder](https://github.com/orangekame3/awesome-terminal-recorder) ⭐ 256 | 🐛 1 | 📅 2026-05-05 - Curated list of outstanding terminal Recorder that make your day brighter! Each item is associated with an animated GIF that shows some examples of usage.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,565 | 🐛 75 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
