...
* [eza](https://github.com/eza-community/eza) ⭐ 22,963 | 🐛 429 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,178 | 🐛 206 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [vivid](https://github.com/sharkdp/vivid) ⭐ 2,259 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - A themeable LS\_COLORS generator with a rich filetype datebase.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,713 | 🐛 137 | 🌐 Rust | 📅 2026-08-19 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
* [z](https://github.com/rupa/z) ⭐ 17,039 | 🐛 107 | 🌐 Shell | 📅 2024-06-19 - Directory changer based on aging and 'frecency'.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,129 | 🐛 188 | 🌐 Rust | 📅 2026-08-11 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [gomi](https://github.com/babarot/gomi) ⭐ 563 | 🐛 2 | 🌐 Go | 📅 2026-06-07 - UNIX rm command with a safety net.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,450 | 🐛 185 | 🌐 C | 📅 2026-05-29 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,793 | 🐛 427 | 🌐 Rust | 📅 2026-08-02 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,790 | 🐛 296 | 🌐 Rust | 📅 2026-08-18 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,081 | 🐛 4 | 🌐 Perl | 📅 2026-08-18 - Make your diffs human-readable instead of machine-readable.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,872 | 🐛 69 | 🌐 Go | 📅 2026-08-17 - A diff tool for YAML files, and sometimes JSON.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,381 | 🐛 179 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
...
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,574 | 🐛 46 | 🌐 Rust | 📅 2026-08-18 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,813 | 🐛 73 | 🌐 Rust | 📅 2026-03-25 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,242 | 🐛 8 | 🌐 C++ | 📅 2026-08-17 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,308 | 🐛 76 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,144 | 🐛 8 | 🌐 Rust | 📅 2026-08-18 - du + rust = dust. Like du but more intuitive.
...
* [gdu](https://github.com/dundee/gdu) ⭐ 5,904 | 🐛 56 | 🌐 Go | 📅 2026-08-18 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,116 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal disk space navigator that traverse the file-system with a TUI interface.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,927 | 🐛 144 | 🌐 C | 📅 2026-05-06 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,111 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,141 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - A modern replacement for ps written in Rust.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,043 | 🐛 41 | 🌐 Rust | 📅 2026-07-13 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
...
* [FClones](https://github.com/pkolaczk/fclones) ⭐ 2,906 | 🐛 99 | 🌐 Rust | 📅 2025-03-03 - Efficient Duplicate File Finder.
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,399 | 🐛 133 | 🌐 C | 📅 2026-08-18 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,477 | 🐛 66 | 🌐 Rust | 📅 2026-08-17 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 22,625 | 🐛 257 | 🌐 Go | 📅 2026-08-15 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,813 | 🐛 4 | 🌐 C | 📅 2026-08-17 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,463 | 🐛 80 | 🌐 Go | 📅 2026-08-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,720 | 🐛 108 | 🌐 Rust | 📅 2026-07-19 - ranger-like terminal file manager
* [walk](https://github.com/antonmedv/walk) ⭐ 3,636 | 🐛 10 | 🌐 Go | 📅 2026-01-06 - Terminal file manager.
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,208 | 🐛 478 | 🌐 C++ | 📅 2026-08-18 - Linux port of Far v2 file manager.
* [clifm](https://github.com/leo-arch/clifm) ⭐ 1,719 | 🐛 26 | 🌐 C | 📅 2026-08-19 - A CLI-based, shell-like, and non-curses terminal file manager written in C: simple, fast, extensible, and lightweight as hell.
...
* [tre](https://github.com/dduan/tre) ⭐ 1,215 | 🐛 23 | 🌐 Rust | 📅 2024-09-03 - `tree` command improved with git awareness, editor aliasing, and colors.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,738 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,714 | 🐛 100 | 🌐 Rust | 📅 2026-08-17 - Painless compression and decompression in the terminal.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,615 | 🐛 61 | 🌐 C | 📅 2026-08-08 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 174,518 | 🐛 872 | 🌐 Python | 📅 2026-07-29 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-08-18 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,311 | 🐛 532 | 🌐 Rust | 📅 2026-08-16 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,710 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,082 | 🐛 371 | 🌐 Python | 📅 2026-06-23.
...
* [awk](https://github.com/onetrueawk/awk) ⭐ 2,220 | 🐛 14 | 🌐 C | 📅 2026-08-18 - A historical, general-purpose text file processor, implements a domain-specific language designed for text processing and typically used as a data extraction and reporting tool.
...
* [sampler](https://github.com/sqshq/sampler) ⭐ 14,785 | 🐛 62 | 🌐 Go | 📅 2024-02-22 - Sampler is a tool for shell commands execution, visualization, and alerting. Configured with a simple YAML file.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,583 | 🐛 25 | 🌐 Go | 📅 2026-07-28 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,851 | 🐛 294 | 🌐 Go | 📅 2026-08-06 - Portable command-line YAML processor.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,665 | 🐛 60 | 🌐 Python | 📅 2026-06-18 - Serializes the output of command line tools to JSON.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,795 | 🐛 17 | 🌐 Go | 📅 2026-07-20 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,716 | 🐛 24 | 🌐 Rust | 📅 2026-08-15 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,830 | 🐛 23 | 🌐 Go | 📅 2026-02-06 - A TUI playground for exploring jq.
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,479 | 🐛 29 | 🌐 Python | 📅 2026-08-04 - Graphtage is a command-line utility and underlying library for semantically comparing and merging tree-like structures, such as JSON, XML, HTML, YAML, plist, and CSS files.
...
* [jtbl](https://github.com/kellyjonbrazil/jtbl) ⭐ 342 | 🐛 2 | 🌐 Python | 📅 2024-04-02 - A simple CLI tool to print JSON and JSON Lines data as a table in the terminal.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,217 | 🐛 712 | 🌐 Go | 📅 2026-08-19 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,354 | 🐛 42 | 🌐 Python | 📅 2026-08-18 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,962 | 🐛 4 | 🌐 Python | 📅 2026-08-18 - A command line client for MySQL that can do autocompletion and syntax highlighting.
* [usql](https://github.com/xo/usql) ⭐ 10,079 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and others, including NoSQL and non-relational databases.
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,001 | 🐛 70 | 🌐 Go | 📅 2026-08-17 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,331 | 🐛 53 | 🌐 Python | 📅 2026-08-18 - The SQL IDE for Your Terminal.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,279 | 🐛 19 | 🌐 Rust | 📅 2026-08-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,225 | 🐛 51 | 🌐 Go | 📅 2026-08-19 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,934 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,759 | 🐛 28 | 🌐 Rust | 📅 2026-08-19 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,759 | 🐛 28 | 🌐 Rust | 📅 2026-08-19 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
...
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,186 | 🐛 15 | 🌐 Go | 📅 2026-08-18 - Interactive client for PostgreSQL, MySQL, SQLite3, Oracle and SQL Server.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,079 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,152 | 🐛 106 | 🌐 Python | 📅 2026-08-14 - Python CLI utility and library for manipulating SQLite databases.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,190 | 🐛 2 | 🌐 Python | 📅 2026-08-18 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,570 | 🐛 327 | 🌐 Go | 📅 2026-08-17 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,929 | 🐛 9 | 🌐 Rust | 📅 2026-08-17 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,181 | 🐛 81 | 🌐 Rust | 📅 2026-08-16 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 26,941 | 🐛 222 | 🌐 Go | 📅 2026-08-16 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,080 | 🐛 696 | 🌐 Rust | 📅 2026-08-18 - Create book from Markdown files.
* [Grip](https://github.com/joeyespo/grip) ⭐ 6,825 | 🐛 126 | 🌐 Python | 📅 2024-07-10 - GitHub Readme Instant Preview - Preview Markdown files as GitHub would render them.
...
* [Frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,269 | 🐛 46 | 🌐 Python | 📅 2024-08-01 - A Markdown viewer / browser for the terminal.
...
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 811 | 🐛 58 | 🌐 Python | 📅 2026-08-17 - Mdformat is an opinionated Markdown formatter that can be used to enforce a consistent style in Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,379 | 🐛 1,033 | 🌐 Go | 📅 2026-08-19 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,467 | 🐛 162 | 🌐 Rust | 📅 2026-08-17 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,445 | 🐛 1,025 | 🌐 Go | 📅 2026-08-19 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 28,809 | 🐛 460 | 🌐 Go | 📅 2026-07-29 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,405 | 🐛 339 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
...
* [tig](https://github.com/jonas/tig) ⭐ 13,307 | 🐛 225 | 🌐 C | 📅 2026-07-27 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,319 | 🐛 97 | 🌐 Go | 📅 2026-08-01 - A beautiful CLI dashboard for GitHub.
* [BFG Repo-Cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,169 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,135 | 🐛 146 | 🌐 Rust | 📅 2026-08-17 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,026 | 🐛 62 | 🌐 Rust | 📅 2026-08-17 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,005 | 🐛 176 | 🌐 Go | 📅 2026-07-06 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,181 | 🐛 79 | 🌐 Go | 📅 2026-08-12 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [git-stats](https://github.com/IonicaBizau/git-stats) ⭐ 6,602 | 🐛 5 | 🌐 HTML | 📅 2025-11-09 - Local git statistics including GitHub-like contributions calendars.
* [git absorb](https://github.com/tummychow/git-absorb) ⭐ 5,690 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - git commit --fixup, but automatic.
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,064 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 - A utility tool powered by fzf for using git interactively.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,036 | 🐛 251 | 🌐 Shell | 📅 2026-08-11 - A bash tool which stores private data inside a git repo; it uses users' public keys, allowing trusted users to access encrypted data using PGP and their secret keys.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,296 | 🐛 11 | 🌐 Rust | 📅 2026-07-03 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [czg](https://github.com/Zhengqbbb/cz-git) ⭐ 1,519 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-18 - Interactively generate standardized commit messages.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,056 | 🐛 1,201 | 🌐 Rust | 📅 2026-08-19 - A Git-compatible VCS that is both simple and powerful.
* [Bob](https://github.com/MordechaiHadad/bob) ⭐ 2,137 | 🐛 20 | 🌐 Rust | 📅 2026-08-19 - Bob is a cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,941 | 🐛 133 | 🌐 TypeScript | 📅 2026-08-18 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 27,488 | 🐛 645 | 🌐 Go | 📅 2026-08-19 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,987 | 🐛 405 | 🌐 JavaScript | 📅 2026-08-18 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,889 | 🐛 4 | 🌐 Go | 📅 2026-08-01 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,444 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,828 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,285 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Instant, easy, and predictable development environments.
...
* [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,840 | 🐛 29 | 🌐 Python | 📅 2026-04-15 - Instant coding answers via the command line.
* [release-it](https://github.com/release-it/release-it) ⭐ 9,029 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or Node.js packages.
* [scc](https://github.com/boyter/scc) ⭐ 8,627 | 🐛 30 | 🌐 Go | 📅 2026-08-18 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
...
* [Flox](https://github.com/flox/flox) ⭐ 4,096 | 🐛 444 | 🌐 Rust | 📅 2026-08-18 - Developer environments you can take with you.
...
* [scriptisto](https://github.com/igor-petruk/scriptisto) ⭐ 1,090 | 🐛 10 | 🌐 Rust | 📅 2025-02-08 - A language-agnostic "shebang interpreter" that enables you to write scripts in compiled languages.
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 164 | 🌐 Rust | 📅 2026-08-18 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [mk](https://github.com/pycontribs/mk) ⭐ 139 | 🐛 12 | 🌐 Python | 📅 2026-08-18 - mk is a CLI tool that aims to ease contribution to any open source project by hiding repository implementation details from the casual contributor.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,384 | 🐛 115 | 🌐 Go | 📅 2026-08-18 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,285 | 🐛 496 | 🌐 Go | 📅 2026-08-18 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,832 | 🐛 41 | 🌐 Go | 📅 2026-07-24 - Multi pod and container log tailing for Kubernetes.
* [KDash](https://github.com/kdash-rs/kdash) ⭐ 2,520 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 - A simple and fast terminal dashboard for Kubernetes.
* [eks-node-viewer](https://github.com/awslabs/eks-node-viewer/) ⭐ 1,634 | 🐛 24 | 🌐 Go | 📅 2026-08-18 - Tool for visualizing dynamic node usage within a kubernetes cluster.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,384 | 🐛 7 | 🌐 Go | 📅 2026-08-01 - Terminal user interface for reading logs from journald, auditd, file system, Docker (including Swarm) containers, Compose stacks, Podman and Kubernetes pods with support for output coloring and multiple filtering modes.
* [TFTUI](https://github.com/idoavrah/terraform-tui) ⭐ 1,290 | 🐛 12 | 🌐 Python | 📅 2024-07-09 - TUI to view and interact with Terraform state.
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,202 | 🐛 15 | 🌐 Go | 📅 2026-08-17 - TUI for Podman environment.
...
* [E1S](https://github.com/keidarcy/e1s) ⭐ 918 | 🐛 2 | 🌐 Go | 📅 2026-08-03 - TUI for browsing and managing AWS ECS resources.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,433 | 🐛 332 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,435 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,279 | 🐛 83 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,900 | 🐛 311 | 🌐 Python | 📅 2025-10-22 - Command line tool for managing Amazon S3 and CloudFront services.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,914 | 🐛 6 | 🌐 Go | 📅 2026-08-18 - Domain Availability Research Tool.
...
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,214 | 🐛 9 | 🌐 Rust | 📅 2026-07-04 - TUI-based HTTP/REST client.
...
* [Shopify Development Tools](https://github.com/ScreenStaring/shopify-dev-tools) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-08-18 - Tools to assist with the development and/or maintenance of Shopify apps and stores.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,060 | 🐛 3 | 🌐 Rust | 📅 2026-08-18 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 48,317 | 🐛 1,817 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,356 | 🐛 170 | 🌐 Rust | 📅 2026-08-12 - Handy way to save and run project-specific commands.
* [mackup](https://github.com/lra/mackup) ⭐ 15,308 | 🐛 295 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux).
* [inshellisense](https://github.com/microsoft/inshellisense) ⭐ 10,652 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-11 - IDE style command line auto complete with support for 600+ command line tools.
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,731 | 🐛 88 | 🌐 Python | 📅 2026-08-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,271 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 59,834 | 🐛 252 | 🌐 Zig | 📅 2026-08-19 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,432 | 🐛 1,814 | 🌐 Rust | 📅 2026-08-18 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [dtach](https://github.com/crigler/dtach) ⭐ 737 | 🐛 20 | 🌐 C | 📅 2025-06-21 - A program written in C that emulates the detach feature of screen.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 34,985 | 🐛 1,857 | 🌐 Rust | 📅 2026-08-18 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,291 | 🐛 1,428 | 🌐 Rust | 📅 2026-08-19 - A modern shell written in Rust, where all data is structured.
* [Elvish](https://github.com/elves/elvish) ⭐ 6,359 | 🐛 350 | 🌐 Go | 📅 2026-03-31 - Elvish is a versatile interactive shell and expressive programming language, combined into one seamless package.
* [Oils](https://github.com/oilshell/oil) ⭐ 3,381 | 🐛 610 | 🌐 Python | 📅 2026-05-31 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 29 | 🐛 52 | 🌐 C++ | 📅 2026-08-18 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,934 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [Pure](https://github.com/sindresorhus/pure) ⭐ 14,395 | 🐛 0 | 🌐 Shell | 📅 2026-07-16 - Pretty, minimal, and fast ZSH prompt.
...
* [extrakto](https://github.com/laktak/extrakto) ⭐ 1,137 | 🐛 1 | 🌐 Python | 📅 2026-03-02 - extrakto for tmux - quickly select, copy/insert/complete text without a mouse.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,671 | 🐛 97 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,264 | 🐛 74 | 🌐 C | 📅 2026-08-18 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,264 | 🐛 74 | 🌐 C | 📅 2026-08-18 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,829 | 🐛 455 | 🌐 C | 📅 2026-08-05 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
...
* [Cloud Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,639 | 🐛 36 | 🌐 Python | 📅 2026-07-05 - Real-time Claude Code usage monitor with predictions and warnings.
...
* [HyFetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,088 | 🐛 9 | 🌐 Shell | 📅 2026-08-09 - A fork of the abandoned [Neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived, HyFetch displays information about your system next to an image, your OS logo, or any ASCII file of your choice.
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,964 | 🐛 11 | 🌐 Rust | 📅 2025-03-08 - Fast, minimal and customizable system information frontend.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,812 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors, including CPU, GPU, RAM usage, power consumption and temperature.
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,066 | 🐛 29 | 🌐 Go | 📅 2026-08-10 - A terminal OpenTelemetry viewer, currently supporting OpenTelemetry, Zipkin (Traces) and Prometheus (Metrics) formats.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,414 | 🐛 210 | 🌐 Rust | 📅 2026-08-18 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,058 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
* [bin](https://github.com/marcosnils/bin) ⭐ 1,264 | 🐛 91 | 🌐 Go | 📅 2026-08-02 - Manages binary files downloaded from different sources.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,473 | 🐛 211 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,530 | 🐛 292 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,826 | 🐛 121 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [quickemu](https://github.com/quickemu-project/quickemu) ⭐ 15,672 | 🐛 67 | 🌐 Shell | 📅 2026-08-14 - Quickly create and run optimized Windows, macOS and Linux desktop virtual machines.
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,879 | 🐛 141 | 🌐 Go | 📅 2026-08-09 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,266 | 🐛 28 | 🌐 Go | 📅 2026-08-18 - A Docker manager for the terminal.
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,073 | 🐛 58 | 🌐 Go | 📅 2026-08-09 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,809 | 🐛 24 | 🌐 Rust | 📅 2026-07-24 - A simple TUI to view & control docker containers.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,332 | 🐛 116 | 🌐 C | 📅 2026-08-09 - A window switcher, application launcher and dmenu replacement.
* [pueue](https://github.com/Nukesor/pueue) ⭐ 6,293 | 🐛 20 | 🌐 Rust | 📅 2026-08-16 - Pueue is a command-line task management tool for sequential and parallel execution of long-running tasks.
* [entr](https://github.com/eradman/entr) ⭐ 5,649 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,697 | 🐛 67 | 🌐 Rust | 📅 2026-07-20 - mprocs runs multiple commands in parallel and shows output of each command separately.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,688 | 🐛 16 | 🌐 Go | 📅 2026-08-17 - TUI for running apps and processes.
* [Marker](https://github.com/pindexis/marker) ⭐ 2,092 | 🐛 49 | 🌐 Python | 📅 2024-04-06 - The terminal command palette.
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,500 | 🐛 6 | 🌐 Go | 📅 2026-08-08 - Executing shell commands via HTTP server.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,885 | 🐛 3 | 🌐 Rust | 📅 2026-08-18 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,048 | 🐛 7 | 🌐 Rust | 📅 2026-08-16 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,048 | 🐛 7 | 🌐 Rust | 📅 2026-08-16 - CLI to manage emails.
...
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,891 | 🐛 28 | 🌐 Go | 📅 2026-08-18 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
* [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) ⭐ 2,249 | 🐛 211 | 🌐 TypeScript | 📅 2026-08-18 - The program provides a solution for archiving, storing, indexing and searching emails from major platforms.
* [meli](https://github.com/meli/meli) ⭐ 882 | 🐛 4 | 🌐 Rust | 📅 2026-08-14 - Terminal mail client.
* [alot](https://github.com/pazz/alot) ⭐ 752 | 🐛 225 | 🌐 Python | 📅 2026-07-29 - MUA written in Python using the [NotMuch](https://notmuchmail.org/) backend, MailDir format support.
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,157 | 🐛 1,188 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
* [slack-term](https://github.com/erroneousboat/slack-term) ⭐ 6,608 | 🐛 68 | 🌐 Go | 📅 2024-04-23 - Slack client for the  terminal.
* [ssh-chat](https://github.com/shazow/ssh-chat) ⭐ 5,906 | 🐛 54 | 🌐 Go | 📅 2026-01-10 - Custom SSH server written in Go. Instead of a shell, you get a chat prompt.
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,736 | 🐛 56 | 🌐 Go | 📅 2026-08-18 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,871 | 🐛 102 | 🌐 Java | 📅 2026-08-17 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,115 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-16 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,921 | 🐛 20 | 🌐 C++ | 📅 2026-08-16 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
...
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,151 | 🐛 22 | 🌐 Haskell | 📅 2026-08-18 - A terminal client for the Mattermost chat system.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 989 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A TUI for Telegram written in Rust.
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 949 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
* [PingMe](https://github.com/kha7iq/pingme) ⭐ 861 | 🐛 4 | 🌐 Go | 📅 2026-07-15 - Sends messages or alerts to multiple messaging platforms & email, including Slack, Telegram, Mattermost, WeChat, and others.
* [Zulip Terminal](https://github.com/zulip/zulip-terminal) ⭐ 854 | 🐛 474 | 🌐 Python | 📅 2026-08-16 - Official Zulip terminal client with TUI.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,220 | 🐛 112 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,905 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
* [bore](https://github.com/ekzhang/bore) ⭐ 11,403 | 🐛 14 | 🌐 Rust | 📅 2026-02-04 - A simple CLI tool for making tunnels to localhost.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,718 | 🐛 42 | 🌐 Go | 📅 2026-08-04 - Interactive CLI tool for HTTP inspection.
* [oha](https://github.com/hatoo/oha) ⭐ 10,498 | 🐛 59 | 🌐 Rust | 📅 2026-08-02 - oha is a tiny program that sends some load to a web application and show real-time TUI.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,664 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Netcat, curl and socat for WebSockets.
* [sshx](https://github.com/ekzhang/sshx) ⭐ 7,646 | 🐛 26 | 🌐 Rust | 📅 2025-06-19 - Fast, collaborative live terminal sharing over the web.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,499 | 🐛 79 | 🌐 Rust | 📅 2026-08-13 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,085 | 🐛 42 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,071 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,105 | 🐛 47 | 🌐 C | 📅 2026-08-02 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,866 | 🐛 14 | 🌐 Rust | 📅 2026-08-17 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
...
* [asn](https://github.com/nitefood/asn) ⭐ 1,922 | 🐛 3 | 🌐 Shell | 📅 2026-06-22 - Server for the following services: ASN, RPKI validity, BGP stats, IPv4v6, Prefix, URL, ASPath, Organization, IP reputation, IP geolocation, IP fingerprinting, Network recon, lookup API server, Web traceroute server.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,810 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,572 | 🐛 25 | 🌐 Rust | 📅 2026-07-09 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,547 | 🐛 16 | 🌐 Rust | 📅 2026-08-18 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 185,417 | 🐛 2,598 | 🌐 Python | 📅 2026-08-18 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,972 | 🐛 4,128 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 41,741 | 🐛 1,160 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 39,914 | 🐛 0 | 🌐 Go | 📅 2026-08-18 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,631 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,830 | 🐛 177 | 🌐 Python | 📅 2026-08-17 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,251 | 🐛 1,156 | 🌐 Python | 📅 2026-08-01 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
* [xh](https://github.com/ducaale/xh) ⭐ 8,027 | 🐛 38 | 🌐 Rust | 📅 2026-08-16 - xh is a friendly and fast tool for sending HTTP requests. It reimplements as much as possible of HTTPie's excellent design.
* [tdl](https://github.com/iyear/tdl) ⭐ 7,931 | 🐛 211 | 🌐 Go | 📅 2026-08-17 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,623 | 🐛 123 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [Yark](https://github.com/Owez/yark) ⭐ 2,182 | 🐛 21 | 🌐 Python | 📅 2026-07-30 - YouTube archiving made simple.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,844 | 🐛 400 | 🌐 C++ | 📅 2026-08-18 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
* [Torrra](https://github.com/stabldev/torrra) ⭐ 1,220 | 🐛 14 | 🌐 Python | 📅 2026-08-18 - A Python tool that lets you find and download torrents without leaving your CLI.
...
* [jira-cli](https://github.com/ankitpokhrel/jira-cli) ⭐ 5,906 | 🐛 163 | 🌐 Go | 📅 2026-08-17 - Feature-rich interactive Jira command line.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,530 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A command line utility to search DuckDuckGo (HTML version) from the terminal.
* [socialscan](https://github.com/iojw/socialscan) ⭐ 1,817 | 🐛 14 | 🌐 Python | 📅 2026-08-03 - Python library and CLI for accurately querying username and email usage on online platforms.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 801 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [av](https://github.com/aviator-co/av) ⭐ 510 | 🐛 72 | 🌐 Go | 📅 2026-08-18 - A command line tool to manage stacked PRs with Aviator.
...
* [ghfetch](https://github.com/orangekame3/ghfetch) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-08-19 - ghfetch is a CLI tool to fetch GitHub user information and show like Neofetch.
...
* [dijo](https://github.com/NerdyPepper/dijo) ⭐ 2,919 | 🐛 36 | 🌐 Rust | 📅 2024-08-13 - Scriptable, curses-based, digital habit tracker.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,640 | 🐛 126 | 🌐 C++ | 📅 2026-08-18 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,376 | 🐛 6 | 🌐 Shell | 📅 2026-08-18 - A feature-rich clock/ timer/ pattern-based time manager in terminal with curated text-art.
...
* [nb](https://github.com/xwmx/nb) ⭐ 8,364 | 🐛 150 | 🌐 Shell | 📅 2026-08-18 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application.
...
* [dnote](https://github.com/dnote/dnote) ⭐ 3,055 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,767 | 🐛 25 | 🌐 Go | 📅 2026-08-03 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 874 | 🐛 8 | 🌐 Rust | 📅 2023-11-04 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 772 | 🐛 24 | 🌐 Rust | 📅 2026-08-16 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [Captain's Log](https://github.com/NikolaDucak/caps-log) ⭐ 393 | 🐛 16 | 🌐 C++ | 📅 2026-08-14 - A small TUI journaling tool (daily entries saved as md files, tags for organizing entries, browse tags, calendar view, encrypted logs, storage using a git repository).
...
* [idea](https://github.com/IonicaBizau/idea) ⭐ 276 | 🐛 2 | 🌐 JavaScript | 📅 2025-02-13 - A lightweight tool for keeping ideas in a safe place quick and easy.
...
* [buku](https://github.com/jarun/buku) ⭐ 7,177 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,041 | 🐛 264 | 🌐 Python | 📅 2026-08-18 - Calendar that can synchronize with CalDAV servers through [vdirsyncer](https://github.com/pimutils/vdirsyncer) ⭐ 1,862 | 🐛 222 | 🌐 Python | 📅 2026-07-10.
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,337 | 🐛 8 | 🌐 Python | 📅 2026-06-17 - Modern TUI calendar and task manager with customizable interface.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,204 | 🐛 36 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,877 | 🐛 18 | 🌐 Python | 📅 2025-07-06 - TUI application where you  can track and analyse your money flow.
...
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 90 | 🐛 3 | 🌐 Rust | 📅 2026-08-18 - A command line TUI tool for managing financial investment portfolios.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,564 | 🐛 784 | 🌐 TypeScript | 📅 2026-08-19 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,476 | 🐛 63 | 🌐 Go | 📅 2026-08-09 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,369 | 🐛 95 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,057 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [DDQA](https://github.com/DataDog/ddqa) ⭐ 109 | 🐛 1 | 🌐 Python | 📅 2026-08-18 - Jira TUI to help with software releasestool for users of Jira to perform QA of anticipated releases of code on GitHub.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,780 | 🐛 74 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,337 | 🐛 172 | 🌐 C++ | 📅 2026-08-16 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [Lotus 1-2-3 for Linux](https://github.com/taviso/123elf) ⭐ 1,282 | 🐛 40 | 🌐 C | 📅 2026-06-27 - A native port of Lotus 1-2-3 Release 3 to Linux.
...
* [write good](https://github.com/btford/write-good) ⭐ 5,079 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English prose.
...
* [storycraftr](https://github.com/raestrada/storycraftr) ⭐ 159 | 🐛 14 | 🌐 Python | 📅 2026-03-06 - StoryCraftr is an open-source AI-powered tool that helps writers craft stories, generate worldbuilding details, and create book outlines and chapters seamlessly through a simple CLI. Empower your creativity with AI.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,649 | 🐛 124 | 🌐 Rust | 📅 2026-03-13 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [Bitwise](https://github.com/mellowcandle/bitwise) ⭐ 721 | 🐛 12 | 🌐 C | 📅 2026-08-18 - Base conversion and bit manipulator in ncurses.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,720 | 🐛 454 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,455 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,441 | 🐛 14 | 🌐 Rust | 📅 2026-08-18 - Very fast implementation of tldr in Rust.
* [pet](https://github.com/knqyf263/pet) ⭐ 5,327 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Pet is a simple command-line snippet manager, written in Go.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,924 | 🐛 99 | 🌐 Go | 📅 2026-08-18 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
* [IntelliShell](https://github.com/lasantosr/intelli-shell) ⭐ 1,272 | 🐛 6 | 🌐 Rust | 📅 2026-07-26 - Command template and snippet manager for the shell. Like IntelliSense, but for shells, acting like a bookmark store for commands.
...
* [docfd](https://github.com/darrenldl/docfd) ⭐ 288 | 🐛 4 | 🌐 OCaml | 📅 2026-08-19 - TUI fuzzy document finder that looks for documentation files in Markdown and txt format in the directory tree.
...
* [fzf-help](https://github.com/BartSte/fzf-help) ⭐ 60 | 🐛 11 | 🌐 Shell | 📅 2026-08-18 - An fzf extension that allows you to select command line options of a given command; the options are retrieved from the command its `--help` documentation.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 109 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 9 | 🐛 0 | 🌐 Zig | 📅 2026-08-18 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 24,966 | 🐛 547 | 🌐 Go | 📅 2026-08-12 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,636 | 🐛 256 | 🌐 JavaScript | 📅 2026-08-16 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,457 | 🐛 37 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,148 | 🐛 57 | 🌐 C | 📅 2026-08-17 - Terminal graphics for the 21 st century.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,303 | 🐛 28 | 🌐 C | 📅 2026-01-31 - Create, manipulate, and optimize GIF images and animations.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 990 | 🐛 17 | 🌐 Python | 📅 2026-08-18 - AI-Powered Command-Line Photo Search Tool.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,699 | 🐛 76 | 🌐 Python | 📅 2026-08-18 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
...
* [ytsurf](https://github.com/Stan-breaks/ytsurf) ⭐ 588 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Youtube in the terminal (syncplay support, audio-only playback and downloads, download videos, history).
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,308 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,555 | 🐛 708 | 🌐 Python | 📅 2026-08-19 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,088 | 🐛 163 | 🌐 Rust | 📅 2026-07-20 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,730 | 🐛 211 | 🌐 Rust | 📅 2026-08-17 - Cross-platform ncurses Spotify client written in Rust, inspired by ncmpc and the likes.
...
* [opencubicplayer](https://github.com/mywave82/opencubicplayer) ⭐ 436 | 🐛 18 | 🌐 C | 📅 2026-08-18 - Open Cubic Player (UNIX fork) is a music visualizer for various tracked music formats (amiga modules, S3M, IT), chiptunes and other formats related to demoscene.
...
* [musikcube](https://github.com/clangen/musikcube) ⭐ 4,824 | 🐛 177 | 🌐 C++ | 📅 2026-03-23 - A cross-platform, terminal-based audio engine, library, player and server written in C++.
* [cue](https://github.com/ravachol/cue) ⭐ 2,984 | 🐛 0 | 🌐 C | 📅 2026-08-14 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 2,984 | 🐛 0 | 🌐 C | 📅 2026-08-14 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,172 | 🐛 49 | 🌐 Rust | 📅 2026-08-17 - Terminal Music Player written in Rust.
...
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,803 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,164 | 🐛 7 | 🌐 Python | 📅 2026-06-10 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,207 | 🐛 420 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting and Git integration.
...
* [timg](https://github.com/hzeller/timg) ⭐ 2,728 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image and video viewer.
* [ov](https://github.com/noborus/ov) ⭐ 2,003 | 🐛 30 | 🌐 Go | 📅 2026-08-19 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,547 | 🐛 15 | 🌐 Go | 📅 2025-06-22 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
* [mcat](https://github.com/Skardyy/mcat) ⭐ 1,379 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Terminal image, video, directory, and Markdown viewer.
...
* [fancy-cat](https://github.com/freref/fancy-cat) ⭐ 555 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - CLI PDF reader with Vim keybindings.
...
* [viu](https://github.com/learn-anything/command-line-tools) ⭐ 492 | 🐛 15 | 📅 2026-08-16 - Command-line application to view images from the terminal written in Rust.
* [GopherTube](https://github.com/krishnassh/gophertube) ⭐ 422 | 🐛 2 | 🌐 Go | 📅 2026-08-19 - A terminal-based YouTube client that scrapes YouTube search results and uses mpv for video playback.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 349 | 🐛 15 | 🌐 Rust | 📅 2026-07-17 - Minimalistic Vim-like TUI document reader.
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 340 | 🐛 16 | 🌐 Rust | 📅 2026-08-18 - An TUI for exploring data of a Kafka cluster.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,927 | 🐛 13 | 🌐 Rust | 📅 2026-08-16 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,666 | 🐛 168 | 🌐 Go | 📅 2026-08-12 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,696 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
...
* [agg](https://github.com/asciinema/agg) ⭐ 1,689 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - agg is a command-line tool for generating animated GIF files from asciicast v2 files produced by `asciinema` terminal recorder.
...
* [SOPS](https://github.com/getsops/sops) ⭐ 22,853 | 🐛 439 | 🌐 Go | 📅 2026-08-17 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [PaperAge](https://github.com/matiaskorhonen/paper-age) ⭐ 609 | 🐛 10 | 🌐 Rust | 📅 2026-07-01 - Easy and secure paper backups of secrets, which takes a text and generates an encrypted QR code to print on paper.
...
* [jdvrif](https://github.com/CleasbyCode/jdvrif) ⭐ 69 | 🐛 0 | 🌐 C++ | 📅 2026-08-18 - CLI tool to embed or extract files via a JPG image. Post and share your embedded JPG image on compatible sites.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,754 | 🐛 14 | 🌐 Rust | 📅 2026-08-10 - Manage your GnuPG keys with ease!
...
* [vet](https://github.com/safedep/vet) ⭐ 1,099 | 🐛 97 | 🌐 Go | 📅 2026-08-16 - Tool for identifying risks in open source software supply chain.
* [OAuth2c](https://github.com/cloudentity/oauth2c) ⭐ 940 | 🐛 3 | 🌐 Go | 📅 2026-08-07 - A command-line tool for interacting with OAuth 2.0 authorization servers.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,444 | 🐛 95 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,224 | 🐛 564 | 🌐 Python | 📅 2026-08-17 - Simple alerting tool, with declarative syntax and builtin providers.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,681 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Real-time ticker data in your terminal.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,157 | 🐛 11 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [Countryfetch](https://github.com/nik-rev/countryfetch) ⭐ 282 | 🐛 5 | 🌐 Rust | 📅 2026-03-06 - A Command-line tool similar to Neofetch for obtaining information about your country.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,151 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - Play chess from your terminal.
...
* [terminal-doom](https://github.com/cryptocode/terminal-doom) ⭐ 433 | 🐛 2 | 🌐 C | 📅 2026-04-26 - Play DOOM in modern terminals.
...
* [cli-chess](https://github.com/trevorbayless/cli-chess) ⭐ 300 | 🐛 13 | 🌐 Python | 📅 2026-08-18 - A highly customizable way to play chess in your terminal. Play online (via Lichess.org) and offline against the Fairy-Stockfish engine. All Lichess variants are supported.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,118 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,461 | 🐛 183 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,184 | 🐛 1 | 🌐 Shell | 📅 2026-08-18 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome git addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,190 | 🐛 15 | 📅 2024-10-15 - A curated list of add-ons that extend/enhance the git CLI.
...
[Awesome Terminal Recorder](https://github.com/orangekame3/awesome-terminal-recorder) ⭐ 253 | 🐛 1 | 📅 2026-05-05 - Curated list of outstanding terminal Recorder that make your day brighter! Each item is associated with an animated GIF that shows some examples of usage.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,232 | 🐛 72 | 📅 2026-08-11 - An awesome list dedicated to TUI programs.
