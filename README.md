...
* [eza](https://github.com/eza-community/eza) ⭐ 23,320 | 🐛 454 | 🌐 Rust | 📅 2026-08-06 - eza is a modern, *maintained* replacement for `ls`, built on `exa`.
* [lsd](https://github.com/lsd-rs/lsd) ⭐ 16,235 | 🐛 209 | 🌐 Rust | 📅 2026-08-17 - This project is a rewrite of GNU ls with lots of added features like colors, icons, tree-view, more formatting options etc. The project is heavily inspired by the super colorls project.
...
* [lscoltui](https://github.com/breynard0/lscoltui) ⭐ 19 | 🐛 0 | 🌐 Rust | 📅 2025-07-08 - A TUI tool for changing the colours of ls.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,611 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - It remembers which directories you use most frequently, so you can "jump" to them in just a few keystrokes.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,491 | 🐛 201 | 🌐 Rust | 📅 2026-09-16 - A simple, fast, and user-friendly alternative to find. Written in Rust.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,463 | 🐛 186 | 🌐 C | 📅 2026-09-16 - Manage the shell history. It has a powerful visual search and execution of previous commands, and history editing capabilities.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,269 | 🐛 443 | 🌐 Rust | 📅 2026-09-19 - A syntax-highlighter for git and diff output.
* [Difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,916 | 🐛 288 | 🌐 Rust | 📅 2026-09-18 - Syntax-aware structured diff tool.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,089 | 🐛 5 | 🌐 Perl | 📅 2026-09-19 - Make your diffs human-readable instead of machine-readable.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,455 | 🐛 200 | 🌐 Rust | 📅 2026-08-04 - Recursively searches directories for a regex pattern.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,122 | 🐛 563 | 🌐 C | 📅 2024-06-16 - (The silver searcher) - a text search utility targeted to source code; it skips versioning systems data directories; it is inspired by `ack`, but faster.
* [ast-grep](https://github.com/ast-grep/ast-grep) ⭐ 15,966 | 🐛 68 | 🌐 Rust | 📅 2026-09-20 - A CLI tool for code structural search, lint and rewriting.
* [ripgrep-all](https://github.com/phiresky/ripgrep-all) ⭐ 9,848 | 🐛 69 | 🌐 Rust | 📅 2026-09-17 - grep in text files but also search in PDFs, E-Books, office documents, zip, tar.gz, etc.
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,296 | 🐛 7 | 🌐 C++ | 📅 2026-09-15 - Ultra fast grep with interactive TUI, fuzzy search, boolean queries, hexdumps and more.
...
* [sd](https://github.com/chmln/sd) ⭐ 7,357 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - s\[earch] & d\[isplace] - An intuitive find & replace CLI a possible replacement for sed.
* [scooter](https://github.com/thomasschafer/scooter) ⭐ 1,296 | 🐛 18 | 🌐 Rust | 📅 2026-09-19 - Interactive find-and-replace TUI app; By default the program recursively searches through files in the current directory and can also be used to process text from stdin.
...
* [Dust](https://github.com/bootandy/dust) ⭐ 12,278 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - du + rust = dust. Like du but more intuitive.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,281 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Disk Usage Analyzer. Learn about the usage of disk space of a given directory with parallel access to max out SSD exploration.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,990 | 🐛 54 | 🌐 Go | 📅 2026-09-16 - Pretty fast disk usage analyzer written in Go. Gdu is intended primarily for SSD disks where it can fully utilize parallel processing. However, HDDs work as well, but the performance gain is not so huge.
...
* [Btop++](https://github.com/aristocratos/btop) ⭐ 34,662 | 🐛 541 | 🌐 C++ | 📅 2026-09-19 - Resource monitor that shows usage and stats for processor, memory, disks, network, and processes. C++ version and continuation of [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,116 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 and [bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,929 | 🐛 99 | 🌐 Python | 📅 2025-06-01.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,014 | 🐛 137 | 🌐 C | 📅 2026-09-19 - A top like task monitor for AMD, Intel and NVIDIA GPUs, that can handle multiple GPUs and print information about them in a htop-familiar way.
...
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,154 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management.
* [procs](https://github.com/dalance/procs) ⭐ 6,178 | 🐛 36 | 🌐 Rust | 📅 2026-09-16 - A modern replacement for ps written in Rust.
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,096 | 🐛 39 | 🌐 Python | 📅 2026-09-15 - Stress-Terminal UI, s-tui, monitors CPU temperature, frequency, power, and utilization in a graphical way from the terminal.
* [gputop](https://github.com/wookayin/gpustat) ⭐ 4,393 | 🐛 30 | 🌐 Python | 📅 2026-09-15 - A simple command-line utility for querying and monitoring GPU status.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,054 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Sort of like top or htop but with zoom-able charts, CPU, GPU, network, and disk usage
...
* [amdgpu-top](https://github.com/Umio-Yasuno/amdgpu_top) ⭐ 1,709 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - A tool that display AMD GPU utilization and information, gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, and AMDGPU driver.
...
* [rmlint](https://github.com/sahib/rmlint) ⭐ 2,422 | 🐛 110 | 🌐 C | 📅 2026-09-19 - Recursively scan a directory tree looking for duplicate and broken files; it outputs statistics and save the list of files in JSON format and produces a shell script that can be inspected before running it to delete the desire files.
* [classifier](https://github.com/bhrigu123/classifier) ⭐ 1,097 | 🐛 25 | 🌐 Python | 📅 2022-03-07 - Organize files in your current directory, by classifying them into folders of music, PDFs, images, etc.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,303 | 🐛 62 | 🌐 Rust | 📅 2026-09-19 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/yorukot/superfile) ⭐ 23,303 | 🐛 269 | 🌐 Go | 📅 2026-09-18 - Pretty fancy and modern file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,958 | 🐛 2 | 🌐 C | 📅 2026-09-19 - "The unorthodox terminal file manager" - a tiny, nearly 0-config and fast file manager supporting all the operations on files and directories.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,517 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - lf (as in "list files") is a terminal file manager written in Go with a heavy inspiration from ranger file manager.
...
* [Far2l](https://github.com/elfmz/far2l) ⭐ 2,216 | 🐛 478 | 🌐 C++ | 📅 2026-09-08 - Linux port of Far v2 file manager.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,827 | 🐛 12 | 🌐 Rust | 📅 2026-09-16 - A hackable, minimal, fast TUI file explorer, stealing ideas from nnn and fzf.
...
* [progress](https://github.com/Xfennec/progress) ⭐ 8,856 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Monitor the progress of common Coreutils command-line tools (`cp`, `mv`, `dd`, `tar`, `rsync`, etc.); it uses a ncurses interface to display the percentage of data copied; it works by reading from system files and retrieving the necessary information for the estimation.
* [ouch](https://github.com/ouch-org/ouch) ⭐ 3,762 | 🐛 95 | 🌐 Rust | 📅 2026-09-17 - Painless compression and decompression in the terminal.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,757 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Terminal native document viewer for Word files (view, search and export documents).
...
* [F2](https://github.com/ayoisaiah/f2) ⭐ 2,450 | 🐛 4 | 🌐 Go | 📅 2026-08-29 - Cross-platform command-line tool for batch renaming files and directories quickly and safely.
...
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,671 | 🐛 61 | 🌐 C | 📅 2026-09-16 - Locally mount a remote file-system through SSH and access files and directory as they would be on the local machine.
...
* [MarkItDown](https://github.com/microsoft/markitdown) ⭐ 185,723 | 🐛 693 | 🌐 Python | 📅 2026-09-16 - Python tool for converting files and office documents to Markdown.
...
* [NestedTextTo](https://github.com/AndydeCleyre/nestedtextto) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-19 - CLI to convert between NestedText and JSON, YAML, or TOML.
...
* [espanso](https://github.com/espanso/espanso) ⭐ 14,509 | 🐛 540 | 🌐 Rust | 📅 2026-09-20 - Cross-platform Text Expander written in Rust. Not limited to the command line.
...
* [rich](https://github.com/Textualize/rich-cli) ⭐ 3,723 | 🐛 47 | 🌐 Python | 📅 2026-08-12 - Rich-CLI is a command line toolbox for fancy output in the terminal, built with [Rich](https://github.com/Textualize/rich) ⭐ 57,397 | 🐛 378 | 🌐 Python | 📅 2026-06-23.
* [trurl](https://github.com/curl/trurl) ⭐ 3,353 | 🐛 5 | 🌐 Perl | 📅 2026-09-02 - Command line tool for URL parsing and manipulation.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,634 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - Command-line JSON viewer.
* [yq](https://github.com/mikefarah/yq) ⭐ 15,982 | 🐛 304 | 🌐 Go | 📅 2026-09-17 - Portable command-line YAML processor.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,678 | 🐛 26 | 🌐 Python | 📅 2026-09-19 - Serializes the output of command line tools to JSON.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,179 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - You can drill down JSON interactively by using filtering queries like jq.
...
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 18 | 🌐 Go | 📅 2026-09-19 - Pure Go implementation of jq.
* [jaq](https://github.com/01mf02/jaq) ⭐ 3,762 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - jaq is a clone of the JSON data processing tool jq, that aims to support a large subset of jq's syntax and operations.
...
* [Dolt](https://github.com/dolthub/dolt) ⭐ 24,474 | 🐛 579 | 🌐 Go | 📅 2026-09-18 - Dolt is Git for Data! Dolt is a SQL database that you can fork, clone, branch, merge, push and pull just like a git repository.
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,394 | 🐛 47 | 🌐 Python | 📅 2026-09-19 - Postgres CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,976 | 🐛 0 | 🌐 Python | 📅 2026-09-19 - A command line client for MySQL that can do autocompletion and syntax highlighting.
...
* [Miller](https://github.com/johnkerl/miller) ⭐ 10,021 | 🐛 72 | 🌐 Go | 📅 2026-09-14 - Miller is like awk, sed, cut, join, and sort for data formats such as CSV, TSV, JSON, JSON Lines, and positionally-indexed.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,339 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - A database management tui for PostGres.
* [LAZYSQL](https://github.com/jorgerojas26/lazysql) ⭐ 4,313 | 🐛 46 | 🌐 Go | 📅 2026-09-17 - A cross-platform TUI database management tool written in Go.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,974 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - CSV file viewer; like `less` but made for CSV.
* [qsv](https://github.com/jqnatividad/qsv) ⭐ 3,789 | 🐛 32 | 🌐 Rust | 📅 2026-09-19 - CSVs sliced, diced & analyzed.
* [qsv](https://github.com/dathere/qsv) ⭐ 3,789 | 🐛 32 | 🌐 Rust | 📅 2026-09-19 - qsv is a command line program for querying, slicing, indexing, analyzing, filtering, enriching, transforming, sorting, validating, joining, formatting & converting tabular data (CSV, spreadsheets, DBs, parquet, etc).
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,320 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - A cross-platform TUI database management tool written in Rust.
...
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,111 | 🐛 17 | 🌐 Rust | 📅 2026-09-19 - A lightweight, terminal-based application to view and query delimiter separated value formatted documents, such as CSV or TSV files.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,567 | 🐛 74 | 🌐 Go | 📅 2026-09-19 - Command line tool that provides jq-style access to structured data sources such as SQL databases, or document formats like CSV or Excel.
...
* [TV](https://github.com/alexhallam/tv) ⭐ 2,164 | 🐛 28 | 🌐 Rust | 📅 2025-08-21 - Cross-platform CSV pretty printer made to maximize viewer enjoyment.
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,824 | 🐛 6 | 🌐 Go | 📅 2022-06-11 - A TUI for viewing and editing databases, written in pure Go.
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,197 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - Your single pane of glass (TUI) for real-time analytics into MySQL/MariaDB & ProxySQL.
...
* [zsv](https://github.com/liquidaty/zsv) ⭐ 397 | 🐛 24 | 🌐 C | 📅 2026-09-19 - The world's fastest (simd) CSV parser, with an extensible, multi-purpose CLI.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,142 | 🐛 330 | 🌐 Go | 📅 2026-09-14 - (FuZzy Finder) - a general-purpose command-line finder with fuzzy search/filter capabilities, good integration with `vim`.
* [skim](https://github.com/lotabout/skim) ⭐ 6,967 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - Fuzzy Finder in rust.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,281 | 🐛 78 | 🌐 Rust | 📅 2026-09-19 - Blazing fast general purpose fuzzy finder TUI.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,389 | 🐛 236 | 🌐 Go | 📅 2026-09-14 - TUI that renders Markdown files, with keybindings similar to `less` and support for styles and cloud encrypted storing
* [mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,157 | 🐛 657 | 🌐 Rust | 📅 2026-09-18 - Create book from Markdown files.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,609 | 🐛 922 | 🌐 Go | 📅 2026-09-20 - Aims to be a successor to [`nano`](https://www.nano-editor.org/). Aiming to be easy to use, it has a nano-like keybindings menu; also takes advantage of the full capabilities of modern terminals, supports mutiple cursors, and has a plugin system. Written in Go.
* [edit](https://github.com/microsoft/edit) ⭐ 14,592 | 🐛 166 | 🌐 Rust | 📅 2026-09-18 - This editor pays homage to the classic MS-DOS Editor, but with a modern interface and input controls similar to VS Code.
...
* [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,514 | 🐛 1,036 | 🌐 Go | 📅 2026-09-19 - A simple terminal UI for git commands that simplify the execution of many operations making them interactive.
* [gitleaks](https://github.com/gitleaks/gitleaks) ⭐ 29,396 | 🐛 484 | 🌐 Go | 📅 2026-09-09 - Tool for detecting and preventing hardcoded secrets like passwords, api keys, and tokens in git repos.
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,509 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - The comfort of a git GUI but right in your terminal, with keyboard only control, scalable UI, and features all the necessary operations of git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,106 | 🐛 95 | 🌐 Shell | 📅 2026-09-20 - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
* [tig](https://github.com/jonas/tig) ⭐ 13,343 | 🐛 231 | 🌐 C | 📅 2026-09-19 - An ncurses-based text-mode interface for `git` that can act as a repository browser, but can also assist in staging changes for commit at chunk level.
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,535 | 🐛 100 | 🌐 Go | 📅 2026-09-08 - A beautiful CLI dashboard for GitHub.
* [git-cliff](https://github.com/orhun/git-cliff) ⭐ 12,247 | 🐛 114 | 🌐 Rust | 📅 2026-09-18 - A highly customizable Changelog Generator that follows Conventional Commit specifications.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,049 | 🐛 64 | 🌐 Rust | 📅 2026-09-18 - Git repository summary on your terminal.
* [git-bug](https://github.com/MichaelMure/git-bug) ⭐ 10,043 | 🐛 149 | 🌐 Go | 📅 2026-09-19 - Distributed, offline-first bug tracker embedded in git, with bridges.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,224 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - Self-hostable Git server for the command line. One distinguished feature is the possibility to create new repositories with a push.
...
* [WRKFLW](https://github.com/bahdotsh/wrkflw) ⭐ 3,319 | 🐛 13 | 🌐 Rust | 📅 2026-09-08 - Command-line tool for validating and executing GitHub actions workflows locally, without a full GitHub environment.
...
* [Jujutsu](https://github.com/martinvonz/jj) ⭐ 31,661 | 🐛 1,253 | 🌐 Rust | 📅 2026-09-20 - A Git-compatible VCS that is both simple and powerful.
...
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 28,416 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-19 - Tool that packs your entire repository into a single, AI-friendly file; Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools.
* [Crush](https://github.com/charmbracelet/crush) ⭐ 28,195 | 🐛 769 | 🌐 Go | 📅 2026-09-20 - Flexible AI coding agent with a wide range of LLMS, maintains multiple work sessions and contexts per project, works everywhere and extensible.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,051 | 🐛 406 | 🌐 JavaScript | 📅 2026-09-19 - Automates the whole node.js package release workflow including: determining the next version number, generating the release notes, and publishing the package.
* [air](https://github.com/air-verse/air) ⭐ 23,997 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Live reload for Go apps.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,549 | 🐛 26 | 🌐 Perl | 📅 2026-09-20 - Tool for counting blank lines, comment lines, and physical lines of source code in many programming languages.
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,924 | 🐛 245 | 🌐 Rust | 📅 2026-09-06 - Tokei is a program that displays statistics about your code. Tokei will show the number of files, total lines within those files and code, comments, and blanks grouped by language.
* [devbox](https://github.com/jetify-com/devbox) ⭐ 12,367 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Instant, easy, and predictable development environments.
...
* [scc](https://github.com/boyter/scc) ⭐ 8,766 | 🐛 26 | 🌐 Go | 📅 2026-09-15 - Sloc Cloc and Code (scc) is a codebase statistics counter. Goal is to be the fastest code counter possible, but also perform COCOMO calculation like sloccount and to estimate code complexity similar to cyclomatic complexity calculators. In short one tool to rule them all.
* [grex](https://github.com/pemistahl/grex) ⭐ 8,194 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool for generating regular expressions from user-provided test cases.
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,433 | 🐛 37 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing Linux binaries.
* [Flox](https://github.com/flox/flox) ⭐ 4,135 | 🐛 435 | 🌐 Rust | 📅 2026-09-18 - Developer environments you can take with you.
...
* [Euporie](https://github.com/joouha/euporie) ⭐ 2,656 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - Allows you to interact with Jupyter kernels, and run Jupyter notebooks - entirely from the terminal.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 901 | 🐛 163 | 🌐 Rust | 📅 2026-09-20 - Continuous benchmarking, Bencher allows you to track the performance of your code or binary over time and catch performance regressions before you release.
...
* [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,094 | 🐛 314 | 🌐 Python | 📅 2026-04-01 - A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package projects, C projects.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,630 | 🐛 78 | 🌐 Go | 📅 2026-09-18 - Kubernetes CLI To Manage Your Clusters In Style!
* [Devbox](https://github.com/jetpack-io/devbox) ⭐ 12,367 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Devbox is a command-line tool that lets you easily create isolated shells and containers by defining the list of packages required by the environment.
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A supercharged AWS command line interface (CLI).
* [stern](https://github.com/stern/stern) ⭐ 4,866 | 🐛 39 | 🌐 Go | 📅 2026-09-14 - Multi pod and container log tailing for Kubernetes.
...
* [OPS](https://github.com/nanovms/ops) ⭐ 1,516 | 🐛 143 | 🌐 Go | 📅 2026-09-09 - Ops is a tool for creating and running a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,194 | 🐛 87 | 🌐 C | 📅 2026-09-19 unikernel. It is used to package, create, and run your application as a [Nanos](https://github.com/nanovms/nanos) ⭐ 3,194 | 🐛 87 | 🌐 C | 📅 2026-09-19 unikernel instance.
...
* [podman-tui](https://github.com/containers/podman-tui) ⭐ 1,235 | 🐛 13 | 🌐 Go | 📅 2026-09-18 - TUI for Podman environment.
...
* [HTTPie](https://github.com/httpie/httpie) ⭐ 38,558 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie for Terminal: human-friendly CLI HTTP client for the API era.
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,486 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - Tool and library for saving complete web pages as a single HTML file.
* [posting](https://github.com/darrenburns/posting) ⭐ 12,429 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - The modern API client that lives in your terminal, not unlike Postman and Insomnia.
...
* [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1,923 | 🐛 7 | 🌐 Go | 📅 2026-09-14 - Domain Availability Research Tool.
...
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,390 | 🐛 2 | 🌐 Rust | 📅 2026-09-20 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://github.com/paul-gauthier/aider) ⭐ 49,068 | 🐛 1,880 | 🌐 Python | 📅 2026-05-22 - aider is AI pair programming in your terminal.
...
* [just](https://github.com/casey/just) ⭐ 35,919 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Handy way to save and run project-specific commands.
...
* [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) ⭐ 7,763 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Automatic CPU speed and power optimizer for Linux, which allows to dynamically change the settings of the CPU to save energy and extend the battery life on laptops.
...
* [landrun](https://github.com/Zouuup/landrun) ⭐ 2,296 | 🐛 5 | 🌐 Go | 📅 2026-07-23 - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
...
* [immortal](https://github.com/immortal/immortal) ⭐ 841 | 🐛 2 | 🌐 Go | 📅 2026-08-16 - A \*nix cross-platform (OS agnostic) supervisor.
...
* [ghostty](https://github.com/ghostty-org/ghostty/) ⭐ 61,323 | 🐛 247 | 🌐 Zig | 📅 2026-09-20 - A fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GPU acceleration.
* [wezterm](https://github.com/wez/wezterm) ⭐ 28,957 | 🐛 1,871 | 🌐 Rust | 📅 2026-09-17 - A GPU-accelerated cross-platform terminal emulator and multiplexer implemented in Rust with tons of features.
...
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,478 | 🐛 1,931 | 🌐 Rust | 📅 2026-09-18 - A workspace aimed at developers, ops-oriented people and anyone who loves the terminal. At its core, it is a terminal multiplexer.
* [vtm](https://github.com/netxs-group/vtm) ⭐ 3,365 | 🐛 21 | 🌐 C++ | 📅 2026-09-19 - Virtual terminal multiplexer with window manager and session sharing.
* [vtm](https://github.com/directvt/vtm) ⭐ 3,365 | 🐛 21 | 🌐 C++ | 📅 2026-09-19 - Virtual terminal multiplexer delivered as a single executable; It runs in native Windows or standard consoles, wraps any CLI app and supports infinite nesting to create a text-based desktop that bridges the gap between TUI and GUI.
...
* [Nushell](https://github.com/nushell/nushell) ⭐ 40,530 | 🐛 1,439 | 🌐 Rust | 📅 2026-09-19 - A modern shell written in Rust, where all data is structured.
...
* [Oils](https://github.com/oilshell/oil) ⭐ 3,392 | 🐛 610 | 🌐 Python | 📅 2026-09-17 - From their README: "Oils is our upgrade path from bash to a better language and runtime!"
* [Ion](https://github.com/redox-os/ion) ⭐ 1,655 | 🐛 60 | 🌐 Rust | 📅 2026-09-19 - Ion is a modern system shell that features a simple, yet powerful, syntax.
...
* [ksh93](https://github.com/ksh93/ksh) ⭐ 282 | 🐛 60 | 🌐 C | 📅 2026-09-20 - (KornShell) a shell programming language that is compatible with the Bourne Shell in addition and has the major command-entry features of the BSD shell csh.
...
* [arsh](https://github.com/sekiguchi-nagisa/arsh) ⭐ 30 | 🐛 51 | 🌐 C++ | 📅 2026-09-19 - A statically typed scripting language with shell-like features.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,123 | 🐛 151 | 🌐 Shell | 📅 2026-09-14 - A theme for Zsh. It emphasizes speed, flexibility and out-of-the-box experience.
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,044 | 🐛 46 | 🌐 Go | 📅 2026-06-09 - TUI-based clipboard manager application written in Go.
...
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,879 | 🐛 98 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [Fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,698 | 🐛 92 | 🌐 C | 📅 2026-09-20 - Like Neofetch, but much faster because written in C.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,698 | 🐛 92 | 🌐 C | 📅 2026-09-20 - An actively maintained, feature-rich and performance oriented, neofetch like system information tool.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,939 | 🐛 449 | 🌐 C | 📅 2026-09-19 - GoAccess is a real-time web log analyzer and interactive viewer, that provides fast and valuable HTTP statistics.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,095 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,586 | 🐛 106 | 🌐 Go | 📅 2025-07-10 - Cross-platform and fully-customizable TUI dashboard and widget library.
...
* [topgrade](https://github.com/topgrade-rs/topgrade) ⭐ 4,564 | 🐛 209 | 🌐 Rust | 📅 2026-09-19 - Upgrade all the things.
* [eget](https://github.com/zyedidia/eget) ⭐ 2,076 | 🐛 57 | 🌐 Go | 📅 2024-07-09 - Easily install prebuilt binaries from GitHub.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,587 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,870 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
...
* [distrobox](https://github.com/89luca89/distrobox) ⭐ 12,988 | 🐛 153 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal as docker or podman containers.
...
* [ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) ⭐ 3,079 | 🐛 64 | 🌐 Go | 📅 2026-09-17 - An SSH Server that Launches Containers in Kubernetes and Docker on demand.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,847 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple TUI to view & control docker containers.
* [nemu](https://github.com/nemuTUI/nemu) ⭐ 607 | 🐛 16 | 🌐 C | 📅 2026-06-11 - Ncurses UI for QEMU.
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,399 | 🐛 115 | 🌐 C | 📅 2026-09-17 - A window switcher, application launcher and dmenu replacement.
...
* [entr](https://github.com/eradman/entr) ⭐ 5,687 | 🐛 1 | 🌐 C | 📅 2026-06-27 - Event Notify Test Runner - Run an arbitrary command when files change.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,783 | 🐛 27 | 🌐 Go | 📅 2026-09-07 - TUI for running apps and processes.
...
* [cfonts](https://github.com/dominikwilkowski/cfonts) ⭐ 1,894 | 🐛 3 | 🌐 Rust | 📅 2026-09-19 - А command line tool for generating ANSI fonts in the console.
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,275 | 🐛 19 | 🌐 Rust | 📅 2026-09-08 - Command-line interface for email management.
* [Himalaya](https://github.com/pimalaya/himalaya) ⭐ 7,275 | 🐛 19 | 🌐 Rust | 📅 2026-09-08 - CLI to manage emails.
* [tmpmail](https://github.com/sdushantha/tmpmail) ⭐ 4,190 | 🐛 7 | 🌐 Shell | 📅 2024-08-17 - A command line utility written in POSIX sh that allows you to create a temporary email address and receive emails to the temporary email address.
* [pop](https://github.com/charmbracelet/pop) ⭐ 2,909 | 🐛 30 | 🌐 Go | 📅 2026-09-01 - Send emails from your terminal; it uses the API at [https://resend.com/](resend.com).
...
* [Telegram messenger CLI](https://github.com/vysheng/tg) ⭐ 7,202 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command-line interface for Telegram using the readline interface.
...
* [Discordo](https://github.com/ayn2op/discordo) ⭐ 5,781 | 🐛 54 | 🌐 Go | 📅 2026-09-12 - A lightweight, secure, and feature-rich Discord terminal client.
* [signal-cli](https://github.com/AsamK/signal-cli) ⭐ 4,921 | 🐛 112 | 🌐 Java | 📅 2026-09-18 - signal-cli provides an unofficial command-line, dbus and JSON-RPC interface for the Signal messenger.
...
* [Instagram CLI](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,147 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 - Instagram from your terminal; It allows you to use social media more intentionally (chat, stay updated with post and stories without falling into endless brainrot).
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,964 | 🐛 18 | 🌐 C++ | 📅 2026-09-19 - Terminal Telegram, WhatsApp and Signal client for LInux and macOS.
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,724 | 🐛 79 | 🌐 Go | 📅 2026-09-18 - A terminal based Matrix client written in Go.
* [gurk](https://github.com/boxdot/gurk-rs) ⭐ 1,379 | 🐛 98 | 🌐 Rust | 📅 2026-09-15 - Signal Messenger client for terminal.
...
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,014 | 🐛 15 | 🌐 Rust | 📅 2026-09-15 - A TUI for Telegram written in Rust.
...
* [Endcord](https://github.com/mzivic7/endcord) ⭐ 992 | 🐛 4 | 🌐 Python | 📅 2026-09-19 - Lightweight and feature rich Discord TUI client, running entirely in terminal, built with python and ncurses library.
...
* [matrix-commander](https://github.com/8go/matrix-commander) ⭐ 758 | 🐛 36 | 🌐 Python | 📅 2026-07-23 - Simple but convenient CLI-based Matrix client app for sending and receiving.
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,552 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Turn CLI tools into web applications; basically, it runs a command and starts a server so that the output can be displayed in a web page.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,391 | 🐛 116 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,943 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - A network diagnostic tool.
...
* [AutoRecon](https://github.com/Tib3rius/AutoRecon) ⭐ 6,115 | 🐛 43 | 🌐 Python | 📅 2026-01-28 - AutoRecon is a multi-threaded network reconnaissance tool which performs automated enumeration of services.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,094 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,115 | 🐛 47 | 🌐 C | 📅 2026-09-19 - A ssl/ssh multiplexer (Applicative Protocol Multiplexer) that allows, for example, to share SSH and HTTPS on the same port.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,038 | 🐛 32 | 🌐 Rust | 📅 2026-09-18 - Cross-platform network monitoring tool with a TUI displaying real-time information about network connections.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,728 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - Arguably a Terminal API Client. It is based on well-known clients such as Postman, Insomnia, or even Bruno, but inside your terminal without any specific graphical environment needed; free, account-less, and offline for now and forever.
...
* [trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ⭐ 2,718 | 🐛 35 | 🌐 Go | 📅 2026-09-12 - An ssh client designed as a drop-in replacement for the openssh client. It aims to provide complete compatibility with openssh, mirroring all its features, while also offering additional useful features. Such as login prompt, batch login, remember password, automated interaction, trzsz, zmodem(rz/sz), udp mode like mosh, etc.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,854 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - All-in-one network scanning tool.
...
* [sshs](https://github.com/quantumsheep/sshs) ⭐ 1,608 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - Terminal user interface for SSH.
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,564 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - kubectl port-forward on steroids, manage and share multiple k8s port forwards, with support for UDP, proxy through the k8s cluster, and github state sync.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,389 | 🐛 37 | 🌐 C | 📅 2026-09-19 - A monitoring and debugging tool to capture networking related statistics and prepare them visually in a human friendly way.
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,242 | 🐛 6 | 🌐 C | 📅 2026-06-29 - wavemon is an ncurses-based monitoring application for wireless network devices on Linux.
...
* [tsshd](https://github.com/trzsz/tsshd) ⭐ 542 | 🐛 0 | 🌐 Go | 📅 2026-09-19 - The tsshd works like mosh-server, while the "tssh --udp" works like mosh. Supports ssh port forwarding, ssh agent forwarding and X11 forwarding.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,856 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi networks and connections on Linux.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,192 | 🐛 2,662 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes.
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,279 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Downloads videos from [YouTube](https://www.youtube.com/) and some other sites useful for automated bulk downloads.
* [aria2](https://github.com/aria2/aria2) ⭐ 42,541 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - Lightweight and easy-to-use download utility; it supports HTTP/HTTPS, FTP, SFTP, BitTorrent, Metalink and multiple sources; cross-platform.
* [croc](https://github.com/schollz/croc) ⭐ 40,389 | 🐛 8 | 🌐 Go | 📅 2026-09-18 - Easily and securely send things from one computer to another.
* [lux](https://github.com/iawia002/lux) ⭐ 31,694 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - Lux is a fast and simple video downloader built with Go.
* [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) ⭐ 22,940 | 🐛 182 | 🌐 Python | 📅 2026-09-14 - The program allows transfer arbitrary-sized files and directories (or short pieces of text) from one computer to another The two endpoints are identified by using identical human-readable codes.
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,768 | 🐛 1,136 | 🌐 Python | 📅 2026-09-19 - Gallery-dl is a command-line program to download image galleries and collections from several image hosting sites.
...
* [tdl](https://github.com/iyear/tdl) ⭐ 8,078 | 🐛 196 | 🌐 Go | 📅 2026-09-14 - Beautiful and feature-rich Telegram downloader, written in Go.
...
* [zrok](https://github.com/openziti/zrok) ⭐ 4,711 | 🐛 125 | 🌐 Go | 📅 2026-06-22 - Geo-scale, next-generation peer-to-peer sharing platform built on top of OpenZiti.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,726 | 🐛 27 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie.
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,533 | 🐛 17 | 🌐 Python | 📅 2024-08-15 - Get songs from YouTube in mp3 format.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,091 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,864 | 🐛 401 | 🌐 C++ | 📅 2026-09-19 - BitTorrent client uses ncurses and is ideal for use with tmux, screen or dtach.
...
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 697 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa TUI for browsing and downloading torrents.
...
* [Awesome CLI](https://github.com/umutphp/awesome-cli) ⭐ 817 | 🐛 2 | 🌐 Go | 📅 2025-10-08 - Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into Awesome lists.
...
* [av](https://github.com/aviator-co/av) ⭐ 509 | 🐛 75 | 🌐 Go | 📅 2026-09-14 - A command line tool to manage stacked PRs with Aviator.
...
* [Dooit](https://github.com/kraanzu/dooit) ⭐ 2,955 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - Todo manager with interactive and beautiful UI, and vim keybindings.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,131 | 🐛 132 | 🌐 Rust | 📅 2026-09-13 - A terminal user interface for taskwarrior.
...
* [dijo](https://github.com/NerdyPepper/dijo) ⭐ 2,921 | 🐛 36 | 🌐 Rust | 📅 2024-08-13 - Scriptable, curses-based, digital habit tracker.
...
* [Timewarrior](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,662 | 🐛 126 | 🌐 C++ | 📅 2026-09-19 - A time tracking utility that offers simple stopwatch features as well as sophisticated calendar-based backfill, along with flexible reporting.
...
* [MyTimer](https://github.com/sepandhaghighi/mytimer) ⭐ 148 | 🐛 2 | 🌐 Python | 📅 2026-09-19 - Simple timer for the terminal with timer-mode and alarm.
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,321 | 🐛 152 | 🌐 Python | 📅 2026-09-19 - jrnl is a simple journal application for the command line to easily create, search, and view journal entries; journals are stored as human-readable plain text, and can also be encrypted using AES encryption.
* [kb](https://github.com/gnebbia/kb) ⭐ 3,412 | 🐛 13 | 🌐 Python | 📅 2025-06-21 - A minimalist knowledge base manager.
* [dnote](https://github.com/dnote/dnote) ⭐ 3,083 | 🐛 41 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook for the terminal. It also offers a seamless multi-device sync and a web interface.
* [zk](https://github.com/mickael-menu/zk) ⭐ 2,807 | 🐛 24 | 🌐 Go | 📅 2026-09-12 - zk is a command-line tool helping you to maintain a plain text Zettelkasten or personal wiki.
* [eureka](https://github.com/simeg/eureka) ⭐ 878 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Store your ideas without leaving the terminal.
* [TUI-Journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 782 | 🐛 13 | 🌐 Rust | 📅 2026-09-06 - Terminal-based application written in Rust that allows you to write and manage your journal/notes with a nice user interface.
...
* [Captain's Log](https://github.com/NikolaDucak/caps-log) ⭐ 404 | 🐛 16 | 🌐 C++ | 📅 2026-08-14 - A small TUI journaling tool (daily entries saved as md files, tags for organizing entries, browse tags, calendar view, encrypted logs, storage using a git repository).
...
* [buku](https://github.com/jarun/buku) ⭐ 7,203 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - A powerful bookmark manager written in Python3 and SQLite3.
...
* [Calcure](https://github.com/anufrievroman/calcure) ⭐ 2,359 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - Modern TUI calendar and task manager with customizable interface.
...
* [Ticker](https://github.com/achannarasappa/ticker) ⭐ 6,235 | 🐛 34 | 🌐 Go | 📅 2026-06-28 - Terminal stock watcher and stock position tracker.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 334 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A simple TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions.
...
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,091 | 🐛 838 | 🌐 TypeScript | 📅 2026-09-20 - It provides lightweight access to Gemini from the terminal.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 44,010 | 🐛 72 | 🌐 Go | 📅 2026-09-07 - An open-source framework for augmenting humans using AI, providing a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
* [AIChat](https://github.com/sigoden/aichat) ⭐ 10,459 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - Using ChatGPT/GPT-3.5/GPT-4 in the terminal.
...
* [Browser CLI](https://github.com/browsemake/browser-cli) ⭐ 48 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-20 - AI agent browser automation tool.
...
* [wtf](https://github.com/wtfutil/wtf) ⭐ 17,095 | 🐛 108 | 🌐 Go | 📅 2026-09-17 - The personal information dashboard for your terminal, including todos, calendar, JIRA, etc.
...
* [ancv](https://github.com/alexpovel/ancv) ⭐ 269 | 🐛 0 | 🌐 Python | 📅 2026-09-19 - Renders your (JSON) resume/CV for online & pretty terminal display.
...
* [floww](https://github.com/dagimg-dot/floww) ⭐ 23 | 🐛 0 | 🌐 Go | 📅 2026-08-01 - Streamline your workflow setup on Linux desktops, defining workspace layouts and application sets in simple configuration files and automate the process of switching workspaces and launching applications.
...
* [Slides](https://github.com/maaslalani/slides) ⭐ 11,662 | 🐛 77 | 🌐 Go | 📅 2026-07-08 - Terminal based presentation tool.
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,857 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 - A terminal slideshow tool.
...
* [qpdf](https://github.com/qpdf/qpdf) ⭐ 5,422 | 🐛 171 | 🌐 C++ | 📅 2026-09-06 - QPDF: A content-preserving PDF document transformer that allows performing several types of operations on PDF files, such as splitting, merging, etc.
...
* [Numbat](https://github.com/sharkdp/numbat) ⭐ 2,687 | 🐛 129 | 🌐 Rust | 📅 2026-08-25 - Numbat is a calculator for scientific computations with first class support for physical dimensions and units.
...
* [bcal](https://github.com/jarun/bcal) ⭐ 701 | 🐛 0 | 🌐 C | 📅 2026-09-17 - Byte CALculator - A REPL CLI utility for storage expression evaluation, SI/IEC conversion, byte address calculation, base conversion and LBA/CHS calculation.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,860 | 🐛 458 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (although I would be extra-cautious at making a program to automatically infer what I was intending).
* [navi](https://github.com/denisidoro/navi) ⭐ 17,573 | 🐛 111 | 🌐 Rust | 📅 2026-09-15 - An interactive cheatsheet tool for the command-line.
...
* [carapace](https://github.com/rsteube/carapace-bin) ⭐ 1,961 | 🐛 92 | 🌐 Go | 📅 2026-09-19 - Carapace provides argument completion for multiple CLI commands and works across multiple POSIX and non-POSIX shells.
...
* [snip](https://github.com/marcopaganini/snip) ⭐ 35 | 🐛 0 | 🌐 Shell | 📅 2024-11-17 - A snippet manager for bash, mostly written in pure bash.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 139 | 🐛 1 | 🌐 Rust | 📅 2026-09-19 - Sessions-based AI coding agent with extensible architecture, smart codebase understanding and no AI provider lock-in.
...
* [Blitzdenk](https://github.com/Lommix/blitzdenk) ⭐ 11 | 🐛 0 | 🌐 Zig | 📅 2026-09-19 - A minimal multi provider coding agent and personal AI TUI; Similar to tools like opencode or claudecode; Written in Rust.
...
* [D2](https://github.com/terrastruct/d2) ⭐ 25,470 | 🐛 528 | 🌐 Go | 📅 2026-09-15 - D2 is a modern diagram scripting language that turns text to diagrams.
* [SVGO](https://github.com/svg/svgo) ⭐ 22,685 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - SVG Optimizer is a Node.js-based tool for optimizing SVG vector graphics files.
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,499 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,260 | 🐛 54 | 🌐 C | 📅 2026-09-19 - Terminal graphics for the 21 st century.
...
* [Diagon](https://github.com/ArthurSonzogni/Diagon) ⭐ 2,222 | 🐛 21 | 🌐 C++ | 📅 2025-05-16 - Diagon is an interactive interpreter, that transforms Markdown-style expression into an ASCII-art representation.
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,047 | 🐛 36 | 🌐 C | 📅 2026-09-11 - A planetarium for your terminal. Explore stars, planets, constellations, and more!
* [durdraw](https://github.com/cmang/durdraw) ⭐ 1,822 | 🐛 6 | 🌐 Python | 📅 2026-09-20 - Versatile ASCII and ANSI Art text editor for drawing in the Linux/Unix/macOS terminal, with animation, 256 and 16 colors, Unicode and CP437, and customizable themes.
...
* [rclip](https://github.com/yurijmikhalevich/rclip) ⭐ 1,005 | 🐛 15 | 🌐 Python | 📅 2026-09-19 - AI-Powered Command-Line Photo Search Tool.
...
* [greentext](https://github.com/jasonuc/greentext) ⭐ 35 | 🐛 0 | 🌐 Go | 📅 2026-09-14 - A CLI tool for creating green-text memes.
...
* [Streamlink](https://github.com/streamlink/streamlink) ⭐ 11,773 | 🐛 70 | 🌐 Python | 📅 2026-09-18 - Streamlink is a CLI utility which pipes video streams from various services into a video player.
* [Editly](https://github.com/mifi/editly) ⭐ 5,505 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - A tool and framework for declarative NLE (non-linear video editing) using Node.js and FFmpeg.
...
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,352 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - A Spotify client for the terminal written in Rust.
* [beets](https://github.com/beetbox/beets) ⭐ 15,678 | 🐛 711 | 🌐 Python | 📅 2026-09-19 - Beets is the media library management system for obsessive music geeks: catalogs your collection, automatically improving its metadata as it goes.
* [mps-youtube](https://github.com/mps-youtube/yewtube) ⭐ 8,792 | 🐛 227 | 🌐 Python | 📅 2026-03-04 - A curses player for music tracks from YouTube; it allows searching for songs and playlists; it downloads the video, extracts the audio track and plays it; handles local playlists and many configuration parameters.
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,226 | 🐛 155 | 🌐 Rust | 📅 2026-09-19 - spotify-player is a fast, easy to use, and configurable terminal music player having feature parity with the official Spotify application.
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 593 | 🐛 18 | 🌐 Rust | 📅 2026-09-19 - Jellyfin client (music streaming); Offers a self-hosted terminal music player with modern features.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-19 - A minimal mpc-like CLI and TUI for controlling mpv from the shell.
...
* [cue](https://github.com/ravachol/cue) ⭐ 3,087 | 🐛 1 | 🌐 C | 📅 2026-09-19 - A command-line music player.
* [kew](https://github.com/ravachol/kew) ⭐ 3,087 | 🐛 1 | 🌐 C | 📅 2026-09-19 - A command-line music player with gapless playback and simple playlist management.
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,211 | 🐛 50 | 🌐 Rust | 📅 2026-09-20 - Terminal Music Player written in Rust.
...
* [terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) ⭐ 4,253 | 🐛 9 | 🌐 Python | 📅 2026-09-20 - TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library.
...
* [The Cognitive Sandbox](https://github.com/sylcrala/cognitive_sandbox) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2026-01-04 - The project is a local simulation environment that allows individual agents (particles) to interact with and remeber each other across sessions.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,506 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting and Git integration.
...
* [ov](https://github.com/noborus/ov) ⭐ 2,022 | 🐛 28 | 🌐 Go | 📅 2026-09-20 - Feature-rich terminal-based text viewer.
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,563 | 🐛 15 | 🌐 Go | 📅 2026-09-19 - Fast, remote-first, multi-host TUI log viewer with timeline histogram and no central server.
...
* [epy](https://github.com/wustho/epy) ⭐ 1,216 | 🐛 72 | 🌐 Python | 📅 2024-03-17 - CLI Ebook (epub2, epub3, fb2, mobi) Reader.
...
* [termv](https://github.com/Roshan-R/termv) ⭐ 300 | 🐛 7 | 🌐 Shell | 📅 2026-05-27 - A terminal IPTV player written in bash.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,991 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.
...
* [vhs](https://github.com/charmbracelet/vhs) ⭐ 20,941 | 🐛 176 | 🌐 Go | 📅 2026-09-09 - Write terminal GIFs as code for integration testing and demoing your CLI tools.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,819 | 🐛 11 | 🌐 Rust | 📅 2026-08-14 - Terminal session recorder.
* [terminalizer](https://github.com/faressoft/terminalizer) ⭐ 16,160 | 🐛 108 | 🌐 JavaScript | 📅 2024-08-29 - Record your terminal and generate animated GIF images or share a web player link [www.terminalizer.com](www.terminalizer.com).
...
* [SOPS](https://github.com/getsops/sops) ⭐ 23,163 | 🐛 447 | 🌐 Go | 📅 2026-09-18 - SOPS (Secrets OPerationS) is a simple and flexible tool for managing secrets, sops is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats, encrypting the values but not the keys.
...
* [Minisign](https://github.com/jedisct1/minisign) ⭐ 2,823 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A dead simple tool to sign files and verify digital signatures.
...
* [sshamble](https://github.com/runZeroInc/sshamble) ⭐ 1,203 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Unexpected exposures in SSH; the tool checks for several common weaknesses in SSH security issues.
...
* [rbw](https://github.com/doy/rbw) ⭐ 1,490 | 🐛 104 | 🌐 Rust | 📅 2025-12-31 - Unofficial command line client for Bitwarden that is “stateful”, i.e., it does not require the manual lock and unlock of the client.
...
* [Keep](https://github.com/keephq/keep) ⭐ 12,336 | 🐛 619 | 🌐 Python | 📅 2026-09-19 - Simple alerting tool, with declarative syntax and builtin providers.
...
* [Managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 772 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A TUI and CLI for managing your arr servers.
...
* [Raijin](https://github.com/MasonStooksbury/Raijin) ⭐ 173 | 🐛 2 | 🌐 Rust | 📅 2026-09-20 - A free, simple weather TUI that pulls data without the need for an API key, account, or subscription.
...
* [GameShell](https://github.com/phyver/GameShell) ⭐ 3,316 | 🐛 16 | 🌐 Shell | 📅 2026-05-05 - GameShell was devised as a tool to help university students to engage with a real shell, in a way that encourages learning while also having fun.
...
* [typtea](https://github.com/ashish0kumar/typtea) ⭐ 244 | 🐛 2 | 🌐 Go | 📅 2026-02-20 - Minimal terminal-based typing speed tester with support for dozens of programming languages.
...
* [Pokete](https://github.com/lxgr-linux/pokete) ⭐ 3,157 | 🐛 30 | 🌐 Python | 📅 2026-05-22 - A terminal based Pokemon like game.
...
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,180 | 🐛 33 | 🌐 Rust | 📅 2026-09-17 - Play chess from your terminal.
...
* [bible](https://github.com/BibleJS/BibleApp) ⭐ 341 | 🐛 0 | 🌐 JavaScript | 📅 2021-04-06 - Read the Holy Bible via the command line.
* [bbl](https://github.com/nehemiaharchives/bbl) ⭐ 96 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-28 - Read, search Holy Bible in command line.
...
[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,458 | 🐛 256 | 📅 2024-06-25 - A wonderful summary from Joshua Levy regarding command line (Bash in particular) tools, programs, tips, and tricks; contains many pointers to resources and repositories, in the form of "to do this you must know that", which gives great pointers but requires further investigation from different sources; translated in many languages.
...
[Caleb Xu shell awesome](https://github.com/alebcay/awesome-shell) ⭐ 37,646 | 🐛 186 | 📅 2025-08-28 - Focused on UNIX shell tools.

[Adam Harris awesome CLI apps](https://github.com/aharris88/awesome-cli-apps) ⭐ 20,428 | 🐛 0 | 🌐 Shell | 📅 2026-09-13 - Nice list of tools; somehow too much JavaScript/Node.js-centered for my tastes.
...
[Awesome TUIs](https://github.com/rothgar/awesome-tuis) ⭐ 20,667 | 🐛 49 | 📅 2026-09-16 - An awesome list dedicated to TUI programs.
